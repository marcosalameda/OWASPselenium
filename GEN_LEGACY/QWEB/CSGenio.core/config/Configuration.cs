...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// </summary>
        public static string Acronym { get; } = "LEGACY";

        /// <summary>
        /// Application version
        /// </summary>
        public static int Version { get; } = 4355;
        ...
        /// </summary>
        public static readonly ClientApplication Application = ClientApplication.QWEB;

        /// <summary>
        /// Modules
        /// </summary>
        public static readonly List<string> Modules = ["QWB"];
        ...
        /// </summary>
        public const int VersionDbGen = 4355;

        /// <summary>
        /// Version of the database indexes
        /// </summary>
        public const int VersionIdxDbGen = 2029;
        ...
        /// </summary>
        public const string GenioVersion = "374.54";
