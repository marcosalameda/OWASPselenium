...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "customeraddressid", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "parentid", FieldType.KEY_INT);
        ...
        public static CSGenioAaddrl search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
