...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codccorr", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "norder", FieldType.NUMERIC);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "qnty", FieldType.NUMERIC);
        ...
        public static CSGenioAccorr search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
