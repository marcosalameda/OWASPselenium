...
namespace CSGenio.business
{
	...
	public class CSGenioAfeeca : DbArea
	{
		...
		public CSGenioAfeeca(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codfeeca", FieldType.KEY_INT);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("flds", new Relation("GQT", "gqtfeeca", "feeca", "codfeeca", "codflds", "GQT", "gqtflds", "flds", "codflds", "codflds"));
		}
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.QSystem="GQT";
			info.TableName="gqtfeeca";
			info.ShadowTabName="";
			info.ShadowTabKeyName="";

			info.PrimaryKeyName="codfeeca";
			info.HumanKeyName="feedback,".TrimEnd(',');
			info.Alias="feeca";
			info.IsDomain = true;
		...
		public static FieldRef FldCodfeeca { get { return m_fldCodfeeca; } }
		private static FieldRef m_fldCodfeeca = new FieldRef("feeca", "codfeeca");

		/// <summary>Field : "" Tipo: "+" Formula:  ""</summary>
		public string ValCodfeeca
		{
			get { return (string)returnValueField(FldCodfeeca); }
		...
		private static FieldRef m_fldZzstate = new FieldRef("feeca", "zzstate");
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAfeeca> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAfeeca>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAfeeca> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAfeeca>(where, listing);
        }
