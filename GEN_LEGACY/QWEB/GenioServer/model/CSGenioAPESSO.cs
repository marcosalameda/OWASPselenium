...
namespace CSGenio.business
{
	...
	/// Person
	/// </summary>
	public class CSGenioApesso : DbArea
	{
		/// <summary>
		...
		public CSGenioApesso(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL GQT CONSTRUTOR PESSO]/
		}

		public CSGenioApesso(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codpesso", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codempre", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codparte", FieldType.KEY_INT);
			Qfield.FieldDescription = "Interested party";
			Qfield.FieldSize =  8;
			Qfield.CavDesignation = "INTERESTED_PARTY36855";
			...
			argumentsListByArea.Add(new ByAreaArguments(new string[] {"dtnascim"}, new int[] {0}, "pesso", "codpesso"));
			Qfield.Formula = new InternalOperationFormula(argumentsListByArea, 1, delegate(object[] args, User user, string module, PersistentSupport sp) {
				return new GlobalFunctions(user,module,sp).Idade(((DateTime)args[0]),DateTime.Today);
			});
			info.RegisterFieldDB(Qfield);
...
//Actualiza as seguintes réplicas:
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codcateg", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codpaise", FieldType.KEY_INT);
			Qfield.FieldDescription = "PAIS DA EMPRESA";
			Qfield.FieldSize =  8;
			Qfield.CavDesignation = "COMPANY_PARENTS01581";
			...
			Qfield.FieldDescription = "PERSON'S PARENTS";
			Qfield.FieldSize =  8;
			Qfield.CavDesignation = "PERSON_S_PARENTS05687";
...
//Actualiza as seguintes réplicas:
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codregia", FieldType.KEY_INT);
			Qfield.FieldDescription = "";
			Qfield.FieldSize =  8;
			Qfield.CavDesignation = "";
			...
			Qfield.FieldDescription = "Indiviudal notifications";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir a edição de caraterísticas";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir o corte de caraterísticas";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir o arrastamento de funcionalidades";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir a rotação de elementos";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir a remoção de caraterísticas";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir marcadores de desenho";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir desenhar polilinhas";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir desenhar polígonos";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Permitir a exportação do mapa";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Curriculum";
			Qfield.FieldSize =  50;
			Qfield.MQueue = false;
			...
			Qfield.Dupmsg = "";
			info.RegisterFieldDB(Qfield);
			Qfield = new Field(info.Alias, "curriculfk", FieldType.KEY_INT);
			Qfield.FieldSize = 8;
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("categ", new Relation("GQT", "gqtpessoas", "pesso", "codpesso", "codcateg", "GQT", "gqtcategorias", "categ", "codcateg", "codcateg"));
			info.ParentTables.Add("cmpny", new Relation("GQT", "gqtpessoas", "pesso", "codpesso", "codempre", "GQT", "gqtcmpny", "cmpny", "codempre", "codempre"));
			info.ParentTables.Add("cntry", new Relation("GQT", "gqtpessoas", "pesso", "codpesso", "codpaise", "GQT", "gqtcntry", "cntry", "codcntry", "codcntry"));
			info.ParentTables.Add("pais1", new Relation("GQT", "gqtpessoas", "pesso", "codpesso", "codcntry", "GQT", "gqtcntry", "pais1", "codcntry", "codcntry"));
			info.ParentTables.Add("regi1", new Relation("GQT", "gqtpessoas", "pesso", "codpesso", "codregia", "GQT", "gqtregio", "regi1", "codregia", "codregia"));
		}
		...
		private static void InicializaFormulas(AreaInfo info)
		{
			...
			argumentsListByArea= new List<ByAreaArguments>();
			argumentsListByArea.Add(new ByAreaArguments(new string[] {"email","email2"},new int[] {0,1},"pesso","codpesso"));
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.AreaPluralDesignation="People";
		...
		private static FieldRef m_fldCodpesso = new FieldRef("pesso", "codpesso");
		...
		private static FieldRef m_fldCodempre = new FieldRef("pesso", "codempre");
		...
		private static FieldRef m_fldCodparte = new FieldRef("pesso", "codparte");
		...
		private static FieldRef m_fldName = new FieldRef("pesso", "name");
		...
		private static FieldRef m_fldGender = new FieldRef("pesso", "gender");
		...
		private static FieldRef m_fldDtnascim = new FieldRef("pesso", "dtnascim");
		...
		private static FieldRef m_fldIdade = new FieldRef("pesso", "idade");
		...
		private static FieldRef m_fldIdfuncio = new FieldRef("pesso", "idfuncio");
		...
		private static FieldRef m_fldTelephon = new FieldRef("pesso", "telephon");
		...
		private static FieldRef m_fldEmail = new FieldRef("pesso", "email");
		...
		private static FieldRef m_fldEmail2 = new FieldRef("pesso", "email2");
		...
		private static FieldRef m_fldPhotogra = new FieldRef("pesso", "photogra");
		...
		private static FieldRef m_fldDtultcat = new FieldRef("pesso", "dtultcat");
		...
		private static FieldRef m_fldCodcateg = new FieldRef("pesso", "codcateg");
		...
		private static FieldRef m_fldExterna = new FieldRef("pesso", "externa");
		...
		private static FieldRef m_fldInterna = new FieldRef("pesso", "interna");
		...
		private static FieldRef m_fldCodpaise = new FieldRef("pesso", "codpaise");
		...
		private static FieldRef m_fldCodcntry = new FieldRef("pesso", "codcntry");
		...
		private static FieldRef m_fldCodregia = new FieldRef("pesso", "codregia");
		...
		private static FieldRef m_fldNotifind = new FieldRef("pesso", "notifind");
		...
		private static FieldRef m_fldTerrain = new FieldRef("pesso", "terrain");
		...
		private static FieldRef m_fldExtquery = new FieldRef("pesso", "extquery");
		...
		private static FieldRef m_fldExtminzm = new FieldRef("pesso", "extminzm");
		...
		private static FieldRef m_fldMapheigh = new FieldRef("pesso", "mapheigh");
		...
		private static FieldRef m_fldZoomlvl = new FieldRef("pesso", "zoomlvl");
		...
		private static FieldRef m_fldOutweigh = new FieldRef("pesso", "outweigh");
		...
		private static FieldRef m_fldLineclr = new FieldRef("pesso", "lineclr");
		...
		private static FieldRef m_fldPolyclr = new FieldRef("pesso", "polyclr");
		...
		private static FieldRef m_fldGroupmrk = new FieldRef("pesso", "groupmrk");
		...
		private static FieldRef m_fldCanedit = new FieldRef("pesso", "canedit");
		...
		private static FieldRef m_fldCancut = new FieldRef("pesso", "cancut");
		...
		private static FieldRef m_fldCandrag = new FieldRef("pesso", "candrag");
		...
		private static FieldRef m_fldCanrot = new FieldRef("pesso", "canrot");
		...
		private static FieldRef m_fldCanremov = new FieldRef("pesso", "canremov");
		...
		private static FieldRef m_fldDrawmrk = new FieldRef("pesso", "drawmrk");
		...
		private static FieldRef m_fldAllowlin = new FieldRef("pesso", "allowlin");
		...
		private static FieldRef m_fldAllowpol = new FieldRef("pesso", "allowpol");
		...
		private static FieldRef m_fldCanexpor = new FieldRef("pesso", "canexpor");
        ...
        public static CSGenioApesso search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioApesso area = new CSGenioApesso(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioApesso> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioApesso>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioApesso> listing)
        {
			sp.searchListAdvancedWhere<CSGenioApesso>(where, listing);
        }
		...
		public override StatusMessage afterUpdate(PersistentSupport sp, Area oldvalues)
		{
				...
				{
					Moment = CSGenio.business.Triggers.TriggerContext.TriggerMoment.AFTER,
					Event = CSGenio.business.Triggers.TriggerContext.TriggerEvent.UPDATE,
					Area = this,
				...
				// Trigger TEST1
				CSGenio.business.Triggers.ITrigger trigger_TEST1 = new CSGenio.business.Triggers.TriggerTest1(context);
				trigger_TEST1.ExecuteActions();
