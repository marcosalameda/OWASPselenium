...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codroigi", FieldType.KEY_INT);
        ...
        public static CSGenioAroigi search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
		...
		public override StatusMessage eliminate(PersistentSupport sp)
		{
			...
			criteria.Equal(CSGenioAroigi.FldCodrogl1, ValCodrogl1);
