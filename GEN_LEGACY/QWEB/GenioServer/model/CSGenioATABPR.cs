...
namespace CSGenio.business
{
	...
	public class CSGenioAtabpr : DbArea
	{
		...
		public CSGenioAtabpr(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codtabpr", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codtpeq1", FieldType.KEY_INT);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("tpequ", new Relation("GQT", "gqttabpr", "tabpr", "codtabpr", "codtpeq1", "GQT", "gqttpequ", "tpequ", "codtpequ", "codtpequ"));
		}
	...
	"today", true));
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.QSystem="GQT";
			info.TableName="gqttabpr";
			info.ShadowTabName="";
			info.ShadowTabKeyName="";

			info.PrimaryKeyName="codtabpr";
		...
		public static FieldRef FldCodtabpr { get { return m_fldCodtabpr; } }
		private static FieldRef m_fldCodtabpr = new FieldRef("tabpr", "codtabpr");

		/// <summary>Field : "" Tipo: "+" Formula:  ""</summary>
		public string ValCodtabpr
		{
			get { return (string)returnValueField(FldCodtabpr); }
		...
		private static FieldRef m_fldSince = new FieldRef("tabpr", "since");
		...
		private static FieldRef m_fldZzstate = new FieldRef("tabpr", "zzstate");
        ...
        public static CSGenioAtabpr search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAtabpr area = new CSGenioAtabpr(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAtabpr> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAtabpr>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAtabpr> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAtabpr>(where, listing);
        }
