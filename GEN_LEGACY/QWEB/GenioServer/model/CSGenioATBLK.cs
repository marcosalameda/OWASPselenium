...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codtblk", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "fkey2", FieldType.KEY_INT);
        ...
        public static CSGenioAtblk search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
