...
//Actualiza as seguintes réplicas:
			...
			Qfield.FieldDescription = "Alterado por";
			Qfield.FieldSize =  128;
			Qfield.VisivelCav = CavVisibilityType.Nunca;
			...
			Qfield.FieldDescription = "Alterado em";
			Qfield.FieldSize =  8;
			Qfield.VisivelCav = CavVisibilityType.Nunca;
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ChildTable[0]= new ChildRelation("pwcom", new String[] {"codpsw"}, DeleteProc.NA);
			info.ChildTable[1]= new ChildRelation("s_ua", new String[] {"codpsw"}, DeleteProc.AP);
			info.ChildTable[2]= new ChildRelation("users", new String[] {"codpsw"}, DeleteProc.NA);
			info.ChildTable[3]= new ChildRelation("prpin", new String[] {"codpsw"}, DeleteProc.NA);
			info.ChildTable[4]= new ChildRelation("pwreg", new String[] {"codpsw"}, DeleteProc.NA);
			info.ChildTable[5]= new ChildRelation("pworg", new String[] {"codpsw"}, DeleteProc.NA);
