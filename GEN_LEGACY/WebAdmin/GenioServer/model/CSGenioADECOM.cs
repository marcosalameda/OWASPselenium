...
//Actualiza as seguintes réplicas:
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "decomnr", FieldType.NUMERIC);
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.AreaDesignation="Desativação de equipamento";
			info.AreaPluralDesignation="Desativação de equipamentos";
        ...
        public static CSGenioAdecom search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
