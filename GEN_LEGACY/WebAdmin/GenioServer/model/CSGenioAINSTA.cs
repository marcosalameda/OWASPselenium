...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codinsta", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codtpequ", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "dtiniage", FieldType.DATETIME);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "dtfimage", FieldType.DATETIME);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "allday", FieldType.LOGIC);
			Qfield.FieldDescription = "Todo o dia";
			Qfield.FieldSize =  1;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "until", FieldType.DATETIME);
        ...
        public static CSGenioAinsta search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
