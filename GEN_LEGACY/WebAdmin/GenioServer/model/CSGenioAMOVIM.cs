...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codmovim", FieldType.KEY_INT);
			...
			Qfield.FieldDescription = "Alterar";
			Qfield.FieldSize =  16;
	...
	"today", true));
        ...
        public static CSGenioAmovim search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
