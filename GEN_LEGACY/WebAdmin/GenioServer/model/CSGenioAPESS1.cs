...
namespace CSGenio.business
{
	...
	public class CSGenioApess1 : DbArea
	{
		...
		public CSGenioApess1(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL GQT CONSTRUTOR PESS1]/
		}

		public CSGenioApess1(User user) : this(user, user.CurrentModule)
		{
		}
...
//Actualiza as seguintes réplicas:
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("cate2", new Relation("GQT", "gqtpessoas", "pess1", "codpesso", "codcateg", "GQT", "gqtcategorias", "cate2", "codcateg", "codcateg"));
			info.ParentTables.Add("cmpny", new Relation("GQT", "gqtpessoas", "pess1", "codpesso", "codempre", "GQT", "gqtcmpny", "cmpny", "codempre", "codempre"));
			info.ParentTables.Add("stake", new Relation("GQT", "gqtpessoas", "pess1", "codpesso", "codparte", "GQT", "gqtstake", "stake", "codparte", "codparte"));
		}
		...
		private static void InicializaFormulas(AreaInfo info)
		{
			...
			argumentsListByArea.Add(new ByAreaArguments(new string[] {"email","email2"},new int[] {0,1},"pess1","codpesso"));
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.AreaDesignation="Comforter";
			info.AreaPluralDesignation="Comforters";
			info.DescriptionCav="COMFORTER42306";
		...
		private static FieldRef m_fldCodpesso = new FieldRef("pess1", "codpesso");
		...
		private static FieldRef m_fldCodempre = new FieldRef("pess1", "codempre");
		...
		private static FieldRef m_fldCodparte = new FieldRef("pess1", "codparte");
		...
		private static FieldRef m_fldName = new FieldRef("pess1", "name");
		...
		private static FieldRef m_fldGender = new FieldRef("pess1", "gender");
		...
		private static FieldRef m_fldDtnascim = new FieldRef("pess1", "dtnascim");
		...
		private static FieldRef m_fldTelephon = new FieldRef("pess1", "telephon");
		...
		private static FieldRef m_fldEmail = new FieldRef("pess1", "email");
		...
		private static FieldRef m_fldEmail2 = new FieldRef("pess1", "email2");
		...
		private static FieldRef m_fldPhotogra = new FieldRef("pess1", "photogra");
		...
		private static FieldRef m_fldDtultcat = new FieldRef("pess1", "dtultcat");
		...
		private static FieldRef m_fldCodcateg = new FieldRef("pess1", "codcateg");
		...
		private static FieldRef m_fldExterna = new FieldRef("pess1", "externa");
		...
		private static FieldRef m_fldInterna = new FieldRef("pess1", "interna");
		...
		private static FieldRef m_fldCodpaise = new FieldRef("pess1", "codpaise");
		...
		private static FieldRef m_fldCodcntry = new FieldRef("pess1", "codcntry");
		...
		private static FieldRef m_fldCodregia = new FieldRef("pess1", "codregia");
		...
		private static FieldRef m_fldNotifind = new FieldRef("pess1", "notifind");
		...
		private static FieldRef m_fldTerrain = new FieldRef("pess1", "terrain");
		...
		private static FieldRef m_fldExtquery = new FieldRef("pess1", "extquery");
		...
		private static FieldRef m_fldMapheigh = new FieldRef("pess1", "mapheigh");
		...
		private static FieldRef m_fldLineclr = new FieldRef("pess1", "lineclr");
		...
		private static FieldRef m_fldPolyclr = new FieldRef("pess1", "polyclr");
		...
		private static FieldRef m_fldGroupmrk = new FieldRef("pess1", "groupmrk");
		...
		private static FieldRef m_fldCanedit = new FieldRef("pess1", "canedit");
		...
		private static FieldRef m_fldCancut = new FieldRef("pess1", "cancut");
		...
		private static FieldRef m_fldCandrag = new FieldRef("pess1", "candrag");
		...
		private static FieldRef m_fldCanrot = new FieldRef("pess1", "canrot");
		...
		private static FieldRef m_fldCanremov = new FieldRef("pess1", "canremov");
		...
		private static FieldRef m_fldDrawmrk = new FieldRef("pess1", "drawmrk");
		...
		private static FieldRef m_fldAllowlin = new FieldRef("pess1", "allowlin");
		...
		private static FieldRef m_fldAllowpol = new FieldRef("pess1", "allowpol");
		...
		private static FieldRef m_fldCanexpor = new FieldRef("pess1", "canexpor");
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioApess1> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioApess1>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioApess1> listing)
        {
			sp.searchListAdvancedWhere<CSGenioApess1>(where, listing);
        }
