...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			Qfield.FieldDescription = "Foto principal";
			Qfield.FieldSize =  3;
			Qfield.MQueue = false;
			Qfield.Decimals = 1;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "bathrms", FieldType.NUMERIC);
			Qfield.FieldDescription = "Numero de Casa de banhos";
			Qfield.FieldSize =  2;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Ano construído";
			Qfield.FieldSize =  50;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Tipo de edifício";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Idade do edifício";
			Qfield.FieldSize =  8;
			Qfield.MQueue = false;
			...
			Qfield.FieldDescription = "Tamanho do terreno";
			Qfield.FieldSize =  15;
			Qfield.MQueue = false;
			Qfield.IntegerDigits = 15;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "floornum", FieldType.NUMERIC);
			Qfield.FieldDescription = "Número do andar";
			Qfield.FieldSize =  3;
			Qfield.MQueue = false;
