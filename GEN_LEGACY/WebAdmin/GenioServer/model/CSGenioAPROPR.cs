...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codpropr", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "endereco", FieldType.MEMO);
        ...
        public static CSGenioApropr search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
