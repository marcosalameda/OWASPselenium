...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codorgaf", FieldType.KEY_INT);
			Qfield.FieldDescription = "Foreign key";
			Qfield.FieldSize =  6;
			Qfield.CavDesignation = "CHAVE_ESTRANGEIRA25502";
        ...
        public static CSGenioAprpin search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
