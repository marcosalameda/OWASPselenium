...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codtblb", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "fkey1", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "textml", FieldType.MEMO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "numint", FieldType.NUMERIC);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "numdec", FieldType.NUMERIC);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "curint", FieldType.CURRENCY);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "curdec", FieldType.CURRENCY);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "bool", FieldType.LOGIC);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "datetm", FieldType.DATETIME);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "datets", FieldType.DATETIMESECONDS);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "timehm", FieldType.TIME_HOURS);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "enumt", FieldType.ARRAY_TEXT);
			Qfield.FieldDescription = "Enumeração (Texto)";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "enumn", FieldType.ARRAY_NUMERIC);
			Qfield.FieldDescription = "Enumeração (Numérico)";
			Qfield.FieldSize =  1;
			Qfield.MQueue = false;
		...
		/// <summary>Field : "Numeric (Integer)" Tipo: "N" Formula:  ""</summary>
		public decimal ValNumint
		{
			get { return (decimal)returnValueField(FldNumint); }
		...
		/// <summary>Field : "Currency (Interger)" Tipo: "$" Formula:  ""</summary>
		public decimal ValCurint
		{
			get { return (decimal)returnValueField(FldCurint); }
        ...
        public static CSGenioAtblb search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
