...
// USE /[MANUAL GQT BUNDLING]/
			...
			bundles.Add(new ScriptBundle("~/Scripts/VerticalMenu").Include(
                "~/Scripts/Layouts/FlatIntranet/jquery.mmenu.min.all.js"));
				
			bundles.Add(new StyleBundle("~/Content/VerticalMenu").Include(
                "~/Content/stylesheets/jquery.mmenu.all.css"));
				
			bundles.Add(new LessBundle("~/Content/css/logOn").Include(
				   "~/Content/stylesheets/logon.less"));
			
			bundles.Add(new StyleBundle("~/Content/SideMenu").Include("~/Content/stylesheets/adminlte.min.css"));
			bundles.Add(new ScriptBundle("~/Scripts/SideMenu").Include("~/Scripts/Layouts/FlatIntranet/sidemenu.js", "~/Scripts/Layouts/FlatIntranet/adminlte.js"));			
