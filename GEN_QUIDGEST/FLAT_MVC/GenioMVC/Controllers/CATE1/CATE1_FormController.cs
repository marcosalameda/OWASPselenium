...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX CATE1]/
		...
		public ActionResult Cate1_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("cate1", Convert.ToString(Navigation.CurrentLevel.GetEntry("cate1"))) : saveMsg);
