...
// USE /[MANUAL GQT INCLUDE_CONTROLLER E2ETS]/

namespace GenioMVC.Controllers
{
    public partial class E2etsController : ControllerBase
    {
        #region NavigationLocation Names controller.cs.vm

// USE /[MANUAL GQT CONTROLLER_NAVIGATION E2ETS]/
        ...
        {
            CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAe2ets>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
            return base.GetActionIds(crs, sp, area);
        }

// USE /[MANUAL GQT MANUAL_CONTROLLER E2ETS]/
