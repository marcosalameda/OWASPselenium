...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX DESPE]/
		...
		public ActionResult Despe_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("expen", Convert.ToString(Navigation.CurrentLevel.GetEntry("expen"))) : saveMsg);
