...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX FAMI1]/
		...
		public ActionResult Fami1_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("fami1", Convert.ToString(Navigation.CurrentLevel.GetEntry("fami1"))) : saveMsg);
