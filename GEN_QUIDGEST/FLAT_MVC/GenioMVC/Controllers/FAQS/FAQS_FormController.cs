...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX FAQS]/
		...
		public ActionResult Faqs_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("faqs", Convert.ToString(Navigation.CurrentLevel.GetEntry("faqs"))) : saveMsg);
