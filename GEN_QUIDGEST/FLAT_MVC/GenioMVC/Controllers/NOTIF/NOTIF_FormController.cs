...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX NOTIF]/
		...
		public ActionResult Notif_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("notif", Convert.ToString(Navigation.CurrentLevel.GetEntry("notif"))) : saveMsg);
