...
// USE /[MANUAL GQT MANUAL_CONTROLLER ROIGF]/
        ...
        public JsonResult GetDependants(string Identifier, string Selected, IDictionary<string, object> Limits)
        {
            ...
            try
            {
				...
				{
					case "ROIGF___ROGL1TITLE___":	// Field (DB)
						values = Roigf_ViewModel.GetDependant_RoigfTableRogl1Title(Selected, navigation);
						break;
					default: break;
				}
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Roigf(Roigf_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "roigf",
                (primaryKey) => Models.Roigf.Find(primaryKey, "FROIGF"),
