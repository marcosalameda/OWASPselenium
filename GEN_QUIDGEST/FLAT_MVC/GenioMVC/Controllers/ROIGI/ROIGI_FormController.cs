...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX ROIGI]/
		...
		public ActionResult Roigi_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("roigi", Convert.ToString(Navigation.CurrentLevel.GetEntry("roigi"))) : saveMsg);
