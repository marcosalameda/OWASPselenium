...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX RORDF]/
		...
		public ActionResult Rordf_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("rordf", Convert.ToString(Navigation.CurrentLevel.GetEntry("rordf"))) : saveMsg);
