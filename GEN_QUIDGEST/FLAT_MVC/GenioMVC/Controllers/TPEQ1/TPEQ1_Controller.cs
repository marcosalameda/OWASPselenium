...
// USE /[MANUAL GQT MANUAL_CONTROLLER TPEQ1]/
        ...
        public JsonResult ReloadDBEdit(string Identifier, IDictionary<string, object> Values)
        {
            ...
            try { row = Models.Tpeq1.Find(navigation.GetStrValue("tpeq1")); }
            catch (Exception)
            {
					...
					case "TPEQ1___FAMI1FAMILY__":	// Field (DB)
                        {
						    ...
						    var model = new Tpeq1_ViewModel(navigation) { editable = false };
        ...
        public JsonResult GetDependants(string Identifier, string Selected, IDictionary<string, object> Limits)
        {
            ...
            try
            {
				...
				{
					case "TPEQ1___FAMI1FAMILY__":	// Field (DB)
						values = Tpeq1_ViewModel.GetDependant_Tpeq1TableFami1Family(Selected, navigation);
						break;
					default: break;
				}
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Tpeq1(Tpeq1_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "tpeq1",
                (primaryKey) => Models.Tpeq1.Find(primaryKey, "FTPEQ1"),
