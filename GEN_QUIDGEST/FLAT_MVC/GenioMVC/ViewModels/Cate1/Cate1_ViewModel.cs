...
namespace GenioMVC.ViewModels.Cate1
{
	public class Cate1_ViewModel : FormViewModel<Models.Cate1>
	{
		...
		/// <summary>Campo : "Abbreviation" Tipo:"C"</summary>
		[Display(Name = "ABBREVIATION31267", ResourceType = typeof(Resources.Resources))]
		[AllowHtml]
		...
		public Cate1_ViewModel() : base("FCATE1") { }

		public Cate1_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FCATE1", currentNavigation, nestedForm) { }

		public Cate1_ViewModel(Models.Cate1 row, NavigationContext currentNavigation, bool nestedForm = false) : base("FCATE1", row, currentNavigation, nestedForm) { }

		public Cate1_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("cate1", id);
			Model = Models.Cate1.Find(id, "FCATE1", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Cate1 model = new Models.Cate1() { Identifier = "FCATE1" };
		...
		public static StatusMessage UpdateConditions(Models.Cate1 model)
		{
			StatusMessage result = new StatusMessage(Status.OK, "");
		...
		public static StatusMessage DeleteConditions(Models.Cate1 model)
		{
			StatusMessage result = new StatusMessage(Status.OK, "");
		...
		public static StatusMessage ViewConditions(Models.Cate1 model)
		{
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Cate1.Find(Navigation.GetStrValue("cate1"), "FCATE1");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Cate1() { Identifier = "FCATE1" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE CATE1]/
		public override void Save()
		{
			...
			try { Model = Models.Cate1.Find(Navigation.GetStrValue("cate1"), "FCATE1"); }
			finally { if (Model == null) Model = new Models.Cate1() { Identifier = "FCATE1" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY CATE1]/
		...
		{
			Model = Models.Cate1.Find(id, "FCATE1");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
