...
namespace GenioMVC.ViewModels.Equip
{
	public class Timequip_ValPrimary_ViewModel : ViewModelBase
	{
		...
		public Timequip_ValPrimary_ViewModel(NavigationContext current_navigation)
		{
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref List<Models.TimelineItem> Qlisting, ref CriteriaSet conditions)
		{
			...
			ListingMVC<CSGenioArepar> listingREPARASO = Models.ModelBase.Where<CSGenioArepar>(false, filterREPARASO, fieldsREPARASO, 0, totalrecords, sortsREPARASO, "IBL_TIMEQUIPPSEUDPRIMARY_", true, false);
