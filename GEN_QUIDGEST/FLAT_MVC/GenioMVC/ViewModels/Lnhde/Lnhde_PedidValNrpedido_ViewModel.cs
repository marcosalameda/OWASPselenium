...
namespace GenioMVC.ViewModels.Lnhde
{
    public class Lnhde_PedidValNrpedido_ViewModel : ListViewModel
    {
        ...
        public Lnhde_PedidValNrpedido_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
// USE /[MANUAL GQT OVERRQLIST LNHDE_NRPEDIDO]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioApedid.GetInformation(), QMVC_POS_RECORD, sorts, lnhde___pedidnrpedidoConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioApedid> listing = Models.ModelBase.Where<CSGenioApedid>(false, lnhde___pedidnrpedidoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHDE___PEDIDNRPEDIDO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
