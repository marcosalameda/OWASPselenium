...
namespace GenioMVC.ViewModels.Pesso
{
    public class Pesso_Regi1ValRegiao_ViewModel : ListViewModel
    {
        ...
        public Pesso_Regi1ValRegiao_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioAregi1.FldCodregia, CSGenioAregi1.FldZzstate, CSGenioAregi1.FldRegiao };
			...
			CriteriaSet pesso___regi1regiao__Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ PESSO_REGI1REGIAO]/

            // This will happen in case there is an error
            if(pesso___regi1regiao__Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAregi1>(false, pesso___regi1regiao__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO___REGI1REGIAO__", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PESSO_REGI1REGIAO]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAregi1.GetInformation(), QMVC_POS_RECORD, sorts, pesso___regi1regiao__Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAregi1> listing = Models.ModelBase.Where<CSGenioAregi1>(false, pesso___regi1regiao__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO___REGI1REGIAO__", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
