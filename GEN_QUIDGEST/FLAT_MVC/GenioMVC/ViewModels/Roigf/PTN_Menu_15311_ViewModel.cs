...
FieldRef[] fields = new FieldRef[] { CSGenioAroigf.FldCodroigf, CSGenioAroigf.FldZzstate, CSGenioAroigf.FldOrder, CSGenioAroigf.FldTitle, CSGenioAroigf.FldCodrogl1, CSGenioArogl1.FldCodrogl1, CSGenioArogl1.FldTitle };
        ...
        public PTN_Menu_15311_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioAroigf.FldCodroigf, CSGenioAroigf.FldZzstate, CSGenioAroigf.FldOrder, CSGenioAroigf.FldTitle, CSGenioAroigf.FldCodrogl1, CSGenioArogl1.FldCodrogl1, CSGenioArogl1.FldTitle };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				CSGenioAroigf model_limit_area = new CSGenioAroigf(UserContext.Current.User);
			...
			CriteriaSet ptn_menu_15311Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;
			
// USE /[MANUAL PTN OVERRQ 15311]/

            // This will happen in case there is an error
            if(ptn_menu_15311Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAroigf>(false, ptn_menu_15311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML15311", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 15311]/

                conditions = ptn_menu_15311Conds;
                return;
			}
...
// USE /[MANUAL PTN OVERRQLIST 15311]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAroigf.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_15311Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAroigf> listing = Models.ModelBase.Where<CSGenioAroigf>(false, ptn_menu_15311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML15311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        {
            var model = new Models.Roigf(true, _fieldsToSerialize);
            if (row == null)
                return model;
