...
FieldRef[] fields = new FieldRef[] { CSGenioArordf.FldCodrordf, CSGenioArordf.FldZzstate, CSGenioArordf.FldOrder, CSGenioArordf.FldTitle };
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioArordf> Qlisting, ref CriteriaSet conditions)
		{
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_411", "dPTN_Menu_411", requestValues, "rordf", allSortOrders);
...
// USE /[MANUAL PTN OVERRQ 411]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioArordf>(false, ptn_menu_411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML411", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 411]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioArordf.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_411Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioArordf> listing = Models.ModelBase.Where<CSGenioArordf>(false, ptn_menu_411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private Models.Rordf MapPTN_Menu_411(CSGenioArordf row)
        {
