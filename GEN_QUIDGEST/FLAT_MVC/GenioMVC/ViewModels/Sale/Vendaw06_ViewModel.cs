...
namespace GenioMVC.ViewModels.Sale
{
	public class Vendaw06_ViewModel : FormViewModel<Models.Sale>
	{
		...
		public Vendaw06_ViewModel() : base("FVENDAW06") { }

		public Vendaw06_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FVENDAW06", currentNavigation, nestedForm) { }

		public Vendaw06_ViewModel(Models.Sale row, NavigationContext currentNavigation, bool nestedForm = false) : base("FVENDAW06", row, currentNavigation, nestedForm) { }

		public Vendaw06_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("sale", id);
			Model = Models.Sale.Find(id, "FVENDAW06", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Sale model = new Models.Sale() { Identifier = "FVENDAW06" };
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Sale.Find(Navigation.GetStrValue("sale"), "FVENDAW06");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Sale() { Identifier = "FVENDAW06" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE VENDAW06]/
		public override void Save()
		{
			...
			try { Model = Models.Sale.Find(Navigation.GetStrValue("sale"), "FVENDAW06"); }
			finally { if (Model == null) Model = new Models.Sale() { Identifier = "FVENDAW06" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY VENDAW06]/
		...
		{
			Model = Models.Sale.Find(id, "FVENDAW06");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
