...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// Application version
        /// </summary>
        public static int Version { get; } = 4235;

        /// <summary>
        /// System id
        /// </summary>
        public static string Program { get; } = "GQT";

        /// <summary>
        /// Application subsystem
        /// </summary>
        public static readonly ClientApplication Application = ClientApplication.GQT;

        /// <summary>
        /// Modules
        /// </summary>
        public static readonly List<string> Modules = ["GQT","PTN","TBS","REG","STY"];
        ...
        /// Login Type
        /// </summary>
        public static LoginTypes LoginType { get; private set; } = LoginTypes.PUREAD;

        /// <summary>
        /// Are fields saved as unicode in the database
        /// </summary>
        public const bool IsDbUnicode = true;

        /// <summary>
        /// Version of the database
        /// </summary>
        public const int VersionDbGen = 4235;

        /// <summary>
        /// Version of the database indexes
        /// </summary>
        public const int VersionIdxDbGen = 1909;
        ...
        /// </summary>
        public const string GenioVersion = "374.05";

        /// <summary>
        /// Solution build version
        /// </summary>
        public const int BuildVersionGen = 2958;
        ...
        public static EmailServer NewEmailServer()
        {
            ...
            email.Codpmail = Guid.NewGuid().ToString();
            return email;
        }
        ...
        {
			// USE /[MANUAL GQT RESOLVEDATASYSTEM]/
            DataSystemXml ds;
            switch (db)
            {
