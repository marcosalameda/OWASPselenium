...
namespace CSGenio.framework
{
	...
	public class User : ICloneable
	{
		...
		//private Dictionary<string,LevelAccess> modulosNivel;//to cada módulo o nível do user
		...
		private string idSessao; //identifier da sessão
		private string Qyear; //Qyear actual
		private List<string> anos; //lista de anos a que este user tem acesso
		private bool publico; //se é publico
		private string moduloActual; //module que está a ser acedido
		private string linguagemActual; //linguagem actual da aplicação
		private string location; // localização do user, utilizado to validação
		private string tokenAux; // token to utilização a recursos externos
		private string code; // code: código recebido por recursos externos
		private bool validated; // validated: parâmetros de recursos externos validados
