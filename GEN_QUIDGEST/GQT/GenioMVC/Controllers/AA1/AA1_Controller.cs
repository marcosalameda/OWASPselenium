...
// USE /[MANUAL GQT INCLUDE_CONTROLLER AA1]/

namespace GenioMVC.Controllers
{
    public partial class Aa1Controller : ControllerBase
    {
        #region NavigationLocation Names controller.cs.vm

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AA1]/
        ...
        {
            CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAaa1>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
            return base.GetActionIds(crs, sp, area);
        }

// USE /[MANUAL GQT MANUAL_CONTROLLER AA1]/
