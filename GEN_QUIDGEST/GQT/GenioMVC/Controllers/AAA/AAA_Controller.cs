...
// USE /[MANUAL GQT INCLUDE_CONTROLLER AAA]/

namespace GenioMVC.Controllers
{
    public partial class AaaController : ControllerBase
    {
        #region NavigationLocation Names controller.cs.vm

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AAA]/
        ...
        {
            CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAaaa>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
            return base.GetActionIds(crs, sp, area);
        }

// USE /[MANUAL GQT MANUAL_CONTROLLER AAA]/
