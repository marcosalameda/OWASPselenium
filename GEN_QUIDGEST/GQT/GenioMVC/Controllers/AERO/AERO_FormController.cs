...
namespace GenioMVC.Controllers
{
	public partial class AeroController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Aero_ModalDBEdit(string partialView)
		{
			Aero_ViewModel model = new Aero_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX AERO]/
		...
		public ActionResult Aero_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("aero", Convert.ToString(Navigation.CurrentLevel.GetEntry("aero"))) : saveMsg);
