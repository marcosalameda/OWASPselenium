...
namespace GenioMVC.Controllers
{
    public partial class AeroController : ControllerBase
    {
		...
		private static readonly NavigationLocation ACTION_PTN_MENU_361 = new NavigationLocation("AIRLINES42267", "PTN_Menu_361", "Aero") { vueRouteName = "menu-PTN_361" };
