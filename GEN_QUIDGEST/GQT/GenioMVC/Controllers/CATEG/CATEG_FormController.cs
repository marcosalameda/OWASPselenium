...
namespace GenioMVC.Controllers
{
	public partial class CategController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Categ_ModalDBEdit(string partialView)
		{
			Categ_ViewModel model = new Categ_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX CATEG]/
		...
		public ActionResult Categ_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("categ", Convert.ToString(Navigation.CurrentLevel.GetEntry("categ"))) : saveMsg);
