...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX TPCAT]/
		...
		public ActionResult Tpcat_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("cattp", Convert.ToString(Navigation.CurrentLevel.GetEntry("cattp"))) : saveMsg);
