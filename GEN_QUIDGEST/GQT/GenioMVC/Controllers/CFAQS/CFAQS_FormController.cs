...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX CFAQS]/
		...
		public ActionResult Cfaqs_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("cfaqs", Convert.ToString(Navigation.CurrentLevel.GetEntry("cfaqs"))) : saveMsg);
