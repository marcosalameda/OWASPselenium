...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX CMPKI]/
		...
		public ActionResult Cmpki_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("cmpki", Convert.ToString(Navigation.CurrentLevel.GetEntry("cmpki"))) : saveMsg);
