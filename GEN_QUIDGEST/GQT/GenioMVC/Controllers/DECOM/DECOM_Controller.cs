...
// USE /[MANUAL GQT MANUAL_CONTROLLER DECOM]/
        ...
        public JsonResult RecalculateFormulas_Abate(Abate_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "decom",
                (primaryKey) => Models.Decom.Find(primaryKey, "FABATE"),
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Abatereq(Abatereq_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "decom",
                (primaryKey) => Models.Decom.Find(primaryKey, "FABATEREQ"),
                (model) => form_data.MapToModel(model as Models.Decom)
            );
        }
