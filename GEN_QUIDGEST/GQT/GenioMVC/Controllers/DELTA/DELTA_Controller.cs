...
// USE /[MANUAL GQT INCLUDE_CONTROLLER DELTA]/

namespace GenioMVC.Controllers
{
    public partial class DeltaController : ControllerBase
    {
        #region NavigationLocation Names controller.cs.vm

// USE /[MANUAL GQT CONTROLLER_NAVIGATION DELTA]/
        ...
        {
            CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAdelta>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
            return base.GetActionIds(crs, sp, area);
        }

// USE /[MANUAL GQT MANUAL_CONTROLLER DELTA]/
