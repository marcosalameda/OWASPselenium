...
namespace GenioMVC.Controllers
{
    ...
    {
        private static readonly NavigationLocation ACTION_PTN_Menu_3L1 = new NavigationLocation("DASHBOARD27032", "PTN_Menu_3L1", "Dashboard");

        // GET: /Dashboard/PTN_Menu_3L1
		[AuthorizeForUsers]
        [ActionName("PTN_Menu_3L1")]
        public ActionResult PTN_Menu_3L1()
        {
            DashboardViewModel vm = new PTN_Menu_3L1_ViewModel(Navigation);
            vm.Load();
            ...
            if (isHomePage) Navigation.SetValue("HomePage", "PTN_Menu_3L1");
            ...
            {
                if (Navigation.CurrentLevel == null || !ACTION_PTN_Menu_3L1.IsSameAction(Navigation.CurrentLevel.Location))
                {
                    if (Navigation.ContainsAction(ACTION_PTN_Menu_3L1))
                        Navigation.RemoveHistoryLevel(ACTION_PTN_Menu_3L1);
                    if (Navigation.CurrentLevel.Location.Action != ACTION_PTN_Menu_3L1.Action)
                    {
                        Navigation.AddHistoryLevel(ACTION_PTN_Menu_3L1, FormMode.Show);
            ...
            {
                CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.MENU01948 + " " + ACTION_PTN_Menu_3L1.ShortDescription());
            ...
            if (isHomePage)
                return PartialView("PTN_Menu_3L1", vm);
        ...
        // GET: "/Dashboard/PTN_Menu_3L1_Widget_COLAB"
		[HttpGet]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public ActionResult PTN_Menu_3L1_Widget_COLAB(string fk)
        {
		...
		[HttpGet]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public ActionResult PTN_Menu_3L1_Widget_EMPLOY()
        {
            // Custom widget based on an empty form
		...
		[HttpGet]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public ActionResult PTN_Menu_3L1_Widget_GRAPH_COUNT()
        {
            // Custom widget based on an empty form
            ...
            return PartialView("Widgets/PTN_Menu_3L1_Widget_GRAPH_COUNT", vm);
        }
		...
		[HttpGet]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public ActionResult PTN_Menu_3L1_RenderMenuWidget(WidgetType type, string widgetId)
        {
            DashboardViewModel vm = new PTN_Menu_3L1_ViewModel(Navigation);
		...
		[HttpGet]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public ActionResult PTN_Menu_3L1_GetWidgetData(WidgetType widgetType, string widgetId)
        {
            DashboardViewModel vm = new PTN_Menu_3L1_ViewModel(Navigation);
