...
// USE /[MANUAL GQT INCLUDE_CONTROLLER EDITS]/

namespace GenioMVC.Controllers
{
    public partial class EditsController : ControllerBase
    {
        #region NavigationLocation Names controller.cs.vm

// USE /[MANUAL GQT CONTROLLER_NAVIGATION EDITS]/
        ...
        {
            CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAedits>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
            return base.GetActionIds(crs, sp, area);
        }

// USE /[MANUAL GQT MANUAL_CONTROLLER EDITS]/
