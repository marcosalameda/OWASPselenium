...
namespace GenioMVC.Controllers
{
	public partial class EvcatController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Evcat_ModalDBEdit(string partialView)
		{
			Evcat_ViewModel model = new Evcat_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX EVCAT]/
		...
		public ActionResult Evcat_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("evcat", Convert.ToString(Navigation.CurrentLevel.GetEntry("evcat"))) : saveMsg);
