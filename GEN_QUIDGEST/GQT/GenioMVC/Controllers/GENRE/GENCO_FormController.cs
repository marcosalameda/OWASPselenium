...
namespace GenioMVC.Controllers
{
	public partial class GenreController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Genco_ModalDBEdit(string partialView)
		{
			Genco_ViewModel model = new Genco_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX GENCO]/
		...
		public ActionResult Genco_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("genre", Convert.ToString(Navigation.CurrentLevel.GetEntry("genre"))) : saveMsg);
