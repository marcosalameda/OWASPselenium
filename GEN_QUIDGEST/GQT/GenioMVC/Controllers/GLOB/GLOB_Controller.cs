...
// USE /[MANUAL GQT MANUAL_CONTROLLER GLOB]/
        ...
        public JsonResult RecalculateFormulas_Glob(Glob_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "glob",
                (primaryKey) => Models.Glob.Find(primaryKey, "FGLOB"),
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Homeg(Homeg_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "glob",
                (primaryKey) => Models.Glob.Find(primaryKey, "FHOMEG"),
                (model) => form_data.MapToModel(model as Models.Glob)
            );
        }
