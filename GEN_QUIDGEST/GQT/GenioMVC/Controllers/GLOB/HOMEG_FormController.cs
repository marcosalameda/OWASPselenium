...
namespace GenioMVC.Controllers
{
	public partial class GlobController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Homeg_ModalDBEdit(string partialView)
		{
			Homeg_ViewModel model = new Homeg_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX HOMEG]/
		...
		public ActionResult Homeg_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("glob", Convert.ToString(Navigation.CurrentLevel.GetEntry("glob"))) : saveMsg);
