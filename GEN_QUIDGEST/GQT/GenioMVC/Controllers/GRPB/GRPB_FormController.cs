...
namespace GenioMVC.Controllers
{
	public partial class GrpbController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Grpb_ModalDBEdit(string partialView)
		{
			Grpb_ViewModel model = new Grpb_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX GRPB]/
		...
		public ActionResult Grpb_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("grpb", Convert.ToString(Navigation.CurrentLevel.GetEntry("grpb"))) : saveMsg);
