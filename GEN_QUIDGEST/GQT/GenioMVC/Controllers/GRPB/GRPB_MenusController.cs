...
namespace GenioMVC.Controllers
{
    public partial class GrpbController : ControllerBase
    {
		...
		private static readonly NavigationLocation ACTION_PTN_MENU_431 = new NavigationLocation("GROUPS__BASIC_25795", "PTN_Menu_431", "Grpb") { vueRouteName = "menu-PTN_431" };
        #endregion
