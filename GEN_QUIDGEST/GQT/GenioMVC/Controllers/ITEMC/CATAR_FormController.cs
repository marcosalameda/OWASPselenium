...
namespace GenioMVC.Controllers
{
	public partial class ItemcController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Catar_ModalDBEdit(string partialView)
		{
			Catar_ViewModel model = new Catar_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX CATAR]/
		...
		public ActionResult Catar_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("itemc", Convert.ToString(Navigation.CurrentLevel.GetEntry("itemc"))) : saveMsg);
