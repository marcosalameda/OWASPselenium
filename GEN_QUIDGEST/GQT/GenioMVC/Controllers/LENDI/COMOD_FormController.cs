...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX COMOD]/
		...
		public ActionResult Comod_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("lendi", Convert.ToString(Navigation.CurrentLevel.GetEntry("lendi"))) : saveMsg);
