...
// USE /[MANUAL GQT MANUAL_CONTROLLER LNHDF]/
        ...
        public JsonResult RecalculateFormulas_Lnhdf(Lnhdf_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "lnhdf",
                (primaryKey) => Models.Lnhdf.Find(primaryKey, "FLNHDF"),
                (model) => form_data.MapToModel(model as Models.Lnhdf)
            );
        }
