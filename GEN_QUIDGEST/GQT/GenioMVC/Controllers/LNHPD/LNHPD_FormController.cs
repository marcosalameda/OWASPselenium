...
namespace GenioMVC.Controllers
{
	public partial class LnhpdController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Lnhpd_ModalDBEdit(string partialView)
		{
			Lnhpd_ViewModel model = new Lnhpd_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX LNHPD]/
		...
		public ActionResult Lnhpd_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("lnhpd", Convert.ToString(Navigation.CurrentLevel.GetEntry("lnhpd"))) : saveMsg);
