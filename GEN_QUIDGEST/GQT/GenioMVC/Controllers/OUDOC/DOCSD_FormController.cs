...
namespace GenioMVC.Controllers
{
	public partial class OudocController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Docsd_ModalDBEdit(string partialView)
		{
			Docsd_ViewModel model = new Docsd_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX DOCSD]/
		...
		public ActionResult Docsd_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("oudoc", Convert.ToString(Navigation.CurrentLevel.GetEntry("oudoc"))) : saveMsg);
