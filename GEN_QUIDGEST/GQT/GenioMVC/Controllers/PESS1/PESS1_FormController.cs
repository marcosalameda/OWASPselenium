...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX PESS1]/
		...
		public ActionResult Pess1_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("pess1", Convert.ToString(Navigation.CurrentLevel.GetEntry("pess1"))) : saveMsg);
