...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX FOTOS]/
		...
		public ActionResult Fotos_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("photo", Convert.ToString(Navigation.CurrentLevel.GetEntry("photo"))) : saveMsg);
