...
namespace GenioMVC.Controllers
{
	public partial class ProjeController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Proje_ModalDBEdit(string partialView)
		{
			Proje_ViewModel model = new Proje_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX PROJE]/
		...
		public ActionResult Proje_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("proje", Convert.ToString(Navigation.CurrentLevel.GetEntry("proje"))) : saveMsg);
