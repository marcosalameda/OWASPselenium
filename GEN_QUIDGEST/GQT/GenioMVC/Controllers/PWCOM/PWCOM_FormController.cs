...
namespace GenioMVC.Controllers
{
	public partial class PwcomController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Pwcom_ModalDBEdit(string partialView)
		{
			Pwcom_ViewModel model = new Pwcom_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX PWCOM]/
		...
		public ActionResult Pwcom_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("pwcom", Convert.ToString(Navigation.CurrentLevel.GetEntry("pwcom"))) : saveMsg);
