...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX PWREG]/
		...
		public ActionResult Pwreg_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("pwreg", Convert.ToString(Navigation.CurrentLevel.GetEntry("pwreg"))) : saveMsg);
