...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX REGIS]/
		...
		public ActionResult Regis_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("regis", Convert.ToString(Navigation.CurrentLevel.GetEntry("regis"))) : saveMsg);
