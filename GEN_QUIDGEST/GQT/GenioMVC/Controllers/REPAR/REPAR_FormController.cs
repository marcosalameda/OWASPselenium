...
namespace GenioMVC.Controllers
{
	public partial class ReparController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Repar_ModalDBEdit(string partialView)
		{
			Repar_ViewModel model = new Repar_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX REPAR]/
		...
		public ActionResult Repar_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("repar", Convert.ToString(Navigation.CurrentLevel.GetEntry("repar"))) : saveMsg);
