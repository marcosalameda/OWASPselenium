...
namespace GenioMVC.Controllers
{
	public partial class Rogl1Controller : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Rogl1_ModalDBEdit(string partialView)
		{
			Rogl1_ViewModel model = new Rogl1_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX ROGL1]/
		...
		public ActionResult Rogl1_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("rogl1", Convert.ToString(Navigation.CurrentLevel.GetEntry("rogl1"))) : saveMsg);
