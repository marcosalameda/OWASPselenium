...
namespace GenioMVC.Controllers
{
	public partial class RoomsController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Salas_ModalDBEdit(string partialView)
		{
			Salas_ViewModel model = new Salas_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX SALAS]/
		...
		public ActionResult Salas_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("rooms", Convert.ToString(Navigation.CurrentLevel.GetEntry("rooms"))) : saveMsg);
