...
// USE /[MANUAL GQT MANUAL_CONTROLLER RORDI]/
        ...
        public JsonResult RecalculateFormulas_Rordi(Rordi_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "rordi",
                (primaryKey) => Models.Rordi.Find(primaryKey, "FRORDI"),
                (model) => form_data.MapToModel(model as Models.Rordi)
            );
        }
