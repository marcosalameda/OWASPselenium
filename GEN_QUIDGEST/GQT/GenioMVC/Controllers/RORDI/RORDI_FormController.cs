...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX RORDI]/
		...
		public ActionResult Rordi_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("rordi", Convert.ToString(Navigation.CurrentLevel.GetEntry("rordi"))) : saveMsg);
