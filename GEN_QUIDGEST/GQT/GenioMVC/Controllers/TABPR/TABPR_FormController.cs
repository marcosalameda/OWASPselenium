...
namespace GenioMVC.Controllers
{
	public partial class TabprController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Tabpr_ModalDBEdit(string partialView)
		{
			Tabpr_ViewModel model = new Tabpr_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX TABPR]/
		...
		public ActionResult Tabpr_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("tabpr", Convert.ToString(Navigation.CurrentLevel.GetEntry("tabpr"))) : saveMsg);
