...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX TPCON]/
		...
		public ActionResult Tpcon_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("tpcon", Convert.ToString(Navigation.CurrentLevel.GetEntry("tpcon"))) : saveMsg);
