...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX TPEQ1]/
		...
		public ActionResult Tpeq1_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("tpeq1", Convert.ToString(Navigation.CurrentLevel.GetEntry("tpeq1"))) : saveMsg);
