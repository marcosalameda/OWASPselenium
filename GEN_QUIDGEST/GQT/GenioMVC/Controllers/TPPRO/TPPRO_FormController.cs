...
namespace GenioMVC.Controllers
{
	public partial class TpproController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Tppro_ModalDBEdit(string partialView)
		{
			Tppro_ViewModel model = new Tppro_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX TPPRO]/
		...
		public ActionResult Tppro_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("tppro", Convert.ToString(Navigation.CurrentLevel.GetEntry("tppro"))) : saveMsg);
