...
namespace GenioMVC.Controllers
{
	public partial class TraduController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Tradu_ModalDBEdit(string partialView)
		{
			Tradu_ViewModel model = new Tradu_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX TRADU]/
		...
		public ActionResult Tradu_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("tradu", Convert.ToString(Navigation.CurrentLevel.GetEntry("tradu"))) : saveMsg);
