...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX VISIT]/
		...
		public ActionResult Visit_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("visit", Convert.ToString(Navigation.CurrentLevel.GetEntry("visit"))) : saveMsg);
