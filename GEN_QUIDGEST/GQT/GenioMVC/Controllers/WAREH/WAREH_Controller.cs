...
// USE /[MANUAL GQT MANUAL_CONTROLLER WAREH]/
        ...
        public JsonResult RecalculateFormulas_Armaz(Armaz_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "wareh",
                (primaryKey) => Models.Wareh.Find(primaryKey, "FARMAZ"),
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Armaz03(Armaz03_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "wareh",
                (primaryKey) => Models.Wareh.Find(primaryKey, "FARMAZ03"),
                (model) => form_data.MapToModel(model as Models.Wareh)
            );
        }
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Armazpop(Armazpop_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "wareh",
                (primaryKey) => Models.Wareh.Find(primaryKey, "FARMAZPOP"),
                (model) => form_data.MapToModel(model as Models.Wareh)
            );
        }
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Authent(Authent_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "wareh",
                (primaryKey) => Models.Wareh.Find(primaryKey, "FAUTHENT"),
                (model) => form_data.MapToModel(model as Models.Wareh)
            );
        }
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Btnsform(Btnsform_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "wareh",
                (primaryKey) => Models.Wareh.Find(primaryKey, "FBTNSFORM"),
                (model) => form_data.MapToModel(model as Models.Wareh)
            );
        }
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Extforms(Extforms_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "wareh",
                (primaryKey) => Models.Wareh.Find(primaryKey, "FEXTFORMS"),
                (model) => form_data.MapToModel(model as Models.Wareh)
            );
        }
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Mltform(Mltform_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "wareh",
                (primaryKey) => Models.Wareh.Find(primaryKey, "FMLTFORM"),
                (model) => form_data.MapToModel(model as Models.Wareh)
            );
        }
		...
		[AuthorizeForUsers]
        [ActionSessionState(System.Web.SessionState.SessionStateBehavior.ReadOnly)]
        public JsonResult RecalculateFormulas_Tmline(Tmline_ViewModel form_data)
        {
            return GenericRecalculateFormulas(form_data, "wareh",
                (primaryKey) => Models.Wareh.Find(primaryKey, "FTMLINE"),
                (model) => form_data.MapToModel(model as Models.Wareh)
            );
        }
