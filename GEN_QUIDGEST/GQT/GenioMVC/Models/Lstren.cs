...
namespace GenioMVC.Models
{
	public class Lstren : ModelBase
	{
		...
		[NumericAttribute(0)]
		public decimal? ValPosicao { get { return Convert.ToDecimal(GlobalFunctions.RoundQG(klass.ValPosicao, 0)); } set { klass.ValPosicao = Convert.ToDouble(value); } }

		[DisplayName("Operação")]
		/// <summary>Field : "Operação" Tipo: "N" Formula:  ""</summary>
		[NumericAttribute(0)]
		public decimal? ValOperacao { get { return Convert.ToDecimal(GlobalFunctions.RoundQG(klass.ValOperacao, 0)); } set { klass.ValOperacao = Convert.ToDouble(value); } }

		[DisplayName("Tipo")]
		/// <summary>Field : "Tipo" Tipo: "N" Formula:  ""</summary>
		[NumericAttribute(0)]
		public decimal? ValTipo { get { return Convert.ToDecimal(GlobalFunctions.RoundQG(klass.ValTipo, 0)); } set { klass.ValTipo = Convert.ToDouble(value); } }
