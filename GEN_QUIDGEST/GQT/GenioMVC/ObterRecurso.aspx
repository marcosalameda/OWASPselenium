...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (assinar == "1")
        {
            System.IO.File.WriteAllBytes(System.IO.Path.GetTempPath() + rec.Name, conteudo);
            System.IO.File.Delete(AppDomain.CurrentDomain.BaseDirectory + "/temp/"+rec.Name);
        }
        else
        {
            ...
            else
            {
                ...
                string disHeader = "Attachment; Filename=\"" + HttpUtility.UrlEncode(rec.Name) + "\"";
