...
FieldRef[] fields = new FieldRef[] { CSGenioAcfaqs.FldCodcfaqs, CSGenioAcfaqs.FldZzstate, CSGenioAcfaqs.FldIcon, CSGenioAcfaqs.FldCategory, CSGenioAcfaqs.FldDescript };
        ...
        public GQT_Menu_B1_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioAcfaqs.FldCodcfaqs, CSGenioAcfaqs.FldZzstate, CSGenioAcfaqs.FldIcon, CSGenioAcfaqs.FldCategory, CSGenioAcfaqs.FldDescript };
			...
			CriteriaSet gqt_menu_b1Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ B1]/

            // This will happen in case there is an error
            if(gqt_menu_b1Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAcfaqs>(false, gqt_menu_b1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLB1", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP B1]/

                conditions = gqt_menu_b1Conds;
                return;
			}
...
// USE /[MANUAL GQT OVERRQLIST B1]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAcfaqs.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_b1Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAcfaqs> listing = Models.ModelBase.Where<CSGenioAcfaqs>(false, gqt_menu_b1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLB1", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
