...
namespace GenioMVC.ViewModels.Dashboard
{
	public abstract class WidgetProvider : WidgetProperties
	{
		...
		public List<Widget> Widgets
		{
			get
			{
				return m_instances.Where(i => i.UserHasAccess()).ToList();
			}
		}
	...
	{
		public delegate ListingMVC<A> GetRowsDelegate<A>(CriteriaSet args = null) where A : T;
		...
		public override void LoadInstances()
		{
	...
	public class BookmarkWidgetProvider : WidgetProvider
	{
		...
		public override void LoadInstances()
		{
			...
			var ckey = string.Format(
				"bookmarks.{0}.{1}",
				UserContext.Current.User.Name,
				UserContext.Current.User.Codpsw
			);
