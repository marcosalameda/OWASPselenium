...
{
    public class GQT_Menu_2C111_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "e6356714-1875-490b-820c-71ac269df34f"; }
...
FieldRef[] fields = new FieldRef[] { CSGenioAdecom.FldCoddeco, CSGenioAdecom.FldZzstate, CSGenioAdecom.FldDecomnr, CSGenioAdecom.FldDtdeco, CSGenioAdecom.FldNote };
        ...
        public GQT_Menu_2C111_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["GQT_Menu_2C111_tableFilters"] ?? "false"), false);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAdecom> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "GQT_Menu_2C111", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "GQT_Menu_2C111"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "GQT_Menu_2C111");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pGQT_Menu_2C111"])) ? int.Parse(requestValues["pGQT_Menu_2C111"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sGQT_Menu_2C111", "dGQT_Menu_2C111", requestValues, "decom", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAdecom.FldCoddeco, CSGenioAdecom.FldZzstate, CSGenioAdecom.FldDecomnr, CSGenioAdecom.FldDtdeco, CSGenioAdecom.FldNote };
			...
			CriteriaSet gqt_menu_2c111Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ 2C111]/

            // This will happen in case there is an error
            if(gqt_menu_2c111Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAdecom>(false, gqt_menu_2c111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2C111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 2C111]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAdecom.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_2c111Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAdecom> listing = Models.ModelBase.Where<CSGenioAdecom>(false, gqt_menu_2c111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2C111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Decom> MapGQT_Menu_2C111(ListingMVC<CSGenioAdecom> Qlisting)
        {
        ...
        private Models.Decom MapGQT_Menu_2C111(CSGenioAdecom row)
        {
