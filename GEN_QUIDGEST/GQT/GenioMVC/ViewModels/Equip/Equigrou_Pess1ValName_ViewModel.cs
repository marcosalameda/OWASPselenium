...
{
    public class Equigrou_Pess1ValName_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "Equigrou_Pess1ValName"; }
        ...
        public Equigrou_Pess1ValName_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["Equigrou_Pess1ValName_tableFilters"] ?? "false"), false);
			...
			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "Equigrou_Pess1ValName_"));
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApess1> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Equigrou_Pess1ValName", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Equigrou_Pess1ValName"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Equigrou_Pess1ValName");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pEquigrou_Pess1ValName"])) ? int.Parse(requestValues["pEquigrou_Pess1ValName"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sEquigrou_Pess1ValName", "dEquigrou_Pess1ValName", requestValues, "pess1", allSortOrders);
...
// USE /[MANUAL GQT OVERRQLIST EQUIGROU_NAME]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioApess1.GetInformation(), QMVC_POS_RECORD, sorts, equigroupess1name____Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioApess1> listing = Models.ModelBase.Where<CSGenioApess1>(false, equigroupess1name____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIGROUPESS1NAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private Models.Pess1 MapEquigrou_Pess1ValName(CSGenioApess1 row)
        {
