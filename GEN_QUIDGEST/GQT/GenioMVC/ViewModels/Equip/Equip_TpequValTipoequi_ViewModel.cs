...
{
    public class Equip_TpequValTipoequi_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "Equip_TpequValTipoequi"; }
...
// USE /[MANUAL GQT LIST_LIMITS EQUIP_TPEQUTIPOEQUI]/
        ...
        public Equip_TpequValTipoequi_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["Equip_TpequValTipoequi_tableFilters"] ?? "false"), false);
			...
			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "Equip_TpequValTipoequi_"));
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtpequ> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Equip_TpequValTipoequi", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Equip_TpequValTipoequi"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Equip_TpequValTipoequi");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pEquip_TpequValTipoequi"])) ? int.Parse(requestValues["pEquip_TpequValTipoequi"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sEquip_TpequValTipoequi", "dEquip_TpequValTipoequi", requestValues, "tpequ", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAtpequ.FldCodtpequ, CSGenioAtpequ.FldZzstate, CSGenioAtpequ.FldTpequcod, CSGenioAtpequ.FldTipoequi, CSGenioAtpequ.FldTpequpai, CSGenioAtpequ.FldNivel, CSGenioAtpequ.FldBackcolo, CSGenioAtpequ.FldCorletra };
			...
			CriteriaSet equip___tpequtipoequiConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ EQUIP_TPEQUTIPOEQUI]/

            // This will happen in case there is an error
            if(equip___tpequtipoequiConds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAtpequ>(false, equip___tpequtipoequiConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___TPEQUTIPOEQUI", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP EQUIP_TPEQUTIPOEQUI]/

                conditions = equip___tpequtipoequiConds;
                return;
			}
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_TPEQUTIPOEQUI]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAtpequ.GetInformation(), QMVC_POS_RECORD, sorts, equip___tpequtipoequiConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAtpequ> listing = Models.ModelBase.Where<CSGenioAtpequ>(false, equip___tpequtipoequiConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___TPEQUTIPOEQUI", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Tpequ> MapEquip_TpequValTipoequi(ListingMVC<CSGenioAtpequ> Qlisting)
        {
        ...
        private Models.Tpequ MapEquip_TpequValTipoequi(CSGenioAtpequ row)
        {
