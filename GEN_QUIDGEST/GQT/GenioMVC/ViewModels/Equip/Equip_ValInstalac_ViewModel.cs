...
// USE /[MANUAL GQT LIST_LIMITS EQUIP_PSEUDINSTALAC]/
        ...
        public Equip_ValInstalac_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
            ...
            SpecialRenderings = new List<SpecialRendering>()
            {
                ...
                new SpecialRendering
                {
                    ...
                    StyleVariables = new List<SpecialRenderingVariable>()
                    {
                        ...
                        new SpecialRenderingVariable { Variable = "allow-center-control", Value = "true" },
