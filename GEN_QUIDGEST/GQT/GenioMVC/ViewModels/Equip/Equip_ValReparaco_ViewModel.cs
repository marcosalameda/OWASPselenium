...
{
    public class Equip_ValReparaco_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "Equip_ValReparaco"; }
...
// USE /[MANUAL GQT LIST_LIMITS EQUIP_PSEUDREPARACO]/
        ...
        public Equip_ValReparaco_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			CriteriaSet subfilters = CriteriaSet.And();
			{
				...
				if (requestValues["filter_ValReparaco_STARTED"] != null)
					filter_ValReparaco_STARTED_1 = requestValues["filter_ValReparaco_STARTED"].Contains("1");
				Navigation.SetValue("filter_ValReparaco_STARTED_1", filter_ValReparaco_STARTED_1);
				...
				if (requestValues["filter_ValReparaco_STARTED"] != null)
					filter_ValReparaco_STARTED_2 = requestValues["filter_ValReparaco_STARTED"].Contains("2");
				Navigation.SetValue("filter_ValReparaco_STARTED_2", filter_ValReparaco_STARTED_2);
				...
				if (requestValues["filter_ValReparaco_STARTED"] != null)
					filter_ValReparaco_STARTED_3 = requestValues["filter_ValReparaco_STARTED"].Contains("3");
				Navigation.SetValue("filter_ValReparaco_STARTED_3", filter_ValReparaco_STARTED_3);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioArepar> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Equip_ValReparaco", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Equip_ValReparaco"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Equip_ValReparaco");
...
FieldRef[] fields = new FieldRef[] { CSGenioArepar.FldCodrepar, CSGenioArepar.FldZzstate, CSGenioArepar.FldNrrepara, CSGenioArepar.FldDtrepara, CSGenioArepar.FldCodcateg, CSGenioAcate1.FldCodcateg, CSGenioAcate1.FldCategoria, CSGenioArepar.FldCodpesso, CSGenioApesso.FldCodpesso, CSGenioApesso.FldName, CSGenioArepar.FldDescript, CSGenioArepar.FldHours, CSGenioArepar.FldTipoarea };
			...
			CriteriaSet equip___pseudreparacoConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ EQUIP_PSEUDREPARACO]/

            // This will happen in case there is an error
            if(equip___pseudreparacoConds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioArepar>(false, equip___pseudreparacoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDREPARACO", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PSEUDREPARACO]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioArepar.GetInformation(), QMVC_POS_RECORD, sorts, equip___pseudreparacoConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioArepar> listing = Models.ModelBase.Where<CSGenioArepar>(false, equip___pseudreparacoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDREPARACO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private Models.Repar MapEquip_ValReparaco(CSGenioArepar row)
        {
