...
namespace GenioMVC.ViewModels.Flds
{
	public class Fldstbl_ViewModel : FormViewModel<Models.Flds>
	{
		...
		/// <summary>Campo : "Nome da companhia aérea" Tipo:"C"</summary>
		[Display(Name = "NOME_DA_COMPANHIA_AE36383", ResourceType = typeof(Resources.Resources))]
		...
		/// <summary>Campo : "Field feedback" Tipo:"DP"</summary>
		[Display(Name = "FIELD_FEEDBACK53085", ResourceType = typeof(Resources.Resources))]
		public TablePartial<GenioMVC.Models.Feeca> ValFeeca { get; set; }
		...
		public Fldstbl_ViewModel() : base("FFLDSTBL") { }

		public Fldstbl_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FFLDSTBL", currentNavigation, nestedForm) { }

		public Fldstbl_ViewModel(Models.Flds row, NavigationContext currentNavigation, bool nestedForm = false) : base("FFLDSTBL", row, currentNavigation, nestedForm) { }

		public Fldstbl_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("flds", id);
			Model = Models.Flds.Find(id, "FFLDSTBL", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Flds model = new Models.Flds() { Identifier = "FFLDSTBL" };
		...
		public override void MapToModel(Models.Flds m)
		{
			...
			{
				CSGenio.framework.Log.Error("Map ViewModel (Fldstbl) to Model (Flds) - Error during mapping");
				throw;
			}
		}
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Flds.Find(Navigation.GetStrValue("flds"), "FFLDSTBL");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Flds() { Identifier = "FFLDSTBL" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE FLDSTBL]/
		public override void Save()
		{
			...
			try { Model = Models.Flds.Find(Navigation.GetStrValue("flds"), "FFLDSTBL"); }
			finally { if (Model == null) Model = new Models.Flds() { Identifier = "FFLDSTBL" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY FLDSTBL]/
		...
		{
			Model = Models.Flds.Find(id, "FFLDSTBL");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
        ...
        public void Load_Fldstbl_aero_name____(NameValueCollection qs, bool lazyLoad = false)
        {
            ...
            CriteriaSet fldstbl_aero_name____Conds = CriteriaSet.And();
            {
                ...
                {
                    fldstbl_aero_name____Conds.Equal(CSGenioAaero.FldCodaero, Navigation.GetValue("aero"));
...
// USE /[MANUAL GQT OVERRQ FLDSTBL_AERONAME]/
                ...
                */
                ...
                //EPH
                //fldstbl_aero_name____Conds = Aero.AddEPH<CSGenioAaero>(ref UserContext.Current.User, fldstbl_aero_name____Conds, "LED_FLDSTBL_AERO_NAME____");

                FieldRef firstVisibleColumn = new FieldRef("aero", "name");
                ListingMVC<CSGenioAaero> listing = Models.ModelBase.Where<CSGenioAaero>(false, fldstbl_aero_name____Conds, fields, offset, numberItems, sorts, "LED_FLDSTBL_AERO_NAME____", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableAeroName.Elements = listing.RowsForViewModel<GenioMVC.Models.Aero>((r) => new GenioMVC.Models.Aero(r, true, _fieldsToSerialize_FLDSTBL_AERO_NAME____));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_FldstblTableAeroName(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_FldstblTableAeroName(this.ValCodaero, Navigation);
            try
            {
