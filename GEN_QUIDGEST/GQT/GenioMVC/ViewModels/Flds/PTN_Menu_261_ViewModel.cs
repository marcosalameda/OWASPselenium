...
{
    public class PTN_Menu_261_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "20270ef5-e5dc-49dd-bba1-1996bfceff09"; }
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 261]/
...
FieldRef[] fields = new FieldRef[] { CSGenioAflds.FldCodflds, CSGenioAflds.FldZzstate, CSGenioAflds.FldCodaero, CSGenioAaero.FldCodaero, CSGenioAaero.FldName, CSGenioAflds.FldDescrip, CSGenioAflds.FldNpassage, CSGenioAflds.FldDuration, CSGenioAflds.FldPrice, CSGenioAflds.FldPrecobil, CSGenioAflds.FldDate, CSGenioAflds.FldDatetime, CSGenioAflds.FldDateseco, CSGenioAflds.FldTime, CSGenioAflds.FldYear, CSGenioAflds.FldPrimviag, CSGenioAflds.FldConditio, CSGenioAflds.FldClass, CSGenioAflds.FldClassnum, CSGenioAflds.FldLogicenu, CSGenioAflds.FldLogo, CSGenioAflds.FldAttach, CSGenioAflds.FldLogoexte, CSGenioAflds.FldCreatuse, CSGenioAflds.FldCreatdat, CSGenioAflds.FldCreathou, CSGenioAflds.FldCreatins, CSGenioAflds.FldCodequip, CSGenioAequip.FldCodequip, CSGenioAequip.FldRegistnr, CSGenioAflds.FldTxtfield, CSGenioAflds.FldEmailfld, CSGenioAflds.FldZipfield, CSGenioAflds.FldIbanfiel, CSGenioAflds.FldSsnumber, CSGenioAflds.FldLicplate, CSGenioAflds.FldVatnumbr, CSGenioAflds.FldBanknmbr, CSGenioAflds.FldNrcntry, CSGenioAflds.FldUpprtext, CSGenioAflds.FldPassfld, CSGenioAflds.FldClrpicke, CSGenioAflds.FldShwrc, CSGenioAflds.FldRadiob };
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PTN_Menu_261_ViewModel" /> class.
        /// </summary>
        /// <param name="currentNavigation">The current navigation</param>
        public PTN_Menu_261_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["PTN_Menu_261_tableFilters"] ?? "false"), false);


			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "PTN_Menu_261_"));
			...
			{
				// EPH
				crs = Models.Flds.AddEPH<CSGenioAflds>(ref u, crs, "ML261");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Flds.AddEPH<CSGenioAflds>(ref u, null, "ML261"));
			}
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAflds> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "PTN_Menu_261", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "PTN_Menu_261"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "PTN_Menu_261");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pPTN_Menu_261"])) ? int.Parse(requestValues["pPTN_Menu_261"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_261", "dPTN_Menu_261", requestValues, "flds", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAflds.FldCodflds, CSGenioAflds.FldZzstate, CSGenioAflds.FldCodaero, CSGenioAaero.FldCodaero, CSGenioAaero.FldName, CSGenioAflds.FldDescrip, CSGenioAflds.FldNpassage, CSGenioAflds.FldDuration, CSGenioAflds.FldPrice, CSGenioAflds.FldPrecobil, CSGenioAflds.FldDate, CSGenioAflds.FldDatetime, CSGenioAflds.FldDateseco, CSGenioAflds.FldTime, CSGenioAflds.FldYear, CSGenioAflds.FldPrimviag, CSGenioAflds.FldConditio, CSGenioAflds.FldClass, CSGenioAflds.FldClassnum, CSGenioAflds.FldLogicenu, CSGenioAflds.FldLogo, CSGenioAflds.FldAttach, CSGenioAflds.FldAttachfk, CSGenioAflds.FldLogoexte, CSGenioAflds.FldCreatuse, CSGenioAflds.FldCreatdat, CSGenioAflds.FldCreathou, CSGenioAflds.FldCreatins, CSGenioAflds.FldCodequip, CSGenioAequip.FldCodequip, CSGenioAequip.FldRegistnr, CSGenioAflds.FldTxtfield, CSGenioAflds.FldEmailfld, CSGenioAflds.FldZipfield, CSGenioAflds.FldIbanfiel, CSGenioAflds.FldSsnumber, CSGenioAflds.FldLicplate, CSGenioAflds.FldVatnumbr, CSGenioAflds.FldBanknmbr, CSGenioAflds.FldNrcntry, CSGenioAflds.FldUpprtext, CSGenioAflds.FldPassfld, CSGenioAflds.FldClrpicke, CSGenioAflds.FldShwrc, CSGenioAflds.FldRadiob };
			...
			CriteriaSet ptn_menu_261Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PTN OVERRQ 261]/

            // This will happen in case there is an error
            if(ptn_menu_261Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAflds>(false, ptn_menu_261Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML261", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 261]/

                conditions = ptn_menu_261Conds;
                return;
			}
...
// USE /[MANUAL PTN OVERRQLIST 261]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAflds.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_261Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAflds> listing = Models.ModelBase.Where<CSGenioAflds>(false, ptn_menu_261Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML261", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				Menu.Elements = MapPTN_Menu_261(listing);
        ...
        private List<Models.Flds> MapPTN_Menu_261(ListingMVC<CSGenioAflds> Qlisting)
        {
            ...
            if (Qlisting.Rows != null)
            {
                foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPTN_Menu_261(row));
					i++;
				}
            }
        ...
        private Models.Flds MapPTN_Menu_261(CSGenioAflds row)
        {
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_261]/
        ...
        private static readonly List<TableSearchColumn> _searchableColumns = new List<TableSearchColumn>
        {
            ...
            new TableSearchColumn("ValNrcntry", CSGenioAflds.FldNrcntry, typeof(decimal?)),
