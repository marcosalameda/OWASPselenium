...
namespace GenioMVC.ViewModels.Glob
{
	public class Glob_ViewModel : FormViewModel<Models.Glob>
	{
		...
		[Display(Name = "EXTERNAL_API_ADDRESS59205", ResourceType = typeof(Resources.Resources))]
		[AllowHtml]
		[StringLength(350, ErrorMessageResourceName = "O_COMPRIMENTO_MAXIMO21747", ErrorMessageResourceType = typeof(Resources.Resources))]
		public string ValApiurl { get; set; }

		/// <summary>Campo : "Legend" Tipo:"IJ"</summary>
		[Display(Name = "LEGEND16814", ResourceType = typeof(Resources.Resources))]
		[UIHint("DBJpegImage")]
		[Newtonsoft.Json.JsonConverter(typeof(Helpers.ResizeImageSerializer), 480, 100, false, true)]
		public byte[] ValLegend { get; set; }
		...
		public Glob_ViewModel() : base("FGLOB") { }

		public Glob_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FGLOB", currentNavigation, nestedForm) { }

		public Glob_ViewModel(Models.Glob row, NavigationContext currentNavigation, bool nestedForm = false) : base("FGLOB", row, currentNavigation, nestedForm) { }

		public Glob_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("glob", id);
			Model = Models.Glob.Find(id, "FGLOB", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Glob model = new Models.Glob() { Identifier = "FGLOB" };
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Glob.Find(Navigation.GetStrValue("glob"), "FGLOB");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Glob() { Identifier = "FGLOB" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE GLOB]/
		public override void Save()
		{
			...
			try { Model = Models.Glob.Find(Navigation.GetStrValue("glob"), "FGLOB"); }
			finally { if (Model == null) Model = new Models.Glob() { Identifier = "FGLOB" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY GLOB]/
		...
		{
			Model = Models.Glob.Find(id, "FGLOB");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
