...
{
	public class Artigext_ViewModel : FormViewModel<Models.Item>
	{
		...
		public Artigext_ViewModel() : base("FARTIGEXT") { }

		public Artigext_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FARTIGEXT", currentNavigation, nestedForm) { }

		public Artigext_ViewModel(Models.Item row, NavigationContext currentNavigation, bool nestedForm = false) : base("FARTIGEXT", row, currentNavigation, nestedForm) { }

		public Artigext_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("item", id);
			Model = Models.Item.Find(id, "FARTIGEXT", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Item model = new Models.Item() { Identifier = "FARTIGEXT" };
		...
		public override void MapToModel(Models.Item m)
		{
			...
			{
				CSGenio.framework.Log.Error("Map ViewModel (Artigext) to Model (Item) - Error during mapping");
				throw;
			}
		}
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Item.Find(Navigation.GetStrValue("item"), "FARTIGEXT");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Item() { Identifier = "FARTIGEXT" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE ARTIGEXT]/
		public override void Save()
		{
			...
			try { Model = Models.Item.Find(Navigation.GetStrValue("item"), "FARTIGEXT"); }
			finally { if (Model == null) Model = new Models.Item() { Identifier = "FARTIGEXT" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY ARTIGEXT]/
		...
		{
			Model = Models.Item.Find(id, "FARTIGEXT");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
        ...
        public void Load_Artigextwarehwarehdes(NameValueCollection qs, bool lazyLoad = false)
        {
            ...
            CriteriaSet artigextwarehwarehdesConds = CriteriaSet.And();
            {
                ...
                {
                    artigextwarehwarehdesConds.Equal(CSGenioAwareh.FldCodwareh, Navigation.GetValue("wareh"));
...
// USE /[MANUAL GQT OVERRQ ARTIGEXT_WAREHWAREHDES]/
                ...
                */
                ...
                //EPH
                //artigextwarehwarehdesConds = Wareh.AddEPH<CSGenioAwareh>(ref UserContext.Current.User, artigextwarehwarehdesConds, "LED_ARTIGEXTWAREHWAREHDES");

                FieldRef firstVisibleColumn = new FieldRef("wareh", "warehdes");
                ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(false, artigextwarehwarehdesConds, fields, offset, numberItems, sorts, "LED_ARTIGEXTWAREHWAREHDES", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableWarehWarehdes.Elements = listing.RowsForViewModel<GenioMVC.Models.Wareh>((r) => new GenioMVC.Models.Wareh(r, true, _fieldsToSerialize_ARTIGEXTWAREHWAREHDES));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_ArtigextTableWarehWarehdes(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_ArtigextTableWarehWarehdes(this.ValCodwareh, Navigation);
            try
            {
        ...
        public void Load_Artigextgitemitemdes_(NameValueCollection qs, bool lazyLoad = false)
        {
            ...
            CriteriaSet artigextgitemitemdes_Conds = CriteriaSet.And();
            {
                ...
                if (hValue != null && !(hValue is Array) && !String.IsNullOrEmpty(Convert.ToString(hValue)))
                {
                    artigextgitemitemdes_Conds.Equal(CSGenioAgitem.FldCodgitem, Navigation.GetValue("gitem"));
...
// USE /[MANUAL GQT OVERRQ ARTIGEXT_GITEMITEMDES]/
                ...
                */
                ...
                //EPH
                //artigextgitemitemdes_Conds = Gitem.AddEPH<CSGenioAgitem>(ref UserContext.Current.User, artigextgitemitemdes_Conds, "LED_ARTIGEXTGITEMITEMDES_");

                FieldRef firstVisibleColumn = new FieldRef("gitem", "itemdes");
                ListingMVC<CSGenioAgitem> listing = Models.ModelBase.Where<CSGenioAgitem>(false, artigextgitemitemdes_Conds, fields, offset, numberItems, sorts, "LED_ARTIGEXTGITEMITEMDES_", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableGitemItemdes.Elements = listing.RowsForViewModel<GenioMVC.Models.Gitem>((r) => new GenioMVC.Models.Gitem(r, true, _fieldsToSerialize_ARTIGEXTGITEMITEMDES_));
        ...
        /// <param name="Navigation">Navigation context</param>
        public static ConcurrentDictionary<string, object> GetDependant_ArtigextTableGitemItemdes(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_ArtigextTableGitemItemdes(this.ValCodgitem, Navigation);
            try
            {
                // That code doesn't include fields of the own control and can be empty if no one dependant field present on the form.
                {
