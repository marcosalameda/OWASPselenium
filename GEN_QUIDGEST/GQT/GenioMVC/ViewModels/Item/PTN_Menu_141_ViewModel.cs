...
FieldRef[] fields = new FieldRef[] { CSGenioAitem.FldCoditem, CSGenioAitem.FldZzstate, CSGenioAitem.FldImage, CSGenioAitem.FldDate, CSGenioAitem.FldDisponib, CSGenioAitem.FldValid };
        ...
        public PTN_Menu_141_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioAitem.FldCoditem, CSGenioAitem.FldZzstate, CSGenioAitem.FldImage, CSGenioAitem.FldDate, CSGenioAitem.FldDisponib, CSGenioAitem.FldValid };
			...
			CriteriaSet ptn_menu_141Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;
			
// USE /[MANUAL PTN OVERRQ 141]/

            // This will happen in case there is an error
            if(ptn_menu_141Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAitem>(false, ptn_menu_141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML141", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 141]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAitem.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_141Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAitem> listing = Models.ModelBase.Where<CSGenioAitem>(false, ptn_menu_141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML141", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
