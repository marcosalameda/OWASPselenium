...
// USE /[MANUAL PTN OVERRQ 221]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAitem>(false, ptn_menu_221Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML221", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 221]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAitem.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_221Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAitem> listing = Models.ModelBase.Where<CSGenioAitem>(false, ptn_menu_221Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML221", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
