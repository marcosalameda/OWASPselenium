...
{
    public class GQT_Menu_1311_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "7c5b168c-36e1-428a-b409-4b372e706c23"; }
        ...
        public int GetCount(User user)
        {
            ...
            //SH Limit simulation
            //conditions.Equal(CSGenioAlendi.FldCodpess1, Navigation.GetValue("pess1"));
...
FieldRef[] fields = new FieldRef[] { CSGenioAlendi.FldCodlendi, CSGenioAlendi.FldZzstate, CSGenioAlendi.FldCodpess1, CSGenioApess1.FldCodpesso, CSGenioApess1.FldName, CSGenioAlendi.FldCodequip, CSGenioAequip.FldCodequip, CSGenioAequip.FldRegistnr, CSGenioAlendi.FldCodpess2, CSGenioApess2.FldCodpesso, CSGenioApess2.FldName, CSGenioAlendi.FldLendinnr, CSGenioAlendi.FldStart, CSGenioAequip.FldFrequenc, CSGenioAlendi.FldWarndt, CSGenioAlendi.FldEnd, CSGenioAlendi.FldObservat, CSGenioAlendi.FldReturndt, CSGenioAlendi.FldReturned, CSGenioAlendi.FldDayslimi };
        ...
        public GQT_Menu_1311_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["GQT_Menu_1311_tableFilters"] ?? "false"), true);
			...
			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "GQT_Menu_1311_"));
			...
			CriteriaSet subfilters = CriteriaSet.And();
			{
				...
				bool filter_GQT_Menu_1311_DEVOLUCAO_0 = false;
				if (requestValues["filter_GQT_Menu_1311_DEVOLUCAO"] != null)
					filter_GQT_Menu_1311_DEVOLUCAO_0 = requestValues["filter_GQT_Menu_1311_DEVOLUCAO"].Contains("0");
				else if (requestValues["filter_GQT_Menu_1311_DEVOLUCAO"] == null)
					filter_GQT_Menu_1311_DEVOLUCAO_0 = true;
				Navigation.SetValue("filter_GQT_Menu_1311_DEVOLUCAO_0", filter_GQT_Menu_1311_DEVOLUCAO_0);
				if (filter_GQT_Menu_1311_DEVOLUCAO_0)
				{
				...
				if (requestValues["filter_GQT_Menu_1311_DEVOLUCAO"] != null)
					filter_GQT_Menu_1311_DEVOLUCAO_1 = requestValues["filter_GQT_Menu_1311_DEVOLUCAO"].Contains("1");
				Navigation.SetValue("filter_GQT_Menu_1311_DEVOLUCAO_1", filter_GQT_Menu_1311_DEVOLUCAO_1);
				...
				if (requestValues["filter_GQT_Menu_1311_DEVOLUCAO"] != null)
					filter_GQT_Menu_1311_DEVOLUCAO_2 = requestValues["filter_GQT_Menu_1311_DEVOLUCAO"].Contains("2");
				Navigation.SetValue("filter_GQT_Menu_1311_DEVOLUCAO_2", filter_GQT_Menu_1311_DEVOLUCAO_2);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAlendi> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "GQT_Menu_1311", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "GQT_Menu_1311"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "GQT_Menu_1311");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pGQT_Menu_1311"])) ? int.Parse(requestValues["pGQT_Menu_1311"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sGQT_Menu_1311", "dGQT_Menu_1311", requestValues, "lendi", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlendi.FldCodlendi, CSGenioAlendi.FldZzstate, CSGenioAlendi.FldCodpess1, CSGenioApess1.FldCodpesso, CSGenioApess1.FldName, CSGenioAlendi.FldCodequip, CSGenioAequip.FldCodequip, CSGenioAequip.FldRegistnr, CSGenioAlendi.FldCodpess2, CSGenioApess2.FldCodpesso, CSGenioApess2.FldName, CSGenioAlendi.FldLendinnr, CSGenioAlendi.FldStart, CSGenioAequip.FldFrequenc, CSGenioAlendi.FldWarndt, CSGenioAlendi.FldEnd, CSGenioAlendi.FldObservat, CSGenioAlendi.FldReturndt, CSGenioAlendi.FldReturned, CSGenioAlendi.FldDayslimi };
	...
	//Tooltip for limit "SH" to area "PESS1" was ignored (unrelated to this viewmodel).
			//Limit type: "SH"			//Current Area = "LENDI"			//1st Area Limit: "PESS1"			//1st Area Field: "CODPESSO"			//1st Area Value: "pess1"

			CriteriaSet gqt_menu_1311Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ 1311]/

            // This will happen in case there is an error
            if(gqt_menu_1311Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAlendi>(false, gqt_menu_1311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1311", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP 1311]/

                conditions = gqt_menu_1311Conds;
                return;
			}
...
// USE /[MANUAL GQT OVERRQLIST 1311]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAlendi.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_1311Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(false, gqt_menu_1311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1311", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Lendi> MapGQT_Menu_1311(ListingMVC<CSGenioAlendi> Qlisting)
        {
        ...
        private Models.Lendi MapGQT_Menu_1311(CSGenioAlendi row)
        {
