...
{
    public class GQT_Menu_1711_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "7477a56b-438b-4cd1-9927-38bc641973fc"; }
...
// USE /[MANUAL GQT LIST_LIMITS 1711]/
        ...
        {
            dbeditTitle = Resources.Resources.LENDINGS_OF__EQUIP__22198;
            var tempDBEditTitle = dbeditTitle;
            string[] titleFields = new string[] { "equip.registnr", "tpequ.tipoequi" };
            FieldRef[] refTitleFields = new FieldRef[] { CSGenioAequip.FldRegistnr, CSGenioAtpequ.FldTipoequi };
            ...
            var values = sp.executeReaderOneRow(querySelect);
            if (values.Count != 0)
            {
                dbeditTitle = string.Format(dbeditTitle, values[0],values[1]);
                // Não protege muito, mas pelo menos não muda título do Location em caso do ViewModel ser usado algures no código manual
                if (Navigation.CurrentLevel.Location.Name == tempDBEditTitle)
                    Navigation.CurrentLevel.redefineLocName(dbeditTitle);
            }
        }
...
FieldRef[] fields = new FieldRef[] { CSGenioAlendi.FldCodlendi, CSGenioAlendi.FldZzstate, CSGenioAlendi.FldCodpess1, CSGenioApess1.FldCodpesso, CSGenioApess1.FldName, CSGenioAlendi.FldCodequip, CSGenioAequip.FldCodequip, CSGenioAequip.FldRegistnr, CSGenioAlendi.FldCodpess2, CSGenioApess2.FldCodpesso, CSGenioApess2.FldName, CSGenioAlendi.FldLendinnr, CSGenioAlendi.FldStart, CSGenioAequip.FldFrequenc, CSGenioAlendi.FldWarndt, CSGenioAlendi.FldEnd, CSGenioAlendi.FldObservat };
        ...
        public GQT_Menu_1711_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["GQT_Menu_1711_tableFilters"] ?? "false"), false);
			...
			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "GQT_Menu_1711_"));
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAlendi> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "GQT_Menu_1711", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "GQT_Menu_1711"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "GQT_Menu_1711");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pGQT_Menu_1711"])) ? int.Parse(requestValues["pGQT_Menu_1711"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sGQT_Menu_1711", "dGQT_Menu_1711", requestValues, "lendi", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlendi.FldCodlendi, CSGenioAlendi.FldZzstate, CSGenioAlendi.FldCodpess1, CSGenioApess1.FldCodpesso, CSGenioApess1.FldName, CSGenioAlendi.FldCodequip, CSGenioAequip.FldCodequip, CSGenioAequip.FldRegistnr, CSGenioAlendi.FldCodpess2, CSGenioApess2.FldCodpesso, CSGenioApess2.FldName, CSGenioAlendi.FldLendinnr, CSGenioAlendi.FldStart, CSGenioAequip.FldFrequenc, CSGenioAlendi.FldWarndt, CSGenioAlendi.FldEnd, CSGenioAlendi.FldObservat };
			...
			//Limit type: "DB"			//Current Area = "LENDI"			//1st Area Limit: "EQUIP"			//1st Area Field: "CODEQUIP"			//1st Area Value: ""
			{
				Limit limit = new Limit();
			...
			CriteriaSet gqt_menu_1711Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ 1711]/

            // This will happen in case there is an error
            if(gqt_menu_1711Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAlendi>(false, gqt_menu_1711Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1711", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP 1711]/

                conditions = gqt_menu_1711Conds;
                return;
			}
...
// USE /[MANUAL GQT OVERRQLIST 1711]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAlendi.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_1711Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(false, gqt_menu_1711Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1711", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Lendi> MapGQT_Menu_1711(ListingMVC<CSGenioAlendi> Qlisting)
        {
        ...
        private Models.Lendi MapGQT_Menu_1711(CSGenioAlendi row)
        {
