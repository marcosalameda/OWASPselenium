...
namespace GenioMVC.ViewModels.Lnhag
{
    public class Lnhag_Tpeq1ValTipoequi_ViewModel : ListViewModel
    {
		...
		{
// USE /[MANUAL GQT LIST_LIMITS LNHAG_TPEQ1TIPOEQUI]/
...
FieldRef[] fields = new FieldRef[] { CSGenioAtpeq1.FldCodtpequ, CSGenioAtpeq1.FldZzstate, CSGenioAtpeq1.FldTipoequi };
			...
			CriteriaSet lnhag___tpeq1tipoequiConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ LNHAG_TPEQ1TIPOEQUI]/

            // This will happen in case there is an error
            if(lnhag___tpeq1tipoequiConds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAtpeq1>(false, lnhag___tpeq1tipoequiConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHAG___TPEQ1TIPOEQUI", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP LNHAG_TPEQ1TIPOEQUI]/

                conditions = lnhag___tpeq1tipoequiConds;
                return;
			}
			...
			if (tableReload)
			{
// USE /[MANUAL GQT OVERRQLIST LNHAG_TPEQ1TIPOEQUI]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAtpeq1.GetInformation(), QMVC_POS_RECORD, sorts, lnhag___tpeq1tipoequiConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAtpeq1> listing = Models.ModelBase.Where<CSGenioAtpeq1>(false, lnhag___tpeq1tipoequiConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHAG___TPEQ1TIPOEQUI", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
