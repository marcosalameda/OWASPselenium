...
{
    /// <summary>
    /// Interface Lstusr_ViewModel
    /// </summary>
    public class Lstusr_ViewModel : ViewModelBase
    {
        /// <summary>
        ...
        /// <summary>Campo : "Colunas" Tipo:"DN"</summary>
        [Display(Name = "COLUNAS06085", ResourceType = typeof(Resources.Resources))]
        [Newtonsoft.Json.JsonProperty("Table")]
        public TablePartial<GenioMVC.Models.Lstcol> ValLstcol { get; set; }
        ...
        public void MapToModel(CSGenioAlstusr m)
        {
            if (m == null)
            {
                CSGenio.framework.Log.Error("Map ViewModel (Lstusr_ViewModel) to Model (CSGenioAlstusr) - Model is a null reference");
            ...
            {
                CSGenio.framework.Log.Error("Map ViewModel (Lstusr_ViewModel) to Model (CSGenioAlstusr) - Error during mapping");
                throw;
            }
        }
