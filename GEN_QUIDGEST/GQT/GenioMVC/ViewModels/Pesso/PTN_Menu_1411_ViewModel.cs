...
{
    public class PTN_Menu_1411_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "70d754f6-18c4-4fa0-9c99-0e776084a3e4"; }
...
FieldRef[] fields = new FieldRef[] { CSGenioApesso.FldCodpesso, CSGenioApesso.FldZzstate, CSGenioApesso.FldCodempre, CSGenioAcmpny.FldCodempre, CSGenioAcmpny.FldDesignat, CSGenioApesso.FldName, CSGenioApesso.FldGender, CSGenioApesso.FldDtnascim, CSGenioApesso.FldIdade, CSGenioApesso.FldIdfuncio, CSGenioApesso.FldTelephon, CSGenioApesso.FldEmail, CSGenioApesso.FldEmail2, CSGenioApesso.FldPhotogra, CSGenioApesso.FldDtultcat, CSGenioApesso.FldCodcateg, CSGenioAcateg.FldCodcateg, CSGenioAcateg.FldCategoria, CSGenioApesso.FldExterna, CSGenioApesso.FldInterna, CSGenioApesso.FldCodpaise, CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldCountry, CSGenioApesso.FldCodcntry, CSGenioApais1.FldCodcntry, CSGenioApais1.FldCountry, CSGenioApesso.FldCodregia, CSGenioAregi1.FldCodregia, CSGenioAregi1.FldRegiao };
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PTN_Menu_1411_ViewModel" /> class.
        /// </summary>
        /// <param name="currentNavigation">The current navigation</param>
        public PTN_Menu_1411_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["PTN_Menu_1411_tableFilters"] ?? "false"), false);
			...
			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "PTN_Menu_1411_"));
			...
			{
				// EPH
				crs = Models.Pesso.AddEPH<CSGenioApesso>(ref u, crs, "ML1411");
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApesso> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "PTN_Menu_1411", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "PTN_Menu_1411"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "PTN_Menu_1411");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pPTN_Menu_1411"])) ? int.Parse(requestValues["pPTN_Menu_1411"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_1411", "dPTN_Menu_1411", requestValues, "pesso", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioApesso.FldCodpesso, CSGenioApesso.FldZzstate, CSGenioApesso.FldCodempre, CSGenioAcmpny.FldCodempre, CSGenioAcmpny.FldDesignat, CSGenioApesso.FldName, CSGenioApesso.FldGender, CSGenioApesso.FldDtnascim, CSGenioApesso.FldIdade, CSGenioApesso.FldIdfuncio, CSGenioApesso.FldTelephon, CSGenioApesso.FldEmail, CSGenioApesso.FldEmail2, CSGenioApesso.FldPhotogra, CSGenioApesso.FldDtultcat, CSGenioApesso.FldCodcateg, CSGenioAcateg.FldCodcateg, CSGenioAcateg.FldCategoria, CSGenioApesso.FldExterna, CSGenioApesso.FldInterna, CSGenioApesso.FldCodpaise, CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldCountry, CSGenioApesso.FldCodcntry, CSGenioApais1.FldCodcntry, CSGenioApais1.FldCountry, CSGenioApesso.FldCodregia, CSGenioAregi1.FldCodregia, CSGenioAregi1.FldRegiao };
			...
			CriteriaSet ptn_menu_1411Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PTN OVERRQ 1411]/

            // This will happen in case there is an error
            if(ptn_menu_1411Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioApesso>(false, ptn_menu_1411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1411", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 1411]/

                conditions = ptn_menu_1411Conds;
                return;
			}
			...
			if (tableReload)
			{
// USE /[MANUAL PTN OVERRQLIST 1411]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioApesso.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_1411Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(false, ptn_menu_1411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				Menu.Elements = MapPTN_Menu_1411(listing);
        ...
        private List<Models.Pesso> MapPTN_Menu_1411(ListingMVC<CSGenioApesso> Qlisting)
        {
            ...
            if (Qlisting.Rows != null)
            {
                foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPTN_Menu_1411(row));
					i++;
				}
            }
        ...
        private Models.Pesso MapPTN_Menu_1411(CSGenioApesso row)
        {
        ...
        #region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_1411]/
        #endregion
