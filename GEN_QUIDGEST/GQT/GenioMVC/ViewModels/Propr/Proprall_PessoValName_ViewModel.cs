...
// USE /[MANUAL GQT LIST_LIMITS PROPRALL_PESSONAME]/
        ...
        public Proprall_PessoValName_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
// USE /[MANUAL GQT OVERRQLIST PROPRALL_PESSONAME]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioApesso.GetInformation(), QMVC_POS_RECORD, sorts, proprallpessoname____Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(false, proprallpessoname____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPRALLPESSONAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
