...
namespace GenioMVC.ViewModels.Pwreg
{
    public class Pwreg_PswValNome_ViewModel : ListViewModel
    {
        ...
        public Pwreg_PswValNome_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
// USE /[MANUAL GQT OVERRQLIST PWREG_NOME]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioApsw.GetInformation(), QMVC_POS_RECORD, sorts, pwreg___psw__nome____Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioApsw> listing = Models.ModelBase.Where<CSGenioApsw>(false, pwreg___psw__nome____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PWREG___PSW__NOME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
