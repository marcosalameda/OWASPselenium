...
namespace GenioMVC.ViewModels.Pwreg
{
	public class Pwreg_ViewModel : FormViewModel<Models.Pwreg>
	{
		...
		public Pwreg_ViewModel() : base("FPWREG") { }

		public Pwreg_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FPWREG", currentNavigation, nestedForm) { }

		public Pwreg_ViewModel(Models.Pwreg row, NavigationContext currentNavigation, bool nestedForm = false) : base("FPWREG", row, currentNavigation, nestedForm) { }

		public Pwreg_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("pwreg", id);
			Model = Models.Pwreg.Find(id, "FPWREG", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Pwreg model = new Models.Pwreg() { Identifier = "FPWREG" };
		...
		public static StatusMessage UpdateConditions(Models.Pwreg model)
		{
			StatusMessage result = new StatusMessage(Status.OK, "");
		...
		public static StatusMessage DeleteConditions(Models.Pwreg model)
		{
			StatusMessage result = new StatusMessage(Status.OK, "");
		...
		public static StatusMessage ViewConditions(Models.Pwreg model)
		{
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Pwreg.Find(Navigation.GetStrValue("pwreg"), "FPWREG");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Pwreg() { Identifier = "FPWREG" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE PWREG]/
		public override void Save()
		{
			...
			try { Model = Models.Pwreg.Find(Navigation.GetStrValue("pwreg"), "FPWREG"); }
			finally { if (Model == null) Model = new Models.Pwreg() { Identifier = "FPWREG" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY PWREG]/
		...
		{
			Model = Models.Pwreg.Find(id, "FPWREG");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
...
// USE /[MANUAL GQT OVERRQ PWREG_PSWNOME]/
                ...
                */
                ...
                //EPH
                //pwreg___psw__nome____Conds = Psw.AddEPH<CSGenioApsw>(ref UserContext.Current.User, pwreg___psw__nome____Conds, "LED_PWREG___PSW__NOME____");

                FieldRef firstVisibleColumn = new FieldRef("psw", "nome");
                ListingMVC<CSGenioApsw> listing = Models.ModelBase.Where<CSGenioApsw>(false, pwreg___psw__nome____Conds, fields, offset, numberItems, sorts, "LED_PWREG___PSW__NOME____", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TablePswNome.Elements = listing.RowsForViewModel<GenioMVC.Models.Psw>((r) => new GenioMVC.Models.Psw(r, true, _fieldsToSerialize_PWREG___PSW__NOME____));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_PwregTablePswNome(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_PwregTablePswNome(this.ValCodpsw, Navigation);
            try
            {
...
// USE /[MANUAL GQT OVERRQ PWREG_REGIOREGIAO]/
                ...
                */
                ...
                //EPH
                //pwreg___regioregiao__Conds = Regio.AddEPH<CSGenioAregio>(ref UserContext.Current.User, pwreg___regioregiao__Conds, "LED_PWREG___REGIOREGIAO__");

                FieldRef firstVisibleColumn = new FieldRef("regio", "regiao");
                ListingMVC<CSGenioAregio> listing = Models.ModelBase.Where<CSGenioAregio>(false, pwreg___regioregiao__Conds, fields, offset, numberItems, sorts, "LED_PWREG___REGIOREGIAO__", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableRegioRegiao.Elements = listing.RowsForViewModel<GenioMVC.Models.Regio>((r) => new GenioMVC.Models.Regio(r, true, _fieldsToSerialize_PWREG___REGIOREGIAO__));
        ...
        /// <param name="Navigation">Navigation context</param>
        public static ConcurrentDictionary<string, object> GetDependant_PwregTableRegioRegiao(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_PwregTableRegioRegiao(this.ValCodregia, Navigation);
            try
            {
                // That code doesn't include fields of the own control and can be empty if no one dependant field present on the form.
