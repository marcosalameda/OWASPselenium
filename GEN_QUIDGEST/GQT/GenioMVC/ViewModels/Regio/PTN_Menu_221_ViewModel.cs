...
namespace GenioMVC.ViewModels.Regio
{
    public class PTN_Menu_221_ViewModel : ListViewModel
    {
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 221]/
...
FieldRef[] fields = new FieldRef[] { CSGenioAregio.FldCodregia, CSGenioAregio.FldZzstate, CSGenioAregio.FldCodcntry, CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldCountry, CSGenioAregio.FldRegiao, CSGenioAregio.FldCodpais1, CSGenioApais1.FldCodcntry, CSGenioApais1.FldCountry };
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["PTN_Menu_221_tableFilters"] ?? "false"), false);
			...
			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "PTN_Menu_221_"));
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAregio> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "PTN_Menu_221", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "PTN_Menu_221"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "PTN_Menu_221");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pPTN_Menu_221"])) ? int.Parse(requestValues["pPTN_Menu_221"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_221", "dPTN_Menu_221", requestValues, "regio", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAregio.FldCodregia, CSGenioAregio.FldZzstate, CSGenioAregio.FldCodcntry, CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldCountry, CSGenioAregio.FldRegiao, CSGenioAregio.FldCodpais1, CSGenioApais1.FldCodcntry, CSGenioApais1.FldCountry };
			...
			CriteriaSet ptn_menu_221Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PTN OVERRQ 221]/

            // This will happen in case there is an error
            if(ptn_menu_221Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAregio>(false, ptn_menu_221Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML221", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 221]/

                conditions = ptn_menu_221Conds;
                return;
			}
...
// USE /[MANUAL PTN OVERRQLIST 221]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAregio.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_221Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAregio> listing = Models.ModelBase.Where<CSGenioAregio>(false, ptn_menu_221Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML221", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Regio> MapPTN_Menu_221(ListingMVC<CSGenioAregio> Qlisting)
        {
        ...
        private Models.Regio MapPTN_Menu_221(CSGenioAregio row)
        {
