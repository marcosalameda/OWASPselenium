...
FieldRef[] fields = new FieldRef[] { CSGenioAroigi.FldCodroigi, CSGenioAroigi.FldZzstate, CSGenioAroigi.FldOrder, CSGenioAroigi.FldTitle, CSGenioAroigi.FldCodrogl1, CSGenioArogl1.FldCodrogl1, CSGenioArogl1.FldTitle };
        ...
        public PTN_Menu_15411_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioAroigi.FldCodroigi, CSGenioAroigi.FldZzstate, CSGenioAroigi.FldOrder, CSGenioAroigi.FldTitle, CSGenioAroigi.FldCodrogl1, CSGenioArogl1.FldCodrogl1, CSGenioArogl1.FldTitle };
			...
			CriteriaSet ptn_menu_15411Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;
			
// USE /[MANUAL PTN OVERRQ 15411]/

            // This will happen in case there is an error
            if(ptn_menu_15411Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAroigi>(false, ptn_menu_15411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML15411", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 15411]/

                conditions = ptn_menu_15411Conds;
                return;
			}
...
// USE /[MANUAL PTN OVERRQLIST 15411]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAroigi.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_15411Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAroigi> listing = Models.ModelBase.Where<CSGenioAroigi>(false, ptn_menu_15411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML15411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
