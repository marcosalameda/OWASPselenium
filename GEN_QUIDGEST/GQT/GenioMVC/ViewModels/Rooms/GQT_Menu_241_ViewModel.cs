...
FieldRef[] fields = new FieldRef[] { CSGenioArooms.FldCodrooms, CSGenioArooms.FldZzstate, CSGenioArooms.FldRoomnr, CSGenioArooms.FldDesignat };
        ...
        public GQT_Menu_241_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioArooms.FldCodrooms, CSGenioArooms.FldZzstate, CSGenioArooms.FldRoomnr, CSGenioArooms.FldDesignat };
			...
			CriteriaSet gqt_menu_241Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ 241]/

            // This will happen in case there is an error
            if(gqt_menu_241Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioArooms>(false, gqt_menu_241Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML241", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP 241]/

                conditions = gqt_menu_241Conds;
                return;
			}
...
// USE /[MANUAL GQT OVERRQLIST 241]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioArooms.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_241Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioArooms> listing = Models.ModelBase.Where<CSGenioArooms>(false, gqt_menu_241Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML241", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
