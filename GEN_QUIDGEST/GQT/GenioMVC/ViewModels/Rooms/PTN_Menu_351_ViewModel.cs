...
FieldRef[] fields = new FieldRef[] { CSGenioArooms.FldCodrooms, CSGenioArooms.FldZzstate, CSGenioArooms.FldRoomnr, CSGenioArooms.FldDesignat };
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioArooms> Qlisting, ref CriteriaSet conditions)
		{
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_351", "dPTN_Menu_351", requestValues, "rooms", allSortOrders);
...
// USE /[MANUAL PTN OVERRQ 351]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioArooms>(false, ptn_menu_351Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML351", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 351]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioArooms.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_351Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioArooms> listing = Models.ModelBase.Where<CSGenioArooms>(false, ptn_menu_351Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML351", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Rooms> MapPTN_Menu_351(ListingMVC<CSGenioArooms> Qlisting)
        {
        ...
        private Models.Rooms MapPTN_Menu_351(CSGenioArooms row)
        {
