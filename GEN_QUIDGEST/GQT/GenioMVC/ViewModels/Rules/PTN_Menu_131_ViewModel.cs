...
namespace GenioMVC.ViewModels.Rules
{
    public class PTN_Menu_131_ViewModel : ListViewModel
    {
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 131]/
...
FieldRef[] fields = new FieldRef[] { CSGenioArules.FldCodregra, CSGenioArules.FldZzstate, CSGenioArules.FldTipocond, CSGenioArules.FldDescript, CSGenioArules.FldLocal };
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Rules.AddEPH<CSGenioArules>(ref u, crs, "ML131");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Rules.AddEPH<CSGenioArules>(ref u, null, "ML131"));
			}
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioArules> Qlisting, ref CriteriaSet conditions)
		{
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_131", "dPTN_Menu_131", requestValues, "rules", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioArules.FldCodregra, CSGenioArules.FldZzstate, CSGenioArules.FldTipocond, CSGenioArules.FldDescript, CSGenioArules.FldLocal };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				CSGenioArules model_limit_area = new CSGenioArules(UserContext.Current.User);
...
// USE /[MANUAL PTN OVERRQ 131]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioArules>(false, ptn_menu_131Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML131", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 131]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioArules.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_131Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioArules> listing = Models.ModelBase.Where<CSGenioArules>(false, ptn_menu_131Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML131", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private Models.Rules MapPTN_Menu_131(CSGenioArules row)
        {
            var model = new Models.Rules(true, _fieldsToSerialize);
            if (row == null)
                return model;
