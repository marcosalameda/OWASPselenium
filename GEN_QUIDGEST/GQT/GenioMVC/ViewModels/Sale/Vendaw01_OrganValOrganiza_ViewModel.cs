...
// USE /[MANUAL GQT LIST_LIMITS VENDAW01_ORGANORGANIZA]/
        ...
        public Vendaw01_OrganValOrganiza_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioAorgan.FldCodorgan, CSGenioAorgan.FldZzstate, CSGenioAorgan.FldOrganiza };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				CSGenioAorgan model_limit_area = new CSGenioAorgan(UserContext.Current.User);
			...
			CriteriaSet vendaw01organorganizaConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ VENDAW01_ORGANORGANIZA]/

            // This will happen in case there is an error
            if(vendaw01organorganizaConds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAorgan>(false, vendaw01organorganizaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_VENDAW01ORGANORGANIZA", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST VENDAW01_ORGANORGANIZA]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAorgan.GetInformation(), QMVC_POS_RECORD, sorts, vendaw01organorganizaConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAorgan> listing = Models.ModelBase.Where<CSGenioAorgan>(false, vendaw01organorganizaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_VENDAW01ORGANORGANIZA", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
