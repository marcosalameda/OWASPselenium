...
namespace GenioMVC.ViewModels.Sale
{
	public class Vendaw03_ViewModel : FormViewModel<Models.Sale>
	{
		...
		public Vendaw03_ViewModel() : base("FVENDAW03") { }

		public Vendaw03_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FVENDAW03", currentNavigation, nestedForm) { }

		public Vendaw03_ViewModel(Models.Sale row, NavigationContext currentNavigation, bool nestedForm = false) : base("FVENDAW03", row, currentNavigation, nestedForm) { }

		public Vendaw03_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("sale", id);
			Model = Models.Sale.Find(id, "FVENDAW03", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Sale model = new Models.Sale() { Identifier = "FVENDAW03" };
		...
		public override void MapFromModel(Models.Sale m)
		{
			if (m == null)
			{
				CSGenio.framework.Log.Error("Map Model (Sale) to ViewModel (Vendaw03) - Model is a null reference");
				throw new ModelNotFoundException("Model not found");
			}
			try
			{
			...
			{
				CSGenio.framework.Log.Error("Map Model (Sale) to ViewModel (Vendaw03) - Error during mapping");
				throw;
			}
		}
		...
		public override void MapToModel(Models.Sale m)
		{
			if (m == null)
			{
				CSGenio.framework.Log.Error("Map ViewModel (Vendaw03) to Model (Sale) - Model is a null reference");
				throw new ModelNotFoundException("Model not found");
			}
			try
			{
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Sale.Find(Navigation.GetStrValue("sale"), "FVENDAW03");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Sale() { Identifier = "FVENDAW03" };
...
// USE /[MANUAL GQT VIEWMODEL_LOADPARTIAL VENDAW03]/
		}

// USE /[MANUAL GQT VIEWMODEL_NEW VENDAW03]/
...
// USE /[MANUAL GQT VIEWMODEL_SAVE VENDAW03]/
		public override void Save()
		{
			...
			try { Model = Models.Sale.Find(Navigation.GetStrValue("sale"), "FVENDAW03"); }
			finally { if (Model == null) Model = new Models.Sale() { Identifier = "FVENDAW03" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY VENDAW03]/
		public override void Destroy(string id)
		{
			Model = Models.Sale.Find(id, "FVENDAW03");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM VENDAW03]/
		#endregion
	}
}
