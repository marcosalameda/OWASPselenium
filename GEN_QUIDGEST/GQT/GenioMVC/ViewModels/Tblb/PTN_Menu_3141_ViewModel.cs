...
namespace GenioMVC.ViewModels.Tblb
{
    public class PTN_Menu_3141_ViewModel : ListViewModel
    {
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "b91b9161-2846-47fc-b5b4-08511357ea57"; }
...
FieldRef[] fields = new FieldRef[] { CSGenioAtblb.FldCodtblb, CSGenioAtblb.FldZzstate, CSGenioAtblb.FldText, CSGenioAtblb.FldTextml, CSGenioAtblb.FldNumint, CSGenioAtblb.FldNumdec, CSGenioAtblb.FldCurint, CSGenioAtblb.FldCurdec, CSGenioAtblb.FldBool, CSGenioAtblb.FldDate, CSGenioAtblb.FldDatetm, CSGenioAtblb.FldDatets, CSGenioAtblb.FldTimehm, CSGenioAtblb.FldEnumt, CSGenioAtblb.FldEnumn };
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtblb> Qlisting, ref CriteriaSet conditions)
		{
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_3141", "dPTN_Menu_3141", requestValues, "tblb", allSortOrders);
...
// USE /[MANUAL PTN OVERRQ 3141]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAtblb>(false, ptn_menu_3141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3141", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3141]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAtblb.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_3141Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAtblb> listing = Models.ModelBase.Where<CSGenioAtblb>(false, ptn_menu_3141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3141", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Tblb> MapPTN_Menu_3141(ListingMVC<CSGenioAtblb> Qlisting)
        {
        ...
        private Models.Tblb MapPTN_Menu_3141(CSGenioAtblb row)
        {
