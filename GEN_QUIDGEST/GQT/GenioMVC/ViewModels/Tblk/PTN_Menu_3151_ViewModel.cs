...
FieldRef[] fields = new FieldRef[] { CSGenioAtblk.FldCodtblk, CSGenioAtblk.FldZzstate, CSGenioAtblk.FldName, CSGenioAtblk.FldFkey1, CSGenioAgrpb.FldCodgrpb, CSGenioAgrpb.FldName, CSGenioAtblk.FldFkey2, CSGenioAtrsb.FldCodtrsb, CSGenioAtrsb.FldName };
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtblk> Qlisting, ref CriteriaSet conditions)
		{
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_3151", "dPTN_Menu_3151", requestValues, "tblk", allSortOrders);
...
// USE /[MANUAL PTN OVERRQ 3151]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAtblk>(false, ptn_menu_3151Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3151", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3151]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAtblk.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_3151Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAtblk> listing = Models.ModelBase.Where<CSGenioAtblk>(false, ptn_menu_3151Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3151", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private Models.Tblk MapPTN_Menu_3151(CSGenioAtblk row)
        {
