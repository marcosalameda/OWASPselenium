...
FieldRef[] fields = new FieldRef[] { CSGenioAtrsb.FldCodtrsb, CSGenioAtrsb.FldZzstate, CSGenioAtrsb.FldName };
        ...
        public PTN_Menu_3141_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["PTN_Menu_3141_tableFilters"] ?? "false"), false);
			...
			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "PTN_Menu_3141_"));
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtrsb> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "PTN_Menu_3141", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "PTN_Menu_3141"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "PTN_Menu_3141");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pPTN_Menu_3141"])) ? int.Parse(requestValues["pPTN_Menu_3141"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_3141", "dPTN_Menu_3141", requestValues, "trsb", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAtrsb.FldCodtrsb, CSGenioAtrsb.FldZzstate, CSGenioAtrsb.FldName };
			...
			CriteriaSet ptn_menu_3141Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;
			
// USE /[MANUAL PTN OVERRQ 3141]/

            // This will happen in case there is an error
            if(ptn_menu_3141Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAtrsb>(false, ptn_menu_3141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3141", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 3141]/

                conditions = ptn_menu_3141Conds;
                return;
			}
...
// USE /[MANUAL PTN OVERRQLIST 3141]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAtrsb.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_3141Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAtrsb> listing = Models.ModelBase.Where<CSGenioAtrsb>(false, ptn_menu_3141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3141", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Trsb> MapPTN_Menu_3141(ListingMVC<CSGenioAtrsb> Qlisting)
        {
        ...
        private Models.Trsb MapPTN_Menu_3141(CSGenioAtrsb row)
        {
