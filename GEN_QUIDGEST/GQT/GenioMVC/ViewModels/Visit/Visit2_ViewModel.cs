...
namespace GenioMVC.ViewModels.Visit
{
	public class Visit2_ViewModel : FormViewModel<Models.Visit>
	{
		...
		/// <summary>Campo : "Background" Tipo:"L"</summary>
		[Display(Name = "BACKGROUND45121", ResourceType = typeof(Resources.Resources))]
		...
		public Visit2_ViewModel() : base("FVISIT2") { }

		public Visit2_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FVISIT2", currentNavigation, nestedForm) { }

		public Visit2_ViewModel(Models.Visit row, NavigationContext currentNavigation, bool nestedForm = false) : base("FVISIT2", row, currentNavigation, nestedForm) { }

		public Visit2_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("visit", id);
			Model = Models.Visit.Find(id, "FVISIT2", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Visit model = new Models.Visit() { Identifier = "FVISIT2" };
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Visit.Find(Navigation.GetStrValue("visit"), "FVISIT2");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Visit() { Identifier = "FVISIT2" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE VISIT2]/
		public override void Save()
		{
			...
			try { Model = Models.Visit.Find(Navigation.GetStrValue("visit"), "FVISIT2"); }
			finally { if (Model == null) Model = new Models.Visit() { Identifier = "FVISIT2" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY VISIT2]/
		...
		{
			Model = Models.Visit.Find(id, "FVISIT2");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
...
// USE /[MANUAL GQT OVERRQ VISIT2_EQUIPREGISTNR]/
                ...
                */
                ...
                //EPH
                //visit2__equipregistnrConds = Equip.AddEPH<CSGenioAequip>(ref UserContext.Current.User, visit2__equipregistnrConds, "LED_VISIT2__EQUIPREGISTNR");

                FieldRef firstVisibleColumn = new FieldRef("equip", "registnr");
                ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(false, visit2__equipregistnrConds, fields, offset, numberItems, sorts, "LED_VISIT2__EQUIPREGISTNR", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableEquipRegistnr.Elements = listing.RowsForViewModel<GenioMVC.Models.Equip>((r) => new GenioMVC.Models.Equip(r, true, _fieldsToSerialize_VISIT2__EQUIPREGISTNR));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_Visit2TableEquipRegistnr(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_Visit2TableEquipRegistnr(this.ValCodequip, Navigation);
            try
            {
