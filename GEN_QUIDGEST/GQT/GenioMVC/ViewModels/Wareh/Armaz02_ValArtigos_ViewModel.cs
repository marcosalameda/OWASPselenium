...
{
    public class Armaz02_ValArtigos_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "Armaz02_ValArtigos"; }
		...
		{
// USE /[MANUAL GQT LIST_LIMITS ARMAZ02_PSEUDARTIGOS]/
		...
		public override CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Item.AddEPH<CSGenioAitem>(ref u, crs, "IBL_ARMAZ02_PSEUDARTIGOS_");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Item.AddEPH<CSGenioAitem>(ref u, null, "IBL_ARMAZ02_PSEUDARTIGOS_"));
			}
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAitem> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Armaz02_ValArtigos", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Armaz02_ValArtigos"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Armaz02_ValArtigos");
...
FieldRef[] fields = new FieldRef[] { CSGenioAitem.FldCoditem, CSGenioAitem.FldZzstate, CSGenioAitem.FldItemdes, CSGenioAitem.FldItemcod, CSGenioAitem.FldEntries, CSGenioAitem.FldExits, CSGenioAitem.FldExistenc, CSGenioAitem.FldImage };
			...
			CriteriaSet armaz02_pseudartigos_Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ ARMAZ02_PSEUDARTIGOS]/

            // This will happen in case there is an error
            if(armaz02_pseudartigos_Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAitem>(false, armaz02_pseudartigos_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAZ02_PSEUDARTIGOS_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ARMAZ02_PSEUDARTIGOS]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAitem.GetInformation(), QMVC_POS_RECORD, sorts, armaz02_pseudartigos_Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAitem> listing = Models.ModelBase.Where<CSGenioAitem>(false, armaz02_pseudartigos_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAZ02_PSEUDARTIGOS_", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        private List<Models.Item> MapArmaz02_ValArtigos(ListingMVC<CSGenioAitem> Qlisting)
        {
            ...
            if (Qlisting.Rows != null)
            {
                foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapArmaz02_ValArtigos(row));
					i++;
				}
            }
        ...
        private Models.Item MapArmaz02_ValArtigos(CSGenioAitem row)
        {
        ...
        #region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM ARMAZ02_VALARTIGOS]/
        #endregion
