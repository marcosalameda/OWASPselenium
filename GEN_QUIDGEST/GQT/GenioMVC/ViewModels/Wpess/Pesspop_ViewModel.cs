...
namespace GenioMVC.ViewModels.Wpess
{
	public class Pesspop_ViewModel : FormViewModel<Models.Wpess>
	{
		...
		public Pesspop_ViewModel() : base("FPESSPOP") { }

		public Pesspop_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FPESSPOP", currentNavigation, nestedForm) { }

		public Pesspop_ViewModel(Models.Wpess row, NavigationContext currentNavigation, bool nestedForm = false) : base("FPESSPOP", row, currentNavigation, nestedForm) { }

		public Pesspop_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("wpess", id);
			Model = Models.Wpess.Find(id, "FPESSPOP", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Wpess model = new Models.Wpess() { Identifier = "FPESSPOP" };
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Wpess.Find(Navigation.GetStrValue("wpess"), "FPESSPOP");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Wpess() { Identifier = "FPESSPOP" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE PESSPOP]/
		public override void Save()
		{
			...
			try { Model = Models.Wpess.Find(Navigation.GetStrValue("wpess"), "FPESSPOP"); }
			finally { if (Model == null) Model = new Models.Wpess() { Identifier = "FPESSPOP" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY PESSPOP]/
		...
		{
			Model = Models.Wpess.Find(id, "FPESSPOP");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
...
// USE /[MANUAL GQT OVERRQ PESSPOP_WAREHWAREHDES]/
                ...
                */
                ...
                //EPH
                //pesspop_warehwarehdesConds = Wareh.AddEPH<CSGenioAwareh>(ref UserContext.Current.User, pesspop_warehwarehdesConds, "LED_PESSPOP_WAREHWAREHDES");

                FieldRef firstVisibleColumn = new FieldRef("wareh", "warehdes");
                ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(false, pesspop_warehwarehdesConds, fields, offset, numberItems, sorts, "LED_PESSPOP_WAREHWAREHDES", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableWarehWarehdes.Elements = listing.RowsForViewModel<GenioMVC.Models.Wareh>((r) => new GenioMVC.Models.Wareh(r, true, _fieldsToSerialize_PESSPOP_WAREHWAREHDES));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_PesspopTableWarehWarehdes(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_PesspopTableWarehWarehdes(this.ValCodwareh, Navigation);
            try
            {
