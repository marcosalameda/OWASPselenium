...
{
    public class AdressAgent2Agent : ModelAiAgent
    {
        public override string AGENT_ID => "AdressAgent2";

        public AdressAgent2Agent(IChatbotService service) : base(service)
        {
        }
        ...
        public override void Execute(DbArea area, PersistentSupport sp, User user)
        {
            ...
            AdressAgent2Response response = base.GetResponse<AdressAgent2Response>(user);
            if (response == null)
                throw new FrameworkException("Answer from AI service was empty", "AdressAgent2Agent.Execute", "Answer from AI service was empty");
        ...
        protected void MapResponse(AdressAgent2Response response)
        {
        }
    ...
    public class AdressAgent2Response
    {             
    }
