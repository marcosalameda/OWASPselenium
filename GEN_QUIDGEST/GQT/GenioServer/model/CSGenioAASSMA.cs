...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codassma", FieldType.CHAVE_PRIMARIA_GUID);
			...
			Qfield.FieldSize =  36;
			Qfield.MQueue = false;
			Qfield.CavDesignation = "__ASSET23159";
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "digdocum", FieldType.FICHEIRO_BD);
			...
			Qfield.Dupmsg = "";
			info.RegisterFieldDB(Qfield);
 			Qfield = new Field(info.Alias, "digdocumfk", FieldType.CHAVE_ESTRANGEIRA_GUID);
			Qfield.FieldSize = 16;
        ...
        public static CSGenioAassma search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
