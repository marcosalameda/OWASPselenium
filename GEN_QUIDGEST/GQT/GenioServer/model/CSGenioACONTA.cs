...
namespace CSGenio.business
{
	...
	public class CSGenioAconta : DbArea
	{
		...
		public CSGenioAconta(User user, string module)
		{
			...
			// USE /[MANUAL GQT CONSTRUTOR CONTA]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codconta", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codgenre", FieldType.CHAVE_ESTRANGEIRA_GUID);
			Qfield.FieldDescription = "";
			Qfield.FieldSize =  36;
			Qfield.CavDesignation = "";
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codtpcon", FieldType.CHAVE_ESTRANGEIRA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "contacto", FieldType.TEXTO);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("genre", new Relation("GQT", "gqtconta", "conta", "codconta", "codgenre", "GQT", "gqtgenre", "genre", "codgenre", "codgenre"));
			info.ParentTables.Add("pesso", new Relation("GQT", "gqtconta", "conta", "codconta", "codpesso", "GQT", "gqtpessoas", "pesso", "codpesso", "codpesso"));
			info.ParentTables.Add("tpcon", new Relation("GQT", "gqtconta", "conta", "codconta", "codtpcon", "GQT", "gqttpcon", "tpcon", "codtpcon", "codtpcon"));
		}
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.QSystem="GQT";
			info.TableName="gqtconta";
			info.ShadowTabName="";
			info.ShadowTabKeyName="";

			info.PrimaryKeyName="codconta";
			info.HumanKeyName="contacto,".TrimEnd(',');
			info.Alias="conta";
			info.IsDomain = true;
		...
		private static FieldRef m_fldCodgenre = new FieldRef("conta", "codgenre");
        ...
        public static CSGenioAconta search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
