...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "firstfacilitie", FieldType.CHAVE_ESTRANGEIRA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "lastfacilitie", FieldType.CHAVE_ESTRANGEIRA_GUID);
        ...
        public static CSGenioAentit search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
