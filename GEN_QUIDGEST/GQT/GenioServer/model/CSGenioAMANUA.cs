...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codmanua", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("digdocum", FieldType.FICHEIRO_BD);
			...
			Qfield.Dupmsg = "";
			info.RegisterFieldDB(Qfield);
 			Qfield = new Field("digdocumfk", FieldType.CHAVE_ESTRANGEIRA_GUID);
			Qfield.FieldSize = 16;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("notes", FieldType.MEMO);
        ...
        public static CSGenioAmanua search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        [Obsolete("Use List<CSGenioAmanua> searchList(PersistentSupport sp, User user, CriteriaSet where, string []fields) instead")]
        public static List<CSGenioAmanua> searchList(PersistentSupport sp, User user, string where, string []fields = null)
        {
            return sp.searchListWhere<CSGenioAmanua>(where, user, fields);
        }
