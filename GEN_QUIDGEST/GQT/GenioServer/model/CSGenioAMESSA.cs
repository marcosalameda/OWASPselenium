...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codmessa", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("mailsent", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("docum_nr", FieldType.NUMERO);
		...
		/// <summary>Field : "Document number" Tipo: "N" Formula:  ""</summary>
		public double ValDocum_nr
		{
			get { return (double)returnValueField(FldDocum_nr); }
        ...
        public static CSGenioAmessa search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        [Obsolete("Use List<CSGenioAmessa> searchList(PersistentSupport sp, User user, CriteriaSet where, string []fields) instead")]
        public static List<CSGenioAmessa> searchList(PersistentSupport sp, User user, string where, string []fields = null)
        {
            return sp.searchListWhere<CSGenioAmessa>(where, user, fields);
        }
