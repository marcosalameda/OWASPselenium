...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codoutpu", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codoutpt", FieldType.CHAVE_ESTRANGEIRA_GUID);
			Qfield.FieldDescription = "";
			Qfield.FieldSize =  36;
			Qfield.Alias = info.Alias;
			Qfield.CavDesignation = "";
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("exitdt", FieldType.DATAHORA);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("coddocsd", FieldType.CHAVE_ESTRANGEIRA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("exitqnty", FieldType.NUMERO);
