...
namespace GenioMVC.Controllers
{
	public partial class AnexdController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Anexd_ModalDBEdit(string partialView)
		{
			Anexd_ViewModel model = new Anexd_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX ANEXD]/
		...
		public ActionResult Anexd_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("anexd", Convert.ToString(Navigation.CurrentLevel.GetEntry("anexd"))) : saveMsg);
