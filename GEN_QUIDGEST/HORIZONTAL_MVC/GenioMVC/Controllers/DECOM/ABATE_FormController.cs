...
namespace GenioMVC.Controllers
{
	public partial class DecomController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Abate_ModalDBEdit(string partialView)
		{
			Abate_ViewModel model = new Abate_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX ABATE]/
		...
		public ActionResult Abate_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("decom", Convert.ToString(Navigation.CurrentLevel.GetEntry("decom"))) : saveMsg);
