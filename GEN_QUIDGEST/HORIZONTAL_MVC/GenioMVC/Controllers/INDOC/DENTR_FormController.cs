...
namespace GenioMVC.Controllers
{
	public partial class IndocController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Dentr_ModalDBEdit(string partialView)
		{
			Dentr_ViewModel model = new Dentr_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX DENTR]/
		...
		public ActionResult Dentr_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("indoc", Convert.ToString(Navigation.CurrentLevel.GetEntry("indoc"))) : saveMsg);
