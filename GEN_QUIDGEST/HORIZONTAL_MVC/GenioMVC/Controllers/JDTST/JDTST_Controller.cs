...
// USE /[MANUAL GQT INCLUDE_CONTROLLER JDTST]/

namespace GenioMVC.Controllers
{
    public partial class JdtstController : ControllerBase
    {
        #region NavigationLocation Names controller.cs.vm

// USE /[MANUAL GQT CONTROLLER_NAVIGATION JDTST]/
        ...
        {
            CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAjdtst>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
            return base.GetActionIds(crs, sp, area);
        }

// USE /[MANUAL GQT MANUAL_CONTROLLER JDTST]/
