...
namespace GenioMVC.Controllers
{
	public partial class LnhagController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Lnhag_ModalDBEdit(string partialView)
		{
			Lnhag_ViewModel model = new Lnhag_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX LNHAG]/
		...
		public ActionResult Lnhag_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("lnhag", Convert.ToString(Navigation.CurrentLevel.GetEntry("lnhag"))) : saveMsg);
