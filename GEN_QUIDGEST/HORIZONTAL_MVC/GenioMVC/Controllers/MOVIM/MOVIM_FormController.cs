...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX MOVIM]/
		...
		public ActionResult Movim_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("movim", Convert.ToString(Navigation.CurrentLevel.GetEntry("movim"))) : saveMsg);
