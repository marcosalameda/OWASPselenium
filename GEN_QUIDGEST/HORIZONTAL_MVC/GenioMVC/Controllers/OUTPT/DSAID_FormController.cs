...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX DSAID]/
		...
		public ActionResult Dsaid_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("outpt", Convert.ToString(Navigation.CurrentLevel.GetEntry("outpt"))) : saveMsg);
