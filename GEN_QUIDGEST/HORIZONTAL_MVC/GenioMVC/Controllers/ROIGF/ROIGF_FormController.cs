...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX ROIGF]/
		...
		public ActionResult Roigf_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("roigf", Convert.ToString(Navigation.CurrentLevel.GetEntry("roigf"))) : saveMsg);
