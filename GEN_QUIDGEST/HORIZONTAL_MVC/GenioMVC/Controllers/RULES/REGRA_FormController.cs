...
namespace GenioMVC.Controllers
{
	public partial class RulesController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Regra_ModalDBEdit(string partialView)
		{
			Regra_ViewModel model = new Regra_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX REGRA]/
		...
		public ActionResult Regra_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("rules", Convert.ToString(Navigation.CurrentLevel.GetEntry("rules"))) : saveMsg);
