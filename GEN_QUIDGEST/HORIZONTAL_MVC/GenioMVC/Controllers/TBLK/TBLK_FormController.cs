...
namespace GenioMVC.Controllers
{
	public partial class TblkController : ControllerBase
	{
		...
		[AuthorizeForUsers]
		public ActionResult Tblk_ModalDBEdit(string partialView)
		{
			Tblk_ViewModel model = new Tblk_ViewModel();
...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX TBLK]/
		...
		public ActionResult Tblk_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("tblk", Convert.ToString(Navigation.CurrentLevel.GetEntry("tblk"))) : saveMsg);
