...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX TRSB]/
		...
		public ActionResult Trsb_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("trsb", Convert.ToString(Navigation.CurrentLevel.GetEntry("trsb"))) : saveMsg);
