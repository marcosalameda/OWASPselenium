...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX ANO]/
		...
		public ActionResult Ano_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("year", Convert.ToString(Navigation.CurrentLevel.GetEntry("year"))) : saveMsg);
