...
//Menu limits:
		...
		/*
		SM, //Selection of a Month
		SD, //Selection of a Day
		SW, //Selection of a Week 
		SP, //Selection of a period
		*/ //DEPRECATED
		SE, //Cross-boundary selection
		SU, //Threshold selection
		DM, //Multiple selection
		DC, //N:N List 
		//DF, //Unchecks items from list //IGNORED in templates
		//DE, //Mark items from list to //IGNORED in templates 
		//Pick/unpicking records from a list to be assigned with foreign key from selected record on a DB list that comes next, doesnt make sense to register.
...
//Other limits:
        ...
        //TODO: if new other limit types are added and supported by Genio, they will have to be added here and its rendering in TableRenderes.cs.vm
    ...
    class LimitComparer : IEqualityComparer<Limit>
    {
        ...
        public int GetHashCode(Limit limit)
        {
            ...
            if (object.ReferenceEquals(limit, null)) return 0;
