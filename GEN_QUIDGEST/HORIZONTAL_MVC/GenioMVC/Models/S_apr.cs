...
namespace GenioMVC.Models
{
	public class S_apr : ModelBase
	{
		...
		public bool ShouldSerializeValCodascpr() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValCodascpr");
		...
		public bool ShouldSerializeValType() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValType");
		...
		public bool ShouldSerializeValDaterequ() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValDaterequ");
		...
		public bool ShouldSerializeValInitprc() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValInitprc");
		...
		public bool ShouldSerializeValEndprc() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValEndprc");
		...
		public bool ShouldSerializeValDuration() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValDuration");
		...
		public bool ShouldSerializeValStatus() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValStatus");
		...
		public bool ShouldSerializeValRsltmsg() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValRsltmsg");
		...
		public bool ShouldSerializeValFinished() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValFinished");
		...
		public bool ShouldSerializeValLastupdt() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValLastupdt");
		...
		public bool ShouldSerializeValResult() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValResult");
		...
		public bool ShouldSerializeValInfo() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValInfo");
		...
		public bool ShouldSerializeValModoproc() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValModoproc");
		...
		public bool ShouldSerializeValExternal() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValExternal");
		...
		public bool ShouldSerializeValCodentit() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValCodentit");

		[DisplayName("Motive")]
		/// <summary>Field : "Motive" Tipo: "C" Formula:  ""</summary>
		public string ValMotivo { get { return klass.ValMotivo; } set { klass.ValMotivo = value; } }
		public bool ShouldSerializeValMotivo() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValMotivo");

		[DisplayName("")]
		/// <summary>Field : "" Tipo: "CF" Formula:  ""</summary>
		public string ValCodpsw { get { return klass.ValCodpsw; } set { klass.ValCodpsw = value; } }
		public bool ShouldSerializeValCodpsw() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValCodpsw");
		...
		public bool ShouldSerializeValOpershut() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValOpershut");
		...
		public bool ShouldSerializeValRtstatus() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValRtstatus");

		[DisplayName("Created by")]
		/// <summary>Field : "Created by" Tipo: "ON" Formula:  ""</summary>
		public string ValOpercria { get { return klass.ValOpercria; } set { klass.ValOpercria = value; } }
		public bool ShouldSerializeValOpercria() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValOpercria");
		...
		public bool ShouldSerializeValDatacria() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValDatacria");
		...
		public bool ShouldSerializeValOpermuda() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValOpermuda");
		...
		public bool ShouldSerializeValDatamuda() => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValDatamuda");

		[DisplayName("ZZSTATE")]
		/// <summary>Field : "ZZSTATE" Type: "INT" Formula:  ""</summary>
		public int ValZzstate { get { return klass.ValZzstate; } set { klass.ValZzstate = value; } }
		public bool ShouldSerializeValZzstate () => this.SerializeAllFields || this.FieldsToSerialize.Contains("S_apr.ValZzstate");

		public S_apr() : this(UserContext.Current.User) { }

		public S_apr(User u)
		{
			this.klass = new CSGenioAs_apr(u);
		}

		public S_apr(string[] fieldsToSerialize) : this()
		{
			SetFieldsToSerialize(fieldsToSerialize);
		}

		public S_apr(bool isEmpty, string[] fieldsToSerialize) : this(fieldsToSerialize)
		{
			this.isEmptyModel = isEmpty;
		}

		public S_apr(bool isEmpty) : this(isEmpty, null) { }

		public S_apr(CSGenioAs_apr val, string[] fieldsToSerialize)
		{
			klass = val; SetFieldsToSerialize(fieldsToSerialize);
		}

		public S_apr(CSGenioAs_apr val) : this(val, null) { }

		public S_apr(CSGenioAs_apr val, bool fillAreasRel, string[] fieldsToSerialize)
		{
			klass = val;
			SetFieldsToSerialize(fieldsToSerialize);
		...
		public S_apr(CSGenioAs_apr val, bool fillAreasRel) : this(val, fillAreasRel, null) { }
		...
		public static S_apr Find(string id, string identifier = null, string[] fieldsToSerialize = null, string[] fieldsToQuery = null)
		{
		...
		public static S_apr Find(string id, UserContext userCtx, string identifier = null, string[] fieldsToSerialize = null, string[] fieldsToQuery = null)
		{
			...
			return record == null ? null : new S_apr(record, fieldsToSerialize) { Identifier = identifier };
		}

		[Obsolete("This method should never be used because it uses the default pagination but never allow in the parameters to set any other page. " +
			"Might induce error in manual routines expection to return all the records in the database, when in fact they only get 1 page of records.")]
		public static List<S_apr> Where(CriteriaSet args = null, string identifier = null, bool noLock = true)
		{
			return Where<CSGenioAs_apr>(false, args, null, 0, 0, null, identifier,noLock).RowsForViewModel<S_apr>();
		}

		[Obsolete("Please use the ModelBase<A>.Where method instead")]
		public static ListingMVC<CSGenioAs_apr> Where(bool distinct, CriteriaSet args = null, Quidgest.Persistence.FieldRef[] fields = null, int offset = 0, int numRegs = 0, List<ColumnSort> sorts = null, string identifier = null, bool noLock = true, bool getTotal = false, string selectrow = "", CriteriaSet PagingPosEPHs = null, Quidgest.Persistence.FieldRef firstVisibleColumn = null)
		{
			return ModelBase.Where<CSGenioAs_apr>(distinct, args, fields, offset, numRegs, sorts, identifier, noLock, getTotal, selectrow, PagingPosEPHs, firstVisibleColumn);
		}

		[Obsolete("Please use the ModelBase<A>.All method instead")]
		public static ListingMVC<CSGenioAs_apr> All(CriteriaSet args = null)
		{
			return Where<CSGenioAs_apr>(false, args, numRegs: -1);
		}

		public static List<S_apr> AllModel(CriteriaSet args = null, string identifier = null)
		{
			return Where<CSGenioAs_apr>(false, args, numRegs: -1, identifier: identifier).RowsForViewModel<S_apr>((r) => new S_apr(r));
		}

// USE /[MANUAL GQT MODEL S_APR]/
	}
}
