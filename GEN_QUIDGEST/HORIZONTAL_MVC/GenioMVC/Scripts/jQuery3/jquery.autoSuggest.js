                        ...
                        */
                        ...
                        for (var x = 0; x < data.length; x++) {
                            ...
                            onDone = function (data) {
                                var data2;
                                count++;
                                data2 = $.isFunction(options.afterRequest) ? options.afterRequest.apply(this, [data, limit == count, query]) : data;
                                return callback(data2, query);
                            };
...
//            input.wrap("<ul class=\"as-selections input-append input-block-level\" id=\"as-selections-" + element + "\"></ul>").wrap("<li class=\"as-original\" id=\"as-original-" + element + "\"></li>");
                ...
                for (_k = 0, _len2 = data.length; _k < _len2; _k++) {
                    ...
                    if (forward) {
                        ...
                        formatted.click(function () {
                            ...
                            oldVal = oldVal.substring(0, oldVal.lastIndexOf(',')+1);
                            input.val('').focus();
                            input.val(oldVal + this.innerText + ',');
