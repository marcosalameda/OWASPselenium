...
namespace GenioMVC.ViewModels.Equip
{
	public class Gmaps_ViewModel : FormViewModel<Models.Equip>
	{
		...
		public Gmaps_ViewModel() : base("FGMAPS") { }

		public Gmaps_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FGMAPS", currentNavigation, nestedForm) { }

		public Gmaps_ViewModel(Models.Equip row, NavigationContext currentNavigation, bool nestedForm = false) : base("FGMAPS", row, currentNavigation, nestedForm) { }

		public Gmaps_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("equip", id);
			Model = Models.Equip.Find(id, "FGMAPS", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Equip model = new Models.Equip() { Identifier = "FGMAPS" };
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Equip.Find(Navigation.GetStrValue("equip"), "FGMAPS");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Equip() { Identifier = "FGMAPS" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE GMAPS]/
		public override void Save()
		{
			...
			try { Model = Models.Equip.Find(Navigation.GetStrValue("equip"), "FGMAPS"); }
			finally { if (Model == null) Model = new Models.Equip() { Identifier = "FGMAPS" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY GMAPS]/
		...
		{
			Model = Models.Equip.Find(id, "FGMAPS");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
