...
{
	public class Leafletd_ViewModel : FormViewModel<Models.Insta>
	{
		...
		public Leafletd_ViewModel() : base("FLEAFLETD") { }

		public Leafletd_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FLEAFLETD", currentNavigation, nestedForm) { }

		public Leafletd_ViewModel(Models.Insta row, NavigationContext currentNavigation, bool nestedForm = false) : base("FLEAFLETD", row, currentNavigation, nestedForm) { }

		public Leafletd_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("insta", id);
			Model = Models.Insta.Find(id, "FLEAFLETD", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Insta model = new Models.Insta() { Identifier = "FLEAFLETD" };
		...
		public override void MapToModel(Models.Insta m)
		{
			...
			{
				CSGenio.framework.Log.Error("Map ViewModel (Leafletd) to Model (Insta) - Error during mapping");
				throw;
			}
		}
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Insta.Find(Navigation.GetStrValue("insta"), "FLEAFLETD");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Insta() { Identifier = "FLEAFLETD" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE LEAFLETD]/
		public override void Save()
		{
			...
			try { Model = Models.Insta.Find(Navigation.GetStrValue("insta"), "FLEAFLETD"); }
			finally { if (Model == null) Model = new Models.Insta() { Identifier = "FLEAFLETD" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY LEAFLETD]/
		...
		{
			Model = Models.Insta.Find(id, "FLEAFLETD");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
        ...
        public void Load_Leafletdequipregistnr(NameValueCollection qs, bool lazyLoad = false)
        {
            ...
            CriteriaSet leafletdequipregistnrConds = CriteriaSet.And();
            {
                ...
                {
                    leafletdequipregistnrConds.Equal(CSGenioAequip.FldCodequip, Navigation.GetValue("equip"));
			...
			// Area limit
			leafletdequipregistnrDoLoad &= AddCriteriaAreaLimit(leafletdequipregistnrConds, CSGenio.business.CSGenioAtpequ.FldCodtpequ, "tpequ", this.ValCodtpequ, false);
...
// USE /[MANUAL GQT OVERRQ LEAFLETD_EQUIPREGISTNR]/
                ...
                */
                ...
                //EPH
                //leafletdequipregistnrConds = Equip.AddEPH<CSGenioAequip>(ref UserContext.Current.User, leafletdequipregistnrConds, "LED_LEAFLETDEQUIPREGISTNR");

                FieldRef firstVisibleColumn = new FieldRef("equip", "registnr");
                ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(false, leafletdequipregistnrConds, fields, offset, numberItems, sorts, "LED_LEAFLETDEQUIPREGISTNR", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableEquipRegistnr.Elements = listing.RowsForViewModel<GenioMVC.Models.Equip>((r) => new GenioMVC.Models.Equip(r, true, _fieldsToSerialize_LEAFLETDEQUIPREGISTNR));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_LeafletdTableEquipRegistnr(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_LeafletdTableEquipRegistnr(this.ValCodequip, Navigation);
            try
            {
