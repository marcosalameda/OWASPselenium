...
namespace GenioMVC.ViewModels.Item
{
    public class Artiginv_WarehValWarehdes_ViewModel : ListViewModel
    {
        ...
        public Artiginv_WarehValWarehdes_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
// USE /[MANUAL GQT OVERRQLIST ARTIGINV_WAREHDES]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAwareh.GetInformation(), QMVC_POS_RECORD, sorts, artiginvwarehwarehdesConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(false, artiginvwarehwarehdesConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARTIGINVWAREHWAREHDES", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
