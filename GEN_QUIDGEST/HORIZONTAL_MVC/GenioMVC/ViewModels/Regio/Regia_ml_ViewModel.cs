...
{
	public class Regia_ml_ViewModel : FormViewModel<Models.Regio>
	{
		...
		public Regia_ml_ViewModel() : base("FREGIA_ML") { }

		public Regia_ml_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FREGIA_ML", currentNavigation, nestedForm) { }

		public Regia_ml_ViewModel(Models.Regio row, NavigationContext currentNavigation, bool nestedForm = false) : base("FREGIA_ML", row, currentNavigation, nestedForm) { }

		public Regia_ml_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("regio", id);
			Model = Models.Regio.Find(id, "FREGIA_ML", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Regio model = new Models.Regio() { Identifier = "FREGIA_ML" };
		...
		public override void MapToModel(Models.Regio m)
		{
			...
			{
				CSGenio.framework.Log.Error("Map ViewModel (Regia_ml) to Model (Regio) - Error during mapping");
				throw;
			}
		}
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Regio.Find(Navigation.GetStrValue("regio"), "FREGIA_ML");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Regio() { Identifier = "FREGIA_ML" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE REGIA_ML]/
		public override void Save()
		{
			...
			try { Model = Models.Regio.Find(Navigation.GetStrValue("regio"), "FREGIA_ML"); }
			finally { if (Model == null) Model = new Models.Regio() { Identifier = "FREGIA_ML" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY REGIA_ML]/
		...
		{
			Model = Models.Regio.Find(id, "FREGIA_ML");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
        ...
        public void Load_Regia_mlcntrycountry_(NameValueCollection qs, bool lazyLoad = false)
        {
            ...
            CriteriaSet regia_mlcntrycountry_Conds = CriteriaSet.And();
            {
                ...
                {
                    regia_mlcntrycountry_Conds.Equal(CSGenioAcntry.FldCodcntry, Navigation.GetValue("cntry"));
...
// USE /[MANUAL GQT OVERRQ REGIA_ML_CNTRYCOUNTRY]/
                ...
                */
                ...
                //EPH
                //regia_mlcntrycountry_Conds = Cntry.AddEPH<CSGenioAcntry>(ref UserContext.Current.User, regia_mlcntrycountry_Conds, "LED_REGIA_MLCNTRYCOUNTRY_");

                FieldRef firstVisibleColumn = new FieldRef("cntry", "country");
                ListingMVC<CSGenioAcntry> listing = Models.ModelBase.Where<CSGenioAcntry>(false, regia_mlcntrycountry_Conds, fields, offset, numberItems, sorts, "LED_REGIA_MLCNTRYCOUNTRY_", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableCntryCountry.Elements = listing.RowsForViewModel<GenioMVC.Models.Cntry>((r) => new GenioMVC.Models.Cntry(r, true, _fieldsToSerialize_REGIA_MLCNTRYCOUNTRY_));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_Regia_mlTableCntryCountry(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_Regia_mlTableCntryCountry(this.ValCodcntry, Navigation);
            try
            {
        ...
        public void Load_Regia_mlpais1country_(NameValueCollection qs, bool lazyLoad = false)
        {
            ...
            CriteriaSet regia_mlpais1country_Conds = CriteriaSet.And();
            {
                ...
                if (hValue != null && !(hValue is Array) && !String.IsNullOrEmpty(Convert.ToString(hValue)))
                {
                    regia_mlpais1country_Conds.Equal(CSGenioApais1.FldCodcntry, Navigation.GetValue("pais1"));
...
// USE /[MANUAL GQT OVERRQ REGIA_ML_PAIS1COUNTRY]/
                ...
                */
                ...
                //EPH
                //regia_mlpais1country_Conds = Pais1.AddEPH<CSGenioApais1>(ref UserContext.Current.User, regia_mlpais1country_Conds, "LED_REGIA_MLPAIS1COUNTRY_");

                FieldRef firstVisibleColumn = new FieldRef("pais1", "country");
                ListingMVC<CSGenioApais1> listing = Models.ModelBase.Where<CSGenioApais1>(false, regia_mlpais1country_Conds, fields, offset, numberItems, sorts, "LED_REGIA_MLPAIS1COUNTRY_", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TablePais1Country.Elements = listing.RowsForViewModel<GenioMVC.Models.Pais1>((r) => new GenioMVC.Models.Pais1(r, true, _fieldsToSerialize_REGIA_MLPAIS1COUNTRY_));
        ...
        /// <param name="Navigation">Navigation context</param>
        public static ConcurrentDictionary<string, object> GetDependant_Regia_mlTablePais1Country(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_Regia_mlTablePais1Country(this.ValCodpais1, Navigation);
            try
            {
                // That code doesn't include fields of the own control and can be empty if no one dependant field present on the form.
