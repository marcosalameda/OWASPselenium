...
namespace CSGenio.business
{
	...
	/// Notification
	/// </summary>
	public class CSGenioAnoti1 : DbArea	{
		/// <summary>
		/// Meta-information on this area
		/// </summary>
		protected readonly static AreaInfo informacao = InicializaAreaInfo();

		public CSGenioAnoti1(User user, string module)
		{
			fields = new Hashtable();
            this.user = user;
            this.module = module;
			this.KeyType = CodeType.GUID_KEY;
			// USE /[MANUAL GQT CONSTRUTOR NOTI1]/
		}

		public CSGenioAnoti1(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("pess2", new Relation("GQT", "gqtnotif", "noti1", "codnotif", "codpesso", "GQT", "gqtpessoas", "pess2", "codpesso", "codpesso"));
		}
		...
		private static FieldRef m_fldCodnotif = new FieldRef("noti1", "codnotif");
		...
		private static FieldRef m_fldNrcomoda = new FieldRef("noti1", "nrcomoda");

		/// <summary>Field : "No. of the dadato" Tipo: "N" Formula:  ""</summary>
		public decimal ValNrcomoda
		{
		...
		private static FieldRef m_fldBegin = new FieldRef("noti1", "begin");
		...
		private static FieldRef m_fldEnd = new FieldRef("noti1", "end");
		...
		private static FieldRef m_fldEmail = new FieldRef("noti1", "email");
		...
		private static FieldRef m_fldIdnotif = new FieldRef("noti1", "idnotif");
		...
		private static FieldRef m_fldIdmsg = new FieldRef("noti1", "idmsg");
		...
		private static FieldRef m_fldMessage = new FieldRef("noti1", "message");
		...
		private static FieldRef m_fldMailerr = new FieldRef("noti1", "mailerr");
		...
		private static FieldRef m_fldDesignat = new FieldRef("noti1", "designat");
		...
		private static FieldRef m_fldCreatdat = new FieldRef("noti1", "creatdat");
		...
		private static FieldRef m_fldCreatope = new FieldRef("noti1", "creatope");
		...
		private static FieldRef m_fldReturned = new FieldRef("noti1", "returned");
		...
		private static FieldRef m_fldDtdevolu = new FieldRef("noti1", "dtdevolu");
		...
		private static FieldRef m_fldCodpesso = new FieldRef("noti1", "codpesso");
		...
		private static FieldRef m_fldZzstate = new FieldRef("noti1", "zzstate");
        ...
        public static CSGenioAnoti1 search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAnoti1 area = new CSGenioAnoti1(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        [Obsolete("Use List<CSGenioAnoti1> searchList(PersistentSupport sp, User user, CriteriaSet where, string []fields) instead")]
        public static List<CSGenioAnoti1> searchList(PersistentSupport sp, User user, string where, string []fields = null)
        {
            return sp.searchListWhere<CSGenioAnoti1>(where, user, fields);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAnoti1> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAnoti1>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAnoti1> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAnoti1>(where, listing);
        }
