...
namespace CSGenio.business
{
	...
	/// Region
	/// </summary>
	public class CSGenioAregi1 : DbArea	{
		/// <summary>
		/// Meta-information on this area
		/// </summary>
		protected readonly static AreaInfo informacao = InicializaAreaInfo();

		public CSGenioAregi1(User user, string module)
		{
			fields = new Hashtable();
            this.user = user;
            this.module = module;
			this.KeyType = CodeType.GUID_KEY;
			// USE /[MANUAL GQT CONSTRUTOR REGI1]/
		}

		public CSGenioAregi1(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codpais1", FieldType.CHAVE_FALSA_GUID);
			Qfield.FieldDescription = "";
			Qfield.FieldSize =  36;
			Qfield.Alias = info.Alias;
			Qfield.CavDesignation = "";
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("pais1", new Relation("GQT", "gqtregio", "regi1", "codregia", "codcntry", "GQT", "gqtcntry", "pais1", "codcntry", "codcntry"));
		}
		...
		private static FieldRef m_fldCodregia = new FieldRef("regi1", "codregia");
		...
		private static FieldRef m_fldCodcntry = new FieldRef("regi1", "codcntry");
		...
		private static FieldRef m_fldRegiao = new FieldRef("regi1", "regiao");
		...
		private static FieldRef m_fldCodpais1 = new FieldRef("regi1", "codpais1");
		...
		private static FieldRef m_fldZzstate = new FieldRef("regi1", "zzstate");
        ...
        public static CSGenioAregi1 search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAregi1 area = new CSGenioAregi1(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        [Obsolete("Use List<CSGenioAregi1> searchList(PersistentSupport sp, User user, CriteriaSet where, string []fields) instead")]
        public static List<CSGenioAregi1> searchList(PersistentSupport sp, User user, string where, string []fields = null)
        {
            return sp.searchListWhere<CSGenioAregi1>(where, user, fields);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAregi1> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAregi1>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAregi1> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAregi1>(where, listing);
        }
