...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX ASSMA]/
		...
		public ActionResult Assma_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("assma", Convert.ToString(Navigation.CurrentLevel.GetEntry("assma"))) : saveMsg);
