...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX DISPA]/
		...
		public ActionResult Dispa_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("dispa", Convert.ToString(Navigation.CurrentLevel.GetEntry("dispa"))) : saveMsg);
