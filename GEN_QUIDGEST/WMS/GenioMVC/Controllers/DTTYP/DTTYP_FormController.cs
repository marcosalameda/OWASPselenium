...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX DTTYP]/
		...
		public ActionResult Dttyp_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("dttyp", Convert.ToString(Navigation.CurrentLevel.GetEntry("dttyp"))) : saveMsg);
