...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX FACTY]/
		...
		public ActionResult Facty_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("facty", Convert.ToString(Navigation.CurrentLevel.GetEntry("facty"))) : saveMsg);
