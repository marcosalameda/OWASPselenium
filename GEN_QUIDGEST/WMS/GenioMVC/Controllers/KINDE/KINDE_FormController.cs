...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX KINDE]/
		...
		public ActionResult Kinde_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("kinde", Convert.ToString(Navigation.CurrentLevel.GetEntry("kinde"))) : saveMsg);
