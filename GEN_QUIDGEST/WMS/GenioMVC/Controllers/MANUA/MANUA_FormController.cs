...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX MANUA]/
		...
		public ActionResult Manua_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("manua", Convert.ToString(Navigation.CurrentLevel.GetEntry("manua"))) : saveMsg);
