...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX MESSA]/
		...
		public ActionResult Messa_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("messa", Convert.ToString(Navigation.CurrentLevel.GetEntry("messa"))) : saveMsg);
