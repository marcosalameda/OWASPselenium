...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX PARAM]/
		...
		public ActionResult Param_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("param", Convert.ToString(Navigation.CurrentLevel.GetEntry("param"))) : saveMsg);
