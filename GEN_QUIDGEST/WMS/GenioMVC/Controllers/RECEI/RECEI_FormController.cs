...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX RECEI]/
		...
		public ActionResult Recei_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFETUADAS10166 + GetHumanKeyToQMessage("recei", Convert.ToString(Navigation.CurrentLevel.GetEntry("recei"))) : saveMsg);
