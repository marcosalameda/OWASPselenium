...
// USE /[MANUAL GQT AFTER_LOAD_EDIT_EX USERS]/
		...
		public ActionResult Users_Edit_Redirect(bool internalRedirect = false)
		{
			...
			if (!internalRedirect || !Request.IsAjaxRequest())
				SuccessMessage(String.IsNullOrEmpty(saveMsg) ? Resources.Resources.ALTERACOES_EFECTUADA64514 + GetHumanKeyToQMessage("users", Convert.ToString(Navigation.CurrentLevel.GetEntry("users"))) : saveMsg);
