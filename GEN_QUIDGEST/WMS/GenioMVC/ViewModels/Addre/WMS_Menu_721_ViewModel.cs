...
FieldRef[] fields = new FieldRef[] { CSGenioAaddre.FldCodaddre, CSGenioAaddre.FldZzstate, CSGenioAaddre.FldAddressuse, CSGenioAaddre.FldAddresstype, CSGenioAaddre.FldAddresstext, CSGenioAaddre.FldAddresscity, CSGenioAaddre.FldAddressdistrict, CSGenioAaddre.FldAddressstate, CSGenioAaddre.FldAddresspostalcode, CSGenioAaddre.FldAddresscountry, CSGenioAaddre.FldPeriodstart, CSGenioAaddre.FldPeriodend };
        ...
        public WMS_Menu_721_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioAaddre.FldCodaddre, CSGenioAaddre.FldZzstate, CSGenioAaddre.FldAddressuse, CSGenioAaddre.FldAddresstype, CSGenioAaddre.FldAddresstext, CSGenioAaddre.FldAddresscity, CSGenioAaddre.FldAddressdistrict, CSGenioAaddre.FldAddressstate, CSGenioAaddre.FldAddresspostalcode, CSGenioAaddre.FldAddresscountry, CSGenioAaddre.FldPeriodstart, CSGenioAaddre.FldPeriodend };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				CSGenioAaddre model_limit_area = new CSGenioAaddre(UserContext.Current.User);
			...
			CriteriaSet wms_menu_721Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL WMS OVERRQ 721]/

            // This will happen in case there is an error
            if(wms_menu_721Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAaddre>(false, wms_menu_721Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML721", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL WMS OVERRQLSTEXP 721]/

                conditions = wms_menu_721Conds;
                return;
			}
...
// USE /[MANUAL WMS OVERRQLIST 721]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAaddre.GetInformation(), QMVC_POS_RECORD, sorts, wms_menu_721Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAaddre> listing = Models.ModelBase.Where<CSGenioAaddre>(false, wms_menu_721Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML721", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
        ...
        {
            var model = new Models.Addre(true, _fieldsToSerialize);
            if (row == null)
                return model;
