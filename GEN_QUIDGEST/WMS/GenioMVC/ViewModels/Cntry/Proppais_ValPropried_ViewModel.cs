...
{
    public class Proppais_ValPropried_ViewModel : ListViewModel
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "Proppais_ValPropried"; }
        ...
        public Proppais_ValPropried_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApropr> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Proppais_ValPropried", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Proppais_ValPropried"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Proppais_ValPropried");
...
FieldRef[] fields = new FieldRef[] { CSGenioApropr.FldCodpropr, CSGenioApropr.FldZzstate, CSGenioApropr.FldPhotogra, CSGenioApropr.FldName, CSGenioApropr.FldPrecoest, CSGenioApropr.FldCodtppro, CSGenioAtppro.FldCodtppro, CSGenioAtppro.FldTppropri, CSGenioApropr.FldMobilada, CSGenioApropr.FldCodcntry, CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldCountry, CSGenioApropr.FldCodregia, CSGenioAregio.FldCodregia, CSGenioAregio.FldRegiao, CSGenioApropr.FldEndereco, CSGenioApropr.FldLocalida, CSGenioApropr.FldPostalco, CSGenioApropr.FldPostallo, CSGenioApropr.FldQtd_wc, CSGenioApropr.FldQtdquart, CSGenioApropr.FldM2, CSGenioApropr.FldDtdispon, CSGenioApropr.FldDescript, CSGenioApropr.FldCoordgeo, CSGenioApropr.FldCodpesso, CSGenioApesso.FldCodpesso, CSGenioApesso.FldName };
			...
			CriteriaSet proppaispseudpropriedConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ PROPPAIS_PSEUDPROPRIED]/

            // This will happen in case there is an error
            if(proppaispseudpropriedConds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioApropr>(false, proppaispseudpropriedConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPPAISPSEUDPROPRIED", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP PROPPAIS_PSEUDPROPRIED]/

                conditions = proppaispseudpropriedConds;
                return;
			}
...
// USE /[MANUAL GQT OVERRQLIST PROPPAIS_PSEUDPROPRIED]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioApropr.GetInformation(), QMVC_POS_RECORD, sorts, proppaispseudpropriedConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioApropr> listing = Models.ModelBase.Where<CSGenioApropr>(false, proppaispseudpropriedConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPPAISPSEUDPROPRIED", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				foreach (GenioMVC.Models.Propr Propr in listing.RowsForViewModel<GenioMVC.Models.Propr>((r) => new GenioMVC.Models.Propr(r, true))) {
                    ...
                    clonedNavigation.AddHistoryLevel(new NavigationLocation("", "Proprall_Show", "Propr") { vueRouteName = "form-PROPRALL", mode = "CANCEL" }, FormMode.Show);
                    tempList.Add(new GenioMVC.ViewModels.Propr.Proprall_ViewModel(Propr, Navigation));
                }
