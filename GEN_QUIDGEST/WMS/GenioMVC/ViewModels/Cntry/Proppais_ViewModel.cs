...
namespace GenioMVC.ViewModels.Cntry
{
	public class Proppais_ViewModel : FormViewModel<Models.Cntry>
	{
		...
		/// <summary>Campo : "Properties" Tipo:"DF"</summary>
		[Display(Name = "PROPERTIES34868", ResourceType = typeof(Resources.Resources))]
		public object ValPropried { get; set; }
		...
		public Proppais_ViewModel() : base("FPROPPAIS") { }

		public Proppais_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FPROPPAIS", currentNavigation, nestedForm) { }

		public Proppais_ViewModel(Models.Cntry row, NavigationContext currentNavigation, bool nestedForm = false) : base("FPROPPAIS", row, currentNavigation, nestedForm) { }

		public Proppais_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("cntry", id);
			Model = Models.Cntry.Find(id, "FPROPPAIS", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Cntry model = new Models.Cntry() { Identifier = "FPROPPAIS" };
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Cntry.Find(Navigation.GetStrValue("cntry"), "FPROPPAIS");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Cntry() { Identifier = "FPROPPAIS" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE PROPPAIS]/
		public override void Save()
		{
			...
			try { Model = Models.Cntry.Find(Navigation.GetStrValue("cntry"), "FPROPPAIS"); }
			finally { if (Model == null) Model = new Models.Cntry() { Identifier = "FPROPPAIS" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY PROPPAIS]/
		...
		{
			Model = Models.Cntry.Find(id, "FPROPPAIS");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
