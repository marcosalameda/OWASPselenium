...
namespace GenioMVC.ViewModels.Dilin
{
    public class Dilin_DispaValDispanr_ViewModel : ListViewModel
    {
        ...
        /// <inheritdoc/>
        public override string Uuid { get => "Dilin_DispaValDispanr"; }
        ...
        public Dilin_DispaValDispanr_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioAdispa.FldCoddispa, CSGenioAdispa.FldZzstate, CSGenioAdispa.FldDispanr };
			...
			CriteriaSet dilin___dispadispanr_Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ DILIN_DISPANR]/

            // This will happen in case there is an error
            if(dilin___dispadispanr_Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAdispa>(false, dilin___dispadispanr_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DILIN___DISPADISPANR_", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP DILIN_DISPANR]/

                conditions = dilin___dispadispanr_Conds;
                return;
			}
...
// USE /[MANUAL GQT OVERRQLIST DILIN_DISPANR]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioAdispa.GetInformation(), QMVC_POS_RECORD, sorts, dilin___dispadispanr_Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAdispa> listing = Models.ModelBase.Where<CSGenioAdispa>(false, dilin___dispadispanr_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DILIN___DISPADISPANR_", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
