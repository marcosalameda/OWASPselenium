...
namespace GenioMVC.ViewModels.Entit
{
	public class Entix_ViewModel : FormViewModel<Models.Entit>
	{
		...
		public TablePartial<GenioMVC.Models.Facil> ValFacilite { get; set; }
		...
		public Entix_ViewModel() : base("FENTIX") { }

		public Entix_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FENTIX", currentNavigation, nestedForm) { }

		public Entix_ViewModel(Models.Entit row, NavigationContext currentNavigation, bool nestedForm = false) : base("FENTIX", row, currentNavigation, nestedForm) { }

		public Entix_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("entit", id);
			Model = Models.Entit.Find(id, "FENTIX", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Entit model = new Models.Entit() { Identifier = "FENTIX" };
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Entit.Find(Navigation.GetStrValue("entit"), "FENTIX");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Entit() { Identifier = "FENTIX" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE ENTIX]/
		public override void Save()
		{
			...
			try { Model = Models.Entit.Find(Navigation.GetStrValue("entit"), "FENTIX"); }
			finally { if (Model == null) Model = new Models.Entit() { Identifier = "FENTIX" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY ENTIX]/
		...
		{
			Model = Models.Entit.Find(id, "FENTIX");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
...
// USE /[MANUAL GQT OVERRQ ENTIX_FACI1NAME]/
                ...
                */
                ...
                //EPH
                //entix___faci1name____Conds = Faci1.AddEPH<CSGenioAfaci1>(ref UserContext.Current.User, entix___faci1name____Conds, "LED_ENTIX___FACI1NAME____");

                FieldRef firstVisibleColumn = null;
                ListingMVC<CSGenioAfaci1> listing = Models.ModelBase.Where<CSGenioAfaci1>(false, entix___faci1name____Conds, fields, offset, numberItems, sorts, "LED_ENTIX___FACI1NAME____", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableFaci1Name.Elements = listing.RowsForViewModel<GenioMVC.Models.Faci1>((r) => new GenioMVC.Models.Faci1(r, true, _fieldsToSerialize_ENTIX___FACI1NAME____));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_EntixTableFaci1Name(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_EntixTableFaci1Name(this.ValFirstfacilitie, Navigation);
            try
            {
...
// USE /[MANUAL GQT OVERRQ ENTIX_FACI2NAME]/
                ...
                */
                ...
                //EPH
                //entix___faci2name____Conds = Faci2.AddEPH<CSGenioAfaci2>(ref UserContext.Current.User, entix___faci2name____Conds, "LED_ENTIX___FACI2NAME____");

                FieldRef firstVisibleColumn = null;
                ListingMVC<CSGenioAfaci2> listing = Models.ModelBase.Where<CSGenioAfaci2>(false, entix___faci2name____Conds, fields, offset, numberItems, sorts, "LED_ENTIX___FACI2NAME____", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableFaci2Name.Elements = listing.RowsForViewModel<GenioMVC.Models.Faci2>((r) => new GenioMVC.Models.Faci2(r, true, _fieldsToSerialize_ENTIX___FACI2NAME____));
        ...
        /// <param name="Navigation">Navigation context</param>
        public static ConcurrentDictionary<string, object> GetDependant_EntixTableFaci2Name(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_EntixTableFaci2Name(this.ValLastfacilitie, Navigation);
            try
            {
                // That code doesn't include fields of the own control and can be empty if no one dependant field present on the form.
