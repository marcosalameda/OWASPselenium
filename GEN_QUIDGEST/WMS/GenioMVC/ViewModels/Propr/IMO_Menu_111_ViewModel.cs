...
FieldRef[] fields = new FieldRef[] { CSGenioApropr.FldCodpropr, CSGenioApropr.FldZzstate, CSGenioApropr.FldName, CSGenioApropr.FldPrecoest, CSGenioApropr.FldCodtppro, CSGenioAtppro.FldCodtppro, CSGenioAtppro.FldTppropri, CSGenioApropr.FldEndereco, CSGenioApropr.FldLocalida, CSGenioApropr.FldCodregia, CSGenioAregio.FldCodregia, CSGenioAregio.FldRegiao, CSGenioApropr.FldPostalco, CSGenioApropr.FldPostallo, CSGenioApropr.FldCodcntry, CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldCountry, CSGenioApropr.FldMobilada, CSGenioApropr.FldQtd_wc, CSGenioApropr.FldQtdquart, CSGenioApropr.FldM2, CSGenioApropr.FldDtdispon, CSGenioApropr.FldPhotogra, CSGenioApropr.FldDescript };
        ...
        public IMO_Menu_111_ViewModel(NavigationContext currentNavigation) : base(currentNavigation)
        {
...
FieldRef[] fields = new FieldRef[] { CSGenioApropr.FldCodpropr, CSGenioApropr.FldZzstate, CSGenioApropr.FldName, CSGenioApropr.FldPrecoest, CSGenioApropr.FldCodtppro, CSGenioAtppro.FldCodtppro, CSGenioAtppro.FldTppropri, CSGenioApropr.FldEndereco, CSGenioApropr.FldLocalida, CSGenioApropr.FldCodregia, CSGenioAregio.FldCodregia, CSGenioAregio.FldRegiao, CSGenioApropr.FldPostalco, CSGenioApropr.FldPostallo, CSGenioApropr.FldCodcntry, CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldCountry, CSGenioApropr.FldMobilada, CSGenioApropr.FldQtd_wc, CSGenioApropr.FldQtdquart, CSGenioApropr.FldM2, CSGenioApropr.FldDtdispon, CSGenioApropr.FldPhotogra, CSGenioApropr.FldDescript };
			...
			CriteriaSet imo_menu_111Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
            tableReload &= hasAllRequiredLimits;

// USE /[MANUAL IMO OVERRQ 111]/

            // This will happen in case there is an error
            if(imo_menu_111Conds == null)
                return;
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioApropr>(false, imo_menu_111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL IMO OVERRQLSTEXP 111]/

                conditions = imo_menu_111Conds;
                return;
			}
...
// USE /[MANUAL IMO OVERRQLIST 111]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = UserContext.Current.PersistentSupport.getPagingPos(CSGenioApropr.GetInformation(), QMVC_POS_RECORD, sorts, imo_menu_111Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioApropr> listing = Models.ModelBase.Where<CSGenioApropr>(false, imo_menu_111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
