...
{
	public class Regiapro_ViewModel : FormViewModel<Models.Regio>
	{
		...
		/// <summary>Campo : "Non Limited Properties" Tipo:"DA"</summary>
		[Display(Name = "NON_LIMITED_PROPERTI11098", ResourceType = typeof(Resources.Resources))]
		public TablePartial<GenioMVC.Models.Propr> ValImoveiss { get; set; }

		/// <summary>Campo : "Properties" Tipo:"DP"</summary>
		[Display(Name = "PROPERTIES34868", ResourceType = typeof(Resources.Resources))]
		public TablePartial<GenioMVC.Models.Propr> ValImoveisl { get; set; }

		/// <summary>Campo : "Properties" Tipo:"DP"</summary>
		[Display(Name = "PROPERTIES34868", ResourceType = typeof(Resources.Resources))]
		public TablePartial<GenioMVC.Models.Propr> ValImoveisg { get; set; }
		...
		public Regiapro_ViewModel() : base("FREGIAPRO") { }

		public Regiapro_ViewModel(NavigationContext currentNavigation, bool nestedForm = false) : base("FREGIAPRO", currentNavigation, nestedForm) { }

		public Regiapro_ViewModel(Models.Regio row, NavigationContext currentNavigation, bool nestedForm = false) : base("FREGIAPRO", row, currentNavigation, nestedForm) { }

		public Regiapro_ViewModel(NavigationContext currentNavigation, string id, bool nestedForm = false, string[] fieldsToLoad = null) : this(currentNavigation, nestedForm)
		{
			this.Navigation.SetValue("regio", id);
			Model = Models.Regio.Find(id, "FREGIAPRO", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(NavigationContext navigation)
		{
			...
			Models.Regio model = new Models.Regio() { Identifier = "FREGIAPRO" };
		...
		public override void MapToModel(Models.Regio m)
		{
			...
			{
				CSGenio.framework.Log.Error("Map ViewModel (Regiapro) to Model (Regio) - Error during mapping");
				throw;
			}
		}
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Regio.Find(Navigation.GetStrValue("regio"), "FREGIAPRO");
			}
			finally
			{
				if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
				{
					if (Model == null)
					{
						Model = new Models.Regio() { Identifier = "FREGIAPRO" };
...
// USE /[MANUAL GQT VIEWMODEL_SAVE REGIAPRO]/
		public override void Save()
		{
			...
			try { Model = Models.Regio.Find(Navigation.GetStrValue("regio"), "FREGIAPRO"); }
			finally { if (Model == null) Model = new Models.Regio() { Identifier = "FREGIAPRO" }; }
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY REGIAPRO]/
		...
		{
			Model = Models.Regio.Find(id, "FREGIAPRO");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
        ...
        public void Load_Regiaprocntrycountry_(NameValueCollection qs, bool lazyLoad = false)
        {
            ...
            CriteriaSet regiaprocntrycountry_Conds = CriteriaSet.And();
            {
                ...
                {
                    regiaprocntrycountry_Conds.Equal(CSGenioAcntry.FldCodcntry, Navigation.GetValue("cntry"));
...
// USE /[MANUAL GQT OVERRQ REGIAPRO_CNTRYCOUNTRY]/
                ...
                */
                ...
                //EPH
                //regiaprocntrycountry_Conds = Cntry.AddEPH<CSGenioAcntry>(ref UserContext.Current.User, regiaprocntrycountry_Conds, "LED_REGIAPROCNTRYCOUNTRY_");

                FieldRef firstVisibleColumn = new FieldRef("cntry", "country");
                ListingMVC<CSGenioAcntry> listing = Models.ModelBase.Where<CSGenioAcntry>(false, regiaprocntrycountry_Conds, fields, offset, numberItems, sorts, "LED_REGIAPROCNTRYCOUNTRY_", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TableCntryCountry.Elements = listing.RowsForViewModel<GenioMVC.Models.Cntry>((r) => new GenioMVC.Models.Cntry(r, true, _fieldsToSerialize_REGIAPROCNTRYCOUNTRY_));
        ...
        public static ConcurrentDictionary<string, object> GetDependant_RegiaproTableCntryCountry(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_RegiaproTableCntryCountry(this.ValCodcntry, Navigation);
            try
            {
        ...
        public void Load_Regiapropais1country_(NameValueCollection qs, bool lazyLoad = false)
        {
            ...
            CriteriaSet regiapropais1country_Conds = CriteriaSet.And();
            {
                ...
                if (hValue != null && !(hValue is Array) && !String.IsNullOrEmpty(Convert.ToString(hValue)))
                {
                    regiapropais1country_Conds.Equal(CSGenioApais1.FldCodcntry, Navigation.GetValue("pais1"));
...
// USE /[MANUAL GQT OVERRQ REGIAPRO_PAIS1COUNTRY]/
                ...
                */
                ...
                //EPH
                //regiapropais1country_Conds = Pais1.AddEPH<CSGenioApais1>(ref UserContext.Current.User, regiapropais1country_Conds, "LED_REGIAPROPAIS1COUNTRY_");

                FieldRef firstVisibleColumn = new FieldRef("pais1", "country");
                ListingMVC<CSGenioApais1> listing = Models.ModelBase.Where<CSGenioApais1>(false, regiapropais1country_Conds, fields, offset, numberItems, sorts, "LED_REGIAPROPAIS1COUNTRY_", true, false, firstVisibleColumn: firstVisibleColumn);
                ...
                TablePais1Country.Elements = listing.RowsForViewModel<GenioMVC.Models.Pais1>((r) => new GenioMVC.Models.Pais1(r, true, _fieldsToSerialize_REGIAPROPAIS1COUNTRY_));
        ...
        /// <param name="Navigation">Navigation context</param>
        public static ConcurrentDictionary<string, object> GetDependant_RegiaproTablePais1Country(string PKey, NavigationContext Navigation)
        {
        ...
        {
            var row = GetDependant_RegiaproTablePais1Country(this.ValCodpais1, Navigation);
            try
            {
                // That code doesn't include fields of the own control and can be empty if no one dependant field present on the form.
