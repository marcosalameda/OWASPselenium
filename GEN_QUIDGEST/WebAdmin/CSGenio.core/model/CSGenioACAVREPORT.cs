...
namespace CSGenio.business
{
	...
	public class CSGenioAcavreport : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
            ...
            info.RegisterFieldDB(new Field(info.Alias, "title", FieldType.TEXTO));
	        info.RegisterFieldDB(new Field(info.Alias, "acesso", FieldType.TEXTO));
		...
		// USE /[MANUAL GQT TABAUX cavreport]/
