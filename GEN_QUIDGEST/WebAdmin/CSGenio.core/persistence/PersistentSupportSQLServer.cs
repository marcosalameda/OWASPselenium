    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("GQTMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("GQTMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("GQTMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("GQTMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("GQTMQQueues_History", "ANO", "ANO")
                            .Select("GQTMQQueues_History", "USERNAME", "USERNAME")
                            .Select("GQTMQQueues_History", "TABELA", "TABELA")
                            .Select("GQTMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("GQTMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("GQTMQQueues_History", "QUEUE", "QUEUE")
                            .Select("GQTMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("GQTMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("GQTMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("GQTMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("GQTMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("GQTMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("GQTMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("GQTMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("GQTMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.GQTMQQueues_History";
