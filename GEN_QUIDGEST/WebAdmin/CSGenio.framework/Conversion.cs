...
namespace CSGenio.framework
{
    ...
    public static class Conversion
    {
        ...
        public static object string2TypeInternal(string fieldValue,FieldFormatting fieldFormatting)
        {
            ...
            switch(fieldFormatting)
            {
              ...
              case FieldFormatting.FLOAT:
                 valorInterno = string2Double(fieldValue);
                 break;
        ...
        /// <summary>
        /// Método que transforma o Qvalue do objecto em double
        /// </summary>
        /// <param name="valorCampo">Qvalue do Qfield</param>
        /// <returns>Qvalue do Qfield convertido</returns>
        public static double string2Double(string fieldValue)
        {
            ...
            return string2Double(fieldValue, provider);
        }
        ...
        /// <returns>The converted value (double) or Zero when conversion was not succeeded</returns>
        public static double string2Double(string fieldValue, NumberFormatInfo provider)
        {
            try
            {
                if (fieldValue.Equals(""))
                    return 0.0;
                double Qvalue = Convert.ToDouble(fieldValue, provider);
                
                return Qvalue;
            }
            catch (Exception ex)
            {
                FrameworkException ef = new FrameworkException("Error converting from string to double.", "Conversion.string2Double", "Error converting from string to double: " + ex.Message, ex);
                return 0.0;
            }
        }
        ...
        public static object internal2InternalValid(object fieldValue, FieldFormatting forField)
        {
            switch (forField)
            {
                ...
                case FieldFormatting.FLOAT:
                    return internalDouble2InternalValidDouble(fieldValue);
                case FieldFormatting.DATAHORA:
                case FieldFormatting.DATA:
                case FieldFormatting.DATASEGUNDO:
        ...
        /// <param name="valorCampo">Qvalue do Qfield</param>
        /// <returns>Qfield string formatado</returns>
        public static double internalDouble2InternalValidDouble(object fieldValue)
        {
            if (fieldValue == null || fieldValue == DBNull.Value)
                return 0.0;
            else if (fieldValue is double)
                ...
                return decimal.ToDouble(Convert.ToDecimal(fieldValue));
            else if (fieldValue is byte)
                return (double)((byte)fieldValue);
            else if (fieldValue is short)
                return (double)((short)fieldValue);
            else if (fieldValue is int)
                return (double)((int)fieldValue);
            else if (fieldValue is long)
                return (double)((long)fieldValue);
            else if (fieldValue is decimal)
                return decimal.ToDouble((decimal)fieldValue);
            else if (fieldValue is string)
            {
                if (fieldValue.Equals(""))
                    return 0.0;
                ...
                {
                    double Qvalue = 0.0;
                    if (double.TryParse(fieldValue.ToString(), out Qvalue))
                        return double.Parse(Qvalue.ToString());
                    else
                        return 0.0;
                }
            }
            else
                throw new FrameworkException(null, "Conversion.internoDouble2InternoValidoDouble", "Error converting from database value to double: " + fieldValue);
        }
        ...
        /*
        /// <summary>
        /// Método que converte de tipo interno to tipo aceite pela BD
        /// </summary>
        /// <param name="valorCampo">Value do Qfield</param>
        /// <param name="format">Formato do Qfield</param>
        /// <returns>o Qvalue do Qfield convertido</returns>
        [Obsolete("Use persistence.ConversaoBD.FromInterno(valorCampo, format) instead")]
        public static string Internal2Db(object fieldValue, FieldFormatting format)
        {
            switch(format)
            {
              case FieldFormatting.TEMPO:
              case FieldFormatting.CARACTERES:
                return internalString2DbString(fieldValue);
              case FieldFormatting.GUID:
                return internalKey2DbKey(fieldValue);
              case FieldFormatting.INTEIRO:
              case FieldFormatting.LOGICO:
                return internalInt2DbInt(fieldValue);
              case FieldFormatting.FLOAT:
                return internalDouble2DbDouble(fieldValue);
              case FieldFormatting.DATAHORA:
              case FieldFormatting.DATA:
                return internalDateTime2DbDateTime(fieldValue);
              case FieldFormatting.JPEG:
                return internalByteArray2DbBinary(fieldValue);
              case FieldFormatting.BINARIO:
                return internalByteArray2DbBinary(fieldValue);
            }
            throw new FrameworkException(null, "Conversion.tpInterno2tpBD", "Error converting value " + fieldValue.ToString() + " to database type " + format + ".");
        }
        */
        /// <summary>
        ...
        /// <param name="valorCampo">Qvalue Qfield</param>
        /// <returns>a string com o Qfield convertido to ser aceite na BD</returns>
        [Obsolete("Use persistence.ConversaoBD.FromNumeric(valorCampo) instead")]
        public static string internalDouble2DbDouble(object fieldValue)
        {
            if (fieldValue == null)
                return "0.0";
            else
        ...
        /// <param name="valorCampo">Qvalue Qfield</param>
        /// <returns>a string com o Qfield convertido to ser aceite na BD</returns>
        [Obsolete("Use persistence.ConversaoBD.FromDate(valorCampo) instead")]
        public static string internalDateTime2DbDateTime(object fieldValue)
        {
            if (fieldValue == null || fieldValue ==DBNull.Value)
                return "NULL";
            else
            {
                if (fieldValue is DateTime)
                {
                    ...
                    if (data.Equals(DateTime.MinValue))
                        return "NULL";
                    return Conversion.dateTime2DateStringConverted(data);
                }
                if (fieldValue is string)
                    return Conversion.dateString2DateStringConverted(fieldValue.ToString());
                else
                    throw new FrameworkException(null, "Conversion.tpInternoDateTime2tpBDDateTime", "Error converting from internal type to string: " + fieldValue.ToString());
            }
        }
        */
        /// <summary>
        ...
        /*
        /// <summary>
        /// Método que transforma um objecto do tipo DateTime numa string usada em queries
        /// </summary>
        /// <param name="data">data a converter</param>
        /// <returns>uma string usada em queries</returns>
        public static string dateTime2DateStringConverted(DateTime data)
        {
            if (data.Equals(DateTime.MinValue))
                return "NULL";
#pragma warning disable 618 //TODO ficam marcados assim explicitamente to saber quer tem de ser mudado
            DatabaseType connectionType = Configuration.LegacyConnectionType;
#pragma warning restore 618
            string dataString;
            if (connectionType.Equals(DatabaseType.ACCESS))
                dataString = "#" + data.Month + "/" + data.Day + "/" + data.Year + "#";
            else if (connectionType.Equals(DatabaseType.SQLSERVER2000) || connectionType.Equals(DatabaseType.SQLSERVER2005) || connectionType.Equals(DatabaseType.SQLSERVER2008))
                dataString = "convert(datetime, '" + data.Day + "/" + data.Month + "/" + data.Year + " " + data.ToLongTimeString() + "', 103)";
            else if (connectionType.Equals(DatabaseType.ORACLE))//passa a suportar fields do tipo DATAHORA (se o time do Qfield deve ser truncado a responsabilidade não é desta função)
                dataString = "TO_DATE('" + data.Year + "/" + data.Month + "/" + data.Day + " "+data.Hour+":"+data.Minute+ ":" +data.Second+"', 'YYYY/MM/DD hh24:mi:ss')";
            else
                throw new FrameworkException(null, "Conversion.dateTime2DataStringConvertida", "Error converting from DateTime to string: " + data.ToString());

            return dataString;
        }

        /// <summary>
        /// Método converte uma data num format aceite por queries
        /// </summary>
        /// <param name="cond">data recebida no pedido</param>
        /// <returns>Data convertida to format aceite por queries</returns>
        public static string dateString2DateStringConverted(string cond)
        {
            try
            {
                DateTime data = dateString2DateTime(cond);
                return dateTime2DateStringConverted(data);
            }
            catch (GenioException ex)
            {
                throw new FrameworkException(ex.UserMessage, "Conversion.dataString2DataStringConvertida", "Error convertint string to date string for queries: " + ex.Message, ex);
            }
            catch (Exception ex)
            {
                throw new FrameworkException(null, "Conversion.dataString2DataStringConvertida", "Error convertint string to date string for queries: " + ex.Message, ex);
            }
        }
        */
        /// <summary>
                ...
                switch (forField)
                {
                    ...
                    case FieldFormatting.FLOAT:
                        if (tpField.Equals(FieldType.ARRAY_COD_NUMERICO))
                            ...
                            return internalDouble2String(fieldValue);
                    case FieldFormatting.DATAHORA:
                    case FieldFormatting.DATASEGUNDO:
                        if (fieldValue is DateTime)
        ...
        /// <param name="valorCampo">Qvalue Qfield</param>
        /// <returns>a string com o Qfield convertido to ser aceite na BD</returns>
        public static string internalDouble2String(object fieldValue)
        {
            if (fieldValue == null || fieldValue ==DBNull.Value)
                return "0.0";
            else
