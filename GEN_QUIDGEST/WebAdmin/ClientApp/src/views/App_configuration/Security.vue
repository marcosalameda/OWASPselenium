<template>
	<div id="app_config_security_container">
		<QGroupBoxContainer :label="Resources.AUTENTICACAO37999">
			<q-row-container>
				<q-control-wrapper class="control-row-group">
					<base-input-structure
						...
						<select-input
							...
							v-if="SelectLists"
							size="xlarge"
							:options="SelectLists.AuthenticationMode" 
				...
				<q-control-wrapper class="control-row-group">
					<base-input-structure
						...
						<select-input
							...
							v-if="SelectLists"
							size="xlarge"
							:options="SelectLists.MultisessionMode"
				...
				<q-control-wrapper class="control-row-group" v-if="Security.Activate2FA">
					<base-input-structure
						class="i-text">
						<checkbox-input
		...
		<QGroupBoxContainer :label="Resources.POLITICA_DE_PASSWORD17131">
			<q-row-container>
				<q-control-wrapper class="control-row-group">
					<base-input-structure
						class="i-text">
				...
				<q-control-wrapper class="control-row-group">
					<base-input-structure
						...
						<select-input
							...
							v-if="SelectLists"
							size="xlarge"
							:options="SelectLists.PasswordStrength" 
							:label="Resources.MODO_DE_AUTENTICACAO19339">
						</select-input>
					</base-input-structure>
				</q-control-wrapper>
				...
				<q-control-wrapper class="control-row-group">
					<base-input-structure
						...
						<select-input
							...
							v-if="SelectLists"
							size="xlarge"
							:options="SelectLists.PasswordAlgorithms"
				...
				<q-control-wrapper class="control-row-group">
					<base-input-structure
						...
						<q-button
							...
							@click.prevent="navigateTo($event, 'manage_blacklist')" />
					</base-input-structure>
				</q-control-wrapper>
			</q-row-container>
		</QGroupBoxContainer>
...
<script>
	...
	import modal_identity_provider from '../System_setup/IdentityProvider.vue';
	import modal_role_provider from '../System_setup/RoleProvider.vue';
	...
	export default {
		...
		showIdentityProviderModal(mode, identityProvider) {
			var vm = this;
		...
		showRoleProviderModal(mode, roleProvider) {
			var vm = this;
		...
		callbackIdentityProvider(eventData) {
			var vm = this;
		...
		changeRoleProvider(roleProvider) {
			var vm = this;
			vm.showRoleProviderModal('edit', roleProvider);
		},
		deleteRoleProvider(roleProvider) {
			var vm = this;
		...
		callbackRoleProvider(eventData) {
			var vm = this;
			switch (eventData.mode) {
			case 'new':
