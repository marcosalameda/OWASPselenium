...
SET @SQL = N'
CREATE DATABASE [ASPStateGQT]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateGQT'', FILENAME = N''' + @SQLDataFolder + 'ASPStateGQT.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateGQT_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateGQT_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateGQT_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateGQT_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateGQT_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateGQT] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateGQT] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
