...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codcity", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codctry", FieldType.CHAVE_ESTRANGEIRA_GUID);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ChildTable[0]= new ChildRelation("prope", new String[] {"codcity"}, DeleteProc.NA);

			// Mother Relations
			//------------------------------
			info.ParentTables = new Dictionary<string, Relation>();
			info.ParentTables.Add("ctry", new Relation("GQT", "gqtcity", "city", "codcity", "codctry", "GQT", "gqtctry", "ctry", "codctry", "codctry"));
		}
		...
		private static FieldRef m_fldCodctry = new FieldRef("city", "codctry");
