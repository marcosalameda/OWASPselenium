...
namespace CSGenio.business
{
	...
	public class CSGenioAmanuf : DbArea
	{
		...
		public CSGenioAmanuf(User user, string module)
		{
            this.user = user;
            this.module = module;
			this.KeyType = CodeType.GUID_KEY;
			// USE /[MANUAL GQT CONSTRUTOR MANUF]/
		}

		public CSGenioAmanuf(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codentit", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "initials", FieldType.TEXTO);
			Qfield.FieldDescription = "Company initials";
			Qfield.FieldSize =  10;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "registra", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "taxnumbe", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "phonenum", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "building", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "street", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "town", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "county", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "state", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "pobox", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "website", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "person", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "contact", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "owner", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "carrier", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "supplier", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "manufact", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "founded", FieldType.DATA);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "firstfacilitie", FieldType.CHAVE_FALSA_GUID);
			Qfield.FieldDescription = "First incorporated facility";
			Qfield.FieldSize =  36;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "lastfacilitie", FieldType.CHAVE_FALSA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "language", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "currency", FieldType.TEXTO);
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.AreaDesignation="Manufacturer";
			info.AreaPluralDesignation="Manufacturers";
			info.DescriptionCav="MANUFACTURER50759";
		...
		private static FieldRef m_fldCodentit = new FieldRef("manuf", "codentit");
		...
		private static FieldRef m_fldInitials = new FieldRef("manuf", "initials");
		...
		private static FieldRef m_fldTaxnumbe = new FieldRef("manuf", "taxnumbe");
		...
		private static FieldRef m_fldPhonenum = new FieldRef("manuf", "phonenum");
		...
		private static FieldRef m_fldBuilding = new FieldRef("manuf", "building");
		...
		private static FieldRef m_fldTown = new FieldRef("manuf", "town");
		...
		private static FieldRef m_fldState = new FieldRef("manuf", "state");
		...
		private static FieldRef m_fldPostalco = new FieldRef("manuf", "postalco");
		...
		private static FieldRef m_fldFax = new FieldRef("manuf", "fax");
		...
		private static FieldRef m_fldPerson = new FieldRef("manuf", "person");
		...
		private static FieldRef m_fldCarrier = new FieldRef("manuf", "carrier");
		...
		private static FieldRef m_fldManufact = new FieldRef("manuf", "manufact");
		...
		private static FieldRef m_fldFirstfacilitie = new FieldRef("manuf", "firstfacilitie");
		...
		private static FieldRef m_fldLanguage = new FieldRef("manuf", "language");
		...
		private static FieldRef m_fldZzstate = new FieldRef("manuf", "zzstate");
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAmanuf> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAmanuf>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAmanuf> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAmanuf>(where, listing);
        }
