...
namespace CSGenio.business
{
	...
	/// Contact
	/// </summary>
	public class CSGenioAprocn : DbArea	{
		/// <summary>
		/// Meta-information on this area
		/// </summary>
		protected readonly static AreaInfo informacao = InicializaAreaInfo();

		public CSGenioAprocn(User user, string module)
		{
		...
		public CSGenioAprocn(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codprocn", FieldType.CHAVE_PRIMARIA_GUID);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("prope", new Relation("GQT", "gqtprocn", "procn", "codprocn", "codprope", "GQT", "gqtprope", "prope", "codprope", "codprope"));
		}
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.QSystem="GQT";
			info.TableName="gqtprocn";
			info.ShadowTabName="";
			info.ShadowTabKeyName="";

			info.PrimaryKeyName="codprocn";
		...
		public static FieldRef FldCodprocn { get { return m_fldCodprocn; } }
		private static FieldRef m_fldCodprocn = new FieldRef("procn", "codprocn");

		/// <summary>Field : "" Tipo: "+" Formula:  ""</summary>
		public string ValCodprocn
		{
			get { return (string)returnValueField(FldCodprocn); }
		...
		private static FieldRef m_fldEmail = new FieldRef("procn", "email");
		...
		private static FieldRef m_fldDescript = new FieldRef("procn", "descript");
		...
		private static FieldRef m_fldZzstate = new FieldRef("procn", "zzstate");
        ...
        public static CSGenioAprocn search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAprocn area = new CSGenioAprocn(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        [Obsolete("Use List<CSGenioAprocn> searchList(PersistentSupport sp, User user, CriteriaSet where, string []fields) instead")]
        public static List<CSGenioAprocn> searchList(PersistentSupport sp, User user, string where, string []fields = null)
        {
            return sp.searchListWhere<CSGenioAprocn>(where, user, fields);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAprocn> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAprocn>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAprocn> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAprocn>(where, listing);
        }
