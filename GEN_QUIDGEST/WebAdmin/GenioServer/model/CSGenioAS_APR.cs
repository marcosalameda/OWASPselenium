...
namespace CSGenio.business
{
	...
	public class CSGenioAs_apr : DbArea	{
		...
		public CSGenioAs_apr(User user, string module)
		{
			...
			// USE /[MANUAL GQT CONSTRUTOR S_APR]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		/// <summary>Field : "Percentage" Tipo: "N" Formula:  ""</summary>
		public double ValPercenta
		{
			get { return (double)returnValueField(FldPercenta); }
		...
		public double ValId
		{
			get { return (double)returnValueField(FldId); }
