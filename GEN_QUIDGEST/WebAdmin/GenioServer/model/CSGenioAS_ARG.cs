...
namespace CSGenio.business
{
	...
	public class CSGenioAs_arg : DbArea
	{
		...
		public CSGenioAs_arg(User user, string module)
		{
			...
			// USE /[MANUAL GQT CONSTRUTOR S_ARG]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codargpr", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "id", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "valor", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "tipo", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "hidden", FieldType.LOGICO);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("s_apr", new Relation("GQT", "asyncprocessargument", "s_arg", "codargpr", "cods_apr", "GQT", "asyncprocess", "s_apr", "codascpr", "codascpr"));
		}
