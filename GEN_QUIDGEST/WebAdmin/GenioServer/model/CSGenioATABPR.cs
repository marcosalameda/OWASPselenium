...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codtabpr", FieldType.CHAVE_PRIMARIA_GUID);
	...
	"today", true));
        ...
        public static CSGenioAtabpr search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
