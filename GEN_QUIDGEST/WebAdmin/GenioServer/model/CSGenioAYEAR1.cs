...
//Actualiza as seguintes réplicas:
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "yearnum", FieldType.NUMERIC);
...
//Actualiza as seguintes réplicas:
        ...
        public static CSGenioAyear1 search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
