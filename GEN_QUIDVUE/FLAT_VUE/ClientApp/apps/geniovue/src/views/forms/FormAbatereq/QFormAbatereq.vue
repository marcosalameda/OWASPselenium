	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				...
				<q-row v-if="controls.ABATEREQDECOMDECOMNR_.isVisible">
					<q-col
				...
				<q-row v-if="controls.ABATEREQPSEUDCOLLAPSE.isVisible">
					<q-col
				...
				<q-row v-if="controls.ABATEREQPSEUDABATETAB.isVisible">
					<q-col
		...
		data()
		{
			...
			return {
				...
				controls: {
					...
					ABATEREQDECOMNOTE____: new fieldControlClass.MultilineStringControl({
						modelField: 'ValNote',
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT ABATEREQ]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
