	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row v-if="controls.ATTAC___ASSETNAME____.isVisible || controls.ATTAC___ATTACATTACHED.isVisible || controls.ATTAC___ATTACNOTE____.isVisible || controls.ATTAC___ATTACDOCUMENT.isVisible">
					<q-col
						...
						<base-input-structure
							v-if="controls.ATTAC___ASSETNAME____.isVisible"
							class="i-text"
							v-bind="controls.ATTAC___ASSETNAME____.wrapperProps"
							:id="getControlId(controls.ATTAC___ASSETNAME____)"
					...
					<q-col
						...
						<base-input-structure
							v-if="controls.ATTAC___ATTACATTACHED.isVisible"
							class="i-text"
							v-bind="controls.ATTAC___ATTACATTACHED.wrapperProps"
							:id="getControlId(controls.ATTAC___ATTACATTACHED)"
					...
					<q-col
						...
						<base-input-structure
							v-if="controls.ATTAC___ATTACNOTE____.isVisible"
							class="i-textarea"
							v-bind="controls.ATTAC___ATTACNOTE____.wrapperProps"
							:id="getControlId(controls.ATTAC___ATTACNOTE____)"
					...
					<q-col
						...
						<base-input-structure
							v-if="controls.ATTAC___ATTACDOCUMENT.isVisible"
							class="i-text"
							v-bind="controls.ATTAC___ATTACDOCUMENT.wrapperProps"
							:id="getControlId(controls.ATTAC___ATTACDOCUMENT)"
...
<script>
	...
	import FormViewModel from './QFormAttacViewModel.js'

	const requiredTextResources = ['QFormAttac', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS ATTAC]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreAttacAssetname: defineAsyncComponent(() => import('@/views/forms/FormAttac/dbedits/AttacAssetnameSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormAttac', false),

				interfaceMetadata: {
					id: 'QFormAttac', // Used for resources
				...
				formInfo: {
					...
					route: 'form-ATTAC',
					area: 'ATTAC',
					primaryKey: 'ValCodattac',
					designation: computed(() => this.Resources.ATTACHMENT29376),
				...
				controls: {
					ATTAC___ASSETNAME____: new fieldControlClass.LookupControl({
					...
					ATTAC___ATTACATTACHED: new fieldControlClass.DateControl({
						...
						valueChangeEvent: 'fieldChange:attac.attached',
					...
					ATTAC___ATTACNOTE____: new fieldControlClass.MultilineStringControl({
						modelField: 'ValNote',
						valueChangeEvent: 'fieldChange:attac.note',
					...
					ATTAC___ATTACDOCUMENT: new fieldControlClass.DocumentControl({
						modelField: 'ValDocument',
						valueChangeEvent: 'fieldChange:attac.document',
				...
				dataApi: {
					...
					Attac: {
						get ValAttached() { return vm.model.ValAttached.value },
						set ValAttached(value) { vm.model.ValAttached.updateValue(value) },
					...
					keys: {
						/** The primary key of the ATTAC table */
						get attac() { return vm.model.ValCodattac },
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS ATTAC]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
