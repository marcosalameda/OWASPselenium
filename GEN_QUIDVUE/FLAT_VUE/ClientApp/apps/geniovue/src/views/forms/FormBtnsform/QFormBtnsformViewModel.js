...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'WAREH',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Btnsform',
				updateFilesTickets: 'UpdateFilesTicketsBtnsform',
				setFile: 'SetFileBtnsform'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormBtnsformViewModel instance.
	 * @returns {QFormBtnsformViewModel} A new instance of QFormBtnsformViewModel
	 */
	clone()
	{
