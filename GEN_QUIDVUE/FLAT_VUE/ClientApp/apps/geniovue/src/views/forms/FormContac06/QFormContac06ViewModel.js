...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'PROCN',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Contac06',
				updateFilesTickets: 'UpdateFilesTicketsContac06',
				setFile: 'SetFileContac06'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormContac06ViewModel instance.
	 * @returns {QFormContac06ViewModel} A new instance of QFormContac06ViewModel
	 */
	clone()
	{
