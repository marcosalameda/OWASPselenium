	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				...
				<q-row v-if="controls.DILIN___PRODUPRODUCT_.isVisible">
					<q-col
				...
				<q-row v-if="controls.DILIN___DILINORDERED_.isVisible || controls.DILIN___DILINDELIVERE.isVisible || controls.DILIN___DILINOUTSTAND.isVisible">
					<q-col
