	...
	<teleport
		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.DILIN___DISPADISPANR_.isVisible || controls.DILIN___DILINLINENUMB.isVisible">
					<q-control-wrapper
						v-show="controls.DILIN___DISPADISPANR_.isVisible"
					...
					<q-control-wrapper
						v-show="controls.DILIN___DILINLINENUMB.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
				...
				<q-row-container v-show="controls.DILIN___PRODUPRODUCT_.isVisible">
					<q-control-wrapper
						v-show="controls.DILIN___PRODUPRODUCT_.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
				...
				<q-row-container v-show="controls.DILIN___DILINORDERED_.isVisible || controls.DILIN___DILINDELIVERE.isVisible || controls.DILIN___DILINOUTSTAND.isVisible">
					<q-control-wrapper
						v-show="controls.DILIN___DILINORDERED_.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.DILIN___DILINDELIVERE.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.DILIN___DILINOUTSTAND.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
...
<script>
	...
	import FormViewModel from './QFormDilinViewModel.js'

	const requiredTextResources = ['QFormDilin', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS DILIN]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreDilinDispadispanr: defineAsyncComponent(() => import('@/views/forms/FormDilin/dbedits/DilinDispadispanrSeeMore.vue')),
			QSeeMoreDilinProduproduct: defineAsyncComponent(() => import('@/views/forms/FormDilin/dbedits/DilinProduproductSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormDilin', false),

				interfaceMetadata: {
					id: 'QFormDilin', // Used for resources
				...
				formInfo: {
					...
					designation: computed(() => this.Resources.DISPATCH_LINE65326),
				...
				controls: {
					DILIN___DISPADISPANR_: new fieldControlClass.LookupControl({
						modelField: 'TableDispaDispanr',
					...
					DILIN___PRODUPRODUCT_: new fieldControlClass.LookupControl({
				...
				dataApi: {
					Dilin: {
						get ValCoddispa() { return vm.model.ValCoddispa.value },
						set ValCoddispa(value) { vm.model.ValCoddispa.updateValue(value) },
						get ValCodprodu() { return vm.model.ValCodprodu.value },
						set ValCodprodu(value) { vm.model.ValCodprodu.updateValue(value) },
						get ValDelivere() { return vm.model.ValDelivere.value },
						set ValDelivere(value) { vm.model.ValDelivere.updateValue(value) },
					...
					Dispa: {
						get ValDispanr() { return vm.model.TableDispaDispanr.value },
						set ValDispanr(value) { vm.model.TableDispaDispanr.updateValue(value) },
					},
					Produ: {
					...
					keys: {
						/** The primary key of the DILIN table */
						get dilin() { return vm.model.ValCoddilin },
						/** The foreign key to the DISPA table */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS DILIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
