...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'WAREH',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Extforms',
				updateFilesTickets: 'UpdateFilesTicketsExtforms',
				setFile: 'SetFileExtforms'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormExtformsViewModel instance.
	 * @returns {QFormExtformsViewModel} A new instance of QFormExtformsViewModel
	 */
	clone()
	{
