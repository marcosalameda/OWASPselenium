	...
	<teleport
		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.PARAM___KINDEDESIGNAT.isVisible">
					<q-control-wrapper
						v-show="controls.PARAM___KINDEDESIGNAT.isVisible"
				...
				<q-row-container v-show="controls.PARAM___PARAMPARAMETE.isVisible || controls.PARAM___PARAMDATATYPE.isVisible || controls.PARAM___PARAMDECPLACE.isVisible">
					<q-control-wrapper
						v-show="controls.PARAM___PARAMPARAMETE.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.PARAM___PARAMDATATYPE.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.PARAM___PARAMDECPLACE.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
...
<script>
	...
	import FormViewModel from './QFormParamViewModel.js'

	const requiredTextResources = ['QFormParam', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS PARAM]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreParamKindedesignat: defineAsyncComponent(() => import('@/views/forms/FormParam/dbedits/ParamKindedesignatSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormParam', false),

				interfaceMetadata: {
					id: 'QFormParam', // Used for resources
				...
				formInfo: {
					...
					route: 'form-PARAM',
					area: 'PARAM',
					primaryKey: 'ValCodparam',
					designation: computed(() => this.Resources.PARAMETER41976),
				...
				controls: {
					PARAM___KINDEDESIGNAT: new fieldControlClass.LookupControl({
					...
					PARAM___PARAMDATATYPE: new fieldControlClass.ArrayStringControl({
						modelField: 'ValDatatype',
						valueChangeEvent: 'fieldChange:param.datatype',
				...
				dataApi: {
					...
					Param: {
						...
						get ValParameter() { return vm.model.ValParameter.value },
						set ValParameter(value) { vm.model.ValParameter.updateValue(value) },
					},
					keys: {
						/** The primary key of the PARAM table */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS PARAM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
