...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'PROPE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Prope03',
				updateFilesTickets: 'UpdateFilesTicketsPrope03',
				setFile: 'SetFilePrope03'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormPrope03ViewModel instance.
	 * @returns {QFormPrope03ViewModel} A new instance of QFormPrope03ViewModel
	 */
	clone()
	{
