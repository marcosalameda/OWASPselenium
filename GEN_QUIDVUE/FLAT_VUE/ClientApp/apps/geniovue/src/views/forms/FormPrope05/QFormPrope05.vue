		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.PROPE05_PSEUDMAININF_.isVisible">
					<q-control-wrapper
						v-show="controls.PROPE05_PSEUDMAININF_.isVisible"
						...
						<q-group-box-container
							...
							<q-row-container v-show="controls.PROPE05_PROPEPHOTO___.isVisible">
								<q-control-wrapper
									v-show="controls.PROPE05_PROPEPHOTO___.isVisible"
									class="control-join-group">
							...
							<q-row-container v-show="controls.PROPE05_PROPETITLE___.isVisible">
								<q-control-wrapper
									v-show="controls.PROPE05_PROPETITLE___.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-text"
							...
							<q-row-container v-show="controls.PROPE05_PROPEPRICE___.isVisible">
								<q-control-wrapper
									v-show="controls.PROPE05_PROPEPRICE___.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-text"
							...
							<q-row-container v-show="controls.PROPE05_PROPEDESCRIPT.isVisible">
								<q-control-wrapper
									v-show="controls.PROPE05_PROPEDESCRIPT.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-textarea"
							...
							<!-- End PROPE05_PSEUDMAININF_ -->
						</q-group-box-container>
					</q-control-wrapper>
				</q-row-container>
				<q-row-container v-show="controls.PROPE05_AGENTNAME____.isVisible || controls.PROPE05_PROPEBATHRMS_.isVisible">
					<q-control-wrapper
						v-show="controls.PROPE05_AGENTNAME____.isVisible || controls.PROPE05_PROPEBATHRMS_.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
							...
							<q-see-more-prope05-agentname
								...
								v-bind="controls.PROPE05_AGENTNAME____.seeMoreParams"
								v-on="controls.PROPE05_AGENTNAME____.handlers" />
						</base-input-structure>
						<base-input-structure
							class="i-text"
				...
				<q-row-container v-show="controls.PROPE05_PROPESIZE____.isVisible || controls.PROPE05_PROPEYEAR____.isVisible || controls.PROPE05_CITY_CITY____.isVisible">
					<q-control-wrapper
						v-show="controls.PROPE05_PROPESIZE____.isVisible || controls.PROPE05_PROPEYEAR____.isVisible || controls.PROPE05_CITY_CITY____.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
						...
						<base-input-structure
							...
							<q-see-more-prope05-city-city
								...
								v-bind="controls.PROPE05_CITY_CITY____.seeMoreParams"
								v-on="controls.PROPE05_CITY_CITY____.handlers" />
						</base-input-structure>
					</q-control-wrapper>
				</q-row-container>
...
<script>
	...
	import FormViewModel from './QFormPrope05ViewModel.js'

	const requiredTextResources = ['QFormPrope05', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS PROPE05]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMorePrope05Agentname: defineAsyncComponent(() => import('@/views/forms/FormPrope05/dbedits/Prope05AgentnameSeeMore.vue')),
			QSeeMorePrope05CityCity: defineAsyncComponent(() => import('@/views/forms/FormPrope05/dbedits/Prope05CityCitySeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormPrope05', false),

				interfaceMetadata: {
					id: 'QFormPrope05', // Used for resources
				...
				controls: {
					PROPE05_PSEUDMAININF_: new fieldControlClass.GroupControl({
						id: 'PROPE05_PSEUDMAININF_',
						name: 'MAININF',
						size: 'large',
					...
					PROPE05_PROPEPHOTO___: new fieldControlClass.ImageControl({
						modelField: 'ValPhoto',
						valueChangeEvent: 'fieldChange:prope.photo',
						id: 'PROPE05_PROPEPHOTO___',
						name: 'PHOTO',
						size: 'mini',
						label: computed(() => this.Resources.FOTO_PRINCIPAL64363),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'PROPE05_PSEUDMAININF_',
						height: 10,
						width: 480,
					...
					PROPE05_PROPETITLE___: new fieldControlClass.StringControl({
						modelField: 'ValTitle',
						valueChangeEvent: 'fieldChange:prope.title',
						id: 'PROPE05_PROPETITLE___',
						name: 'TITLE',
						size: 'xxlarge',
						...
						container: 'PROPE05_PSEUDMAININF_',
						maxLength: 50,
						labelId: 'label_PROPE05_PROPETITLE___',
						controlLimits: [
						],
					}, this),
					PROPE05_PROPEPRICE___: new fieldControlClass.CurrencyControl({
						modelField: 'ValPrice',
						valueChangeEvent: 'fieldChange:prope.price',
						id: 'PROPE05_PROPEPRICE___',
						name: 'PRICE',
						size: 'medium',
					...
					PROPE05_PROPEDESCRIPT: new fieldControlClass.MultilineStringControl({
						modelField: 'ValDescript',
						valueChangeEvent: 'fieldChange:prope.descript',
						id: 'PROPE05_PROPEDESCRIPT',
						name: 'DESCRIPT',
						size: 'xxlarge',
					...
					PROPE05_AGENTNAME____: new fieldControlClass.LookupControl({
						modelField: 'TableAgentName',
						valueChangeEvent: 'fieldChange:agent.name',
						id: 'PROPE05_AGENTNAME____',
						name: 'NAME',
						size: 'xxlarge',
					...
					PROPE05_PROPEBATHRMS_: new fieldControlClass.NumberControl({
						modelField: 'ValBathrms',
						valueChangeEvent: 'fieldChange:prope.bathrms',
						id: 'PROPE05_PROPEBATHRMS_',
						name: 'BATHRMS',
						size: 'large',
					...
					PROPE05_PROPESIZE____: new fieldControlClass.NumberControl({
						modelField: 'ValSize',
						valueChangeEvent: 'fieldChange:prope.size',
						id: 'PROPE05_PROPESIZE____',
						name: 'SIZE',
						size: 'medium',
					...
					PROPE05_PROPEYEAR____: new fieldControlClass.StringControl({
						modelField: 'ValYear',
						valueChangeEvent: 'fieldChange:prope.year',
						id: 'PROPE05_PROPEYEAR____',
						name: 'YEAR',
						size: 'xxlarge',
						...
						labelPosition: computed(() => this.labelAlignment.topleft),
						maxLength: 50,
						labelId: 'label_PROPE05_PROPEYEAR____',
						controlLimits: [
						],
					}, this),
					PROPE05_CITY_CITY____: new fieldControlClass.LookupControl({
						modelField: 'TableCityCity',
						valueChangeEvent: 'fieldChange:city.city',
						id: 'PROPE05_CITY_CITY____',
						name: 'CITY',
						size: 'xxlarge',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD PROPE05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
