	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row v-if="controls.PROPE05_PSEUDMAININF_.isVisible">
					<q-col
						...
						<q-group-box-container
							...
							<q-row v-if="controls.PROPE05_PROPETITLE___.isVisible">
								<q-col
							...
							<q-row v-if="controls.PROPE05_PROPEPRICE___.isVisible">
								<q-col
							...
							<q-row v-if="controls.PROPE05_PROPEDESCRIPT.isVisible">
								<q-col
				...
				<q-row v-if="controls.PROPE05_AGENTNAME____.isVisible || controls.PROPE05_PROPEBATHRMS_.isVisible">
					<q-col
						v-if="controls.PROPE05_AGENTNAME____.isVisible || controls.PROPE05_PROPEBATHRMS_.isVisible"
						cols="auto">
						<base-input-structure
				...
				<q-row v-if="controls.PROPE05_PROPESIZE____.isVisible || controls.PROPE05_PROPEYEAR____.isVisible || controls.PROPE05_CITY_CITY____.isVisible">
					<q-col
						v-if="controls.PROPE05_PROPESIZE____.isVisible || controls.PROPE05_PROPEYEAR____.isVisible || controls.PROPE05_CITY_CITY____.isVisible"
						cols="auto">
						<base-input-structure
