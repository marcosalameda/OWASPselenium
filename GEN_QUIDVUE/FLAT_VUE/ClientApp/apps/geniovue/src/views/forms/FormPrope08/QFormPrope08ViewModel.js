...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'PROPE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_PROPE08',
				updateFilesTickets: 'UpdateFilesTicketsPROPE08'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormPrope08ViewModel instance.
	 * @returns {QFormPrope08ViewModel} A new instance of QFormPrope08ViewModel
	 */
	clone()
	{
