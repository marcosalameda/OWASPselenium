...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'PROPE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_PROPE10',
				updateFilesTickets: 'UpdateFilesTicketsPROPE10'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormPrope10ViewModel instance.
	 * @returns {QFormPrope10ViewModel} A new instance of QFormPrope10ViewModel
	 */
	clone()
	{
