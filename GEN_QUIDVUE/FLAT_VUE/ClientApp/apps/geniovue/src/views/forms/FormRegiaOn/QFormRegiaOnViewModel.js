...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'REGIO',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Regia_on',
				updateFilesTickets: 'UpdateFilesTicketsRegia_on',
				setFile: 'SetFileRegia_on'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormRegiaOnViewModel instance.
	 * @returns {QFormRegiaOnViewModel} A new instance of QFormRegiaOnViewModel
	 */
	clone()
	{
