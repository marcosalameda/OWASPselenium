...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'REGIO',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Regiapro',
				updateFilesTickets: 'UpdateFilesTicketsRegiapro',
				setFile: 'SetFileRegiapro'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormRegiaproViewModel instance.
	 * @returns {QFormRegiaproViewModel} A new instance of QFormRegiaproViewModel
	 */
	clone()
	{
