...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'EQUIP',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Timequip',
				updateFilesTickets: 'UpdateFilesTicketsTimequip',
				setFile: 'SetFileTimequip'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormTimequipViewModel instance.
	 * @returns {QFormTimequipViewModel} A new instance of QFormTimequipViewModel
	 */
	clone()
	{
