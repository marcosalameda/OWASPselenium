...
<script>
	...
	import FormViewModel from './QFormVendawVendaw02ViewModel.js'

	const requiredTextResources = ['QFormVendawVendaw02', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawVendaw02', false),

				interfaceMetadata: {
					id: 'QFormVendawVendaw02', // Used for resources
