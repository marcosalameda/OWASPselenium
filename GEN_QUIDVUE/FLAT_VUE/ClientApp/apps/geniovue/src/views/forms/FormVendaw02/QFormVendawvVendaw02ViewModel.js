...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			actions: {
				...
				updateFilesTickets: 'UpdateFilesTicketsVendaw02',
				setFile: 'SetFileVendaw02'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormVendawvVendaw02ViewModel instance.
	 * @returns {QFormVendawvVendaw02ViewModel} A new instance of QFormVendawvVendaw02ViewModel
	 */
	clone()
	{
