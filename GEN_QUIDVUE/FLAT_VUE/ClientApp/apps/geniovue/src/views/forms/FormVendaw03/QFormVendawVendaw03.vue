...
<script>
	...
	import FormViewModel from './QFormVendawVendaw03ViewModel.js'

	const requiredTextResources = ['QFormVendawVendaw03', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawVendaw03', false),

				interfaceMetadata: {
					id: 'QFormVendawVendaw03', // Used for resources
