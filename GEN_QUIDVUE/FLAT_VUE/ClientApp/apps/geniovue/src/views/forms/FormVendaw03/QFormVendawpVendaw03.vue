							...
							<q-row v-if="controls.VENDAW03PSEUDNOVOGR03.isVisible">
								<q-col v-if="controls.VENDAW03PSEUDNOVOGR03.isVisible">
									<q-group-box-container
										...
										:id="getControlId(controls.VENDAW03PSEUDNOVOGR03)"
										:no-border="controls.VENDAW03PSEUDNOVOGR03.borderless">
										...
										<q-row v-if="controls.VENDAW03SALE_PREABORD.isVisible || controls.VENDAW03SALE_HOMEWORK.isVisible">
											<q-col
												...
												<base-input-structure
													v-if="controls.VENDAW03SALE_PREABORD.isVisible"
													class="i-text"
													v-bind="controls.VENDAW03SALE_PREABORD.wrapperProps"
													:id="getControlId(controls.VENDAW03SALE_PREABORD)"
													v-on="controls.VENDAW03SALE_PREABORD.handlers"
													:loading="controls.VENDAW03SALE_PREABORD.props.loading"
													:reporting-mode-on="reportingModeCAV"
													:suggestion-mode-on="suggestionModeOn">
													<q-date-time-picker
														v-if="controls.VENDAW03SALE_PREABORD.isVisible"
														v-bind="controls.VENDAW03SALE_PREABORD.props"
														:id="getControlId(controls.VENDAW03SALE_PREABORD)"
											...
											<q-col
												...
												<base-input-structure
													v-if="controls.VENDAW03SALE_HOMEWORK.isVisible"
													class="i-text"
													v-bind="controls.VENDAW03SALE_HOMEWORK.wrapperProps"
													:id="getControlId(controls.VENDAW03SALE_HOMEWORK)"
													v-on="controls.VENDAW03SALE_HOMEWORK.handlers"
													:loading="controls.VENDAW03SALE_HOMEWORK.props.loading"
													:reporting-mode-on="reportingModeCAV"
													:suggestion-mode-on="suggestionModeOn">
													<template #label>
														<q-checkbox
...
<script>
	...
	import FormViewModel from './QFormVendawpVendaw03ViewModel.js'

	const requiredTextResources = ['QFormVendawpVendaw03', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QFormVendawpVendaw03',
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW03',
					location: 'form-VENDAWP-VENDAW03',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawpVendaw03', false),

				interfaceMetadata: {
					id: 'QFormVendawpVendaw03', // Used for resources
				...
				formInfo: {
					...
					designation: computed(() => this.Resources.PRE_ABORDAGEM30870),
				...
				wizardData: readonly({
					...
					stepFieldIds: [
						'VENDAW03PSEUDNOVOGR03',
						'VENDAW03SALE_PREABORD',
						'VENDAW03SALE_HOMEWORK',
					]
				}),
				...
				controls: {
					VENDAW03PSEUDNOVOGR03: new fieldControlClass.GroupControl({
						...
						isCollapsible: false,
						anchored: false,
						directChildren: ['VENDAW03SALE_PREABORD', 'VENDAW03SALE_HOMEWORK'],
						controlLimits: [
						],
					}, this),
					VENDAW03SALE_PREABORD: new fieldControlClass.DateControl({
						modelField: 'ValPreabord',
						valueChangeEvent: 'fieldChange:sale.preabord',
						id: 'VENDAW03SALE_PREABORD',
						name: 'PREABORD',
						size: 'medium',
						label: computed(() => this.Resources.PRE_APPROACH58979),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'VENDAW03PSEUDNOVOGR03',
						dateTimeType: 'dateTime',
						controlLimits: [
						],
					}, this),
					VENDAW03SALE_HOMEWORK: new fieldControlClass.BooleanControl({
						modelField: 'ValHomework',
						valueChangeEvent: 'fieldChange:sale.homework',
						id: 'VENDAW03SALE_HOMEWORK',
						name: 'HOMEWORK',
						size: 'medium',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD VENDAW03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
