...
<script>
	...
	import FormViewModel from './QFormVendawvVendaw03ViewModel.js'

	const requiredTextResources = ['QFormVendawvVendaw03', 'hardcoded', 'messages']
	...
	export default {
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW03',
					location: 'form-VENDAWV-VENDAW03',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawvVendaw03', false),

				interfaceMetadata: {
					id: 'QFormVendawvVendaw03', // Used for resources
