...
<script>
	...
	import FormViewModel from './QFormVendawVendaw04ViewModel.js'

	const requiredTextResources = ['QFormVendawVendaw04', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawVendaw04', false),

				interfaceMetadata: {
					id: 'QFormVendawVendaw04', // Used for resources
