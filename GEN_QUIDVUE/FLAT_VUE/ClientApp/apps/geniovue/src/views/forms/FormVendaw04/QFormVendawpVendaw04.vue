...
<script>
	...
	import FormViewModel from './QFormVendawpVendaw04ViewModel.js'

	const requiredTextResources = ['QFormVendawpVendaw04', 'hardcoded', 'messages']
	...
	export default {
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW04',
					location: 'form-VENDAWP-VENDAW04',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawpVendaw04', false),

				interfaceMetadata: {
					id: 'QFormVendawpVendaw04', // Used for resources
