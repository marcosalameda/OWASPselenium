				...
				<q-row-container v-show="controls.VENDAWV_PSEUDFASES___.isVisible">
					<q-control-wrapper
						...
						<q-wizard
							...
							<q-row-container
								v-show="controls.VENDAW04PSEUDNOVOGR04.isVisible"
								is-large>
								<q-control-wrapper
									v-show="controls.VENDAW04PSEUDNOVOGR04.isVisible"
									...
									<q-group-box-container
										...
										<q-row-container v-show="controls.VENDAW04SALE_DTABORDA.isVisible || controls.VENDAW04SALE_APPROACH.isVisible">
											<q-control-wrapper
												v-show="controls.VENDAW04SALE_DTABORDA.isVisible"
												class="control-join-group">
											...
											<q-control-wrapper
												v-show="controls.VENDAW04SALE_APPROACH.isVisible"
												class="control-join-group">
												<base-input-structure
													class="i-checkbox"
...
<script>
	...
	import FormViewModel from './QFormVendawvVendaw04ViewModel.js'

	const requiredTextResources = ['QFormVendawvVendaw04', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QFormVendawvVendaw04',
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW04',
					location: 'form-VENDAWV-VENDAW04',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawvVendaw04', false),

				interfaceMetadata: {
					id: 'QFormVendawvVendaw04', // Used for resources
				...
				formInfo: {
					...
					designation: computed(() => this.Resources.ABORDAGEM05839),
				...
				wizardData: readonly({
					...
					stepFieldIds: [
						'VENDAW04PSEUDNOVOGR04',
						'VENDAW04SALE_DTABORDA',
						'VENDAW04SALE_APPROACH',
					]
				}),
				...
				controls: {
					VENDAW04PSEUDNOVOGR04: new fieldControlClass.GroupControl({
						id: 'VENDAW04PSEUDNOVOGR04',
						name: 'NOVOGR04',
						size: 'block',
					...
					VENDAW04SALE_DTABORDA: new fieldControlClass.DateControl({
						modelField: 'ValDtaborda',
						valueChangeEvent: 'fieldChange:sale.dtaborda',
						id: 'VENDAW04SALE_DTABORDA',
						name: 'DTABORDA',
						size: 'medium',
						label: computed(() => this.Resources.APPROACH06577),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'VENDAW04PSEUDNOVOGR04',
						dateTimeType: 'dateTime',
						controlLimits: [
						],
					}, this),
					VENDAW04SALE_APPROACH: new fieldControlClass.BooleanControl({
						modelField: 'ValApproach',
						valueChangeEvent: 'fieldChange:sale.approach',
						id: 'VENDAW04SALE_APPROACH',
						name: 'APPROACH',
						size: 'medium',
						label: computed(() => this.Resources.APPROACH_TAKEN46072),
						placeholder: '',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD VENDAW04]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
