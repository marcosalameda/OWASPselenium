...
<script>
	...
	import FormViewModel from './QFormVendawpVendaw06ViewModel.js'

	const requiredTextResources = ['QFormVendawpVendaw06', 'hardcoded', 'messages']
	...
	export default {
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW06',
					location: 'form-VENDAWP-VENDAW06',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawpVendaw06', false),

				interfaceMetadata: {
					id: 'QFormVendawpVendaw06', // Used for resources
