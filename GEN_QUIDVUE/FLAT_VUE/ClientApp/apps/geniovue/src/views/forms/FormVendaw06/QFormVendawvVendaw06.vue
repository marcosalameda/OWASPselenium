				...
				<q-row v-if="controls.VENDAWV_PSEUDFASES___.isVisible">
					<q-col
						...
						<q-wizard
							...
							<q-row v-if="controls.VENDAW06PSEUDNOVOGR06.isVisible">
								<q-col v-if="controls.VENDAW06PSEUDNOVOGR06.isVisible">
									<q-group-box-container
										v-if="controls.VENDAW06PSEUDNOVOGR06.isVisible"
										v-bind="controls.VENDAW06PSEUDNOVOGR06"
										:id="getControlId(controls.VENDAW06PSEUDNOVOGR06)"
										:no-border="controls.VENDAW06PSEUDNOVOGR06.borderless">
										<!-- Start VENDAW06PSEUDNOVOGR06 -->
										<q-row v-if="controls.VENDAW06SALE_DTSUPERA.isVisible">
											<q-col
												v-if="controls.VENDAW06SALE_DTSUPERA.isVisible"
												cols="auto">
												<base-input-structure
													v-if="controls.VENDAW06SALE_DTSUPERA.isVisible"
													class="i-text"
													v-bind="controls.VENDAW06SALE_DTSUPERA.wrapperProps"
													:id="getControlId(controls.VENDAW06SALE_DTSUPERA)"
													v-on="controls.VENDAW06SALE_DTSUPERA.handlers"
													:loading="controls.VENDAW06SALE_DTSUPERA.props.loading"
													:reporting-mode-on="reportingModeCAV"
													:suggestion-mode-on="suggestionModeOn">
													<q-date-time-picker
														v-if="controls.VENDAW06SALE_DTSUPERA.isVisible"
														v-bind="controls.VENDAW06SALE_DTSUPERA.props"
														:id="getControlId(controls.VENDAW06SALE_DTSUPERA)"
...
<script>
	...
	import FormViewModel from './QFormVendawvVendaw06ViewModel.js'

	const requiredTextResources = ['QFormVendawvVendaw06', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QFormVendawvVendaw06',
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW06',
					location: 'form-VENDAWV-VENDAW06',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawvVendaw06', false),

				interfaceMetadata: {
					id: 'QFormVendawvVendaw06', // Used for resources
				...
				formInfo: {
					...
					designation: computed(() => this.Resources.SUPERAR_OBJECOES02243),
				...
				wizardData: readonly({
					...
					stepFieldIds: [
						'VENDAW06PSEUDNOVOGR06',
						'VENDAW06SALE_DTSUPERA',
					]
				}),
				...
				controls: {
					VENDAW06PSEUDNOVOGR06: new fieldControlClass.GroupControl({
						id: 'VENDAW06PSEUDNOVOGR06',
						name: 'NOVOGR06',
						size: 'block',
						...
						isCollapsible: false,
						anchored: false,
						directChildren: ['VENDAW06SALE_DTSUPERA'],
						controlLimits: [
						],
					}, this),
					VENDAW06SALE_DTSUPERA: new fieldControlClass.DateControl({
						modelField: 'ValDtsupera',
						valueChangeEvent: 'fieldChange:sale.dtsupera',
						id: 'VENDAW06SALE_DTSUPERA',
						name: 'DTSUPERA',
						size: 'medium',
						label: computed(() => this.Resources.OVERCOMING_OBJECTION04521),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'VENDAW06PSEUDNOVOGR06',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS VENDAW06]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
