...
<script>
	...
	import FormViewModel from './QFormVendawVendaw07ViewModel.js'

	const requiredTextResources = ['QFormVendawVendaw07', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawVendaw07', false),

				interfaceMetadata: {
					id: 'QFormVendawVendaw07', // Used for resources
