...
<script>
	...
	import FormViewModel from './QFormVendawpVendaw07ViewModel.js'

	const requiredTextResources = ['QFormVendawpVendaw07', 'hardcoded', 'messages']
	...
	export default {
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW07',
					location: 'form-VENDAWP-VENDAW07',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawpVendaw07', false),

				interfaceMetadata: {
					id: 'QFormVendawpVendaw07', // Used for resources
