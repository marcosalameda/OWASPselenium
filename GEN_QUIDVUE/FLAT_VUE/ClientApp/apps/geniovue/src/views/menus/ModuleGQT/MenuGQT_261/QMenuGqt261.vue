		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE GQT_Menu_261]/ -->
				</q-table>
...
<script>
	...
	import MenuViewModel from './QMenuGQT_261ViewModel.js'

	const requiredTextResources = ['QMenuGQT_261', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS GQT_MENU_261]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuGQT_261', false),

				interfaceMetadata: {
					id: 'QMenuGQT_261', // Used for resources
				...
				menuInfo: {
					id: '261',
					isMenuList: true,
					designation: computed(() => this.Resources.FACILITIES08876),
					acronym: 'GQT_261',
					name: 'INSTA',
					route: 'menu-GQT_261',
					order: '261',
				...
				controls: {
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'EDIT', formName: 'INSTA'
								}
							},
							formsDefinition: {
								'INSTA': {
						...
						uuid: '0655f0e5-8a64-4786-911e-9b4ece9f7ac0',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS GQT_MENU_261]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT GQT_MENU_261]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS GQT_261]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS GQT_MENU_261]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
