		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE GQT_Menu_REPAIR_LIST]/ -->
				</q-table>
...
<script>
	...
	import MenuViewModel from './QMenuGQT_REPAIR_LISTViewModel.js'

	const requiredTextResources = ['QMenuGQT_REPAIR_LIST', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS GQT_MENU_REPAIR_LIST]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuGqtRepairList',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuGQT_REPAIR_LIST', false),

				interfaceMetadata: {
					id: 'QMenuGQT_REPAIR_LIST', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'GQT_REPAIR_LIST',
					name: 'REPAR',
					route: 'menu-GQT_REPAIR_LIST',
					order: '311',
					controller: 'REPAR',
					action: 'GQT_Menu_REPAIR_LIST',
					isPopup: false
				},
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'EDIT', formName: 'REPAR'
								}
							},
							formsDefinition: {
								'REPAR': {
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS GQT_MENU_REPAIR_LIST]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT GQT_MENU_REPAIR_LIST]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS GQT_REPAIR_LIST]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS GQT_MENU_REPAIR_LIST]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
