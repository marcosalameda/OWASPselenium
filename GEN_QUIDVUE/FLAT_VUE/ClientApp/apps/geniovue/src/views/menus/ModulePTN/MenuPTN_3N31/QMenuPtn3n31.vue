		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE PTN_Menu_3N31]/ -->
				</q-table>
...
<script>
	...
	import MenuViewModel from './QMenuPTN_3N31ViewModel.js'

	const requiredTextResources = ['QMenuPTN_3N31', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS PTN_MENU_3N31]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuPTN_3N31', false),

				interfaceMetadata: {
					id: 'QMenuPTN_3N31', // Used for resources
				...
				menuInfo: {
					id: '3N31',
					isMenuList: true,
					designation: computed(() => this.Resources.OPERACAO29482),
					acronym: 'PTN_3N31',
					name: 'OPERACOES',
					route: 'menu-PTN_3N31',
					order: '3N31',
					controller: 'OPERACOES',
					action: 'PTN_Menu_3N31',
					isPopup: false
				},
					...
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									limits: [
										{
											identifier: 'id',
											fnValueSelector: (row) => row.ValCodoperacoes
										},
									],
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'SHOW', formName: 'OPERACOES'
								}
							},
							formsDefinition: {
								'OPERACOES': {
							...
							defaultColumnSorting: {
								columnName: 'ValOperacao_ru',
								sortOrder: 'asc'
							}
						},
						globalEvents: ['changed-OPERACOES', 'changed-ENTIDADE'],
						uuid: 'cc6d4bc3-b7a0-4a3c-b78f-ecf7cb9cf987',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS PTN_MENU_3N31]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT PTN_MENU_3N31]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS PTN_3N31]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS PTN_MENU_3N31]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
