		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE STY_Menu_FULLCALENDAR]/ -->
				</q-table>
...
<script>
	...
	import MenuViewModel from './QMenuSTY_FULLCALENDARViewModel.js'

	const requiredTextResources = ['QMenuSTY_FULLCALENDAR', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS STY_MENU_FULLCALENDAR]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuStyFullcalendar',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuSTY_FULLCALENDAR', false),

				interfaceMetadata: {
					id: 'QMenuSTY_FULLCALENDAR', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'STY_FULLCALENDAR',
					name: 'EQUIP',
					route: 'menu-STY_FULLCALENDAR',
					order: '35111',
					controller: 'EQUIP',
					action: 'STY_Menu_FULLCALENDAR',
					isPopup: false
				},
				...
				controls: {
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'SHOW', formName: 'FULLCALE'
								}
							},
							formsDefinition: {
								'FULLCALE': {
						...
						uuid: 'cb03d09a-7795-4e74-9423-745e49d6ec5f',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS STY_MENU_FULLCALENDAR]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT STY_MENU_FULLCALENDAR]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS STY_FULLCALENDAR]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS STY_MENU_FULLCALENDAR]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
