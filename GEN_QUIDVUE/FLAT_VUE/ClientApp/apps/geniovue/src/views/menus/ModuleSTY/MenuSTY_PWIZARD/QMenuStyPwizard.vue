		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE STY_Menu_PWIZARD]/ -->
				</q-table>
...
<script>
	...
	import MenuViewModel from './QMenuSTY_PWIZARDViewModel.js'

	const requiredTextResources = ['QMenuSTY_PWIZARD', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS STY_MENU_PWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuStyPwizard',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuSTY_PWIZARD', false),

				interfaceMetadata: {
					id: 'QMenuSTY_PWIZARD', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'STY_PWIZARD',
					name: 'VENDA',
					route: 'menu-STY_PWIZARD',
					order: '42311',
					controller: 'SALE',
					action: 'STY_Menu_PWIZARD',
					isPopup: false
				},
				...
				controls: {
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'EDIT', formName: 'VENDAWP'
								}
							},
							formsDefinition: {
								'VENDAWP': {
						...
						uuid: 'a184b20e-024a-470b-9ef1-f0447e74da48',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS STY_MENU_PWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT STY_MENU_PWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS STY_PWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS STY_MENU_PWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
