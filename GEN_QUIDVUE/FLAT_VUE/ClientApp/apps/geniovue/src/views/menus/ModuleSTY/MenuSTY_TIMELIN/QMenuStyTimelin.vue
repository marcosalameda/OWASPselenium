		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE STY_Menu_TIMELIN]/ -->
				</q-table>
...
<script>
	...
	import MenuViewModel from './QMenuSTY_TIMELINViewModel.js'

	const requiredTextResources = ['QMenuSTY_TIMELIN', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS STY_MENU_TIMELIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuStyTimelin',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuSTY_TIMELIN', false),

				interfaceMetadata: {
					id: 'QMenuSTY_TIMELIN', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'STY_TIMELIN',
					name: 'WAREH',
					route: 'menu-STY_TIMELIN',
					order: '4111',
					controller: 'WAREH',
					action: 'STY_Menu_TIMELIN',
					isPopup: false
				},
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'SHOW', formName: 'TMLINE'
								}
							},
							formsDefinition: {
								'TMLINE': {
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS STY_MENU_TIMELIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT STY_MENU_TIMELIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS STY_TIMELIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS STY_MENU_TIMELIN]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
