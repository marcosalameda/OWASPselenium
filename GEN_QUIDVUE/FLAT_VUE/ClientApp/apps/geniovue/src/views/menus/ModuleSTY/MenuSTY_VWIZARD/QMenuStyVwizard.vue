		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE STY_Menu_VWIZARD]/ -->
				</q-table>
...
<script>
	...
	import MenuViewModel from './QMenuSTY_VWIZARDViewModel.js'

	const requiredTextResources = ['QMenuSTY_VWIZARD', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS STY_MENU_VWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuStyVwizard',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuSTY_VWIZARD', false),

				interfaceMetadata: {
					id: 'QMenuSTY_VWIZARD', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'STY_VWIZARD',
					name: 'VENDA',
					route: 'menu-STY_VWIZARD',
					order: '42211',
					controller: 'SALE',
					action: 'STY_Menu_VWIZARD',
					isPopup: false
				},
				...
				controls: {
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'EDIT', formName: 'VENDAWV'
								}
							},
							formsDefinition: {
								'VENDAWV': {
						...
						uuid: 'f2d1cbbd-a32f-46d9-bce2-59d3c80a3e1b',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS STY_MENU_VWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT STY_MENU_VWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS STY_VWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS STY_MENU_VWIZARD]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
