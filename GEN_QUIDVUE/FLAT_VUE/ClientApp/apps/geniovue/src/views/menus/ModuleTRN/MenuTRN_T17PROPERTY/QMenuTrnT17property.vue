		...
		<div
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE TRN_Menu_T17PROPERTY]/ -->
				</q-table>
			</q-row-container>
		</div>
	</teleport>
...
<script>
	...
	import MenuViewModel from './QMenuTRN_T17PROPERTYViewModel.js'

	const requiredTextResources = ['QMenuTRN_T17PROPERTY', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS TRN_MENU_T17PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuTrnT17property',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuTRN_T17PROPERTY', false),

				interfaceMetadata: {
					id: 'QMenuTRN_T17PROPERTY', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'TRN_T17PROPERTY',
					name: 'PROPE',
					route: 'menu-TRN_T17PROPERTY',
					order: '1H11',
					controller: 'PROPE',
					action: 'TRN_Menu_T17PROPERTY',
					isPopup: false
				},
				...
				controls: {
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'SHOW', formName: 'PROPE17'
								}
							},
							formsDefinition: {
								'PROPE17': {
						...
						uuid: 'fbf41316-5b58-43ba-b6ac-4e58695ac11d',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS TRN_MENU_T17PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT TRN_MENU_T17PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS TRN_T17PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS TRN_MENU_T17PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
