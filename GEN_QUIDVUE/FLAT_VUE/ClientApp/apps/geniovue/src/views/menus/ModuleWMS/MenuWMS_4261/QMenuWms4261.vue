...
<script>
	...
	import MenuViewModel from './QMenuWMS_4261ViewModel.js'

	const requiredTextResources = ['QMenuWMS_4261', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS WMS_MENU_4261]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuWMS_4261', false),

				interfaceMetadata: {
					id: 'QMenuWMS_4261', // Used for resources
				...
				menuInfo: {
					id: '4261',
					isMenuList: true,
					designation: computed(() => this.Resources.LOCATION_EXTENSION_C33560),
					acronym: 'WMS_4261',
					name: 'LCEXT',
					route: 'menu-WMS_4261',
					order: '4261',
					controller: 'LCEXT',
					action: 'WMS_Menu_4261',
					isPopup: false
				},
							...
							rowClickAction: {
								...
								params: {
									...
									limits: [
										{
											identifier: 'id',
											fnValueSelector: (row) => row.ValCodlcext
										},
									],
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'SHOW', formName: 'LCEXT',
								}
							},
							formsDefinition: {
								'LCEXT': {
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS WMS_MENU_4261]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT WMS_MENU_4261]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS WMS_4261]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS WMS_MENU_4261]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
