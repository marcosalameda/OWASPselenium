...
export default {
	install: (app) => {
		...
		// Special renderings
		app.component('QCalendar', defineAsyncComponent(() => import('./rendering/QCalendar.vue')))
		...
		app.component('QChart', defineAsyncComponent(() => import('./rendering/chart/QChart.vue')))
		app.component('QCollapsiblerowslist', defineAsyncComponent(() => import('./rendering/QCollapsiblerowslist.vue')))
