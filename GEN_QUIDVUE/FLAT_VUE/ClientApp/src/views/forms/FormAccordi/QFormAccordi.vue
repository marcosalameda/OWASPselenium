				...
				<q-row-container v-show="controls.ACCORDI_PSEUDNOVOGR05.isVisible">
					<q-control-wrapper
						...
						<q-accordion-container
							...
							v-on="controls.ACCORDI_PSEUDNOVOGR05.handlers"
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		watch: {
			...
			'controls.ACCORDI_PSEUDNOVOGR02.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'ACCORDI_PSEUDNOVOGR02',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.ACCORDI_PSEUDNOVOGR06.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'ACCORDI_PSEUDNOVOGR06',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.ACCORDI_PSEUDNOVOGR03.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'ACCORDI_PSEUDNOVOGR03',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.ACCORDI_PSEUDNOVOGR04.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'ACCORDI_PSEUDNOVOGR04',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.ACCORDI_PSEUDNOVOGR11.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'ACCORDI_PSEUDNOVOGR11',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
