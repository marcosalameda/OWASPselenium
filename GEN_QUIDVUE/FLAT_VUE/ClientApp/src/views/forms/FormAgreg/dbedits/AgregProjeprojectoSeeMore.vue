<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-agreg-projeprojecto-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['AGREG___PROJEPROJECTO_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AgregProjeprojectoSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('AGREG___PROJEPROJECTO_SeeMore', false),

				interfaceMetadata: {
					id: 'AGREG___PROJEPROJECTO_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'AGREG___PROJEPROJECTO_SeeMore',
					name: 'AGREG___PROJEPROJECTO_SeeMore',
					controller: 'AGREG',
					action: 'AGREG_ProjeValProjecto'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-agreg-projeprojecto',
				...
				isActive: true,
				returnElement: 'AGREG___PROJEPROJECTO_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-agreg-projeprojecto')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Agreg_Agreg_ProjeValProjecto',
