<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-agreg-year-year-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['AGREG___YEAR_YEAR_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AgregYearYearSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('AGREG___YEAR_YEAR_____SeeMore', false),

				interfaceMetadata: {
					id: 'AGREG___YEAR_YEAR_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'AGREG___YEAR_YEAR_____SeeMore',
					name: 'AGREG___YEAR_YEAR_____SeeMore',
					controller: 'AGREG',
					action: 'AGREG_YearValYear'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'AGREG___YEAR_YEAR_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-agreg-year-year')
		},
