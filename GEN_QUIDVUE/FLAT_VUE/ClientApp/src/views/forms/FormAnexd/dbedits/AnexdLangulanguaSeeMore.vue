<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-anexd-langulangua-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ANEXD___LANGULANGUA___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AnexdLangulanguaSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ANEXD___LANGULANGUA___SeeMore', false),

				interfaceMetadata: {
					id: 'ANEXD___LANGULANGUA___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ANEXD___LANGULANGUA___SeeMore',
					name: 'ANEXD___LANGULANGUA___SeeMore',
					controller: 'ANEXD',
					action: 'ANEXD_LanguValLangua'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-anexd-langulangua',
				headerTitle: computed(() => this.Resources.LANGUAGES08795),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'ANEXD___LANGULANGUA___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-anexd-langulangua')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Anexd_Anexd_LanguValLangua',
