					...
					<q-control-wrapper
						...
						<base-input-structure
							...
							<q-numeric-input
								...
								v-bind="controls.ANO_____YEAR_YEARNUM_"
								:model-value="model.ValYearnum.value"
...
<script>
	...
	import FormViewModel from './QFormAnoViewModel.js'

	const requiredTextResources = ['QFormAno', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormAno', false),

				interfaceMetadata: {
					id: 'QFormAno', // Used for resources
				...
				controls: {
					ANO_____YEAR_YEAR____: new fieldControlClass.StringControl({
						modelField: 'ValYear',
						valueChangeEvent: 'fieldChange:year.year',
						id: 'ANO_____YEAR_YEAR____',
						name: 'YEAR',
						size: 'mini',
						hasLabel: true,
					...
					ANO_____YEAR_YEARNUM_: new fieldControlClass.NumberControl({
						modelField: 'ValYearnum',
						valueChangeEvent: 'fieldChange:year.yearnum',
						maxIntegers: 4,
						maxDecimals: 0,
						id: 'ANO_____YEAR_YEARNUM_',
						name: 'YEARNUM',
						size: 'small',
						hasLabel: true,
						label: computed(() => this.Resources.YEAR__NUMBERS_29394),
						userHelp: '',
						description: '',
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
					...
					ANO_____PSEUDTODASDES: new fieldControlClass.TableListControl({
						...
						config: {
							...
							viewManagement: 'N',
							showLimitsInfo: true,
							tableTitle: computed(() => this.Resources.ALL_THE_EXPENSES38264),
						...
						controlLimits: [
							{
								identifier: ['id', 'year'],
								dependencyEvents: ['fieldChange:year.codyear'],
								dependencyField: 'YEAR.CODYEAR',
					...
					ANO_____PSEUDAGREGADO: new fieldControlClass.TableListControl({
						...
						config: {
							...
							viewManagement: 'N',
							showLimitsInfo: true,
							tableTitle: computed(() => this.Resources.AGGREGATED_PER_YEAR01261),
							showAlternatePagination: true,
							permissions: {
							},
							globalSearch: {
					...
					ANO_____YEAR_VALUE___: new fieldControlClass.CurrencyControl({
						modelField: 'ValValue',
						valueChangeEvent: 'fieldChange:year.value',
						maxIntegers: 7,
						maxDecimals: 2,
						id: 'ANO_____YEAR_VALUE___',
						name: 'VALUE',
						size: 'small',
						hasLabel: true,
						label: computed(() => this.Resources.VALUE10285),
				...
				tableFields: readonly([
					'ANO_____PSEUDTODASDES',
					'ANO_____PSEUDAGREGADO',
				]),
				...
				dataApi: {
					Year: {
						...
						get ValYearnum() { return vm.model.ValYearnum.value },
						set ValYearnum(value) { vm.model.ValYearnum.updateValue(value) },
					},
					keys: {
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS ANO]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS ANO]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS ANO]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS ANO]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS ANO]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS ANO]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS ANO]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS ANO]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
