<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-armapesswarehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ARMAPESSWAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ArmapesswarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ARMAPESSWAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'ARMAPESSWAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ARMAPESSWAREHWAREHDES_SeeMore',
					name: 'ARMAPESSWAREHWAREHDES_SeeMore',
					controller: 'WPESS',
					action: 'ARMAPESS_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-armapesswarehwarehdes',
				...
				isActive: true,
				returnElement: 'ARMAPESSWAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-armapesswarehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Armapess_WarehValWarehdes',
							serverMode: true,
						...
						uuid: 'Armapess_Armapess_WarehValWarehdes',
