<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-artig-warehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ARTIG___WAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ArtigWarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ARTIG___WAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'ARTIG___WAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ARTIG___WAREHWAREHDES_SeeMore',
					name: 'ARTIG___WAREHWAREHDES_SeeMore',
					controller: 'ITEM',
					action: 'ARTIG_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-artig-warehwarehdes',
				...
				isActive: true,
				returnElement: 'ARTIG___WAREHWAREHDES'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-artig-warehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Artig_Artig_WarehValWarehdes',
