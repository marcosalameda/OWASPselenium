<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-artigextgitemitemdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ARTIGEXTGITEMITEMDES__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ArtigextgitemitemdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ARTIGEXTGITEMITEMDES__SeeMore', false),

				interfaceMetadata: {
					id: 'ARTIGEXTGITEMITEMDES__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ARTIGEXTGITEMITEMDES__SeeMore',
					name: 'ARTIGEXTGITEMITEMDES__SeeMore',
					controller: 'ITEM',
					action: 'ARTIGEXT_GitemValItemdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-artigextgitemitemdes',
				headerTitle: computed(() => this.Resources.GLOBAL_ARTICLES62131),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'ARTIGEXTGITEMITEMDES__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-artigextgitemitemdes')
		},
					...
					configuration: {
						...
						config: {
							...
							defaultColumnSorting: {
								columnName: 'ValItemgcod',
								sortOrder: 'asc'
							}
						},
						globalEvents: ['changed-GITEM'],
						uuid: 'Artigext_Artigext_GitemValItemdes',
