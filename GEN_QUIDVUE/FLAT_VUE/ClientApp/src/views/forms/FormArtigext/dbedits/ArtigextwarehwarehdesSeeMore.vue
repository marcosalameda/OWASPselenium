<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-artigextwarehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ARTIGEXTWAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ArtigextwarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ARTIGEXTWAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'ARTIGEXTWAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ARTIGEXTWAREHWAREHDES_SeeMore',
					name: 'ARTIGEXTWAREHWAREHDES_SeeMore',
					controller: 'ITEM',
					action: 'ARTIGEXT_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-artigextwarehwarehdes',
				...
				isActive: true,
				returnElement: 'ARTIGEXTWAREHWAREHDES'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-artigextwarehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Artigext_WarehValWarehdes',
							serverMode: true,
						...
						uuid: 'Artigext_Artigext_WarehValWarehdes',
