	...
	<teleport
		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.ARTIGINVITEM_IMAGE___.isVisible">
					<q-control-wrapper
						v-show="controls.ARTIGINVITEM_IMAGE___.isVisible"
						class="control-join-group">
						<base-input-structure
							class="q-image"
							v-bind="controls.ARTIGINVITEM_IMAGE___"
				...
				<q-row-container v-show="controls.ARTIGINVGITEMITEMDES_.isVisible">
					<q-control-wrapper
						v-show="controls.ARTIGINVGITEMITEMDES_.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
							v-bind="controls.ARTIGINVGITEMITEMDES_"
				...
				<q-row-container v-show="controls.ARTIGINVWAREHWAREHDES.isVisible">
					<q-control-wrapper
						v-show="controls.ARTIGINVWAREHWAREHDES.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
							v-bind="controls.ARTIGINVWAREHWAREHDES"
				...
				<q-row-container v-show="controls.ARTIGINVITEM_ITEMTYPE.isVisible || controls.ARTIGINVITEM_ITEMCOD_.isVisible">
					<q-control-wrapper
						v-show="controls.ARTIGINVITEM_ITEMTYPE.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
							v-bind="controls.ARTIGINVITEM_ITEMTYPE"
					...
					<q-control-wrapper
						v-show="controls.ARTIGINVITEM_ITEMCOD_.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
							v-bind="controls.ARTIGINVITEM_ITEMCOD_"
				...
				<q-row-container v-show="controls.ARTIGINVITEM_ITEMDES_.isVisible || controls.ARTIGINVITEM_VALID___.isVisible">
					<q-control-wrapper
						v-show="controls.ARTIGINVITEM_ITEMDES_.isVisible || controls.ARTIGINVITEM_VALID___.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
							v-bind="controls.ARTIGINVITEM_ITEMDES_"
						...
						<base-input-structure
							class="i-checkbox"
							v-bind="controls.ARTIGINVITEM_VALID___"
			...
			return {
				...
				controls: {
					...
					ARTIGINVITEM_ITEMDES_: new fieldControlClass.StringControl({
						...
						labelPosition: computed(() => this.labelAlignment.topleft),
						maxLength: 85,
						labelId: 'label_ARTIGINVITEM_ITEMDES_',
						mustBeFilled: true,
						controlLimits: [
						],
					}, this),
