<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-artiginvgitemitemdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ARTIGINVGITEMITEMDES__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ArtiginvgitemitemdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ARTIGINVGITEMITEMDES__SeeMore', false),

				interfaceMetadata: {
					id: 'ARTIGINVGITEMITEMDES__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ARTIGINVGITEMITEMDES__SeeMore',
					name: 'ARTIGINVGITEMITEMDES__SeeMore',
					controller: 'ITEM',
					action: 'ARTIGINV_GitemValItemdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-artiginvgitemitemdes',
				...
				isActive: true,
				returnElement: 'ARTIGINVGITEMITEMDES__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-artiginvgitemitemdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Artiginv_Artiginv_GitemValItemdes',
