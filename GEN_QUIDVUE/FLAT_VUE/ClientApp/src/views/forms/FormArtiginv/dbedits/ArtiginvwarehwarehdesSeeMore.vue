<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-artiginvwarehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ARTIGINVWAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ArtiginvwarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ARTIGINVWAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'ARTIGINVWAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ARTIGINVWAREHWAREHDES_SeeMore',
					name: 'ARTIGINVWAREHWAREHDES_SeeMore',
					controller: 'ITEM',
					action: 'ARTIGINV_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-artiginvwarehwarehdes',
				...
				isActive: true,
				returnElement: 'ARTIGINVWAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-artiginvwarehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Artiginv_WarehValWarehdes',
							serverMode: true,
						...
						uuid: 'Artiginv_Artiginv_WarehValWarehdes',
