<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-artigvalwarehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ARTIGVALWAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ArtigvalwarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ARTIGVALWAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'ARTIGVALWAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ARTIGVALWAREHWAREHDES_SeeMore',
					name: 'ARTIGVALWAREHWAREHDES_SeeMore',
					controller: 'ITEM',
					action: 'ARTIGVAL_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-artigvalwarehwarehdes',
				...
				isActive: true,
				returnElement: 'ARTIGVALWAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-artigvalwarehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Artigval_WarehValWarehdes',
							serverMode: true,
						...
						uuid: 'Artigval_Artigval_WarehValWarehdes',
