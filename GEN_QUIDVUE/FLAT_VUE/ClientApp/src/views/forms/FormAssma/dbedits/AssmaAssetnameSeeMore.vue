<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-assma-assetname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ASSMA___ASSETNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AssmaAssetnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ASSMA___ASSETNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'ASSMA___ASSETNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ASSMA___ASSETNAME_____SeeMore',
					name: 'ASSMA___ASSETNAME_____SeeMore',
					controller: 'ASSMA',
					action: 'ASSMA_AssetValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'ASSMA___ASSETNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-assma-assetname')
		},
