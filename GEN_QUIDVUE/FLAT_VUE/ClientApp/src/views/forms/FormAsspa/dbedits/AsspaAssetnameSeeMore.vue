<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-asspa-assetname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ASSPA___ASSETNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AsspaAssetnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ASSPA___ASSETNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'ASSPA___ASSETNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ASSPA___ASSETNAME_____SeeMore',
					name: 'ASSPA___ASSETNAME_____SeeMore',
					controller: 'ASSPA',
					action: 'ASSPA_AssetValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-asspa-assetname',
				headerTitle: computed(() => this.Resources.ASSETS12081),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'ASSPA___ASSETNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-asspa-assetname')
		},
