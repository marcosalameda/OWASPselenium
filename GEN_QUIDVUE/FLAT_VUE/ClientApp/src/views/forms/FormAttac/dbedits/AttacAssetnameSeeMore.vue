<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-attac-assetname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ATTAC___ASSETNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AttacAssetnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ATTAC___ASSETNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'ATTAC___ASSETNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ATTAC___ASSETNAME_____SeeMore',
					name: 'ATTAC___ASSETNAME_____SeeMore',
					controller: 'ATTAC',
					action: 'ATTAC_AssetValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'ATTAC___ASSETNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-attac-assetname')
		},
