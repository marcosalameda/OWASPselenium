					...
					<q-control-wrapper
						...
						<base-input-structure
							...
							<q-toggle-input
								...
								:true-label="controls.CAMPO___FLDS_LOGICENU.trueLabel"
								:false-label="controls.CAMPO___FLDS_LOGICENU.falseLabel"
								:readonly="controls.CAMPO___FLDS_LOGICENU.readonly"
