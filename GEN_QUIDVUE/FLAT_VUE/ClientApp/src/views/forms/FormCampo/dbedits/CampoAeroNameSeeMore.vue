<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-campo-aero-name-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CAMPO___AERO_NAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'CampoAeroNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CAMPO___AERO_NAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'CAMPO___AERO_NAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CAMPO___AERO_NAME_____SeeMore',
					name: 'CAMPO___AERO_NAME_____SeeMore',
					controller: 'FLDS',
					action: 'CAMPO_AeroValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'CAMPO___AERO_NAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-campo-aero-name')
		},
