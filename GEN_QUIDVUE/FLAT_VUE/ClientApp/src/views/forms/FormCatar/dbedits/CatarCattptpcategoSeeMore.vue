<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-catar-cattptpcatego-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CATAR___CATTPTPCATEGO_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'CatarCattptpcategoSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CATAR___CATTPTPCATEGO_SeeMore', false),

				interfaceMetadata: {
					id: 'CATAR___CATTPTPCATEGO_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CATAR___CATTPTPCATEGO_SeeMore',
					name: 'CATAR___CATTPTPCATEGO_SeeMore',
					controller: 'ITEMC',
					action: 'CATAR_CattpValTpcatego'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-catar-cattptpcatego',
				headerTitle: computed(() => this.Resources.CATEGORY_TYPES54620),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'CATAR___CATTPTPCATEGO'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-catar-cattptpcatego')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Catar_Catar_CattpValTpcatego',
