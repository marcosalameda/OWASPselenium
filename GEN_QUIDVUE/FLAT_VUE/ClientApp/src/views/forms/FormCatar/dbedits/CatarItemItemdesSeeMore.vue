<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-catar-item-itemdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CATAR___ITEM_ITEMDES__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'CatarItemItemdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CATAR___ITEM_ITEMDES__SeeMore', false),

				interfaceMetadata: {
					id: 'CATAR___ITEM_ITEMDES__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CATAR___ITEM_ITEMDES__SeeMore',
					name: 'CATAR___ITEM_ITEMDES__SeeMore',
					controller: 'ITEMC',
					action: 'CATAR_ItemValItemdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-catar-item-itemdes',
				...
				isActive: true,
				returnElement: 'CATAR___ITEM_ITEMDES__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-catar-item-itemdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Catar_Catar_ItemValItemdes',
