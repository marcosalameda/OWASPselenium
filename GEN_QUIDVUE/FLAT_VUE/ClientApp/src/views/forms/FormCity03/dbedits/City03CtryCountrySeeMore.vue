<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-city03-ctry-country-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CITY03__CTRY_COUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'City03CtryCountrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CITY03__CTRY_COUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'CITY03__CTRY_COUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CITY03__CTRY_COUNTRY__SeeMore',
					name: 'CITY03__CTRY_COUNTRY__SeeMore',
					controller: 'CITY',
					action: 'CITY03_CtryValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-city03-ctry-country',
				...
				isActive: true,
				returnElement: 'CITY03__CTRY_COUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-city03-ctry-country')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'City03_City03_CtryValCountry',
