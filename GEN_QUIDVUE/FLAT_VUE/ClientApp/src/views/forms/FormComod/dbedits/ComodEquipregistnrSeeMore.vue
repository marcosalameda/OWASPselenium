...
<script>
	...
	const requiredTextResources = ['COMOD___EQUIPREGISTNR_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ComodEquipregistnrSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('COMOD___EQUIPREGISTNR_SeeMore', false),

				interfaceMetadata: {
					id: 'COMOD___EQUIPREGISTNR_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'COMOD___EQUIPREGISTNR_SeeMore',
					name: 'COMOD___EQUIPREGISTNR_SeeMore',
					controller: 'LENDI',
					action: 'COMOD_EquipValRegistnr'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'COMOD___EQUIPREGISTNR_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-comod-equipregistnr')
		},
