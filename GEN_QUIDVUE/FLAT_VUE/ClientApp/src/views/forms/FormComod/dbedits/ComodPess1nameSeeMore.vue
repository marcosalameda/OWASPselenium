<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-comod-pess1name-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['COMOD___PESS1NAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ComodPess1nameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('COMOD___PESS1NAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'COMOD___PESS1NAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'COMOD___PESS1NAME_____SeeMore',
					name: 'COMOD___PESS1NAME_____SeeMore',
					controller: 'LENDI',
					action: 'COMOD_Pess1ValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'COMOD___PESS1NAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-comod-pess1name')
		},
