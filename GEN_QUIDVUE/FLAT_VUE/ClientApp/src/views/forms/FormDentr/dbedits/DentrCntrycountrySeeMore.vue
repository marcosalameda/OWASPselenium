<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-dentr-cntrycountry-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DENTR___CNTRYCOUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DentrCntrycountrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DENTR___CNTRYCOUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'DENTR___CNTRYCOUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DENTR___CNTRYCOUNTRY__SeeMore',
					name: 'DENTR___CNTRYCOUNTRY__SeeMore',
					controller: 'INDOC',
					action: 'DENTR_CntryValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-dentr-cntrycountry',
				...
				isActive: true,
				returnElement: 'DENTR___CNTRYCOUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-dentr-cntrycountry')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Dentr_Dentr_CntryValCountry',
