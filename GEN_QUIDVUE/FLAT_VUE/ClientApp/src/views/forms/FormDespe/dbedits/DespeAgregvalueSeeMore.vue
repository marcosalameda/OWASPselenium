<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-despe-agregvalue-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DESPE___AGREGVALUE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DespeAgregvalueSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DESPE___AGREGVALUE____SeeMore', false),

				interfaceMetadata: {
					id: 'DESPE___AGREGVALUE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DESPE___AGREGVALUE____SeeMore',
					name: 'DESPE___AGREGVALUE____SeeMore',
					controller: 'EXPEN',
					action: 'DESPE_AgregValValue'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-despe-agregvalue',
				headerTitle: computed(() => this.Resources.AGGREGATED_PER_YEAR01261),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'DESPE___AGREGVALUE____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-despe-agregvalue')
		},
