<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-despe-year-year-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DESPE___YEAR_YEAR_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DespeYearYearSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DESPE___YEAR_YEAR_____SeeMore', false),

				interfaceMetadata: {
					id: 'DESPE___YEAR_YEAR_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DESPE___YEAR_YEAR_____SeeMore',
					name: 'DESPE___YEAR_YEAR_____SeeMore',
					controller: 'EXPEN',
					action: 'DESPE_YearValYear'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'DESPE___YEAR_YEAR_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-despe-year-year')
		},
