<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-dispa-entitname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DISPA___ENTITNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DispaEntitnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DISPA___ENTITNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'DISPA___ENTITNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DISPA___ENTITNAME_____SeeMore',
					name: 'DISPA___ENTITNAME_____SeeMore',
					controller: 'DISPA',
					action: 'DISPA_EntitValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'DISPA___ENTITNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-dispa-entitname')
		},
