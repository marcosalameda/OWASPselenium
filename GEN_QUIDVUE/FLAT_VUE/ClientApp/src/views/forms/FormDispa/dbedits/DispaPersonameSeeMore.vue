<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-dispa-personame-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DISPA___PERSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DispaPersonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DISPA___PERSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'DISPA___PERSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DISPA___PERSONAME_____SeeMore',
					name: 'DISPA___PERSONAME_____SeeMore',
					controller: 'DISPA',
					action: 'DISPA_PersoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'DISPA___PERSONAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-dispa-personame')
		},
