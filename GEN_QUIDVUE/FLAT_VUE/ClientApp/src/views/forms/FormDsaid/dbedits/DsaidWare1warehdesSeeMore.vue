<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-dsaid-ware1warehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DSAID___WARE1WAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DsaidWare1warehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DSAID___WARE1WAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'DSAID___WARE1WAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DSAID___WARE1WAREHDES_SeeMore',
					name: 'DSAID___WARE1WAREHDES_SeeMore',
					controller: 'OUTPT',
					action: 'DSAID_Ware1ValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-dsaid-ware1warehdes',
				...
				isActive: true,
				returnElement: 'DSAID___WARE1WAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-dsaid-ware1warehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						globalEvents: ['changed-WARE1'],
						uuid: 'Dsaid_Dsaid_Ware1ValWarehdes',
