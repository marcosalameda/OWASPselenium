<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-empre-cntrycountry-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EMPRE___CNTRYCOUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EmpreCntrycountrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EMPRE___CNTRYCOUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'EMPRE___CNTRYCOUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EMPRE___CNTRYCOUNTRY__SeeMore',
					name: 'EMPRE___CNTRYCOUNTRY__SeeMore',
					controller: 'CMPNY',
					action: 'EMPRE_CntryValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-empre-cntrycountry',
				...
				isActive: true,
				returnElement: 'EMPRE___CNTRYCOUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-empre-cntrycountry')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Empre_Empre_CntryValCountry',
