<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equigroupess1name-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIGROUPESS1NAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Equigroupess1nameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIGROUPESS1NAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIGROUPESS1NAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIGROUPESS1NAME_____SeeMore',
					name: 'EQUIGROUPESS1NAME_____SeeMore',
					controller: 'EQUIP',
					action: 'EQUIGROU_Pess1ValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'EQUIGROUPESS1NAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-equigroupess1name')
		},
					...
					configuration: {
						...
						columnsOriginal: [
							new listColumnTypes.TextColumn({
								...
								area: 'PESS1',
								field: 'NAME',
								label: computed(() => this.Resources.NAME55452),
								dataLength: 85,
								scrollData: 85,
							}),
						],
						config: {
							name: 'Equigrou_Pess1ValName',
							serverMode: true,
						...
						uuid: 'Equigrou_Equigrou_Pess1ValName',
