<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equigroutpequtipoequi-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIGROUTPEQUTIPOEQUI_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquigroutpequtipoequiSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIGROUTPEQUTIPOEQUI_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIGROUTPEQUTIPOEQUI_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIGROUTPEQUTIPOEQUI_SeeMore',
					name: 'EQUIGROUTPEQUTIPOEQUI_SeeMore',
					controller: 'EQUIP',
					action: 'EQUIGROU_TpequValTipoequi'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equigroutpequtipoequi',
				...
				isActive: true,
				returnElement: 'EQUIGROUTPEQUTIPOEQUI_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-equigroutpequtipoequi')
		},
					...
					configuration: {
						...
						columnsOriginal: [
							new listColumnTypes.TextColumn({
								...
								area: 'TPEQU',
								field: 'TIPOEQUI',
								label: computed(() => this.Resources.TIPOEQUI34411),
								dataLength: 50,
								scrollData: 50,
							}, computed(() => vm.model), computed(() => vm.internalEvents)),
						],
						config: {
							name: 'Equigrou_TpequValTipoequi',
							serverMode: true,
						...
						uuid: 'Equigrou_Equigrou_TpequValTipoequi',
