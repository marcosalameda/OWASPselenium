...
export default class ViewModel extends ViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		watch(() => this.ValSitefabr.value, (newValue, oldValue) => this.onUpdate('equip.sitefabr', this.ValSitefabr, newValue, oldValue))
		...
		watch(() => this.ValBefore.value, (newValue, oldValue) => this.onUpdate('equip.before', this.ValBefore, newValue, oldValue))
		...
		watch(() => this.ValFollowin.value, (newValue, oldValue) => this.onUpdate('equip.followin', this.ValFollowin, newValue, oldValue))
		...
		watch(() => this.ValLast.value, (newValue, oldValue) => this.onUpdate('equip.last', this.ValLast, newValue, oldValue))
		...
		this.ValMoviment = reactive(new modelFieldType.String({
			type: 'Text',
			id: 'ValMoviment',
		...
		watch(() => this.ValMoviment.value, (newValue, oldValue) => this.onUpdate('equip.moviment', this.ValMoviment, newValue, oldValue))
		...
		watch(() => this.ValLastpho.value, (newValue, oldValue) => this.onUpdate('equip.lastpho', this.ValLastpho, newValue, oldValue))
		...
		watch(() => this.TableDecomDecomnr.value, (newValue, oldValue) => this.onUpdate('decom.decomnr', this.TableDecomDecomnr, newValue, oldValue))
		...
		watch(() => this.ValIfabatif.value, (newValue, oldValue) => this.onUpdate('equip.ifabatif', this.ValIfabatif, newValue, oldValue))
		...
		watch(() => this.List_Movimevv_SelectedIds.value, (newValue, oldValue) => this.onUpdate('pseud.movimevv', this.List_Movimevv_SelectedIds, newValue, oldValue))
