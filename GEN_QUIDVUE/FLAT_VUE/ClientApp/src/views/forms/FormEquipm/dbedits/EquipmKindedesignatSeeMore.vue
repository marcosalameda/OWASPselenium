<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equipm-kindedesignat-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIPM__KINDEDESIGNAT_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipmKindedesignatSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIPM__KINDEDESIGNAT_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIPM__KINDEDESIGNAT_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIPM__KINDEDESIGNAT_SeeMore',
					name: 'EQUIPM__KINDEDESIGNAT_SeeMore',
					controller: 'ASSET',
					action: 'EQUIPM_KindeValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equipm-kindedesignat',
				...
				isActive: true,
				returnElement: 'EQUIPM__KINDEDESIGNAT_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-equipm-kindedesignat')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Equipm_Equipm_KindeValDesignat',
