<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-facil-entitname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FACIL___ENTITNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FacilEntitnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FACIL___ENTITNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'FACIL___ENTITNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FACIL___ENTITNAME_____SeeMore',
					name: 'FACIL___ENTITNAME_____SeeMore',
					controller: 'FACIL',
					action: 'FACIL_EntitValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FACIL___ENTITNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-facil-entitname')
		},
