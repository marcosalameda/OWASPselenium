<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-facilfexfactytype-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FACILFEXFACTYTYPE_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FacilfexfactytypeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FACILFEXFACTYTYPE_____SeeMore', false),

				interfaceMetadata: {
					id: 'FACILFEXFACTYTYPE_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FACILFEXFACTYTYPE_____SeeMore',
					name: 'FACILFEXFACTYTYPE_____SeeMore',
					controller: 'FACIL',
					action: 'FACILFEX_FactyValType'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FACILFEXFACTYTYPE_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-facilfexfactytype')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Facilfex_Facilfex_FactyValType',
