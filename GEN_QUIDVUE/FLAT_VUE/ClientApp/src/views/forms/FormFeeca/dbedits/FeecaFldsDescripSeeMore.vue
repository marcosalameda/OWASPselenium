<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-feeca-flds-descrip-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FEECA___FLDS_DESCRIP__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FeecaFldsDescripSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FEECA___FLDS_DESCRIP__SeeMore', false),

				interfaceMetadata: {
					id: 'FEECA___FLDS_DESCRIP__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FEECA___FLDS_DESCRIP__SeeMore',
					name: 'FEECA___FLDS_DESCRIP__SeeMore',
					controller: 'FEECA',
					action: 'FEECA_FldsValDescrip'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-feeca-flds-descrip',
				headerTitle: computed(() => this.Resources.FIELD_TYPES49172),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'FEECA___FLDS_DESCRIP__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-feeca-flds-descrip')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Feeca_Feeca_FldsValDescrip',
