								...
								<q-control-wrapper
									...
									<base-input-structure
										...
										<q-toggle-input
											...
											:true-label="controls.FLDSTBL_FLDS_LOGICENU.trueLabel"
											:false-label="controls.FLDSTBL_FLDS_LOGICENU.falseLabel"
											:readonly="controls.FLDSTBL_FLDS_LOGICENU.readonly"
								...
								<q-control-wrapper
									...
									<base-input-structure
										...
										<q-text-field
											...
											:model-value="model.PseudValField001.value"
		...
		data()
		{
			...
			return {
				...
				controls: {
					...
					FLDSTBL_FLDS_DESCRIP_: new fieldControlClass.StringControl({
					...
					FLDSTBL_PSEUDFIELD003: new fieldControlClass.ImageControl({
						...
						container: 'FLDSTBL_PSEUDNOVOGR06',
						icon: {
							icon: computed(() => `${this.system.resourcesPath}pexels-polat-eyyüp-albayrak-13933341.jpg`),
							type: 'img',
						},
						height: 500,
						width: 500,
