<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fldstbl-aero-name-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FLDSTBL_AERO_NAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FldstblAeroNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FLDSTBL_AERO_NAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'FLDSTBL_AERO_NAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FLDSTBL_AERO_NAME_____SeeMore',
					name: 'FLDSTBL_AERO_NAME_____SeeMore',
					controller: 'FLDS',
					action: 'FLDSTBL_AeroValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FLDSTBL_AERO_NAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-fldstbl-aero-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Fldstbl_Fldstbl_AeroValName',
