<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-globfactfactytype-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['GLOBFACTFACTYTYPE_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'GlobfactfactytypeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('GLOBFACTFACTYTYPE_____SeeMore', false),

				interfaceMetadata: {
					id: 'GLOBFACTFACTYTYPE_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'GLOBFACTFACTYTYPE_____SeeMore',
					name: 'GLOBFACTFACTYTYPE_____SeeMore',
					controller: 'GLOB',
					action: 'GLOBFACT_FactyValType'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'GLOBFACTFACTYTYPE_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-globfactfactytype')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Globfact_Globfact_FactyValType',
