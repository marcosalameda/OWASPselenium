...
export default class ViewModel extends ViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'EQUIP',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_GMAPS'
			}
		})
		...
		this.ValRegistnr = reactive(new modelFieldType.String({
			...
			valueFormula: {
				...
				fnFormula(params)
				{
					return netAPI.postData('EQUIP', 'GMAPS_EQUIP_REGISTNR_Formula', this.serverObjModel, undefined, undefined, undefined, this.navigationId)
				},
	...
	/**
	 * Creates a clone of the current QFormGmapsViewModel instance.
	 * @returns {QFormGmapsViewModel} A new instance of QFormGmapsViewModel
	 */
	clone()
	{
