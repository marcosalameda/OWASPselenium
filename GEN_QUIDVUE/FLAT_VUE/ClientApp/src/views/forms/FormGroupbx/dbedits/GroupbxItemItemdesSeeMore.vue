<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-groupbx-item-itemdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['GROUPBX_ITEM_ITEMDES__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'GroupbxItemItemdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('GROUPBX_ITEM_ITEMDES__SeeMore', false),

				interfaceMetadata: {
					id: 'GROUPBX_ITEM_ITEMDES__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'GROUPBX_ITEM_ITEMDES__SeeMore',
					name: 'GROUPBX_ITEM_ITEMDES__SeeMore',
					controller: 'EQUIP',
					action: 'GROUPBX_ItemValItemdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-groupbx-item-itemdes',
				...
				isActive: true,
				returnElement: 'GROUPBX_ITEM_ITEMDES__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-groupbx-item-itemdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Groupbx_Groupbx_ItemValItemdes',
