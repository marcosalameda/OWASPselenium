<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-groupbx-warehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['GROUPBX_WAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'GroupbxWarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('GROUPBX_WAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'GROUPBX_WAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'GROUPBX_WAREHWAREHDES_SeeMore',
					name: 'GROUPBX_WAREHWAREHDES_SeeMore',
					controller: 'EQUIP',
					action: 'GROUPBX_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-groupbx-warehwarehdes',
				headerTitle: computed(() => this.Resources.WAREHOUSES43533),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'GROUPBX_WAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-groupbx-warehwarehdes')
		},
					...
					configuration: {
						...
						config: {
							...
							defaultColumnSorting: {
								columnName: 'ValWarehcod',
								sortOrder: 'asc'
							}
						},
						changeEvents: ['changed-WAREH'],
						uuid: 'Groupbx_Groupbx_WarehValWarehdes',
