<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-item-warehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ITEM____WAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ItemWarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ITEM____WAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'ITEM____WAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ITEM____WAREHWAREHDES_SeeMore',
					name: 'ITEM____WAREHWAREHDES_SeeMore',
					controller: 'ITEM',
					action: 'ITEM_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-item-warehwarehdes',
				...
				isActive: true,
				returnElement: 'ITEM____WAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-item-warehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Item_Item_WarehValWarehdes',
