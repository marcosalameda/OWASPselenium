<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-lcext-locatgln-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LCEXT___LOCATGLN______SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LcextLocatglnSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LCEXT___LOCATGLN______SeeMore', false),

				interfaceMetadata: {
					id: 'LCEXT___LOCATGLN______SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LCEXT___LOCATGLN______SeeMore',
					name: 'LCEXT___LOCATGLN______SeeMore',
					controller: 'LCEXT',
					action: 'LCEXT_LocatValGln'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'LCEXT___LOCATGLN______lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-lcext-locatgln')
		},
