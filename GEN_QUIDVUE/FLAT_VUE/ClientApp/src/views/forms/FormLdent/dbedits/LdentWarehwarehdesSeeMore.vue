<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-ldent-warehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LDENT___WAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LdentWarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LDENT___WAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'LDENT___WAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LDENT___WAREHWAREHDES_SeeMore',
					name: 'LDENT___WAREHWAREHDES_SeeMore',
					controller: 'LDENT',
					action: 'LDENT_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-ldent-warehwarehdes',
				...
				isActive: true,
				returnElement: 'LDENT___WAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-ldent-warehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Ldent_Ldent_WarehValWarehdes',
