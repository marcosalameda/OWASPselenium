<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-ldentnorwarehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LDENTNORWAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LdentnorwarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LDENTNORWAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'LDENTNORWAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LDENTNORWAREHWAREHDES_SeeMore',
					name: 'LDENTNORWAREHWAREHDES_SeeMore',
					controller: 'LDENT',
					action: 'LDENTNOR_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-ldentnorwarehwarehdes',
				...
				isActive: true,
				returnElement: 'LDENTNORWAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-ldentnorwarehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Ldentnor_WarehValWarehdes',
							serverMode: true,
						...
						uuid: 'Ldentnor_Ldentnor_WarehValWarehdes',
