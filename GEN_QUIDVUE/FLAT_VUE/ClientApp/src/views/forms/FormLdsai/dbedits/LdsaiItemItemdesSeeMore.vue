<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-ldsai-item-itemdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LDSAI___ITEM_ITEMDES__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LdsaiItemItemdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LDSAI___ITEM_ITEMDES__SeeMore', false),

				interfaceMetadata: {
					id: 'LDSAI___ITEM_ITEMDES__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LDSAI___ITEM_ITEMDES__SeeMore',
					name: 'LDSAI___ITEM_ITEMDES__SeeMore',
					controller: 'OUTPU',
					action: 'LDSAI_ItemValItemdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-ldsai-item-itemdes',
				...
				isActive: true,
				returnElement: 'LDSAI___ITEM_ITEMDES__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-ldsai-item-itemdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Ldsai_Ldsai_ItemValItemdes',
