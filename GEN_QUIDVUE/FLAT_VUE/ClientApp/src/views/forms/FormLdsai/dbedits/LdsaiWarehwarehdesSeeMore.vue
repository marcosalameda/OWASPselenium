<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-ldsai-warehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LDSAI___WAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LdsaiWarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LDSAI___WAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'LDSAI___WAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LDSAI___WAREHWAREHDES_SeeMore',
					name: 'LDSAI___WAREHWAREHDES_SeeMore',
					controller: 'OUTPU',
					action: 'LDSAI_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-ldsai-warehwarehdes',
				...
				isActive: true,
				returnElement: 'LDSAI___WAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-ldsai-warehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Ldsai_Ldsai_WarehValWarehdes',
