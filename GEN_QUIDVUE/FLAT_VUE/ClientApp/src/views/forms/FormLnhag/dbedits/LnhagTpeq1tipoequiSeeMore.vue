<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-lnhag-tpeq1tipoequi-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LNHAG___TPEQ1TIPOEQUI_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LnhagTpeq1tipoequiSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LNHAG___TPEQ1TIPOEQUI_SeeMore', false),

				interfaceMetadata: {
					id: 'LNHAG___TPEQ1TIPOEQUI_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LNHAG___TPEQ1TIPOEQUI_SeeMore',
					name: 'LNHAG___TPEQ1TIPOEQUI_SeeMore',
					controller: 'LNHAG',
					action: 'LNHAG_Tpeq1ValTipoequi'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-lnhag-tpeq1tipoequi',
				...
				isActive: true,
				returnElement: 'LNHAG___TPEQ1TIPOEQUI_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-lnhag-tpeq1tipoequi')
		},
