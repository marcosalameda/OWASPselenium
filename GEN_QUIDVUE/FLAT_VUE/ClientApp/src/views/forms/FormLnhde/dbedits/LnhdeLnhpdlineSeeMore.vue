...
<script>
	...
	const requiredTextResources = ['LNHDE___LNHPDLINE_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LnhdeLnhpdlineSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LNHDE___LNHPDLINE_____SeeMore', false),

				interfaceMetadata: {
					id: 'LNHDE___LNHPDLINE_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LNHDE___LNHPDLINE_____SeeMore',
					name: 'LNHDE___LNHPDLINE_____SeeMore',
					controller: 'LNHDE',
					action: 'LNHDE_LnhpdValLine'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'LNHDE___LNHPDLINE_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-lnhde-lnhpdline')
		},
