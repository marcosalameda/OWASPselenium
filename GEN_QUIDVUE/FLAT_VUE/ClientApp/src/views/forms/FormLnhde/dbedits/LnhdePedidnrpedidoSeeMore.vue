<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-lnhde-pedidnrpedido-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LNHDE___PEDIDNRPEDIDO_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LnhdePedidnrpedidoSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LNHDE___PEDIDNRPEDIDO_SeeMore', false),

				interfaceMetadata: {
					id: 'LNHDE___PEDIDNRPEDIDO_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LNHDE___PEDIDNRPEDIDO_SeeMore',
					name: 'LNHDE___PEDIDNRPEDIDO_SeeMore',
					controller: 'LNHDE',
					action: 'LNHDE_PedidValNrpedido'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-lnhde-pedidnrpedido',
				headerTitle: computed(() => this.Resources.EQUIPMENT_REQUESTS07243),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'LNHDE___PEDIDNRPEDIDO_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-lnhde-pedidnrpedido')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Lnhde_Lnhde_PedidValNrpedido',
