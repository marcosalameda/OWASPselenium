<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-lnhpd-pedidnrpedido-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LNHPD___PEDIDNRPEDIDO_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LnhpdPedidnrpedidoSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LNHPD___PEDIDNRPEDIDO_SeeMore', false),

				interfaceMetadata: {
					id: 'LNHPD___PEDIDNRPEDIDO_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LNHPD___PEDIDNRPEDIDO_SeeMore',
					name: 'LNHPD___PEDIDNRPEDIDO_SeeMore',
					controller: 'LNHPD',
					action: 'LNHPD_PedidValNrpedido'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-lnhpd-pedidnrpedido',
				...
				isActive: true,
				returnElement: 'LNHPD___PEDIDNRPEDIDO_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-lnhpd-pedidnrpedido')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Lnhpd_Lnhpd_PedidValNrpedido',
