<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-lnhpd-tpequtipoequi-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LNHPD___TPEQUTIPOEQUI_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LnhpdTpequtipoequiSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LNHPD___TPEQUTIPOEQUI_SeeMore', false),

				interfaceMetadata: {
					id: 'LNHPD___TPEQUTIPOEQUI_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LNHPD___TPEQUTIPOEQUI_SeeMore',
					name: 'LNHPD___TPEQUTIPOEQUI_SeeMore',
					controller: 'LNHPD',
					action: 'LNHPD_TpequValTipoequi'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-lnhpd-tpequtipoequi',
				...
				isActive: true,
				returnElement: 'LNHPD___TPEQUTIPOEQUI_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-lnhpd-tpequtipoequi')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Lnhpd_Lnhpd_TpequValTipoequi',
