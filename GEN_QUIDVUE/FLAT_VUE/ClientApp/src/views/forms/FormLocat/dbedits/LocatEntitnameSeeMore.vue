<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-locat-entitname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LOCAT___ENTITNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LocatEntitnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LOCAT___ENTITNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'LOCAT___ENTITNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LOCAT___ENTITNAME_____SeeMore',
					name: 'LOCAT___ENTITNAME_____SeeMore',
					controller: 'LOCAT',
					action: 'LOCAT_EntitValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'LOCAT___ENTITNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-locat-entitname')
		},
