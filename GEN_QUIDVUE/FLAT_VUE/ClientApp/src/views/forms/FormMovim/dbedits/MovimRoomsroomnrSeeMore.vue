<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-movim-roomsroomnr-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['MOVIM___ROOMSROOMNR___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'MovimRoomsroomnrSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('MOVIM___ROOMSROOMNR___SeeMore', false),

				interfaceMetadata: {
					id: 'MOVIM___ROOMSROOMNR___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'MOVIM___ROOMSROOMNR___SeeMore',
					name: 'MOVIM___ROOMSROOMNR___SeeMore',
					controller: 'MOVIM',
					action: 'MOVIM_RoomsValRoomnr'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-movim-roomsroomnr',
				headerTitle: computed(() => this.Resources.ROOMS06809),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'MOVIM___ROOMSROOMNR___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-movim-roomsroomnr')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Movim_Movim_RoomsValRoomnr',
