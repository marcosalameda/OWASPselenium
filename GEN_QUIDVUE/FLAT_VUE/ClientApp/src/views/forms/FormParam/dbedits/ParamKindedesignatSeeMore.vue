<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-param-kindedesignat-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PARAM___KINDEDESIGNAT_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ParamKindedesignatSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PARAM___KINDEDESIGNAT_SeeMore', false),

				interfaceMetadata: {
					id: 'PARAM___KINDEDESIGNAT_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PARAM___KINDEDESIGNAT_SeeMore',
					name: 'PARAM___KINDEDESIGNAT_SeeMore',
					controller: 'PARAM',
					action: 'PARAM_KindeValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-param-kindedesignat',
				...
				isActive: true,
				returnElement: 'PARAM___KINDEDESIGNAT_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-param-kindedesignat')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Param_Param_KindeValDesignat',
