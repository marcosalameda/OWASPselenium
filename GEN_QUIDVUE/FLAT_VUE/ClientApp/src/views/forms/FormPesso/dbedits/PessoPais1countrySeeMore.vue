<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pesso-pais1country-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PESSO___PAIS1COUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PessoPais1countrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PESSO___PAIS1COUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'PESSO___PAIS1COUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PESSO___PAIS1COUNTRY__SeeMore',
					name: 'PESSO___PAIS1COUNTRY__SeeMore',
					controller: 'PESSO',
					action: 'PESSO_Pais1ValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-pesso-pais1country',
				...
				isActive: true,
				returnElement: 'PESSO___PAIS1COUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pesso-pais1country')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Pesso_Pesso_Pais1ValCountry',
