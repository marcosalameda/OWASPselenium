										...
										<q-row-container
											...
											<q-control-wrapper
												...
												<q-accordion-container
													...
													v-on="controls.PESSOS01PSEUDNOVOGR06.handlers"
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		watch: {
			...
			'controls.PESSOS01PSEUDNOVOGR03.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'PESSOS01PSEUDNOVOGR03',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.PESSOS01PSEUDNOVOGR04.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'PESSOS01PSEUDNOVOGR04',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.PESSOS01PSEUDNOVOGR05.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'PESSOS01PSEUDNOVOGR05',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.PESSOS01PSEUDNOVOGR07.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'PESSOS01PSEUDNOVOGR07',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
