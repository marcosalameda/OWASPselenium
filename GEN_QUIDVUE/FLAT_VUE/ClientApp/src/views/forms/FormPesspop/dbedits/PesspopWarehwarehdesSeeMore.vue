<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pesspop-warehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PESSPOP_WAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PesspopWarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PESSPOP_WAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'PESSPOP_WAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PESSPOP_WAREHWAREHDES_SeeMore',
					name: 'PESSPOP_WAREHWAREHDES_SeeMore',
					controller: 'WPESS',
					action: 'PESSPOP_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-pesspop-warehwarehdes',
				...
				isActive: true,
				returnElement: 'PESSPOP_WAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pesspop-warehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Pesspop_Pesspop_WarehValWarehdes',
