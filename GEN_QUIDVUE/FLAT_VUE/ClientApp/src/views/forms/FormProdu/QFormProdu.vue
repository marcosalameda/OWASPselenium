								...
								<q-control-wrapper
									...
									<base-input-structure
										...
										<q-toggle-input
											...
											:model-value="model.ValIn_use.value"
											:true-label="controls.PRODU___PRODUIN_USE__.trueLabel"
											:false-label="controls.PRODU___PRODUIN_USE__.falseLabel"
											:readonly="controls.PRODU___PRODUIN_USE__.readonly"
											@update:model-value="model.ValIn_use.fnUpdateValue" />
									</base-input-structure>
								</q-control-wrapper>
							</q-row-container>
								...
								<q-control-wrapper
									...
									<base-input-structure
										...
										<q-textarea-input
											...
											:rows="3"
											:cols="85"
											:is-required="controls.PRODU___PRODUDESCRIPT.isRequired"
											:readonly="controls.PRODU___PRODUDESCRIPT.readonly"
											:placeholder="controls.PRODU___PRODUDESCRIPT.placeholder"
								...
								<q-control-wrapper
									...
									<base-input-structure
										...
										<q-numeric-input
											...
											v-bind="controls.PRODU___PRODUINPUTS__"
											:model-value="model.ValInputs.value"
								...
								<q-control-wrapper
									...
									<base-input-structure
										...
										<q-numeric-input
											...
											v-bind="controls.PRODU___PRODUOUTPUTS_"
											:model-value="model.ValOutputs.value"
								...
								<q-control-wrapper
									...
									<base-input-structure
										...
										<q-numeric-input
											...
											v-bind="controls.PRODU___PRODUSTOCK___"
											:model-value="model.ValStock.value"
				...
				<q-row-container
					...
					<q-control-wrapper
						...
						<q-accordion-container
							...
							v-on="controls.PRODU___PSEUDNOVOGR06.handlers"
		...
		data()
		{
			...
			return {
				...
				controls: {
					...
					PRODU___PRODUDESCRIPT: new fieldControlClass.StringControl({
						...
						container: 'PRODU___PSEUDNOVOGR01',
						maxLength: 85,
						labelId: 'label_PRODU___PRODUDESCRIPT',
						mustBeFilled: false,
						controlLimits: [
						],
					}, this),
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		watch: {
			...
			'controls.PRODU___PSEUDNOVOGR02.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'PRODU___PSEUDNOVOGR02',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.PRODU___PSEUDNOVOGR04.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'PRODU___PSEUDNOVOGR04',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.PRODU___PSEUDNOVOGR05.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'PRODU___PSEUDNOVOGR05',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
