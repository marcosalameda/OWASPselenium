<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-produ-lcextglnext-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PRODU___LCEXTGLNEXT___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ProduLcextglnextSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PRODU___LCEXTGLNEXT___SeeMore', false),

				interfaceMetadata: {
					id: 'PRODU___LCEXTGLNEXT___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PRODU___LCEXTGLNEXT___SeeMore',
					name: 'PRODU___LCEXTGLNEXT___SeeMore',
					controller: 'PRODU',
					action: 'PRODU_LcextValGlnext'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PRODU___LCEXTGLNEXT___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-produ-lcextglnext')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Produ_Produ_LcextValGlnext',
