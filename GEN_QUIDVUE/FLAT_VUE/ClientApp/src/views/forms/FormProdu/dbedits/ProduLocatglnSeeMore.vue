<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-produ-locatgln-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PRODU___LOCATGLN______SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ProduLocatglnSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PRODU___LOCATGLN______SeeMore', false),

				interfaceMetadata: {
					id: 'PRODU___LOCATGLN______SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PRODU___LOCATGLN______SeeMore',
					name: 'PRODU___LOCATGLN______SeeMore',
					controller: 'PRODU',
					action: 'PRODU_LocatValGln'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PRODU___LOCATGLN______lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-produ-locatgln')
		},
