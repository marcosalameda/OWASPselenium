<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-produsimlcextglnext-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PRODUSIMLCEXTGLNEXT___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ProdusimlcextglnextSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PRODUSIMLCEXTGLNEXT___SeeMore', false),

				interfaceMetadata: {
					id: 'PRODUSIMLCEXTGLNEXT___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PRODUSIMLCEXTGLNEXT___SeeMore',
					name: 'PRODUSIMLCEXTGLNEXT___SeeMore',
					controller: 'PRODU',
					action: 'PRODUSIM_LcextValGlnext'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-produsimlcextglnext',
				headerTitle: computed(() => this.Resources.LOCATION_EXTENSION_C33560),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'PRODUSIMLCEXTGLNEXT___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-produsimlcextglnext')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Produsim_Produsim_LcextValGlnext',
