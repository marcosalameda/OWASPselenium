<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-prope01-agentname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPE01_AGENTNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Prope01AgentnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPE01_AGENTNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPE01_AGENTNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPE01_AGENTNAME_____SeeMore',
					name: 'PROPE01_AGENTNAME_____SeeMore',
					controller: 'PROPE',
					action: 'PROPE01_AgentValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PROPE01_AGENTNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-prope01-agentname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Prope01_Prope01_AgentValName',
