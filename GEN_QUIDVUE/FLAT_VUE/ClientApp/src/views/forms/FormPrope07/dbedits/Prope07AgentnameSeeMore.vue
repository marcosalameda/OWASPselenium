...
<script>
	...
	const requiredTextResources = ['PROPE07_AGENTNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Prope07AgentnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPE07_AGENTNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPE07_AGENTNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPE07_AGENTNAME_____SeeMore',
					name: 'PROPE07_AGENTNAME_____SeeMore',
					controller: 'PROPE',
					action: 'PROPE07_AgentValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PROPE07_AGENTNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-prope07-agentname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Prope07_Prope07_AgentValName',
