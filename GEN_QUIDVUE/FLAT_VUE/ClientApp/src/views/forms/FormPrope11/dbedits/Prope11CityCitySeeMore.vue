<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-prope11-city-city-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPE11_CITY_CITY_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Prope11CityCitySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPE11_CITY_CITY_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPE11_CITY_CITY_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPE11_CITY_CITY_____SeeMore',
					name: 'PROPE11_CITY_CITY_____SeeMore',
					controller: 'PROPE',
					action: 'PROPE11_CityValCity'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PROPE11_CITY_CITY_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-prope11-city-city')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Prope11_Prope11_CityValCity',
