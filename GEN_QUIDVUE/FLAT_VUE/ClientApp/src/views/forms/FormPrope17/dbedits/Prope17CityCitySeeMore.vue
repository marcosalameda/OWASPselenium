<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-prope17-city-city-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPE17_CITY_CITY_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Prope17CityCitySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPE17_CITY_CITY_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPE17_CITY_CITY_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPE17_CITY_CITY_____SeeMore',
					name: 'PROPE17_CITY_CITY_____SeeMore',
					controller: 'PROPE',
					action: 'PROPE17_CityValCity'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PROPE17_CITY_CITY_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-prope17-city-city')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Prope17_Prope17_CityValCity',
