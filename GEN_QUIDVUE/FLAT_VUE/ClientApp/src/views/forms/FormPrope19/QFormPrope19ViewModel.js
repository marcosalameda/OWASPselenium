...
export default class ViewModel extends ViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		this.ValBuildtyp = reactive(new modelFieldType.String({
			...
			area: 'PROPE',
			field: 'BUILDTYP',
			arrayOptions: qProjArrays.QArrayBuildtyp.setResources(vm.$getResource).elements,
			maxLength: 1,
		...
		this.ValTypology = reactive(new modelFieldType.Number({
			...
			area: 'PROPE',
			field: 'TYPOLOGY',
			arrayOptions: qProjArrays.QArrayAparttyp.setResources(vm.$getResource).elements,
			maxDigits: 1,
			decimalDigits: 0,
