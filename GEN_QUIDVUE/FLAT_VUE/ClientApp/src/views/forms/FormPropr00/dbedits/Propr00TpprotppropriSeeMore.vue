<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-propr00-tpprotppropri-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPR00_TPPROTPPROPRI_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Propr00TpprotppropriSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPR00_TPPROTPPROPRI_SeeMore', false),

				interfaceMetadata: {
					id: 'PROPR00_TPPROTPPROPRI_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPR00_TPPROTPPROPRI_SeeMore',
					name: 'PROPR00_TPPROTPPROPRI_SeeMore',
					controller: 'PROPR',
					action: 'PROPR00_TpproValTppropri'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-propr00-tpprotppropri',
				...
				isActive: true,
				returnElement: 'PROPR00_TPPROTPPROPRI_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-propr00-tpprotppropri')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Propr00_Propr00_TpproValTppropri',
