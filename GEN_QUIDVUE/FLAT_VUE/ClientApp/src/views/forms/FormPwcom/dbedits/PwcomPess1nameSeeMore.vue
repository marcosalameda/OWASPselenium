<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pwcom-pess1name-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PWCOM___PESS1NAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PwcomPess1nameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PWCOM___PESS1NAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PWCOM___PESS1NAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PWCOM___PESS1NAME_____SeeMore',
					name: 'PWCOM___PESS1NAME_____SeeMore',
					controller: 'PWCOM',
					action: 'PWCOM_Pess1ValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PWCOM___PESS1NAME____'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pwcom-pess1name')
		},
