<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pworg-psw-nome-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PWORG___PSW__NOME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PworgPswNomeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PWORG___PSW__NOME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PWORG___PSW__NOME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PWORG___PSW__NOME_____SeeMore',
					name: 'PWORG___PSW__NOME_____SeeMore',
					controller: 'PWORG',
					action: 'PWORG_PswValNome'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PWORG___PSW__NOME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pworg-psw-nome')
		},
