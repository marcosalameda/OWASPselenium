<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pwreg-psw-nome-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PWREG___PSW__NOME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PwregPswNomeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PWREG___PSW__NOME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PWREG___PSW__NOME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PWREG___PSW__NOME_____SeeMore',
					name: 'PWREG___PSW__NOME_____SeeMore',
					controller: 'PWREG',
					action: 'PWREG_PswValNome'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PWREG___PSW__NOME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pwreg-psw-nome')
		},
