<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-regia-cntrycountry-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['REGIA___CNTRYCOUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'RegiaCntrycountrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('REGIA___CNTRYCOUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'REGIA___CNTRYCOUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'REGIA___CNTRYCOUNTRY__SeeMore',
					name: 'REGIA___CNTRYCOUNTRY__SeeMore',
					controller: 'REGIO',
					action: 'REGIA_CntryValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-regia-cntrycountry',
				...
				isActive: true,
				returnElement: 'REGIA___CNTRYCOUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-regia-cntrycountry')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Regia_Regia_CntryValCountry',
