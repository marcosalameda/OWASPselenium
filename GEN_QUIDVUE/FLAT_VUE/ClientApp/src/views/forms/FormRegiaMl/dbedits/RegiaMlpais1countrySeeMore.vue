<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-regia-mlpais1country-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['REGIA_MLPAIS1COUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'RegiaMlpais1countrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('REGIA_MLPAIS1COUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'REGIA_MLPAIS1COUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'REGIA_MLPAIS1COUNTRY__SeeMore',
					name: 'REGIA_MLPAIS1COUNTRY__SeeMore',
					controller: 'REGIO',
					action: 'REGIA_ML_Pais1ValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-regia-mlpais1country',
				...
				isActive: true,
				returnElement: 'REGIA_MLPAIS1COUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-regia-mlpais1country')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Regia_ml_Regia_ml_Pais1ValCountry',
