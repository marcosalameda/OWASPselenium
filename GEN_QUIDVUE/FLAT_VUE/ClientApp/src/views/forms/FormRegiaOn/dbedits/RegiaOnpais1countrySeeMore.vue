<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-regia-onpais1country-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['REGIA_ONPAIS1COUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'RegiaOnpais1countrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('REGIA_ONPAIS1COUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'REGIA_ONPAIS1COUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'REGIA_ONPAIS1COUNTRY__SeeMore',
					name: 'REGIA_ONPAIS1COUNTRY__SeeMore',
					controller: 'REGIO',
					action: 'REGIA_ON_Pais1ValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-regia-onpais1country',
				...
				isActive: true,
				returnElement: 'REGIA_ONPAIS1COUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-regia-onpais1country')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						globalEvents: ['changed-PAIS1'],
						uuid: 'Regia_on_Regia_on_Pais1ValCountry',
