<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-regiaprocntrycountry-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['REGIAPROCNTRYCOUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'RegiaprocntrycountrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('REGIAPROCNTRYCOUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'REGIAPROCNTRYCOUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'REGIAPROCNTRYCOUNTRY__SeeMore',
					name: 'REGIAPROCNTRYCOUNTRY__SeeMore',
					controller: 'REGIO',
					action: 'REGIAPRO_CntryValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-regiaprocntrycountry',
				...
				isActive: true,
				returnElement: 'REGIAPROCNTRYCOUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-regiaprocntrycountry')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Regiapro_Regiapro_CntryValCountry',
