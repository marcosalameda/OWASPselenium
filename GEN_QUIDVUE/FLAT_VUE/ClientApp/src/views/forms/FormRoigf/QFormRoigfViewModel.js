...
export default class ViewModel extends ViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		watch(() => this.ValCodroigf.value, (newValue, oldValue) => this.onUpdate('roigf.codroigf', this.ValCodroigf, newValue, oldValue))
		...
		watch(() => this.ValCodrogl1.value, (newValue, oldValue) => this.onUpdate('roigf.codrogl1', this.ValCodrogl1, newValue, oldValue))
		...
		watch(() => this.ValOrder.value, (newValue, oldValue) => this.onUpdate('roigf.order', this.ValOrder, newValue, oldValue))
		...
		watch(() => this.ValTitle.value, (newValue, oldValue) => this.onUpdate('roigf.title', this.ValTitle, newValue, oldValue))
	}
	...
	set QPrimaryKey(value) { this.ValCodroigf.value = value }
}
