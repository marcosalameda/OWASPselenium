<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-roigi-rogl1title-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ROIGI___ROGL1TITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'RoigiRogl1titleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ROIGI___ROGL1TITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'ROIGI___ROGL1TITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ROIGI___ROGL1TITLE____SeeMore',
					name: 'ROIGI___ROGL1TITLE____SeeMore',
					controller: 'ROIGI',
					action: 'ROIGI_Rogl1ValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'ROIGI___ROGL1TITLE____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-roigi-rogl1title')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Roigi_Roigi_Rogl1ValTitle',
