...
export default class ViewModel extends ViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'TBLB',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_TBLB'
			}
		})
		...
		this.ValEnumt = reactive(new modelFieldType.String({
			...
			area: 'TBLB',
			field: 'ENUMT',
			arrayOptions: qProjArrays.QArrayTypet.setResources(vm.$getResource).elements,
			maxLength: 1,
		...
		this.ValEnumn = reactive(new modelFieldType.Number({
			...
			area: 'TBLB',
			field: 'ENUMN',
			arrayOptions: qProjArrays.QArrayTypen.setResources(vm.$getResource).elements,
			maxDigits: 1,
			decimalDigits: 0,
	...
	/**
	 * Creates a clone of the current QFormTblbViewModel instance.
	 * @returns {QFormTblbViewModel} A new instance of QFormTblbViewModel
	 */
	clone()
	{
