<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-tblk-trsb-name-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['TBLK____TRSB_NAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'TblkTrsbNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('TBLK____TRSB_NAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'TBLK____TRSB_NAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'TBLK____TRSB_NAME_____SeeMore',
					name: 'TBLK____TRSB_NAME_____SeeMore',
					controller: 'TBLK',
					action: 'TBLK_TrsbValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-tblk-trsb-name',
				headerTitle: computed(() => this.Resources.RELATED_TABLES__BASI34539),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'TBLK____TRSB_NAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-tblk-trsb-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						changeEvents: ['changed-TRSB'],
						uuid: 'Tblk_Tblk_TrsbValName',
