<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-tpcon-genregender-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['TPCON___GENREGENDER___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'TpconGenregenderSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('TPCON___GENREGENDER___SeeMore', false),

				interfaceMetadata: {
					id: 'TPCON___GENREGENDER___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'TPCON___GENREGENDER___SeeMore',
					name: 'TPCON___GENREGENDER___SeeMore',
					controller: 'TPCON',
					action: 'TPCON_GenreValGender'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-tpcon-genregender',
				headerTitle: computed(() => this.Resources.CONTACT_GENRES29532),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'TPCON___GENREGENDER___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-tpcon-genregender')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Tpcon_Tpcon_GenreValGender',
