<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-tpequ-familfamily-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['TPEQU___FAMILFAMILY___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'TpequFamilfamilySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('TPEQU___FAMILFAMILY___SeeMore', false),

				interfaceMetadata: {
					id: 'TPEQU___FAMILFAMILY___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'TPEQU___FAMILFAMILY___SeeMore',
					name: 'TPEQU___FAMILFAMILY___SeeMore',
					controller: 'TPEQU',
					action: 'TPEQU_FamilValFamily'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-tpequ-familfamily',
				headerTitle: computed(() => this.Resources.EQUIPMENTE_FAMILIES20990),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'TPEQU___FAMILFAMILY___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-tpequ-familfamily')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Tpequ_FamilValFamily',
							serverMode: true,
							pkColumn: 'ValCodfamil',
							tableAlias: 'FAMIL',
							tableNamePlural: computed(() => this.Resources.EQUIPMENTE_FAMILIES20990),
							viewManagement: 'N',
							showLimitsInfo: true,
							tableTitle: '',
						...
						globalEvents: ['changed-FAMIL'],
						uuid: 'Tpequ_Tpequ_FamilValFamily',
