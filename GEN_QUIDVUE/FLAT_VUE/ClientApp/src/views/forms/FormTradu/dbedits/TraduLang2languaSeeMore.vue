<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-tradu-lang2langua-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['TRADU___LANG2LANGUA___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'TraduLang2languaSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('TRADU___LANG2LANGUA___SeeMore', false),

				interfaceMetadata: {
					id: 'TRADU___LANG2LANGUA___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'TRADU___LANG2LANGUA___SeeMore',
					name: 'TRADU___LANG2LANGUA___SeeMore',
					controller: 'TRADU',
					action: 'TRADU_Lang2ValLangua'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'TRADU___LANG2LANGUA___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-tradu-lang2langua')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						changeEvents: ['changed-LANG2'],
						uuid: 'Tradu_Tradu_Lang2ValLangua',
