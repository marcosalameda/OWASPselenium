<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-users-personame-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['USERS___PERSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'UsersPersonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('USERS___PERSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'USERS___PERSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'USERS___PERSONAME_____SeeMore',
					name: 'USERS___PERSONAME_____SeeMore',
					controller: 'USERS',
					action: 'USERS_PersoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-users-personame',
				headerTitle: computed(() => this.Resources.PERSONS18356),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'USERS___PERSONAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-users-personame')
		},
