<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-venda-organorganiza-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['VENDA___ORGANORGANIZA_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'VendaOrganorganizaSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('VENDA___ORGANORGANIZA_SeeMore', false),

				interfaceMetadata: {
					id: 'VENDA___ORGANORGANIZA_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'VENDA___ORGANORGANIZA_SeeMore',
					name: 'VENDA___ORGANORGANIZA_SeeMore',
					controller: 'SALE',
					action: 'VENDA_OrganValOrganiza'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-venda-organorganiza',
				...
				isActive: true,
				returnElement: 'VENDA___ORGANORGANIZA_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-venda-organorganiza')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Venda_Venda_OrganValOrganiza',
