<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-vendaw01organorganiza-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['VENDAW01ORGANORGANIZA_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Vendaw01organorganizaSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('VENDAW01ORGANORGANIZA_SeeMore', false),

				interfaceMetadata: {
					id: 'VENDAW01ORGANORGANIZA_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'VENDAW01ORGANORGANIZA_SeeMore',
					name: 'VENDAW01ORGANORGANIZA_SeeMore',
					controller: 'SALE',
					action: 'VENDAW01_OrganValOrganiza'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-vendaw01organorganiza',
				headerTitle: computed(() => this.Resources.ORGANIZATIONS__NEW_O27983),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'VENDAW01ORGANORGANIZA_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-vendaw01organorganiza')
		},
					...
					configuration: {
						...
						columnsOriginal: [
							new listColumnTypes.TextColumn({
								...
								area: 'ORGAN',
								field: 'ORGANIZA',
								label: computed(() => this.Resources.ORGANIZATION__NEW_OR35065),
								dataLength: 85,
								scrollData: 85,
							}),
						],
						config: {
							name: 'Vendaw01_OrganValOrganiza',
							serverMode: true,
							pkColumn: 'ValCodorgan',
							tableAlias: 'ORGAN',
							tableNamePlural: computed(() => this.Resources.ORGANIZATIONS__NEW_O27983),
							viewManagement: 'N',
							showLimitsInfo: true,
							tableTitle: '',
							...
							defaultColumnSorting: {
								columnName: 'ValOrganiza',
								sortOrder: 'asc'
							}
						},
						changeEvents: ['changed-ORGAN'],
						uuid: 'Vendaw01_Vendaw01_OrganValOrganiza',
