					...
					<q-control-wrapper
						...
						<base-input-structure
							...
							<q-textarea-input
								...
								id="VISIT2__VISITDESCRIPT"
								size="xxlarge"
								:model-value="model.ValDescript.value"
								:rows="3"
								:cols="85"
								:is-required="controls.VISIT2__VISITDESCRIPT.isRequired"
								:readonly="controls.VISIT2__VISITDESCRIPT.readonly"
								:placeholder="controls.VISIT2__VISITDESCRIPT.placeholder"
						...
						<base-input-structure
							...
							<template #label>
								<q-checkbox-input
									...
									id="VISIT2__VISITTODOODIA"
									size="mini"
									:model-value="model.ValTodoodia.value"
									:readonly="controls.VISIT2__VISITTODOODIA.readonly"
...
<script>
	...
	const requiredTextResources = ['QFormVisit2', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS VISIT2]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreVisit2Equipregistnr: defineAsyncComponent(() => import('@/views/forms/FormVisit2/dbedits/Visit2EquipregistnrSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVisit2', false),

				interfaceMetadata: {
					id: 'QFormVisit2', // Used for resources
				...
				controls: {
					VISIT2__EQUIPREGISTNR: new fieldControlClass.LookupControl({
						modelField: 'TableEquipRegistnr',
						valueChangeEvent: 'fieldChange:equip.registnr',
						id: 'VISIT2__EQUIPREGISTNR',
						name: 'REGISTNR',
						size: 'mini',
						hasLabel: true,
					...
					VISIT2__VISITTITLE___: new fieldControlClass.StringControl({
						modelField: 'ValTitle',
						valueChangeEvent: 'fieldChange:visit.title',
						id: 'VISIT2__VISITTITLE___',
						name: 'TITLE',
						size: 'xxlarge',
						hasLabel: true,
					...
					VISIT2__VISITSTARTDT_: new fieldControlClass.DateControl({
						modelField: 'ValStartdt',
						valueChangeEvent: 'fieldChange:visit.startdt',
						id: 'VISIT2__VISITSTARTDT_',
						name: 'STARTDT',
						size: 'medium',
						hasLabel: true,
					...
					VISIT2__VISITDTFIM___: new fieldControlClass.DateControl({
						modelField: 'ValDtfim',
						valueChangeEvent: 'fieldChange:visit.dtfim',
						id: 'VISIT2__VISITDTFIM___',
						name: 'DTFIM',
						size: 'medium',
						hasLabel: true,
					...
					VISIT2__VISITDESCRIPT: new fieldControlClass.StringControl({
						...
						labelPosition: computed(() => this.labelAlignment.topleft),
						maxLength: 85,
						labelId: 'label_VISIT2__VISITDESCRIPT',
						mustBeFilled: false,
						controlLimits: [
						],
					}, this),
					VISIT2__VISITTODOODIA: new fieldControlClass.BooleanControl({
					...
					VISIT2__VISITCOLOR___: new fieldControlClass.StringControl({
						modelField: 'ValColor',
						valueChangeEvent: 'fieldChange:visit.color',
						id: 'VISIT2__VISITCOLOR___',
						name: 'COLOR',
						size: 'xlarge',
						hasLabel: true,
				...
				dataApi: {
					...
					Visit: {
						get ValBack() { return vm.model.ValBack.value },
						set ValBack(value) { vm.model.ValBack.updateValue(value) },
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS VISIT2]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
