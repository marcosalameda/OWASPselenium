<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-visit2-equipregistnr-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['VISIT2__EQUIPREGISTNR_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Visit2EquipregistnrSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('VISIT2__EQUIPREGISTNR_SeeMore', false),

				interfaceMetadata: {
					id: 'VISIT2__EQUIPREGISTNR_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'VISIT2__EQUIPREGISTNR_SeeMore',
					name: 'VISIT2__EQUIPREGISTNR_SeeMore',
					controller: 'VISIT',
					action: 'VISIT2_EquipValRegistnr'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-visit2-equipregistnr',
				...
				isActive: true,
				returnElement: 'VISIT2__EQUIPREGISTNR_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-visit2-equipregistnr')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Visit2_Visit2_EquipValRegistnr',
