<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-wid-iequwarehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['WID_IEQUWAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'WidIequwarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('WID_IEQUWAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'WID_IEQUWAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'WID_IEQUWAREHWAREHDES_SeeMore',
					name: 'WID_IEQUWAREHWAREHDES_SeeMore',
					controller: 'EQUIP',
					action: 'WID_IEQU_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-wid-iequwarehwarehdes',
				...
				isActive: true,
				returnElement: 'WID_IEQUWAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-wid-iequwarehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Wid_iequ_WarehValWarehdes',
							serverMode: true,
						...
						uuid: 'Wid_iequ_Wid_iequ_WarehValWarehdes',
