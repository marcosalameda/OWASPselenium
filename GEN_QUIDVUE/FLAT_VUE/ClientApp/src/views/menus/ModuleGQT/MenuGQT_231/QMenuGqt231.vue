...
<script>
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('GQT_Menu_231', false),

				interfaceMetadata: {
					id: 'QMenuGQT_231', // Used for resources
		...
		methods: {
			...
			applyChanges()
			{
				const action = 'GQT_Menu_231_Execute'
