...
<script>
	...
	const requiredTextResources = ['QMenuGQT_251', 'hardcoded', 'messages']
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('GQT_Menu_251', false),

				interfaceMetadata: {
					id: 'QMenuGQT_251', // Used for resources
		...
		methods: {
			...
			applyChanges()
			{
				const action = 'GQT_Menu_251_Execute'
