...
<script>
	...
	const requiredTextResources = ['QMenuPTN_231', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS PTN_MENU_231]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuPTN_231', false),

				interfaceMetadata: {
					id: 'QMenuPTN_231', // Used for resources
				...
				model: {
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							// The list support form: REGRA
							crudConditions: {
								// eslint-disable-next-line no-unused-vars
								update: (row) => {
									// eslint-disable-next-line eqeqeq
									if (!(row.Fields.ValTipocond!="U"||row.Fields.ValLocal!="F"))
										return false
									return true
								},
								// eslint-disable-next-line no-unused-vars
								view: (row) => {
									// eslint-disable-next-line eqeqeq
									if (!(row.Fields.ValTipocond!="V"||row.Fields.ValLocal!="F"))
										return false
									return true
								},
								// eslint-disable-next-line no-unused-vars
								delete: (row) => {
									// eslint-disable-next-line eqeqeq
									if (!(row.Fields.ValTipocond!="D"||row.Fields.ValLocal!="F"))
										return false
									return true
								},
							},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS PTN_MENU_231]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS PTN_MENU_231]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
