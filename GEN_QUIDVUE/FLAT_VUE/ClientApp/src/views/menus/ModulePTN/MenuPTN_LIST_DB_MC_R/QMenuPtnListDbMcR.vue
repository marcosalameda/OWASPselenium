...
<script>
	...
	const requiredTextResources = ['QMenuPTN_LIST_DB_MC_R', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS PTN_MENU_LIST_DB_MC_R]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuPtnListDbMcR',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuPTN_LIST_DB_MC_R', false),

				interfaceMetadata: {
					id: 'QMenuPTN_LIST_DB_MC_R', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'PTN_LIST_DB_MC_R',
					name: 'ITEM',
					route: 'menu-PTN_LIST_DB_MC_R',
					order: '391',
					controller: 'ITEM',
					action: 'PTN_Menu_LIST_DB_MC_R',
					isPopup: false
				},
		...
		mounted()
		{
			...
			this.$eventHub.on('EXEC-PTN_MenuMC_LIST_DB_MC_R', this.PTN_MenuMC_LIST_DB_MC_R)
			this.$eventHub.on('EXEC-MENU-ROUTINE-PTN_LIST_DB_MC_R', this.onExecRoutineEvent)

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS PTN_MENU_LIST_DB_MC_R]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
			 ...
			 */
			PTN_MenuMC_LIST_DB_MC_R(params)
			{
				return netAPI.postData(this.controls.menu.controller, 'PTN_MenuMC_LIST_DB_MC_R', params, (data) => {
					if (data.actionName)
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			PTN_Menu_LIST_DB_MC_R_MenuR_OPENARTIGVAL(jsonRouteValues, fnAfterConfirm)
			{
				jsonRouteValues.action = 'PTN_Menu_LIST_DB_MC_R_MenuR_OPENARTIGVAL'
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			PTN_Menu_LIST_DB_MC_R_MenuR_OPENARTIGINV(jsonRouteValues, fnAfterConfirm)
			{
				jsonRouteValues.action = 'PTN_Menu_LIST_DB_MC_R_MenuR_OPENARTIGINV'
				this.PTN_MenuR_OPENARTIGINV(jsonRouteValues, fnAfterConfirm)
			},
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS PTN_LIST_DB_MC_R]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS PTN_MENU_LIST_DB_MC_R]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
