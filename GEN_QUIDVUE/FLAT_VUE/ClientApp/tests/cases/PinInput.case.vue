		...
		<div class="form-flow">
		  <q-row-container>
			<q-control-wrapper class="control-join-group">
				<div class="input-group" id ="input-length-container">
					<label for="input-length">Input Length:</label>
					<input type="number" id="input-length" v-model="inputLength">
				</div>
				<div class="input-group">
					<label for="allow-alphanumeric">Alphanumeric</label>
					<input type="checkbox" name="allow-alphanumeric" v-model="alphanumeric">
				</div>
				<div class="input-group">
				...
				<div class="input-group">
					...
					<select id="selectedTheme" v-model="selectedTheme">
				...
				<div class="input-group">
					...
					<select id="selectBorder" v-model="selectBorder">
				...
				<div class="input-group">
					...
					<input type="text" id="v-model-input" v-model="pinValue">
				</div>
			</q-control-wrapper>
		  </q-row-container>
		  <div class="pin-input-container">
			<base-input-structure id="CTRL_1" label="Input pin">
			  <q-pin-input
				:charNumber="inputLength"
				:pinType="inputType"
				:theme="selectedTheme"
