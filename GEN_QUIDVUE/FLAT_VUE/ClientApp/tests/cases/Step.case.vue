<template>
			...
			<div class="form-flow">
				<q-row-container>
					<q-control-wrapper class="control-join-group">
						<base-input-structure id="CTRL_1" label="Step Input">
                            <div class="step-column">
                                <div class="step-container">
                                        ...
                                        <div class="step-block" id="live"> 
                                            <Step v-model="text" @update:modelValue="handleChange" v-bind="live.stepProperties"/>
                                        </div>
                                </div>
  ...
  <script>
  import Step from '@/components/rendering/QStep.vue';
