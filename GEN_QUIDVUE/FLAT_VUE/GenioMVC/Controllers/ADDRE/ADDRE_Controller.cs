...
namespace GenioMVC.Controllers
{
	public partial class AddreController : ControllerBase
	{
		...
		public AddreController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION ADDRE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAaddre>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER ADDRE]/
		...
		/// <summary>
		/// Recalculate formulas of the "Addre" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Addre([FromBody]Addre_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "addre",
				(primaryKey) => Models.Addre.Find(primaryKey, UserContext.Current, "FADDRE"),
				(model) => formData.MapToModel(model as Models.Addre)
			);
		}
		...
		{
			return base.GetDocumsTickets("ADDRE", requestModel.FieldName, requestModel.KeyValue);
		}
