...
namespace GenioMVC.Controllers
{
	public partial class AddreController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult WMS_Menu_721([FromBody]RequestMenuModel requestModel)
		{
			...
			WMS_Menu_721_ViewModel model = new WMS_Menu_721_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_WMS_MENU_721.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_WMS_MENU_721.Action)
