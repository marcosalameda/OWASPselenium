...
// USE /[MANUAL GQT INCLUDE_CONTROLLER ADDRL]/

namespace GenioMVC.Controllers
{
	public partial class AddrlController : ControllerBase
	{
		private IChatbotService _aiService;
		public AddrlController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION ADDRL]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAaddrl>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER ADDRL]/
		...
		{
			return base.GetDocumsTickets("ADDRL", requestModel.FieldName, requestModel.KeyValue);
		}
