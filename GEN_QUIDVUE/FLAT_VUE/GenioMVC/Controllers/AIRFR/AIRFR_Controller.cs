...
// USE /[MANUAL GQT INCLUDE_CONTROLLER AIRFR]/

namespace GenioMVC.Controllers
{
	public partial class AirfrController : ControllerBase
	{
		private IChatbotService _aiService;
		public AirfrController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AIRFR]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAairfr>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER AIRFR]/
		...
		{
			return base.GetDocumsTickets("AIRFR", requestModel.FieldName, requestModel.KeyValue);
		}
