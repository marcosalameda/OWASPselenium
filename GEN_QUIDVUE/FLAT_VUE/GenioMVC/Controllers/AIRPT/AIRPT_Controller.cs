...
// USE /[MANUAL GQT INCLUDE_CONTROLLER AIRPT]/
...
namespace GenioMVC.Controllers
{
	public partial class AirptController : ControllerBase
	{
		...
		public AirptController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AIRPT]/
...
// USE /[MANUAL GQT MANUAL_CONTROLLER AIRPT]/
		...
		{
			return base.GetDocumsTickets("AIRPT", requestModel.FieldName, requestModel.KeyValue);
		}
