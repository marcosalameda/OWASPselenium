...
namespace GenioMVC.Controllers
{
	public partial class AnexdController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult GQT_Menu_931([FromBody]RequestMenuModel requestModel)
		{
			...
			GQT_Menu_931_ViewModel model = new GQT_Menu_931_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_GQT_MENU_931.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_GQT_MENU_931.Action)
