...
namespace GenioMVC.Controllers
{
	public partial class AsspaController : ControllerBase
	{
		...
		public AsspaController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER ASSPA]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Asspa row = new Models.Asspa(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Asspa([FromBody]Asspa_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "asspa",
				(primaryKey) => Models.Asspa.Find(primaryKey, UserContext.Current, "FASSPA"),
				(model) => formData.MapToModel(model as Models.Asspa)
			);
		}
		...
		{
			return base.GetDocumsTickets("ASSPA", requestModel.FieldName, requestModel.KeyValue);
		}
