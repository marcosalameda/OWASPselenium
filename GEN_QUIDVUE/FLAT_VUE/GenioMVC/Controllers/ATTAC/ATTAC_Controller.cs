...
namespace GenioMVC.Controllers
{
	public partial class AttacController : ControllerBase
	{
		...
		public AttacController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER ATTAC]/
		...
		{
			return base.GetDocumsTickets("ATTAC", requestModel.FieldName, requestModel.KeyValue);
		}
