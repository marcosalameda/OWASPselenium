...
namespace GenioMVC.Controllers
{
	public partial class CategController : ControllerBase
	{
		...
		public CategController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION CATEG]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcateg>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER CATEG]/
		...
		/// <summary>
		/// Recalculate formulas of the "Categ" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Categ([FromBody]Categ_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "categ",
				(primaryKey) => Models.Categ.Find(primaryKey, UserContext.Current, "FCATEG"),
				(model) => formData.MapToModel(model as Models.Categ)
			);
		}
		...
		{
			return base.GetDocumsTickets("CATEG", requestModel.FieldName, requestModel.KeyValue);
		}
