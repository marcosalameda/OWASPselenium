...
// USE /[MANUAL GQT INCLUDE_CONTROLLER CCORR]/

namespace GenioMVC.Controllers
{
	public partial class CcorrController : ControllerBase
	{
		private IChatbotService _aiService;
		public CcorrController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION CCORR]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAccorr>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER CCORR]/
		...
		{
			return base.GetDocumsTickets("CCORR", requestModel.FieldName, requestModel.KeyValue);
		}
