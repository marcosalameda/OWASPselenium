...
namespace GenioMVC.Controllers
{
	public partial class CmpkiController : ControllerBase
	{
		...
		public CmpkiController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER CMPKI]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Cmpki row = new Models.Cmpki(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Cmpki([FromBody]Cmpki_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "cmpki",
				(primaryKey) => Models.Cmpki.Find(primaryKey, UserContext.Current, "FCMPKI"),
				(model) => formData.MapToModel(model as Models.Cmpki)
			);
		}
		...
		{
			return base.GetDocumsTickets("CMPKI", requestModel.FieldName, requestModel.KeyValue);
		}
