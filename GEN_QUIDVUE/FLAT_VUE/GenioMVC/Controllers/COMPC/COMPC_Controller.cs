...
namespace GenioMVC.Controllers
{
	public partial class CompcController : ControllerBase
	{
		...
		public CompcController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION COMPC]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcompc>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER COMPC]/
		...
		/// <summary>
		/// Recalculate formulas of the "Compclas" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Compclas([FromBody]Compclas_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "compc",
				(primaryKey) => Models.Compc.Find(primaryKey, UserContext.Current, "FCOMPCLAS"),
				(model) => formData.MapToModel(model as Models.Compc)
			);
		}
		...
		{
			return base.GetDocumsTickets("COMPC", requestModel.FieldName, requestModel.KeyValue);
		}
