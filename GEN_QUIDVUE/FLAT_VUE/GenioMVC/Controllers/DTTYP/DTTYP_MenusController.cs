...
namespace GenioMVC.Controllers
{
	public partial class DttypController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult WMS_Menu_7111([FromBody]RequestMenuModel requestModel)
		{
			...
			WMS_Menu_7111_ViewModel model = new WMS_Menu_7111_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_WMS_MENU_7111.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_WMS_MENU_7111.Action)
