...
// USE /[MANUAL GQT AFTER_CANCEL WID_IEQU]/
		...
		public ActionResult Wid_iequ_TpequValTipoequi([FromBody]RequestLookupModel requestModel)
		{
			...
			Wid_iequ_TpequValTipoequi_ViewModel model = new Wid_iequ_TpequValTipoequi_ViewModel(UserContext.Current);
		...
		public ActionResult Wid_iequ_WarehValWarehdes([FromBody]RequestLookupModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
			...
			IsStateReadonly = true;
			Wid_iequ_WarehValWarehdes_ViewModel model = new Wid_iequ_WarehValWarehdes_ViewModel(UserContext.Current);
