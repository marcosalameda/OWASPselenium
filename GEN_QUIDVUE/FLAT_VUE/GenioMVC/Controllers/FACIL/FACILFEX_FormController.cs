...
// USE /[MANUAL GQT CONTROLLER_SHOW FACILFEX]/
		...
		public ActionResult Facilfex_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Facilfex_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST FACILFEX]/
		...
		{
			string id = requestModel.Id;
			Facilfex_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET FACILFEX]/
		public ActionResult Facilfex_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("facil");
					var model = GenioMVC.Models.Facil.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL FACILFEX]/
		...
		public ActionResult Facilfex_EntitValName([FromBody] Facilfex_EntitValNameModel requestModel)
		{
			...
			Models.Facil parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Facilfex_EntitValName_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Facilfex_FactyValType([FromBody] Facilfex_FactyValTypeModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Facilfex_FactyValType_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT FACILFEX]/
		...
		public class FacilfexDocumValidateTickets : RequestDocumValidateTickets
		{
			public Facilfex_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsFacilfex([FromBody] FacilfexDocumValidateTickets requestModel)
		{
