...
namespace GenioMVC.Controllers
{
	public partial class Fami1Controller : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult GQT_Menu_2921([FromBody]RequestMenuModel requestModel)
		{
			...
			GQT_Menu_2921_ViewModel model = new GQT_Menu_2921_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_GQT_MENU_2921.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_GQT_MENU_2921.Action)
