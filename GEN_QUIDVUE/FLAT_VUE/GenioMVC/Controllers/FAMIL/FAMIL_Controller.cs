...
// USE /[MANUAL GQT INCLUDE_CONTROLLER FAMIL]/

namespace GenioMVC.Controllers
{
	public partial class FamilController : ControllerBase
	{
		private IChatbotService _aiService;
		public FamilController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION FAMIL]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAfamil>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER FAMIL]/
		...
		{
			return base.GetDocumsTickets("FAMIL", requestModel.FieldName, requestModel.KeyValue);
		}
