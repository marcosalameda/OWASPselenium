...
// USE /[MANUAL GQT INCLUDE_CONTROLLER FTGRI]/

namespace GenioMVC.Controllers
{
	public partial class FtgriController : ControllerBase
	{
		private IChatbotService _aiService;
		public FtgriController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION FTGRI]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAftgri>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER FTGRI]/
		...
		{
			return base.GetDocumsTickets("FTGRI", requestModel.FieldName, requestModel.KeyValue);
		}
