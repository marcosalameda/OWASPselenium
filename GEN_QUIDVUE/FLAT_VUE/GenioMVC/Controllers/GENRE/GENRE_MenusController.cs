...
namespace GenioMVC.Controllers
{
	public partial class GenreController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult TBS_Menu_161([FromBody]RequestMenuModel requestModel)
		{
			...
			TBS_Menu_161_ViewModel model = new TBS_Menu_161_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_TBS_MENU_161.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_TBS_MENU_161.Action)
