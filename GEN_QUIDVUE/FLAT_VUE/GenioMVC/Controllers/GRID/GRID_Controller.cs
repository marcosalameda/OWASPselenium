...
// USE /[MANUAL GQT INCLUDE_CONTROLLER GRID]/
...
namespace GenioMVC.Controllers
{
	public partial class GridController : ControllerBase
	{
		...
		public GridController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION GRID]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAgrid>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER GRID]/
		...
		{
			return base.GetDocumsTickets("GRID", requestModel.FieldName, requestModel.KeyValue);
		}
