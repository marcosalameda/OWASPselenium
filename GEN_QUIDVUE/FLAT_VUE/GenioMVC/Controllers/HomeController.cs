...
namespace GenioMVC.Controllers
{
	...
	{
        public HomeController(UserContextService userContext): base(userContext)
        {
        }
...
// USE /[MANUAL GQT HOME_CONTROLLER_INDEX]/
		...
		/// <returns></returns>
		[HttpGet]
		public ActionResult GetEphFormAction(string module = "")
		{
			...
			if (user.EphTofill != null)
			{
				...
				while (!string.IsNullOrEmpty(id))
				{
					...
					actionName = menu.Route_VUE;
					id = menu.ParentId;
				}
			}

			return JsonOK(new { routeName = actionName });
		}
