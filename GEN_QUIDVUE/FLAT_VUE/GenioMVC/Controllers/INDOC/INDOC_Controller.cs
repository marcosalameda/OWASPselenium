...
namespace GenioMVC.Controllers
{
	public partial class IndocController : ControllerBase
	{
		...
		public IndocController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER INDOC]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Indoc row = new Models.Indoc(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Dentr([FromBody]Dentr_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "indoc",
				(primaryKey) => Models.Indoc.Find(primaryKey, UserContext.Current, "FDENTR"),
				(model) => formData.MapToModel(model as Models.Indoc)
			);
		}
		...
		{
			return base.GetDocumsTickets("INDOC", requestModel.FieldName, requestModel.KeyValue);
		}
