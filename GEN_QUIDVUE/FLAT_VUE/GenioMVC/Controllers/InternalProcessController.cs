...
namespace GenioMVC.Controllers
{
    public class InternalProcessController : Controller
    {
        ...
        {
            if(telemetryData == null) return Json(new { success = true });
        ...
        private void SetTraceTags(Activity activity, TelemetryEvent telemetryEvent)
        {
            ...
            if(telemetryEvent.Timestamp != null) TimestampToDateTime(Convert.ToInt64(telemetryEvent.Timestamp.ToString()) / 1000);
