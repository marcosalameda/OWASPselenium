...
// USE /[MANUAL GQT INCLUDE_CONTROLLER LANG1]/

namespace GenioMVC.Controllers
{
	public partial class Lang1Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Lang1Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION LANG1]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAlang1>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER LANG1]/
		...
		{
			return base.GetDocumsTickets("LANG1", requestModel.FieldName, requestModel.KeyValue);
		}
