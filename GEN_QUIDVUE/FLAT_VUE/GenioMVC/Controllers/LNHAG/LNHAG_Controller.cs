...
// USE /[MANUAL GQT MANUAL_CONTROLLER LNHAG]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Lnhag row = new Models.Lnhag(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Lnhag([FromBody]Lnhag_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "lnhag",
				(primaryKey) => Models.Lnhag.Find(primaryKey, UserContext.Current, "FLNHAG"),
				(model) => formData.MapToModel(model as Models.Lnhag)
			);
		}
		...
		{
			return base.GetDocumsTickets("LNHAG", requestModel.FieldName, requestModel.KeyValue);
		}
