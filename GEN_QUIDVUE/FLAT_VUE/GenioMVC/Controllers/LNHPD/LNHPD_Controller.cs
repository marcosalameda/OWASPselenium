...
// USE /[MANUAL GQT MANUAL_CONTROLLER LNHPD]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			try
			{
				row = Models.Lnhpd.Find(Navigation.GetStrValue("lnhpd"), UserContext.Current);
			}
			catch (Exception)
			{
			...
			if (row == null)
			{
				row = new Models.Lnhpd(UserContext.Current);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Lnhpd([FromBody]Lnhpd_ViewModel form_data)
		{
