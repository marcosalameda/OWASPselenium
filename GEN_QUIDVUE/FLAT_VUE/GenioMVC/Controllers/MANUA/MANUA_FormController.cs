...
// USE /[MANUAL GQT CONTROLLER_SHOW MANUA]/
		...
		public ActionResult Manua_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Manua_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST MANUA]/
		...
		{
			string id = requestModel.Id;
			Manua_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET MANUA]/
		public ActionResult Manua_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("manua");
					var model = GenioMVC.Models.Manua.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL MANUA]/
		...
		public ActionResult Manua_KindeValDesignat([FromBody] Manua_KindeValDesignatModel requestModel)
		{
			...
			Models.Manua parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Manua_KindeValDesignat_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT MANUA]/
		...
		/// <returns>A JSON response with the result of the operation</returns>
		public ActionResult SetFileManuaDigdocum([FromForm] RequestDocumsCreateModel requestModel)
		{
