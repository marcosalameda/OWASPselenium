...
namespace GenioMVC.Controllers
{
	public partial class MessaController : ControllerBase
	{
		...
		public MessaController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER MESSA]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Messa row = new Models.Messa(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Messa([FromBody]Messa_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "messa",
				(primaryKey) => Models.Messa.Find(primaryKey, UserContext.Current, "FMESSA"),
				(model) => formData.MapToModel(model as Models.Messa)
			);
		}
		...
		{
			return base.GetDocumsTickets("MESSA", requestModel.FieldName, requestModel.KeyValue);
		}
