...
namespace GenioMVC.Controllers
{
	public partial class MovimController : ControllerBase
	{
		...
		public MovimController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER MOVIM]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Movim row = new Models.Movim(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Movim([FromBody]Movim_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "movim",
				(primaryKey) => Models.Movim.Find(primaryKey, UserContext.Current, "FMOVIM"),
				(model) => formData.MapToModel(model as Models.Movim)
			);
		}
		...
		{
			return base.GetDocumsTickets("MOVIM", requestModel.FieldName, requestModel.KeyValue);
		}
