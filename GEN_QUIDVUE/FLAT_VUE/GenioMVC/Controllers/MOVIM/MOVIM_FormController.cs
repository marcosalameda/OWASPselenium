...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET MOVIM]/
		public ActionResult Movim_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					GenioMVC.Models.Movim model = new(UserContext.Current);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT MOVIM]/
		...
		public class MovimDocumValidateTickets : RequestDocumValidateTickets
		{
			public Movim_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsMovim([FromBody] MovimDocumValidateTickets requestModel)
		{
