...
// USE /[MANUAL GQT CONTROLLER_SHOW NOTIF]/
		...
		public ActionResult Notif_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Notif_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST NOTIF]/
		...
		{
			string id = requestModel.Id;
			Notif_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET NOTIF]/
		public ActionResult Notif_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("notif");
					var model = GenioMVC.Models.Notif.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL NOTIF]/
		...
		public ActionResult Notif_Pess2ValName([FromBody] Notif_Pess2ValNameModel requestModel)
		{
			...
			Models.Notif parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Notif_Pess2ValName_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT NOTIF]/
		...
		public class NotifDocumValidateTickets : RequestDocumValidateTickets
		{
			public Notif_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsNotif([FromBody] NotifDocumValidateTickets requestModel)
		{
