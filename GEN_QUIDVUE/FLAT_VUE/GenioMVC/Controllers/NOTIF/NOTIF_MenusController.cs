...
namespace GenioMVC.Controllers
{
	public partial class NotifController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult GQT_Menu_81([FromBody]RequestMenuModel requestModel)
		{
			...
			GQT_Menu_81_ViewModel model = new GQT_Menu_81_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_GQT_MENU_81.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_GQT_MENU_81.Action)
