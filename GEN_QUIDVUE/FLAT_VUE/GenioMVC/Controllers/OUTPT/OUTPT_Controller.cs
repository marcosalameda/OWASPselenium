...
namespace GenioMVC.Controllers
{
	public partial class OutptController : ControllerBase
	{
		...
		public OutptController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER OUTPT]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Outpt row = new Models.Outpt(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Dsaid([FromBody]Dsaid_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "outpt",
				(primaryKey) => Models.Outpt.Find(primaryKey, UserContext.Current, "FDSAID"),
				(model) => formData.MapToModel(model as Models.Outpt)
			);
		}
		...
		{
			return base.GetDocumsTickets("OUTPT", requestModel.FieldName, requestModel.KeyValue);
		}
