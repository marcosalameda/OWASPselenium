...
// USE /[MANUAL GQT CONTROLLER_SHOW PARAM]/
		...
		public ActionResult Param_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Param_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST PARAM]/
		...
		{
			string id = requestModel.Id;
			Param_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET PARAM]/
		public ActionResult Param_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("param");
					var model = GenioMVC.Models.Param.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL PARAM]/
		...
		public ActionResult Param_KindeValDesignat([FromBody] Param_KindeValDesignatModel requestModel)
		{
			...
			Models.Param parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Param_KindeValDesignat_ViewModel model = new(m_userContext, parentCtx);
