...
// USE /[MANUAL GQT INCLUDE_CONTROLLER PERIO]/

namespace GenioMVC.Controllers
{
	public partial class PerioController : ControllerBase
	{
		private IChatbotService _aiService;
		public PerioController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION PERIO]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAperio>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER PERIO]/
		...
		{
			return base.GetDocumsTickets("PERIO", requestModel.FieldName, requestModel.KeyValue);
		}
