...
namespace GenioMVC.Controllers
{
	...
	{
		public ProduController(UserContextService userContext): base(userContext) { }
...
// USE /[MANUAL GQT MANUAL_CONTROLLER PRODU]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			try
			{
				row = Models.Produ.Find(Navigation.GetStrValue("produ"), UserContext.Current);
			}
			catch (Exception)
			{
			...
			if (row == null)
			{
				row = new Models.Produ(UserContext.Current);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Produ([FromBody]Produ_ViewModel form_data)
		{
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Produsim([FromBody]Produsim_ViewModel form_data)
		{
			return GenericRecalculateFormulas(form_data, "produ",
