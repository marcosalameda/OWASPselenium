...
// USE /[MANUAL GQT CONTROLLER_SHOW PROPE17]/
		...
		public ActionResult Prope17_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Prope17_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST PROPE17]/
		...
		{
			string id = requestModel.Id;
			Prope17_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT AFTER_CANCEL PROPE17]/
		...
		public ActionResult Prope17_CityValCity([FromBody] Prope17_CityValCityModel requestModel)
		{
			...
			Prope17_CityValCity_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Prope17_AgentValName([FromBody] Prope17_AgentValNameModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Prope17_AgentValName_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Prope17_ValProphoto([FromBody] Prope17_ValProphotoModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Prope17_ValProphoto_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Prope17_ValPropcont([FromBody] Prope17_ValPropcontModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Prope17_ValPropcont_ViewModel model = new(m_userContext, parentCtx);
