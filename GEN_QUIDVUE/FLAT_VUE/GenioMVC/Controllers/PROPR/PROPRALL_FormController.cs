...
namespace GenioMVC.Controllers
{
	public partial class ProprController : ControllerBase
	{
		...
		public ActionResult Proprall_ModalDBEdit()
		{
			Proprall_ViewModel model = new Proprall_ViewModel(UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL PROPRALL]/
		...
		{
			var model = new Proprall_ViewModel(UserContext.Current, true);
			model.setModes(Request.Query["m"].ToString());
			PersistentSupport sp = UserContext.Current.PersistentSupport;
			var navigationLocationAction = ACTION_PROPRALL_NEW.SetRoutedValues(new { m = Request.Query["m"].ToString() });
		...
		[HttpPost]
		public ActionResult MFProprall_New_GET()
		{
			return MFProprall_New();
		}
		...
		public ActionResult MFProprall_Edit([FromBody]RequestIdModel requestModel)
		{
			var id = requestModel.Id;
			return RedirectToFormAction("PROPRALL", "EDIT", new { id = id, partialView = "MFProprall", nestedForm = "true", multiForm = "true" });
		}

		[HttpPost]
		public ActionResult MFProprall_Edit_GET([FromBody]RequestIdModel requestModel)
		{
			return MFProprall_Edit(requestModel);
		}

		//
		// GET /Propr/MFProprall_Cancel
		[ActionName("MFProprall_Cancel")]
		public ActionResult MFProprall_Cancel([FromBody]RequestIdModel requestModel)
		{
			var id = requestModel.Id;
		...
		public JsonResult MFProprall_Delete([FromBody]RequestIdModel requestModel)
		{
			var id = requestModel.Id;
			var eventSink = new EventSink()
			{
