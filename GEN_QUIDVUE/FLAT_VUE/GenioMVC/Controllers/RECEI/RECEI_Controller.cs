...
namespace GenioMVC.Controllers
{
	public partial class ReceiController : ControllerBase
	{
		...
		public ReceiController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER RECEI]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Recei row = new Models.Recei(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Recei([FromBody]Recei_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "recei",
				(primaryKey) => Models.Recei.Find(primaryKey, UserContext.Current, "FRECEI"),
				(model) => formData.MapToModel(model as Models.Recei)
			);
		}
		...
		{
			return base.GetDocumsTickets("RECEI", requestModel.FieldName, requestModel.KeyValue);
		}
