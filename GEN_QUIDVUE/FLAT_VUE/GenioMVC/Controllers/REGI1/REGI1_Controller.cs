...
// USE /[MANUAL GQT INCLUDE_CONTROLLER REGI1]/

namespace GenioMVC.Controllers
{
	public partial class Regi1Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Regi1Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION REGI1]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAregi1>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER REGI1]/
		...
		{
			return base.GetDocumsTickets("REGI1", requestModel.FieldName, requestModel.KeyValue);
		}
