...
namespace GenioMVC.Controllers
{
	public partial class RoigiController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult PTN_Menu_15411([FromBody]RequestMenuModel requestModel)
		{
			...
			PTN_Menu_15411_ViewModel model = new PTN_Menu_15411_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_PTN_MENU_15411.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_PTN_MENU_15411.Action)
...
// USE /[MANUAL PTN MENU_GET 15411]/
		...
		public ActionResult ReorderPTN_Menu_15411([FromBody]RequestReorderModel requestModel)
		{
