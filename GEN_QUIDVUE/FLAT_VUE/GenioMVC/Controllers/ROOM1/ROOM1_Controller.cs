...
// USE /[MANUAL GQT INCLUDE_CONTROLLER ROOM1]/

namespace GenioMVC.Controllers
{
	public partial class Room1Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Room1Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION ROOM1]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAroom1>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER ROOM1]/
		...
		{
			return base.GetDocumsTickets("ROOM1", requestModel.FieldName, requestModel.KeyValue);
		}
