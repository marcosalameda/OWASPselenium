...
namespace GenioMVC.Controllers
{
	public partial class SpeciController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult GQT_Menu_331([FromBody]RequestMenuModel requestModel)
		{
			...
			GQT_Menu_331_ViewModel model = new GQT_Menu_331_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_GQT_MENU_331.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_GQT_MENU_331.Action)
