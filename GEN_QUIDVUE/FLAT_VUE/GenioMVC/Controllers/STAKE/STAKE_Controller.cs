...
// USE /[MANUAL GQT INCLUDE_CONTROLLER STAKE]/

namespace GenioMVC.Controllers
{
	public partial class StakeController : ControllerBase
	{
		private IChatbotService _aiService;
		public StakeController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION STAKE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAstake>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER STAKE]/
		...
		{
			return base.GetDocumsTickets("STAKE", requestModel.FieldName, requestModel.KeyValue);
		}
