...
namespace GenioMVC.Controllers
{
	public partial class TabprController : ControllerBase
	{
		...
		public TabprController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER TABPR]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Tabpr row = new Models.Tabpr(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Tabpr([FromBody]Tabpr_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "tabpr",
				(primaryKey) => Models.Tabpr.Find(primaryKey, UserContext.Current, "FTABPR"),
				(model) => formData.MapToModel(model as Models.Tabpr)
			);
		}
		...
		{
			return base.GetDocumsTickets("TABPR", requestModel.FieldName, requestModel.KeyValue);
		}
