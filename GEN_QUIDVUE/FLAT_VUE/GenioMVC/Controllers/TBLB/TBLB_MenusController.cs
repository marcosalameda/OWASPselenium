...
namespace GenioMVC.Controllers
{
	public partial class TblbController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult PTN_Menu_1131([FromBody]RequestMenuModel requestModel)
		{
			...
			PTN_Menu_1131_ViewModel model = new PTN_Menu_1131_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_PTN_MENU_1131.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_PTN_MENU_1131.Action)
