...
namespace GenioMVC.Controllers
{
	public partial class TraduController : ControllerBase
	{
		...
		public TraduController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER TRADU]/
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Tradu([FromBody]Tradu_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "tradu",
				(primaryKey) => Models.Tradu.Find(primaryKey, UserContext.Current, "FTRADU"),
				(model) => formData.MapToModel(model as Models.Tradu)
			);
		}
		...
		{
			return base.GetDocumsTickets("TRADU", requestModel.FieldName, requestModel.KeyValue);
		}
