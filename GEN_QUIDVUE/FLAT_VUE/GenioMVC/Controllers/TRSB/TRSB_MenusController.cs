...
namespace GenioMVC.Controllers
{
	public partial class TrsbController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult PTN_Menu_1141([FromBody]RequestMenuModel requestModel)
		{
			...
			PTN_Menu_1141_ViewModel model = new PTN_Menu_1141_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_PTN_MENU_1141.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_PTN_MENU_1141.Action)
