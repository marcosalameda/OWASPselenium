...
namespace GenioMVC.Controllers
{
	public partial class UsersController : ControllerBase
	{
		...
		public UsersController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER USERS]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Users row = new Models.Users(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Users([FromBody]Users_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "users",
				(primaryKey) => Models.Users.Find(primaryKey, UserContext.Current, "FUSERS"),
				(model) => formData.MapToModel(model as Models.Users)
			);
		}
		...
		{
			return base.GetDocumsTickets("USERS", requestModel.FieldName, requestModel.KeyValue);
		}
