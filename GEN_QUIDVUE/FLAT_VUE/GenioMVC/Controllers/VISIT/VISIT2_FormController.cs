...
namespace GenioMVC.Controllers
{
	public partial class VisitController : ControllerBase
	{
		...
		private static readonly NavigationLocation ACTION_VISIT2_CANCEL = new("FULL_CALENDAR_EVENTS04140", "Visit2_Cancel", "Visit") { vueRouteName = "form-VISIT2", mode = "CANCEL" };
		private static readonly NavigationLocation ACTION_VISIT2_SHOW = new("FULL_CALENDAR_EVENTS04140", "Visit2_Show", "Visit") { vueRouteName = "form-VISIT2", mode = "SHOW" };
		private static readonly NavigationLocation ACTION_VISIT2_NEW = new("FULL_CALENDAR_EVENTS04140", "Visit2_New", "Visit") { vueRouteName = "form-VISIT2", mode = "NEW" };
		private static readonly NavigationLocation ACTION_VISIT2_EDIT = new("FULL_CALENDAR_EVENTS04140", "Visit2_Edit", "Visit") { vueRouteName = "form-VISIT2", mode = "EDIT" };
		private static readonly NavigationLocation ACTION_VISIT2_DUPLICATE = new("FULL_CALENDAR_EVENTS04140", "Visit2_Duplicate", "Visit") { vueRouteName = "form-VISIT2", mode = "DUPLICATE" };
		private static readonly NavigationLocation ACTION_VISIT2_DELETE = new("FULL_CALENDAR_EVENTS04140", "Visit2_Delete", "Visit") { vueRouteName = "form-VISIT2", mode = "DELETE" };
...
// USE /[MANUAL GQT CONTROLLER_SHOW VISIT2]/
		...
		public ActionResult Visit2_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Visit2_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST VISIT2]/
		...
		{
			string id = requestModel.Id;
			Visit2_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET VISIT2]/
		public ActionResult Visit2_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("visit");
					var model = GenioMVC.Models.Visit.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL VISIT2]/
		...
		public ActionResult Visit2_EquipValRegistnr([FromBody] Visit2_EquipValRegistnrModel requestModel)
		{
			...
			Models.Visit parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Visit2_EquipValRegistnr_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT VISIT2]/
		...
		public class Visit2DocumValidateTickets : RequestDocumValidateTickets
		{
			public Visit2_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsVisit2([FromBody] Visit2DocumValidateTickets requestModel)
		{
