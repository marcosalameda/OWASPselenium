...
namespace GenioMVC.Controllers
{
	public partial class WpessController : ControllerBase
	{
		...
		public ActionResult Armapess_ModalDBEdit()
		{
			Armapess_ViewModel model = new Armapess_ViewModel(UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL ARMAPESS]/
		...
		{
			var model = new Armapess_ViewModel(UserContext.Current, true);
			model.setModes(Request.Query["m"].ToString());
			PersistentSupport sp = UserContext.Current.PersistentSupport;
			var navigationLocationAction = ACTION_ARMAPESS_NEW.SetRoutedValues(new { m = Request.Query["m"].ToString() });
		...
		[HttpPost]
		public ActionResult MFArmapess_New_GET()
		{
			return MFArmapess_New();
		}
		...
		public ActionResult MFArmapess_Edit([FromBody]RequestIdModel requestModel)
		{
			var id = requestModel.Id;
			return RedirectToFormAction("ARMAPESS", "EDIT", new { id = id, partialView = "MFArmapess", nestedForm = "true", multiForm = "true" });
		}

		[HttpPost]
		public ActionResult MFArmapess_Edit_GET([FromBody]RequestIdModel requestModel)
		{
			return MFArmapess_Edit(requestModel);
		}

		//
		// GET /Wpess/MFArmapess_Cancel
		[ActionName("MFArmapess_Cancel")]
		public ActionResult MFArmapess_Cancel([FromBody]RequestIdModel requestModel)
		{
			var id = requestModel.Id;
		...
		public JsonResult MFArmapess_Delete([FromBody]RequestIdModel requestModel)
		{
			var id = requestModel.Id;
			var eventSink = new EventSink()
			{
