...
// USE /[MANUAL GQT MANUAL_CONTROLLER WPESS]/
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Armapess([FromBody]Armapess_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "wpess",
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Imgmagn([FromBody]Imgmagn_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "wpess",
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Pesspop([FromBody]Pesspop_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "wpess",
		...
		{
			return base.GetDocumsTickets("WPESS", requestModel.FieldName, requestModel.KeyValue);
		}
