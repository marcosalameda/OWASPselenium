...
namespace GenioMVC.Models
{
	public class Lang1 : ModelBase
	{
		...
		[ShouldSerialize("Lang1.ValCodlang")]
		...
		[ShouldSerialize("Lang1.ValLangua")]
		public string ValLangua { get { return klass.ValLangua; } set { klass.ValLangua = value; } }

		[DisplayName("Acronym")]
		/// <summary>Field : "Acronym" Tipo: "C" Formula:  ""</summary>
		[ShouldSerialize("Lang1.ValAcron")]
		public string ValAcron { get { return klass.ValAcron; } set { klass.ValAcron = value; } }

		[DisplayName("ZZSTATE")]
		[ShouldSerialize("Lang1.ValZzstate")]
		/// <summary>Field: "ZZSTATE", Type: "INT", Formula: ""</summary>
		public virtual int ValZzstate { get { return klass.ValZzstate; } set { klass.ValZzstate = value; } }

		public Lang1(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = new CSGenioAlang1(userContext.User);
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
				SetFieldsToSerialize(fieldsToSerialize);
		}

		public Lang1(UserContext userContext, CSGenioAlang1 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = val;
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
		...
		public static Lang1 Find(string id, UserContext userCtx, string identifier = null, string[] fieldsToSerialize = null, string[] fieldsToQuery = null)
		{
			...
			return record == null ? null : new Lang1(userCtx, record, false, fieldsToSerialize) { Identifier = identifier };
		}

		public static List<Lang1> AllModel(UserContext userCtx, CriteriaSet args = null, string identifier = null)
		{
			return Where<CSGenioAlang1>(userCtx, false, args, numRegs: -1, identifier: identifier).RowsForViewModel<Lang1>((r) => new Lang1(userCtx, r));
		}
