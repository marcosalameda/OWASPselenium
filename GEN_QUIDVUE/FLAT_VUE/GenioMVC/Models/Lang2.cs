...
namespace GenioMVC.Models
{
	public class Lang2 : ModelBase
	{
		...
		[ShouldSerialize("Lang2.ValCodlang")]
		...
		[ShouldSerialize("Lang2.ValLangua")]
		public string ValLangua { get { return klass.ValLangua; } set { klass.ValLangua = value; } }

		[DisplayName("Acronym")]
		/// <summary>Field : "Acronym" Tipo: "C" Formula:  ""</summary>
		[ShouldSerialize("Lang2.ValAcron")]
		public string ValAcron { get { return klass.ValAcron; } set { klass.ValAcron = value; } }

		[DisplayName("ZZSTATE")]
		[ShouldSerialize("Lang2.ValZzstate")]
		/// <summary>Field: "ZZSTATE", Type: "INT", Formula: ""</summary>
		public virtual int ValZzstate { get { return klass.ValZzstate; } set { klass.ValZzstate = value; } }

		public Lang2(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = new CSGenioAlang2(userContext.User);
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
				SetFieldsToSerialize(fieldsToSerialize);
		}

		public Lang2(UserContext userContext, CSGenioAlang2 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = val;
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
		...
		public static Lang2 Find(string id, UserContext userCtx, string identifier = null, string[] fieldsToSerialize = null, string[] fieldsToQuery = null)
		{
			...
			return record == null ? null : new Lang2(userCtx, record, false, fieldsToSerialize) { Identifier = identifier };
		}

		public static List<Lang2> AllModel(UserContext userCtx, CriteriaSet args = null, string identifier = null)
		{
			return Where<CSGenioAlang2>(userCtx, false, args, numRegs: -1, identifier: identifier).RowsForViewModel<Lang2>((r) => new Lang2(userCtx, r));
		}
