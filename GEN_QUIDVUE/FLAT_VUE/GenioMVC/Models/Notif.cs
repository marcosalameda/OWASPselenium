...
namespace GenioMVC.Models
{
	public class Notif : ModelBase
	{
		...
		[ShouldSerialize("Notif.ValCodnotif")]
		...
		[ShouldSerialize("Notif.ValNrcomoda")]
		[NumericAttribute(0)]
		...
		[ShouldSerialize("Notif.ValBegin")]
		...
		[ShouldSerialize("Notif.ValEmail")]
		...
		[ShouldSerialize("Notif.ValIdnotif")]
		...
		[ShouldSerialize("Notif.ValIdmsg")]
		...
		[ShouldSerialize("Notif.ValMessage")]
		...
		[ShouldSerialize("Notif.ValMailerr")]
		...
		[ShouldSerialize("Notif.ValDesignat")]
		...
		[ShouldSerialize("Notif.ValCreatdat")]
		[DataType(DataType.Date)]
		[DateAttribute("OD")]
		...
		[ShouldSerialize("Notif.ValCreatope")]
		...
		[ShouldSerialize("Notif.ValReturned")]
		...
		[ShouldSerialize("Notif.ValDtdevolu")]
		[DataType(DataType.Date)]
		[DateAttribute("D")]
		...
		{
			klass = new CSGenioAnotif(userContext.User);
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
				SetFieldsToSerialize(fieldsToSerialize);
		}

		public Notif(UserContext userContext, CSGenioAnotif val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = val;
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
		...
		public static Notif Find(string id, UserContext userCtx, string identifier = null, string[] fieldsToSerialize = null, string[] fieldsToQuery = null)
		{
			...
			return record == null ? null : new Notif(userCtx, record, false, fieldsToSerialize) { Identifier = identifier };
		}

		public static List<Notif> AllModel(UserContext userCtx, CriteriaSet args = null, string identifier = null)
		{
			return Where<CSGenioAnotif>(userCtx, false, args, numRegs: -1, identifier: identifier).RowsForViewModel<Notif>((r) => new Notif(userCtx, r));
		}
