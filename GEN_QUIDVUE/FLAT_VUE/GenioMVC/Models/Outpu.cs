...
namespace GenioMVC.Models
{
	public class Outpu : ModelBase
	{
		...
		public virtual Outpt Outpt
		{
			get
			{
				if (!isEmptyModel && (_outpt == null || (!string.IsNullOrEmpty(ValCodoutpt) && (_outpt.isEmptyModel || _outpt.klass.QPrimaryKey != ValCodoutpt))))
		...
		public virtual Oudoc Oudoc
		{
			get
			{
				if (!isEmptyModel && (_oudoc == null || (!string.IsNullOrEmpty(ValCoddocsd) && (_oudoc.isEmptyModel || _oudoc.klass.QPrimaryKey != ValCoddocsd))))
