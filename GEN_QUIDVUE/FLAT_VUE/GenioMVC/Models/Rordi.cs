...
namespace GenioMVC.Models
{
	public class Rordi : ModelBase
	{
		...
		[ShouldSerialize("Rordi.ValCodrordi")]
		...
		[ShouldSerialize("Rordi.ValOrder")]
		[NumericAttribute(0)]
		...
		[ShouldSerialize("Rordi.ValTitle")]
		public string ValTitle { get { return klass.ValTitle; } set { klass.ValTitle = value; } }

		[DisplayName("ZZSTATE")]
		[ShouldSerialize("Rordi.ValZzstate")]
		/// <summary>Field: "ZZSTATE", Type: "INT", Formula: ""</summary>
		public virtual int ValZzstate { get { return klass.ValZzstate; } set { klass.ValZzstate = value; } }

		public Rordi(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = new CSGenioArordi(userContext.User);
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
				SetFieldsToSerialize(fieldsToSerialize);
		}

		public Rordi(UserContext userContext, CSGenioArordi val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = val;
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
		...
		public static Rordi Find(string id, UserContext userCtx, string identifier = null, string[] fieldsToSerialize = null, string[] fieldsToQuery = null)
		{
			...
			return record == null ? null : new Rordi(userCtx, record, false, fieldsToSerialize) { Identifier = identifier };
		}

		public static List<Rordi> AllModel(UserContext userCtx, CriteriaSet args = null, string identifier = null)
		{
			return Where<CSGenioArordi>(userCtx, false, args, numRegs: -1, identifier: identifier).RowsForViewModel<Rordi>((r) => new Rordi(userCtx, r));
		}
