...
namespace GenioMVC.Models
{
	public class Wareh : ModelBase
	{
		...
		[ShouldSerialize("Wareh.ValCodwareh")]
		...
		[ShouldSerialize("Wareh.ValWarehdes")]
		...
		[ShouldSerialize("Wareh.ValWarehcod")]
		...
		[ShouldSerialize("Wareh.ValActivity")]
		...
		[ShouldSerialize("Wareh.ValShowreco")]
		...
		{
			klass = new CSGenioAwareh(userContext.User);
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
				SetFieldsToSerialize(fieldsToSerialize);
		}

		public Wareh(UserContext userContext, CSGenioAwareh val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = val;
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
		...
		public static Wareh Find(string id, UserContext userCtx, string identifier = null, string[] fieldsToSerialize = null, string[] fieldsToQuery = null)
		{
			...
			return record == null ? null : new Wareh(userCtx, record, false, fieldsToSerialize) { Identifier = identifier };
		}

		public static List<Wareh> AllModel(UserContext userCtx, CriteriaSet args = null, string identifier = null)
		{
			return Where<CSGenioAwareh>(userCtx, false, args, numRegs: -1, identifier: identifier).RowsForViewModel<Wareh>((r) => new Wareh(userCtx, r));
		}
