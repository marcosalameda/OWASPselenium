...
{
	public class TRN_Menu_T02AGENT_ViewModel : MenuListViewModel<Models.Agent>
	{
		/// <summary>
		...
		public override string Uuid => "472be16b-6b14-4c30-a982-53f54ef89d9d";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T02AGENT]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT02AGENT");
		...
		public TRN_Menu_T02AGENT_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T02AGENT_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T02AGENT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref trn_menu_t02agentConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT02AGENT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T02AGENT]/
				...
				ListingMVC<CSGenioAagent> listing = Models.ModelBase.Where<CSGenioAagent>(m_userContext, distinct, trn_menu_t02agentConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT02AGENT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T02AGENT_RowViewModel> Elements = [];
			int i = 0;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T02AGENT]/
		...
		[
			"Agent", "Agent.ValCodagent", "Agent.ValZzstate", "Agent.ValBirthdat", "Agent.ValName", "Agent.ValPhoto", "Agent.ValEmail", "Agent.ValTelephon"
		];
