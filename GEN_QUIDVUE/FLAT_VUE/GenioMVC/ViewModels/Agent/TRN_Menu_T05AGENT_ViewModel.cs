...
{
	public class TRN_Menu_T05AGENT_ViewModel : MenuListViewModel<Models.Agent>
	{
		/// <summary>
		...
		public override string Uuid => "28159670-9318-4ea4-940a-52dc168610dd";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T05AGENT]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT05AGENT");
		...
		public TRN_Menu_T05AGENT_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T05AGENT_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T05AGENT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref trn_menu_t05agentConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT05AGENT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T05AGENT]/
				...
				ListingMVC<CSGenioAagent> listing = Models.ModelBase.Where<CSGenioAagent>(m_userContext, distinct, trn_menu_t05agentConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT05AGENT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T05AGENT_RowViewModel> Elements = [];
			int i = 0;
