...
{
	public class TRN_Menu_T14AGENT_ViewModel : MenuListViewModel<Models.Agent>
	{
		/// <summary>
		...
		public override string Uuid => "9f3951a1-a9c6-455f-a4dc-4259e5d3941f";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T14AGENT]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT14AGENT");
		...
		public TRN_Menu_T14AGENT_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T14AGENT_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T14AGENT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref trn_menu_t14agentConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT14AGENT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T14AGENT]/
		...
		{
			List<TRN_Menu_T14AGENT_RowViewModel> Elements = [];
			int i = 0;
