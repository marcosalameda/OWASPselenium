...
{
	public class TRN_Menu_T16AGENTBY_ViewModel : MenuListViewModel<Models.Agent>
	{
		/// <summary>
		...
		public override string Uuid => "58e9b1d8-dd6b-4d74-8e18-1d2b6de442c5";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T16AGENTBY]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT16AGENTBY");
			...
			ListingMVC<CSGenioAagent> listing = new(fields, null, 1, 1, false, user, true, string.Empty, true);
		...
		public TRN_Menu_T16AGENTBY_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T16AGENTBY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T16AGENTBY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref trn_menu_t16agentbyConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT16AGENTBY", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T16AGENTBY]/
				...
				ListingMVC<CSGenioAagent> listing = Models.ModelBase.Where<CSGenioAagent>(m_userContext, distinct, trn_menu_t16agentbyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT16AGENTBY", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T16AGENTBY_RowViewModel> Elements = [];
			int i = 0;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T16AGENTBY]/
		...
		[
			"Agent", "Agent.ValCodagent", "Agent.ValZzstate", "Agent.ValName", "Agent.ValBirthdat", "Agent.ValEmail", "Agent.ValPhoto", "Agent.ValTelephon"
		];
