...
public class Agreg_YearValYear_RowViewModel : Models.Year
{
	#region Constructors

	public Agreg_YearValYear_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Agreg_YearValYear_RowViewModel(UserContext userContext, CSGenioAyear val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
