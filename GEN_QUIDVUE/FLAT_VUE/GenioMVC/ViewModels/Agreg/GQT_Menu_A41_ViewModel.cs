...
FieldRef[] fields = new FieldRef[] { CSGenioAagreg.FldCodaggre, CSGenioAagreg.FldZzstate, CSGenioAagreg.FldCodyear, CSGenioAyear.FldCodyear, CSGenioAyear.FldYear, CSGenioAagreg.FldValue };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "GQT_Menu_A41", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAagreg.FldCodaggre, CSGenioAagreg.FldZzstate, CSGenioAagreg.FldCodyear, CSGenioAyear.FldCodyear, CSGenioAyear.FldYear, CSGenioAagreg.FldValue };
			...
			gqt_menu_a41Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST A41]/
				...
				ListingMVC<CSGenioAagreg> listing = Models.ModelBase.Where<CSGenioAagreg>(m_userContext, false, gqt_menu_a41Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLA41", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
