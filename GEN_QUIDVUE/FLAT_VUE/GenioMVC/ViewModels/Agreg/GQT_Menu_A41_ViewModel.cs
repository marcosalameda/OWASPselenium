...
// USE /[MANUAL GQT OVERRQ A41]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagreg>(m_userContext, false, ref gqt_menu_a41Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLA41", true, firstVisibleColumn: firstVisibleColumn);
