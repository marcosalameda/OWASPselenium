...
{
	public class GQT_Menu_A41_ViewModel : MenuListViewModel<Models.Agreg>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<GQT_Menu_A41_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "469f180d-8af8-44e6-b8c8-94ac1147a812";
...
// USE /[MANUAL GQT LIST_LIMITS A41]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLA41");
			...
			ListingMVC<CSGenioAagreg> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public GQT_Menu_A41_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="GQT_Menu_A41_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public GQT_Menu_A41_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public GQT_Menu_A41_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_A41_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAagreg> Qlisting, ref CriteriaSet conditions)
		{
			...
			}, "ms", "Time to load the menu."))
			{
				...
				CriteriaSet gqt_menu_a41Conds = CriteriaSet.And();
				...
				conditions.SubSets.Add(gqt_menu_a41Conds);
				gqt_menu_a41Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ A41]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAagreg>(m_userContext, false, gqt_menu_a41Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLA41", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST A41]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAagreg.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_a41Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
		...
		private List<GQT_Menu_A41_RowViewModel> MapGQT_Menu_A41(ListingMVC<CSGenioAagreg> Qlisting)
		{
			List<GQT_Menu_A41_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a GQT_Menu_A41_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_A41_RowViewModel MapGQT_Menu_A41(CSGenioAagreg row)
		{
			var model = new GQT_Menu_A41_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
