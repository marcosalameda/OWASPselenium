...
namespace GenioMVC.ViewModels.Asset
{
	public class Equip02_ValAttachme_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValAttachme", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAattac.FldCodattac, CSGenioAattac.FldZzstate, CSGenioAattac.FldAttached, CSGenioAattac.FldNote, CSGenioAattac.FldDocument, CSGenioAattac.FldDocumentfk };
			...
			equip02_pseudattachmeConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ EQUIP02_PSEUDATTACHME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAattac>(m_userContext, false, equip02_pseudattachmeConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP02_PSEUDATTACHME", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST EQUIP02_PSEUDATTACHME]/
				...
				ListingMVC<CSGenioAattac> listing = Models.ModelBase.Where<CSGenioAattac>(m_userContext, false, equip02_pseudattachmeConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP02_PSEUDATTACHME", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Attac(m_userContext, true, _fieldsToSerialize);
