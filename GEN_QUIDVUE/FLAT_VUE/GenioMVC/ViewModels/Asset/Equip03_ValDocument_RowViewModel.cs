...
public class Equip03_ValDocument_RowViewModel : Models.Assma
{
	#region Constructors

	public Equip03_ValDocument_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Equip03_ValDocument_RowViewModel(UserContext userContext, CSGenioAassma val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
