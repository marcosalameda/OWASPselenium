...
// USE /[MANUAL GQT OVERRQ EQUIP03_PSEUDDOCUMENT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAassma>(m_userContext, false, ref equip03_pseuddocumentConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP03_PSEUDDOCUMENT", true, firstVisibleColumn: firstVisibleColumn);
