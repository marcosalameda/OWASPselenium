...
// USE /[MANUAL GQT OVERRQ EQUIP04_PSEUDPARAMETE]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAasspa>(m_userContext, false, ref equip04_pseudparameteConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP04_PSEUDPARAMETE", true, firstVisibleColumn: firstVisibleColumn);
