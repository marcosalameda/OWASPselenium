...
public class Equipm_KindeValDesignat_RowViewModel : Models.Kinde
{
	#region Constructors

	public Equipm_KindeValDesignat_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Equipm_KindeValDesignat_RowViewModel(UserContext userContext, CSGenioAkinde val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
