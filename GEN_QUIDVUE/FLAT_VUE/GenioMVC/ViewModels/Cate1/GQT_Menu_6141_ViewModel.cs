...
// USE /[MANUAL GQT OVERRQ 6141]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcate1>(m_userContext, false, gqt_menu_6141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6141", true, firstVisibleColumn: firstVisibleColumn);
