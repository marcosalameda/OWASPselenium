...
FieldRef[] fields = new FieldRef[] { CSGenioAcate1.FldCodcateg, CSGenioAcate1.FldZzstate, CSGenioAcate1.FldCategoria, CSGenioAcate1.FldAbbreviation };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "GQT_Menu_6141", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAcate1.FldCodcateg, CSGenioAcate1.FldZzstate, CSGenioAcate1.FldCategoria, CSGenioAcate1.FldAbbreviation };
			...
			gqt_menu_6141Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST 6141]/
				...
				ListingMVC<CSGenioAcate1> listing = Models.ModelBase.Where<CSGenioAcate1>(m_userContext, false, gqt_menu_6141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6141", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Cate1(m_userContext, true, _fieldsToSerialize);
