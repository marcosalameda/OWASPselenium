...
// USE /[MANUAL GQT VIEWMODEL_SAVE CATEG]/
		public override void Save()
		{
			...
			try { Model = Models.Categ.Find(Navigation.GetStrValue("categ"), m_userContext, "FCATEG"); }
			finally { if (Model == null) Model = new Models.Categ(m_userContext) { Identifier = "FCATEG" }; }
