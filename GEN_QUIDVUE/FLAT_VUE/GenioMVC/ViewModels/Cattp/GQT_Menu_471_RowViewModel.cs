...
public class GQT_Menu_471_RowViewModel : Models.Cattp
{
	#region Constructors

	public GQT_Menu_471_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_471_RowViewModel(UserContext userContext, CSGenioAcattp val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
