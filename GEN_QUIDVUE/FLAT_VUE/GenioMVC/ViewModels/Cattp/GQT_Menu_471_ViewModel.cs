...
FieldRef[] fields = new FieldRef[] { CSGenioAcattp.FldCodtpcat, CSGenioAcattp.FldZzstate, CSGenioAcattp.FldTpcatego };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "GQT_Menu_471", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAcattp.FldCodtpcat, CSGenioAcattp.FldZzstate, CSGenioAcattp.FldTpcatego };
			...
			gqt_menu_471Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST 471]/
				...
				ListingMVC<CSGenioAcattp> listing = Models.ModelBase.Where<CSGenioAcattp>(m_userContext, false, gqt_menu_471Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML471", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
