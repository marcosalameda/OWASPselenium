...
public class Cfaqs_ValExpfaqs_RowViewModel : Models.Faqs
{
	#region Constructors

	public Cfaqs_ValExpfaqs_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Cfaqs_ValExpfaqs_RowViewModel(UserContext userContext, CSGenioAfaqs val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
