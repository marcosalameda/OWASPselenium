...
namespace GenioMVC.ViewModels.Cfaqs
{
	public class Cfaqs_ValExpfaqs_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValExpfaqs", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAfaqs.FldCodfaqs, CSGenioAfaqs.FldZzstate, CSGenioAfaqs.FldQuestion, CSGenioAfaqs.FldAnswer };
			...
			cfaqs___pseudexpfaqs_Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST CFAQS_PSEUDEXPFAQS]/
				...
				ListingMVC<CSGenioAfaqs> listing = Models.ModelBase.Where<CSGenioAfaqs>(m_userContext, false, cfaqs___pseudexpfaqs_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CFAQS___PSEUDEXPFAQS_", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
