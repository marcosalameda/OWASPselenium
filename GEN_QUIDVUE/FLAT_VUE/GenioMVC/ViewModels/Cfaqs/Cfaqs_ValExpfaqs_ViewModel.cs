...
{
	public class Cfaqs_ValExpfaqs_ViewModel : MenuListViewModel<Models.Faqs>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Cfaqs_ValExpfaqs_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Cfaqs_ValExpfaqs";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS CFAQS_PSEUDEXPFAQS]/
		...
		public Cfaqs_ValExpfaqs_ViewModel() : base(null!) { }
		...
		public Cfaqs_ValExpfaqs_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Cfaqs_ValExpfaqs_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAfaqs> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet cfaqs___pseudexpfaqs_Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(cfaqs___pseudexpfaqs_Conds);
			cfaqs___pseudexpfaqs_Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ CFAQS_PSEUDEXPFAQS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAfaqs>(m_userContext, false, ref cfaqs___pseudexpfaqs_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CFAQS___PSEUDEXPFAQS_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST CFAQS_PSEUDEXPFAQS]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAfaqs.GetInformation(), QMVC_POS_RECORD, sorts, cfaqs___pseudexpfaqs_Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<Cfaqs_ValExpfaqs_RowViewModel> MapCfaqs_ValExpfaqs(ListingMVC<CSGenioAfaqs> Qlisting)
		{
			List<Cfaqs_ValExpfaqs_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Cfaqs_ValExpfaqs_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Cfaqs_ValExpfaqs_RowViewModel MapCfaqs_ValExpfaqs(CSGenioAfaqs row)
		{
			var model = new Cfaqs_ValExpfaqs_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
