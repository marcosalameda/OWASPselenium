...
namespace GenioMVC.ViewModels.Cfaqs
{
	public class Cfaqs_ViewModel : FormViewModel<Models.Cfaqs>
	{
		...
		public GenioMVC.ViewModels.ImageModel ValIcon { get; set; }
...
// USE /[MANUAL GQT VIEWMODEL_SAVE CFAQS]/
		public override void Save()
		{
			...
			try { Model = Models.Cfaqs.Find(Navigation.GetStrValue("cfaqs"), m_userContext, "FCFAQS"); }
			finally { if (Model == null) Model = new Models.Cfaqs(m_userContext) { Identifier = "FCFAQS" }; }
