...
{
	public class TRN_Menu_T03CITY_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "63aabfb4-2f04-4f1f-8c1e-e15afc38592b"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet trn_menu_t03cityConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT03CITY");
			trn_menu_t03cityConds.Equal(CSGenioAcity.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL TRN OVERRQ T03CITY]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(trn_menu_t03cityConds, listing);
...
// USE /[MANUAL TRN OVERRQLIST T03CITY]/
		...
		{
			var Elements = new List<TRN_Menu_T03CITY_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T03CITY_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
