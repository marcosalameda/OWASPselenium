...
{
	public class TRN_Menu_T12CITY_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "3d71f770-6835-4376-a917-e3c383dbf4f0"; }
...
// USE /[MANUAL TRN OVERRQLIST T12CITY]/
		...
		{
			var Elements = new List<TRN_Menu_T12CITY_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T12CITY_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
