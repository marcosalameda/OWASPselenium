...
{
	public class TRN_Menu_T12CITY_ViewModel : MenuListViewModel<Models.City>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<TRN_Menu_T12CITY_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "3d71f770-6835-4376-a917-e3c383dbf4f0";
...
// USE /[MANUAL TRN LIST_LIMITS T12CITY]/
		...
		public TRN_Menu_T12CITY_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="TRN_Menu_T12CITY_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public TRN_Menu_T12CITY_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public TRN_Menu_T12CITY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.City.AddEPH<CSGenioAcity>(ref u, crs, "MLT12CITY");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.City.AddEPH<CSGenioAcity>(ref u, null, "MLT12CITY"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcity> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet trn_menu_t12cityConds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "MLT12CITY");
			...
			conditions.SubSets.Add(trn_menu_t12cityConds);
			trn_menu_t12cityConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL TRN OVERRQ T12CITY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcity>(m_userContext, false, ref trn_menu_t12cityConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT12CITY", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL TRN OVERRQLSTEXP T12CITY]/
			...
			if (tableReload)
			{
// USE /[MANUAL TRN OVERRQLIST T12CITY]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcity.GetInformation(), QMVC_POS_RECORD, sorts, trn_menu_t12cityConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
				...
				Menu.Elements = MapTRN_Menu_T12CITY(listing);

				Menu.Identifier = "MLT12CITY";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "MLT12CITY";
		...
		private List<TRN_Menu_T12CITY_RowViewModel> MapTRN_Menu_T12CITY(ListingMVC<CSGenioAcity> Qlisting)
		{
			List<TRN_Menu_T12CITY_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapTRN_Menu_T12CITY(row));
					i++;
				}
			}
		...
		/// to a TRN_Menu_T12CITY_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private TRN_Menu_T12CITY_RowViewModel MapTRN_Menu_T12CITY(CSGenioAcity row)
		{
			var model = new TRN_Menu_T12CITY_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T12CITY]/
