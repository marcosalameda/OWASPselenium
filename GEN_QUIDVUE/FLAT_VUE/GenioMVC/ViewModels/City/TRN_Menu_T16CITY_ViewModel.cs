...
{
	public class TRN_Menu_T16CITY_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "23af91ec-8200-4225-be5b-b441a07318c9"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet trn_menu_t16cityConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT16CITY");
			trn_menu_t16cityConds.Equal(CSGenioAcity.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL TRN OVERRQ T16CITY]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(trn_menu_t16cityConds, listing);
...
// USE /[MANUAL TRN OVERRQLIST T16CITY]/
		...
		{
			var Elements = new List<TRN_Menu_T16CITY_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T16CITY_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
