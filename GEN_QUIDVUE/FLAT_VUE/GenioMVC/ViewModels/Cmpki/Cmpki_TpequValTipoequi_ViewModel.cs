...
{
	public class Cmpki_TpequValTipoequi_ViewModel : MenuListViewModel<Models.Tpequ>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Cmpki_TpequValTipoequi_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Cmpki_TpequValTipoequi";
...
// USE /[MANUAL GQT LIST_LIMITS CMPKI_TPEQUTIPOEQUI]/
		...
		public Cmpki_TpequValTipoequi_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Cmpki_TpequValTipoequi_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Cmpki_TpequValTipoequi_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Cmpki_TpequValTipoequi_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Cmpki_TpequValTipoequi_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtpequ> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(cmpki___tpequtipoequiConds);
			cmpki___tpequtipoequiConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ CMPKI_TPEQUTIPOEQUI]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtpequ>(m_userContext, false, ref cmpki___tpequtipoequiConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CMPKI___TPEQUTIPOEQUI", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST CMPKI_TPEQUTIPOEQUI]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAtpequ.GetInformation(), QMVC_POS_RECORD, sorts, cmpki___tpequtipoequiConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAtpequ> listing = Models.ModelBase.Where<CSGenioAtpequ>(m_userContext, distinct, cmpki___tpequtipoequiConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CMPKI___TPEQUTIPOEQUI", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Cmpki_TpequValTipoequi_RowViewModel> MapCmpki_TpequValTipoequi(ListingMVC<CSGenioAtpequ> Qlisting)
		{
			List<Cmpki_TpequValTipoequi_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Cmpki_TpequValTipoequi_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Cmpki_TpequValTipoequi_RowViewModel MapCmpki_TpequValTipoequi(CSGenioAtpequ row)
		{
			var model = new Cmpki_TpequValTipoequi_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
