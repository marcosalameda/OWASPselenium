...
// USE /[MANUAL GQT OVERRQLIST 2A11]/
		...
		{
			var Elements = new List<GQT_Menu_2A11_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_2A11_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_2A11]/
		...
		[
			"Cmpki", "Cmpki.ValCodcmpki", "Cmpki.ValZzstate", "Cmpki.ValOrder", "Tpequ", "Tpequ.ValTipoequi", "Tpeq1", "Tpeq1.ValTipoequi", "Cmpki.ValQuantida", "Cmpki.ValCodtpeq1", "Cmpki.ValCodtpequ", "BtnPermission"
		];
