...
namespace GenioMVC.ViewModels.Cmpki
{
	public class GQT_Menu_2B1_ViewModel : ListViewModel
	{
		...
		public TablePartial<GQT_Menu_2B1_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_2b1Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2B1");
			gqt_menu_2b1Conds.Equal(CSGenioAcmpki.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 2B1]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_2b1Conds, listing);
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_2B1_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcmpki> Qlisting, ref CriteriaSet conditions)
		{
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				gqt_menu_2b1Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST 2B1]/
					...
					ListingMVC<CSGenioAcmpki> listing = Models.ModelBase.Where<CSGenioAcmpki>(m_userContext, false, gqt_menu_2b1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2B1", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<GQT_Menu_2B1_RowViewModel> MapGQT_Menu_2B1(ListingMVC<CSGenioAcmpki> Qlisting)
		{
			var Elements = new List<GQT_Menu_2B1_RowViewModel>();
			int i = 0;
		...
		/// to a GQT_Menu_2B1_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_2B1_RowViewModel MapGQT_Menu_2B1(CSGenioAcmpki row)
		{
			var model = new GQT_Menu_2B1_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_2B1_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_2B1]/
		...
		[
			"Cmpki", "Cmpki.ValCodcmpki", "Cmpki.ValZzstate", "Tpequ", "Tpequ.ValTipoequi", "Cmpki.ValOrder", "Tpeq1", "Tpeq1.ValTipoequi", "Cmpki.ValQuantida", "Cmpki.ValCodtpeq1", "Cmpki.ValCodtpequ", "BtnPermission"
		];
