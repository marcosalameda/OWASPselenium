...
{
	public class Empre_CntryValCountry_ViewModel : MenuListViewModel<Models.Cntry>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Empre_CntryValCountry";
...
// USE /[MANUAL GQT LIST_LIMITS EMPRE_CNTRYCOUNTRY]/
		...
		public Empre_CntryValCountry_ViewModel() : base(null!) { }
		...
		public Empre_CntryValCountry_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST EMPRE_CNTRYCOUNTRY]/
		...
		{
			List<Empre_CntryValCountry_RowViewModel> Elements = [];
			int i = 0;
