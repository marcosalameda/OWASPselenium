...
namespace GenioMVC.ViewModels.Cmpny
{
	public class TBS_Menu_111_ViewModel : ListViewModel
	{
		...
		public TablePartial<TBS_Menu_111_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet tbs_menu_111Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML111");
			tbs_menu_111Conds.Equal(CSGenioAcmpny.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL TBS OVERRQ 111]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(tbs_menu_111Conds, listing);
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<TBS_Menu_111_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcmpny> Qlisting, ref CriteriaSet conditions)
		{
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				tbs_menu_111Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL TBS OVERRQLIST 111]/
		...
		private List<TBS_Menu_111_RowViewModel> MapTBS_Menu_111(ListingMVC<CSGenioAcmpny> Qlisting)
		{
			var Elements = new List<TBS_Menu_111_RowViewModel>();
			int i = 0;
		...
		/// to a TBS_Menu_111_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private TBS_Menu_111_RowViewModel MapTBS_Menu_111(CSGenioAcmpny row)
		{
			var model = new TBS_Menu_111_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(TBS_Menu_111_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TBS_MENU_111]/
		...
		[
			"Cmpny", "Cmpny.ValCodempre", "Cmpny.ValZzstate", "Cmpny.ValDesignat", "Cmpny.ValAcronym", "Cmpny.ValNif", "Cmpny.ValTelephon", "Cmpny.ValEmail", "Cmpny.ValLogo", "Cmpny.ValCodcntry", "BtnPermission"
		];
