...
// USE /[MANUAL GQT OVERRQLIST WID_COLA_PSEUDPESSLIST]/
		...
		{
			var Elements = new List<Wid_cola_ValPesslist_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Wid_cola_ValPesslist_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WID_COLA_VALPESSLIST]/
		...
		[
			"Pesso", "Pesso.ValCodpesso", "Pesso.ValZzstate", "Pesso.ValName", "Pesso.ValPhotogra", "Pesso.ValEmail", "Categ", "Categ.ValCategoria", "Pesso.ValCodcateg", "Pesso.ValCodempre", "Pesso.ValCodpaise", "Pesso.ValCodcntry", "Pesso.ValCodregia", "BtnPermission"
		];
