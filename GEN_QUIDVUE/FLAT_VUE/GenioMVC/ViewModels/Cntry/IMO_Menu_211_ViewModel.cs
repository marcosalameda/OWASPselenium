...
{
	public class IMO_Menu_211_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "a1f95b79-43d9-4afa-90b0-1c6f2d9334b1"; }
		...
		{
			dbeditTitle = Resources.Resources.COUNTRIES64527;
		}
...
FieldRef[] fields = new FieldRef[] { CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldZzstate, CSGenioAcntry.FldCountry, CSGenioAcntry.FldActive, CSGenioAcntry.FldCodigonr, CSGenioAcntry.FldAlfa2, CSGenioAcntry.FldAlfa3, CSGenioAcntry.FldFlag };
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="IMO_Menu_211_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public IMO_Menu_211_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["IMO_Menu_211_tableFilters"] ?? "false"), true);
			...
			LoadUserTableConfig(requestValues, allSortOrders, "IMO_Menu_211", ref numberListItems);

			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "IMO_Menu_211_"));
			...
			CriteriaSet subfilters = CriteriaSet.And();
			{
				...
				if (requestValues["filter_IMO_Menu_211_ACTIVO"] != null)
					filter_IMO_Menu_211_ACTIVO_1 = requestValues["filter_IMO_Menu_211_ACTIVO"].Contains("1");
				else if (requestValues["filter_IMO_Menu_211_ACTIVO"] == null)
					filter_IMO_Menu_211_ACTIVO_1 = true;
				Navigation.SetValue("filter_IMO_Menu_211_ACTIVO_1", filter_IMO_Menu_211_ACTIVO_1);
				...
				if (requestValues["filter_IMO_Menu_211_ACTIVO"] != null)
					filter_IMO_Menu_211_ACTIVO_2 = requestValues["filter_IMO_Menu_211_ACTIVO"].Contains("2");
				Navigation.SetValue("filter_IMO_Menu_211_ACTIVO_2", filter_IMO_Menu_211_ACTIVO_2);
				...
				if (requestValues["filter_IMO_Menu_211_ACTIVO"] != null)
					filter_IMO_Menu_211_ACTIVO_3 = requestValues["filter_IMO_Menu_211_ACTIVO"].Contains("3");
				Navigation.SetValue("filter_IMO_Menu_211_ACTIVO_3", filter_IMO_Menu_211_ACTIVO_3);
			...
			{
				// EPH
				crs = Models.Cntry.AddEPH<CSGenioAcntry>(ref u, crs, "ML211");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Cntry.AddEPH<CSGenioAcntry>(ref u, null, "ML211"));
			}
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcntry> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "IMO_Menu_211", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "IMO_Menu_211"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "IMO_Menu_211");

			User u = m_userContext.User;
			Menu = new TablePartial<GenioMVC.Models.Cntry>();

			CriteriaSet imo_menu_211Conds = CriteriaSet.And();
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pIMO_Menu_211"])) ? int.Parse(requestValues["pIMO_Menu_211"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sIMO_Menu_211", "dIMO_Menu_211", requestValues, "cntry", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldZzstate, CSGenioAcntry.FldCountry, CSGenioAcntry.FldActive, CSGenioAcntry.FldCodigonr, CSGenioAcntry.FldAlfa2, CSGenioAcntry.FldAlfa3, CSGenioAcntry.FldFlag };
			...
			conditions.SubSets.Add(imo_menu_211Conds);
			imo_menu_211Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL IMO OVERRQ 211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAcntry>(m_userContext, false, imo_menu_211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL IMO OVERRQLSTEXP 211]/
...
// USE /[MANUAL IMO OVERRQLIST 211]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcntry.GetInformation(), QMVC_POS_RECORD, sorts, imo_menu_211Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAcntry> listing = Models.ModelBase.Where<CSGenioAcntry>(m_userContext, false, imo_menu_211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				Menu.Elements = MapIMO_Menu_211(listing);
		...
		private List<Models.Cntry> MapIMO_Menu_211(ListingMVC<CSGenioAcntry> Qlisting)
		{
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapIMO_Menu_211(row));
					i++;
				}
			}
		...
		private Models.Cntry MapIMO_Menu_211(CSGenioAcntry row)
		{
			var model = new Models.Cntry(m_userContext, true, _fieldsToSerialize);
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM IMO_MENU_211]/
		#endregion
