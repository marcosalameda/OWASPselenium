...
// USE /[MANUAL GQT OVERRQLIST PAIS_PSEUDPROPRIE1]/
		...
		{
			var Elements = new List<Pais_ValProprie1_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Pais_ValProprie1_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PAIS_VALPROPRIE1]/
		...
		[
			"Propr", "Propr.ValCodpropr", "Propr.ValZzstate", "Propr.ValName", "Propr.ValPrecoest", "Propr.ValCodcntry", "Propr.ValCodpais1", "Propr.ValCodpesso", "Propr.ValCodregia", "Propr.ValCodtppro", "BtnPermission"
		];
