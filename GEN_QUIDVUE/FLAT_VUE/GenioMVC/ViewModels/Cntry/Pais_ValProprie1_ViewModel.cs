...
{
	public class Pais_ValProprie1_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Pais_ValProprie1"; }
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValProprie1", ref numberListItems);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApropr> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Pais_ValProprie1", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Pais_ValProprie1"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Pais_ValProprie1");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pValProprie1"])) ? int.Parse(requestValues["pValProprie1"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sValProprie1", "dValProprie1", requestValues, "propr", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioApropr.FldCodpropr, CSGenioApropr.FldZzstate, CSGenioApropr.FldName, CSGenioApropr.FldPrecoest };
			...
			pais____pseudproprie1Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PAIS_PSEUDPROPRIE1]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioApropr>(m_userContext, false, pais____pseudproprie1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PAIS____PSEUDPROPRIE1", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PAIS_PSEUDPROPRIE1]/
				...
				ListingMVC<CSGenioApropr> listing = Models.ModelBase.Where<CSGenioApropr>(m_userContext, false, pais____pseudproprie1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PAIS____PSEUDPROPRIE1", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		private Models.Propr MapPais_ValProprie1(CSGenioApropr row)
		{
