...
namespace GenioMVC.ViewModels.Cntry
{
	public class Pais_ViewModel : FormViewModel<Models.Cntry>, IPreparableForSerialization
	{
		...
		public Pais_ViewModel(UserContext userContext, Models.Cntry row, bool nestedForm = false) : base(userContext, "FPAIS", row, nestedForm) { }
		...
		public Pais_ViewModel(UserContext userContext, string id, bool nestedForm = false, string[]? fieldsToLoad = null) : this(userContext, nestedForm)
		{
			...
			Model = Models.Cntry.Find(id, userContext, "FPAIS", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Cntry.Find(Navigation.GetStrValue("cntry"), m_userContext, "FPAIS");
			}
			finally
			{
				if (Model == null)
		...
		public override void LoadPartial(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			if (Model == null)
			{
				...
				if (Model == null)
				{
					Model = new Models.Cntry(m_userContext) { Identifier = "FPAIS" };
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY PAIS]/
		...
		{
			Model = Models.Cntry.Find(id, m_userContext, "FPAIS");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
