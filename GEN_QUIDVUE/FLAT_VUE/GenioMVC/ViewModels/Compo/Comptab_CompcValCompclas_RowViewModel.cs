...
public class Comptab_CompcValCompclas_RowViewModel : Models.Compc
{
	#region Constructors

	public Comptab_CompcValCompclas_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Comptab_CompcValCompclas_RowViewModel(UserContext userContext, CSGenioAcompc val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
