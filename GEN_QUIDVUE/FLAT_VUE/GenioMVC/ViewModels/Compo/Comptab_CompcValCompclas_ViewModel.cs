...
{
	public class Comptab_CompcValCompclas_ViewModel : MenuListViewModel<Models.Compc>
	{
		/// <summary>
		...
		{
// USE /[MANUAL GQT LIST_LIMITS COMPTAB_COMPCCOMPCLAS]/
		...
		public Comptab_CompcValCompclas_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Comptab_CompcValCompclas_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Comptab_CompcValCompclas_ViewModel(UserContext userContext) : base(userContext)
		{
			ValCodcompo = userContext.CurrentNavigation.CurrentLevel.GetEntry("compo")?.ToString();
		}
		...
		public Comptab_CompcValCompclas_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Compc.AddEPH<CSGenioAcompc>(ref u, crs, "IBL_COMPTAB_COMPCCOMPCLAS");
			...
			crs.Criterias.Add(new Criteria(new ColumnReference(CSGenioAcompc.FldZzstate), CriteriaOperator.Equal, 0));
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Compc.AddEPH<CSGenioAcompc>(ref u, null, "IBL_COMPTAB_COMPCCOMPCLAS"));
			}
...
// USE /[MANUAL GQT OVERRQLIST COMPTAB_COMPCCOMPCLAS]/
		...
		{
			List<Comptab_CompcValCompclas_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapComptab_CompcValCompclas(row));
					i++;
				}
			}
		...
		/// to a Comptab_CompcValCompclas_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Comptab_CompcValCompclas_RowViewModel MapComptab_CompcValCompclas(CSGenioAcompc row)
		{
			var model = new Comptab_CompcValCompclas_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM COMPTAB_COMPCVALCOMPCLAS]/

		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Compc", "Compc.ValCodcompc", "Compc.ValZzstate", "Compc.ValCompclas"
		];
