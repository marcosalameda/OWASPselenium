...
public class Comptab_ValBehavior_RowViewModel : Models.Compb
{
	#region Constructors

	public Comptab_ValBehavior_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Comptab_ValBehavior_RowViewModel(UserContext userContext, CSGenioAcompb val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
