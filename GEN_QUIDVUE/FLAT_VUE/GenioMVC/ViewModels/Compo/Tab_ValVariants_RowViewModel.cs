...
public class Tab_ValVariants_RowViewModel : Models.Compv
{
	#region Constructors

	public Tab_ValVariants_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Tab_ValVariants_RowViewModel(UserContext userContext, CSGenioAcompv val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
