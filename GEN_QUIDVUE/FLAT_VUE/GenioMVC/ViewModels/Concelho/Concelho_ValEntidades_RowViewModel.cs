...
public class Concelho_ValEntidades_RowViewModel : Models.Entidade
{
	#region Constructors

	public Concelho_ValEntidades_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Concelho_ValEntidades_RowViewModel(UserContext userContext, CSGenioAentidade val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
