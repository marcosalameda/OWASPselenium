...
public class PTN_Menu_3N11_RowViewModel : Models.Concelho
{
	#region Constructors

	public PTN_Menu_3N11_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_3N11_RowViewModel(UserContext userContext, CSGenioAconcelho val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
