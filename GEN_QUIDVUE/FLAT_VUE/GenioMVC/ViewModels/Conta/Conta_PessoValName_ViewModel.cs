...
{
	public class Conta_PessoValName_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Conta_PessoValName";
...
// USE /[MANUAL GQT LIST_LIMITS CONTA_PESSONAME]/
		...
		public Conta_PessoValName_ViewModel() : base(null!) { }
		...
		public Conta_PessoValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST CONTA_PESSONAME]/
		...
		{
			List<Conta_PessoValName_RowViewModel> Elements = [];
			int i = 0;
