...
// USE /[MANUAL GQT OVERRQLIST CONTA_TPCONTIPOCONT]/
		...
		{
			var Elements = new List<Conta_TpconValTipocont_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Conta_TpconValTipocont_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM CONTA_TPCONVALTIPOCONT]/
		...
		[
			"Tpcon", "Tpcon.ValCodtpcon", "Tpcon.ValZzstate", "Tpcon.ValTipocont", "Tpcon.ValCodgenre", "BtnPermission"
		];
