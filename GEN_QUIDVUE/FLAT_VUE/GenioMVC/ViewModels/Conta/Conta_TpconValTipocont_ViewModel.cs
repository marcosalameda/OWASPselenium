...
namespace GenioMVC.ViewModels.Conta
{
	public class Conta_TpconValTipocont_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Conta_TpconValTipocont", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAtpcon.FldCodtpcon, CSGenioAtpcon.FldZzstate, CSGenioAtpcon.FldTipocont };
			...
			conta___tpcontipocontConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ CONTA_TPCONTIPOCONT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAtpcon>(m_userContext, false, conta___tpcontipocontConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CONTA___TPCONTIPOCONT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST CONTA_TPCONTIPOCONT]/
				...
				ListingMVC<CSGenioAtpcon> listing = Models.ModelBase.Where<CSGenioAtpcon>(m_userContext, false, conta___tpcontipocontConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CONTA___TPCONTIPOCONT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Tpcon(m_userContext, true, _fieldsToSerialize);
