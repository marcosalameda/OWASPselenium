...
{
	public class TBS_Menu_141_ViewModel : MenuListViewModel<Models.Conta>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "c97df91f-65ee-4b77-9b9a-cec4db5ebdb9";
...
// USE /[MANUAL TBS LIST_LIMITS 141]/
		...
		public TBS_Menu_141_ViewModel() : base(null!) { }
		...
		public TBS_Menu_141_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TBS OVERRQLIST 141]/
		...
		{
			List<TBS_Menu_141_RowViewModel> Elements = [];
			int i = 0;
