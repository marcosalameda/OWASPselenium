...
// USE /[MANUAL TRN LIST_LIMITS T12COUNTRY]/
		...
		public TRN_Menu_T12COUNTRY_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Ctry.AddEPH<CSGenioActry>(ref u, crs, "MLT12COUNTRY");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Ctry.AddEPH<CSGenioActry>(ref u, null, "MLT12COUNTRY"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioActry> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(trn_menu_t12countryConds);
			trn_menu_t12countryConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL TRN OVERRQ T12COUNTRY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioActry>(m_userContext, false, ref trn_menu_t12countryConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT12COUNTRY", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL TRN OVERRQLSTEXP T12COUNTRY]/
			...
			if (tableReload)
			{
// USE /[MANUAL TRN OVERRQLIST T12COUNTRY]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioActry.GetInformation(), QMVC_POS_RECORD, sorts, trn_menu_t12countryConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
				...
				Menu.Elements = MapTRN_Menu_T12COUNTRY(listing);

				Menu.Identifier = "MLT12COUNTRY";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "MLT12COUNTRY";
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapTRN_Menu_T12COUNTRY(row));
					i++;
				}
			}
