...
public class TRN_Menu_T16COUNTRY_RowViewModel : Models.Ctry
{
	#region Constructors

	public TRN_Menu_T16COUNTRY_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public TRN_Menu_T16COUNTRY_RowViewModel(UserContext userContext, CSGenioActry val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
