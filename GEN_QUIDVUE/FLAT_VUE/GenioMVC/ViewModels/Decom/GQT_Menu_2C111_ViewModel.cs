...
FieldRef[] fields = new FieldRef[] { CSGenioAdecom.FldCoddeco, CSGenioAdecom.FldZzstate, CSGenioAdecom.FldDecomnr, CSGenioAdecom.FldDtdeco, CSGenioAdecom.FldNote };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "GQT_Menu_2C111", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAdecom.FldCoddeco, CSGenioAdecom.FldZzstate, CSGenioAdecom.FldDecomnr, CSGenioAdecom.FldDtdeco, CSGenioAdecom.FldNote };
			...
			gqt_menu_2c111Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST 2C111]/
				...
				ListingMVC<CSGenioAdecom> listing = Models.ModelBase.Where<CSGenioAdecom>(m_userContext, false, gqt_menu_2c111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2C111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
