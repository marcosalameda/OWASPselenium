...
public class GQT_Menu_2C31_RowViewModel : Models.Decom
{
	#region Constructors

	public GQT_Menu_2C31_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_2C31_RowViewModel(UserContext userContext, CSGenioAdecom val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
