...
{
	public class PTN_Menu_111_ViewModel : MenuListViewModel<Models.Decom>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<PTN_Menu_111_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "08896786-8e39-461e-b166-e259f92211f7";
...
// USE /[MANUAL PTN LIST_LIMITS 111]/
		...
		public PTN_Menu_111_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_111_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_111_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public PTN_Menu_111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAdecom> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet ptn_menu_111Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(ptn_menu_111Conds);
			ptn_menu_111Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ 111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAdecom>(m_userContext, false, ref ptn_menu_111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 111]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAdecom.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_111Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<PTN_Menu_111_RowViewModel> MapPTN_Menu_111(ListingMVC<CSGenioAdecom> Qlisting)
		{
			List<PTN_Menu_111_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a PTN_Menu_111_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_111_RowViewModel MapPTN_Menu_111(CSGenioAdecom row)
		{
			var model = new PTN_Menu_111_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
