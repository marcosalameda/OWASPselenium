...
public class Dilin_DispaValDispanr_RowViewModel : Models.Dispa
{
	#region Constructors

	public Dilin_DispaValDispanr_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Dilin_DispaValDispanr_RowViewModel(UserContext userContext, CSGenioAdispa val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
