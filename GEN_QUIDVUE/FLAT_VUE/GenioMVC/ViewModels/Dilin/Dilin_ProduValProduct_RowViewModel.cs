...
public class Dilin_ProduValProduct_RowViewModel : Models.Produ
{
	#region Constructors

	public Dilin_ProduValProduct_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Dilin_ProduValProduct_RowViewModel(UserContext userContext, CSGenioAprodu val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
