...
// USE /[MANUAL GQT VIEWMODEL_NEW DILIN]/
		...
		public override CrudViewModelValidationResult Validate()
		{
			...
			validator.Required("ValCodprodu", Resources.Resources.PRODUCT12880, ValCodprodu);
...
// USE /[MANUAL GQT VIEWMODEL_SAVE DILIN]/
		public override void Save()
		{
			...
			try { Model = Models.Dilin.Find(Navigation.GetStrValue("dilin"), m_userContext, "FDILIN"); }
			finally { if (Model == null) Model = new Models.Dilin(m_userContext) { Identifier = "FDILIN" }; }
