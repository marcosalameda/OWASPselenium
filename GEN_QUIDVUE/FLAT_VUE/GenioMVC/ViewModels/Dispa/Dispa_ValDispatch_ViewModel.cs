...
namespace GenioMVC.ViewModels.Dispa
{
	public class Dispa_ValDispatch_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValDispatch", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAdilin.FldCoddilin, CSGenioAdilin.FldZzstate, CSGenioAdilin.FldLinenumb, CSGenioAdilin.FldCodprodu, CSGenioAprodu.FldCodprodu, CSGenioAprodu.FldSku, CSGenioAprodu.FldGtin, CSGenioAprodu.FldProduct, CSGenioAdilin.FldOrdered, CSGenioAdilin.FldDelivere, CSGenioAdilin.FldOutstand };
			...
			dispa___pseuddispatchConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST DISPA_PSEUDDISPATCH]/
				...
				ListingMVC<CSGenioAdilin> listing = Models.ModelBase.Where<CSGenioAdilin>(m_userContext, false, dispa___pseuddispatchConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DISPA___PSEUDDISPATCH", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
