...
// USE /[MANUAL GQT OVERRQ DISPA_PSEUDDISPATCH]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAdilin>(m_userContext, false, ref dispa___pseuddispatchConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DISPA___PSEUDDISPATCH", true, firstVisibleColumn: firstVisibleColumn);
