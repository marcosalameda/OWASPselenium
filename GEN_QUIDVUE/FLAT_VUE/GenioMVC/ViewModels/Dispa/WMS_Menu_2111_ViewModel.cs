...
{
	public class WMS_Menu_2111_ViewModel : ListViewModel
	{
		/// <summary>
...
FieldRef[] fields = new FieldRef[] { CSGenioAdispa.FldCoddispa, CSGenioAdispa.FldZzstate, CSGenioAdispa.FldDispadt, CSGenioAdispa.FldDispanr, CSGenioAdispa.FldCodentit, CSGenioAentit.FldCodentit, CSGenioAentit.FldName };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["WMS_Menu_2111_tableFilters"] ?? "false"), false);
			...
			LoadUserTableConfig(requestValues, allSortOrders, "WMS_Menu_2111", ref numberListItems);

			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "WMS_Menu_2111_"));
			...
			// Limitations
			// Limit "SC"
			crs.Equal(CSGenioAdispa.FldIsprepar, "0");
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAdispa> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "WMS_Menu_2111", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "WMS_Menu_2111"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "WMS_Menu_2111");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pWMS_Menu_2111"])) ? int.Parse(requestValues["pWMS_Menu_2111"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sWMS_Menu_2111", "dWMS_Menu_2111", requestValues, "dispa", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAdispa.FldCoddispa, CSGenioAdispa.FldZzstate, CSGenioAdispa.FldDispadt, CSGenioAdispa.FldDispanr, CSGenioAdispa.FldCodentit, CSGenioAentit.FldCodentit, CSGenioAentit.FldName };
			...
			//Limit type: "SC"			//Current Area = "DISPA"			//1st Area Limit: "DISPA"			//1st Area Field: "ISPREPAR"			//1st Area Value: "0"
			{
				Limit limit = new Limit();
			...
			wms_menu_2111Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQ 2111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAdispa>(m_userContext, false, wms_menu_2111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL WMS OVERRQLIST 2111]/
				...
				ListingMVC<CSGenioAdispa> listing = Models.ModelBase.Where<CSGenioAdispa>(m_userContext, false, wms_menu_2111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		private List<Models.Dispa> MapWMS_Menu_2111(ListingMVC<CSGenioAdispa> Qlisting)
		{
		...
		private Models.Dispa MapWMS_Menu_2111(CSGenioAdispa row)
		{
