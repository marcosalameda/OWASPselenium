...
{
	public class WMS_Menu_2111_ViewModel : MenuListViewModel<Models.Dispa>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<WMS_Menu_2111_RowViewModel> Menu { get; set; }
		...
		{
// USE /[MANUAL WMS LIST_LIMITS 2111]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2111");
		...
		public WMS_Menu_2111_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="WMS_Menu_2111_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public WMS_Menu_2111_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public WMS_Menu_2111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void LoadToExport(out ListingMVC<CSGenioAdispa> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<WMS_Menu_2111_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Dispa.AddEPH<CSGenioAdispa>(ref u, crs, "ML2111");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Dispa.AddEPH<CSGenioAdispa>(ref u, null, "ML2111"));
			}
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAdispa> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<WMS_Menu_2111_RowViewModel>();

			CriteriaSet wms_menu_2111Conds = CriteriaSet.And();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "dispa", allSortOrders);
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML2111");
			...
			conditions.SubSets.Add(wms_menu_2111Conds);
			wms_menu_2111Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL WMS OVERRQ 2111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAdispa>(m_userContext, false, ref wms_menu_2111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2111", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL WMS OVERRQLSTEXP 2111]/
			...
			if (tableReload)
			{
// USE /[MANUAL WMS OVERRQLIST 2111]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAdispa.GetInformation(), QMVC_POS_RECORD, sorts, wms_menu_2111Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAdispa> listing = Models.ModelBase.Where<CSGenioAdispa>(m_userContext, distinct, wms_menu_2111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapWMS_Menu_2111(listing);

				Menu.Identifier = "ML2111";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "ML2111";
		...
		private List<WMS_Menu_2111_RowViewModel> MapWMS_Menu_2111(ListingMVC<CSGenioAdispa> Qlisting)
		{
			List<WMS_Menu_2111_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapWMS_Menu_2111(row));
					i++;
				}
			}
		...
		/// to a WMS_Menu_2111_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private WMS_Menu_2111_RowViewModel MapWMS_Menu_2111(CSGenioAdispa row)
		{
			var model = new WMS_Menu_2111_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_2111]/
