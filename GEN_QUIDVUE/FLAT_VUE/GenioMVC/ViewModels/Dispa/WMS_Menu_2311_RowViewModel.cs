...
public class WMS_Menu_2311_RowViewModel : Models.Dispa
{
	#region Constructors

	public WMS_Menu_2311_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public WMS_Menu_2311_RowViewModel(UserContext userContext, CSGenioAdispa val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
