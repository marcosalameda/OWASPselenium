...
{
	public class WMS_Menu_2311_ViewModel : ListViewModel
	{
		/// <summary>
...
// USE /[MANUAL WMS OVERRQLIST 2311]/
		...
		{
			var Elements = new List<WMS_Menu_2311_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_2311_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
