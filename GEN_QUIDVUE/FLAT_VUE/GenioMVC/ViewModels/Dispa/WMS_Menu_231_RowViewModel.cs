...
public class WMS_Menu_231_RowViewModel : Models.Dispa
{
	#region Constructors

	public WMS_Menu_231_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public WMS_Menu_231_RowViewModel(UserContext userContext, CSGenioAdispa val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
