...
{
	public class WMS_Menu_241_ViewModel : ListViewModel
	{
		/// <summary>
...
// USE /[MANUAL WMS OVERRQLIST 241]/
		...
		{
			var Elements = new List<WMS_Menu_241_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_241_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
