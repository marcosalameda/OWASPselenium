...
public class WMS_Menu_251_RowViewModel : Models.Disst
{
	#region Constructors

	public WMS_Menu_251_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public WMS_Menu_251_RowViewModel(UserContext userContext, CSGenioAdisst val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
