...
{
	public class WMS_Menu_251_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "8396af2d-3423-474d-82bf-a8886b01cd72"; }
...
// USE /[MANUAL WMS LIST_LIMITS 251]/
		...
		public override int GetCount(User user)
		{
			...
			ListingMVC<CSGenioAdisst> listing = new ListingMVC<CSGenioAdisst>(fields, null, 1, 1, false, user, true, string.Empty, false);
...
// USE /[MANUAL WMS OVERRQLIST 251]/
		...
		{
			var Elements = new List<WMS_Menu_251_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_251_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_251]/
		...
		[
			"Disst", "Disst.ValCoddisst", "Disst.ValZzstate", "Disst.ValStatus", "Disst.ValOrder", "Disst.ValDescript", "BtnPermission"
		];
