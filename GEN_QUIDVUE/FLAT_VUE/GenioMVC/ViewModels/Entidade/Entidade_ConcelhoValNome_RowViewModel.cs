...
public class Entidade_ConcelhoValNome_RowViewModel : Models.Concelho
{
	#region Constructors

	public Entidade_ConcelhoValNome_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Entidade_ConcelhoValNome_RowViewModel(UserContext userContext, CSGenioAconcelho val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
