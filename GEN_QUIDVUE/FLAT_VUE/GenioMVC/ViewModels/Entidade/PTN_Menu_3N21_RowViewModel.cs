...
public class PTN_Menu_3N21_RowViewModel : Models.Entidade
{
	#region Constructors

	public PTN_Menu_3N21_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_3N21_RowViewModel(UserContext userContext, CSGenioAentidade val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
