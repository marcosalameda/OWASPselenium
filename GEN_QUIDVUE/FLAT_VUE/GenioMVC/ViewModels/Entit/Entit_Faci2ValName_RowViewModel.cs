...
public class Entit_Faci2ValName_RowViewModel : Models.Faci2
{
	#region Constructors

	public Entit_Faci2ValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Entit_Faci2ValName_RowViewModel(UserContext userContext, CSGenioAfaci2 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
