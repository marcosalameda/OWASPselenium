...
// USE /[MANUAL GQT VIEWMODEL_SAVE ENTIT]/
		public override void Save()
		{
			...
			try { Model = Models.Entit.Find(Navigation.GetStrValue("entit"), m_userContext, "FENTIT"); }
			finally { if (Model == null) Model = new Models.Entit(m_userContext) { Identifier = "FENTIT" }; }
