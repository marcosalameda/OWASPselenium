...
// USE /[MANUAL GQT OVERRQ ENTIX_PSEUDFACILITE]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAfacil>(m_userContext, false, ref entix___pseudfaciliteConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ENTIX___PSEUDFACILITE", true, firstVisibleColumn: firstVisibleColumn);
