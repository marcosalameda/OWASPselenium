...
// USE /[MANUAL WMS LIST_LIMITS 511]/
		...
		public override List<Exports.QColumn> GetColumnsToExport()
		{
			...
			[
				...
				new Exports.QColumn(CSGenioAentit.FldWebsite, FieldType.TEXT, Resources.Resources.WEB_SITE06263, 30, 0, true),
				new Exports.QColumn(CSGenioAentit.FldPerson, FieldType.TEXT, Resources.Resources.PERSON_DEPARTMENT_TO28777, 30, 0, true),
...
// USE /[MANUAL WMS OVERRQ 511]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAentit>(m_userContext, false, ref wms_menu_511Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL WMS OVERRQLIST 511]/
				...
				ListingMVC<CSGenioAentit> listing = Models.ModelBase.Where<CSGenioAentit>(m_userContext, distinct, wms_menu_511Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
