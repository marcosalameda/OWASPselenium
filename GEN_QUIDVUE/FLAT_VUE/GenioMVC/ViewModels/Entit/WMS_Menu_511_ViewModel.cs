...
{
	public class WMS_Menu_511_ViewModel : MenuListViewModel<Models.Entit>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "07a4ae81-9ea2-4709-901d-950c72bb072b";
		...
		{
// USE /[MANUAL WMS LIST_LIMITS 511]/
		...
		public WMS_Menu_511_ViewModel() : base(null!) { }
		...
		public WMS_Menu_511_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL WMS OVERRQLIST 511]/
		...
		{
			List<WMS_Menu_511_RowViewModel> Elements = [];
			int i = 0;
