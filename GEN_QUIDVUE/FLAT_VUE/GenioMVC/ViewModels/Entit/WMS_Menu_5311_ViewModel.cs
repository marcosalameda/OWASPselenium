...
{
	public class WMS_Menu_5311_ViewModel : MenuListViewModel<Models.Entit>
	{
		/// <summary>
		...
		public override string Uuid => "67fb6ab2-0a8d-4d73-b3db-8b368c5a92e8";
		...
		{
// USE /[MANUAL WMS LIST_LIMITS 5311]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML5311");
		...
		public WMS_Menu_5311_ViewModel() : base(null!) { }
		...
		public WMS_Menu_5311_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL WMS OVERRQ 5311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAentit>(m_userContext, false, ref wms_menu_5311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5311", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL WMS OVERRQLIST 5311]/
				...
				ListingMVC<CSGenioAentit> listing = Models.ModelBase.Where<CSGenioAentit>(m_userContext, distinct, wms_menu_5311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<WMS_Menu_5311_RowViewModel> Elements = [];
			int i = 0;
