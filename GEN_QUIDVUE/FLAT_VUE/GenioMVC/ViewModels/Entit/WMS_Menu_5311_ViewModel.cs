...
{
	public class WMS_Menu_5311_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<WMS_Menu_5311_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_5311Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML5311");
			wms_menu_5311Conds.Equal(CSGenioAentit.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						wms_menu_5311Conds.Equal(CSGenioAentit.FldCarrier, 1);


// USE /[MANUAL WMS OVERRQ 5311]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_5311Conds, listing);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="WMS_Menu_5311_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public WMS_Menu_5311_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<WMS_Menu_5311_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Entit.AddEPH<CSGenioAentit>(ref u, crs, "ML5311");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Entit.AddEPH<CSGenioAentit>(ref u, null, "ML5311"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAentit> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet wms_menu_5311Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML5311");
			...
			//1st Area Value: "1"
			{
				...
				conditions.SubSets.Add(wms_menu_5311Conds);
				wms_menu_5311Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQ 5311]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAentit>(m_userContext, false, wms_menu_5311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5311", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL WMS OVERRQLSTEXP 5311]/
				...
				if (tableReload)
				{
// USE /[MANUAL WMS OVERRQLIST 5311]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAentit.GetInformation(), QMVC_POS_RECORD, sorts, wms_menu_5311Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAentit> listing = Models.ModelBase.Where<CSGenioAentit>(m_userContext, false, wms_menu_5311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapWMS_Menu_5311(listing);

					Menu.Identifier = "ML5311";
					Menu.Slots = new Dictionary<string, List<object>>();

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "ML5311";
		...
		private List<WMS_Menu_5311_RowViewModel> MapWMS_Menu_5311(ListingMVC<CSGenioAentit> Qlisting)
		{
			var Elements = new List<WMS_Menu_5311_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapWMS_Menu_5311(row));
					i++;
				}
			}
		...
		/// to a WMS_Menu_5311_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private WMS_Menu_5311_RowViewModel MapWMS_Menu_5311(CSGenioAentit row)
		{
			var model = new WMS_Menu_5311_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_5311_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_5311]/
		#endregion
