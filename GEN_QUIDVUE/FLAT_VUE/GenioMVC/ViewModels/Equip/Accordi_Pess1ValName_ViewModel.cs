...
// USE /[MANUAL GQT OVERRQ ACCORDI_PESS1NAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApess1>(m_userContext, false, ref accordi_pess1name____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ACCORDI_PESS1NAME____", true, firstVisibleColumn: firstVisibleColumn);
