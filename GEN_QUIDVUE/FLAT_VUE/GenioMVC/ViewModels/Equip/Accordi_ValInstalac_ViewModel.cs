...
{
	public class Accordi_ValInstalac_ViewModel : MenuListViewModel<Models.Insta>
	{
		/// <summary>
		...
		public override string Uuid => "Accordi_ValInstalac";
...
// USE /[MANUAL GQT LIST_LIMITS ACCORDI_PSEUDINSTALAC]/
		...
		public Accordi_ValInstalac_ViewModel() : base(null!) { }
		...
		public Accordi_ValInstalac_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ ACCORDI_PSEUDINSTALAC]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAinsta>(m_userContext, false, ref accordi_pseudinstalacConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ACCORDI_PSEUDINSTALAC", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ACCORDI_PSEUDINSTALAC]/
		...
		{
			List<Accordi_ValInstalac_RowViewModel> Elements = [];
			int i = 0;
