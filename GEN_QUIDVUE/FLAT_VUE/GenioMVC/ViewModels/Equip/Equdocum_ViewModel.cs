...
// USE /[MANUAL GQT VIEWMODEL_SAVE EQUDOCUM]/
		public override void Save()
		{
			...
			try { Model = Models.Equip.Find(Navigation.GetStrValue("equip"), m_userContext, "FEQUDOCUM"); }
			finally { if (Model == null) Model = new Models.Equip(m_userContext) { Identifier = "FEQUDOCUM" }; }
