...
public class Equip_DecomValDecomnr_RowViewModel : Models.Decom
{
	#region Constructors

	public Equip_DecomValDecomnr_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Equip_DecomValDecomnr_RowViewModel(UserContext userContext, CSGenioAdecom val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
