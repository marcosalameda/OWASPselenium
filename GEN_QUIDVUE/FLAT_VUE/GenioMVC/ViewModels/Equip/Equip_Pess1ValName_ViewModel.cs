...
// USE /[MANUAL GQT LIST_LIMITS EQUIP_PESS1NAME]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (!tableConfig.GroupFilters.ContainsKey("filter_Equip_Pess1ValName_FILTER1"))
			{
				string defaultValue = "";
				tableConfig.Filters.Add(new GroupFilter { Key = "filter_Equip_Pess1ValName_FILTER1", Value = defaultValue });
			}

			{
				...
				if (tableConfig.GroupFilters.ContainsKey("filter_Equip_Pess1ValName_FILTER1"))
					filter_Equip_Pess1ValName_FILTER1_1 = tableConfig.GroupFilters["filter_Equip_Pess1ValName_FILTER1"].Contains("1");
			...
			if (!tableConfig.GroupFilters.ContainsKey("filter_Equip_Pess1ValName_FILTER2"))
			{
				string defaultValue = "";
				tableConfig.Filters.Add(new GroupFilter { Key = "filter_Equip_Pess1ValName_FILTER2", Value = defaultValue });
			}

			{
				...
				if (tableConfig.GroupFilters.ContainsKey("filter_Equip_Pess1ValName_FILTER2"))
					filter_Equip_Pess1ValName_FILTER2_1 = tableConfig.GroupFilters["filter_Equip_Pess1ValName_FILTER2"].Contains("1");
...
// USE /[MANUAL GQT OVERRQ EQUIP_PESS1NAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApess1>(m_userContext, false, ref equip___pess1name____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PESS1NAME____", true, firstVisibleColumn: firstVisibleColumn);
