...
namespace GenioMVC.ViewModels.Equip
{
	public class Equip_Pess1ValName_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Equip_Pess1ValName", ref numberListItems);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApess1> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Equip_Pess1ValName", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Equip_Pess1ValName"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Equip_Pess1ValName");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pEquip_Pess1ValName"])) ? int.Parse(requestValues["pEquip_Pess1ValName"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sEquip_Pess1ValName", "dEquip_Pess1ValName", requestValues, "pess1", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioApess1.FldCodpesso, CSGenioApess1.FldZzstate, CSGenioApess1.FldName };
			...
			equip___pess1name____Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PESS1NAME]/
				...
				ListingMVC<CSGenioApess1> listing = Models.ModelBase.Where<CSGenioApess1>(m_userContext, false, equip___pess1name____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PESS1NAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		private List<Models.Pess1> MapEquip_Pess1ValName(ListingMVC<CSGenioApess1> Qlisting)
		{
		...
		private Models.Pess1 MapEquip_Pess1ValName(CSGenioApess1 row)
		{
