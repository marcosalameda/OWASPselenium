...
// USE /[MANUAL GQT OVERRQ EQUIP_PSEUDFOTOEQUI]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAphoto>(m_userContext, false, ref equip___pseudfotoequiConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDFOTOEQUI", true, firstVisibleColumn: firstVisibleColumn);
