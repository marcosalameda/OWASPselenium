...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PSEUDFOTOEQUI]/
		...
		{
			var Elements = new List<Equip_ValFotoequi_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Equip_ValFotoequi_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM EQUIP_VALFOTOEQUI]/
		...
		[
			"Photo", "Photo.ValCodphoto", "Photo.ValZzstate", "Photo.ValTitle", "Photo.ValPhotogra", "Photo.ValCodequip", "BtnPermission"
		];
