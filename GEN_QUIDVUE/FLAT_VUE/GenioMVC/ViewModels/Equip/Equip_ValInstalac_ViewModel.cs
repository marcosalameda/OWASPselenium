...
{
	public class Equip_ValInstalac_ViewModel : MenuListViewModel<Models.Insta>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<Equip_ValInstalac_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "Equip_ValInstalac";
...
// USE /[MANUAL GQT LIST_LIMITS EQUIP_PSEUDINSTALAC]/
		...
		public Equip_ValInstalac_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Equip_ValInstalac_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Equip_ValInstalac_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Equip_ValInstalac_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Equip_ValInstalac_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAinsta> Qlisting, ref CriteriaSet conditions)
		{
			...
			}, "ms", "Time to load the form."))
			{
				...
				CriteriaSet equip___pseudinstalacConds = CriteriaSet.And();
				...
				conditions.SubSets.Add(equip___pseudinstalacConds);
				equip___pseudinstalacConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ EQUIP_PSEUDINSTALAC]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAinsta>(m_userContext, false, equip___pseudinstalacConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDINSTALAC", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PSEUDINSTALAC]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAinsta.GetInformation(), QMVC_POS_RECORD, sorts, equip___pseudinstalacConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAinsta> listing = Models.ModelBase.Where<CSGenioAinsta>(m_userContext, false, equip___pseudinstalacConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDINSTALAC", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Equip_ValInstalac_RowViewModel> MapEquip_ValInstalac(ListingMVC<CSGenioAinsta> Qlisting)
		{
			List<Equip_ValInstalac_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Equip_ValInstalac_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Equip_ValInstalac_RowViewModel MapEquip_ValInstalac(CSGenioAinsta row)
		{
			var model = new Equip_ValInstalac_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
