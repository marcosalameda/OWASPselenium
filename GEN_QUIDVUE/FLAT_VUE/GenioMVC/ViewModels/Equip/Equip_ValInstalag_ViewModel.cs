...
{
	public class Equip_ValInstalag_ViewModel : MenuListViewModel<Models.Insta>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Equip_ValInstalag";
...
// USE /[MANUAL GQT LIST_LIMITS EQUIP_PSEUDINSTALAG]/
		...
		public Equip_ValInstalag_ViewModel() : base(null!) { }
		...
		public Equip_ValInstalag_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PSEUDINSTALAG]/
		...
		{
			List<Equip_ValInstalag_RowViewModel> Elements = [];
			int i = 0;
