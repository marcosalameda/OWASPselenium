...
namespace GenioMVC.ViewModels.Equip
{
	public class Equip_ValInstalag_ViewModel : ListViewModel
	{
		...
		public TablePartial<Equip_ValInstalag_RowViewModel> Menu { get; set; }
		...
		{
// USE /[MANUAL GQT LIST_LIMITS EQUIP_PSEUDINSTALAG]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Equip_ValInstalag_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAinsta> Qlisting, ref CriteriaSet conditions)
		{
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				equip___pseudinstalagConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PSEUDINSTALAG]/
					...
					ListingMVC<CSGenioAinsta> listing = Models.ModelBase.Where<CSGenioAinsta>(m_userContext, false, equip___pseudinstalagConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDINSTALAG", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Equip_ValInstalag_RowViewModel> MapEquip_ValInstalag(ListingMVC<CSGenioAinsta> Qlisting)
		{
			var Elements = new List<Equip_ValInstalag_RowViewModel>();
			int i = 0;
		...
		/// to a Equip_ValInstalag_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Equip_ValInstalag_RowViewModel MapEquip_ValInstalag(CSGenioAinsta row)
		{
			var model = new Equip_ValInstalag_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(Equip_ValInstalag_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM EQUIP_VALINSTALAG]/
		...
		[
			"Insta", "Insta.ValCodinsta", "Insta.ValZzstate", "Insta.ValSince", "Insta.ValUntil", "Insta.ValHours", "Insta.ValPrecohor", "Insta.ValValue", "Insta.ValCodequip", "Insta.ValCodtpequ", "BtnPermission"
		];
