...
namespace GenioMVC.ViewModels.Equip
{
	public class Equip_ValMovimels_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValMovimels", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAmovim.FldCodmovim, CSGenioAmovim.FldZzstate, CSGenioAmovim.FldDhmudanc, CSGenioAmovim.FldCodrooms, CSGenioArooms.FldCodrooms, CSGenioArooms.FldRoomnr, CSGenioArooms.FldDesignat, CSGenioAmovim.FldObservat };
			...
			equip___pseudmovimelsConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PSEUDMOVIMELS]/
				...
				ListingMVC<CSGenioAmovim> listing = Models.ModelBase.Where<CSGenioAmovim>(m_userContext, false, equip___pseudmovimelsConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDMOVIMELS", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Movim(m_userContext, true, _fieldsToSerialize);
