...
public class Equip_ValReparaco_RowViewModel : Models.Repar
{
	#region Constructors

	public Equip_ValReparaco_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Equip_ValReparaco_RowViewModel(UserContext userContext, CSGenioArepar val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
