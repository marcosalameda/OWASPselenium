...
namespace GenioMVC.ViewModels.Equip
{
	public class Equip_ValTlequipa_ViewModel : ViewModelBase
	{
		...
		public Equip_ValTlequipa_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref List<Models.TimelineItem> Qlisting, ref CriteriaSet conditions)
		{
			...
			ListingMVC<CSGenioAvisit> listingVISITAS = Models.ModelBase.Where<CSGenioAvisit>(m_userContext, false, filterVISITAS, fieldsVISITAS, 0, totalrecords, sortsVISITAS, "IBL_EQUIP___PSEUDTLEQUIPA", true, false);
			...
			ListingMVC<CSGenioArepar> listingREPARACO = Models.ModelBase.Where<CSGenioArepar>(m_userContext, false, filterREPARACO, fieldsREPARACO, 0, totalrecords, sortsREPARACO, "IBL_EQUIP___PSEUDTLEQUIPA", true, false);
