...
// USE /[MANUAL GQT OVERRQLIST EQUIP_WAREHWAREHDES]/
					...
					ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, equip___warehwarehdesConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___WAREHWAREHDES", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Equip_WarehValWarehdes_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Equip_WarehValWarehdes_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM EQUIP_WAREHVALWAREHDES]/
		...
		[
			"Wareh", "Wareh.ValCodwareh", "Wareh.ValZzstate", "Wareh.ValWarehdes", "Wareh.ValWarehcod", "BtnPermission"
		];
