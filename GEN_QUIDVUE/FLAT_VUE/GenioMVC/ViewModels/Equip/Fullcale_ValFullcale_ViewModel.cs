...
namespace GenioMVC.ViewModels.Equip
{
	public class Fullcale_ValFullcale_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValFullcale", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAvisit.FldCodvisit, CSGenioAvisit.FldZzstate, CSGenioAvisit.FldTitle, CSGenioAvisit.FldStartdt, CSGenioAvisit.FldDtfim, CSGenioAvisit.FldDescript, CSGenioAvisit.FldTodoodia, CSGenioAvisit.FldColor, CSGenioAvisit.FldBack };
			...
			fullcalepseudfullcaleConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST FULLCALE_PSEUDFULLCALE]/
				...
				ListingMVC<CSGenioAvisit> listing = Models.ModelBase.Where<CSGenioAvisit>(m_userContext, false, fullcalepseudfullcaleConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_FULLCALEPSEUDFULLCALE", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Visit(m_userContext, true, _fieldsToSerialize);
