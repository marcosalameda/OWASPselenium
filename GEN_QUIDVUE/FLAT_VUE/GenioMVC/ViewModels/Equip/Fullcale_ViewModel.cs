...
// USE /[MANUAL GQT VIEWMODEL_SAVE FULLCALE]/
		public override void Save()
		{
			...
			try { Model = Models.Equip.Find(Navigation.GetStrValue("equip"), m_userContext, "FFULLCALE"); }
			finally { if (Model == null) Model = new Models.Equip(m_userContext) { Identifier = "FFULLCALE" }; }
