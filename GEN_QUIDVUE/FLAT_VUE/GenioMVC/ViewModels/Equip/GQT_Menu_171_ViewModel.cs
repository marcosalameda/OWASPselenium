...
{
	public class GQT_Menu_171_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "1090b7c9-cd38-40ef-a2d1-2d42d0f77d18"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_171Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML171");
			gqt_menu_171Conds.Equal(CSGenioAequip.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 171]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_171Conds, listing);
...
// USE /[MANUAL GQT OVERRQ 171]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, gqt_menu_171Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML171", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 171]/
					...
					ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, gqt_menu_171Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML171", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_171_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_171_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_171]/
		...
		[
			"Equip", "Equip.ValCodequip", "Equip.ValZzstate", "Equip.ValSequennr", "Equip.ValRegistnr", "Equip.ValDesignat", "Equip.ValDtaquisi", "Equip.ValDtdeco", "Cmpny", "Cmpny.ValDesignat", "Equip.ValCodempre", "Equip.ValCoddeco", "Equip.ValCoditem", "Equip.ValCodpess1", "Equip.ValCodrooms", "Equip.ValCodtpequ", "Equip.ValCodwareh", "BtnPermission"
		];
