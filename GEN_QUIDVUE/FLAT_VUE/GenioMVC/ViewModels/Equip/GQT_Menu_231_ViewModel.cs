...
{
	public class GQT_Menu_231_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<GQT_Menu_231_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid { get => "1ef47b5e-55ef-4a74-adc4-a282edf007b4"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_231Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML231");
			gqt_menu_231Conds.Equal(CSGenioAequip.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

			

// USE /[MANUAL GQT OVERRQ 231]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_231Conds, listing);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GQT_Menu_231_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public GQT_Menu_231_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_231_RowViewModel>();
			...
			if (!tableConfig.StaticFilters.ContainsKey("filter_GQT_Menu_231_ACTIVO"))
				tableConfig.StaticFilters.Add("filter_GQT_Menu_231_ACTIVO", null);

			{
				var groupFilters = CriteriaSet.Or();
				bool filter_GQT_Menu_231_ACTIVO_1 = false;
				if (tableConfig.StaticFilters["filter_GQT_Menu_231_ACTIVO"] != null)
					filter_GQT_Menu_231_ACTIVO_1 = tableConfig.StaticFilters["filter_GQT_Menu_231_ACTIVO"].Contains("1");
				else if (tableConfig.StaticFilters["filter_GQT_Menu_231_ACTIVO"] == null)
				...
				if (tableConfig.StaticFilters["filter_GQT_Menu_231_ACTIVO"] != null)
					filter_GQT_Menu_231_ACTIVO_2 = tableConfig.StaticFilters["filter_GQT_Menu_231_ACTIVO"].Contains("2");
			...
			{
				// EPH
				crs = Models.Equip.AddEPH<CSGenioAequip>(ref u, crs, "ML231");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Equip.AddEPH<CSGenioAequip>(ref u, null, "ML231"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAequip> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet gqt_menu_231Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				conditions.SubSets.Add(gqt_menu_231Conds);
				gqt_menu_231Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 231]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, gqt_menu_231Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML231", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP 231]/
...
// USE /[MANUAL GQT OVERRQLIST 231]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAequip.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_231Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, gqt_menu_231Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML231", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapGQT_Menu_231(listing);
		...
		private List<GQT_Menu_231_RowViewModel> MapGQT_Menu_231(ListingMVC<CSGenioAequip> Qlisting)
		{
			var Elements = new List<GQT_Menu_231_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapGQT_Menu_231(row));
					i++;
				}
			}
		...
		/// to a GQT_Menu_231_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_231_RowViewModel MapGQT_Menu_231(CSGenioAequip row)
		{
			var model = new GQT_Menu_231_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_231_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_231]/
		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Equip", "Equip.ValCodequip", "Equip.ValZzstate", "Equip.ValRegistnr", "Equip.ValDesignat", "Equip.ValPhotogra", "Room1", "Room1.ValRoomnr", "Tpequ", "Tpequ.ValTipoequi", "Wareh", "Wareh.ValWarehdes", "Item", "Item.ValItemdes", "Equip.ValCodempre", "Equip.ValCoddeco", "Equip.ValCoditem", "Equip.ValCodpess1", "Equip.ValCodrooms", "Equip.ValCodtpequ", "Equip.ValCodwareh", "BtnPermission"
		];
