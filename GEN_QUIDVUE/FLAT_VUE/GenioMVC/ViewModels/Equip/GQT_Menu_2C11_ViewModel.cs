...
{
	public class GQT_Menu_2C11_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<GQT_Menu_2C11_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "1ac74500-24cd-4979-9f76-49d2b8b45ea2";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS 2C11]/
		...
		public GQT_Menu_2C11_ViewModel() : base(null!) { }
		...
		public GQT_Menu_2C11_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<GQT_Menu_2C11_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAequip> Qlisting, ref CriteriaSet conditions)
		{
			...
			gqt_menu_2c11Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 2C11]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref gqt_menu_2c11Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2C11", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 2C11]/
				...
				ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, gqt_menu_2c11Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2C11", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<GQT_Menu_2C11_RowViewModel> MapGQT_Menu_2C11(ListingMVC<CSGenioAequip> Qlisting)
		{
			List<GQT_Menu_2C11_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a GQT_Menu_2C11_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_2C11_RowViewModel MapGQT_Menu_2C11(CSGenioAequip row)
		{
			var model = new GQT_Menu_2C11_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
