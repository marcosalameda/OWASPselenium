...
{
	public class GQT_Menu_2C311_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		...
		public override string Uuid => "a9fa1cd7-7fc1-464f-9b11-ea8abaa66953";
...
// USE /[MANUAL GQT LIST_LIMITS 2C311]/
		...
		public GQT_Menu_2C311_ViewModel() : base(null!) { }
		...
		public GQT_Menu_2C311_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ 2C311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref gqt_menu_2c311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2C311", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 2C311]/
				...
				ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, gqt_menu_2c311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2C311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_2C311_RowViewModel> Elements = [];
			int i = 0;
