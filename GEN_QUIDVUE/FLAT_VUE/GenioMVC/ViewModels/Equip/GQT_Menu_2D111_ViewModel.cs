...
{
	public class GQT_Menu_2D111_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<GQT_Menu_2D111_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "bab5f91b-0ea6-4734-93b1-4dd943ec66c5";
...
// USE /[MANUAL GQT LIST_LIMITS 2D111]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2D111");
		...
		public GQT_Menu_2D111_ViewModel() : base(null!) { }
		...
		public GQT_Menu_2D111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<GQT_Menu_2D111_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAequip> Qlisting, ref CriteriaSet conditions)
		{
			...
			gqt_menu_2d111Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 2D111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref gqt_menu_2d111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2D111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 2D111]/
				...
				ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, gqt_menu_2d111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2D111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<GQT_Menu_2D111_RowViewModel> MapGQT_Menu_2D111(ListingMVC<CSGenioAequip> Qlisting)
		{
			List<GQT_Menu_2D111_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a GQT_Menu_2D111_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_2D111_RowViewModel MapGQT_Menu_2D111(CSGenioAequip row)
		{
			var model = new GQT_Menu_2D111_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
