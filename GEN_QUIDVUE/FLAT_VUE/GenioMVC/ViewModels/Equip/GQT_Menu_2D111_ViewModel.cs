...
namespace GenioMVC.ViewModels.Equip
{
	public class GQT_Menu_2D111_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_2d111Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2D111");
			gqt_menu_2d111Conds.Equal(CSGenioAequip.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 2D111]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_2d111Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 2D111]/
					...
					ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, gqt_menu_2d111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2D111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_2D111_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_2D111_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
