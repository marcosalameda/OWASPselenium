...
{
	public class GQT_Menu_6211_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		...
		public override string Uuid => "1894ac04-c1ca-40a7-a507-5fc0f49867ed";
...
// USE /[MANUAL GQT LIST_LIMITS 6211]/
		...
		public GQT_Menu_6211_ViewModel() : base(null!) { }
		...
		public GQT_Menu_6211_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ 6211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref gqt_menu_6211Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6211", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 6211]/
				...
				ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, gqt_menu_6211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_6211_RowViewModel> Elements = [];
			int i = 0;
