...
public class Gmaps_ValInstalac_RowViewModel : Models.Insta
{
	#region Constructors

	public Gmaps_ValInstalac_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Gmaps_ValInstalac_RowViewModel(UserContext userContext, CSGenioAinsta val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
