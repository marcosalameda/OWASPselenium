...
{
	public class Gmaps_ValInstalac_ViewModel : MenuListViewModel<Models.Insta>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<Gmaps_ValInstalac_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "Gmaps_ValInstalac";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS GMAPS_PSEUDINSTALAC]/
		...
		public Gmaps_ValInstalac_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Gmaps_ValInstalac_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Gmaps_ValInstalac_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Gmaps_ValInstalac_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Gmaps_ValInstalac_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAinsta> Qlisting, ref CriteriaSet conditions)
		{
			...
			}, "ms", "Time to load the form."))
			{
				...
				CriteriaSet gmaps___pseudinstalacConds = CriteriaSet.And();
				...
				conditions.SubSets.Add(gmaps___pseudinstalacConds);
				gmaps___pseudinstalacConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ GMAPS_PSEUDINSTALAC]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAinsta>(m_userContext, false, gmaps___pseudinstalacConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_GMAPS___PSEUDINSTALAC", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST GMAPS_PSEUDINSTALAC]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAinsta.GetInformation(), QMVC_POS_RECORD, sorts, gmaps___pseudinstalacConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAinsta> listing = Models.ModelBase.Where<CSGenioAinsta>(m_userContext, false, gmaps___pseudinstalacConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_GMAPS___PSEUDINSTALAC", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Gmaps_ValInstalac_RowViewModel> MapGmaps_ValInstalac(ListingMVC<CSGenioAinsta> Qlisting)
		{
			List<Gmaps_ValInstalac_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Gmaps_ValInstalac_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Gmaps_ValInstalac_RowViewModel MapGmaps_ValInstalac(CSGenioAinsta row)
		{
			var model = new Gmaps_ValInstalac_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
