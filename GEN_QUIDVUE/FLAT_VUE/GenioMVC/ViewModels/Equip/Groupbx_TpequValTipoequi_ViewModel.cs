...
// USE /[MANUAL GQT OVERRQ GROUPBX_TPEQUTIPOEQUI]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAtpequ>(m_userContext, false, groupbx_tpequtipoequiConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_GROUPBX_TPEQUTIPOEQUI", true, firstVisibleColumn: firstVisibleColumn);
