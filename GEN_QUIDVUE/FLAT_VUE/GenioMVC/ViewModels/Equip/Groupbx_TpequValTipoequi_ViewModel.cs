...
{
	public class Groupbx_TpequValTipoequi_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Groupbx_TpequValTipoequi"; }
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Groupbx_TpequValTipoequi", ref numberListItems);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtpequ> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Groupbx_TpequValTipoequi", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Groupbx_TpequValTipoequi"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Groupbx_TpequValTipoequi");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pGroupbx_TpequValTipoequi"])) ? int.Parse(requestValues["pGroupbx_TpequValTipoequi"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sGroupbx_TpequValTipoequi", "dGroupbx_TpequValTipoequi", requestValues, "tpequ", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAtpequ.FldCodtpequ, CSGenioAtpequ.FldZzstate, CSGenioAtpequ.FldTpequcod, CSGenioAtpequ.FldTipoequi, CSGenioAtpequ.FldTpequpai, CSGenioAtpequ.FldNivel, CSGenioAtpequ.FldBackcolo, CSGenioAtpequ.FldCorletra };
			...
			groupbx_tpequtipoequiConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST GROUPBX_TPEQUTIPOEQUI]/
				...
				ListingMVC<CSGenioAtpequ> listing = Models.ModelBase.Where<CSGenioAtpequ>(m_userContext, false, groupbx_tpequtipoequiConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_GROUPBX_TPEQUTIPOEQUI", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		private List<Models.Tpequ> MapGroupbx_TpequValTipoequi(ListingMVC<CSGenioAtpequ> Qlisting)
		{
		...
		private Models.Tpequ MapGroupbx_TpequValTipoequi(CSGenioAtpequ row)
		{
