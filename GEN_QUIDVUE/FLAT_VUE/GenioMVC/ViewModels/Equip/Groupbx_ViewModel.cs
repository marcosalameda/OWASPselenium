...
// USE /[MANUAL GQT VIEWMODEL_SAVE GROUPBX]/
		public override void Save()
		{
			...
			try { Model = Models.Equip.Find(Navigation.GetStrValue("equip"), m_userContext, "FGROUPBX"); }
			finally { if (Model == null) Model = new Models.Equip(m_userContext) { Identifier = "FGROUPBX" }; }
