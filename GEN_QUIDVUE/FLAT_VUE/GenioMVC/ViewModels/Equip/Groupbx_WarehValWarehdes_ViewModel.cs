...
// USE /[MANUAL GQT OVERRQLIST GROUPBX_WAREHWAREHDES]/
					...
					ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, groupbx_warehwarehdesConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_GROUPBX_WAREHWAREHDES", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Groupbx_WarehValWarehdes_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Groupbx_WarehValWarehdes_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
