...
namespace GenioMVC.ViewModels.Equip
{
	public class PTN_Menu_341_ViewModel : ListViewModel
	{
		...
		public TablePartial<PTN_Menu_341_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_341Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML341");
			ptn_menu_341Conds.Equal(CSGenioAequip.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ 341]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_341Conds, listing);
		...
		public PTN_Menu_341_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<PTN_Menu_341_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAequip> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet ptn_menu_341Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				conditions.SubSets.Add(ptn_menu_341Conds);
				ptn_menu_341Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ 341]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, ptn_menu_341Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML341", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 341]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAequip.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_341Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
		...
		private List<PTN_Menu_341_RowViewModel> MapPTN_Menu_341(ListingMVC<CSGenioAequip> Qlisting)
		{
			var Elements = new List<PTN_Menu_341_RowViewModel>();
			int i = 0;
		...
		/// to a PTN_Menu_341_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_341_RowViewModel MapPTN_Menu_341(CSGenioAequip row)
		{
			var model = new PTN_Menu_341_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_341_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
