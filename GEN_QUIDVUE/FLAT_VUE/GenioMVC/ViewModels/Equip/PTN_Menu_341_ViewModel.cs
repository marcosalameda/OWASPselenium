...
{
	public class PTN_Menu_341_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		...
		public override string Uuid => "ca3ef0a0-cece-4811-810f-91450c0387b3";
...
// USE /[MANUAL PTN LIST_LIMITS 341]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML341");
		...
		public PTN_Menu_341_ViewModel() : base(null!) { }
		...
		public PTN_Menu_341_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 341]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref ptn_menu_341Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML341", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 341]/
		...
		{
			List<PTN_Menu_341_RowViewModel> Elements = [];
			int i = 0;
