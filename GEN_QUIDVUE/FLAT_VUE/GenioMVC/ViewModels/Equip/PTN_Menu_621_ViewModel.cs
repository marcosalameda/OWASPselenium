...
{
	public class PTN_Menu_621_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		...
		public override string Uuid => "6def943c-7d5b-443b-b5ec-d149ca11940f";
...
// USE /[MANUAL PTN LIST_LIMITS 621]/
		...
		public PTN_Menu_621_ViewModel() : base(null!) { }
		...
		public PTN_Menu_621_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 621]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref ptn_menu_621Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML621", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 621]/
				...
				ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, ptn_menu_621Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML621", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_621_RowViewModel> Elements = [];
			int i = 0;
