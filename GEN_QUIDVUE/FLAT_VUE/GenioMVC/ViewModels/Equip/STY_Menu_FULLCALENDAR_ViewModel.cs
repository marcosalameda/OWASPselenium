...
{
	public class STY_Menu_FULLCALENDAR_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		...
		public override string Uuid => "cb03d09a-7795-4e74-9423-745e49d6ec5f";
...
// USE /[MANUAL STY LIST_LIMITS FULLCALENDAR]/
		...
		public STY_Menu_FULLCALENDAR_ViewModel() : base(null!) { }
		...
		public STY_Menu_FULLCALENDAR_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL STY OVERRQ FULLCALENDAR]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref sty_menu_fullcalendarConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLFULLCALENDAR", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST FULLCALENDAR]/
				...
				ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, sty_menu_fullcalendarConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLFULLCALENDAR", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<STY_Menu_FULLCALENDAR_RowViewModel> Elements = [];
			int i = 0;
