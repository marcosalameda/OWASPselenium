...
namespace GenioMVC.ViewModels.Equip
{
	public class STY_Menu_GROUPBOX_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet sty_menu_groupboxConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLGROUPBOX");
			sty_menu_groupboxConds.Equal(CSGenioAequip.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						sty_menu_groupboxConds.Equal(CSGenioAequip.FldShowrc, 1);
...
// USE /[MANUAL STY OVERRQ GROUPBOX]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(sty_menu_groupboxConds, listing);
...
// USE /[MANUAL STY OVERRQLIST GROUPBOX]/
		...
		{
			var Elements = new List<STY_Menu_GROUPBOX_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(STY_Menu_GROUPBOX_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
