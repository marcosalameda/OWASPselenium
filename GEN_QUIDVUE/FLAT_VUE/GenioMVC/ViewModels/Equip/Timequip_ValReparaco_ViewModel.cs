...
FieldRef[] fields = new FieldRef[] { CSGenioArepar.FldCodrepar, CSGenioArepar.FldZzstate, CSGenioArepar.FldDtrepara, CSGenioArepar.FldNrrepara, CSGenioArepar.FldTipoarea, CSGenioArepar.FldDescript, CSGenioArepar.FldHours };
			...
			timequippseudreparacoConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST TIMEQUIP_PSEUDREPARACO]/
				...
				ListingMVC<CSGenioArepar> listing = Models.ModelBase.Where<CSGenioArepar>(m_userContext, false, timequippseudreparacoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TIMEQUIPPSEUDREPARACO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
