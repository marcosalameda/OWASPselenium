...
// USE /[MANUAL GQT VIEWMODEL_SAVE TIMEQUIP]/
		public override void Save()
		{
			...
			try { Model = Models.Equip.Find(Navigation.GetStrValue("equip"), m_userContext, "FTIMEQUIP"); }
			finally { if (Model == null) Model = new Models.Equip(m_userContext) { Identifier = "FTIMEQUIP" }; }
