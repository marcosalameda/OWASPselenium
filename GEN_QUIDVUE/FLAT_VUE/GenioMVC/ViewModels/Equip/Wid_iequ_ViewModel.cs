...
// USE /[MANUAL GQT OVERRQ WID_IEQU_TPEQUTIPOEQUI]/
				...
				*/
				...
				TableTpequTipoequi.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Tpequ(m_userContext, r, true, _fieldsToSerialize_WID_IEQUTPEQUTIPOEQUI));
...
// USE /[MANUAL GQT OVERRQ WID_IEQU_WAREHWAREHDES]/
				...
				*/
				...
				TableWarehWarehdes.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Wareh(m_userContext, r, true, _fieldsToSerialize_WID_IEQUWAREHWAREHDES));
