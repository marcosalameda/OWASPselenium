...
// USE /[MANUAL GQT LIST_LIMITS WID_IEQU_WAREHWAREHDES]/
		...
		public Wid_iequ_WarehValWarehdes_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAwareh> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(wid_iequwarehwarehdesConds);
...
// USE /[MANUAL GQT OVERRQ WID_IEQU_WAREHWAREHDES]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAwareh>(m_userContext, false, ref wid_iequwarehwarehdesConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_WID_IEQUWAREHWAREHDES", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST WID_IEQU_WAREHWAREHDES]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAwareh.GetInformation(), QMVC_POS_RECORD, sorts, wid_iequwarehwarehdesConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
