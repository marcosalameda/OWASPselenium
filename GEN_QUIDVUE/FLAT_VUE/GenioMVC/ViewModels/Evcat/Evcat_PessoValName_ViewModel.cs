...
{
	public class Evcat_PessoValName_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Evcat_PessoValName";
...
// USE /[MANUAL GQT LIST_LIMITS EVCAT_PESSONAME]/
		...
		public Evcat_PessoValName_ViewModel() : base(null!) { }
		...
		public Evcat_PessoValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST EVCAT_PESSONAME]/
		...
		{
			List<Evcat_PessoValName_RowViewModel> Elements = [];
			int i = 0;
