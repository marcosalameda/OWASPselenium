...
// USE /[MANUAL GQT OVERRQ DESPE_AGREGVALUE]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagreg>(m_userContext, false, ref despe___agregvalue___Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DESPE___AGREGVALUE___", true, firstVisibleColumn: firstVisibleColumn);
