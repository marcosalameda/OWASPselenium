...
namespace GenioMVC.ViewModels.Expen
{
	public class Despe_AgregValValue_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Despe_AgregValValue", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAagreg.FldCodaggre, CSGenioAagreg.FldZzstate, CSGenioAagreg.FldValue };
			...
			despe___agregvalue___Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST DESPE_AGREGVALUE]/
				...
				ListingMVC<CSGenioAagreg> listing = Models.ModelBase.Where<CSGenioAagreg>(m_userContext, false, despe___agregvalue___Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DESPE___AGREGVALUE___", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
