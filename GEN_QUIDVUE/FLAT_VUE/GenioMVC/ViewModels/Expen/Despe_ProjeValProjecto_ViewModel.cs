...
// USE /[MANUAL GQT OVERRQ DESPE_PROJEPROJECTO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAproje>(m_userContext, false, ref despe___projeprojectoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DESPE___PROJEPROJECTO", true, firstVisibleColumn: firstVisibleColumn);
