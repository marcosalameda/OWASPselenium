...
namespace GenioMVC.ViewModels.Expen
{
	public class Despe_YearValYear_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Despe_YearValYear", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAyear.FldCodyear, CSGenioAyear.FldZzstate, CSGenioAyear.FldYear };
			...
			despe___year_year____Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST DESPE_YEARYEAR]/
				...
				ListingMVC<CSGenioAyear> listing = Models.ModelBase.Where<CSGenioAyear>(m_userContext, false, despe___year_year____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DESPE___YEAR_YEAR____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
