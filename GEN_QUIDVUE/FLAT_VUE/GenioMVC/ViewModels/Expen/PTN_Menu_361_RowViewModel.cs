...
public class PTN_Menu_361_RowViewModel : Models.Expen
{
	#region Constructors

	public PTN_Menu_361_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_361_RowViewModel(UserContext userContext, CSGenioAexpen val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
