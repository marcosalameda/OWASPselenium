...
namespace GenioMVC.ViewModels.Expen
{
	public class PTN_Menu_361_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_361Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML361");
			ptn_menu_361Conds.Equal(CSGenioAexpen.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ 361]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_361Conds, listing);
...
// USE /[MANUAL PTN OVERRQ 361]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAexpen>(m_userContext, false, ptn_menu_361Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML361", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 361]/
		...
		{
			var Elements = new List<PTN_Menu_361_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_361_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
