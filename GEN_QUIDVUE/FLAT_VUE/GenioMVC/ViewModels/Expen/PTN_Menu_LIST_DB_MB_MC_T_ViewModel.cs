...
// USE /[MANUAL PTN LIST_LIMITS LIST_DB_MB_MC_T]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLLIST_DB_MB_MC_T");
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAexpen> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(ptn_menu_list_db_mb_mc_tConds);
			ptn_menu_list_db_mb_mc_tConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ LIST_DB_MB_MC_T]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAexpen>(m_userContext, false, ref ptn_menu_list_db_mb_mc_tConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MB_MC_T", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST LIST_DB_MB_MC_T]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAexpen.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_list_db_mb_mc_tConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAexpen> listing = Models.ModelBase.Where<CSGenioAexpen>(m_userContext, distinct, ptn_menu_list_db_mb_mc_tConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MB_MC_T", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
