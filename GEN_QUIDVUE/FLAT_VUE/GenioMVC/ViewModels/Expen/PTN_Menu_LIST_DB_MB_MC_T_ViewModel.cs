...
namespace GenioMVC.ViewModels.Expen
{
	public class PTN_Menu_LIST_DB_MB_MC_T_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_list_db_mb_mc_tConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLLIST_DB_MB_MC_T");
			ptn_menu_list_db_mb_mc_tConds.Equal(CSGenioAexpen.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ LIST_DB_MB_MC_T]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_list_db_mb_mc_tConds, listing);
...
// USE /[MANUAL PTN OVERRQ LIST_DB_MB_MC_T]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAexpen>(m_userContext, false, ptn_menu_list_db_mb_mc_tConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MB_MC_T", true, firstVisibleColumn: firstVisibleColumn);
