...
// USE /[MANUAL PTN OVERRQ LIST_DB_MC_T]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAexpen>(m_userContext, false, ref ptn_menu_list_db_mc_tConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MC_T", true, firstVisibleColumn: firstVisibleColumn);
