...
// USE /[MANUAL GQT LIST_LIMITS FACIL_FACTYTYPE]/
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAfacty> Qlisting, ref CriteriaSet conditions)
		{
			...
			facil___factytype____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ FACIL_FACTYTYPE]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAfacty>(m_userContext, false, ref facil___factytype____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_FACIL___FACTYTYPE____", true, firstVisibleColumn: firstVisibleColumn);
