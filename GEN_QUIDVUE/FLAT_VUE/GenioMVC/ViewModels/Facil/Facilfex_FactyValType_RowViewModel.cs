...
public class Facilfex_FactyValType_RowViewModel : Models.Facty
{
	#region Constructors

	public Facilfex_FactyValType_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Facilfex_FactyValType_RowViewModel(UserContext userContext, CSGenioAfacty val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
