...
// USE /[MANUAL GQT VIEWMODEL_SAVE FACILFEX]/
		public override void Save()
		{
			...
			try { Model = Models.Facil.Find(Navigation.GetStrValue("facil"), m_userContext, "FFACILFEX"); }
			finally { if (Model == null) Model = new Models.Facil(m_userContext) { Identifier = "FFACILFEX" }; }
