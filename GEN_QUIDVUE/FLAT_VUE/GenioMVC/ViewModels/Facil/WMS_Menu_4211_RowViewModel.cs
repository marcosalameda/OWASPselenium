...
public class WMS_Menu_4211_RowViewModel : Models.Facil
{
	#region Constructors

	public WMS_Menu_4211_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public WMS_Menu_4211_RowViewModel(UserContext userContext, CSGenioAfacil val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
