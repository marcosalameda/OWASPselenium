...
FieldRef[] fields = new FieldRef[] { CSGenioAfacil.FldCodfacil, CSGenioAfacil.FldZzstate, CSGenioAfacil.FldCodentit, CSGenioAentit.FldCodentit, CSGenioAentit.FldName, CSGenioAfacil.FldIncorpor, CSGenioAfacil.FldName, CSGenioAfacil.FldFaciltyp, CSGenioAfacil.FldCodfacty, CSGenioAfacty.FldCodfacty, CSGenioAfacty.FldType, CSGenioAfacil.FldAddress, CSGenioAfacil.FldImage, CSGenioAfacil.FldGpsinput, CSGenioAfacil.FldLatitude, CSGenioAfacil.FldLongitud, CSGenioAfacil.FldGeocoori, CSGenioAfacil.FldGeocoord };
		...
		public WMS_Menu_4211_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "WMS_Menu_4211", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAfacil.FldCodfacil, CSGenioAfacil.FldZzstate, CSGenioAfacil.FldCodentit, CSGenioAentit.FldCodentit, CSGenioAentit.FldName, CSGenioAfacil.FldIncorpor, CSGenioAfacil.FldName, CSGenioAfacil.FldFaciltyp, CSGenioAfacil.FldCodfacty, CSGenioAfacty.FldCodfacty, CSGenioAfacty.FldType, CSGenioAfacil.FldAddress, CSGenioAfacil.FldImage, CSGenioAfacil.FldGpsinput, CSGenioAfacil.FldLatitude, CSGenioAfacil.FldLongitud, CSGenioAfacil.FldGeocoori, CSGenioAfacil.FldGeocoord };
			...
			conditions.SubSets.Add(wms_menu_4211Conds);
			wms_menu_4211Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQ 4211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAfacil>(m_userContext, false, wms_menu_4211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4211", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL WMS OVERRQLIST 4211]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAfacil.GetInformation(), QMVC_POS_RECORD, sorts, wms_menu_4211Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAfacil> listing = Models.ModelBase.Where<CSGenioAfacil>(m_userContext, false, wms_menu_4211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
