...
// USE /[MANUAL GQT OVERRQ FAMI1_PSEUDTIPOSEQU]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtpeq1>(m_userContext, false, ref fami1___pseudtiposequConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_FAMI1___PSEUDTIPOSEQU", true, firstVisibleColumn: firstVisibleColumn);
