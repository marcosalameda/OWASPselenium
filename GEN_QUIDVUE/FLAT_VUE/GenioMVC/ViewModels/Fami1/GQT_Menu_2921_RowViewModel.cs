...
public class GQT_Menu_2921_RowViewModel : Models.Fami1
{
	#region Constructors

	public GQT_Menu_2921_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_2921_RowViewModel(UserContext userContext, CSGenioAfami1 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
