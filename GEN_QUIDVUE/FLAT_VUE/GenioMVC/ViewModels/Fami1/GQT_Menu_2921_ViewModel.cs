...
// USE /[MANUAL GQT LIST_LIMITS 2921]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAfami1> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAfami1> Qlisting, ref CriteriaSet conditions)
		{
				...
				List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig.ColumnOrderBy, "fami1", allSortOrders);
...
// USE /[MANUAL GQT OVERRQ 2921]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAfami1>(m_userContext, false, gqt_menu_2921Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2921", true, firstVisibleColumn: firstVisibleColumn);
