...
FieldRef[] fields = new FieldRef[] { CSGenioAfami1.FldCodfamil, CSGenioAfami1.FldZzstate, CSGenioAfami1.FldFamily };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "GQT_Menu_2921", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAfami1.FldCodfamil, CSGenioAfami1.FldZzstate, CSGenioAfami1.FldFamily };
			...
			gqt_menu_2921Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST 2921]/
				...
				ListingMVC<CSGenioAfami1> listing = Models.ModelBase.Where<CSGenioAfami1>(m_userContext, false, gqt_menu_2921Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2921", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
