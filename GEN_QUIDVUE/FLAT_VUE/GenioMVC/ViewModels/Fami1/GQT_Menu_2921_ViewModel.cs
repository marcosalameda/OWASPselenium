...
{
	public class GQT_Menu_2921_ViewModel : MenuListViewModel<Models.Fami1>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<GQT_Menu_2921_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "7d41ceb4-cb60-497f-b5c3-07676a99758b";
...
// USE /[MANUAL GQT LIST_LIMITS 2921]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2921");
			...
			ListingMVC<CSGenioAfami1> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public GQT_Menu_2921_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="GQT_Menu_2921_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public GQT_Menu_2921_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public GQT_Menu_2921_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void LoadToExport(out ListingMVC<CSGenioAfami1> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<GQT_Menu_2921_RowViewModel>();
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAfami1> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<GQT_Menu_2921_RowViewModel>();

			CriteriaSet gqt_menu_2921Conds = CriteriaSet.And();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "fami1", allSortOrders);
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				CSGenioAfami1 model_limit_area = new CSGenioAfami1(m_userContext.User);
			...
			conditions.SubSets.Add(gqt_menu_2921Conds);
			gqt_menu_2921Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 2921]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAfami1>(m_userContext, false, ref gqt_menu_2921Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2921", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 2921]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAfami1.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_2921Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<GQT_Menu_2921_RowViewModel> MapGQT_Menu_2921(ListingMVC<CSGenioAfami1> Qlisting)
		{
			List<GQT_Menu_2921_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a GQT_Menu_2921_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_2921_RowViewModel MapGQT_Menu_2921(CSGenioAfami1 row)
		{
			var model = new GQT_Menu_2921_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
