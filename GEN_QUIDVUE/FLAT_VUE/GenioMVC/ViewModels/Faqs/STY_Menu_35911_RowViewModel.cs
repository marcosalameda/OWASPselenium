...
public class STY_Menu_35911_RowViewModel : Models.Faqs
{
	#region Constructors

	public STY_Menu_35911_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public STY_Menu_35911_RowViewModel(UserContext userContext, CSGenioAfaqs val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
