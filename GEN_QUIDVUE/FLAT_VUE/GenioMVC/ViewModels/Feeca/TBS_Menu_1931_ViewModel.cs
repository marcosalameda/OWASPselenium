...
// USE /[MANUAL TBS LIST_LIMITS 1931]/
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAfeeca> Qlisting, ref CriteriaSet conditions)
		{
			...
			tbs_menu_1931Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL TBS OVERRQ 1931]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAfeeca>(m_userContext, false, ref tbs_menu_1931Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1931", true, firstVisibleColumn: firstVisibleColumn);
