...
public class Campo_AeroValName_RowViewModel : Models.Aero
{
	#region Constructors

	public Campo_AeroValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Campo_AeroValName_RowViewModel(UserContext userContext, CSGenioAaero val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
