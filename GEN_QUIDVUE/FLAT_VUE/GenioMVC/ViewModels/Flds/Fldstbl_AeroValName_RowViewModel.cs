...
public class Fldstbl_AeroValName_RowViewModel : Models.Aero
{
	#region Constructors

	public Fldstbl_AeroValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Fldstbl_AeroValName_RowViewModel(UserContext userContext, CSGenioAaero val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
