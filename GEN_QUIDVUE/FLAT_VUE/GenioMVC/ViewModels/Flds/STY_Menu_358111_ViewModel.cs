...
{
	public class STY_Menu_358111_ViewModel : MenuListViewModel<Models.Flds>
	{
		/// <summary>
		...
		public override string Uuid => "b4876464-045a-4467-8a78-71f8b25b3bcd";
...
// USE /[MANUAL STY LIST_LIMITS 358111]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML358111");
		...
		public STY_Menu_358111_ViewModel() : base(null!) { }
		...
		public STY_Menu_358111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL STY OVERRQ 358111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAflds>(m_userContext, false, ref sty_menu_358111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML358111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST 358111]/
				...
				ListingMVC<CSGenioAflds> listing = Models.ModelBase.Where<CSGenioAflds>(m_userContext, distinct, sty_menu_358111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML358111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<STY_Menu_358111_RowViewModel> Elements = [];
			int i = 0;
