...
{
	public class STY_Menu_358211_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<STY_Menu_358211_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid { get => "0c20c0e5-c392-4c3c-b7a5-6a57ddaa68bc"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet sty_menu_358211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML358211");
			sty_menu_358211Conds.Equal(CSGenioAflds.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						sty_menu_358211Conds.Equal(CSGenioAflds.FldShwrc, 1);


// USE /[MANUAL STY OVERRQ 358211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(sty_menu_358211Conds, listing);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STY_Menu_358211_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public STY_Menu_358211_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<STY_Menu_358211_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Flds.AddEPH<CSGenioAflds>(ref u, crs, "ML358211");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Flds.AddEPH<CSGenioAflds>(ref u, null, "ML358211"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAflds> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet sty_menu_358211Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML358211");
			...
			//1st Area Value: "1"
			{
				...
				conditions.SubSets.Add(sty_menu_358211Conds);
				sty_menu_358211Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL STY OVERRQ 358211]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAflds>(m_userContext, false, sty_menu_358211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML358211", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL STY OVERRQLSTEXP 358211]/
				...
				if (tableReload)
				{
// USE /[MANUAL STY OVERRQLIST 358211]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAflds.GetInformation(), QMVC_POS_RECORD, sorts, sty_menu_358211Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAflds> listing = Models.ModelBase.Where<CSGenioAflds>(m_userContext, false, sty_menu_358211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML358211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapSTY_Menu_358211(listing);

					Menu.Identifier = "ML358211";
					Menu.Slots = new Dictionary<string, List<object>>();

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "ML358211";
		...
		private List<STY_Menu_358211_RowViewModel> MapSTY_Menu_358211(ListingMVC<CSGenioAflds> Qlisting)
		{
			var Elements = new List<STY_Menu_358211_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapSTY_Menu_358211(row));
					i++;
				}
			}
		...
		/// to a STY_Menu_358211_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private STY_Menu_358211_RowViewModel MapSTY_Menu_358211(CSGenioAflds row)
		{
			var model = new STY_Menu_358211_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(STY_Menu_358211_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM STY_MENU_358211]/
		#endregion
