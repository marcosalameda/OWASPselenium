...
{
	public class STY_Menu_358211_ViewModel : MenuListViewModel<Models.Flds>
	{
		/// <summary>
		...
		public override string Uuid => "0c20c0e5-c392-4c3c-b7a5-6a57ddaa68bc";
		...
		{
// USE /[MANUAL STY LIST_LIMITS 358211]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML358211");
		...
		public STY_Menu_358211_ViewModel() : base(null!) { }
		...
		public STY_Menu_358211_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL STY OVERRQ 358211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAflds>(m_userContext, false, ref sty_menu_358211Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML358211", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST 358211]/
				...
				ListingMVC<CSGenioAflds> listing = Models.ModelBase.Where<CSGenioAflds>(m_userContext, distinct, sty_menu_358211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML358211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<STY_Menu_358211_RowViewModel> Elements = [];
			int i = 0;
