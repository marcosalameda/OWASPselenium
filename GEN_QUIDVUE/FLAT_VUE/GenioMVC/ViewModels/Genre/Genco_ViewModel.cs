...
// USE /[MANUAL GQT VIEWMODEL_SAVE GENCO]/
		public override void Save()
		{
			...
			try { Model = Models.Genre.Find(Navigation.GetStrValue("genre"), m_userContext, "FGENCO"); }
			finally { if (Model == null) Model = new Models.Genre(m_userContext) { Identifier = "FGENCO" }; }
