...
// USE /[MANUAL GQT VIEWMODEL_SAVE HOMEG]/
		public override void Save()
		{
			...
			try { Model = Models.Glob.Find(Navigation.GetStrValue("glob"), m_userContext, "FHOMEG"); }
			finally { if (Model == null) Model = new Models.Glob(m_userContext) { Identifier = "FHOMEG" }; }
