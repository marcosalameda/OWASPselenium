...
FieldRef[] fields = new FieldRef[] { CSGenioAglob.FldCodglob, CSGenioAglob.FldZzstate, CSGenioAglob.FldCodfacty, CSGenioAfacty.FldCodfacty, CSGenioAfacty.FldType };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "WMS_Menu_4241", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAglob.FldCodglob, CSGenioAglob.FldZzstate, CSGenioAglob.FldCodfacty, CSGenioAfacty.FldCodfacty, CSGenioAfacty.FldType };
			...
			wms_menu_4241Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQLIST 4241]/
				...
				ListingMVC<CSGenioAglob> listing = Models.ModelBase.Where<CSGenioAglob>(m_userContext, false, wms_menu_4241Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4241", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
