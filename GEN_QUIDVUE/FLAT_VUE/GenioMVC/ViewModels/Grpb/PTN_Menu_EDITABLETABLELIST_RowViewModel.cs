...
public class PTN_Menu_EDITABLETABLELIST_RowViewModel : Models.Grpb
{
	#region Constructors

	public PTN_Menu_EDITABLETABLELIST_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public PTN_Menu_EDITABLETABLELIST_RowViewModel(UserContext userContext, CSGenioAgrpb val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
