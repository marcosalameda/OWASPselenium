...
namespace GenioMVC.ViewModels.Indoc
{
	public class Dentr_CmpnyValDesignat_ViewModel : ListViewModel
	{
		...
		public TablePartial<Dentr_CmpnyValDesignat_RowViewModel> Menu { get; set; }
...
// USE /[MANUAL GQT LIST_LIMITS DENTR_CMPNYDESIGNAT]/
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcmpny> Qlisting, ref CriteriaSet conditions)
		{
			...
			//1st Area Value: ""
			{
				...
				dentr___cmpnydesignatConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST DENTR_CMPNYDESIGNAT]/
					...
					ListingMVC<CSGenioAcmpny> listing = Models.ModelBase.Where<CSGenioAcmpny>(m_userContext, false, dentr___cmpnydesignatConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DENTR___CMPNYDESIGNAT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Dentr_CmpnyValDesignat_RowViewModel> MapDentr_CmpnyValDesignat(ListingMVC<CSGenioAcmpny> Qlisting)
		{
			var Elements = new List<Dentr_CmpnyValDesignat_RowViewModel>();
			int i = 0;
		...
		/// to a Dentr_CmpnyValDesignat_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Dentr_CmpnyValDesignat_RowViewModel MapDentr_CmpnyValDesignat(CSGenioAcmpny row)
		{
			var model = new Dentr_CmpnyValDesignat_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(Dentr_CmpnyValDesignat_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
