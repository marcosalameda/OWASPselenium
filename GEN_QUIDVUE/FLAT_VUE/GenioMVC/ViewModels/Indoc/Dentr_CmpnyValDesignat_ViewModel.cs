...
{
	public class Dentr_CmpnyValDesignat_ViewModel : MenuListViewModel<Models.Cmpny>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Dentr_CmpnyValDesignat";
...
// USE /[MANUAL GQT LIST_LIMITS DENTR_CMPNYDESIGNAT]/
		...
		public Dentr_CmpnyValDesignat_ViewModel() : base(null!) { }
		...
		public Dentr_CmpnyValDesignat_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST DENTR_CMPNYDESIGNAT]/
		...
		{
			List<Dentr_CmpnyValDesignat_RowViewModel> Elements = [];
			int i = 0;
