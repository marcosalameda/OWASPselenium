...
// USE /[MANUAL GQT OVERRQ DENTR_CNTRYCOUNTRY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcntry>(m_userContext, false, ref dentr___cntrycountry_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DENTR___CNTRYCOUNTRY_", true, firstVisibleColumn: firstVisibleColumn);
