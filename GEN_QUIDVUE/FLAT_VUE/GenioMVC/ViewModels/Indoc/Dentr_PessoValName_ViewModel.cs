...
namespace GenioMVC.ViewModels.Indoc
{
	public class Dentr_PessoValName_ViewModel : ListViewModel
	{
		...
		public TablePartial<Dentr_PessoValName_RowViewModel> Menu { get; set; }
...
// USE /[MANUAL GQT LIST_LIMITS DENTR_PESSONAME]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Dentr_PessoValName_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApesso> Qlisting, ref CriteriaSet conditions)
		{
			...
			//1st Area Value: ""
			{
				...
				dentr___pessoname____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST DENTR_PESSONAME]/
		...
		private List<Dentr_PessoValName_RowViewModel> MapDentr_PessoValName(ListingMVC<CSGenioApesso> Qlisting)
		{
			var Elements = new List<Dentr_PessoValName_RowViewModel>();
			int i = 0;
		...
		/// to a Dentr_PessoValName_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Dentr_PessoValName_RowViewModel MapDentr_PessoValName(CSGenioApesso row)
		{
			var model = new Dentr_PessoValName_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(Dentr_PessoValName_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
