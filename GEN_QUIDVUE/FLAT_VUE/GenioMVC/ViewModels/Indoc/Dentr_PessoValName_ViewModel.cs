...
{
	public class Dentr_PessoValName_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		public override string Uuid => "Dentr_PessoValName";
...
// USE /[MANUAL GQT LIST_LIMITS DENTR_PESSONAME]/
		...
		public Dentr_PessoValName_ViewModel() : base(null!) { }
		...
		public Dentr_PessoValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ DENTR_PESSONAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref dentr___pessoname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DENTR___PESSONAME____", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST DENTR_PESSONAME]/
		...
		{
			List<Dentr_PessoValName_RowViewModel> Elements = [];
			int i = 0;
