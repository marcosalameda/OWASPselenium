...
public class Dentr_ValEntradas_RowViewModel : Models.Ldent
{
	#region Constructors

	public Dentr_ValEntradas_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Dentr_ValEntradas_RowViewModel(UserContext userContext, CSGenioAldent val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
