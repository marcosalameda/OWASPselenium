...
{
	public class Dentr_Ware1ValWarehdes_ViewModel : MenuListViewModel<Models.Ware1>
	{
		/// <summary>
		...
		public override string Uuid => "Dentr_Ware1ValWarehdes";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS DENTR_WARE1WAREHDES]/
		...
		public Dentr_Ware1ValWarehdes_ViewModel() : base(null!) { }
		...
		public Dentr_Ware1ValWarehdes_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ DENTR_WARE1WAREHDES]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAware1>(m_userContext, false, ref dentr___ware1warehdesConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DENTR___WARE1WAREHDES", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST DENTR_WARE1WAREHDES]/
		...
		{
			List<Dentr_Ware1ValWarehdes_RowViewModel> Elements = [];
			int i = 0;
