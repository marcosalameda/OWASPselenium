...
public class GQT_Menu_431_RowViewModel : Models.Indoc
{
	#region Constructors

	public GQT_Menu_431_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public GQT_Menu_431_RowViewModel(UserContext userContext, CSGenioAindoc val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
