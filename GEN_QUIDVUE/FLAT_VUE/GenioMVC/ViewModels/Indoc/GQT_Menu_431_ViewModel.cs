...
{
	public class GQT_Menu_431_ViewModel : MenuListViewModel<Models.Indoc>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "99a66472-9195-457d-8f66-630e59903e49";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS 431]/
		...
		public override int GetCount(User user)
		{
			...
			ListingMVC<CSGenioAindoc> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public GQT_Menu_431_ViewModel() : base(null!) { }
		...
		public GQT_Menu_431_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST 431]/
					...
					ListingMVC<CSGenioAindoc> listing = Models.ModelBase.Where<CSGenioAindoc>(m_userContext, distinct, gqt_menu_431Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML431", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_431_RowViewModel> Elements = [];
			int i = 0;
