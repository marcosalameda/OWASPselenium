...
public class GQT_Menu_261_RowViewModel : Models.Insta
{
	#region Constructors

	public GQT_Menu_261_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public GQT_Menu_261_RowViewModel(UserContext userContext, CSGenioAinsta val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
