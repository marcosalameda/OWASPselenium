...
{
	public class GQT_Menu_261_ViewModel : MenuListViewModel<Models.Insta>
	{
		/// <summary>
		...
		public override string Uuid => "0655f0e5-8a64-4786-911e-9b4ece9f7ac0";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS 261]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML261");
		...
		public GQT_Menu_261_ViewModel() : base(null!) { }
		...
		public GQT_Menu_261_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ 261]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAinsta>(m_userContext, false, ref gqt_menu_261Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML261", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 261]/
				...
				ListingMVC<CSGenioAinsta> listing = Models.ModelBase.Where<CSGenioAinsta>(m_userContext, distinct, gqt_menu_261Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML261", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_261_RowViewModel> Elements = [];
			int i = 0;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_261]/
		...
		[
			"Insta", "Insta.ValCodinsta", "Insta.ValZzstate", "Insta.ValSince", "Insta.ValUntil", "Equip", "Equip.ValRegistnr", "Equip.ValDesignat", "Tpequ", "Tpequ.ValTipoequi", "Insta.ValHours", "Insta.ValPrecohor", "Insta.ValValue", "Insta.ValCoordgeo", "Insta.ValCodequip", "Insta.ValCodtpequ"
		];
