...
// USE /[MANUAL STY OVERRQ LEAFLET]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAinsta>(m_userContext, false, ref sty_menu_leafletConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLEAFLET", true, firstVisibleColumn: firstVisibleColumn);
