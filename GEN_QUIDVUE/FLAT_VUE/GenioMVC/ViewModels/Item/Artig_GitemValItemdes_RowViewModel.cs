...
public class Artig_GitemValItemdes_RowViewModel : Models.Gitem
{
	#region Constructors

	public Artig_GitemValItemdes_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Artig_GitemValItemdes_RowViewModel(UserContext userContext, CSGenioAgitem val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
