...
// USE /[MANUAL GQT OVERRQLIST ARTIG_PSEUDLENTRADA]/
		...
		{
			var Elements = new List<Artig_ValLentrada_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Artig_ValLentrada_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM ARTIG_VALLENTRADA]/
		...
		[
			"Ldent", "Ldent.ValCodldent", "Ldent.ValZzstate", "Ldent.ValDhentra", "Indoc", "Indoc.ValDocumenr", "Ldent.ValLine", "Ldent.ValQtdentra", "Ldent.ValCoddentr", "Indoc.ValCoddentr", "Ldent.ValCoditem", "Ldent.ValCodwareh", "BtnPermission"
		];
