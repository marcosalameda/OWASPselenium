...
namespace GenioMVC.ViewModels.Item
{
	public class Artig_ValLentrada_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValLentrada", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAldent.FldCodldent, CSGenioAldent.FldZzstate, CSGenioAldent.FldDhentra, CSGenioAldent.FldCoddentr, CSGenioAindoc.FldCoddentr, CSGenioAindoc.FldDocumenr, CSGenioAldent.FldLine, CSGenioAldent.FldQtdentra };
			...
			artig___pseudlentradaConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ ARTIG_PSEUDLENTRADA]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAldent>(m_userContext, false, artig___pseudlentradaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARTIG___PSEUDLENTRADA", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ARTIG_PSEUDLENTRADA]/
				...
				ListingMVC<CSGenioAldent> listing = Models.ModelBase.Where<CSGenioAldent>(m_userContext, false, artig___pseudlentradaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARTIG___PSEUDLENTRADA", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
