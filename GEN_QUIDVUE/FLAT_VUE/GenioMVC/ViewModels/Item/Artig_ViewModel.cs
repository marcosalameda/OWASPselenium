...
// USE /[MANUAL GQT OVERRQ ARTIG_WAREHWAREHDES]/
				...
				*/
				...
				TableWarehWarehdes.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Wareh(m_userContext, r, true, _fieldsToSerialize_ARTIG___WAREHWAREHDES));
...
// USE /[MANUAL GQT OVERRQ ARTIG_GITEMITEMDES]/
				...
				*/
				...
				TableGitemItemdes.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Gitem(m_userContext, r, true, _fieldsToSerialize_ARTIG___GITEMITEMDES_));
