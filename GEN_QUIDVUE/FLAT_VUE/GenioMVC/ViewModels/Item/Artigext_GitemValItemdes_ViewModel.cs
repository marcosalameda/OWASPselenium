...
{
	public class Artigext_GitemValItemdes_ViewModel : MenuListViewModel<Models.Gitem>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Artigext_GitemValItemdes_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Artigext_GitemValItemdes";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS ARTIGEXT_GITEMITEMDES]/
		...
		public Artigext_GitemValItemdes_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Artigext_GitemValItemdes_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Artigext_GitemValItemdes_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Artigext_GitemValItemdes_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Artigext_GitemValItemdes_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAgitem> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(artigextgitemitemdes_Conds);
			artigextgitemitemdes_Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ ARTIGEXT_GITEMITEMDES]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAgitem>(m_userContext, false, ref artigextgitemitemdes_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARTIGEXTGITEMITEMDES_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ARTIGEXT_GITEMITEMDES]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAgitem.GetInformation(), QMVC_POS_RECORD, sorts, artigextgitemitemdes_Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAgitem> listing = Models.ModelBase.Where<CSGenioAgitem>(m_userContext, distinct, artigextgitemitemdes_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARTIGEXTGITEMITEMDES_", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Artigext_GitemValItemdes_RowViewModel> MapArtigext_GitemValItemdes(ListingMVC<CSGenioAgitem> Qlisting)
		{
			List<Artigext_GitemValItemdes_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Artigext_GitemValItemdes_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Artigext_GitemValItemdes_RowViewModel MapArtigext_GitemValItemdes(CSGenioAgitem row)
		{
			var model = new Artigext_GitemValItemdes_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
