...
// USE /[MANUAL GQT OVERRQLIST ARTIGEXT_GITEMITEMDES]/
		...
		{
			var Elements = new List<Artigext_GitemValItemdes_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Artigext_GitemValItemdes_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM ARTIGEXT_GITEMVALITEMDES]/
		...
		[
			"Gitem", "Gitem.ValCodgitem", "Gitem.ValZzstate", "Gitem.ValItemdes", "Gitem.ValItemgcod", "BtnPermission"
		];
