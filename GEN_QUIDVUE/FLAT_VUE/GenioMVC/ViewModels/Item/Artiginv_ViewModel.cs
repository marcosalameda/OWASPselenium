...
// USE /[MANUAL GQT VIEWMODEL_SAVE ARTIGINV]/
		public override void Save()
		{
			...
			try { Model = Models.Item.Find(Navigation.GetStrValue("item"), m_userContext, "FARTIGINV"); }
			finally { if (Model == null) Model = new Models.Item(m_userContext) { Identifier = "FARTIGINV" }; }
