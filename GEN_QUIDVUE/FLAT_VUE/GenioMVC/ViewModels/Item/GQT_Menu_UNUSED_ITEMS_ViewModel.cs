...
{
	public class GQT_Menu_UNUSED_ITEMS_ViewModel : MenuListViewModel<Models.Item>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<GQT_Menu_UNUSED_ITEMS_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "026b4b45-a993-4305-9455-a3c221daa253";
		...
		public override CriteriaSet BaseConditions
		{
			get
			{
				...
				if (Navigation.CheckKey("item.valid"))
					conds.Equal(CSGenioAitem.FldValid, Navigation.GetValue("item.valid"));
...
// USE /[MANUAL GQT LIST_LIMITS UNUSED_ITEMS]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLUNUSED_ITEMS");
			...
			ListingMVC<CSGenioAitem> listing = new(fields, null, 1, 1, false, user, true, string.Empty, true);
		...
		public GQT_Menu_UNUSED_ITEMS_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="GQT_Menu_UNUSED_ITEMS_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public GQT_Menu_UNUSED_ITEMS_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public GQT_Menu_UNUSED_ITEMS_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAitem> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet gqt_menu_unused_itemsConds = CriteriaSet.And();
			...
			conditions.SubSets.Add(gqt_menu_unused_itemsConds);
			gqt_menu_unused_itemsConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ UNUSED_ITEMS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAitem>(m_userContext, false, ref gqt_menu_unused_itemsConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLUNUSED_ITEMS", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST UNUSED_ITEMS]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAitem.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_unused_itemsConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAitem> listing = Models.ModelBase.Where<CSGenioAitem>(m_userContext, distinct, gqt_menu_unused_itemsConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLUNUSED_ITEMS", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_UNUSED_ITEMS_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a GQT_Menu_UNUSED_ITEMS_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_UNUSED_ITEMS_RowViewModel MapGQT_Menu_UNUSED_ITEMS(CSGenioAitem row)
		{
			var model = new GQT_Menu_UNUSED_ITEMS_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
