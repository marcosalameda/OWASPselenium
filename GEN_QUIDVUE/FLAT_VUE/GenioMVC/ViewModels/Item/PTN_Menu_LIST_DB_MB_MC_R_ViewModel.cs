...
// USE /[MANUAL PTN OVERRQ LIST_DB_MB_MC_R]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAitem>(m_userContext, false, ref ptn_menu_list_db_mb_mc_rConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MB_MC_R", true, firstVisibleColumn: firstVisibleColumn);
