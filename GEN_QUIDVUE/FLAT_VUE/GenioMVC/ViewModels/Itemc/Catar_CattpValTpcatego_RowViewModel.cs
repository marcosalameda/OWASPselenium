...
public class Catar_CattpValTpcatego_RowViewModel : Models.Cattp
{
	#region Constructors

	public Catar_CattpValTpcatego_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Catar_CattpValTpcatego_RowViewModel(UserContext userContext, CSGenioAcattp val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
