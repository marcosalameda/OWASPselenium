...
public class GQT_Menu_481_RowViewModel : Models.Itemc
{
	#region Constructors

	public GQT_Menu_481_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public GQT_Menu_481_RowViewModel(UserContext userContext, CSGenioAitemc val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
