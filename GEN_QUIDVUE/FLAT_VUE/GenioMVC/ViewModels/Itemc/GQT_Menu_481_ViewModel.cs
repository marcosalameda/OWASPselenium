...
FieldRef[] fields = new FieldRef[] { CSGenioAitemc.FldCodcatar, CSGenioAitemc.FldZzstate, CSGenioAitemc.FldCoditem, CSGenioAitem.FldCoditem, CSGenioAitem.FldItemdes, CSGenioAitemc.FldCodtpcat, CSGenioAcattp.FldCodtpcat, CSGenioAcattp.FldTpcatego };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "GQT_Menu_481", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAitemc.FldCodcatar, CSGenioAitemc.FldZzstate, CSGenioAitemc.FldCoditem, CSGenioAitem.FldCoditem, CSGenioAitem.FldItemdes, CSGenioAitemc.FldCodtpcat, CSGenioAcattp.FldCodtpcat, CSGenioAcattp.FldTpcatego };
			...
			gqt_menu_481Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST 481]/
				...
				ListingMVC<CSGenioAitemc> listing = Models.ModelBase.Where<CSGenioAitemc>(m_userContext, false, gqt_menu_481Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML481", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Itemc(m_userContext, true, _fieldsToSerialize);
