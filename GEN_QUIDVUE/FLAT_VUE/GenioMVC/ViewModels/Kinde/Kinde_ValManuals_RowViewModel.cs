...
public class Kinde_ValManuals_RowViewModel : Models.Manua
{
	#region Constructors

	public Kinde_ValManuals_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Kinde_ValManuals_RowViewModel(UserContext userContext, CSGenioAmanua val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
