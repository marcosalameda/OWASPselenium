...
public class Kinde_ValParamete_RowViewModel : Models.Param
{
	#region Constructors

	public Kinde_ValParamete_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Kinde_ValParamete_RowViewModel(UserContext userContext, CSGenioAparam val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
