...
// USE /[MANUAL GQT OVERRQLIST KINDE_PSEUDPARAMETE]/
		...
		{
			var Elements = new List<Kinde_ValParamete_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Kinde_ValParamete_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM KINDE_VALPARAMETE]/
		...
		[
			"Param", "Param.ValCodparam", "Param.ValZzstate", "Param.ValParameter", "Param.ValDatatype", "Param.ValDecimalplaces", "Param.ValCodkinde", "BtnPermission"
		];
