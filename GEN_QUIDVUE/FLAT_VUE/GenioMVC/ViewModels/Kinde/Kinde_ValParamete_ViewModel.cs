...
FieldRef[] fields = new FieldRef[] { CSGenioAparam.FldCodparam, CSGenioAparam.FldZzstate, CSGenioAparam.FldParameter, CSGenioAparam.FldDatatype, CSGenioAparam.FldDecimalplaces };
			...
			kinde___pseudparameteConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST KINDE_PSEUDPARAMETE]/
				...
				ListingMVC<CSGenioAparam> listing = Models.ModelBase.Where<CSGenioAparam>(m_userContext, false, kinde___pseudparameteConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_KINDE___PSEUDPARAMETE", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM KINDE_VALPARAMETE]/
		...
		private static readonly List<TableSearchColumn> _searchableColumns = new List<TableSearchColumn>
		{
			...
			new TableSearchColumn("ValDecimalplaces", CSGenioAparam.FldDecimalplaces, typeof(double), array : "DecPlace")
		};
	}
}
