...
public class GQT_Menu_921_RowViewModel : Models.Langu
{
	#region Constructors

	public GQT_Menu_921_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public GQT_Menu_921_RowViewModel(UserContext userContext, CSGenioAlangu val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
