...
public class Lcext_LocatValGln_RowViewModel : Models.Locat
{
	#region Constructors

	public Lcext_LocatValGln_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Lcext_LocatValGln_RowViewModel(UserContext userContext, CSGenioAlocat val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
