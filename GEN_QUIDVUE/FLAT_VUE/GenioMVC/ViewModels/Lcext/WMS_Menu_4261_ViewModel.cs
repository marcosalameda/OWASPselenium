...
FieldRef[] fields = new FieldRef[] { CSGenioAlcext.FldCodlcext, CSGenioAlcext.FldZzstate, CSGenioAlcext.FldCodlocat, CSGenioAlocat.FldCodlocat, CSGenioAlocat.FldGln, CSGenioAlcext.FldGlnext, CSGenioAlcext.FldSpacetyp, CSGenioAlcext.FldSpaceobs };
		...
		public WMS_Menu_4261_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "WMS_Menu_4261", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlcext.FldCodlcext, CSGenioAlcext.FldZzstate, CSGenioAlcext.FldCodlocat, CSGenioAlocat.FldCodlocat, CSGenioAlocat.FldGln, CSGenioAlcext.FldGlnext, CSGenioAlcext.FldSpacetyp, CSGenioAlcext.FldSpaceobs };
			...
			conditions.SubSets.Add(wms_menu_4261Conds);
			wms_menu_4261Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQ 4261]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAlcext>(m_userContext, false, wms_menu_4261Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4261", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL WMS OVERRQLIST 4261]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAlcext.GetInformation(), QMVC_POS_RECORD, sorts, wms_menu_4261Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAlcext> listing = Models.ModelBase.Where<CSGenioAlcext>(m_userContext, false, wms_menu_4261Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4261", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
