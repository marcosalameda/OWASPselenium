...
// USE /[MANUAL WMS OVERRQ 4261]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlcext>(m_userContext, false, ref wms_menu_4261Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4261", true, firstVisibleColumn: firstVisibleColumn);
