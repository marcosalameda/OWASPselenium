...
public class Ldent_IndocValDocumenr_RowViewModel : Models.Indoc
{
	#region Constructors

	public Ldent_IndocValDocumenr_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Ldent_IndocValDocumenr_RowViewModel(UserContext userContext, CSGenioAindoc val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
