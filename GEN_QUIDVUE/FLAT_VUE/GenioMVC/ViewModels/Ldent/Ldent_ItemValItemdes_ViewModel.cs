...
namespace GenioMVC.ViewModels.Ldent
{
	public class Ldent_ItemValItemdes_ViewModel : ListViewModel
	{
		...
		public TablePartial<Ldent_ItemValItemdes_RowViewModel> Menu { get; set; }
...
// USE /[MANUAL GQT LIST_LIMITS LDENT_ITEMITEMDES]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Ldent_ItemValItemdes_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAitem> Qlisting, ref CriteriaSet conditions)
		{
			...
			//1st Area Value: ""
			{
				...
				ldent___item_itemdes_Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST LDENT_ITEMITEMDES]/
		...
		private List<Ldent_ItemValItemdes_RowViewModel> MapLdent_ItemValItemdes(ListingMVC<CSGenioAitem> Qlisting)
		{
			var Elements = new List<Ldent_ItemValItemdes_RowViewModel>();
			int i = 0;
		...
		/// to a Ldent_ItemValItemdes_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Ldent_ItemValItemdes_RowViewModel MapLdent_ItemValItemdes(CSGenioAitem row)
		{
			var model = new Ldent_ItemValItemdes_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(Ldent_ItemValItemdes_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
