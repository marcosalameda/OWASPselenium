...
{
	public class Ldent_ItemValItemdes_ViewModel : MenuListViewModel<Models.Item>
	{
		/// <summary>
		...
		public override string Uuid => "Ldent_ItemValItemdes";
...
// USE /[MANUAL GQT LIST_LIMITS LDENT_ITEMITEMDES]/
		...
		public Ldent_ItemValItemdes_ViewModel() : base(null!) { }
		...
		public Ldent_ItemValItemdes_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ LDENT_ITEMITEMDES]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAitem>(m_userContext, false, ref ldent___item_itemdes_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LDENT___ITEM_ITEMDES_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST LDENT_ITEMITEMDES]/
		...
		{
			List<Ldent_ItemValItemdes_RowViewModel> Elements = [];
			int i = 0;
