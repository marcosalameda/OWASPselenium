...
namespace GenioMVC.ViewModels.Ldent
{
	public class Ldentnor_IndocValDocumenr_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Ldentnor_IndocValDocumenr", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAindoc.FldCoddentr, CSGenioAindoc.FldZzstate, CSGenioAindoc.FldDocumenr, CSGenioAindoc.FldDhdocume };
			...
			ldentnorindocdocumenrConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST LDENTNOR_INDOCDOCUMENR]/
				...
				ListingMVC<CSGenioAindoc> listing = Models.ModelBase.Where<CSGenioAindoc>(m_userContext, false, ldentnorindocdocumenrConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LDENTNORINDOCDOCUMENR", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
