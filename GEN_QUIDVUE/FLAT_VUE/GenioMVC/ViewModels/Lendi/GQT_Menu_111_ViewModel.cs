...
{
	public class GQT_Menu_111_ViewModel : MenuListViewModel<Models.Lendi>
	{
		/// <summary>
		...
		protected override TableViewsManagementMode ViewsManagementMode => TableViewsManagementMode.PersistMany;
		...
		/// <inheritdoc/>
		public override string Uuid => "d8250c34-a862-4c8d-8eed-1e2a4fabb9a0";
...
// USE /[MANUAL GQT LIST_LIMITS 111]/
		...
		public GQT_Menu_111_ViewModel() : base(null!) { }
		...
		public GQT_Menu_111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
...

			{
				...
				bool filter_GQT_Menu_111_DEVOLUCAO_4 = false;
				if (tableConfig.StaticFilters["filter_GQT_Menu_111_DEVOLUCAO"] != null)
					filter_GQT_Menu_111_DEVOLUCAO_4 = tableConfig.StaticFilters["filter_GQT_Menu_111_DEVOLUCAO"].Contains("4");
				if (filter_GQT_Menu_111_DEVOLUCAO_4)
				{
...
// USE /[MANUAL GQT OVERRQLIST 111]/
					...
					ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, distinct, gqt_menu_111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_111_RowViewModel> Elements = [];
			int i = 0;
