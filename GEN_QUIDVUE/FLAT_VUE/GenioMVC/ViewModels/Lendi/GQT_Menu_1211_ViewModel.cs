...
// USE /[MANUAL GQT LIST_LIMITS 1211]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (!tableConfig.GroupFilters.ContainsKey("filter_GQT_Menu_1211_DEVOLUCAO"))
			{
				string defaultValue = "1";
				tableConfig.Filters.Add(new GroupFilter { Key = "filter_GQT_Menu_1211_DEVOLUCAO", Value = defaultValue });
			}

			{
				...
				if (tableConfig.GroupFilters.ContainsKey("filter_GQT_Menu_1211_DEVOLUCAO"))
					filter_GQT_Menu_1211_DEVOLUCAO_1 = tableConfig.GroupFilters["filter_GQT_Menu_1211_DEVOLUCAO"].Contains("1");
				else if (!tableConfig.GroupFilters.ContainsKey("filter_GQT_Menu_1211_DEVOLUCAO"))
				...
				if (tableConfig.GroupFilters.ContainsKey("filter_GQT_Menu_1211_DEVOLUCAO"))
					filter_GQT_Menu_1211_DEVOLUCAO_2 = tableConfig.GroupFilters["filter_GQT_Menu_1211_DEVOLUCAO"].Contains("2");
				...
				if (tableConfig.GroupFilters.ContainsKey("filter_GQT_Menu_1211_DEVOLUCAO"))
					filter_GQT_Menu_1211_DEVOLUCAO_3 = tableConfig.GroupFilters["filter_GQT_Menu_1211_DEVOLUCAO"].Contains("3");
...
// USE /[MANUAL GQT OVERRQ 1211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlendi>(m_userContext, false, ref gqt_menu_1211Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1211", true, firstVisibleColumn: firstVisibleColumn);
