...
namespace GenioMVC.ViewModels.Lendi
{
	public class GQT_Menu_1311_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_1311Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML1311");
			gqt_menu_1311Conds.Equal(CSGenioAlendi.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						gqt_menu_1311Conds.Equal(CSGenioAlendi.FldCodpess1, "");
...
// USE /[MANUAL GQT OVERRQ 1311]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_1311Conds, listing);
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (!tableConfig.StaticFilters.ContainsKey("filter_GQT_Menu_1311_DEVOLUCAO"))
				tableConfig.StaticFilters.Add("filter_GQT_Menu_1311_DEVOLUCAO", null);

			{
				var groupFilters = CriteriaSet.Or();
				bool filter_GQT_Menu_1311_DEVOLUCAO_1 = false;
				if (tableConfig.StaticFilters["filter_GQT_Menu_1311_DEVOLUCAO"] != null)
					filter_GQT_Menu_1311_DEVOLUCAO_1 = tableConfig.StaticFilters["filter_GQT_Menu_1311_DEVOLUCAO"].Contains("1");
				else if (tableConfig.StaticFilters["filter_GQT_Menu_1311_DEVOLUCAO"] == null)
				...
				if (tableConfig.StaticFilters["filter_GQT_Menu_1311_DEVOLUCAO"] != null)
					filter_GQT_Menu_1311_DEVOLUCAO_2 = tableConfig.StaticFilters["filter_GQT_Menu_1311_DEVOLUCAO"].Contains("2");
				...
				if (tableConfig.StaticFilters["filter_GQT_Menu_1311_DEVOLUCAO"] != null)
					filter_GQT_Menu_1311_DEVOLUCAO_3 = tableConfig.StaticFilters["filter_GQT_Menu_1311_DEVOLUCAO"].Contains("3");
...
// USE /[MANUAL GQT OVERRQLIST 1311]/
					...
					ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, false, gqt_menu_1311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1311", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_1311_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_1311_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
