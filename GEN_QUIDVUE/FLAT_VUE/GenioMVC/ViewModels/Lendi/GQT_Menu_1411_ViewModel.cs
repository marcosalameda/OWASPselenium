...
{
	public class GQT_Menu_1411_ViewModel : MenuListViewModel<Models.Lendi>
	{
		/// <summary>
		...
		public override string Uuid => "918a2ea7-9eb6-4228-98f9-4bb4c1bc9bca";
...
// USE /[MANUAL GQT LIST_LIMITS 1411]/
		...
		public GQT_Menu_1411_ViewModel() : base(null!) { }
		...
		public GQT_Menu_1411_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ 1411]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlendi>(m_userContext, false, ref gqt_menu_1411Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1411", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 1411]/
				...
				ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, distinct, gqt_menu_1411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_1411_RowViewModel> Elements = [];
			int i = 0;
