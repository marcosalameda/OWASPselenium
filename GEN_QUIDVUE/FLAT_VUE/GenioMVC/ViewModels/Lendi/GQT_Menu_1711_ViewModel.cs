...
// USE /[MANUAL GQT OVERRQ 1711]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlendi>(m_userContext, false, ref gqt_menu_1711Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1711", true, firstVisibleColumn: firstVisibleColumn);
