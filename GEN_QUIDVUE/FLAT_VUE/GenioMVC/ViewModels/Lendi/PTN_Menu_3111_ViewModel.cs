...
// USE /[MANUAL PTN OVERRQ 3111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlendi>(m_userContext, false, ref ptn_menu_3111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3111", true, firstVisibleColumn: firstVisibleColumn);
