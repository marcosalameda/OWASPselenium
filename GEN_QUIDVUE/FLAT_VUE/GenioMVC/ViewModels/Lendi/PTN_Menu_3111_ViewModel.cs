...
namespace GenioMVC.ViewModels.Lendi
{
	public class PTN_Menu_3111_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_3111Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML3111");
			ptn_menu_3111Conds.Equal(CSGenioAlendi.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ 3111]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_3111Conds, listing);
...
// USE /[MANUAL PTN OVERRQLIST 3111]/
					...
					ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, false, ptn_menu_3111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<PTN_Menu_3111_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_3111_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
