...
{
	public class PTN_Menu_3121_ViewModel : MenuListViewModel<Models.Lendi>
	{
		/// <summary>
		...
		public override string Uuid => "8231c2ef-5d7e-44f4-958f-e2469c90c9f7";
...
// USE /[MANUAL PTN LIST_LIMITS 3121]/
		...
		public PTN_Menu_3121_ViewModel() : base(null!) { }
		...
		public PTN_Menu_3121_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 3121]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlendi>(m_userContext, false, ref ptn_menu_3121Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3121", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3121]/
				...
				ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, distinct, ptn_menu_3121Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3121", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_3121_RowViewModel> Elements = [];
			int i = 0;
