...
public class PTN_Menu_LIST_DM_MB_R_RowViewModel : Models.Lendi
{
	#region Constructors

	public PTN_Menu_LIST_DM_MB_R_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_LIST_DM_MB_R_RowViewModel(UserContext userContext, CSGenioAlendi val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
