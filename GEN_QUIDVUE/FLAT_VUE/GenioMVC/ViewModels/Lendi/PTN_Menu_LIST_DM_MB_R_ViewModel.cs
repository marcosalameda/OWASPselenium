...
// USE /[MANUAL PTN OVERRQLIST LIST_DM_MB_R]/
					...
					ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, false, ptn_menu_list_dm_mb_rConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DM_MB_R", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
