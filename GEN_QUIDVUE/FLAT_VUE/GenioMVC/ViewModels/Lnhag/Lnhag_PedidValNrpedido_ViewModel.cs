...
// USE /[MANUAL GQT OVERRQ LNHAG_PEDIDNRPEDIDO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApedid>(m_userContext, false, ref lnhag___pedidnrpedidoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHAG___PEDIDNRPEDIDO", true, firstVisibleColumn: firstVisibleColumn);
