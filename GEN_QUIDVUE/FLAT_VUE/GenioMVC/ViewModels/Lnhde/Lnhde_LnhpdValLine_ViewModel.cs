...
// USE /[MANUAL GQT OVERRQLIST LNHDE_LNHPDLINE]/
		...
		{
			var Elements = new List<Lnhde_LnhpdValLine_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Lnhde_LnhpdValLine_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM LNHDE_LNHPDVALLINE]/
		...
		[
			"Lnhpd", "Lnhpd.ValCodlnhpd", "Lnhpd.ValZzstate", "Lnhpd.ValLine", "Lnhpd.ValCodpedid", "Lnhpd.ValCodtpequ", "BtnPermission"
		];
