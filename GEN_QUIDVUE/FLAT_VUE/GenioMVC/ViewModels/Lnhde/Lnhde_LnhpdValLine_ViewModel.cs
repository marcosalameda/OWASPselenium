...
namespace GenioMVC.ViewModels.Lnhde
{
	public class Lnhde_LnhpdValLine_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Lnhde_LnhpdValLine", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlnhpd.FldCodlnhpd, CSGenioAlnhpd.FldZzstate, CSGenioAlnhpd.FldLine };
			...
			lnhde___lnhpdline____Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST LNHDE_LNHPDLINE]/
				...
				ListingMVC<CSGenioAlnhpd> listing = Models.ModelBase.Where<CSGenioAlnhpd>(m_userContext, false, lnhde___lnhpdline____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHDE___LNHPDLINE____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
