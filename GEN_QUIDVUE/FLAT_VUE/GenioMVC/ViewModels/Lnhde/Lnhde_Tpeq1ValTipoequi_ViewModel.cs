...
// USE /[MANUAL GQT OVERRQLIST LNHDE_TPEQ1TIPOEQUI]/
		...
		{
			var Elements = new List<Lnhde_Tpeq1ValTipoequi_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Lnhde_Tpeq1ValTipoequi_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM LNHDE_TPEQ1VALTIPOEQUI]/
		...
		[
			"Tpeq1", "Tpeq1.ValCodtpequ", "Tpeq1.ValZzstate", "Tpeq1.ValTpequcod", "Tpeq1.ValTipoequi", "Tpeq1.ValCodfamil", "BtnPermission"
		];
