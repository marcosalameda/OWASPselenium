...
public class Lnhde_ValLnprops_RowViewModel : Models.Lnhdf
{
	#region Constructors

	public Lnhde_ValLnprops_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Lnhde_ValLnprops_RowViewModel(UserContext userContext, CSGenioAlnhdf val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
