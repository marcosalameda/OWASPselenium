...
public class Lnhpd_PedidValNrpedido_RowViewModel : Models.Pedid
{
	#region Constructors

	public Lnhpd_PedidValNrpedido_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Lnhpd_PedidValNrpedido_RowViewModel(UserContext userContext, CSGenioApedid val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
