...
// USE /[MANUAL GQT OVERRQ LNHPD_PEDIDNRPEDIDO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApedid>(m_userContext, false, ref lnhpd___pedidnrpedidoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHPD___PEDIDNRPEDIDO", true, firstVisibleColumn: firstVisibleColumn);
