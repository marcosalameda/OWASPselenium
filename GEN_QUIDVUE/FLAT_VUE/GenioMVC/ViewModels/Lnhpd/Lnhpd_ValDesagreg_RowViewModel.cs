...
public class Lnhpd_ValDesagreg_RowViewModel : Models.Lnhde
{
	#region Constructors

	public Lnhpd_ValDesagreg_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Lnhpd_ValDesagreg_RowViewModel(UserContext userContext, CSGenioAlnhde val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
