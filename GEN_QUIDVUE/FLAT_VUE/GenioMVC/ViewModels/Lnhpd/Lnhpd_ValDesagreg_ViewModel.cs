...
FieldRef[] fields = new FieldRef[] { CSGenioAlnhde.FldCodlnhde, CSGenioAlnhde.FldZzstate, CSGenioAlnhde.FldOrdem, CSGenioAlnhde.FldCodtpequ, CSGenioAtpeq1.FldCodtpequ, CSGenioAtpeq1.FldTipoequi, CSGenioAlnhde.FldQuantida, CSGenioAlnhde.FldDescript, CSGenioAlnhde.FldCode, CSGenioAlnhde.FldUrl };
			...
			lnhpd___pseuddesagregConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST LNHPD_PSEUDDESAGREG]/
				...
				ListingMVC<CSGenioAlnhde> listing = Models.ModelBase.Where<CSGenioAlnhde>(m_userContext, false, lnhpd___pseuddesagregConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHPD___PSEUDDESAGREG", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
