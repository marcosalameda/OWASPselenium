...
// USE /[MANUAL GQT OVERRQ LNHPD_PSEUDDESAGREG]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlnhde>(m_userContext, false, ref lnhpd___pseuddesagregConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHPD___PSEUDDESAGREG", true, firstVisibleColumn: firstVisibleColumn);
