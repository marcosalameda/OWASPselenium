...
// USE /[MANUAL GQT OVERRQLIST LNHPD_PSEUDDESCONJU]/
					...
					ListingMVC<CSGenioAtpequ> listing = Models.ModelBase.Where<CSGenioAtpequ>(m_userContext, false, lnhpd___pseuddesconjuConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHPD___PSEUDDESCONJU", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Lnhpd_ValDesconju_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Lnhpd_ValDesconju_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
