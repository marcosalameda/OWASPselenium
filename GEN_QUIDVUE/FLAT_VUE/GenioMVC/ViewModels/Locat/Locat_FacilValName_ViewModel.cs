...
// USE /[MANUAL GQT OVERRQLIST LOCAT_FACILNAME]/
		...
		{
			var Elements = new List<Locat_FacilValName_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Locat_FacilValName_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM LOCAT_FACILVALNAME]/
		...
		[
			"Facil", "Facil.ValCodfacil", "Facil.ValZzstate", "Facil.ValName", "Facil.ValCodcntry", "Facil.ValCodentit", "Facil.ValCodfacty", "BtnPermission"
		];
