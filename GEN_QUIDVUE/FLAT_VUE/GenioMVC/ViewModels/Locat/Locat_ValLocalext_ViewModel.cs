...
namespace GenioMVC.ViewModels.Locat
{
	public class Locat_ValLocalext_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValLocalext", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlcext.FldCodlcext, CSGenioAlcext.FldZzstate, CSGenioAlcext.FldGlnext, CSGenioAlcext.FldSpacetyp, CSGenioAlcext.FldSpaceobs };
			...
			conditions.SubSets.Add(locat___pseudlocalextConds);
			locat___pseudlocalextConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ LOCAT_PSEUDLOCALEXT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAlcext>(m_userContext, false, locat___pseudlocalextConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LOCAT___PSEUDLOCALEXT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST LOCAT_PSEUDLOCALEXT]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAlcext.GetInformation(), QMVC_POS_RECORD, sorts, locat___pseudlocalextConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAlcext> listing = Models.ModelBase.Where<CSGenioAlcext>(m_userContext, false, locat___pseudlocalextConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LOCAT___PSEUDLOCALEXT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
