...
// USE /[MANUAL GQT OVERRQ MANUA_KINDEDESIGNAT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAkinde>(m_userContext, false, ref manua___kindedesignatConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_MANUA___KINDEDESIGNAT", true, firstVisibleColumn: firstVisibleColumn);
