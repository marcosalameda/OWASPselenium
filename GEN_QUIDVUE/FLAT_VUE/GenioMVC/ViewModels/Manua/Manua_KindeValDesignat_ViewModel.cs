...
namespace GenioMVC.ViewModels.Manua
{
	public class Manua_KindeValDesignat_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Manua_KindeValDesignat", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAkinde.FldCodkinde, CSGenioAkinde.FldZzstate, CSGenioAkinde.FldDesignat };
			...
			conditions.SubSets.Add(manua___kindedesignatConds);
			manua___kindedesignatConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ MANUA_DESIGNAT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAkinde>(m_userContext, false, manua___kindedesignatConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_MANUA___KINDEDESIGNAT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST MANUA_DESIGNAT]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAkinde.GetInformation(), QMVC_POS_RECORD, sorts, manua___kindedesignatConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAkinde> listing = Models.ModelBase.Where<CSGenioAkinde>(m_userContext, false, manua___kindedesignatConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_MANUA___KINDEDESIGNAT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
