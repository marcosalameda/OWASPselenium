...
// USE /[MANUAL GQT VIEWMODEL_NEW MOVIM]/
		...
		public override CrudViewModelValidationResult Validate()
		{
			...
			validator.Required("ValDhmudanc", Resources.Resources.CHANGE36355, ValDhmudanc);
...
// USE /[MANUAL GQT VIEWMODEL_SAVE MOVIM]/
		public override void Save()
		{
			...
			try { Model = Models.Movim.Find(Navigation.GetStrValue("movim"), m_userContext, "FMOVIM"); }
			finally { if (Model == null) Model = new Models.Movim(m_userContext) { Identifier = "FMOVIM" }; }
