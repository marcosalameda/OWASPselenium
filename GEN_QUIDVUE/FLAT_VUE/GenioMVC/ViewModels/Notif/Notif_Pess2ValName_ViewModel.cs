...
namespace GenioMVC.ViewModels.Notif
{
	public class Notif_Pess2ValName_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Notif_Pess2ValName", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioApess2.FldCodpesso, CSGenioApess2.FldZzstate, CSGenioApess2.FldName };
			...
			notif___pess2name____Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST NOTIF_PESS2NAME]/
				...
				ListingMVC<CSGenioApess2> listing = Models.ModelBase.Where<CSGenioApess2>(m_userContext, false, notif___pess2name____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_NOTIF___PESS2NAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
