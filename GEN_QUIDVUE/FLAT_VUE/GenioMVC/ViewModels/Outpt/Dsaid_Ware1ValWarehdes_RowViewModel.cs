...
public class Dsaid_Ware1ValWarehdes_RowViewModel : Models.Ware1
{
	#region Constructors

	public Dsaid_Ware1ValWarehdes_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Dsaid_Ware1ValWarehdes_RowViewModel(UserContext userContext, CSGenioAware1 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
