...
public class GQT_Menu_411_RowViewModel : Models.Outpt
{
	#region Constructors

	public GQT_Menu_411_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public GQT_Menu_411_RowViewModel(UserContext userContext, CSGenioAoutpt val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
