...
namespace GenioMVC.ViewModels.Outpt
{
	public class GQT_Menu_411_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_411Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML411");
			gqt_menu_411Conds.Equal(CSGenioAoutpt.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 411]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_411Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 411]/
					...
					ListingMVC<CSGenioAoutpt> listing = Models.ModelBase.Where<CSGenioAoutpt>(m_userContext, false, gqt_menu_411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_411_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_411_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
