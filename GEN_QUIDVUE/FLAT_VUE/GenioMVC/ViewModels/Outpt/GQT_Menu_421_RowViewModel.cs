...
public class GQT_Menu_421_RowViewModel : Models.Outpt
{
	#region Constructors

	public GQT_Menu_421_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_421_RowViewModel(UserContext userContext, CSGenioAoutpt val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
