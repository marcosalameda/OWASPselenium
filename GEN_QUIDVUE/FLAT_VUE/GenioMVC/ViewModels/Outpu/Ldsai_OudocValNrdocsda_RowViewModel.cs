...
public class Ldsai_OudocValNrdocsda_RowViewModel : Models.Oudoc
{
	#region Constructors

	public Ldsai_OudocValNrdocsda_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Ldsai_OudocValNrdocsda_RowViewModel(UserContext userContext, CSGenioAoudoc val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
