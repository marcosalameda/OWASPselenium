...
namespace GenioMVC.ViewModels.Outpu
{
	public class Ldsai_OudocValNrdocsda_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Ldsai_OudocValNrdocsda", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAoudoc.FldCoddocsd, CSGenioAoudoc.FldZzstate, CSGenioAoudoc.FldNrdocsda, CSGenioAoudoc.FldDtdocsda, CSGenioAoudoc.FldTitle };
			...
			ldsai___oudocnrdocsdaConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ LDSAI_OUDOCNRDOCSDA]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAoudoc>(m_userContext, false, ldsai___oudocnrdocsdaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LDSAI___OUDOCNRDOCSDA", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST LDSAI_OUDOCNRDOCSDA]/
				...
				ListingMVC<CSGenioAoudoc> listing = Models.ModelBase.Where<CSGenioAoudoc>(m_userContext, false, ldsai___oudocnrdocsdaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LDSAI___OUDOCNRDOCSDA", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Oudoc(m_userContext, true, _fieldsToSerialize);
		...
		private void SetDocumentFields(ListingMVC<CSGenioAoudoc> listing)
		{
			...
			foreach (CSGenioAoudoc row in listing.Rows)
			{
			}
		}
