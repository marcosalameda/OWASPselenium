...
// USE /[MANUAL GQT OVERRQ PARAM_KINDEDESIGNAT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAkinde>(m_userContext, false, ref param___kindedesignatConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PARAM___KINDEDESIGNAT", true, firstVisibleColumn: firstVisibleColumn);
