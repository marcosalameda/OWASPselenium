...
namespace GenioMVC.ViewModels.Pedid
{
	public class Pedid_ValAgrupame_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValAgrupame", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlnhag.FldCodlnhag, CSGenioAlnhag.FldZzstate, CSGenioAlnhag.FldCodtpequ, CSGenioAtpeq1.FldCodtpequ, CSGenioAtpeq1.FldTipoequi, CSGenioAlnhag.FldQtdtpequ };
			...
			pedid___pseudagrupameConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PEDID_PSEUDAGRUPAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAlnhag>(m_userContext, false, pedid___pseudagrupameConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PEDID___PSEUDAGRUPAME", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PEDID_PSEUDAGRUPAME]/
				...
				ListingMVC<CSGenioAlnhag> listing = Models.ModelBase.Where<CSGenioAlnhag>(m_userContext, false, pedid___pseudagrupameConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PEDID___PSEUDAGRUPAME", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Lnhag(m_userContext, true, _fieldsToSerialize);
