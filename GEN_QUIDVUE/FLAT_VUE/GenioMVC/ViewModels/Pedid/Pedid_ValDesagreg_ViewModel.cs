...
{
	public class Pedid_ValDesagreg_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Pedid_ValDesagreg"; }
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValDesagreg", ref numberListItems);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAlnhde> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Pedid_ValDesagreg", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Pedid_ValDesagreg"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Pedid_ValDesagreg");
...
FieldRef[] fields = new FieldRef[] { CSGenioAlnhde.FldCodlnhde, CSGenioAlnhde.FldZzstate, CSGenioAlnhde.FldOrdem, CSGenioAlnhde.FldCodtpequ, CSGenioAtpeq1.FldCodtpequ, CSGenioAtpeq1.FldTipoequi, CSGenioAlnhde.FldQuantida };
			...
			pedid___pseuddesagregConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PEDID_PSEUDDESAGREG]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAlnhde>(m_userContext, false, pedid___pseuddesagregConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PEDID___PSEUDDESAGREG", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PEDID_PSEUDDESAGREG]/
				...
				ListingMVC<CSGenioAlnhde> listing = Models.ModelBase.Where<CSGenioAlnhde>(m_userContext, false, pedid___pseuddesagregConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PEDID___PSEUDDESAGREG", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		private Models.Lnhde MapPedid_ValDesagreg(CSGenioAlnhde row)
		{
			var model = new Models.Lnhde(m_userContext, true, _fieldsToSerialize);
		...
		private void SetDocumentFields(ListingMVC<CSGenioAlnhde> listing)
		{
			...
			foreach (CSGenioAlnhde row in listing.Rows)
			{
			}
		}
