...
// USE /[MANUAL GQT VIEWMODEL_SAVE PEDID]/
		public override void Save()
		{
			...
			try { Model = Models.Pedid.Find(Navigation.GetStrValue("pedid"), m_userContext, "FPEDID"); }
			finally { if (Model == null) Model = new Models.Pedid(m_userContext) { Identifier = "FPEDID" }; }
