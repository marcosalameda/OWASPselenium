...
FieldRef[] fields = new FieldRef[] { CSGenioAperso.FldCodperso, CSGenioAperso.FldZzstate, CSGenioAperso.FldName, CSGenioAperso.FldGender, CSGenioAperso.FldIdentifi, CSGenioAperso.FldPhoto, CSGenioAperso.FldDob, CSGenioAperso.FldEmail, CSGenioAperso.FldYear, CSGenioAperso.FldMonth, CSGenioAperso.FldTob };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "WMS_Menu_43211", ref numberListItems);
			...
			if (!Navigation.CheckKey("perso.gender"))
				return null;
			crs.Equal(CSGenioAperso.FldGender, Navigation.GetValue("limitKey"));
...
FieldRef[] fields = new FieldRef[] { CSGenioAperso.FldCodperso, CSGenioAperso.FldZzstate, CSGenioAperso.FldName, CSGenioAperso.FldGender, CSGenioAperso.FldIdentifi, CSGenioAperso.FldPhoto, CSGenioAperso.FldDob, CSGenioAperso.FldEmail, CSGenioAperso.FldYear, CSGenioAperso.FldMonth, CSGenioAperso.FldTob };
			...
			wms_menu_43211Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQLIST 43211]/
				...
				ListingMVC<CSGenioAperso> listing = Models.ModelBase.Where<CSGenioAperso>(m_userContext, false, wms_menu_43211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML43211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_43211]/
		...
		private static readonly List<TableSearchColumn> _searchableColumns = new List<TableSearchColumn>
		{
			...
			new TableSearchColumn("ValMonth", CSGenioAperso.FldMonth, typeof(double), visible : false, array : "Months"),
