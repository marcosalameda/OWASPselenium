...
// USE /[MANUAL WMS OVERRQ 43211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAperso>(m_userContext, false, ref wms_menu_43211Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML43211", true, firstVisibleColumn: firstVisibleColumn);
