...
{
	public class PTN_Menu_511_ViewModel : MenuListViewModel<Models.Pess1>
	{
		/// <summary>
		...
		public override string Uuid => "1f270728-876d-4479-8410-6d28a97b770a";
...
// USE /[MANUAL PTN LIST_LIMITS 511]/
		...
		public PTN_Menu_511_ViewModel() : base(null!) { }
		...
		public PTN_Menu_511_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 511]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApess1>(m_userContext, false, ref ptn_menu_511Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 511]/
		...
		{
			List<PTN_Menu_511_RowViewModel> Elements = [];
			int i = 0;
