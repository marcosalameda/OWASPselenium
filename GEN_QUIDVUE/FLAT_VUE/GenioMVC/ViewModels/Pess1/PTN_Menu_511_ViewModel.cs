...
namespace GenioMVC.ViewModels.Pess1
{
	public class PTN_Menu_511_ViewModel : ListViewModel
	{
		...
		public TablePartial<PTN_Menu_511_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_511Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML511");
			ptn_menu_511Conds.Equal(CSGenioApess1.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ 511]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_511Conds, listing);
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<PTN_Menu_511_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApess1> Qlisting, ref CriteriaSet conditions)
		{
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				ptn_menu_511Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ 511]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApess1>(m_userContext, false, ptn_menu_511Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 511]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApess1.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_511Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
		...
		private List<PTN_Menu_511_RowViewModel> MapPTN_Menu_511(ListingMVC<CSGenioApess1> Qlisting)
		{
			var Elements = new List<PTN_Menu_511_RowViewModel>();
			int i = 0;
		...
		/// to a PTN_Menu_511_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_511_RowViewModel MapPTN_Menu_511(CSGenioApess1 row)
		{
			var model = new PTN_Menu_511_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_511_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
