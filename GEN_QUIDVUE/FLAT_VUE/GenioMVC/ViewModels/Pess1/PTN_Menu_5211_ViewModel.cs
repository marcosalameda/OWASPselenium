...
{
	public class PTN_Menu_5211_ViewModel : MenuListViewModel<Models.Pess1>
	{
		/// <summary>
		...
		public override string Uuid => "c7f12669-5f27-4535-8fe3-5bbc959c61a9";
...
// USE /[MANUAL PTN LIST_LIMITS 5211]/
		...
		public PTN_Menu_5211_ViewModel() : base(null!) { }
		...
		public PTN_Menu_5211_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 5211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApess1>(m_userContext, false, ref ptn_menu_5211Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5211", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 5211]/
				...
				ListingMVC<CSGenioApess1> listing = Models.ModelBase.Where<CSGenioApess1>(m_userContext, distinct, ptn_menu_5211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_5211_RowViewModel> Elements = [];
			int i = 0;
