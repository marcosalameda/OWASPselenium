...
{
	public class PTN_Menu_5231_ViewModel : ListViewModel
	{
		/// <summary>
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_5231Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML5231");
			ptn_menu_5231Conds.Equal(CSGenioApess1.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ 5231]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_5231Conds, listing);
...
// USE /[MANUAL PTN OVERRQLIST 5231]/
		...
		{
			var Elements = new List<PTN_Menu_5231_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_5231_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
