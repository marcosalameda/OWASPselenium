...
namespace GenioMVC.ViewModels.Pess1
{
	public class Pess1_StakeValDesignat_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Pess1_StakeValDesignat", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAstake.FldCodparte, CSGenioAstake.FldZzstate, CSGenioAstake.FldDesignat };
			...
			pess1___stakedesignatConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PESS1_STAKEDESIGNAT]/
				...
				ListingMVC<CSGenioAstake> listing = Models.ModelBase.Where<CSGenioAstake>(m_userContext, false, pess1___stakedesignatConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESS1___STAKEDESIGNAT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Stake(m_userContext, true, _fieldsToSerialize);
