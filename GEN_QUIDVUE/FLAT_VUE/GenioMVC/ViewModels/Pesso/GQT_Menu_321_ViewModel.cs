...
namespace GenioMVC.ViewModels.Pesso
{
	public class GQT_Menu_321_ViewModel : ListViewModel
	{
		...
		public TablePartial<GQT_Menu_321_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_321Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML321");
			gqt_menu_321Conds.Equal(CSGenioApesso.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 321]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_321Conds, listing);
		...
		public GQT_Menu_321_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_321_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApesso> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet gqt_menu_321Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				conditions.SubSets.Add(gqt_menu_321Conds);
				gqt_menu_321Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 321]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, gqt_menu_321Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML321", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 321]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApesso.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_321Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, gqt_menu_321Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML321", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<GQT_Menu_321_RowViewModel> MapGQT_Menu_321(ListingMVC<CSGenioApesso> Qlisting)
		{
			var Elements = new List<GQT_Menu_321_RowViewModel>();
			int i = 0;
		...
		/// to a GQT_Menu_321_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_321_RowViewModel MapGQT_Menu_321(CSGenioApesso row)
		{
			var model = new GQT_Menu_321_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_321_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
