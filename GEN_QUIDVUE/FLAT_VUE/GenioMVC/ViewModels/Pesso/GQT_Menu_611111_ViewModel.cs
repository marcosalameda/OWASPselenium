...
{
	public class GQT_Menu_611111_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		public override string Uuid => "f2eb64d6-f528-4f16-8111-582d7e7a5d73";
...
// USE /[MANUAL GQT LIST_LIMITS 611111]/
		...
		public GQT_Menu_611111_ViewModel() : base(null!) { }
		...
		public GQT_Menu_611111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ 611111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref gqt_menu_611111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML611111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 611111]/
				...
				ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, distinct, gqt_menu_611111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML611111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_611111_RowViewModel> Elements = [];
			int i = 0;
