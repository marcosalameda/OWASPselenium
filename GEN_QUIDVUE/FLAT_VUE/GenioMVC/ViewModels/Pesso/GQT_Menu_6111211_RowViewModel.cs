...
public class GQT_Menu_6111211_RowViewModel : Models.Pesso
{
	#region Constructors

	public GQT_Menu_6111211_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_6111211_RowViewModel(UserContext userContext, CSGenioApesso val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
