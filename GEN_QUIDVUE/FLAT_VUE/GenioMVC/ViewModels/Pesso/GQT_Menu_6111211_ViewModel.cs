...
{
	public class GQT_Menu_6111211_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		public override string Uuid => "0216aa9a-1896-4701-8367-c179b9589e96";
...
// USE /[MANUAL GQT LIST_LIMITS 6111211]/
		...
		public GQT_Menu_6111211_ViewModel() : base(null!) { }
		...
		public GQT_Menu_6111211_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ 6111211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref gqt_menu_6111211Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6111211", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 6111211]/
				...
				ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, distinct, gqt_menu_6111211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6111211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_6111211_RowViewModel> Elements = [];
			int i = 0;
