...
namespace GenioMVC.ViewModels.Pesso
{
	public class GQT_Menu_6111211_ViewModel : ListViewModel
	{
		...
		public TablePartial<GQT_Menu_6111211_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_6111211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML6111211");
			gqt_menu_6111211Conds.Equal(CSGenioApesso.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						gqt_menu_6111211Conds.Equal(CSGenioApesso.FldGender, "M");
...
// USE /[MANUAL GQT OVERRQ 6111211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_6111211Conds, listing);
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_6111211_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApesso> Qlisting, ref CriteriaSet conditions)
		{
			...
			//1st Area Value: "M"
			{
				...
				gqt_menu_6111211Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST 6111211]/
					...
					ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, gqt_menu_6111211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6111211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<GQT_Menu_6111211_RowViewModel> MapGQT_Menu_6111211(ListingMVC<CSGenioApesso> Qlisting)
		{
			var Elements = new List<GQT_Menu_6111211_RowViewModel>();
			int i = 0;
		...
		/// to a GQT_Menu_6111211_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_6111211_RowViewModel MapGQT_Menu_6111211(CSGenioApesso row)
		{
			var model = new GQT_Menu_6111211_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_6111211_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_6111211]/
		...
		[
			"Pesso", "Pesso.ValCodpesso", "Pesso.ValZzstate", "Pesso.ValName", "Pesso.ValGender", "Pesso.ValDtnascim", "Pesso.ValTelephon", "Pesso.ValEmail", "Pesso.ValPhotogra", "Pesso.ValIdfuncio", "Cmpny", "Cmpny.ValDesignat", "Pesso.ValCodempre", "Cmpny.ValCodempre", "Pesso.ValCodcateg", "Pesso.ValCodpaise", "Pesso.ValCodcntry", "Pesso.ValCodregia", "BtnPermission"
		];
