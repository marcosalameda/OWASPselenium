...
namespace GenioMVC.ViewModels.Pesso
{
	public class GQT_Menu_6111311_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_6111311Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML6111311");
			gqt_menu_6111311Conds.Equal(CSGenioApesso.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						gqt_menu_6111311Conds.Equal(CSGenioApesso.FldGender, "F");
...
// USE /[MANUAL GQT OVERRQ 6111311]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_6111311Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 6111311]/
					...
					ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, gqt_menu_6111311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6111311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_6111311_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_6111311_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
