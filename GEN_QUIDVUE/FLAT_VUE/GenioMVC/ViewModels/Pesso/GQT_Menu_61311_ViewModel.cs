...
{
	public class GQT_Menu_61311_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		public override string Uuid => "43b74fc0-f043-4186-85a5-b0b0e481fb34";
...
// USE /[MANUAL GQT LIST_LIMITS 61311]/
		...
		public GQT_Menu_61311_ViewModel() : base(null!) { }
		...
		public GQT_Menu_61311_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ 61311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref gqt_menu_61311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61311", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 61311]/
				...
				ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, distinct, gqt_menu_61311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_61311_RowViewModel> Elements = [];
			int i = 0;
