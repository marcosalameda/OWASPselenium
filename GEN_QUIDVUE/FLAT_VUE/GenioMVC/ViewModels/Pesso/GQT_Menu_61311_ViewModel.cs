...
{
	public class GQT_Menu_61311_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<GQT_Menu_61311_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid { get => "43b74fc0-f043-4186-85a5-b0b0e481fb34"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_61311Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML61311");
			gqt_menu_61311Conds.Equal(CSGenioApesso.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						gqt_menu_61311Conds.Equal(CSGenioApesso.FldGender, "F");


// USE /[MANUAL GQT OVERRQ 61311]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_61311Conds, listing);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GQT_Menu_61311_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public GQT_Menu_61311_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_61311_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Pesso.AddEPH<CSGenioApesso>(ref u, crs, "ML61311");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Pesso.AddEPH<CSGenioApesso>(ref u, null, "ML61311"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApesso> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet gqt_menu_61311Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML61311");
			...
			//1st Area Value: "F"
			{
				...
				conditions.SubSets.Add(gqt_menu_61311Conds);
				gqt_menu_61311Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 61311]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, gqt_menu_61311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61311", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP 61311]/
				...
				if (tableReload)
				{
// USE /[MANUAL GQT OVERRQLIST 61311]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApesso.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_61311Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, gqt_menu_61311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapGQT_Menu_61311(listing);

					Menu.Identifier = "ML61311";
					Menu.Slots = new Dictionary<string, List<object>>();

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "ML61311";
		...
		private List<GQT_Menu_61311_RowViewModel> MapGQT_Menu_61311(ListingMVC<CSGenioApesso> Qlisting)
		{
			var Elements = new List<GQT_Menu_61311_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapGQT_Menu_61311(row));
					i++;
				}
			}
		...
		/// to a GQT_Menu_61311_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_61311_RowViewModel MapGQT_Menu_61311(CSGenioApesso row)
		{
			var model = new GQT_Menu_61311_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_61311_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_61311]/
		#endregion
