...
{
	public class Pesso1_CmpnyValDesignat_ViewModel : MenuListViewModel<Models.Cmpny>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Pesso1_CmpnyValDesignat";
...
// USE /[MANUAL GQT LIST_LIMITS PESSO1_CMPNYDESIGNAT]/
		...
		public Pesso1_CmpnyValDesignat_ViewModel() : base(null!) { }
		...
		public Pesso1_CmpnyValDesignat_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST PESSO1_CMPNYDESIGNAT]/
		...
		{
			List<Pesso1_CmpnyValDesignat_RowViewModel> Elements = [];
			int i = 0;
