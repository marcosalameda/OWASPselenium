...
namespace GenioMVC.ViewModels.Pesso
{
	public class Pesso1_CmpnyValDesignat_ViewModel : ListViewModel
	{
		...
		public TablePartial<Pesso1_CmpnyValDesignat_RowViewModel> Menu { get; set; }
...
// USE /[MANUAL GQT LIST_LIMITS PESSO1_CMPNYDESIGNAT]/
		...
		public Pesso1_CmpnyValDesignat_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Pesso1_CmpnyValDesignat_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcmpny> Qlisting, ref CriteriaSet conditions)
		{
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				conditions.SubSets.Add(pesso1__cmpnydesignatConds);
				pesso1__cmpnydesignatConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PESSO1_CMPNYDESIGNAT]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcmpny>(m_userContext, false, pesso1__cmpnydesignatConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__CMPNYDESIGNAT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PESSO1_CMPNYDESIGNAT]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcmpny.GetInformation(), QMVC_POS_RECORD, sorts, pesso1__cmpnydesignatConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAcmpny> listing = Models.ModelBase.Where<CSGenioAcmpny>(m_userContext, false, pesso1__cmpnydesignatConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__CMPNYDESIGNAT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Pesso1_CmpnyValDesignat_RowViewModel> MapPesso1_CmpnyValDesignat(ListingMVC<CSGenioAcmpny> Qlisting)
		{
			var Elements = new List<Pesso1_CmpnyValDesignat_RowViewModel>();
			int i = 0;
		...
		/// to a Pesso1_CmpnyValDesignat_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Pesso1_CmpnyValDesignat_RowViewModel MapPesso1_CmpnyValDesignat(CSGenioAcmpny row)
		{
			var model = new Pesso1_CmpnyValDesignat_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(Pesso1_CmpnyValDesignat_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
