...
public class Pesso1_Regi1ValRegiao_RowViewModel : Models.Regi1
{
	#region Constructors

	public Pesso1_Regi1ValRegiao_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Pesso1_Regi1ValRegiao_RowViewModel(UserContext userContext, CSGenioAregi1 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
