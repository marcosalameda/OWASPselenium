...
// USE /[MANUAL GQT OVERRQ PESSO1_PSEUDCONTACTO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAconta>(m_userContext, false, ref pesso1__pseudcontactoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__PSEUDCONTACTO", true, firstVisibleColumn: firstVisibleColumn);
