...
public class Pesso1_ValEvolucao_RowViewModel : Models.Evcat
{
	#region Constructors

	public Pesso1_ValEvolucao_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Pesso1_ValEvolucao_RowViewModel(UserContext userContext, CSGenioAevcat val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
