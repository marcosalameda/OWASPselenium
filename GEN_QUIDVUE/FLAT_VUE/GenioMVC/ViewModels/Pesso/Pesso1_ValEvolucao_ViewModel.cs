...
{
	public class Pesso1_ValEvolucao_ViewModel : MenuListViewModel<Models.Evcat>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Pesso1_ValEvolucao_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Pesso1_ValEvolucao";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS PESSO1_PSEUDEVOLUCAO]/
		...
		public Pesso1_ValEvolucao_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Pesso1_ValEvolucao_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Pesso1_ValEvolucao_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Pesso1_ValEvolucao_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Evcat.AddEPH<CSGenioAevcat>(ref u, crs, "IBL_PESSO1__PSEUDEVOLUCAO");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Evcat.AddEPH<CSGenioAevcat>(ref u, null, "IBL_PESSO1__PSEUDEVOLUCAO"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAevcat> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet pesso1__pseudevolucaoConds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "IBL_PESSO1__PSEUDEVOLUCAO");
			...
			conditions.SubSets.Add(pesso1__pseudevolucaoConds);
			pesso1__pseudevolucaoConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ PESSO1_PSEUDEVOLUCAO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAevcat>(m_userContext, false, ref pesso1__pseudevolucaoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__PSEUDEVOLUCAO", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLSTEXP PESSO1_PSEUDEVOLUCAO]/
			...
			if (tableReload)
			{
// USE /[MANUAL GQT OVERRQLIST PESSO1_PSEUDEVOLUCAO]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAevcat.GetInformation(), QMVC_POS_RECORD, sorts, pesso1__pseudevolucaoConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAevcat> listing = Models.ModelBase.Where<CSGenioAevcat>(m_userContext, distinct, pesso1__pseudevolucaoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__PSEUDEVOLUCAO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapPesso1_ValEvolucao(listing);

				Menu.Identifier = "IBL_PESSO1__PSEUDEVOLUCAO";

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "IBL_PESSO1__PSEUDEVOLUCAO";
		...
		{
			List<Pesso1_ValEvolucao_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPesso1_ValEvolucao(row));
					i++;
				}
			}
		...
		/// to a Pesso1_ValEvolucao_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Pesso1_ValEvolucao_RowViewModel MapPesso1_ValEvolucao(CSGenioAevcat row)
		{
			var model = new Pesso1_ValEvolucao_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PESSO1_VALEVOLUCAO]/
