...
namespace GenioMVC.ViewModels.Pesso
{
	public class Pesso1_ValEvolucao_ViewModel : ListViewModel
	{
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAevcat> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Pesso1_ValEvolucao", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Pesso1_ValEvolucao"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Pesso1_ValEvolucao");
...
FieldRef[] fields = new FieldRef[] { CSGenioAevcat.FldCodprogr, CSGenioAevcat.FldZzstate, CSGenioAevcat.FldSince, CSGenioAevcat.FldCodcateg, CSGenioAcate1.FldCodcateg, CSGenioAcate1.FldCategoria, CSGenioAevcat.FldFimperio, CSGenioAevcat.FldObservat };
			...
			pesso1__pseudevolucaoConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PESSO1_PSEUDEVOLUCAO]/
				...
				ListingMVC<CSGenioAevcat> listing = Models.ModelBase.Where<CSGenioAevcat>(m_userContext, false, pesso1__pseudevolucaoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__PSEUDEVOLUCAO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		private List<Models.Evcat> MapPesso1_ValEvolucao(ListingMVC<CSGenioAevcat> Qlisting)
		{
		...
		private Models.Evcat MapPesso1_ValEvolucao(CSGenioAevcat row)
		{
