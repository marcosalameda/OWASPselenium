...
// USE /[MANUAL GQT OVERRQLIST PESSO_CATEGCATEGORY]/
					...
					ListingMVC<CSGenioAcateg> listing = Models.ModelBase.Where<CSGenioAcateg>(m_userContext, false, pesso___categcategoryConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO___CATEGCATEGORY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Pesso_CategValCategoria_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Pesso_CategValCategoria_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PESSO_CATEGVALCATEGORIA]/
		...
		[
			"Categ", "Categ.ValCodcateg", "Categ.ValZzstate", "Categ.ValCategoria", "Categ.ValAbbreviation", "BtnPermission"
		];
