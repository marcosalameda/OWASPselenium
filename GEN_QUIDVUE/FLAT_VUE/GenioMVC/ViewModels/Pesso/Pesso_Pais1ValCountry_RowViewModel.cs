...
public class Pesso_Pais1ValCountry_RowViewModel : Models.Pais1
{
	#region Constructors

	public Pesso_Pais1ValCountry_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Pesso_Pais1ValCountry_RowViewModel(UserContext userContext, CSGenioApais1 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
