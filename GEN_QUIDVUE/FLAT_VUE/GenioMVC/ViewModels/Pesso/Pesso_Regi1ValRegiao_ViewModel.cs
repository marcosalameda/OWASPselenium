...
{
	public class Pesso_Regi1ValRegiao_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Pesso_Regi1ValRegiao"; }
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["Pesso_Regi1ValRegiao_tableFilters"] ?? "false"), false);
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Pesso_Regi1ValRegiao", ref numberListItems);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAregi1> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Pesso_Regi1ValRegiao", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Pesso_Regi1ValRegiao"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Pesso_Regi1ValRegiao");
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pPesso_Regi1ValRegiao"])) ? int.Parse(requestValues["pPesso_Regi1ValRegiao"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPesso_Regi1ValRegiao", "dPesso_Regi1ValRegiao", requestValues, "regi1", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAregi1.FldCodregia, CSGenioAregi1.FldZzstate, CSGenioAregi1.FldRegiao };
			...
			//Limit type: "A"			//Current Area = "REGI1"			//1st Area Limit: "PAIS1"			//1st Area Field: "CODCNTRY"			//1st Area Value: ""
			{
				Limit limit = new Limit();
			...
			pesso___regi1regiao__Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PESSO_REGI1REGIAO]/
				...
				ListingMVC<CSGenioAregi1> listing = Models.ModelBase.Where<CSGenioAregi1>(m_userContext, false, pesso___regi1regiao__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO___REGI1REGIAO__", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		private Models.Regi1 MapPesso_Regi1ValRegiao(CSGenioAregi1 row)
		{
			var model = new Models.Regi1(m_userContext, true, _fieldsToSerialize);
