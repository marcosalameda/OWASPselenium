...
public class Pesso_ValContacto_RowViewModel : Models.Conta
{
	#region Constructors

	public Pesso_ValContacto_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Pesso_ValContacto_RowViewModel(UserContext userContext, CSGenioAconta val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
