...
namespace GenioMVC.ViewModels.Pesso
{
	public class Pesso_ValEspecitl_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValEspecitl", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAesppe.FldCodesppe, CSGenioAesppe.FldZzstate, CSGenioAesppe.FldCodespec, CSGenioAspeci.FldCodespec, CSGenioAspeci.FldEspecial, CSGenioAspeci.FldAreatecn };
			...
			pesso___pseudespecitlConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PESSO_PSEUDESPECITL]/
				...
				ListingMVC<CSGenioAesppe> listing = Models.ModelBase.Where<CSGenioAesppe>(m_userContext, false, pesso___pseudespecitlConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO___PSEUDESPECITL", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Esppe(m_userContext, true, _fieldsToSerialize);
		...
		private void SetDocumentFields(ListingMVC<CSGenioAesppe> listing)
		{
			...
			foreach (CSGenioAesppe row in listing.Rows)
			{
			}
		}
