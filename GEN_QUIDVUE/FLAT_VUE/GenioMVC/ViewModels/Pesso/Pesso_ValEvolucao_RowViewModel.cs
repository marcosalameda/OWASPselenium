...
public class Pesso_ValEvolucao_RowViewModel : Models.Evcat
{
	#region Constructors

	public Pesso_ValEvolucao_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Pesso_ValEvolucao_RowViewModel(UserContext userContext, CSGenioAevcat val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
