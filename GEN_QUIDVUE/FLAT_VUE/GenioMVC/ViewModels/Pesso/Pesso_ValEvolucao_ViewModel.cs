...
namespace GenioMVC.ViewModels.Pesso
{
	public class Pesso_ValEvolucao_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValEvolucao", ref numberListItems);
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAevcat> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "Pesso_ValEvolucao", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "Pesso_ValEvolucao"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "Pesso_ValEvolucao");
...
FieldRef[] fields = new FieldRef[] { CSGenioAevcat.FldCodprogr, CSGenioAevcat.FldZzstate, CSGenioAevcat.FldSince, CSGenioAevcat.FldCodcateg, CSGenioAcate1.FldCodcateg, CSGenioAcate1.FldCategoria, CSGenioAevcat.FldFimperio, CSGenioAevcat.FldObservat };
			...
			pesso___pseudevolucaoConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PESSO_PSEUDEVOLUCAO]/
				...
				ListingMVC<CSGenioAevcat> listing = Models.ModelBase.Where<CSGenioAevcat>(m_userContext, false, pesso___pseudevolucaoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO___PSEUDEVOLUCAO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		private List<Models.Evcat> MapPesso_ValEvolucao(ListingMVC<CSGenioAevcat> Qlisting)
		{
		...
		private Models.Evcat MapPesso_ValEvolucao(CSGenioAevcat row)
		{
			var model = new Models.Evcat(m_userContext, true, _fieldsToSerialize);
