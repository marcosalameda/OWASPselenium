...
// USE /[MANUAL GQT OVERRQ PESSO_CATEGCATEGORY]/
				...
				*/
				...
				TableCategCategory.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Categ(m_userContext, r, true, _fieldsToSerialize_PESSO___CATEGCATEGORY));
...
// USE /[MANUAL GQT OVERRQ PESSO_PAIS1COUNTRY]/
				...
				*/
				...
				TablePais1Country.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Pais1(m_userContext, r, true, _fieldsToSerialize_PESSO___PAIS1COUNTRY_));
...
// USE /[MANUAL GQT OVERRQ PESSO_CMPNYDESIGNAT]/
				...
				*/
				...
				TableCmpnyDesignat.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Cmpny(m_userContext, r, true, _fieldsToSerialize_PESSO___CMPNYDESIGNAT));
...
// USE /[MANUAL GQT OVERRQ PESSO_REGI1REGIAO]/
				...
				*/
				...
				TableRegi1Regiao.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Regi1(m_userContext, r, true, _fieldsToSerialize_PESSO___REGI1REGIAO__));
