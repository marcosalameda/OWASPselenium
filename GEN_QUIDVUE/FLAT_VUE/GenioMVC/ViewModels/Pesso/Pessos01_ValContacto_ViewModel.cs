...
// USE /[MANUAL GQT OVERRQLIST PESSOS01_PSEUDCONTACTO]/
					...
					ListingMVC<CSGenioAconta> listing = Models.ModelBase.Where<CSGenioAconta>(m_userContext, false, pessos01pseudcontactoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSOS01PSEUDCONTACTO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Pessos01_ValContacto_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Pessos01_ValContacto_RowViewModel model)
		{
			bool canView = false;
			bool canEdit = true;
			bool canDelete = true;
