...
FieldRef[] fields = new FieldRef[] { CSGenioAevcat.FldCodprogr, CSGenioAevcat.FldZzstate, CSGenioAevcat.FldSince, CSGenioAevcat.FldCodcateg, CSGenioAcate1.FldCodcateg, CSGenioAcate1.FldCategoria, CSGenioAevcat.FldFimperio, CSGenioAevcat.FldObservat };
			...
			pessos01pseudevolucaoConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PESSOS01_PSEUDEVOLUCAO]/
				...
				ListingMVC<CSGenioAevcat> listing = Models.ModelBase.Where<CSGenioAevcat>(m_userContext, false, pessos01pseudevolucaoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSOS01PSEUDEVOLUCAO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
