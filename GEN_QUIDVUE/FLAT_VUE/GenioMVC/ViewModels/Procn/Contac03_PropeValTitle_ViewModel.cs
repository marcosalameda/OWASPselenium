...
{
	public class Contac03_PropeValTitle_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Contac03_PropeValTitle_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Contac03_PropeValTitle";
...
// USE /[MANUAL GQT LIST_LIMITS CONTAC03_PROPETITLE]/
		...
		public Contac03_PropeValTitle_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Contac03_PropeValTitle_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Contac03_PropeValTitle_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Contac03_PropeValTitle_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Prope.AddEPH<CSGenioAprope>(ref u, crs, "IBL_CONTAC03PROPETITLE___");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Prope.AddEPH<CSGenioAprope>(ref u, null, "IBL_CONTAC03PROPETITLE___"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAprope> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(contac03propetitle___Conds);
...
// USE /[MANUAL GQT OVERRQ CONTAC03_PROPETITLE]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref contac03propetitle___Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CONTAC03PROPETITLE___", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST CONTAC03_PROPETITLE]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAprope.GetInformation(), QMVC_POS_RECORD, sorts, contac03propetitle___Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, distinct, contac03propetitle___Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CONTAC03PROPETITLE___", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapContac03_PropeValTitle(listing);

				Menu.Identifier = "IBL_CONTAC03PROPETITLE___";

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "IBL_CONTAC03PROPETITLE___";
		...
		private List<Contac03_PropeValTitle_RowViewModel> MapContac03_PropeValTitle(ListingMVC<CSGenioAprope> Qlisting)
		{
			List<Contac03_PropeValTitle_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapContac03_PropeValTitle(row));
					i++;
				}
			}
		...
		/// to a Contac03_PropeValTitle_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Contac03_PropeValTitle_RowViewModel MapContac03_PropeValTitle(CSGenioAprope row)
		{
			var model = new Contac03_PropeValTitle_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM CONTAC03_PROPEVALTITLE]/
