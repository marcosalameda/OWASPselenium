...
{
	public class Contac03_PropeValTitle_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Contac03_PropeValTitle"; }
...
// USE /[MANUAL GQT OVERRQLIST CONTAC03_TITLE]/
		...
		{
			var Elements = new List<Contac03_PropeValTitle_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Contac03_PropeValTitle_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
