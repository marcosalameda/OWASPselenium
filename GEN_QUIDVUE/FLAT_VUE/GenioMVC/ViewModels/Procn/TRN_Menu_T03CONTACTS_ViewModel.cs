...
// USE /[MANUAL TRN OVERRQ T03CONTACTS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprocn>(m_userContext, false, ref trn_menu_t03contactsConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT03CONTACTS", true, firstVisibleColumn: firstVisibleColumn);
