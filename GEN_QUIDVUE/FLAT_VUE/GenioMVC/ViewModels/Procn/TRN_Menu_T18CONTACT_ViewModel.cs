...
{
	public class TRN_Menu_T18CONTACT_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "96a6c4cf-408f-4e64-bd93-a0675f994a73"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet trn_menu_t18contactConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT18CONTACT");
			trn_menu_t18contactConds.Equal(CSGenioAprocn.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL TRN OVERRQ T18CONTACT]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(trn_menu_t18contactConds, listing);
...
// USE /[MANUAL TRN OVERRQ T18CONTACT]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAprocn>(m_userContext, false, trn_menu_t18contactConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT18CONTACT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T18CONTACT]/
					...
					ListingMVC<CSGenioAprocn> listing = Models.ModelBase.Where<CSGenioAprocn>(m_userContext, false, trn_menu_t18contactConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT18CONTACT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<TRN_Menu_T18CONTACT_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T18CONTACT_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
