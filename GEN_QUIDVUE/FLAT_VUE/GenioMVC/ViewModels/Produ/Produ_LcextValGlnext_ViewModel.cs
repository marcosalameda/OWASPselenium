...
namespace GenioMVC.ViewModels.Produ
{
	public class Produ_LcextValGlnext_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Produ_LcextValGlnext", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlcext.FldCodlcext, CSGenioAlcext.FldZzstate, CSGenioAlcext.FldGlnext };
			...
			produ___lcextglnext__Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PRODU_GLNEXT]/
				...
				ListingMVC<CSGenioAlcext> listing = Models.ModelBase.Where<CSGenioAlcext>(m_userContext, false, produ___lcextglnext__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PRODU___LCEXTGLNEXT__", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
