...
// USE /[MANUAL GQT OVERRQ PRODU_PSEUDINPUTSRE]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArelin>(m_userContext, false, ref produ___pseudinputsreConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PRODU___PSEUDINPUTSRE", true, firstVisibleColumn: firstVisibleColumn);
