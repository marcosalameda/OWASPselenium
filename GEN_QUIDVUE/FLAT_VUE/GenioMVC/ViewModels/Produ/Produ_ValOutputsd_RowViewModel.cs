...
public class Produ_ValOutputsd_RowViewModel : Models.Dilin
{
	#region Constructors

	public Produ_ValOutputsd_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Produ_ValOutputsd_RowViewModel(UserContext userContext, CSGenioAdilin val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
