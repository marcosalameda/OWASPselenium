...
namespace GenioMVC.ViewModels.Produ
{
	public class Produ_ValOutputsd_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValOutputsd", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAdilin.FldCoddilin, CSGenioAdilin.FldZzstate, CSGenioAdilin.FldInstant, CSGenioAdilin.FldCoddispa, CSGenioAdispa.FldCoddispa, CSGenioAdispa.FldDispanr, CSGenioAentit.FldCodentit, CSGenioAentit.FldName, CSGenioAdilin.FldLinenumb, CSGenioAdilin.FldOrdered, CSGenioAdilin.FldDelivere, CSGenioAdilin.FldOutstand };
			...
			produ___pseudoutputsdConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PRODU_PSEUDOUTPUTSD]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAdilin>(m_userContext, false, produ___pseudoutputsdConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PRODU___PSEUDOUTPUTSD", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PRODU_PSEUDOUTPUTSD]/
				...
				ListingMVC<CSGenioAdilin> listing = Models.ModelBase.Where<CSGenioAdilin>(m_userContext, false, produ___pseudoutputsdConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PRODU___PSEUDOUTPUTSD", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Dilin(m_userContext, true, _fieldsToSerialize);
