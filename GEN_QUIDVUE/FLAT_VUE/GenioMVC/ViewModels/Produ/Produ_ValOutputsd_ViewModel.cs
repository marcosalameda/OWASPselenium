...
// USE /[MANUAL GQT OVERRQLIST PRODU_PSEUDOUTPUTSD]/
					...
					ListingMVC<CSGenioAdilin> listing = Models.ModelBase.Where<CSGenioAdilin>(m_userContext, false, produ___pseudoutputsdConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PRODU___PSEUDOUTPUTSD", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Produ_ValOutputsd_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Produ_ValOutputsd_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PRODU_VALOUTPUTSD]/
		...
		[
			"Dilin", "Dilin.ValCoddilin", "Dilin.ValZzstate", "Dilin.ValInstant", "Dispa", "Dispa.ValDispanr", "Entit", "Entit.ValName", "Dilin.ValLinenumb", "Dilin.ValOrdered", "Dilin.ValDelivere", "Dilin.ValOutstand", "Dilin.ValCoddispa", "Dilin.ValCodprodu", "BtnPermission"
		];
