...
namespace GenioMVC.ViewModels.Produ
{
	public class Produ_ValStockevo_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValStockevo", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAstock.FldCodstock, CSGenioAstock.FldZzstate, CSGenioAstock.FldSequence, CSGenioAstock.FldDate, CSGenioAstock.FldType, CSGenioAstock.FldReferenc, CSGenioAstock.FldQuantity, CSGenioAstock.FldBalance };
			...
			produ___pseudstockevoConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PRODU_PSEUDSTOCKEVO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAstock>(m_userContext, false, produ___pseudstockevoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PRODU___PSEUDSTOCKEVO", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PRODU_PSEUDSTOCKEVO]/
				...
				ListingMVC<CSGenioAstock> listing = Models.ModelBase.Where<CSGenioAstock>(m_userContext, false, produ___pseudstockevoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PRODU___PSEUDSTOCKEVO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Stock(m_userContext, true, _fieldsToSerialize);
