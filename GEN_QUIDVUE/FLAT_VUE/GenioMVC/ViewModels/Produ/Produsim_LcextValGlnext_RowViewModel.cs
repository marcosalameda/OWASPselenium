...
public class Produsim_LcextValGlnext_RowViewModel : Models.Lcext
{
	#region Constructors

	public Produsim_LcextValGlnext_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Produsim_LcextValGlnext_RowViewModel(UserContext userContext, CSGenioAlcext val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
