...
// USE /[MANUAL GQT VIEWMODEL_NEW PRODUSIM]/
		...
		public override CrudViewModelValidationResult Validate()
		{
			...
			validator.Required("ValProduct", Resources.Resources.PRODUCT12880, ValProduct);
...
// USE /[MANUAL GQT VIEWMODEL_SAVE PRODUSIM]/
		public override void Save()
		{
			...
			try { Model = Models.Produ.Find(Navigation.GetStrValue("produ"), m_userContext, "FPRODUSIM"); }
			finally { if (Model == null) Model = new Models.Produ(m_userContext) { Identifier = "FPRODUSIM" }; }
...
// USE /[MANUAL GQT OVERRQ PRODUSIM_LOCATGLN]/
		...
		public void Load_Produsimlcextglnext__(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			// Area limit
			produsimlcextglnext__DoLoad &= AddCriteriaAreaLimit(produsimlcextglnext__Conds, CSGenio.business.CSGenioAlocat.FldCodlocat, "locat", this.ValCodlocat, false);
