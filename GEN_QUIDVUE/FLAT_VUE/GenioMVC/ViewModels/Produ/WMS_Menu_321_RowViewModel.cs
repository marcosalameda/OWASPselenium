...
public class WMS_Menu_321_RowViewModel : Models.Produ
{
	#region Constructors

	public WMS_Menu_321_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public WMS_Menu_321_RowViewModel(UserContext userContext, CSGenioAprodu val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
