...
// USE /[MANUAL WMS OVERRQ 321]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprodu>(m_userContext, false, ref wms_menu_321Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML321", true, firstVisibleColumn: firstVisibleColumn);
