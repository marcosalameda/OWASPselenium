...
public class GQT_Menu_A11_RowViewModel : Models.Proje
{
	#region Constructors

	public GQT_Menu_A11_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public GQT_Menu_A11_RowViewModel(UserContext userContext, CSGenioAproje val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
