...
public class Proje_ValAgregado_RowViewModel : Models.Agreg
{
	#region Constructors

	public Proje_ValAgregado_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Proje_ValAgregado_RowViewModel(UserContext userContext, CSGenioAagreg val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
