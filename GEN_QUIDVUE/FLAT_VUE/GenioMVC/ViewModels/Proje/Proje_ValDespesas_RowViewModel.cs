...
public class Proje_ValDespesas_RowViewModel : Models.Expen
{
	#region Constructors

	public Proje_ValDespesas_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Proje_ValDespesas_RowViewModel(UserContext userContext, CSGenioAexpen val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
