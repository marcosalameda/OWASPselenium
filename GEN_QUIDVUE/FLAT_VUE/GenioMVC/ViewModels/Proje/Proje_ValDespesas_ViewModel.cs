...
{
	public class Proje_ValDespesas_ViewModel : MenuListViewModel<Models.Expen>
	{
		/// <summary>
		...
		public override string Uuid => "Proje_ValDespesas";
...
// USE /[MANUAL GQT LIST_LIMITS PROJE_PSEUDDESPESAS]/
		...
		public Proje_ValDespesas_ViewModel() : base(null!) { }
		...
		public Proje_ValDespesas_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ PROJE_PSEUDDESPESAS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAexpen>(m_userContext, false, ref proje___pseuddespesasConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROJE___PSEUDDESPESAS", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PROJE_PSEUDDESPESAS]/
		...
		{
			List<Proje_ValDespesas_RowViewModel> Elements = [];
			int i = 0;
