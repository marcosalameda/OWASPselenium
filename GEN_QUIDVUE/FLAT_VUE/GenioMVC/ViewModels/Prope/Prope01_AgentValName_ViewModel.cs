...
{
	public class Prope01_AgentValName_ViewModel : MenuListViewModel<Models.Agent>
	{
		/// <summary>
		...
		public override string Uuid => "Prope01_AgentValName";
...
// USE /[MANUAL GQT LIST_LIMITS PROPE01_AGENTNAME]/
		...
		public Prope01_AgentValName_ViewModel() : base(null!) { }
		...
		public Prope01_AgentValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ PROPE01_AGENTNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref prope01_agentname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE01_AGENTNAME____", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PROPE01_AGENTNAME]/
				...
				ListingMVC<CSGenioAagent> listing = Models.ModelBase.Where<CSGenioAagent>(m_userContext, distinct, prope01_agentname____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE01_AGENTNAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<Prope01_AgentValName_RowViewModel> Elements = [];
			int i = 0;
