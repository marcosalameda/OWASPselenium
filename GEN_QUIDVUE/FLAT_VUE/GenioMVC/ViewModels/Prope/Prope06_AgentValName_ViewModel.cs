...
// USE /[MANUAL GQT OVERRQ PROPE06_AGENTNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref prope06_agentname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE06_AGENTNAME____", true, firstVisibleColumn: firstVisibleColumn);
