...
// USE /[MANUAL GQT OVERRQ PROPE06_CITYCITY]/
				...
				*/
				...
				TableCityCity.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.City(m_userContext, r, true, _fieldsToSerialize_PROPE06_CITY_CITY____));
...
// USE /[MANUAL GQT OVERRQ PROPE06_AGENTNAME]/
				...
				*/
				...
				TableAgentName.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Agent(m_userContext, r, true, _fieldsToSerialize_PROPE06_AGENTNAME____));
