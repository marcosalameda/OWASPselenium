...
{
	public class Prope08_AgentValName_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Prope08_AgentValName"; }
...
// USE /[MANUAL GQT OVERRQLIST PROPE08_AGENTNAME]/
		...
		{
			var Elements = new List<Prope08_AgentValName_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Prope08_AgentValName_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
