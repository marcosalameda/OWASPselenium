...
// USE /[MANUAL GQT OVERRQ PROPE08_AGENTNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref prope08_agentname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE08_AGENTNAME____", true, firstVisibleColumn: firstVisibleColumn);
