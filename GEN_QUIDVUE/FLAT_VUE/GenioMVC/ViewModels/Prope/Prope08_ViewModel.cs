...
// USE /[MANUAL GQT OVERRQ PROPE08_CITYCITY]/
				...
				*/
				...
				TableCityCity.Elements = listing.RowsForViewModel<GenioMVC.Models.City>((r) => new GenioMVC.Models.City(m_userContext, r, true, _fieldsToSerialize_PROPE08_CITY_CITY____));
...
// USE /[MANUAL GQT OVERRQ PROPE08_AGENTNAME]/
				...
				*/
				...
				TableAgentName.Elements = listing.RowsForViewModel<GenioMVC.Models.Agent>((r) => new GenioMVC.Models.Agent(m_userContext, r, true, _fieldsToSerialize_PROPE08_AGENTNAME____));
