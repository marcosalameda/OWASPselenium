...
public class Prope09_ValPropcont_RowViewModel : Models.Procn
{
	#region Constructors

	public Prope09_ValPropcont_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Prope09_ValPropcont_RowViewModel(UserContext userContext, CSGenioAprocn val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
