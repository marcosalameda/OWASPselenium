...
{
	public class Prope10_ValPropcont_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Prope10_ValPropcont"; }
...
// USE /[MANUAL GQT OVERRQLIST PROPE10_PSEUDPROPCONT]/
		...
		{
			var Elements = new List<Prope10_ValPropcont_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Prope10_ValPropcont_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PROPE10_VALPROPCONT]/
		...
		[
			"Procn", "Procn.ValCodprocn", "Procn.ValZzstate", "Procn.ValName", "Procn.ValEmail", "Procn.ValTelephon", "Procn.ValDescript", "Procn.ValDate", "Procn.ValCodprope", "BtnPermission"
		];
