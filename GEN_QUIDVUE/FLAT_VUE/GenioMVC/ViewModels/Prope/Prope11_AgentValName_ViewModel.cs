...
{
	public class Prope11_AgentValName_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Prope11_AgentValName"; }
...
// USE /[MANUAL GQT OVERRQLIST PROPE11_AGENTNAME]/
		...
		{
			var Elements = new List<Prope11_AgentValName_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Prope11_AgentValName_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
