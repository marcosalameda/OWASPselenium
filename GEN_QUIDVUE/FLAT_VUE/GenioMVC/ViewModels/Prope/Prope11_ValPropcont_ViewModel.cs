...
{
	public class Prope11_ValPropcont_ViewModel : MenuListViewModel<Models.Procn>
	{
		/// <summary>
		...
		public override string Uuid => "Prope11_ValPropcont";
...
// USE /[MANUAL GQT LIST_LIMITS PROPE11_PSEUDPROPCONT]/
		...
		public Prope11_ValPropcont_ViewModel() : base(null!) { }
		...
		public Prope11_ValPropcont_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ PROPE11_PSEUDPROPCONT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprocn>(m_userContext, false, ref prope11_pseudpropcontConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE11_PSEUDPROPCONT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PROPE11_PSEUDPROPCONT]/
		...
		{
			List<Prope11_ValPropcont_RowViewModel> Elements = [];
			int i = 0;
