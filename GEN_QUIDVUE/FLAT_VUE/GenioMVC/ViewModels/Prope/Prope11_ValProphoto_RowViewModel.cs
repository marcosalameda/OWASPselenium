...
public class Prope11_ValProphoto_RowViewModel : Models.Proph
{
	#region Constructors

	public Prope11_ValProphoto_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Prope11_ValProphoto_RowViewModel(UserContext userContext, CSGenioAproph val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
