...
// USE /[MANUAL GQT OVERRQ PROPE11_PSEUDPROPHOTO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAproph>(m_userContext, false, ref prope11_pseudprophotoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE11_PSEUDPROPHOTO", true, firstVisibleColumn: firstVisibleColumn);
