...
// USE /[MANUAL GQT OVERRQ PROPE11_CITYCITY]/
				...
				*/
				...
				TableCityCity.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.City(m_userContext, r, true, _fieldsToSerialize_PROPE11_CITY_CITY____));
...
// USE /[MANUAL GQT OVERRQ PROPE11_AGENTNAME]/
				...
				*/
				...
				TableAgentName.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Agent(m_userContext, r, true, _fieldsToSerialize_PROPE11_AGENTNAME____));
