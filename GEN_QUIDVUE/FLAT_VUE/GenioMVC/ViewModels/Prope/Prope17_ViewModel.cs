...
// USE /[MANUAL GQT OVERRQ PROPE17_CITYCITY]/
				...
				*/
				...
				TableCityCity.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.City(m_userContext, r, true, _fieldsToSerialize_PROPE17_CITY_CITY____));
...
// USE /[MANUAL GQT OVERRQ PROPE17_AGENTNAME]/
				...
				*/
				...
				TableAgentName.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Agent(m_userContext, r, true, _fieldsToSerialize_PROPE17_AGENTNAME____));
