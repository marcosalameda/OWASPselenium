...
{
	public class Prope19_ValPropcont_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Prope19_ValPropcont"; }
...
// USE /[MANUAL GQT OVERRQLIST PROPE19_PSEUDPROPCONT]/
		...
		{
			var Elements = new List<Prope19_ValPropcont_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Prope19_ValPropcont_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
