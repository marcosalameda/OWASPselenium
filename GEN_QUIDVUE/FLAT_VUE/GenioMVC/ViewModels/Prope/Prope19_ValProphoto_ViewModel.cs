...
{
	public class Prope19_ValProphoto_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Prope19_ValProphoto"; }
...
// USE /[MANUAL GQT OVERRQ PROPE19_PSEUDPROPHOTO]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAproph>(m_userContext, false, prope19_pseudprophotoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE19_PSEUDPROPHOTO", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PROPE19_PSEUDPROPHOTO]/
		...
		{
			var Elements = new List<Prope19_ValProphoto_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Prope19_ValProphoto_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
