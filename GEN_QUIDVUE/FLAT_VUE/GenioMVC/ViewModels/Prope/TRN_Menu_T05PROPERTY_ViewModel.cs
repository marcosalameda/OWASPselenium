...
{
	public class TRN_Menu_T05PROPERTY_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		...
		public override string Uuid => "a9cfa2c0-5784-41b1-872a-173eca01d9a4";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T05PROPERTY]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT05PROPERTY");
		...
		public TRN_Menu_T05PROPERTY_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T05PROPERTY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T05PROPERTY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref trn_menu_t05propertyConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT05PROPERTY", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T05PROPERTY]/
				...
				ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, distinct, trn_menu_t05propertyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT05PROPERTY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T05PROPERTY_RowViewModel> Elements = [];
			int i = 0;
