...
{
	public class TRN_Menu_T10PROPERTY_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		...
		public override string Uuid => "e87dec61-0a6d-4e91-8522-3678bab6dd20";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T10PROPERTY]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT10PROPERTY");
		...
		public TRN_Menu_T10PROPERTY_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T10PROPERTY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T10PROPERTY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref trn_menu_t10propertyConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT10PROPERTY", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T10PROPERTY]/
				...
				ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, distinct, trn_menu_t10propertyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT10PROPERTY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T10PROPERTY_RowViewModel> Elements = [];
			int i = 0;
