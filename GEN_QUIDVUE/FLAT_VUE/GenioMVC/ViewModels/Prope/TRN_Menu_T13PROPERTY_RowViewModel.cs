...
public class TRN_Menu_T13PROPERTY_RowViewModel : Models.Prope
{
	#region Constructors

	public TRN_Menu_T13PROPERTY_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public TRN_Menu_T13PROPERTY_RowViewModel(UserContext userContext, CSGenioAprope val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
