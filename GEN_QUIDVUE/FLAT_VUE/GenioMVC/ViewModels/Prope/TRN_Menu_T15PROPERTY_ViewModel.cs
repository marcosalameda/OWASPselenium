...
{
	public class TRN_Menu_T15PROPERTY_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<TRN_Menu_T15PROPERTY_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "3e3a9697-a65a-4342-bad0-a75a02c193f4";
...
// USE /[MANUAL TRN LIST_LIMITS T15PROPERTY]/
		...
		public TRN_Menu_T15PROPERTY_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="TRN_Menu_T15PROPERTY_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public TRN_Menu_T15PROPERTY_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public TRN_Menu_T15PROPERTY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Prope.AddEPH<CSGenioAprope>(ref u, crs, "MLT15PROPERTY");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Prope.AddEPH<CSGenioAprope>(ref u, null, "MLT15PROPERTY"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAprope> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet trn_menu_t15propertyConds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "MLT15PROPERTY");
			...
			conditions.SubSets.Add(trn_menu_t15propertyConds);
			trn_menu_t15propertyConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL TRN OVERRQ T15PROPERTY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref trn_menu_t15propertyConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT15PROPERTY", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL TRN OVERRQLSTEXP T15PROPERTY]/
			...
			if (tableReload)
			{
// USE /[MANUAL TRN OVERRQLIST T15PROPERTY]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAprope.GetInformation(), QMVC_POS_RECORD, sorts, trn_menu_t15propertyConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
				...
				Menu.Elements = MapTRN_Menu_T15PROPERTY(listing);

				Menu.Identifier = "MLT15PROPERTY";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "MLT15PROPERTY";
		...
		private List<TRN_Menu_T15PROPERTY_RowViewModel> MapTRN_Menu_T15PROPERTY(ListingMVC<CSGenioAprope> Qlisting)
		{
			List<TRN_Menu_T15PROPERTY_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapTRN_Menu_T15PROPERTY(row));
					i++;
				}
			}
		...
		/// to a TRN_Menu_T15PROPERTY_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private TRN_Menu_T15PROPERTY_RowViewModel MapTRN_Menu_T15PROPERTY(CSGenioAprope row)
		{
			var model = new TRN_Menu_T15PROPERTY_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T15PROPERTY]/
