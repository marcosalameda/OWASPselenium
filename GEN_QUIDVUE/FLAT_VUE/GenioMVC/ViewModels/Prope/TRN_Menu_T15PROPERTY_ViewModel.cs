...
{
	public class TRN_Menu_T15PROPERTY_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "3e3a9697-a65a-4342-bad0-a75a02c193f4"; }
...
// USE /[MANUAL TRN OVERRQLIST T15PROPERTY]/
		...
		{
			var Elements = new List<TRN_Menu_T15PROPERTY_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T15PROPERTY_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
