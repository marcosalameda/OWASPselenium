...
{
	public class TRN_Menu_T17PROPERTY_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "fbf41316-5b58-43ba-b6ac-4e58695ac11d";
...
// USE /[MANUAL TRN LIST_LIMITS T17PROPERTY]/
		...
		public TRN_Menu_T17PROPERTY_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T17PROPERTY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQLIST T17PROPERTY]/
		...
		{
			List<TRN_Menu_T17PROPERTY_RowViewModel> Elements = [];
			int i = 0;
