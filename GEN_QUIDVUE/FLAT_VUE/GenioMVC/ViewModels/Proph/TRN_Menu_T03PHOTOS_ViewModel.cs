...
// USE /[MANUAL TRN OVERRQ T03PHOTOS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAproph>(m_userContext, false, ref trn_menu_t03photosConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT03PHOTOS", true, firstVisibleColumn: firstVisibleColumn);
