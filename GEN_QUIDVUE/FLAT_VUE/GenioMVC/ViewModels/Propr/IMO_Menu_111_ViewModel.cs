...
{
	public class IMO_Menu_111_ViewModel : MenuListViewModel<Models.Propr>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<IMO_Menu_111_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "5d7b8c5d-ac05-4bf4-b866-40e2585c681e";
...
// USE /[MANUAL IMO LIST_LIMITS 111]/
		...
		public override int GetCount(User user)
		{
			...
			ListingMVC<CSGenioApropr> listing = new(fields, null, 1, 1, false, user, true, string.Empty, true);
		...
		public IMO_Menu_111_ViewModel() : base(null!) { }
		...
		public IMO_Menu_111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApropr> Qlisting, ref CriteriaSet conditions)
		{
			...
			imo_menu_111Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL IMO OVERRQ 111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApropr>(m_userContext, false, ref imo_menu_111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL IMO OVERRQLIST 111]/
		...
		private List<IMO_Menu_111_RowViewModel> MapIMO_Menu_111(ListingMVC<CSGenioApropr> Qlisting)
		{
			List<IMO_Menu_111_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a IMO_Menu_111_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private IMO_Menu_111_RowViewModel MapIMO_Menu_111(CSGenioApropr row)
		{
			var model = new IMO_Menu_111_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
