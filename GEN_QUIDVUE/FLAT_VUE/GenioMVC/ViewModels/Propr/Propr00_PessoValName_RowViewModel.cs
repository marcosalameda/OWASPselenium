...
public class Propr00_PessoValName_RowViewModel : Models.Pesso
{
	#region Constructors

	public Propr00_PessoValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Propr00_PessoValName_RowViewModel(UserContext userContext, CSGenioApesso val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
