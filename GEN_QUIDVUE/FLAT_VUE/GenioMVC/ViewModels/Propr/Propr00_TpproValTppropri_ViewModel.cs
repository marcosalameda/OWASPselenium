...
namespace GenioMVC.ViewModels.Propr
{
	public class Propr00_TpproValTppropri_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Propr00_TpproValTppropri", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAtppro.FldCodtppro, CSGenioAtppro.FldZzstate, CSGenioAtppro.FldTppropri };
			...
			propr00_tpprotppropriConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PROPR00_TPPROTPPROPRI]/
				...
				ListingMVC<CSGenioAtppro> listing = Models.ModelBase.Where<CSGenioAtppro>(m_userContext, false, propr00_tpprotppropriConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPR00_TPPROTPPROPRI", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
