...
// USE /[MANUAL GQT OVERRQ PROPRALL_CNTRYCOUNTRY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcntry>(m_userContext, false, ref proprallcntrycountry_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPRALLCNTRYCOUNTRY_", true, firstVisibleColumn: firstVisibleColumn);
