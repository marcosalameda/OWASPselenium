...
{
	public class Proprall_CntryValCountry_ViewModel : MenuListViewModel<Models.Cntry>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Proprall_CntryValCountry";
...
// USE /[MANUAL GQT LIST_LIMITS PROPRALL_CNTRYCOUNTRY]/
		...
		public Proprall_CntryValCountry_ViewModel() : base(null!) { }
		...
		public Proprall_CntryValCountry_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST PROPRALL_CNTRYCOUNTRY]/
		...
		{
			List<Proprall_CntryValCountry_RowViewModel> Elements = [];
			int i = 0;
