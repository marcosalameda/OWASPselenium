...
{
	public class Proprall_PessoValName_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Proprall_PessoValName";
...
// USE /[MANUAL GQT LIST_LIMITS PROPRALL_PESSONAME]/
		...
		public Proprall_PessoValName_ViewModel() : base(null!) { }
		...
		public Proprall_PessoValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST PROPRALL_PESSONAME]/
		...
		{
			List<Proprall_PessoValName_RowViewModel> Elements = [];
			int i = 0;
