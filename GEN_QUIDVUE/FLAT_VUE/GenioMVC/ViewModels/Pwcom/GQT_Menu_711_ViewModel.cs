...
FieldRef[] fields = new FieldRef[] { CSGenioApwcom.FldCodpwcom, CSGenioApwcom.FldZzstate, CSGenioApwcom.FldCodpsw, CSGenioApsw.FldCodpsw, CSGenioApsw.FldNome, CSGenioApwcom.FldCodpess1, CSGenioApess1.FldCodpesso, CSGenioApess1.FldName, CSGenioApwcom.FldFoto, CSGenioApwcom.FldNridenti };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "GQT_Menu_711", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioApwcom.FldCodpwcom, CSGenioApwcom.FldZzstate, CSGenioApwcom.FldCodpsw, CSGenioApsw.FldCodpsw, CSGenioApsw.FldNome, CSGenioApwcom.FldCodpess1, CSGenioApess1.FldCodpesso, CSGenioApess1.FldName, CSGenioApwcom.FldFoto, CSGenioApwcom.FldNridenti };
			...
			gqt_menu_711Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST 711]/
				...
				ListingMVC<CSGenioApwcom> listing = Models.ModelBase.Where<CSGenioApwcom>(m_userContext, false, gqt_menu_711Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML711", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Pwcom(m_userContext, true, _fieldsToSerialize);
