...
{
	public class Pwcom_Pess1ValName_ViewModel : MenuListViewModel<Models.Pess1>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Pwcom_Pess1ValName_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Pwcom_Pess1ValName";
...
// USE /[MANUAL GQT LIST_LIMITS PWCOM_PESS1NAME]/
		...
		public Pwcom_Pess1ValName_ViewModel() : base(null!) { }
		...
		public Pwcom_Pess1ValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Pwcom_Pess1ValName_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApess1> Qlisting, ref CriteriaSet conditions)
		{
			...
			pwcom___pess1name____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PWCOM_PESS1NAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApess1>(m_userContext, false, ref pwcom___pess1name____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PWCOM___PESS1NAME____", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PWCOM_PESS1NAME]/
		...
		private List<Pwcom_Pess1ValName_RowViewModel> MapPwcom_Pess1ValName(ListingMVC<CSGenioApess1> Qlisting)
		{
			List<Pwcom_Pess1ValName_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Pwcom_Pess1ValName_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Pwcom_Pess1ValName_RowViewModel MapPwcom_Pess1ValName(CSGenioApess1 row)
		{
			var model = new Pwcom_Pess1ValName_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
