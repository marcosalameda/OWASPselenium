...
// USE /[MANUAL GQT OVERRQ PWCOM_PSWNOME]/
				...
				*/
				...
				TablePswNome.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Psw(m_userContext, r, true, _fieldsToSerialize_PWCOM___PSW__NOME____));
...
// USE /[MANUAL GQT OVERRQ PWCOM_PESS1NAME]/
				...
				*/
				...
				TablePess1Name.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Pess1(m_userContext, r, true, _fieldsToSerialize_PWCOM___PESS1NAME____));
