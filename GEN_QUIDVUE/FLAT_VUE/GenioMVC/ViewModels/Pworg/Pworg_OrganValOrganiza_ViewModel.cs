...
namespace GenioMVC.ViewModels.Pworg
{
	public class Pworg_OrganValOrganiza_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Pworg_OrganValOrganiza", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAorgan.FldCodorgan, CSGenioAorgan.FldZzstate, CSGenioAorgan.FldOrganiza };
			...
			pworg___organorganizaConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PWORG_ORGANIZA]/
				...
				ListingMVC<CSGenioAorgan> listing = Models.ModelBase.Where<CSGenioAorgan>(m_userContext, false, pworg___organorganizaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PWORG___ORGANORGANIZA", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
