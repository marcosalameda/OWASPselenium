...
public class IMO_Menu_LISTA_REGIAO_RowViewModel : Models.Pwreg
{
	#region Constructors

	public IMO_Menu_LISTA_REGIAO_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public IMO_Menu_LISTA_REGIAO_RowViewModel(UserContext userContext, CSGenioApwreg val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
