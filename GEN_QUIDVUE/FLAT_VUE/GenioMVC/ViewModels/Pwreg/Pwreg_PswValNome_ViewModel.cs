...
{
	public class Pwreg_PswValNome_ViewModel : MenuListViewModel<Models.Psw>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<Pwreg_PswValNome_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "Pwreg_PswValNome";
...
// USE /[MANUAL GQT LIST_LIMITS PWREG_PSWNOME]/
		...
		public Pwreg_PswValNome_ViewModel() : base(null!) { }
		...
		public Pwreg_PswValNome_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Pwreg_PswValNome_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApsw> Qlisting, ref CriteriaSet conditions)
		{
			...
			}, "ms", "Time to load the form."))
			{
				...
				pwreg___psw__nome____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST PWREG_PSWNOME]/
					...
					ListingMVC<CSGenioApsw> listing = Models.ModelBase.Where<CSGenioApsw>(m_userContext, false, pwreg___psw__nome____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PWREG___PSW__NOME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Pwreg_PswValNome_RowViewModel> MapPwreg_PswValNome(ListingMVC<CSGenioApsw> Qlisting)
		{
			List<Pwreg_PswValNome_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Pwreg_PswValNome_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Pwreg_PswValNome_RowViewModel MapPwreg_PswValNome(CSGenioApsw row)
		{
			var model = new Pwreg_PswValNome_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
