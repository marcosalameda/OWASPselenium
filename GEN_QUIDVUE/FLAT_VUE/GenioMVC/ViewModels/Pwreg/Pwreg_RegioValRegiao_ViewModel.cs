...
{
	public class Pwreg_RegioValRegiao_ViewModel : MenuListViewModel<Models.Regio>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<Pwreg_RegioValRegiao_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "Pwreg_RegioValRegiao";
...
// USE /[MANUAL GQT LIST_LIMITS PWREG_REGIOREGIAO]/
		...
		public Pwreg_RegioValRegiao_ViewModel() : base(null!) { }
		...
		{
			ValCodpwreg = userContext.CurrentNavigation.CurrentLevel.GetEntry("pwreg")?.ToString();
		}
		...
		public Pwreg_RegioValRegiao_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST PWREG_REGIOREGIAO]/
					...
					ListingMVC<CSGenioAregio> listing = Models.ModelBase.Where<CSGenioAregio>(m_userContext, false, pwreg___regioregiao__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PWREG___REGIOREGIAO__", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Pwreg_RegioValRegiao_RowViewModel> MapPwreg_RegioValRegiao(ListingMVC<CSGenioAregio> Qlisting)
		{
			List<Pwreg_RegioValRegiao_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Pwreg_RegioValRegiao_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Pwreg_RegioValRegiao_RowViewModel MapPwreg_RegioValRegiao(CSGenioAregio row)
		{
			var model = new Pwreg_RegioValRegiao_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
