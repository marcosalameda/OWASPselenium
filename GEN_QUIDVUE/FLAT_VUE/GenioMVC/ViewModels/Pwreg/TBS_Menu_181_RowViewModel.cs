...
public class TBS_Menu_181_RowViewModel : Models.Pwreg
{
	#region Constructors

	public TBS_Menu_181_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public TBS_Menu_181_RowViewModel(UserContext userContext, CSGenioApwreg val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
