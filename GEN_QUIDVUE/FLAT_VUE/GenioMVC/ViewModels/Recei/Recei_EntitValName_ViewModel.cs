...
// USE /[MANUAL GQT OVERRQLIST RECEI_ENTITNAME]/
		...
		{
			var Elements = new List<Recei_EntitValName_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Recei_EntitValName_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM RECEI_ENTITVALNAME]/
		...
		[
			"Entit", "Entit.ValCodentit", "Entit.ValZzstate", "Entit.ValName", "Entit.ValInitials", "Entit.ValTaxnumbe", "Entit.ValEmail", "Entit.ValPhonenum", "Entit.ValContact", "Entit.ValLanguage", "Entit.ValFirstfacilitie", "Entit.ValLastfacilitie", "BtnPermission"
		];
