...
namespace GenioMVC.ViewModels.Recei
{
	public class Recei_ValReceiptl_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValReceiptl", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioArelin.FldCoddilin, CSGenioArelin.FldZzstate, CSGenioArelin.FldLinenumb, CSGenioArelin.FldCodprodu, CSGenioAprodu.FldCodprodu, CSGenioAprodu.FldSku, CSGenioAprodu.FldGtin, CSGenioAprodu.FldProduct, CSGenioArelin.FldOrdered, CSGenioArelin.FldReceived, CSGenioArelin.FldOutstand };
			...
			recei___pseudreceiptlConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ RECEI_PSEUDRECEIPTL]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioArelin>(m_userContext, false, recei___pseudreceiptlConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_RECEI___PSEUDRECEIPTL", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST RECEI_PSEUDRECEIPTL]/
				...
				ListingMVC<CSGenioArelin> listing = Models.ModelBase.Where<CSGenioArelin>(m_userContext, false, recei___pseudreceiptlConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_RECEI___PSEUDRECEIPTL", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Relin(m_userContext, true, _fieldsToSerialize);
