...
public class WMS_Menu_121_RowViewModel : Models.Recei
{
	#region Constructors

	public WMS_Menu_121_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public WMS_Menu_121_RowViewModel(UserContext userContext, CSGenioArecei val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
