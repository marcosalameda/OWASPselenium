...
public class PTN_Menu_211_RowViewModel : Models.Regio
{
	#region Constructors

	public PTN_Menu_211_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_211_RowViewModel(UserContext userContext, CSGenioAregio val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
