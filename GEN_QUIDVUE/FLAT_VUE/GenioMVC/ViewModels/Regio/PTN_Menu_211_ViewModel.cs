...
namespace GenioMVC.ViewModels.Regio
{
	public class PTN_Menu_211_ViewModel : ListViewModel
	{
		...
		public TablePartial<PTN_Menu_211_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid { get => "3ff5c84d-e77b-442c-b81e-603fe2ba55be"; }
		...
		public override int GetCount(User user)
		{
			...
			var areaBase = CSGenio.business.Area.createArea("regio", user, "PTN");

			//gets eph conditions to be applied in listing
			CriteriaSet ptn_menu_211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML211");
			ptn_menu_211Conds.Equal(CSGenioAregio.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ 211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_211Conds, listing);
		...
		public void LoadToExport(out ListingMVC<CSGenioAregio> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<PTN_Menu_211_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Regio.AddEPH<CSGenioAregio>(ref u, crs, "ML211");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Regio.AddEPH<CSGenioAregio>(ref u, null, "ML211"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAregio> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig.ColumnOrderBy, "regio", allSortOrders);
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				ptn_menu_211Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ 211]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAregio>(m_userContext, false, ptn_menu_211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 211]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAregio.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_211Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAregio> listing = Models.ModelBase.Where<CSGenioAregio>(m_userContext, false, ptn_menu_211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<PTN_Menu_211_RowViewModel> MapPTN_Menu_211(ListingMVC<CSGenioAregio> Qlisting)
		{
			var Elements = new List<PTN_Menu_211_RowViewModel>();
			int i = 0;
		...
		/// to a PTN_Menu_211_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_211_RowViewModel MapPTN_Menu_211(CSGenioAregio row)
		{
			var model = new PTN_Menu_211_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_211_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_211]/
		...
		[
			"Regio", "Regio.ValCodregia", "Regio.ValZzstate", "Cntry", "Cntry.ValCountry", "Regio.ValRegiao", "Pais1", "Pais1.ValCountry", "Regio.ValCodcntry", "Regio.ValCodpais1", "BtnPermission"
		];
