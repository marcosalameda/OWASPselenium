...
namespace GenioMVC.ViewModels.Regio
{
	public class Regia_CntryValCountry_ViewModel : ListViewModel
	{
		...
		public TablePartial<Regia_CntryValCountry_RowViewModel> Menu { get; set; }
...
// USE /[MANUAL GQT LIST_LIMITS REGIA_CNTRYCOUNTRY]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Regia_CntryValCountry_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcntry> Qlisting, ref CriteriaSet conditions)
		{
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				regia___cntrycountry_Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST REGIA_CNTRYCOUNTRY]/
		...
		private List<Regia_CntryValCountry_RowViewModel> MapRegia_CntryValCountry(ListingMVC<CSGenioAcntry> Qlisting)
		{
			var Elements = new List<Regia_CntryValCountry_RowViewModel>();
			int i = 0;
		...
		/// to a Regia_CntryValCountry_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Regia_CntryValCountry_RowViewModel MapRegia_CntryValCountry(CSGenioAcntry row)
		{
			var model = new Regia_CntryValCountry_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(Regia_CntryValCountry_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
