...
public class Regia_ml_Pais1ValCountry_RowViewModel : Models.Pais1
{
	#region Constructors

	public Regia_ml_Pais1ValCountry_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Regia_ml_Pais1ValCountry_RowViewModel(UserContext userContext, CSGenioApais1 val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
