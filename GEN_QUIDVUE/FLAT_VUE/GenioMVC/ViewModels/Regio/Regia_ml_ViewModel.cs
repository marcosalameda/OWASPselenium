...
// USE /[MANUAL GQT OVERRQ REGIA_ML_CNTRYCOUNTRY]/
				...
				*/
				...
				TableCntryCountry.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Cntry(m_userContext, r, true, _fieldsToSerialize_REGIA_MLCNTRYCOUNTRY_));
...
// USE /[MANUAL GQT OVERRQ REGIA_ML_PAIS1COUNTRY]/
				...
				*/
				...
				TablePais1Country.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Pais1(m_userContext, r, true, _fieldsToSerialize_REGIA_MLPAIS1COUNTRY_));
