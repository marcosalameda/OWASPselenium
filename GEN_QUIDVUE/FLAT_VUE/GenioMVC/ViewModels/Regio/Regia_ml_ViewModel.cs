...
// USE /[MANUAL GQT VIEWMODEL_SAVE REGIA_ML]/
		public override void Save()
		{
			...
			try { Model = Models.Regio.Find(Navigation.GetStrValue("regio"), m_userContext, "FREGIA_ML"); }
			finally { if (Model == null) Model = new Models.Regio(m_userContext) { Identifier = "FREGIA_ML" }; }
