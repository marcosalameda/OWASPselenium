...
namespace GenioMVC.ViewModels.Regio
{
	public class Regia_on_Pais1ValCountry_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Regia_on_Pais1ValCountry", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioApais1.FldCodcntry, CSGenioApais1.FldZzstate, CSGenioApais1.FldCountry };
			...
			regia_onpais1country_Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST REGIA_ON_PAIS1COUNTRY]/
				...
				ListingMVC<CSGenioApais1> listing = Models.ModelBase.Where<CSGenioApais1>(m_userContext, false, regia_onpais1country_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REGIA_ONPAIS1COUNTRY_", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
