...
// USE /[MANUAL GQT OVERRQ REGIAPRO_PSEUDIMOVEISS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApropr>(m_userContext, false, ref regiapropseudimoveissConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REGIAPROPSEUDIMOVEISS", true, firstVisibleColumn: firstVisibleColumn);
