...
// USE /[MANUAL GQT VIEWMODEL_SAVE REGIAPRO]/
		public override void Save()
		{
			...
			try { Model = Models.Regio.Find(Navigation.GetStrValue("regio"), m_userContext, "FREGIAPRO"); }
			finally { if (Model == null) Model = new Models.Regio(m_userContext) { Identifier = "FREGIAPRO" }; }
