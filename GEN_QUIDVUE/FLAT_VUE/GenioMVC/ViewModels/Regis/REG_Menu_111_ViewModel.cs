...
FieldRef[] fields = new FieldRef[] { CSGenioAregis.FldCodregis, CSGenioAregis.FldZzstate, CSGenioAregis.FldName, CSGenioAregis.FldNif, CSGenioAregis.FldEmail1, CSGenioAregis.FldEmail2, CSGenioAregis.FldTelephon };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "REG_Menu_111", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAregis.FldCodregis, CSGenioAregis.FldZzstate, CSGenioAregis.FldName, CSGenioAregis.FldNif, CSGenioAregis.FldEmail1, CSGenioAregis.FldEmail2, CSGenioAregis.FldTelephon };
			...
			reg_menu_111Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL REG OVERRQ 111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAregis>(m_userContext, false, reg_menu_111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL REG OVERRQLIST 111]/
				...
				ListingMVC<CSGenioAregis> listing = Models.ModelBase.Where<CSGenioAregis>(m_userContext, false, reg_menu_111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Regis(m_userContext, true, _fieldsToSerialize);
