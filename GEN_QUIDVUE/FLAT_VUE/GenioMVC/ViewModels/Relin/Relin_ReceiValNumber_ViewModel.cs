...
// USE /[MANUAL GQT OVERRQLIST RELIN_RECEINUMBER]/
		...
		{
			var Elements = new List<Relin_ReceiValNumber_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Relin_ReceiValNumber_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM RELIN_RECEIVALNUMBER]/
		...
		[
			"Recei", "Recei.ValCodrecei", "Recei.ValZzstate", "Recei.ValNumber", "Recei.ValCodentit", "BtnPermission"
		];
