...
namespace GenioMVC.ViewModels.Repar
{
	public class GQT_Menu_311_ViewModel : MenuListViewModel<Models.Repar>
	{
		...
		{
// USE /[MANUAL GQT LIST_LIMITS 311]/
...
// USE /[MANUAL GQT OVERRQ 311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArepar>(m_userContext, false, ref gqt_menu_311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML311", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 311]/
				...
				ListingMVC<CSGenioArepar> listing = Models.ModelBase.Where<CSGenioArepar>(m_userContext, distinct, gqt_menu_311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
