...
public class GQT_Menu_REPAIR_LIST_RowViewModel : Models.Repar
{
	#region Constructors

	public GQT_Menu_REPAIR_LIST_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_REPAIR_LIST_RowViewModel(UserContext userContext, CSGenioArepar val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
