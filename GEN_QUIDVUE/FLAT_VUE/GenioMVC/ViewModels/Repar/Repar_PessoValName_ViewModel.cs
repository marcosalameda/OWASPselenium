...
{
	public class Repar_PessoValName_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Repar_PessoValName";
...
// USE /[MANUAL GQT LIST_LIMITS REPAR_PESSONAME]/
		...
		public Repar_PessoValName_ViewModel() : base(null!) { }
		...
		public Repar_PessoValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST REPAR_PESSONAME]/
		...
		{
			List<Repar_PessoValName_RowViewModel> Elements = [];
			int i = 0;
