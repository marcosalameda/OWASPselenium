...
namespace GenioMVC.ViewModels.Repar
{
	public class Repar_PessoValName_ViewModel : ListViewModel
	{
		...
		public TablePartial<Repar_PessoValName_RowViewModel> Menu { get; set; }
...
// USE /[MANUAL GQT LIST_LIMITS REPAR_PESSONAME]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Repar_PessoValName_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApesso> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("form_load_time", new List<KeyValuePair<string, object>>() {
				...
				repar___pessoname____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST REPAR_PESSONAME]/
					...
					ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, repar___pessoname____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REPAR___PESSONAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Repar_PessoValName_RowViewModel> MapRepar_PessoValName(ListingMVC<CSGenioApesso> Qlisting)
		{
			var Elements = new List<Repar_PessoValName_RowViewModel>();
			int i = 0;
		...
		/// to a Repar_PessoValName_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Repar_PessoValName_RowViewModel MapRepar_PessoValName(CSGenioApesso row)
		{
			var model = new Repar_PessoValName_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(Repar_PessoValName_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
