...
public class Repar_SpeciValEspecial_RowViewModel : Models.Speci
{
	#region Constructors

	public Repar_SpeciValEspecial_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Repar_SpeciValEspecial_RowViewModel(UserContext userContext, CSGenioAspeci val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
