...
namespace GenioMVC.ViewModels.Repar
{
	public class Repar_SpeciValEspecial_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Repar_SpeciValEspecial", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAspeci.FldCodespec, CSGenioAspeci.FldZzstate, CSGenioAspeci.FldEspecial, CSGenioAspeci.FldAreatecn };
			...
			repar___speciespecialConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST REPAR_SPECIESPECIAL]/
				...
				ListingMVC<CSGenioAspeci> listing = Models.ModelBase.Where<CSGenioAspeci>(m_userContext, false, repar___speciespecialConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REPAR___SPECIESPECIAL", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
