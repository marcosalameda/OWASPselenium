...
{
	public class PTN_Menu_15311_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<GenioMVC.Models.Roigf> Menu { get; set; }
		...
		{
			dbeditTitle = Resources.Resources.ORDERS_IN_GROUP___FL17142;
		}
...
FieldRef[] fields = new FieldRef[] { CSGenioAroigf.FldCodroigf, CSGenioAroigf.FldZzstate, CSGenioAroigf.FldOrder, CSGenioAroigf.FldTitle, CSGenioAroigf.FldCodrogl1, CSGenioArogl1.FldCodrogl1, CSGenioArogl1.FldTitle };
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_15311_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_15311_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public void LoadToExport(out ListingMVC<CSGenioAroigf> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			...
			if (ajaxRequest && userColumns!=null)
			{
				...
				foreach (CSGenioAlstcol column in userColumns)
				{
					...
					string areabase = column.ValTabela.ToLower() != "roigf" ? CultureInfo.InvariantCulture.TextInfo.ToTitleCase(column.ValTabela) + "." : "";
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GenioMVC.Models.Roigf>();
			Menu.SetFilters(bool.Parse(requestValues["PTN_Menu_15311_tableFilters"] ?? "false"), false);
			...
			LoadUserTableConfig(requestValues, allSortOrders, "PTN_Menu_15311", ref numberListItems);

			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "PTN_Menu_15311_"));
			...
			{
				// EPH
				crs = Models.Roigf.AddEPH<CSGenioAroigf>(ref u, crs, "ML15311");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Roigf.AddEPH<CSGenioAroigf>(ref u, null, "ML15311"));
			}
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAroigf> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "PTN_Menu_15311", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "PTN_Menu_15311"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "PTN_Menu_15311");

			User u = m_userContext.User;
			Menu = new TablePartial<GenioMVC.Models.Roigf>();

			CriteriaSet ptn_menu_15311Conds = CriteriaSet.And();
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pPTN_Menu_15311"])) ? int.Parse(requestValues["pPTN_Menu_15311"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_15311", "dPTN_Menu_15311", requestValues, "roigf", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAroigf.FldCodroigf, CSGenioAroigf.FldZzstate, CSGenioAroigf.FldOrder, CSGenioAroigf.FldTitle, CSGenioAroigf.FldCodrogl1, CSGenioArogl1.FldCodrogl1, CSGenioArogl1.FldTitle };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML15311");
			...
			//Limit type: "DB"			//Current Area = "ROIGF"			//1st Area Limit: "ROGL1"			//1st Area Field: "CODROGL1"			//1st Area Value: ""
			{
				Limit limit = new Limit();
			...
			conditions.SubSets.Add(ptn_menu_15311Conds);
			ptn_menu_15311Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PTN OVERRQ 15311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAroigf>(m_userContext, false, ptn_menu_15311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML15311", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 15311]/
			...
			if (tableReload)
			{
// USE /[MANUAL PTN OVERRQLIST 15311]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAroigf.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_15311Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAroigf> listing = Models.ModelBase.Where<CSGenioAroigf>(m_userContext, false, ptn_menu_15311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML15311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				Menu.Elements = MapPTN_Menu_15311(listing);

				Menu.Identifier = "ML15311";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "ML15311";
		...
		private List<Models.Roigf> MapPTN_Menu_15311(ListingMVC<CSGenioAroigf> Qlisting)
		{
			var Elements = new List<Models.Roigf>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPTN_Menu_15311(row));
					i++;
				}
			}
		...
		/// to a Models.Roigf object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Models.Roigf MapPTN_Menu_15311(CSGenioAroigf row)
		{
			var model = new Models.Roigf(m_userContext, true, _fieldsToSerialize);
		...
		#region ReorderCode
		public void ReorderPTN_Menu_15311(string id, string position)
		{
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_15311]/
		#endregion
