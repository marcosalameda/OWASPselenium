...
// USE /[MANUAL PTN LIST_LIMITS 4311]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAroigf> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAroigf> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<PTN_Menu_4311_RowViewModel>();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "roigf", allSortOrders);
...
// USE /[MANUAL PTN OVERRQ 4311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAroigf>(m_userContext, false, ref ptn_menu_4311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4311", true, firstVisibleColumn: firstVisibleColumn);
