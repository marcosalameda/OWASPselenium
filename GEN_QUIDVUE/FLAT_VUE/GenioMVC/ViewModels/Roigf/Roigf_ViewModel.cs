...
// USE /[MANUAL GQT VIEWMODEL_SAVE ROIGF]/
		public override void Save()
		{
			...
			try { Model = Models.Roigf.Find(Navigation.GetStrValue("roigf"), m_userContext, "FROIGF"); }
			finally { if (Model == null) Model = new Models.Roigf(m_userContext) { Identifier = "FROIGF" }; }
