...
{
	public class PTN_Menu_15411_ViewModel : ListViewModel
	{
		/// <summary>
...
FieldRef[] fields = new FieldRef[] { CSGenioAroigi.FldCodroigi, CSGenioAroigi.FldZzstate, CSGenioAroigi.FldOrder, CSGenioAroigi.FldTitle, CSGenioAroigi.FldCodrogl1, CSGenioArogl1.FldCodrogl1, CSGenioArogl1.FldTitle };
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_15411_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_15411_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["PTN_Menu_15411_tableFilters"] ?? "false"), false);
			...
			LoadUserTableConfig(requestValues, allSortOrders, "PTN_Menu_15411", ref numberListItems);

			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "PTN_Menu_15411_"));
			...
			{
				// EPH
				crs = Models.Roigi.AddEPH<CSGenioAroigi>(ref u, crs, "ML15411");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Roigi.AddEPH<CSGenioAroigi>(ref u, null, "ML15411"));
			}
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAroigi> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "PTN_Menu_15411", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "PTN_Menu_15411"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "PTN_Menu_15411");

			User u = m_userContext.User;
			Menu = new TablePartial<GenioMVC.Models.Roigi>();

			CriteriaSet ptn_menu_15411Conds = CriteriaSet.And();
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pPTN_Menu_15411"])) ? int.Parse(requestValues["pPTN_Menu_15411"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_15411", "dPTN_Menu_15411", requestValues, "roigi", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAroigi.FldCodroigi, CSGenioAroigi.FldZzstate, CSGenioAroigi.FldOrder, CSGenioAroigi.FldTitle, CSGenioAroigi.FldCodrogl1, CSGenioArogl1.FldCodrogl1, CSGenioArogl1.FldTitle };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML15411");
			...
			conditions.SubSets.Add(ptn_menu_15411Conds);
			ptn_menu_15411Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PTN OVERRQ 15411]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAroigi>(m_userContext, false, ptn_menu_15411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML15411", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 15411]/
			...
			if (tableReload)
			{
// USE /[MANUAL PTN OVERRQLIST 15411]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAroigi.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_15411Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAroigi> listing = Models.ModelBase.Where<CSGenioAroigi>(m_userContext, false, ptn_menu_15411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML15411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				Menu.Elements = MapPTN_Menu_15411(listing);

				Menu.Identifier = "ML15411";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "ML15411";
		...
		private List<Models.Roigi> MapPTN_Menu_15411(ListingMVC<CSGenioAroigi> Qlisting)
		{
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPTN_Menu_15411(row));
					i++;
				}
			}
		...
		private Models.Roigi MapPTN_Menu_15411(CSGenioAroigi row)
		{
			var model = new Models.Roigi(m_userContext, true, _fieldsToSerialize);
		...
		private void SetDocumentFields(ListingMVC<CSGenioAroigi> listing)
		{
			...
			foreach (CSGenioAroigi row in listing.Rows)
			{
			}
		}

		#region ReorderCode
		public void ReorderPTN_Menu_15411(string id, string position)
		{
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_15411]/
		#endregion
