...
// USE /[MANUAL PTN LIST_LIMITS 4411]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAroigi> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAroigi> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<PTN_Menu_4411_RowViewModel>();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "roigi", allSortOrders);
...
// USE /[MANUAL PTN OVERRQ 4411]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAroigi>(m_userContext, false, ref ptn_menu_4411Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4411", true, firstVisibleColumn: firstVisibleColumn);
