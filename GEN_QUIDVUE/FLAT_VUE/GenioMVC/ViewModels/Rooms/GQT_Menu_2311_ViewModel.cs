...
namespace GenioMVC.ViewModels.Rooms
{
	public class GQT_Menu_2311_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_2311Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2311");
			gqt_menu_2311Conds.Equal(CSGenioArooms.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 2311]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_2311Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 2311]/
					...
					ListingMVC<CSGenioArooms> listing = Models.ModelBase.Where<CSGenioArooms>(m_userContext, false, gqt_menu_2311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
