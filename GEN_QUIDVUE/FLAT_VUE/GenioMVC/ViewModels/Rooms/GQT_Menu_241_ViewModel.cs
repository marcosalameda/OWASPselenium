...
// USE /[MANUAL GQT OVERRQ 241]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArooms>(m_userContext, false, ref gqt_menu_241Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML241", true, firstVisibleColumn: firstVisibleColumn);
