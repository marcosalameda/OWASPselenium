...
// USE /[MANUAL PTN OVERRQ 3311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArooms>(m_userContext, false, ref ptn_menu_3311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3311", true, firstVisibleColumn: firstVisibleColumn);
