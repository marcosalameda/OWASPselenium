...
{
	public class PTN_Menu_3411_ViewModel : MenuListViewModel<Models.Rooms>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "b7bbcce5-d714-4ca0-ba86-50f80137d65b";
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 3411]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML3411");
		...
		public PTN_Menu_3411_ViewModel() : base(null!) { }
		...
		public PTN_Menu_3411_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQLIST 3411]/
					...
					ListingMVC<CSGenioArooms> listing = Models.ModelBase.Where<CSGenioArooms>(m_userContext, distinct, ptn_menu_3411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_3411_RowViewModel> Elements = [];
			int i = 0;
