...
// USE /[MANUAL PTN OVERRQ 3411]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArooms>(m_userContext, false, ref ptn_menu_3411Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3411", true, firstVisibleColumn: firstVisibleColumn);
