...
{
	public class PTN_Menu_3511_ViewModel : MenuListViewModel<Models.Rooms>
	{
		/// <summary>
		...
		public override string Uuid => "457cb6c5-92df-44e2-b595-bbd715d45ef8";
...
// USE /[MANUAL PTN LIST_LIMITS 3511]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Rooms.AddEPH<CSGenioArooms>(ref u, crs, "ML3511");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Rooms.AddEPH<CSGenioArooms>(ref u, null, "ML3511"));
			}
...
// USE /[MANUAL PTN OVERRQ 3511]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArooms>(m_userContext, false, ref ptn_menu_3511Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3511", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3511]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioArooms.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_3511Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioArooms> listing = Models.ModelBase.Where<CSGenioArooms>(m_userContext, distinct, ptn_menu_3511Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3511", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<PTN_Menu_3511_RowViewModel> MapPTN_Menu_3511(ListingMVC<CSGenioArooms> Qlisting)
		{
		...
		private PTN_Menu_3511_RowViewModel MapPTN_Menu_3511(CSGenioArooms row)
		{
