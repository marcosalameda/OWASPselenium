...
public class PTN_Menu_351_RowViewModel : Models.Rooms
{
	#region Constructors
	...
	public PTN_Menu_351_RowViewModel(UserContext userContext, CSGenioArooms val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
