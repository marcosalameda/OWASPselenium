...
// USE /[MANUAL GQT VIEWMODEL_SAVE SALAS]/
		public override void Save()
		{
			...
			try { Model = Models.Rooms.Find(Navigation.GetStrValue("rooms"), m_userContext, "FSALAS"); }
			finally { if (Model == null) Model = new Models.Rooms(m_userContext) { Identifier = "FSALAS" }; }
