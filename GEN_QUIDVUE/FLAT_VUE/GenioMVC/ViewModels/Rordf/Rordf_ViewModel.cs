...
// USE /[MANUAL GQT VIEWMODEL_SAVE RORDF]/
		public override void Save()
		{
			...
			try { Model = Models.Rordf.Find(Navigation.GetStrValue("rordf"), m_userContext, "FRORDF"); }
			finally { if (Model == null) Model = new Models.Rordf(m_userContext) { Identifier = "FRORDF" }; }
