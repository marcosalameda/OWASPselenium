...
// USE /[MANUAL PTN OVERRQ 131]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArules>(m_userContext, false, ref ptn_menu_131Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML131", true, firstVisibleColumn: firstVisibleColumn);
