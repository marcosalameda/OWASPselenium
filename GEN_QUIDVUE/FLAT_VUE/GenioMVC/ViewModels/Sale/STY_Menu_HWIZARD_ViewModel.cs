...
{
	public class STY_Menu_HWIZARD_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<GenioMVC.Models.Sale> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid { get => "a370304d-2d03-4a9e-8e32-41d68cf57714"; }
		...
		{
			dbeditTitle = Resources.Resources.VENDAS00012;
		}
...
FieldRef[] fields = new FieldRef[] { CSGenioAsale.FldCodvenda, CSGenioAsale.FldZzstate, CSGenioAsale.FldNrlide, CSGenioAsale.FldStartdt, CSGenioAsale.FldIdentifi, CSGenioAsale.FldPotcompr, CSGenioAsale.FldProspecc, CSGenioAsale.FldInteress, CSGenioAsale.FldSemrfina, CSGenioAsale.FldSemcapac, CSGenioAsale.FldDtqualif, CSGenioAsale.FldQualific, CSGenioAsale.FldPreabord, CSGenioAsale.FldHomework, CSGenioAsale.FldDtaborda, CSGenioAsale.FldApproach, CSGenioAsale.FldApresent, CSGenioAsale.FldDtaprese, CSGenioAsale.FldDtsupera, CSGenioAsale.FldTentfech, CSGenioAsale.FldDtvenda, CSGenioAsale.FldDtacompa };
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STY_Menu_HWIZARD_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public STY_Menu_HWIZARD_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public void LoadToExport(out ListingMVC<CSGenioAsale> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			...
			if (ajaxRequest && userColumns!=null)
			{
				...
				foreach (CSGenioAlstcol column in userColumns)
				{
					...
					string areabase = column.ValTabela.ToLower() != "sale" ? CultureInfo.InvariantCulture.TextInfo.ToTitleCase(column.ValTabela) + "." : "";
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GenioMVC.Models.Sale>();
			Menu.SetFilters(bool.Parse(requestValues["STY_Menu_HWIZARD_tableFilters"] ?? "false"), false);
			...
			LoadUserTableConfig(requestValues, allSortOrders, "STY_Menu_HWIZARD", ref numberListItems);

			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "STY_Menu_HWIZARD_"));
			...
			{
				// EPH
				crs = Models.Sale.AddEPH<CSGenioAsale>(ref u, crs, "MLHWIZARD");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Sale.AddEPH<CSGenioAsale>(ref u, null, "MLHWIZARD"));
			}
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAsale> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "STY_Menu_HWIZARD", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "STY_Menu_HWIZARD"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "STY_Menu_HWIZARD");

			User u = m_userContext.User;
			Menu = new TablePartial<GenioMVC.Models.Sale>();

			CriteriaSet sty_menu_hwizardConds = CriteriaSet.And();
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pSTY_Menu_HWIZARD"])) ? int.Parse(requestValues["pSTY_Menu_HWIZARD"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sSTY_Menu_HWIZARD", "dSTY_Menu_HWIZARD", requestValues, "sale", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAsale.FldCodvenda, CSGenioAsale.FldZzstate, CSGenioAsale.FldNrlide, CSGenioAsale.FldStartdt, CSGenioAsale.FldIdentifi, CSGenioAsale.FldPotcompr, CSGenioAsale.FldProspecc, CSGenioAsale.FldInteress, CSGenioAsale.FldSemrfina, CSGenioAsale.FldSemcapac, CSGenioAsale.FldDtqualif, CSGenioAsale.FldQualific, CSGenioAsale.FldPreabord, CSGenioAsale.FldHomework, CSGenioAsale.FldDtaborda, CSGenioAsale.FldApproach, CSGenioAsale.FldApresent, CSGenioAsale.FldDtaprese, CSGenioAsale.FldDtsupera, CSGenioAsale.FldTentfech, CSGenioAsale.FldDtvenda, CSGenioAsale.FldDtacompa };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "MLHWIZARD");
			...
			//Limit type: "SC"			//Current Area = "SALE"			//1st Area Limit: "SALE"			//1st Area Field: "SHOWRCRD"			//1st Area Value: "1"
			{
				Limit limit = new Limit();
				limit.TipoLimite = LimitType.SC;
				limit.NaoAplicaSeNulo = false;
				CSGenioAsale model_limit_area = new CSGenioAsale(m_userContext.User);
				string limit_field = "showrcrd", limit_field_value = "1";
			...
			conditions.SubSets.Add(sty_menu_hwizardConds);
			sty_menu_hwizardConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL STY OVERRQ HWIZARD]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAsale>(m_userContext, false, sty_menu_hwizardConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLHWIZARD", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL STY OVERRQLSTEXP HWIZARD]/
			...
			if (tableReload)
			{
// USE /[MANUAL STY OVERRQLIST HWIZARD]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAsale.GetInformation(), QMVC_POS_RECORD, sorts, sty_menu_hwizardConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAsale> listing = Models.ModelBase.Where<CSGenioAsale>(m_userContext, false, sty_menu_hwizardConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLHWIZARD", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				Menu.Elements = MapSTY_Menu_HWIZARD(listing);

				Menu.Identifier = "MLHWIZARD";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "MLHWIZARD";
		...
		private List<Models.Sale> MapSTY_Menu_HWIZARD(ListingMVC<CSGenioAsale> Qlisting)
		{
			var Elements = new List<Models.Sale>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapSTY_Menu_HWIZARD(row));
					i++;
				}
			}
		...
		/// to a Models.Sale object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Models.Sale MapSTY_Menu_HWIZARD(CSGenioAsale row)
		{
			var model = new Models.Sale(m_userContext, true, _fieldsToSerialize);
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM STY_MENU_HWIZARD]/
		#endregion
