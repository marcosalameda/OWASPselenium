...
public class STY_Menu_PWIZARD_RowViewModel : Models.Sale
{
	#region Constructors

	public STY_Menu_PWIZARD_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public STY_Menu_PWIZARD_RowViewModel(UserContext userContext, CSGenioAsale val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
