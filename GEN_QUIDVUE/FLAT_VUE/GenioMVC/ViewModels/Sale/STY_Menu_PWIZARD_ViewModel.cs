...
namespace GenioMVC.ViewModels.Sale
{
	public class STY_Menu_PWIZARD_ViewModel : ListViewModel
	{
		...
		public TablePartial<STY_Menu_PWIZARD_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet sty_menu_pwizardConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLPWIZARD");
			sty_menu_pwizardConds.Equal(CSGenioAsale.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						sty_menu_pwizardConds.Equal(CSGenioAsale.FldShowrcrd, 1);
...
// USE /[MANUAL STY OVERRQ PWIZARD]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(sty_menu_pwizardConds, listing);
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<STY_Menu_PWIZARD_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAsale> Qlisting, ref CriteriaSet conditions)
		{
			...
			//1st Area Value: "1"
			{
				...
				sty_menu_pwizardConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL STY OVERRQLIST PWIZARD]/
					...
					ListingMVC<CSGenioAsale> listing = Models.ModelBase.Where<CSGenioAsale>(m_userContext, false, sty_menu_pwizardConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLPWIZARD", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<STY_Menu_PWIZARD_RowViewModel> MapSTY_Menu_PWIZARD(ListingMVC<CSGenioAsale> Qlisting)
		{
			var Elements = new List<STY_Menu_PWIZARD_RowViewModel>();
			int i = 0;
		...
		/// to a STY_Menu_PWIZARD_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private STY_Menu_PWIZARD_RowViewModel MapSTY_Menu_PWIZARD(CSGenioAsale row)
		{
			var model = new STY_Menu_PWIZARD_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(STY_Menu_PWIZARD_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
