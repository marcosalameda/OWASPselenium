...
{
	public class STY_Menu_VWIZARD_ViewModel : MenuListViewModel<Models.Sale>
	{
		/// <summary>
		...
		public override string Uuid => "f2d1cbbd-a32f-46d9-bce2-59d3c80a3e1b";
...
// USE /[MANUAL STY LIST_LIMITS VWIZARD]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLVWIZARD");
		...
		public STY_Menu_VWIZARD_ViewModel() : base(null!) { }
		...
		public STY_Menu_VWIZARD_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL STY OVERRQ VWIZARD]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAsale>(m_userContext, false, ref sty_menu_vwizardConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLVWIZARD", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST VWIZARD]/
		...
		{
			List<STY_Menu_VWIZARD_RowViewModel> Elements = [];
			int i = 0;
