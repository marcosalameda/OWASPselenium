...
public class Venda_OrganValOrganiza_RowViewModel : Models.Organ
{
	#region Constructors

	public Venda_OrganValOrganiza_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Venda_OrganValOrganiza_RowViewModel(UserContext userContext, CSGenioAorgan val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
