...
public class Vendaw01_OrganValOrganiza_RowViewModel : Models.Organ
{
	#region Constructors

	public Vendaw01_OrganValOrganiza_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Vendaw01_OrganValOrganiza_RowViewModel(UserContext userContext, CSGenioAorgan val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
