...
// USE /[MANUAL GQT VIEWMODEL_SAVE VENDAW01]/
		public override void Save()
		{
			...
			try { Model = Models.Sale.Find(Navigation.GetStrValue("sale"), m_userContext, "FVENDAW01"); }
			finally { if (Model == null) Model = new Models.Sale(m_userContext) { Identifier = "FVENDAW01" }; }
