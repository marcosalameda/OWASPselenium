...
namespace GenioMVC.ViewModels.Sale
{
	public class Vendaw03_ViewModel : FormViewModel<Models.Sale>, IPreparableForSerialization
	{
		...
		public Vendaw03_ViewModel(UserContext userContext, bool nestedForm = false) : base(userContext, "FVENDAW03", nestedForm) { }

		public Vendaw03_ViewModel(UserContext userContext, Models.Sale row, bool nestedForm = false) : base(userContext, "FVENDAW03", row, nestedForm) { }

		public Vendaw03_ViewModel(UserContext userContext, string id, bool nestedForm = false, string[]? fieldsToLoad = null) : this(userContext, nestedForm)
		{
			this.Navigation.SetValue("sale", id);
			Model = Models.Sale.Find(id, userContext, "FVENDAW03", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Sale.Find(Navigation.GetStrValue("sale"), m_userContext, "FVENDAW03");
			}
			finally
			{
				if (Model == null)
		...
		public override void LoadPartial(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			if (Model == null)
			{
				...
				if (Model == null)
				{
					Model = new Models.Sale(m_userContext) { Identifier = "FVENDAW03" };
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY VENDAW03]/
		...
		{
			Model = Models.Sale.Find(id, m_userContext, "FVENDAW03");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
