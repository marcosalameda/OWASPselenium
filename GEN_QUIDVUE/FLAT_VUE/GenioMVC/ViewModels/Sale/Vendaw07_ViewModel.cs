...
// USE /[MANUAL GQT VIEWMODEL_SAVE VENDAW07]/
		public override void Save()
		{
			...
			try { Model = Models.Sale.Find(Navigation.GetStrValue("sale"), m_userContext, "FVENDAW07"); }
			finally { if (Model == null) Model = new Models.Sale(m_userContext) { Identifier = "FVENDAW07" }; }
