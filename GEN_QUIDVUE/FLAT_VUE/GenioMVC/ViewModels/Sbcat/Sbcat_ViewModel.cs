...
// USE /[MANUAL GQT VIEWMODEL_SAVE SBCAT]/
		public override void Save()
		{
			...
			try { Model = Models.Sbcat.Find(Navigation.GetStrValue("sbcat"), m_userContext, "FSBCAT"); }
			finally { if (Model == null) Model = new Models.Sbcat(m_userContext) { Identifier = "FSBCAT" }; }
