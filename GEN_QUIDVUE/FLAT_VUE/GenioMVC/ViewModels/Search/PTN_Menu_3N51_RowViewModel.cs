...
public class PTN_Menu_3N51_RowViewModel : Models.Search
{
	#region Constructors

	public PTN_Menu_3N51_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_3N51_RowViewModel(UserContext userContext, CSGenioAsearch val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
