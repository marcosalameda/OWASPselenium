...
public class Search_ValRegioes_RowViewModel : Models.Regio
{
	#region Constructors

	public Search_ValRegioes_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Search_ValRegioes_RowViewModel(UserContext userContext, CSGenioAregio val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
