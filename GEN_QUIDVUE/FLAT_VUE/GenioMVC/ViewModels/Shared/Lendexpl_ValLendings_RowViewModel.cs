...
public class Lendexpl_ValLendings_RowViewModel : Models.Lendi
{
	#region Constructors

	public Lendexpl_ValLendings_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Lendexpl_ValLendings_RowViewModel(UserContext userContext, CSGenioAlendi val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
