...
// USE /[MANUAL GQT VIEWMODEL_LOADPARTIAL WID_GRAP]/
		...
		public override void SetViewModelValue(string fullFieldName, object value)
		{
			try
			{
				...
				{
					default:
						Log.Error($"SetViewModelValue (Wid_grap) - Unexpected field identifier {fullFieldName}");
						break;
				}
			}
			catch (Exception ex)
			{
				throw new FrameworkException(Resources.Resources.PEDIMOS_DESCULPA__OC63848, "SetViewModelValue (Wid_grap)", "Unexpected error", ex);
			}
		}
