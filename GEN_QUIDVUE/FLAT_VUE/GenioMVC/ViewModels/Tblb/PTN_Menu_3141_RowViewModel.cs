...
public class PTN_Menu_3141_RowViewModel : Models.Tblb
{
	#region Constructors

	public PTN_Menu_3141_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_3141_RowViewModel(UserContext userContext, CSGenioAtblb val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
