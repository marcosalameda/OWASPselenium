...
{
	public class PTN_Menu_1151_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "97187a64-556a-4f32-8f75-fb65b150f229"; }
...
FieldRef[] fields = new FieldRef[] { CSGenioAtblk.FldCodtblk, CSGenioAtblk.FldZzstate, CSGenioAtblk.FldName, CSGenioAtblk.FldFkey1, CSGenioAgrpb.FldCodgrpb, CSGenioAgrpb.FldName, CSGenioAtblk.FldFkey2, CSGenioAtrsb.FldCodtrsb, CSGenioAtrsb.FldName };
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_1151_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_1151_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu.SetFilters(bool.Parse(requestValues["PTN_Menu_1151_tableFilters"] ?? "false"), false);
			...
			LoadUserTableConfig(requestValues, allSortOrders, "PTN_Menu_1151", ref numberListItems);

			crs.SubSets.Add(ProcessSearchFilters(Menu, GetSearchColumns(true), requestValues, "PTN_Menu_1151_"));
			...
			{
				// EPH
				crs = Models.Tblk.AddEPH<CSGenioAtblk>(ref u, crs, "ML1151");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Tblk.AddEPH<CSGenioAtblk>(ref u, null, "ML1151"));
			}
		...
		public void Load(int numberListItems, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtblk> Qlisting, ref CriteriaSet conditions)
		{
			...
			if (ajaxRequest)
				this.Navigation.SetValue("requestValues" + "PTN_Menu_1151", requestValues);
			else if (!ajaxRequest && this.Navigation.CheckKey("requestValues" + "PTN_Menu_1151"))
				requestValues = this.Navigation.GetValue<NameValueCollection>("requestValues" + "PTN_Menu_1151");

			User u = m_userContext.User;
			Menu = new TablePartial<GenioMVC.Models.Tblk>();

			CriteriaSet ptn_menu_1151Conds = CriteriaSet.And();
			...
			var pageNumber = (ajaxRequest && !String.IsNullOrEmpty(requestValues["pPTN_Menu_1151"])) ? int.Parse(requestValues["pPTN_Menu_1151"]) : 1;

			// Added to avoid 0 or -1 pages when setting number of records to -1 to disable pagination
			if (pageNumber < 1)
				pageNumber = 1;

			List<ColumnSort> sorts = GetRequestSorts(this.Menu, "sPTN_Menu_1151", "dPTN_Menu_1151", requestValues, "tblk", allSortOrders);
...
FieldRef[] fields = new FieldRef[] { CSGenioAtblk.FldCodtblk, CSGenioAtblk.FldZzstate, CSGenioAtblk.FldName, CSGenioAtblk.FldFkey1, CSGenioAgrpb.FldCodgrpb, CSGenioAgrpb.FldName, CSGenioAtblk.FldFkey2, CSGenioAtrsb.FldCodtrsb, CSGenioAtrsb.FldName };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML1151");
			...
			conditions.SubSets.Add(ptn_menu_1151Conds);
			ptn_menu_1151Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PTN OVERRQ 1151]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAtblk>(m_userContext, false, ptn_menu_1151Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1151", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 1151]/
			...
			if (tableReload)
			{
// USE /[MANUAL PTN OVERRQLIST 1151]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAtblk.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_1151Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
					{
				...
				ListingMVC<CSGenioAtblk> listing = Models.ModelBase.Where<CSGenioAtblk>(m_userContext, false, ptn_menu_1151Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1151", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				Menu.Elements = MapPTN_Menu_1151(listing);

				Menu.Identifier = "ML1151";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "ML1151";
		...
		private List<Models.Tblk> MapPTN_Menu_1151(ListingMVC<CSGenioAtblk> Qlisting)
		{
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPTN_Menu_1151(row));
					i++;
				}
			}
		...
		private Models.Tblk MapPTN_Menu_1151(CSGenioAtblk row)
		{
			var model = new Models.Tblk(m_userContext, true, _fieldsToSerialize);
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_1151]/
		#endregion
