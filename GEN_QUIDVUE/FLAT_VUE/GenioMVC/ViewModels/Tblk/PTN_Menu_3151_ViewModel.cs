...
{
	public class PTN_Menu_3151_ViewModel : MenuListViewModel<Models.Tblk>
	{
		/// <summary>
...
// USE /[MANUAL PTN OVERRQ 3151]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtblk>(m_userContext, false, ref ptn_menu_3151Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3151", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3151]/
				...
				ListingMVC<CSGenioAtblk> listing = Models.ModelBase.Where<CSGenioAtblk>(m_userContext, distinct, ptn_menu_3151Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3151", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
