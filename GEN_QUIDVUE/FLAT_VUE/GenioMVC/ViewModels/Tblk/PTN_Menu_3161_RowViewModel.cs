...
public class PTN_Menu_3161_RowViewModel : Models.Tblk
{
	#region Constructors

	public PTN_Menu_3161_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_3161_RowViewModel(UserContext userContext, CSGenioAtblk val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
