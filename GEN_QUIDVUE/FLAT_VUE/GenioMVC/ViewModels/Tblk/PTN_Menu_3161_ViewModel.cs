...
// USE /[MANUAL PTN OVERRQ 3161]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAtblk>(m_userContext, false, ptn_menu_3161Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3161", true, firstVisibleColumn: firstVisibleColumn);
