...
namespace GenioMVC.ViewModels.Tblk
{
	public class Tblk_TrsbValName_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Tblk_TrsbValName", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAtrsb.FldCodtrsb, CSGenioAtrsb.FldZzstate, CSGenioAtrsb.FldName };
			...
			tblk____trsb_name____Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST TBLK_NAME]/
				...
				ListingMVC<CSGenioAtrsb> listing = Models.ModelBase.Where<CSGenioAtrsb>(m_userContext, false, tblk____trsb_name____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TBLK____TRSB_NAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
