...
public class TBS_Menu_151_RowViewModel : Models.Tpcon
{
	#region Constructors

	public TBS_Menu_151_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public TBS_Menu_151_RowViewModel(UserContext userContext, CSGenioAtpcon val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
