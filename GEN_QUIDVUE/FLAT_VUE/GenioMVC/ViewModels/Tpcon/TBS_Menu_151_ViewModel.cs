...
FieldRef[] fields = new FieldRef[] { CSGenioAtpcon.FldCodtpcon, CSGenioAtpcon.FldZzstate, CSGenioAtpcon.FldGenconta, CSGenioAtpcon.FldTipocont };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "TBS_Menu_151", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAtpcon.FldCodtpcon, CSGenioAtpcon.FldZzstate, CSGenioAtpcon.FldGenconta, CSGenioAtpcon.FldTipocont };
			...
			tbs_menu_151Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL TBS OVERRQLIST 151]/
				...
				ListingMVC<CSGenioAtpcon> listing = Models.ModelBase.Where<CSGenioAtpcon>(m_userContext, false, tbs_menu_151Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML151", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
