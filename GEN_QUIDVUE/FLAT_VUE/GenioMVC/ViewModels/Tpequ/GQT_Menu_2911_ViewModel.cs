...
// USE /[MANUAL GQT OVERRQLIST 2911]/
		...
		public override void MapFromModel(Models.Tpequ m)
		{
			if (m == null)
			{
				CSGenio.framework.Log.Error("Map Model (Tpequ) to ViewModel (GQT_Menu_2911) - Model is a null reference.");
			...
			{
				CSGenio.framework.Log.Error("Map Model (Tpequ) to ViewModel (GQT_Menu_2911) - Error during mapping.");
				throw;
			}
		}
		...
		public override void MapToModel(Models.Tpequ m)
		{
			if (m == null)
			{
				CSGenio.framework.Log.Error("Map ViewModel (GQT_Menu_2911) to Model (Tpequ) - Model is a null reference.");
				throw new ModelNotFoundException("Model not found");
			}
			...
			{
				CSGenio.framework.Log.Error("Map ViewModel (GQT_Menu_2911) to Model (Tpequ) - Error during mapping.");
				throw;
			}
		}
