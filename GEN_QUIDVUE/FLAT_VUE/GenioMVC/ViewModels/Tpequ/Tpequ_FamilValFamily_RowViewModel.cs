...
public class Tpequ_FamilValFamily_RowViewModel : Models.Famil
{
	#region Constructors

	public Tpequ_FamilValFamily_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Tpequ_FamilValFamily_RowViewModel(UserContext userContext, CSGenioAfamil val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
