...
public class Tpequ_ValComponen_RowViewModel : Models.Cmpki
{
	#region Constructors

	public Tpequ_ValComponen_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}

	public Tpequ_ValComponen_RowViewModel(UserContext userContext, CSGenioAcmpki val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowData();
	}
