...
// USE /[MANUAL GQT OVERRQ TPEQU_PSEUDCOMPONEN]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcmpki>(m_userContext, false, ref tpequ___pseudcomponenConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TPEQU___PSEUDCOMPONEN", true, firstVisibleColumn: firstVisibleColumn);
