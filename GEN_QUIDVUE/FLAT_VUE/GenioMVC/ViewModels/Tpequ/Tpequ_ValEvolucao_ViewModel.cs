...
// USE /[MANUAL GQT LIST_LIMITS TPEQU_PSEUDEVOLUCAO]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAtabpr> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtabpr> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<Tpequ_ValEvolucao_RowViewModel>();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "tabpr", allSortOrders);
...
// USE /[MANUAL GQT OVERRQ TPEQU_PSEUDEVOLUCAO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtabpr>(m_userContext, false, ref tpequ___pseudevolucaoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TPEQU___PSEUDEVOLUCAO", true, firstVisibleColumn: firstVisibleColumn);
