...
{
	public class Tpequ_ValInstalac_ViewModel : MenuListViewModel<Models.Insta>
	{
		/// <summary>
		...
		public override string Uuid => "Tpequ_ValInstalac";
...
// USE /[MANUAL GQT LIST_LIMITS TPEQU_PSEUDINSTALAC]/
		...
		public Tpequ_ValInstalac_ViewModel() : base(null!) { }
		...
		public Tpequ_ValInstalac_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ TPEQU_PSEUDINSTALAC]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAinsta>(m_userContext, false, ref tpequ___pseudinstalacConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TPEQU___PSEUDINSTALAC", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST TPEQU_PSEUDINSTALAC]/
		...
		{
			List<Tpequ_ValInstalac_RowViewModel> Elements = [];
			int i = 0;
