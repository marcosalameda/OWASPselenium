...
{
	public class Tpequ_ValInstalac_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "DP"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<Tpequ_ValInstalac_RowViewModel> Menu { get; set; }

		/// <inheritdoc/>
		public override string TableAlias { get => "insta"; }

		/// <inheritdoc/>
		public override string Uuid { get => "Tpequ_ValInstalac"; }
		...
		{
// USE /[MANUAL GQT LIST_LIMITS TPEQU_PSEUDINSTALAC]/
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Tpequ_ValInstalac_ViewModel" /> class.
		/// </summary>
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Tpequ_ValInstalac_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Insta.AddEPH<CSGenioAinsta>(ref u, crs, "IBL_TPEQU___PSEUDINSTALAC");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Insta.AddEPH<CSGenioAinsta>(ref u, null, "IBL_TPEQU___PSEUDINSTALAC"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAinsta> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("form_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet tpequ___pseudinstalacConds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "IBL_TPEQU___PSEUDINSTALAC");
				...
				conditions.SubSets.Add(tpequ___pseudinstalacConds);
				tpequ___pseudinstalacConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ TPEQU_PSEUDINSTALAC]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAinsta>(m_userContext, false, tpequ___pseudinstalacConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TPEQU___PSEUDINSTALAC", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP TPEQU_PSEUDINSTALAC]/
				...
				if (tableReload)
				{
// USE /[MANUAL GQT OVERRQLIST TPEQU_PSEUDINSTALAC]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAinsta.GetInformation(), QMVC_POS_RECORD, sorts, tpequ___pseudinstalacConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
					...
					Menu.Elements = MapTpequ_ValInstalac(listing);

					Menu.Identifier = "IBL_TPEQU___PSEUDINSTALAC";

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "IBL_TPEQU___PSEUDINSTALAC";
		...
		private List<Tpequ_ValInstalac_RowViewModel> MapTpequ_ValInstalac(ListingMVC<CSGenioAinsta> Qlisting)
		{
			var Elements = new List<Tpequ_ValInstalac_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapTpequ_ValInstalac(row));
					i++;
				}
			}
		...
		/// to a Tpequ_ValInstalac_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Tpequ_ValInstalac_RowViewModel MapTpequ_ValInstalac(CSGenioAinsta row)
		{
			var model = new Tpequ_ValInstalac_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(Tpequ_ValInstalac_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TPEQU_VALINSTALAC]/
		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Insta", "Insta.ValCodinsta", "Insta.ValZzstate", "Insta.ValDesignat", "Insta.ValDtiniage", "Insta.ValDtfimage", "Insta.ValDescript", "Insta.ValAllday", "Insta.ValSince", "Insta.ValUntil", "Insta.ValHours", "Insta.ValPrecohor", "Insta.ValValue", "Insta.ValCoordgeo", "Insta.ValCodequip", "Insta.ValCodtpequ", "BtnPermission"
		];
