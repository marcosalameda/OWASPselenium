...
// USE /[MANUAL GQT OVERRQ TPEQU_PSEUDUNICO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtpequ>(m_userContext, false, ref tpequ___pseudunico___Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TPEQU___PSEUDUNICO___", true, firstVisibleColumn: firstVisibleColumn);
