...
// USE /[MANUAL GQT VIEWMODEL_SAVE TPPRO]/
		public override void Save()
		{
			...
			try { Model = Models.Tppro.Find(Navigation.GetStrValue("tppro"), m_userContext, "FTPPRO"); }
			finally { if (Model == null) Model = new Models.Tppro(m_userContext) { Identifier = "FTPPRO" }; }
