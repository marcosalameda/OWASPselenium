...
public class GQT_Menu_911_RowViewModel : Models.Tradu
{
	#region Constructors

	public GQT_Menu_911_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_911_RowViewModel(UserContext userContext, CSGenioAtradu val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
