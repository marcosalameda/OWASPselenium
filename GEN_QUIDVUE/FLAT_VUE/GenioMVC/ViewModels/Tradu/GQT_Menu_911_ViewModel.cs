...
// USE /[MANUAL GQT LIST_LIMITS 911]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAtradu> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtradu> Qlisting, ref CriteriaSet conditions)
		{
			...
			}, "ms", "Time to load the menu."))
			{
				...
				List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig.ColumnOrderBy, "tradu", allSortOrders);
