...
namespace GenioMVC.ViewModels.Tradu
{
	public class Tradu_Lang1ValLangua_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Tradu_Lang1ValLangua", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlang1.FldCodlang, CSGenioAlang1.FldZzstate, CSGenioAlang1.FldLangua };
			...
			tradu___lang1langua__Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST TRADU_LANG1LANGUA]/
				...
				ListingMVC<CSGenioAlang1> listing = Models.ModelBase.Where<CSGenioAlang1>(m_userContext, false, tradu___lang1langua__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TRADU___LANG1LANGUA__", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Lang1(m_userContext, true, _fieldsToSerialize);
		...
		private void SetDocumentFields(ListingMVC<CSGenioAlang1> listing)
		{
			...
			foreach (CSGenioAlang1 row in listing.Rows)
			{
			}
		}
