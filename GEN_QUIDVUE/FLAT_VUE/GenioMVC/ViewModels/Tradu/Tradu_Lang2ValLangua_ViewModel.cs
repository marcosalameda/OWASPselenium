...
namespace GenioMVC.ViewModels.Tradu
{
	public class Tradu_Lang2ValLangua_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "Tradu_Lang2ValLangua", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAlang2.FldCodlang, CSGenioAlang2.FldZzstate, CSGenioAlang2.FldLangua };
			...
			tradu___lang2langua__Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST TRADU_LANG2LANGUA]/
				...
				ListingMVC<CSGenioAlang2> listing = Models.ModelBase.Where<CSGenioAlang2>(m_userContext, false, tradu___lang2langua__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TRADU___LANG2LANGUA__", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Lang2(m_userContext, true, _fieldsToSerialize);
		...
		private void SetDocumentFields(ListingMVC<CSGenioAlang2> listing)
		{
			...
			foreach (CSGenioAlang2 row in listing.Rows)
			{
			}
		}
