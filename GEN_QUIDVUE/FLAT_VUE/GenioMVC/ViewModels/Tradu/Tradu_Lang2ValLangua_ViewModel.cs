...
// USE /[MANUAL GQT LIST_LIMITS TRADU_LANG2LANGUA]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAlang2> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAlang2> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<Tradu_Lang2ValLangua_RowViewModel>();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "lang2", allSortOrders);
...
// USE /[MANUAL GQT OVERRQ TRADU_LANG2LANGUA]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlang2>(m_userContext, false, ref tradu___lang2langua__Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TRADU___LANG2LANGUA__", true, firstVisibleColumn: firstVisibleColumn);
