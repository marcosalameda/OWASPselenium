...
// USE /[MANUAL GQT OVERRQLIST TRADU_LANG2LANGUA]/
					...
					ListingMVC<CSGenioAlang2> listing = Models.ModelBase.Where<CSGenioAlang2>(m_userContext, false, tradu___lang2langua__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TRADU___LANG2LANGUA__", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Tradu_Lang2ValLangua_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Tradu_Lang2ValLangua_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRADU_LANG2VALLANGUA]/
		...
		[
			"Lang2", "Lang2.ValCodlang", "Lang2.ValZzstate", "Lang2.ValLangua", "BtnPermission"
		];
