...
public class PTN_Menu_3141_RowViewModel : Models.Trsb
{
	#region Constructors
	...
	public PTN_Menu_3141_RowViewModel(UserContext userContext, CSGenioAtrsb val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
