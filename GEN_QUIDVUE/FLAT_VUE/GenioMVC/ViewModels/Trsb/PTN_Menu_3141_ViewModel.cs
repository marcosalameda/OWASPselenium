...
{
	public class PTN_Menu_3141_ViewModel : MenuListViewModel<Models.Trsb>
	{
		/// <summary>
...
// USE /[MANUAL PTN OVERRQ 3141]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtrsb>(m_userContext, false, ref ptn_menu_3141Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3141", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3141]/
				...
				ListingMVC<CSGenioAtrsb> listing = Models.ModelBase.Where<CSGenioAtrsb>(m_userContext, distinct, ptn_menu_3141Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3141", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
