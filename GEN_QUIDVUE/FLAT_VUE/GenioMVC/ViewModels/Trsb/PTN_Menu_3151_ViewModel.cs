...
// USE /[MANUAL PTN OVERRQ 3151]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAtrsb>(m_userContext, false, ptn_menu_3151Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3151", true, firstVisibleColumn: firstVisibleColumn);
