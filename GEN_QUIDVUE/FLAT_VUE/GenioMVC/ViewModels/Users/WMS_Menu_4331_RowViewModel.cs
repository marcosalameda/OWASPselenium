...
public class WMS_Menu_4331_RowViewModel : Models.Users
{
	#region Constructors

	public WMS_Menu_4331_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public WMS_Menu_4331_RowViewModel(UserContext userContext, CSGenioAusers val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
