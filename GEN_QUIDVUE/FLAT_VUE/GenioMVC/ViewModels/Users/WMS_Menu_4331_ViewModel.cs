...
// USE /[MANUAL WMS LIST_LIMITS 4331]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAusers> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAusers> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<WMS_Menu_4331_RowViewModel>();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "users", allSortOrders);
...
// USE /[MANUAL WMS OVERRQ 4331]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAusers>(m_userContext, false, ref wms_menu_4331Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4331", true, firstVisibleColumn: firstVisibleColumn);
