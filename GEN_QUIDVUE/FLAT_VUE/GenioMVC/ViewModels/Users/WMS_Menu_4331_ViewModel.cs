...
FieldRef[] fields = new FieldRef[] { CSGenioAusers.FldCodusers, CSGenioAusers.FldZzstate, CSGenioAusers.FldCodpsw, CSGenioApsw.FldCodpsw, CSGenioApsw.FldNome, CSGenioAusers.FldCodperso, CSGenioAperso.FldCodperso, CSGenioAperso.FldName };
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "WMS_Menu_4331", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAusers.FldCodusers, CSGenioAusers.FldZzstate, CSGenioAusers.FldCodpsw, CSGenioApsw.FldCodpsw, CSGenioApsw.FldNome, CSGenioAusers.FldCodperso, CSGenioAperso.FldCodperso, CSGenioAperso.FldName };
			...
			wms_menu_4331Conds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQLIST 4331]/
				...
				ListingMVC<CSGenioAusers> listing = Models.ModelBase.Where<CSGenioAusers>(m_userContext, false, wms_menu_4331Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4331", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
		...
		{
			var model = new Models.Users(m_userContext, true, _fieldsToSerialize);
