...
// USE /[MANUAL GQT VIEWMODEL_SAVE VISIT]/
		public override void Save()
		{
			...
			try { Model = Models.Visit.Find(Navigation.GetStrValue("visit"), m_userContext, "FVISIT"); }
			finally { if (Model == null) Model = new Models.Visit(m_userContext) { Identifier = "FVISIT" }; }
