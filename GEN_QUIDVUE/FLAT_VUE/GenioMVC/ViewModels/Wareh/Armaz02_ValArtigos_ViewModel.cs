...
{
	public class Armaz02_ValArtigos_ViewModel : MenuListViewModel<Models.Item>
	{
		/// <summary>
...
// USE /[MANUAL GQT LIST_LIMITS ARMAZ02_PSEUDARTIGOS]/
		...
		public Armaz02_ValArtigos_ViewModel() : base(null!) { }
		...
		public Armaz02_ValArtigos_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST ARMAZ02_PSEUDARTIGOS]/
					...
					ListingMVC<CSGenioAitem> listing = Models.ModelBase.Where<CSGenioAitem>(m_userContext, false, armaz02_pseudartigos_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAZ02_PSEUDARTIGOS_", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<Armaz02_ValArtigos_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Armaz02_ValArtigos_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Armaz02_ValArtigos_RowViewModel MapArmaz02_ValArtigos(CSGenioAitem row)
		{
			var model = new Armaz02_ValArtigos_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
