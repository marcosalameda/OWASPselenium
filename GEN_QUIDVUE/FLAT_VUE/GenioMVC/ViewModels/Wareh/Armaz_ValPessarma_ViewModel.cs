...
// USE /[MANUAL GQT OVERRQLIST ARMAZ_PSEUDPESSARMA]/
		...
		{
			var Elements = new List<Armaz_ValPessarma_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Armaz_ValPessarma_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM ARMAZ_VALPESSARMA]/
		...
		[
			"Wpess", "Wpess.ValCodpess", "Wpess.ValZzstate", "Wpess.ValName", "Wpess.ValSex", "Wpess.ValNfunc", "Wpess.ValCodwareh", "BtnPermission"
		];
