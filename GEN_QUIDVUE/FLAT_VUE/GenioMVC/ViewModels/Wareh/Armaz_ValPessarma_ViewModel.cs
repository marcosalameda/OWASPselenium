...
namespace GenioMVC.ViewModels.Wareh
{
	public class Armaz_ValPessarma_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValPessarma", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAwpess.FldCodpess, CSGenioAwpess.FldZzstate, CSGenioAwpess.FldName, CSGenioAwpess.FldSex, CSGenioAwpess.FldNfunc };
			...
			armaz___pseudpessarmaConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ ARMAZ_PSEUDPESSARMA]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioAwpess>(m_userContext, false, armaz___pseudpessarmaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAZ___PSEUDPESSARMA", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ARMAZ_PSEUDPESSARMA]/
				...
				ListingMVC<CSGenioAwpess> listing = Models.ModelBase.Where<CSGenioAwpess>(m_userContext, false, armaz___pseudpessarmaConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAZ___PSEUDPESSARMA", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
