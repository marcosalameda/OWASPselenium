...
// USE /[MANUAL GQT VIEWMODEL_SAVE BTNSFORM]/
		public override void Save()
		{
			...
			try { Model = Models.Wareh.Find(Navigation.GetStrValue("wareh"), m_userContext, "FBTNSFORM"); }
			finally { if (Model == null) Model = new Models.Wareh(m_userContext) { Identifier = "FBTNSFORM" }; }
