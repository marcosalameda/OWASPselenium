...
{
	public class GQT_Menu_461_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "c57ebd33-a9eb-45a9-83fa-a0ebd4db3a84"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_461Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML461");
			gqt_menu_461Conds.Equal(CSGenioAwareh.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 461]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_461Conds, listing);
...
// USE /[MANUAL GQT OVERRQ 461]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, gqt_menu_461Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML461", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 461]/
					...
					ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, gqt_menu_461Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML461", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_461_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_461_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
