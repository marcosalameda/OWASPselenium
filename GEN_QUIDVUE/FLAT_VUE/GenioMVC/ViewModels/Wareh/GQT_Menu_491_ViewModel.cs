...
namespace GenioMVC.ViewModels.Wareh
{
	public class GQT_Menu_491_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_491Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML491");
			gqt_menu_491Conds.Equal(CSGenioAwareh.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 491]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_491Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 491]/
					...
					ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, gqt_menu_491Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML491", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_491_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_491_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
