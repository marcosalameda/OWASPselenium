...
{
	public class GQT_Menu_491_ViewModel : MenuListViewModel<Models.Wareh>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<GQT_Menu_491_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "265c0c22-e05f-4449-9b6f-2218715f1a3d";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS 491]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML491");
		...
		public GQT_Menu_491_ViewModel() : base(null!) { }
		...
		public GQT_Menu_491_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<GQT_Menu_491_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAwareh> Qlisting, ref CriteriaSet conditions)
		{
			...
			gqt_menu_491Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 491]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAwareh>(m_userContext, false, ref gqt_menu_491Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML491", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 491]/
				...
				ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, distinct, gqt_menu_491Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML491", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<GQT_Menu_491_RowViewModel> MapGQT_Menu_491(ListingMVC<CSGenioAwareh> Qlisting)
		{
			List<GQT_Menu_491_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a GQT_Menu_491_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_491_RowViewModel MapGQT_Menu_491(CSGenioAwareh row)
		{
			var model = new GQT_Menu_491_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
