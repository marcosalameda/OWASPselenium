...
{
	public class STY_Menu_EXPOSETABLE_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "5a78032b-d6ee-4835-a462-b5172b68f789"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet sty_menu_exposetableConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLEXPOSETABLE");
			sty_menu_exposetableConds.Equal(CSGenioAwareh.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						sty_menu_exposetableConds.Equal(CSGenioAwareh.FldShowreco, 1);
...
// USE /[MANUAL STY OVERRQ EXPOSETABLE]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(sty_menu_exposetableConds, listing);
...
// USE /[MANUAL STY OVERRQ EXPOSETABLE]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, sty_menu_exposetableConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLEXPOSETABLE", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST EXPOSETABLE]/
					...
					ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, sty_menu_exposetableConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLEXPOSETABLE", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<STY_Menu_EXPOSETABLE_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(STY_Menu_EXPOSETABLE_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM STY_MENU_EXPOSETABLE]/
		...
		[
			"Wareh", "Wareh.ValCodwareh", "Wareh.ValZzstate", "Wareh.ValWarehdes", "Wareh.ValWarehcod", "Wareh.ValActivity", "BtnPermission"
		];
