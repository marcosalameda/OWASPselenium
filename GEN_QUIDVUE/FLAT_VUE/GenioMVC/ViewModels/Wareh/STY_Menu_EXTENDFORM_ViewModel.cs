...
{
	public class STY_Menu_EXTENDFORM_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "48d615f9-915f-4df1-8b3a-b03dde4a3d70"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet sty_menu_extendformConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLEXTENDFORM");
			sty_menu_extendformConds.Equal(CSGenioAwareh.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						sty_menu_extendformConds.Equal(CSGenioAwareh.FldShowreco, 1);
...
// USE /[MANUAL STY OVERRQ EXTENDFORM]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(sty_menu_extendformConds, listing);
...
// USE /[MANUAL STY OVERRQ EXTENDFORM]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, sty_menu_extendformConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLEXTENDFORM", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST EXTENDFORM]/
		...
		{
			var Elements = new List<STY_Menu_EXTENDFORM_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(STY_Menu_EXTENDFORM_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
