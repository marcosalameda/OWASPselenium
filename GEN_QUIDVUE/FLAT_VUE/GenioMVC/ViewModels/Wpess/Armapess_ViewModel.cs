...
// USE /[MANUAL GQT VIEWMODEL_SAVE ARMAPESS]/
		public override void Save()
		{
			...
			try { Model = Models.Wpess.Find(Navigation.GetStrValue("wpess"), m_userContext, "FARMAPESS"); }
			finally { if (Model == null) Model = new Models.Wpess(m_userContext) { Identifier = "FARMAPESS" }; }
