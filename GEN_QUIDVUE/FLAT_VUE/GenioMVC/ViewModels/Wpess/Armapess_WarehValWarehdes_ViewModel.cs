...
{
	public class Armapess_WarehValWarehdes_ViewModel : MenuListViewModel<Models.Wareh>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Armapess_WarehValWarehdes_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Armapess_WarehValWarehdes";
...
// USE /[MANUAL GQT LIST_LIMITS ARMAPESS_WAREHWAREHDES]/
		...
		public Armapess_WarehValWarehdes_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Armapess_WarehValWarehdes_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Armapess_WarehValWarehdes_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Armapess_WarehValWarehdes_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Armapess_WarehValWarehdes_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAwareh> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(armapesswarehwarehdesConds);
			armapesswarehwarehdesConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ ARMAPESS_WAREHWAREHDES]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAwareh>(m_userContext, false, ref armapesswarehwarehdesConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAPESSWAREHWAREHDES", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ARMAPESS_WAREHWAREHDES]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAwareh.GetInformation(), QMVC_POS_RECORD, sorts, armapesswarehwarehdesConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAwareh> listing = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, distinct, armapesswarehwarehdesConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAPESSWAREHWAREHDES", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Armapess_WarehValWarehdes_RowViewModel> MapArmapess_WarehValWarehdes(ListingMVC<CSGenioAwareh> Qlisting)
		{
			List<Armapess_WarehValWarehdes_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Armapess_WarehValWarehdes_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Armapess_WarehValWarehdes_RowViewModel MapArmapess_WarehValWarehdes(CSGenioAwareh row)
		{
			var model = new Armapess_WarehValWarehdes_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
