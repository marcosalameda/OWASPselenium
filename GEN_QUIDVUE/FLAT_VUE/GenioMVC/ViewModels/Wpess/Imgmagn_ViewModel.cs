...
namespace GenioMVC.ViewModels.Wpess
{
	public class Imgmagn_ViewModel : FormViewModel<Models.Wpess>
	{
		...
		public GenioMVC.ViewModels.ImageModel ValFtbackgr { get; set; }
...
// USE /[MANUAL GQT VIEWMODEL_SAVE IMGMAGN]/
		public override void Save()
		{
			...
			try { Model = Models.Wpess.Find(Navigation.GetStrValue("wpess"), m_userContext, "FIMGMAGN"); }
			finally { if (Model == null) Model = new Models.Wpess(m_userContext) { Identifier = "FIMGMAGN" }; }
