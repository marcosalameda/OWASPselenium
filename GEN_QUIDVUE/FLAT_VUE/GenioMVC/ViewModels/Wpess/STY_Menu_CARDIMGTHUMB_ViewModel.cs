...
// USE /[MANUAL STY OVERRQ CARDIMGTHUMB]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAwpess>(m_userContext, false, ref sty_menu_cardimgthumbConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLCARDIMGTHUMB", true, firstVisibleColumn: firstVisibleColumn);
