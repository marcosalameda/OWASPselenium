...
{
	public class STY_Menu_CARDIMGTOP_ViewModel : MenuListViewModel<Models.Wpess>
	{
		/// <summary>
		...
		public override string Uuid => "0e99ffff-7adf-43a1-9968-81840cdfb35c";
...
// USE /[MANUAL STY LIST_LIMITS CARDIMGTOP]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLCARDIMGTOP");
		...
		public STY_Menu_CARDIMGTOP_ViewModel() : base(null!) { }
		...
		public STY_Menu_CARDIMGTOP_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL STY OVERRQ CARDIMGTOP]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAwpess>(m_userContext, false, ref sty_menu_cardimgtopConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLCARDIMGTOP", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST CARDIMGTOP]/
				...
				ListingMVC<CSGenioAwpess> listing = Models.ModelBase.Where<CSGenioAwpess>(m_userContext, distinct, sty_menu_cardimgtopConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLCARDIMGTOP", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<STY_Menu_CARDIMGTOP_RowViewModel> Elements = [];
			int i = 0;
