...
public class STY_Menu_IMGBACKGROUND_RowViewModel : Models.Wpess
{
	#region Constructors

	public STY_Menu_IMGBACKGROUND_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public STY_Menu_IMGBACKGROUND_RowViewModel(UserContext userContext, CSGenioAwpess val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
