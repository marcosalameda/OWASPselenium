...
// USE /[MANUAL STY LIST_LIMITS IMGBACKGROUND]/
		...
		public override List<Exports.QColumn> GetColumnsToExport()
		{
			...
			[
				...
				new Exports.QColumn(CSGenioAwpess.FldShowreco, FieldType.LOGIC, Resources.Resources.SHOW_RECORD11620, 1, 0, false),
			];
		}
...
// USE /[MANUAL STY OVERRQ IMGBACKGROUND]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAwpess>(m_userContext, false, ref sty_menu_imgbackgroundConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLIMGBACKGROUND", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST IMGBACKGROUND]/
				...
				ListingMVC<CSGenioAwpess> listing = Models.ModelBase.Where<CSGenioAwpess>(m_userContext, distinct, sty_menu_imgbackgroundConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLIMGBACKGROUND", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM STY_MENU_IMGBACKGROUND]/
		...
		[
			"Wpess", "Wpess.ValCodpess", "Wpess.ValZzstate", "Wpess.ValName", "Wpess.ValDate", "Wpess.ValSex", "Wpess.ValNfunc", "Wpess.ValAdress", "Wpess.ValZipcode", "Wpess.ValCountry", "Wpess.ValEmail", "Wpess.ValCellphon", "Wpess.ValNaturali", "Wpess.ValNacional", "Wareh", "Wareh.ValWarehdes", "Wpess.ValFtbackgr", "Wpess.ValShowreco", "Wpess.ValCodwareh"
		];
		...
		[
			...
			new TableSearchColumn("ValShowreco", CSGenioAwpess.FldShowreco, typeof(bool), visible : false),
		];
