...
{
	public class STY_Menu_IMGBACKGROUND_ViewModel : MenuListViewModel<Models.Wpess>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "1e458cba-04d7-4e05-b1f9-079d14d87bcf";
		...
		{
// USE /[MANUAL STY LIST_LIMITS IMGBACKGROUND]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLIMGBACKGROUND");
		...
		public STY_Menu_IMGBACKGROUND_ViewModel() : base(null!) { }
		...
		public STY_Menu_IMGBACKGROUND_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL STY OVERRQLIST IMGBACKGROUND]/
		...
		{
			List<STY_Menu_IMGBACKGROUND_RowViewModel> Elements = [];
			int i = 0;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM STY_MENU_IMGBACKGROUND]/
		...
		[
			"Wpess", "Wpess.ValCodpess", "Wpess.ValZzstate", "Wpess.ValName", "Wpess.ValDate", "Wpess.ValSex", "Wpess.ValNfunc", "Wpess.ValAdress", "Wpess.ValZipcode", "Wpess.ValCountry", "Wpess.ValEmail", "Wpess.ValCellphon", "Wpess.ValNaturali", "Wpess.ValNacional", "Wareh", "Wareh.ValWarehdes", "Wpess.ValFtbackgr", "Wpess.ValCodwareh"
		];
