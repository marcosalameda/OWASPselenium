...
// USE /[MANUAL STY LIST_LIMITS PESSCARD]/
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAwpess> Qlisting, ref CriteriaSet conditions)
		{
			...
			sty_menu_pesscardConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL STY OVERRQ PESSCARD]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAwpess>(m_userContext, false, ref sty_menu_pesscardConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLPESSCARD", true, firstVisibleColumn: firstVisibleColumn);
