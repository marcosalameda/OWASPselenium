...
public class Ano_ValAgregado_RowViewModel : Models.Agreg
{
	#region Constructors

	public Ano_ValAgregado_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Ano_ValAgregado_RowViewModel(UserContext userContext, CSGenioAagreg val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
