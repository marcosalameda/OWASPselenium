...
namespace GenioMVC.ViewModels.Year
{
	public class Ano_ValTodasdes_ViewModel : ListViewModel
	{
		...
		public CriteriaSet BuildCriteriaSet(NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			LoadUserTableConfig(requestValues, allSortOrders, "ValTodasdes", ref numberListItems);
...
FieldRef[] fields = new FieldRef[] { CSGenioAexpen.FldCoddespe, CSGenioAexpen.FldZzstate, CSGenioAexpen.FldDescript, CSGenioAexpen.FldValue };
			...
			ano_____pseudtodasdesConds = BuildCriteriaSet(requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLIST ANO_PSEUDTODASDES]/
				...
				ListingMVC<CSGenioAexpen> listing = Models.ModelBase.Where<CSGenioAexpen>(m_userContext, false, ano_____pseudtodasdesConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ANO_____PSEUDTODASDES", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
