...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("coddttyp", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("string", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("uuid", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("uppercas", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("qrcode", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("multilin", FieldType.MEMO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("multili3", FieldType.MEMO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("boolean", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("boolean2", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("smallint", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("integer", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("bigint", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("real", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("float", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("decimal", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("decimal9", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("money", FieldType.VALOR);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("money9", FieldType.VALOR);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("dtsesond", FieldType.DATASEGUNDO);
		...
		/// <summary>Field : "Conditional (smallint) (storage: 2 byte)" Tipo: "IF" Formula:  ""</summary>
		public double ValBoolean2
		{
			get { return (double)returnValueField(FldBoolean2); }
		...
		/// <summary>Field : "Numeric  4.0 - small integer (storage: 2 byte)" Tipo: "N" Formula:  ""</summary>
		public double ValSmallint
		{
			get { return (double)returnValueField(FldSmallint); }
		...
		/// <summary>Field : "Numeric  9.0 - integer (storage: 4 byte)" Tipo: "N" Formula:  ""</summary>
		public double ValInteger
		{
			get { return (double)returnValueField(FldInteger); }
		...
		/// <summary>Field : "Numeric 15.0 - big integer (storage: 8 byte)" Tipo: "N" Formula:  ""</summary>
		public double ValBigint
		{
			get { return (double)returnValueField(FldBigint); }
		...
		{
			get { return (double)returnValueField(FldReal); }
		...
		{
			get { return (double)returnValueField(FldFloat); }
		...
		/// <summary>Field : "Decimal (1-10) (storage: 5 byte)" Tipo: "ND" Formula:  ""</summary>
		public double ValDecimal
		{
			get { return (double)returnValueField(FldDecimal); }
		...
		/// <summary>Field : "Decimal (11-15) (storage: 9 byte)" Tipo: "ND" Formula:  ""</summary>
		public double ValDecimal9
		{
			get { return (double)returnValueField(FldDecimal9); }
		...
		{
			get { return (double)returnValueField(FldMoney); }
		...
		/// <summary>Field : "Money - decimal (11-15) (storage: 9 byte)" Tipo: "$D" Formula:  ""</summary>
		public double ValMoney9
		{
			get { return (double)returnValueField(FldMoney9); }
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        [Obsolete("Use List<CSGenioAdttyp> searchList(PersistentSupport sp, User user, CriteriaSet where, string []fields) instead")]
        public static List<CSGenioAdttyp> searchList(PersistentSupport sp, User user, string where, string []fields = null)
        {
            return sp.searchListWhere<CSGenioAdttyp>(where, user, fields);
        }
