...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codglob", FieldType.CHAVE_PRIMARIA_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("home", FieldType.MEMO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pzero", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("remetent", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("semrspdd", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("semrspin", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("semrpbsc", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("semrpini", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("semrpact", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pvalmin", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("plimmau", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("palert", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("plimbom", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("plimsup", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pvalmax", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pzerod", FieldType.NUMERO);
			Qfield.FieldDescription = "0%";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			Qfield.Formula = new InternalOperationFormula(argumentsListByArea, 1, delegate(object[] args, User user, string module, PersistentSupport sp) {
				return 100+(100-((double)args[0]));
			});
			info.RegisterFieldDB(Qfield);

			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pvalmind", FieldType.NUMERO);
			Qfield.FieldDescription = "Minimum";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("palertd", FieldType.NUMERO);
			Qfield.FieldDescription = "Alert";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("plimbomd", FieldType.NUMERO);
			Qfield.FieldDescription = "Good";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("plimsupd", FieldType.NUMERO);
			Qfield.FieldDescription = "Overcome";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pvalmaxd", FieldType.NUMERO);
			Qfield.FieldDescription = "Maximum";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("iniciano", FieldType.ARRAY_COD_TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pzeroc", FieldType.NUMERO);
			Qfield.FieldDescription = "0%";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pminc", FieldType.NUMERO);
			Qfield.FieldDescription = "Minimum";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pmauc", FieldType.NUMERO);
			Qfield.FieldDescription = "Bad";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("palertc", FieldType.NUMERO);
			Qfield.FieldDescription = "Alert";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("plimmaud", FieldType.NUMERO);
			Qfield.FieldDescription = "Bad";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pbomc", FieldType.NUMERO);
			Qfield.FieldDescription = "Good";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pbomsc", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("palertsc", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pmausc", FieldType.NUMERO);
			Qfield.FieldDescription = "Bad";
			Qfield.FieldSize =  6;
			Qfield.Alias = info.Alias;
			Qfield.Decimals = 2;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pmaxsc", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pzerosc", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("tipscard", FieldType.ARRAY_COD_TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("organism", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("morada", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("cpostal", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("lpostal", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("fax", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("site", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("simbolo", FieldType.IMAGEM_JPEG);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("simbolol", FieldType.IMAGEM_JPEG);
			Qfield.FieldDescription = "Header";
			Qfield.FieldSize =  14;
			Qfield.Alias = info.Alias;
			Qfield.CavDesignation = "CABECALHO50133";
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("footerp", FieldType.IMAGEM_JPEG);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("footerl", FieldType.IMAGEM_JPEG);
			Qfield.FieldDescription = "Footer";
			Qfield.FieldSize =  14;
			Qfield.Alias = info.Alias;
			Qfield.CavDesignation = "RODAPE46446";
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("marcagua", FieldType.IMAGEM_JPEG);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("logomint", FieldType.IMAGEM_JPEG);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pathdocu", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("smtpmail", FieldType.TEXTO);
			Qfield.FieldDescription = "Sender Email";
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("servsmtp", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("smtpport", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("smtpssl", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("smtpuser", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("smtppass", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("tpbonifi", FieldType.ARRAY_COD_TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("mostrano", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("sodiasut", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("executou", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("xmlgraph", FieldType.MEMO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("filtrorg", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("scoreout", FieldType.ARRAY_COD_TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("minister", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("dtultnot", FieldType.DATA);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("integdoc", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("prefobje", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("prefindi", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("gantunit", FieldType.ARRAY_COD_TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("gantstep", FieldType.NUMERO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("migrarlt", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("filtrrsp", FieldType.LOGICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("docbd", FieldType.FICHEIRO_BD);
			...
			Qfield.Dupmsg = "";
			info.RegisterFieldDB(Qfield);
 			Qfield = new Field("docbdfk", FieldType.CHAVE_ESTRANGEIRA_GUID);
			Qfield.FieldSize = 16;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("horassem", FieldType.ARRAY_COD_NUMERICO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("afetacao", FieldType.ARRAY_COD_TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("pricolor", FieldType.TEXTO);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("codfacty", FieldType.CHAVE_ESTRANGEIRA_GUID);
			Qfield.FieldDescription = "";
			Qfield.FieldSize =  36;
			Qfield.Alias = info.Alias;
			Qfield.MQueue = false;
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("legend", FieldType.IMAGEM_JPEG);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field("apiurl", FieldType.TEXTO);
		...
		/// <summary>Field : "0%" Tipo: "N" Formula:  ""</summary>
		public double ValPzero
		{
			get { return (double)returnValueField(FldPzero); }
		...
		/// <summary>Field : "Minimum" Tipo: "N" Formula:  ""</summary>
		public double ValPvalmin
		{
			get { return (double)returnValueField(FldPvalmin); }
		...
		/// <summary>Field : "Bad" Tipo: "N" Formula:  ""</summary>
		public double ValPlimmau
		{
			get { return (double)returnValueField(FldPlimmau); }
		...
		/// <summary>Field : "Alert" Tipo: "N" Formula:  ""</summary>
		public double ValPalert
		{
			get { return (double)returnValueField(FldPalert); }
		...
		/// <summary>Field : "Good" Tipo: "N" Formula:  ""</summary>
		public double ValPlimbom
		{
			get { return (double)returnValueField(FldPlimbom); }
		...
		/// <summary>Field : "Overcome" Tipo: "N" Formula:  ""</summary>
		public double ValPlimsup
		{
			get { return (double)returnValueField(FldPlimsup); }
		...
		/// <summary>Field : "Maximum" Tipo: "N" Formula:  ""</summary>
		public double ValPvalmax
		{
			get { return (double)returnValueField(FldPvalmax); }
		...
		/// <summary>Field : "0%" Tipo: "N" Formula: + "100+(100-[GLOB->PZERO])"</summary>
		public double ValPzerod
		{
			get { return (double)returnValueField(FldPzerod); }
		...
		/// <summary>Field : "Minimum" Tipo: "N" Formula: + "100+(100-[GLOB->PVALMAX])"</summary>
		public double ValPvalmind
		{
			get { return (double)returnValueField(FldPvalmind); }
		...
		/// <summary>Field : "Alert" Tipo: "N" Formula: + "100+(100-[GLOB->PALERT])"</summary>
		public double ValPalertd
		{
			get { return (double)returnValueField(FldPalertd); }
		...
		/// <summary>Field : "Good" Tipo: "N" Formula: + "100+(100-[GLOB->PLIMBOM])"</summary>
		public double ValPlimbomd
		{
			get { return (double)returnValueField(FldPlimbomd); }
		...
		/// <summary>Field : "Overcome" Tipo: "N" Formula: + "100+(100-[GLOB->PLIMSUP])"</summary>
		public double ValPlimsupd
		{
			get { return (double)returnValueField(FldPlimsupd); }
		...
		/// <summary>Field : "Maximum" Tipo: "N" Formula: + "100+(100-[GLOB->PVALMIN])"</summary>
		public double ValPvalmaxd
		{
			get { return (double)returnValueField(FldPvalmaxd); }
		...
		/// <summary>Field : "0%" Tipo: "N" Formula:  ""</summary>
		public double ValPzeroc
		{
			get { return (double)returnValueField(FldPzeroc); }
		...
		/// <summary>Field : "Minimum" Tipo: "N" Formula:  ""</summary>
		public double ValPminc
		{
			get { return (double)returnValueField(FldPminc); }
		...
		/// <summary>Field : "Bad" Tipo: "N" Formula:  ""</summary>
		public double ValPmauc
		{
			get { return (double)returnValueField(FldPmauc); }
		...
		/// <summary>Field : "Alert" Tipo: "N" Formula:  ""</summary>
		public double ValPalertc
		{
			get { return (double)returnValueField(FldPalertc); }
		...
		/// <summary>Field : "Bad" Tipo: "N" Formula: + "100+(100-[GLOB->PLIMMAU])"</summary>
		public double ValPlimmaud
		{
			get { return (double)returnValueField(FldPlimmaud); }
		...
		/// <summary>Field : "Good" Tipo: "N" Formula:  ""</summary>
		public double ValPbomc
		{
			get { return (double)returnValueField(FldPbomc); }
		...
		/// <summary>Field : "Good sup." Tipo: "N" Formula: + "100+(100-[GLOB->PBOMC])"</summary>
		public double ValPbomsc
		{
			get { return (double)returnValueField(FldPbomsc); }
		...
		/// <summary>Field : "Alert sup." Tipo: "N" Formula: + "100+(100-[GLOB->PALERTC])"</summary>
		public double ValPalertsc
		{
			get { return (double)returnValueField(FldPalertsc); }
		...
		/// <summary>Field : "Bad" Tipo: "N" Formula: + "100+(100-[GLOB->PMAUC])"</summary>
		public double ValPmausc
		{
			get { return (double)returnValueField(FldPmausc); }
		...
		/// <summary>Field : "Maximum Sup." Tipo: "N" Formula: + "100+(100-[GLOB->PMINC])"</summary>
		public double ValPmaxsc
		{
			get { return (double)returnValueField(FldPmaxsc); }
		...
		/// <summary>Field : "100%" Tipo: "N" Formula: + "100+(100-[GLOB->PZEROC])"</summary>
		public double ValPzerosc
		{
			get { return (double)returnValueField(FldPzerosc); }
		...
		/// <summary>Field : "SMTP Port" Tipo: "N" Formula:  ""</summary>
		public double ValSmtpport
		{
			get { return (double)returnValueField(FldSmtpport); }
		...
		/// <summary>Field : "Gantt - Forward" Tipo: "N" Formula:  ""</summary>
		public double ValGantstep
		{
			get { return (double)returnValueField(FldGantstep); }
		...
		/// <summary>Field : "Number of weekly hours" Tipo: "AN" Formula:  ""</summary>
		public double ValHorassem
		{
			get { return (double)returnValueField(FldHorassem); }
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        [Obsolete("Use List<CSGenioAglob> searchList(PersistentSupport sp, User user, CriteriaSet where, string []fields) instead")]
        public static List<CSGenioAglob> searchList(PersistentSupport sp, User user, string where, string []fields = null)
        {
            return sp.searchListWhere<CSGenioAglob>(where, user, fields);
        }
