...
namespace CSGenio.business
{
	...
	/// Warehouse
	/// </summary>
	public class CSGenioAware1 : DbArea	{
		/// <summary>
		...
		public CSGenioAware1(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static FieldRef m_fldCodwareh = new FieldRef("ware1", "codwareh");
		...
		private static FieldRef m_fldWarehcod = new FieldRef("ware1", "warehcod");
		...
		private static FieldRef m_fldShowreco = new FieldRef("ware1", "showreco");
		...
		private static FieldRef m_fldZzstate = new FieldRef("ware1", "zzstate");
        ...
        public static CSGenioAware1 search(PersistentSupport sp, string key, User user, string[] fields = null)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAware1 area = new CSGenioAware1(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        [Obsolete("Use List<CSGenioAware1> searchList(PersistentSupport sp, User user, CriteriaSet where, string []fields) instead")]
        public static List<CSGenioAware1> searchList(PersistentSupport sp, User user, string where, string []fields = null)
        {
            return sp.searchListWhere<CSGenioAware1>(where, user, fields);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAware1> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAware1>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAware1> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAware1>(where, listing);
        }
