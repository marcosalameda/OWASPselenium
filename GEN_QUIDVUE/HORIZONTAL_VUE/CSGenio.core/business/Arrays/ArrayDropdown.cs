...
namespace CSGenio.business
{
	...
	/// </summary>
	public class ArrayDropdown : Array<decimal>
	{
		/// <summary>
		/// The instance
		/// </summary>
		private static readonly ArrayDropdown _instance = new ArrayDropdown();
		...
		/// The instance.
		/// </value>
		public static ArrayDropdown Instance { get => _instance; }
		...
		/// <summary>
		/// Prevents a default instance of the <see cref="ArrayDropdown"/> class from being created.
		/// </summary>
		private ArrayDropdown() : base() {}
		...
		protected override Dictionary<decimal, ArrayElement> LoadDictionary()
		{
			...
			{
				{ E_1_1, new ArrayElement() { ResourceId = "DROPDOWN51902", HelpId = "", Group = "" } },
				{ E_2_2, new ArrayElement() { ResourceId = "INLINE64198", HelpId = "", Group = "" } },
			};
		}
