	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				...
				<q-row v-if="controls.AGENT01_AGENTNAME____.isVisible || controls.AGENT01_AGENTBIRTHDAT.isVisible">
					<q-col
						v-if="controls.AGENT01_AGENTNAME____.isVisible || controls.AGENT01_AGENTBIRTHDAT.isVisible"
						cols="auto">
						<base-input-structure
				...
				<q-row v-if="controls.AGENT01_AGENTEMAIL___.isVisible">
					<q-col
