		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.AGENT05_PSEUDAGENTINF.isVisible">
					<q-control-wrapper
						v-show="controls.AGENT05_PSEUDAGENTINF.isVisible"
						...
						<q-group-box-container
							...
							<q-row-container v-show="controls.AGENT05_AGENTPHOTO___.isVisible">
								<q-control-wrapper
									v-show="controls.AGENT05_AGENTPHOTO___.isVisible"
									class="control-join-group">
							...
							<q-row-container v-show="controls.AGENT05_AGENTNAME____.isVisible">
								<q-control-wrapper
									v-show="controls.AGENT05_AGENTNAME____.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-text"
							...
							<q-row-container v-show="controls.AGENT05_AGENTBIRTHDAT.isVisible">
								<q-control-wrapper
									v-show="controls.AGENT05_AGENTBIRTHDAT.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-text"
							...
							<q-row-container v-show="controls.AGENT05_AGENTEMAIL___.isVisible || controls.AGENT05_AGENTTELEPHON.isVisible">
								<q-control-wrapper
									v-show="controls.AGENT05_AGENTEMAIL___.isVisible || controls.AGENT05_AGENTTELEPHON.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-text"
...
<script>
	...
	import FormViewModel from './QFormAgent05ViewModel.js'

	const requiredTextResources = ['QFormAgent05', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS AGENT05]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormAgent05', false),

				interfaceMetadata: {
					id: 'QFormAgent05', // Used for resources
				...
				controls: {
					AGENT05_PSEUDAGENTINF: new fieldControlClass.GroupControl({
						id: 'AGENT05_PSEUDAGENTINF',
						name: 'AGENTINF',
						size: 'large',
					...
					AGENT05_AGENTPHOTO___: new fieldControlClass.ImageControl({
						modelField: 'ValPhoto',
						valueChangeEvent: 'fieldChange:agent.photo',
						id: 'AGENT05_AGENTPHOTO___',
						name: 'PHOTO',
						size: 'mini',
						label: computed(() => this.Resources.PHOTO51874),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'AGENT05_PSEUDAGENTINF',
						height: 10,
						width: 480,
					...
					AGENT05_AGENTNAME____: new fieldControlClass.StringControl({
						modelField: 'ValName',
						valueChangeEvent: 'fieldChange:agent.name',
						id: 'AGENT05_AGENTNAME____',
						name: 'NAME',
						size: 'xxlarge',
						...
						container: 'AGENT05_PSEUDAGENTINF',
						maxLength: 50,
						labelId: 'label_AGENT05_AGENTNAME____',
						mustBeFilled: true,
						controlLimits: [
						],
					}, this),
					AGENT05_AGENTBIRTHDAT: new fieldControlClass.DateControl({
						modelField: 'ValBirthdat',
						valueChangeEvent: 'fieldChange:agent.birthdat',
						id: 'AGENT05_AGENTBIRTHDAT',
						name: 'BIRTHDAT',
						size: 'medium',
					...
					AGENT05_AGENTEMAIL___: new fieldControlClass.MaskControl({
						modelField: 'ValEmail',
						valueChangeEvent: 'fieldChange:agent.email',
						id: 'AGENT05_AGENTEMAIL___',
						name: 'EMAIL',
						size: 'xxlarge',
						...
						container: 'AGENT05_PSEUDAGENTINF',
						maxLength: 50,
						labelId: 'label_AGENT05_AGENTEMAIL___',
						mustBeFilled: true,
						controlLimits: [
						],
					}, this),
					AGENT05_AGENTTELEPHON: new fieldControlClass.StringControl({
						modelField: 'ValTelephon',
						valueChangeEvent: 'fieldChange:agent.telephon',
						id: 'AGENT05_AGENTTELEPHON',
						name: 'TELEPHON',
						size: 'xxlarge',
						...
						container: 'AGENT05_PSEUDAGENTINF',
						maxLength: 50,
						labelId: 'label_AGENT05_AGENTTELEPHON',
						controlLimits: [
						],
					}, this),
				},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD AGENT05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
