				...
				<q-row v-if="controls.AGENT05_PSEUDAGENTINF.isVisible">
					<q-col
						...
						<q-group-box-container
							...
							<q-row v-if="controls.AGENT05_AGENTNAME____.isVisible">
								<q-col
							...
							<q-row v-if="controls.AGENT05_AGENTBIRTHDAT.isVisible">
								<q-col
							...
							<q-row v-if="controls.AGENT05_AGENTEMAIL___.isVisible || controls.AGENT05_AGENTTELEPHON.isVisible">
								<q-col
									v-if="controls.AGENT05_AGENTEMAIL___.isVisible || controls.AGENT05_AGENTTELEPHON.isVisible"
									cols="auto">
									<base-input-structure
