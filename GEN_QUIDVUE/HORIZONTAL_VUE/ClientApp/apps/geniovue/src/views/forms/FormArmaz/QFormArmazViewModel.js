...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'WAREH',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Armaz',
				updateFilesTickets: 'UpdateFilesTicketsArmaz',
				setFile: 'SetFileArmaz'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormArmazViewModel instance.
	 * @returns {QFormArmazViewModel} A new instance of QFormArmazViewModel
	 */
	clone()
	{
