			...
			return {
				...
				controls: {
					...
					ARTIG___PSEUDCONTACOR: new fieldControlClass.TableListControl({
						...
						globalEvents: ['changed-INDOC', 'changed-CCORR', 'changed-ITEM'],
					...
					ARTIG___PSEUDLSAIDAS_: new fieldControlClass.TableListControl({
						...
						globalEvents: ['changed-WAREH', 'changed-OUDOC', 'changed-OUTPU', 'changed-OUTPT', 'changed-ITEM', 'changed-WARE1'],
					...
					ARTIG___ITEM_CATEGORY: new fieldControlClass.MultilineStringControl({
