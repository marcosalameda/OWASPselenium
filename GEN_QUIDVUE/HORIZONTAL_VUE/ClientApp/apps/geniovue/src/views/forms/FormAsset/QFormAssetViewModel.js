...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'ASSET',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Asset',
				updateFilesTickets: 'UpdateFilesTicketsAsset',
				setFile: 'SetFileAsset'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormAssetViewModel instance.
	 * @returns {QFormAssetViewModel} A new instance of QFormAssetViewModel
	 */
	clone()
	{
