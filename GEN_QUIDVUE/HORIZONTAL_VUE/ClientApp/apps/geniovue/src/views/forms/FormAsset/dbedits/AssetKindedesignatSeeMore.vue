<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-asset-kindedesignat-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ASSET___KINDEDESIGNAT_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AssetKindedesignatSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ASSET___KINDEDESIGNAT_SeeMore', false),

				interfaceMetadata: {
					id: 'ASSET___KINDEDESIGNAT_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ASSET___KINDEDESIGNAT_SeeMore',
					name: 'ASSET___KINDEDESIGNAT_SeeMore',
					controller: 'ASSET',
					action: 'ASSET_KindeValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-asset-kindedesignat',
				dismissAction: this.close,
				returnElement: 'ASSET___KINDEDESIGNAT_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-asset-kindedesignat')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Asset_Asset_KindeValDesignat',
