<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-asset-manufname-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ASSET___MANUFNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AssetManufnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ASSET___MANUFNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'ASSET___MANUFNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ASSET___MANUFNAME_____SeeMore',
					name: 'ASSET___MANUFNAME_____SeeMore',
					controller: 'ASSET',
					action: 'ASSET_ManufValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-asset-manufname',
				dismissAction: this.close,
				returnElement: 'ASSET___MANUFNAME_____see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-asset-manufname')
		},
