<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-asset-global-filter-kinde-designat-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ASSET_GLOBAL_FILTER__KINDE__DESIGNAT_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AssetGlobalFilterKindeDesignatSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ASSET_GLOBAL_FILTER__KINDE__DESIGNAT_SeeMore', false),

				interfaceMetadata: {
					id: 'ASSET_GLOBAL_FILTER__KINDE__DESIGNAT_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ASSET_GLOBAL_FILTER__KINDE__DESIGNAT_SeeMore',
					name: 'ASSET_GLOBAL_FILTER__KINDE__DESIGNAT_SeeMore',
					controller: 'ASSET',
					action: 'ASSET_GLOBAL_FILTER_KindeValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-asset-global-filter-kinde-designat',
				dismissAction: this.close,
				returnElement: 'ASSET_GLOBAL_FILTER__KINDE__DESIGNAT_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-asset-global-filter-kinde-designat')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Asset_global_filter_KindeValDesignat',
							serverMode: true,
						...
						uuid: 'Asset_global_filter_Asset_global_filter_KindeValDesignat',
