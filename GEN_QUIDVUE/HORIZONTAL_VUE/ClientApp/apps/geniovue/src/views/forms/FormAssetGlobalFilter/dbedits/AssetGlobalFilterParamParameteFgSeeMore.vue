<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-asset-global-filter-param-paramete-fg-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ASSET_GLOBAL_FILTER__PARAM__PARAMETE_FG_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AssetGlobalFilterParamParameteFgSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ASSET_GLOBAL_FILTER__PARAM__PARAMETE_FG_SeeMore', false),

				interfaceMetadata: {
					id: 'ASSET_GLOBAL_FILTER__PARAM__PARAMETE_FG_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ASSET_GLOBAL_FILTER__PARAM__PARAMETE_FG_SeeMore',
					name: 'ASSET_GLOBAL_FILTER__PARAM__PARAMETE_FG_SeeMore',
					controller: 'ASSET',
					action: 'ASSET_GLOBAL_FILTER_ValParameter'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-asset-global-filter-param-paramete-fg',
				dismissAction: this.close,
				returnElement: 'ASSET_GLOBAL_FILTER__PARAM__PARAMETE_FG_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-asset-global-filter-param-paramete-fg')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Asset_global_filter_ValParameter',
							serverMode: true,
						...
						uuid: 'Asset_global_filter_Asset_global_filter_ValParameter',
