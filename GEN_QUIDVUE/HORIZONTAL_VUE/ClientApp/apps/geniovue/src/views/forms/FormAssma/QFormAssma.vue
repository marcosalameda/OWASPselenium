	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				...
				<q-row v-if="controls.ASSMA___ASSMANAME____.isVisible">
					<q-col
				...
				<q-row v-if="controls.ASSMA___ASSMADIGDOCUM.isVisible">
					<q-col
				...
				<q-row v-if="controls.ASSMA___ASSMANOTES___.isVisible">
					<q-col
		...
		data()
		{
			...
			return {
				...
				controls: {
					...
					ASSMA___ASSMANOTES___: new fieldControlClass.MultilineStringControl({
						modelField: 'ValNotes',
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT ASSMA]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
