	...
	<teleport
		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.CMPKI___TPEQUTIPOEQUI.isVisible">
					<q-control-wrapper
						v-show="controls.CMPKI___TPEQUTIPOEQUI.isVisible"
				...
				<q-row-container v-show="controls.CMPKI___CMPKIORDER___.isVisible || controls.CMPKI___TPEQ1TIPOEQUI.isVisible || controls.CMPKI___CMPKIQUANTIDA.isVisible">
					<q-control-wrapper
						v-show="controls.CMPKI___CMPKIORDER___.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.CMPKI___TPEQ1TIPOEQUI.isVisible || controls.CMPKI___CMPKIQUANTIDA.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
				...
				<q-row-container v-show="controls.CMPKI___CMPKICODE____.isVisible">
					<q-control-wrapper
						v-show="controls.CMPKI___CMPKICODE____.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
				...
				<q-row-container v-show="controls.CMPKI___CMPKIDESCRIPT.isVisible">
					<q-control-wrapper
						v-show="controls.CMPKI___CMPKIDESCRIPT.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-textarea"
				...
				<q-row-container v-show="controls.CMPKI___CMPKIURL_____.isVisible">
					<q-control-wrapper
						v-show="controls.CMPKI___CMPKIURL_____.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
...
<script>
	...
	import FormViewModel from './QFormCmpkiViewModel.js'

	const requiredTextResources = ['QFormCmpki', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS CMPKI]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreCmpkiTpequtipoequi: defineAsyncComponent(() => import('@/views/forms/FormCmpki/dbedits/CmpkiTpequtipoequiSeeMore.vue')),
			QSeeMoreCmpkiTpeq1tipoequi: defineAsyncComponent(() => import('@/views/forms/FormCmpki/dbedits/CmpkiTpeq1tipoequiSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormCmpki', false),

				interfaceMetadata: {
					id: 'QFormCmpki', // Used for resources
				...
				formInfo: {
					...
					route: 'form-CMPKI',
					area: 'CMPKI',
					primaryKey: 'ValCodcmpki',
					designation: computed(() => this.Resources.KIT_COMPONENT05829),
				...
				controls: {
					CMPKI___TPEQUTIPOEQUI: new fieldControlClass.LookupControl({
					...
					CMPKI___TPEQ1TIPOEQUI: new fieldControlClass.LookupControl({
					...
					CMPKI___CMPKICODE____: new fieldControlClass.StringControl({
						modelField: 'ValCode',
						valueChangeEvent: 'fieldChange:cmpki.code',
					...
					CMPKI___CMPKIDESCRIPT: new fieldControlClass.MultilineStringControl({
						modelField: 'ValDescript',
						valueChangeEvent: 'fieldChange:cmpki.descript',
					...
					CMPKI___CMPKIURL_____: new fieldControlClass.StringControl({
						modelField: 'ValUrl',
						valueChangeEvent: 'fieldChange:cmpki.url',
				...
				dataApi: {
					Cmpki: {
						...
						get ValCodtpeq1() { return vm.model.ValCodtpeq1.value },
						set ValCodtpeq1(value) { vm.model.ValCodtpeq1.updateValue(value) },
					...
					keys: {
						/** The primary key of the CMPKI table */
						get cmpki() { return vm.model.ValCodcmpki },
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS CMPKI]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
