<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-comod-pess2name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['COMOD___PESS2NAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ComodPess2nameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('COMOD___PESS2NAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'COMOD___PESS2NAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'COMOD___PESS2NAME_____SeeMore',
					name: 'COMOD___PESS2NAME_____SeeMore',
					controller: 'LENDI',
					action: 'COMOD_Pess2ValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-comod-pess2name',
				dismissAction: this.close,
				returnElement: 'COMOD___PESS2NAME_____see-more_button'
			}
			const props = {
				class: 'q-dialog-see-more',
				title: computed(() => this.Resources.DADATARIANS56438),
				buttons: [
					{
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-comod-pess2name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						globalEvents: ['changed-PESS2', 'changed-STAKE', 'changed-CMPNY'],
						uuid: 'Comod_Comod_Pess2ValName',
