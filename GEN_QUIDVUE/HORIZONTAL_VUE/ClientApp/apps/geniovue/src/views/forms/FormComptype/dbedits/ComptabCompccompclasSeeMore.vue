<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-comptab-compccompclas-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['COMPTAB_COMPCCOMPCLAS_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ComptabCompccompclasSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('COMPTAB_COMPCCOMPCLAS_SeeMore', false),

				interfaceMetadata: {
					id: 'COMPTAB_COMPCCOMPCLAS_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'COMPTAB_COMPCCOMPCLAS_SeeMore',
					name: 'COMPTAB_COMPCCOMPCLAS_SeeMore',
					controller: 'COMPO',
					action: 'COMPTAB_CompcValCompclas'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-comptab-compccompclas',
				headerTitle: computed(() => this.Resources.COMPONENTES_CLASS21159),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'COMPTAB_COMPCCOMPCLAS_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-comptab-compccompclas')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Comptab_CompcValCompclas',
							serverMode: true,
							pkColumn: 'ValCodcompc',
							tableAlias: 'COMPC',
							tableNamePlural: computed(() => this.Resources.COMPONENTES_CLASS21159),
							viewManagement: '',
							showLimitsInfo: true,
							tableTitle: '',
							...
							defaultSearchColumnName: 'ValCompclas',
							defaultSearchColumnNameOriginal: 'ValCompclas',
							defaultColumnSorting: {
								columnName: 'ValCompclas',
								sortOrder: 'asc'
							}
						},
						globalEvents: ['changed-COMPC'],
						uuid: 'Comptab_Comptab_CompcValCompclas',
