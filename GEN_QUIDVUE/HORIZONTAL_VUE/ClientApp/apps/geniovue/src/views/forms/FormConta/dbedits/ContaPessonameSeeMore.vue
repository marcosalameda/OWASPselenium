<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-conta-pessoname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CONTA___PESSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ContaPessonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CONTA___PESSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'CONTA___PESSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CONTA___PESSONAME_____SeeMore',
					name: 'CONTA___PESSONAME_____SeeMore',
					controller: 'CONTA',
					action: 'CONTA_PessoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'CONTA___PESSONAME_____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-conta-pessoname')
		},
