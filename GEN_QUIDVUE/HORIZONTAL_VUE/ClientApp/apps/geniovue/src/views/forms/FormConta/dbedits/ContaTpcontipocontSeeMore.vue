<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-conta-tpcontipocont-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CONTA___TPCONTIPOCONT_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ContaTpcontipocontSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CONTA___TPCONTIPOCONT_SeeMore', false),

				interfaceMetadata: {
					id: 'CONTA___TPCONTIPOCONT_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CONTA___TPCONTIPOCONT_SeeMore',
					name: 'CONTA___TPCONTIPOCONT_SeeMore',
					controller: 'CONTA',
					action: 'CONTA_TpconValTipocont'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-conta-tpcontipocont',
				headerTitle: computed(() => this.Resources.CONTACT_TYPES56696),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'CONTA___TPCONTIPOCONT_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-conta-tpcontipocont')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						globalEvents: ['changed-GENRE', 'changed-TPCON'],
						uuid: 'Conta_Conta_TpconValTipocont',
