		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.CONTAC03PROCNNAME____.isVisible || controls.CONTAC03PROCNEMAIL___.isVisible || controls.CONTAC03PROCNTELEPHON.isVisible || controls.CONTAC03PROCNDESCRIPT.isVisible || controls.CONTAC03PROCNDATE____.isVisible || controls.CONTAC03PROPETITLE___.isVisible">
					<q-control-wrapper
						v-show="controls.CONTAC03PROCNNAME____.isVisible"
					...
					<q-control-wrapper
						v-show="controls.CONTAC03PROCNEMAIL___.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.CONTAC03PROCNTELEPHON.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.CONTAC03PROCNDESCRIPT.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-textarea"
					...
					<q-control-wrapper
						v-show="controls.CONTAC03PROCNDATE____.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.CONTAC03PROPETITLE___.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
							...
							<q-see-more-contac03propetitle
								...
								v-bind="controls.CONTAC03PROPETITLE___.seeMoreParams"
								v-on="controls.CONTAC03PROPETITLE___.handlers" />
						</base-input-structure>
					</q-control-wrapper>
				</q-row-container>
...
<script>
	...
	import FormViewModel from './QFormContac03ViewModel.js'

	const requiredTextResources = ['QFormContac03', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS CONTAC03]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreContac03propetitle: defineAsyncComponent(() => import('@/views/forms/FormContac03/dbedits/Contac03propetitleSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormContac03', false),

				interfaceMetadata: {
					id: 'QFormContac03', // Used for resources
				...
				controls: {
					CONTAC03PROCNNAME____: new fieldControlClass.StringControl({
						modelField: 'ValName',
						valueChangeEvent: 'fieldChange:procn.name',
						id: 'CONTAC03PROCNNAME____',
						name: 'NAME',
						size: 'xxlarge',
						...
						maxLength: 50,
						labelId: 'label_CONTAC03PROCNNAME____',
						controlLimits: [
						],
					}, this),
					CONTAC03PROCNEMAIL___: new fieldControlClass.StringControl({
						modelField: 'ValEmail',
						valueChangeEvent: 'fieldChange:procn.email',
						id: 'CONTAC03PROCNEMAIL___',
						name: 'EMAIL',
						size: 'xxlarge',
						...
						labelPosition: computed(() => this.labelAlignment.topleft),
						maxLength: 50,
						labelId: 'label_CONTAC03PROCNEMAIL___',
						controlLimits: [
						],
					}, this),
					CONTAC03PROCNTELEPHON: new fieldControlClass.StringControl({
						modelField: 'ValTelephon',
						valueChangeEvent: 'fieldChange:procn.telephon',
						id: 'CONTAC03PROCNTELEPHON',
						name: 'TELEPHON',
						size: 'xxlarge',
						...
						labelPosition: computed(() => this.labelAlignment.topleft),
						maxLength: 50,
						labelId: 'label_CONTAC03PROCNTELEPHON',
						controlLimits: [
						],
					}, this),
					CONTAC03PROCNDESCRIPT: new fieldControlClass.MultilineStringControl({
						modelField: 'ValDescript',
						valueChangeEvent: 'fieldChange:procn.descript',
						id: 'CONTAC03PROCNDESCRIPT',
						name: 'DESCRIPT',
						size: 'xxlarge',
					...
					CONTAC03PROCNDATE____: new fieldControlClass.DateControl({
						modelField: 'ValDate',
						valueChangeEvent: 'fieldChange:procn.date',
						id: 'CONTAC03PROCNDATE____',
						name: 'DATE',
						size: 'small',
					...
					CONTAC03PROPETITLE___: new fieldControlClass.LookupControl({
						modelField: 'TablePropeTitle',
						valueChangeEvent: 'fieldChange:prope.title',
						id: 'CONTAC03PROPETITLE___',
						name: 'TITLE',
						size: 'xxlarge',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD CONTAC03]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
