<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-contac03propetitle-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CONTAC03PROPETITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Contac03propetitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CONTAC03PROPETITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'CONTAC03PROPETITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CONTAC03PROPETITLE____SeeMore',
					name: 'CONTAC03PROPETITLE____SeeMore',
					controller: 'PROCN',
					action: 'CONTAC03_PropeValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-contac03propetitle',
				...
				isActive: true,
				returnElement: 'CONTAC03PROPETITLE____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-contac03propetitle')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Contac03_Contac03_PropeValTitle',
