<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-contac06propetitle-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CONTAC06PROPETITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Contac06propetitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CONTAC06PROPETITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'CONTAC06PROPETITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CONTAC06PROPETITLE____SeeMore',
					name: 'CONTAC06PROPETITLE____SeeMore',
					controller: 'PROCN',
					action: 'CONTAC06_PropeValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-contac06propetitle',
				...
				isActive: true,
				returnElement: 'CONTAC06PROPETITLE____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-contac06propetitle')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Contac06_Contac06_PropeValTitle',
