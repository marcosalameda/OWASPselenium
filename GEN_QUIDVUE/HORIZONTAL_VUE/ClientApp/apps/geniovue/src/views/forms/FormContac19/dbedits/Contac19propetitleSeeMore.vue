<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-contac19propetitle-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CONTAC19PROPETITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Contac19propetitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CONTAC19PROPETITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'CONTAC19PROPETITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CONTAC19PROPETITLE____SeeMore',
					name: 'CONTAC19PROPETITLE____SeeMore',
					controller: 'PROCN',
					action: 'CONTAC19_PropeValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-contac19propetitle',
				...
				isActive: true,
				returnElement: 'CONTAC19PROPETITLE____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-contac19propetitle')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Contac19_Contac19_PropeValTitle',
