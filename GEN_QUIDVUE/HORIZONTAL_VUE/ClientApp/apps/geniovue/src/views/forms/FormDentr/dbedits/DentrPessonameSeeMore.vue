<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-dentr-pessoname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DENTR___PESSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DentrPessonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DENTR___PESSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'DENTR___PESSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DENTR___PESSONAME_____SeeMore',
					name: 'DENTR___PESSONAME_____SeeMore',
					controller: 'INDOC',
					action: 'DENTR_PessoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'DENTR___PESSONAME_____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-dentr-pessoname')
		},
