<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-dilin-produproduct-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DILIN___PRODUPRODUCT__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DilinProduproductSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DILIN___PRODUPRODUCT__SeeMore', false),

				interfaceMetadata: {
					id: 'DILIN___PRODUPRODUCT__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DILIN___PRODUPRODUCT__SeeMore',
					name: 'DILIN___PRODUPRODUCT__SeeMore',
					controller: 'DILIN',
					action: 'DILIN_ProduValProduct'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-dilin-produproduct',
				dismissAction: this.close,
				returnElement: 'DILIN___PRODUPRODUCT__see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-dilin-produproduct')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Dilin_Dilin_ProduValProduct',
