<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equip-cmpnydesignat-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIP___CMPNYDESIGNAT_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipCmpnydesignatSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIP___CMPNYDESIGNAT_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIP___CMPNYDESIGNAT_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIP___CMPNYDESIGNAT_SeeMore',
					name: 'EQUIP___CMPNYDESIGNAT_SeeMore',
					controller: 'EQUIP',
					action: 'EQUIP_CmpnyValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equip-cmpnydesignat',
				...
				isActive: true,
				returnElement: 'EQUIP___CMPNYDESIGNAT_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-equip-cmpnydesignat')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Equip_Equip_CmpnyValDesignat',
