<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equip-empty-cmpny-designat-fg-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIP_EMPTY__CMPNY__DESIGNAT_FG_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipEmptyCmpnyDesignatFgSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIP_EMPTY__CMPNY__DESIGNAT_FG_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIP_EMPTY__CMPNY__DESIGNAT_FG_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIP_EMPTY__CMPNY__DESIGNAT_FG_SeeMore',
					name: 'EQUIP_EMPTY__CMPNY__DESIGNAT_FG_SeeMore',
					controller: '',
					action: 'EQUIP_EMPTY_ValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equip-empty-cmpny-designat-fg',
				dismissAction: this.close,
				returnElement: 'EQUIP_EMPTY__CMPNY__DESIGNAT_FG_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-equip-empty-cmpny-designat-fg')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						internalEvents: ['filterChange:cntry.codcntry', 'filterChange:cmpny.codempre'],
						uuid: 'Equip_empty_Equip_empty_ValDesignat',
