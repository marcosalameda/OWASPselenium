<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equip-empty-cntry-country-fg-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIP_EMPTY__CNTRY__COUNTRY_FG_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipEmptyCntryCountryFgSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIP_EMPTY__CNTRY__COUNTRY_FG_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIP_EMPTY__CNTRY__COUNTRY_FG_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIP_EMPTY__CNTRY__COUNTRY_FG_SeeMore',
					name: 'EQUIP_EMPTY__CNTRY__COUNTRY_FG_SeeMore',
					controller: '',
					action: 'EQUIP_EMPTY_ValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equip-empty-cntry-country-fg',
				dismissAction: this.close,
				returnElement: 'EQUIP_EMPTY__CNTRY__COUNTRY_FG_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-equip-empty-cntry-country-fg')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						internalEvents: ['filterChange:cntry.codcntry'],
						uuid: 'Equip_empty_Equip_empty_ValCountry',
