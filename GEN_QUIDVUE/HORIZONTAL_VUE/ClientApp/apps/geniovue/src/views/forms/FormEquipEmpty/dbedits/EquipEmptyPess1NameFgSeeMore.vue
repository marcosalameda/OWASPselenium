<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equip-empty-pess1-name-fg-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIP_EMPTY__PESS1__NAME_FG_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipEmptyPess1NameFgSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIP_EMPTY__PESS1__NAME_FG_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIP_EMPTY__PESS1__NAME_FG_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIP_EMPTY__PESS1__NAME_FG_SeeMore',
					name: 'EQUIP_EMPTY__PESS1__NAME_FG_SeeMore',
					controller: '',
					action: 'EQUIP_EMPTY_ValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equip-empty-pess1-name-fg',
				dismissAction: this.close,
				returnElement: 'EQUIP_EMPTY__PESS1__NAME_FG_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-equip-empty-pess1-name-fg')
		},
