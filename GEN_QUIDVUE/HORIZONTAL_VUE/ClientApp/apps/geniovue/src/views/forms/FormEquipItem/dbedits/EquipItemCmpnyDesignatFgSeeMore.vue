<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equip-item-cmpny-designat-fg-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIP_ITEM__CMPNY__DESIGNAT_FG_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipItemCmpnyDesignatFgSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIP_ITEM__CMPNY__DESIGNAT_FG_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIP_ITEM__CMPNY__DESIGNAT_FG_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIP_ITEM__CMPNY__DESIGNAT_FG_SeeMore',
					name: 'EQUIP_ITEM__CMPNY__DESIGNAT_FG_SeeMore',
					controller: 'ITEM',
					action: 'EQUIP_ITEM_ValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equip-item-cmpny-designat-fg',
				dismissAction: this.close,
				returnElement: 'EQUIP_ITEM__CMPNY__DESIGNAT_FG_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-equip-item-cmpny-designat-fg')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Equip_item_Equip_item_ValDesignat',
