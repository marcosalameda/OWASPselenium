<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equip-item-cntry-country-fg-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIP_ITEM__CNTRY__COUNTRY_FG_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipItemCntryCountryFgSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIP_ITEM__CNTRY__COUNTRY_FG_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIP_ITEM__CNTRY__COUNTRY_FG_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIP_ITEM__CNTRY__COUNTRY_FG_SeeMore',
					name: 'EQUIP_ITEM__CNTRY__COUNTRY_FG_SeeMore',
					controller: 'ITEM',
					action: 'EQUIP_ITEM_ValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equip-item-cntry-country-fg',
				dismissAction: this.close,
				returnElement: 'EQUIP_ITEM__CNTRY__COUNTRY_FG_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-equip-item-cntry-country-fg')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Equip_item_Equip_item_ValCountry',
