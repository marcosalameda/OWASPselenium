<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equip-item-wareh-warehdes-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIP_ITEM__WAREH__WAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipItemWarehWarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIP_ITEM__WAREH__WAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIP_ITEM__WAREH__WAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIP_ITEM__WAREH__WAREHDES_SeeMore',
					name: 'EQUIP_ITEM__WAREH__WAREHDES_SeeMore',
					controller: 'ITEM',
					action: 'EQUIP_ITEM_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equip-item-wareh-warehdes',
				dismissAction: this.close,
				returnElement: 'EQUIP_ITEM__WAREH__WAREHDES_see-more_button'
			}
			const props = {
				class: 'q-dialog-see-more',
				title: computed(() => this.Resources.WAREHOUSES43533),
				buttons: [
					{
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-equip-item-wareh-warehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Equip_item_WarehValWarehdes',
							serverMode: true,
						...
						uuid: 'Equip_item_Equip_item_WarehValWarehdes',
