<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-esppe-pessoname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ESPPE___PESSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EsppePessonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ESPPE___PESSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'ESPPE___PESSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ESPPE___PESSONAME_____SeeMore',
					name: 'ESPPE___PESSONAME_____SeeMore',
					controller: 'ESPPE',
					action: 'ESPPE_PessoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'ESPPE___PESSONAME_____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-esppe-pessoname')
		},
