<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-evcat-pessoname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EVCAT___PESSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EvcatPessonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EVCAT___PESSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'EVCAT___PESSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EVCAT___PESSONAME_____SeeMore',
					name: 'EVCAT___PESSONAME_____SeeMore',
					controller: 'EVCAT',
					action: 'EVCAT_PessoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'EVCAT___PESSONAME_____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-evcat-pessoname')
		},
