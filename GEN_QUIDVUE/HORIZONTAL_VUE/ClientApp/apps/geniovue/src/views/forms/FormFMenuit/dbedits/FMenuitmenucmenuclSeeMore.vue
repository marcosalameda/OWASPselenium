<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-f-menuitmenucmenucl-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['F_MENUITMENUCMENUCL___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FMenuitmenucmenuclSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('F_MENUITMENUCMENUCL___SeeMore', false),

				interfaceMetadata: {
					id: 'F_MENUITMENUCMENUCL___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'F_MENUITMENUCMENUCL___SeeMore',
					name: 'F_MENUITMENUCMENUCL___SeeMore',
					controller: 'MENUIT',
					action: 'F_MENUIT_MenucValMenucl'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-f-menuitmenucmenucl',
				headerTitle: computed(() => this.Resources.MENU_CLASSES17951),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'F_MENUITMENUCMENUCL___see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-f-menuitmenucmenucl')
		},
					...
					configuration: {
						...
						config: {
							...
							defaultColumnSorting: {
								columnName: 'ValMenucl',
								sortOrder: 'asc'
							}
						},
						globalEvents: ['changed-MENUC'],
						uuid: 'F_menuit_F_menuit_MenucValMenucl',
