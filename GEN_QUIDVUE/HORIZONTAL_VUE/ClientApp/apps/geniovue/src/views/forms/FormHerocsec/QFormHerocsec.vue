			...
			return {
				...
				controls: {
					...
					HEROTEXTPSEUDFIELD006: new fieldControlClass.ImageControl({
						...
						tab: 'HEROCSECPSEUDHEROTEXT',
						icon: {
							icon: computed(() => `${this.$app.resourcesPath}Dt_input_tag.png?v=3639`),
							type: 'img',
						},
						height: 0,
						width: 150,
					...
					HEROIMG_PSEUDFIELD007: new fieldControlClass.ImageControl({
						...
						tab: 'HEROCSECPSEUDHEROIMG_',
						icon: {
							icon: computed(() => `${this.$app.resourcesPath}Screenshot 2026-03-02 144033.png?v=3639`),
							type: 'img',
						},
						height: 0,
						width: 150,
					...
					HEROIMG_PSEUDFIELD009: new fieldControlClass.ImageControl({
						...
						tab: 'HEROCSECPSEUDHEROIMG_',
						icon: {
							icon: computed(() => `${this.$app.resourcesPath}Screenshot 2026-03-02 145357.png?v=3639`),
							type: 'img',
						},
						height: 0,
						width: 150,
					...
					HEROIMG_PSEUDFIELD002: new fieldControlClass.ImageControl({
						...
						tab: 'HEROCSECPSEUDHEROIMG_',
						icon: {
							icon: computed(() => `${this.$app.resourcesPath}office-man.png?v=3639`),
							type: 'img',
						},
						height: 0,
						width: 150,
