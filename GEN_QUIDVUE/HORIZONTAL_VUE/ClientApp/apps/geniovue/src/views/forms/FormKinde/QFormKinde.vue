	...
	<teleport
		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.KINDE___KINDEDESIGNAT.isVisible">
					<q-control-wrapper
						v-show="controls.KINDE___KINDEDESIGNAT.isVisible"
				...
				<q-row-container v-show="controls.KINDE___PSEUDPARAMETE.isVisible">
					<q-control-wrapper
				...
				<q-row-container v-show="controls.KINDE___PSEUDMANUALS_.isVisible">
					<q-control-wrapper
...
<script>
	...
	import FormViewModel from './QFormKindeViewModel.js'

	const requiredTextResources = ['QFormKinde', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS KINDE]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormKinde', false),

				interfaceMetadata: {
					id: 'QFormKinde', // Used for resources
				...
				formInfo: {
					...
					route: 'form-KINDE',
					area: 'KINDE',
					primaryKey: 'ValCodkinde',
					designation: computed(() => this.Resources.KIND_OF_EQUIPMENT22928),
				...
				controls: {
					KINDE___KINDEDESIGNAT: new fieldControlClass.StringControl({
					...
					KINDE___PSEUDPARAMETE: new fieldControlClass.TableListControl({
						...
						config: {
							...
							tableAlias: 'PARAM',
							tableNamePlural: computed(() => this.Resources.PARAMETERS28294),
							viewManagement: 'N',
							showLimitsInfo: true,
							...
							formsDefinition: {
								'PARAM': {
									fnKeySelector: (row) => row.Fields.ValCodparam,
									isPopup: false
								},
							},
						...
						controlLimits: [
							{
								identifier: ['id', 'kinde'],
								dependencyEvents: ['fieldChange:kinde.codkinde'],
								dependencyField: 'KINDE.CODKINDE',
								fnValueSelector: (model) => model.ValCodkinde.value
							},
						],
					}, this),
					KINDE___PSEUDMANUALS_: new fieldControlClass.TableListControl({
						...
						config: {
							name: 'ValManuals',
							serverMode: true,
							pkColumn: 'ValCodmanua',
							tableAlias: 'MANUA',
							tableNamePlural: computed(() => this.Resources.MANUALS_TO_COLLECT30729),
							viewManagement: 'N',
							showLimitsInfo: true,
							tableTitle: computed(() => this.Resources.MANUALS14730),
							showAlternatePagination: true,
							permissions: {
							},
							searchBarConfig: {
							...
							formsDefinition: {
								'MANUA': {
									fnKeySelector: (row) => row.Fields.ValCodmanua,
									isPopup: false
								},
							},
						...
						globalEvents: ['changed-KINDE', 'changed-MANUA'],
				...
				tableFields: readonly([
					'KINDE___PSEUDPARAMETE',
					'KINDE___PSEUDMANUALS_',
				]),
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS KINDE]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
