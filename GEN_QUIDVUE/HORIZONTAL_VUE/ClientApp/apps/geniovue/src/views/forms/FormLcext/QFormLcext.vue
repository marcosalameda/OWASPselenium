				...
				<q-row-container
					...
					<q-control-wrapper
						...
						<q-group-box-container
							...
							<q-row-container v-show="controls.LCEXT___LOCATGLN_____.isVisible">
								<q-control-wrapper
									v-show="controls.LCEXT___LOCATGLN_____.isVisible"
							...
							<q-row-container v-show="controls.LCEXT___LCEXTGLNEXT__.isVisible">
								<q-control-wrapper
									v-show="controls.LCEXT___LCEXTGLNEXT__.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-text"
							...
							<q-row-container v-show="controls.LCEXT___LCEXTSPACETYP.isVisible || controls.LCEXT___LCEXTSPACEOBS.isVisible">
								<q-control-wrapper
									v-show="controls.LCEXT___LCEXTSPACETYP.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-text"
								...
								<q-control-wrapper
									v-show="controls.LCEXT___LCEXTSPACEOBS.isVisible"
									class="control-join-group">
									<base-input-structure
										class="i-text"
...
<script>
	...
	import FormViewModel from './QFormLcextViewModel.js'

	const requiredTextResources = ['QFormLcext', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS LCEXT]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMoreLcextLocatgln: defineAsyncComponent(() => import('@/views/forms/FormLcext/dbedits/LcextLocatglnSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormLcext', false),

				interfaceMetadata: {
					id: 'QFormLcext', // Used for resources
				...
				formInfo: {
					...
					route: 'form-LCEXT',
					area: 'LCEXT',
					primaryKey: 'ValCodlcext',
					designation: computed(() => this.Resources.LOCATION_EXTENSION_C10932),
				...
				controls: {
					LCEXT___PSEUDNOVOGR01: new fieldControlClass.GroupControl({
						id: 'LCEXT___PSEUDNOVOGR01',
						name: 'NOVOGR01',
						size: 'block',
					...
					LCEXT___LOCATGLN_____: new fieldControlClass.LookupControl({
					...
					LCEXT___LCEXTSPACETYP: new fieldControlClass.ArrayStringControl({
						modelField: 'ValSpacetyp',
						valueChangeEvent: 'fieldChange:lcext.spacetyp',
					...
					LCEXT___LCEXTSPACEOBS: new fieldControlClass.StringControl({
						modelField: 'ValSpaceobs',
						valueChangeEvent: 'fieldChange:lcext.spaceobs',
				...
				dataApi: {
					Lcext: {
						...
						get ValGlnext() { return vm.model.ValGlnext.value },
						set ValGlnext(value) { vm.model.ValGlnext.updateValue(value) },
						get ValSpaceobs() { return vm.model.ValSpaceobs.value },
						set ValSpaceobs(value) { vm.model.ValSpaceobs.updateValue(value) },
						get ValSpacetyp() { return vm.model.ValSpacetyp.value },
						set ValSpacetyp(value) { vm.model.ValSpacetyp.updateValue(value) },
					},
					Locat: {
					...
					keys: {
						/** The primary key of the LCEXT table */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS LCEXT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
