<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-ldentnorindocdocumenr-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LDENTNORINDOCDOCUMENR_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LdentnorindocdocumenrSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LDENTNORINDOCDOCUMENR_SeeMore', false),

				interfaceMetadata: {
					id: 'LDENTNORINDOCDOCUMENR_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LDENTNORINDOCDOCUMENR_SeeMore',
					name: 'LDENTNORINDOCDOCUMENR_SeeMore',
					controller: 'LDENT',
					action: 'LDENTNOR_IndocValDocumenr'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'LDENTNORINDOCDOCUMENR_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-ldentnorindocdocumenr')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						globalEvents: ['changed-CNTRY', 'changed-PESSO', 'changed-CMPNY', 'changed-WARE1', 'changed-INDOC'],
