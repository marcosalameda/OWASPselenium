<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-ldsai-outptdocumenr-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LDSAI___OUTPTDOCUMENR_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LdsaiOutptdocumenrSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LDSAI___OUTPTDOCUMENR_SeeMore', false),

				interfaceMetadata: {
					id: 'LDSAI___OUTPTDOCUMENR_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LDSAI___OUTPTDOCUMENR_SeeMore',
					name: 'LDSAI___OUTPTDOCUMENR_SeeMore',
					controller: 'OUTPU',
					action: 'LDSAI_OutptValDocumenr'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-ldsai-outptdocumenr',
				...
				isActive: true,
				returnElement: 'LDSAI___OUTPTDOCUMENR_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-ldsai-outptdocumenr')
		},
					...
					configuration: {
						...
						config: {
							...
							defaultColumnSorting: {
								columnName: 'ValDhdocume',
								sortOrder: 'asc'
							}
						},
						globalEvents: ['changed-WARE1', 'changed-OUTPT'],
						uuid: 'Ldsai_Ldsai_OutptValDocumenr',
