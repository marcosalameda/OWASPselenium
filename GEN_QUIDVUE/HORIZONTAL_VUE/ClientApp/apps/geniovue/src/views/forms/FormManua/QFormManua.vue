	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				...
				<q-row v-if="controls.MANUA___MANUANAME____.isVisible">
					<q-col
				...
				<q-row v-if="controls.MANUA___MANUADIGDOCUM.isVisible">
					<q-col
				...
				<q-row v-if="controls.MANUA___MANUANOTES___.isVisible">
					<q-col
		...
		data()
		{
			...
			return {
				...
				controls: {
					...
					MANUA___MANUANOTES___: new fieldControlClass.MultilineStringControl({
						modelField: 'ValNotes',
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT MANUA]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
