	...
	<teleport
		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.MLTFORM_WAREHWAREHDES.isVisible || controls.MLTFORM_WAREHWAREHCOD.isVisible || controls.MLTFORM_PSEUDMLTFORM1.isVisible">
					<q-control-wrapper
						v-show="controls.MLTFORM_WAREHWAREHDES.isVisible"
					...
					<q-control-wrapper
						v-show="controls.MLTFORM_WAREHWAREHCOD.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.MLTFORM_PSEUDMLTFORM1.isVisible"
						class="control-join-group">
						<q-table
							v-show="controls.MLTFORM_PSEUDMLTFORM1.isVisible"
...
<script>
	...
	import FormViewModel from './QFormMltformViewModel.js'

	const requiredTextResources = ['QFormMltform', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS MLTFORM]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormMltform', false),

				interfaceMetadata: {
					id: 'QFormMltform', // Used for resources
				...
				formInfo: {
					...
					designation: computed(() => this.Resources.MULTIFORM41286),
				...
				controls: {
					MLTFORM_WAREHWAREHDES: new fieldControlClass.StringControl({
						modelField: 'ValWarehdes',
						valueChangeEvent: 'fieldChange:wareh.warehdes',
						id: 'MLTFORM_WAREHWAREHDES',
						name: 'WAREHDES',
						size: 'xxlarge',
						...
						maxLength: 85,
						labelId: 'label_MLTFORM_WAREHWAREHDES',
						controlLimits: [
						],
					}, this),
					MLTFORM_WAREHWAREHCOD: new fieldControlClass.StringControl({
						modelField: 'ValWarehcod',
						valueChangeEvent: 'fieldChange:wareh.warehcod',
						id: 'MLTFORM_WAREHWAREHCOD',
						name: 'WAREHCOD',
						size: 'small',
						...
						labelPosition: computed(() => this.labelAlignment.topleft),
						maxLength: 10,
						labelId: 'label_MLTFORM_WAREHWAREHCOD',
						controlLimits: [
						],
					}, this),
					MLTFORM_PSEUDMLTFORM1: new fieldControlClass.TableListControl({
						id: 'MLTFORM_PSEUDMLTFORM1',
						name: 'MLTFORM1',
						size: 'mini',
						...
						columnsOriginal: [
							...
							new listColumnTypes.NumericColumn({
								...
								area: 'WPESS',
								field: 'NFUNC',
								label: computed(() => this.Resources.EMPLOYEE_NUMBER50873),
								scrollData: 1,
								maxDigits: 6,
								decimalPlaces: 0,
							}, computed(() => vm.model), computed(() => vm.internalEvents)),
							new listColumnTypes.DateColumn({
								...
								area: 'WPESS',
								field: 'DATE',
								label: computed(() => this.Resources.BIRTH_DATE00284),
								scrollData: 8,
								dateTimeType: 'date',
							}, computed(() => vm.model), computed(() => vm.internalEvents)),
						],
						config: {
							...
							viewManagement: 'N',
							showLimitsInfo: true,
							tableTitle: computed(() => this.Resources.WAREHOUSE_EMPLOYEES19716),
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD MLTFORM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		watch: {
			...
			'formInfo.mode'()
			{
				...
				for (const key in this.controls.MLTFORM_PSEUDMLTFORM1.rowFormProps)
					this.controls.MLTFORM_PSEUDMLTFORM1.rowFormProps[key].mode = this.formModes.show
			}
		}
	}
</script>
