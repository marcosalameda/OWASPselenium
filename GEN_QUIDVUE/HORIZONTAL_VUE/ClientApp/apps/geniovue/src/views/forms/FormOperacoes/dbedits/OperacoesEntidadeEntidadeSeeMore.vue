<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-operacoes-entidade-entidade-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['OPERACOES__ENTIDADE__ENTIDADE_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'OperacoesEntidadeEntidadeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('OPERACOES__ENTIDADE__ENTIDADE_SeeMore', false),

				interfaceMetadata: {
					id: 'OPERACOES__ENTIDADE__ENTIDADE_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'OPERACOES__ENTIDADE__ENTIDADE_SeeMore',
					name: 'OPERACOES__ENTIDADE__ENTIDADE_SeeMore',
					controller: 'OPERACOES',
					action: 'OPERACOES_EntidadeValEntidade'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-operacoes-entidade-entidade',
				dismissAction: this.close,
				returnElement: 'OPERACOES__ENTIDADE__ENTIDADE_see-more_button'
			}
			const props = {
				class: 'q-dialog-see-more',
				title: computed(() => this.Resources.ENTIDADE36471),
				buttons: [
					{
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-operacoes-entidade-entidade')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Operacoes_EntidadeValEntidade',
							serverMode: true,
						...
						uuid: 'Operacoes_Operacoes_EntidadeValEntidade',
