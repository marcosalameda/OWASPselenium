<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pess1-cmpnydesignat-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PESS1___CMPNYDESIGNAT_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Pess1CmpnydesignatSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PESS1___CMPNYDESIGNAT_SeeMore', false),

				interfaceMetadata: {
					id: 'PESS1___CMPNYDESIGNAT_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PESS1___CMPNYDESIGNAT_SeeMore',
					name: 'PESS1___CMPNYDESIGNAT_SeeMore',
					controller: 'PESS1',
					action: 'PESS1_CmpnyValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-pess1-cmpnydesignat',
				...
				isActive: true,
				returnElement: 'PESS1___CMPNYDESIGNAT_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-pess1-cmpnydesignat')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Pess1_Pess1_CmpnyValDesignat',
