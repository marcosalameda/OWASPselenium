<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pesso-cmpnydesignat-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PESSO___CMPNYDESIGNAT_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PessoCmpnydesignatSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PESSO___CMPNYDESIGNAT_SeeMore', false),

				interfaceMetadata: {
					id: 'PESSO___CMPNYDESIGNAT_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PESSO___CMPNYDESIGNAT_SeeMore',
					name: 'PESSO___CMPNYDESIGNAT_SeeMore',
					controller: 'PESSO',
					action: 'PESSO_CmpnyValDesignat'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-pesso-cmpnydesignat',
				...
				isActive: true,
				returnElement: 'PESSO___CMPNYDESIGNAT_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-pesso-cmpnydesignat')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Pesso_Pesso_CmpnyValDesignat',
