<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pesso1-categcategory-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PESSO1__CATEGCATEGORY_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Pesso1CategcategorySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PESSO1__CATEGCATEGORY_SeeMore', false),

				interfaceMetadata: {
					id: 'PESSO1__CATEGCATEGORY_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PESSO1__CATEGCATEGORY_SeeMore',
					name: 'PESSO1__CATEGCATEGORY_SeeMore',
					controller: 'PESSO',
					action: 'PESSO1_CategValCategoria'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-pesso1-categcategory',
				dismissAction: this.close,
				returnElement: 'PESSO1__CATEGCATEGORY_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-pesso1-categcategory')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Pesso1_Pesso1_CategValCategoria',
