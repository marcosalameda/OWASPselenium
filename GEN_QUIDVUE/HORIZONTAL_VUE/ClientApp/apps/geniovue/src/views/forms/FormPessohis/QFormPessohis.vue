	...
	<teleport
		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.PESSOHISPSEUDFIELD002.isVisible">
					<q-control-wrapper
						v-show="controls.PESSOHISPSEUDFIELD002.isVisible"
				...
				<q-row-container v-show="controls.PESSOHISPESSOIDFUNCIO.isVisible || controls.PESSOHISPESSONAME____.isVisible">
					<q-control-wrapper
						v-show="controls.PESSOHISPESSOIDFUNCIO.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
					...
					<q-control-wrapper
						v-show="controls.PESSOHISPESSONAME____.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
				...
				<q-row-container
					v-show="controls.PESSOHISPSEUDFIELD001.isVisible"
					is-large>
					<q-control-wrapper
						v-show="controls.PESSOHISPSEUDFIELD001.isVisible"
...
<script>
	...
	import FormViewModel from './QFormPessohisViewModel.js'

	const requiredTextResources = ['QFormPessohis', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS PESSOHIS]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormPessohis', false),

				interfaceMetadata: {
					id: 'QFormPessohis', // Used for resources
				...
				controls: {
					PESSOHISPSEUDFIELD002: new fieldControlClass.BaseControl({
						id: 'PESSOHISPSEUDFIELD002',
						name: 'FIELD002',
						size: 'xxlarge',
						hasLabel: false,
						label: computed(() => this.Resources.HIST_PATTERN_DESCRIP64421),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						controlLimits: [
						],
					}, this),
					PESSOHISPESSOIDFUNCIO: new fieldControlClass.NumberControl({
						modelField: 'ValIdfuncio',
						valueChangeEvent: 'fieldChange:pesso.idfuncio',
						id: 'PESSOHISPESSOIDFUNCIO',
						name: 'IDFUNCIO',
						size: 'medium',
					...
					PESSOHISPESSONAME____: new fieldControlClass.StringControl({
						modelField: 'ValName',
						valueChangeEvent: 'fieldChange:pesso.name',
						id: 'PESSOHISPESSONAME____',
						name: 'NAME',
						size: 'xxlarge',
						...
						labelPosition: computed(() => this.labelAlignment.topleft),
						maxLength: 85,
						labelId: 'label_PESSOHISPESSONAME____',
						mustBeFilled: true,
						controlLimits: [
						],
					}, this),
					PESSOHISPSEUDFIELD001: new fieldControlClass.TableListControl({
						id: 'PESSOHISPSEUDFIELD001',
						name: 'FIELD001',
						size: 'block',
						...
						config: {
							name: 'ValField001',
							serverMode: true,
							pkColumn: 'ValCodhpess',
							tableAlias: 'HPESS',
							tableNamePlural: computed(() => this.Resources.PERSON_HISTORIES60224),
							viewManagement: '',
							showLimitsInfo: true,
							tableTitle: computed(() => this.Resources.HISTORY52142),
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD PESSOHIS]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
