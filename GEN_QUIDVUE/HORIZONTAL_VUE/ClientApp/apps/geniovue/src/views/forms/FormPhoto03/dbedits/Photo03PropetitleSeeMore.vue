<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-photo03-propetitle-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PHOTO03_PROPETITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Photo03PropetitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PHOTO03_PROPETITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'PHOTO03_PROPETITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PHOTO03_PROPETITLE____SeeMore',
					name: 'PHOTO03_PROPETITLE____SeeMore',
					controller: 'PROPH',
					action: 'PHOTO03_PropeValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-photo03-propetitle',
				...
				isActive: true,
				returnElement: 'PHOTO03_PROPETITLE____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-photo03-propetitle')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Photo03_Photo03_PropeValTitle',
