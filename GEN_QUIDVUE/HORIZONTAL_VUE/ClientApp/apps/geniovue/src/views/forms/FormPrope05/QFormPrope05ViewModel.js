...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'PROPE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Prope05',
				updateFilesTickets: 'UpdateFilesTicketsPrope05',
				setFile: 'SetFilePrope05'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormPrope05ViewModel instance.
	 * @returns {QFormPrope05ViewModel} A new instance of QFormPrope05ViewModel
	 */
	clone()
	{
