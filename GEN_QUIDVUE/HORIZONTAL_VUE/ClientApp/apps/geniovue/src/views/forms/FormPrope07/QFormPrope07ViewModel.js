...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'PROPE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_PROPE07',
				updateFilesTickets: 'UpdateFilesTicketsPROPE07'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormPrope07ViewModel instance.
	 * @returns {QFormPrope07ViewModel} A new instance of QFormPrope07ViewModel
	 */
	clone()
	{
