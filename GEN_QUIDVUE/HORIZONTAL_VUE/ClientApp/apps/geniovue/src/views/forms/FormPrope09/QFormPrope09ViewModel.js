...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'PROPE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_PROPE09',
				updateFilesTickets: 'UpdateFilesTicketsPROPE09'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormPrope09ViewModel instance.
	 * @returns {QFormPrope09ViewModel} A new instance of QFormPrope09ViewModel
	 */
	clone()
	{
