...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'PROPE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_PROPE17',
				updateFilesTickets: 'UpdateFilesTicketsPROPE17'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormPrope17ViewModel instance.
	 * @returns {QFormPrope17ViewModel} A new instance of QFormPrope17ViewModel
	 */
	clone()
	{
