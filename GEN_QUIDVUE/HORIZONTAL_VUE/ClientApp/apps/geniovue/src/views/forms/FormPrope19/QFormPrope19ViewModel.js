...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		this.stopWatchers.push(watch(() => this.ValOrder.value, (newValue, oldValue) => this.onUpdate('prope.order', this.ValOrder, newValue, oldValue)))
		...
		this.stopWatchers.push(watch(() => this.ValGrndsize.value, (newValue, oldValue) => this.onUpdate('prope.grndsize', this.ValGrndsize, newValue, oldValue)))
		...
		this.stopWatchers.push(watch(() => this.ValFloornum.value, (newValue, oldValue) => this.onUpdate('prope.floornum', this.ValFloornum, newValue, oldValue)))
		...
		this.ValBuildage = reactive(new modelFieldType.Number({
			...
			valueFormula: {
				...
				fnFormula(params)
				{
					...
					return qApi.Year(qApi.Today())-qApi.Year(qApi.DateAddYears('',qApi.atoi(this.ValYear.value)))
				},
