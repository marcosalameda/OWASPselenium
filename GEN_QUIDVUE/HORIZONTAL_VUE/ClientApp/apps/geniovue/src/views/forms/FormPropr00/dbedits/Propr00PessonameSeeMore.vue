<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-propr00-pessoname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPR00_PESSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Propr00PessonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPR00_PESSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPR00_PESSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPR00_PESSONAME_____SeeMore',
					name: 'PROPR00_PESSONAME_____SeeMore',
					controller: 'PROPR',
					action: 'PROPR00_PessoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-propr00-pessoname',
				headerTitle: computed(() => this.Resources.PEOPLE34206),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'PROPR00_PESSONAME_____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-propr00-pessoname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Propr00_Propr00_PessoValName',
