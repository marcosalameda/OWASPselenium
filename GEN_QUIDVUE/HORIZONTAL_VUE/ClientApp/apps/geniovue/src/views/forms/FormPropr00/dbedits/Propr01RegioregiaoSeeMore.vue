<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-propr01-regioregiao-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPR01_REGIOREGIAO___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Propr01RegioregiaoSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPR01_REGIOREGIAO___SeeMore', false),

				interfaceMetadata: {
					id: 'PROPR01_REGIOREGIAO___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPR01_REGIOREGIAO___SeeMore',
					name: 'PROPR01_REGIOREGIAO___SeeMore',
					controller: 'PROPR',
					action: 'PROPR01_RegioValRegiao'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-propr01-regioregiao',
				...
				isActive: true,
				returnElement: 'PROPR01_REGIOREGIAO___see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-propr01-regioregiao')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Propr01_Propr01_RegioValRegiao',
