<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-proprallpessoname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPRALLPESSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ProprallpessonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPRALLPESSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPRALLPESSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPRALLPESSONAME_____SeeMore',
					name: 'PROPRALLPESSONAME_____SeeMore',
					controller: 'PROPR',
					action: 'PROPRALL_PessoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PROPRALLPESSONAME_____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-proprallpessoname')
		},
