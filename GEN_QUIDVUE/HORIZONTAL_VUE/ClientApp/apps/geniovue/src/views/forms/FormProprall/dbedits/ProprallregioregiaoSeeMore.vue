<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-proprallregioregiao-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPRALLREGIOREGIAO___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ProprallregioregiaoSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPRALLREGIOREGIAO___SeeMore', false),

				interfaceMetadata: {
					id: 'PROPRALLREGIOREGIAO___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPRALLREGIOREGIAO___SeeMore',
					name: 'PROPRALLREGIOREGIAO___SeeMore',
					controller: 'PROPR',
					action: 'PROPRALL_RegioValRegiao'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-proprallregioregiao',
				...
				isActive: true,
				returnElement: 'PROPRALLREGIOREGIAO___see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-proprallregioregiao')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						globalEvents: ['changed-CNTRY', 'changed-PAIS1', 'changed-REGIO'],
						uuid: 'Proprall_Proprall_RegioValRegiao',
