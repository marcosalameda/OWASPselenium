		...
		<div
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row-container v-show="controls.PWCOM___PSW__NOME____.isVisible">
					<q-control-wrapper
						v-show="controls.PWCOM___PSW__NOME____.isVisible"
				...
				<q-row-container v-show="controls.PWCOM___PESS1NAME____.isVisible">
					<q-control-wrapper
						v-show="controls.PWCOM___PESS1NAME____.isVisible"
						class="control-join-group">
						<base-input-structure
							class="i-text"
				...
				<q-row-container v-show="controls.PWCOM___PWCOMFOTO____.isVisible">
					<q-control-wrapper
						v-show="controls.PWCOM___PWCOMFOTO____.isVisible"
						class="control-join-group">
						<base-input-structure
							class="q-image"
...
<script>
	...
	import FormViewModel from './QFormPwcomViewModel.js'

	const requiredTextResources = ['QFormPwcom', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		components: {
			QSeeMorePwcomPswNome: defineAsyncComponent(() => import('@/views/forms/FormPwcom/dbedits/PwcomPswNomeSeeMore.vue')),
			QSeeMorePwcomPess1name: defineAsyncComponent(() => import('@/views/forms/FormPwcom/dbedits/PwcomPess1nameSeeMore.vue')),
		},
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormPwcom', false),

				interfaceMetadata: {
					id: 'QFormPwcom', // Used for resources
				...
				formInfo: {
					...
					route: 'form-PWCOM',
					area: 'PWCOM',
					primaryKey: 'ValCodpwcom',
					designation: computed(() => this.Resources.MOVING_ACCESS62712),
				...
				controls: {
					PWCOM___PSW__NOME____: new fieldControlClass.LookupControl({
					...
					PWCOM___PWCOMFOTO____: new fieldControlClass.ImageControl({
						modelField: 'ValFoto',
						valueChangeEvent: 'fieldChange:pwcom.foto',
				...
				dataApi: {
					...
					keys: {
						/** The primary key of the PWCOM table */
						get pwcom() { return vm.model.ValCodpwcom },
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS PWCOM]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
