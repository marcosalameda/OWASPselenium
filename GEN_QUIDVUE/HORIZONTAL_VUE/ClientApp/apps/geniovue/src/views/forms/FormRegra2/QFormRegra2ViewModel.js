...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'RULES',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Regra2',
				updateFilesTickets: 'UpdateFilesTicketsRegra2',
				setFile: 'SetFileRegra2'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormRegra2ViewModel instance.
	 * @returns {QFormRegra2ViewModel} A new instance of QFormRegra2ViewModel
	 */
	clone()
	{
