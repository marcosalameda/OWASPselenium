<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-repar-pessoname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['REPAR___PESSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ReparPessonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('REPAR___PESSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'REPAR___PESSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'REPAR___PESSONAME_____SeeMore',
					name: 'REPAR___PESSONAME_____SeeMore',
					controller: 'REPAR',
					action: 'REPAR_PessoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'REPAR___PESSONAME_____see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-repar-pessoname')
		},
