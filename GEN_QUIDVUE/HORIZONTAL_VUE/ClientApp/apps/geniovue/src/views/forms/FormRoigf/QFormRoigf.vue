	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				...
				<q-row v-if="controls.ROIGF___ROIGFORDER___.isVisible || controls.ROIGF___ROIGFTITLE___.isVisible">
					<q-col
						v-if="controls.ROIGF___ROIGFORDER___.isVisible || controls.ROIGF___ROIGFTITLE___.isVisible"
						cols="auto">
						<base-input-structure
