<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-search-cntrycountry-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['SEARCH__CNTRYCOUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'SearchCntrycountrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('SEARCH__CNTRYCOUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'SEARCH__CNTRYCOUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'SEARCH__CNTRYCOUNTRY__SeeMore',
					name: 'SEARCH__CNTRYCOUNTRY__SeeMore',
					controller: 'SEARCH',
					action: 'SEARCH_CntryValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-search-cntrycountry',
				dismissAction: this.close,
				returnElement: 'SEARCH__CNTRYCOUNTRY__see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-search-cntrycountry')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Search_Search_CntryValCountry',
