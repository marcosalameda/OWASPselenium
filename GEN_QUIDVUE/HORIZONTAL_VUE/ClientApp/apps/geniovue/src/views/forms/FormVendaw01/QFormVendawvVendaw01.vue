...
<script>
	...
	import FormViewModel from './QFormVendawvVendaw01ViewModel.js'

	const requiredTextResources = ['QFormVendawvVendaw01', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawvVendaw01', false),

				interfaceMetadata: {
					id: 'QFormVendawvVendaw01', // Used for resources
