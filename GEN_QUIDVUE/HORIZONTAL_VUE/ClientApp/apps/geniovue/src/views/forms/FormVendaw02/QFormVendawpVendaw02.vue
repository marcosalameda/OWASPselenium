...
<script>
	...
	import FormViewModel from './QFormVendawpVendaw02ViewModel.js'

	const requiredTextResources = ['QFormVendawpVendaw02', 'hardcoded', 'messages']
	...
	export default {
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW02',
					location: 'form-VENDAWP-VENDAW02',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawpVendaw02', false),

				interfaceMetadata: {
					id: 'QFormVendawpVendaw02', // Used for resources
