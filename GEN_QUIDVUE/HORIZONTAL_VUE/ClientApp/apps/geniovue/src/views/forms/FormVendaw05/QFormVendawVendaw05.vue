...
<script>
	...
	import FormViewModel from './QFormVendawVendaw05ViewModel.js'

	const requiredTextResources = ['QFormVendawVendaw05', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawVendaw05', false),

				interfaceMetadata: {
					id: 'QFormVendawVendaw05', // Used for resources
