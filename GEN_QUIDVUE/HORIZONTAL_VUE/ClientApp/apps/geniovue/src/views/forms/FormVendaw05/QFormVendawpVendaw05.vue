				...
				<q-row-container v-show="controls.VENDAWP_PSEUDFASES___.isVisible">
					<q-control-wrapper
						...
						<q-wizard
							...
							<q-row-container
								v-show="controls.VENDAW05PSEUDNOVOGR05.isVisible"
								is-large>
								<q-control-wrapper
									v-show="controls.VENDAW05PSEUDNOVOGR05.isVisible"
									...
									<q-group-box-container
										...
										:is-visible="controls.VENDAW05PSEUDNOVOGR05.isVisible">
										<!-- Start VENDAW05PSEUDNOVOGR05 -->
										<q-row-container v-show="controls.VENDAW05SALE_DTAPRESE.isVisible || controls.VENDAW05SALE_APRESENT.isVisible">
											<q-control-wrapper
												v-show="controls.VENDAW05SALE_DTAPRESE.isVisible"
												class="control-join-group">
												<base-input-structure
													class="i-text"
													v-bind="controls.VENDAW05SALE_DTAPRESE"
											...
											<q-control-wrapper
												v-show="controls.VENDAW05SALE_APRESENT.isVisible"
												class="control-join-group">
												<base-input-structure
													class="i-checkbox"
													v-bind="controls.VENDAW05SALE_APRESENT"
