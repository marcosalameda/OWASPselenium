...
<script>
	...
	import FormViewModel from './QFormVendawpVendaw05ViewModel.js'

	const requiredTextResources = ['QFormVendawpVendaw05', 'hardcoded', 'messages']
	...
	export default {
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW05',
					location: 'form-VENDAWP-VENDAW05',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawpVendaw05', false),

				interfaceMetadata: {
					id: 'QFormVendawpVendaw05', // Used for resources
