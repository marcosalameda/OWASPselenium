				...
				<q-row v-if="controls.VENDAWV_PSEUDFASES___.isVisible">
					<q-col
						...
						<q-wizard
							...
							<q-row v-if="controls.VENDAW05PSEUDNOVOGR05.isVisible">
								<q-col v-if="controls.VENDAW05PSEUDNOVOGR05.isVisible">
									<q-group-box-container
										v-if="controls.VENDAW05PSEUDNOVOGR05.isVisible"
										v-bind="controls.VENDAW05PSEUDNOVOGR05"
										:id="getControlId(controls.VENDAW05PSEUDNOVOGR05)"
										:no-border="controls.VENDAW05PSEUDNOVOGR05.borderless">
										<!-- Start VENDAW05PSEUDNOVOGR05 -->
										<q-row v-if="controls.VENDAW05SALE_DTAPRESE.isVisible || controls.VENDAW05SALE_APRESENT.isVisible">
											<q-col
												v-if="controls.VENDAW05SALE_DTAPRESE.isVisible"
												cols="auto">
												<base-input-structure
													v-if="controls.VENDAW05SALE_DTAPRESE.isVisible"
													class="i-text"
													v-bind="controls.VENDAW05SALE_DTAPRESE.wrapperProps"
													:id="getControlId(controls.VENDAW05SALE_DTAPRESE)"
													v-on="controls.VENDAW05SALE_DTAPRESE.handlers"
													:loading="controls.VENDAW05SALE_DTAPRESE.props.loading"
													:reporting-mode-on="reportingModeCAV"
													:suggestion-mode-on="suggestionModeOn">
													<q-date-time-picker
														v-if="controls.VENDAW05SALE_DTAPRESE.isVisible"
														v-bind="controls.VENDAW05SALE_DTAPRESE.props"
														:id="getControlId(controls.VENDAW05SALE_DTAPRESE)"
											...
											<q-col
												...
												<base-input-structure
													v-if="controls.VENDAW05SALE_APRESENT.isVisible"
													class="i-text"
													v-bind="controls.VENDAW05SALE_APRESENT.wrapperProps"
													:id="getControlId(controls.VENDAW05SALE_APRESENT)"
													v-on="controls.VENDAW05SALE_APRESENT.handlers"
													:loading="controls.VENDAW05SALE_APRESENT.props.loading"
													:reporting-mode-on="reportingModeCAV"
													:suggestion-mode-on="suggestionModeOn">
													<template #label>
														<q-checkbox
...
<script>
	...
	import FormViewModel from './QFormVendawvVendaw05ViewModel.js'

	const requiredTextResources = ['QFormVendawvVendaw05', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QFormVendawvVendaw05',
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW05',
					location: 'form-VENDAWV-VENDAW05',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawvVendaw05', false),

				interfaceMetadata: {
					id: 'QFormVendawvVendaw05', // Used for resources
				...
				formInfo: {
					...
					designation: computed(() => this.Resources.APRESENTACAO15975),
				...
				wizardData: readonly({
					...
					stepFieldIds: [
						'VENDAW05PSEUDNOVOGR05',
						'VENDAW05SALE_DTAPRESE',
						'VENDAW05SALE_APRESENT',
					]
				}),
				...
				controls: {
					VENDAW05PSEUDNOVOGR05: new fieldControlClass.GroupControl({
						id: 'VENDAW05PSEUDNOVOGR05',
						name: 'NOVOGR05',
						size: 'block',
						...
						isCollapsible: false,
						anchored: false,
						directChildren: ['VENDAW05SALE_DTAPRESE', 'VENDAW05SALE_APRESENT'],
						controlLimits: [
						],
					}, this),
					VENDAW05SALE_DTAPRESE: new fieldControlClass.DateControl({
						modelField: 'ValDtaprese',
						valueChangeEvent: 'fieldChange:sale.dtaprese',
						id: 'VENDAW05SALE_DTAPRESE',
						name: 'DTAPRESE',
						size: 'medium',
						label: computed(() => this.Resources.PRESENTATION_MADE15117),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'VENDAW05PSEUDNOVOGR05',
						dateTimeType: 'dateTime',
						controlLimits: [
						],
					}, this),
					VENDAW05SALE_APRESENT: new fieldControlClass.BooleanControl({
						modelField: 'ValApresent',
						valueChangeEvent: 'fieldChange:sale.apresent',
						id: 'VENDAW05SALE_APRESENT',
						name: 'APRESENT',
						size: 'small',
						label: computed(() => this.Resources.PRESENTATION64246),
						placeholder: '',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLBLR VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS VENDAW05]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
