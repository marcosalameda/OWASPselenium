...
<script>
	...
	import FormViewModel from './QFormVendawVendaw06ViewModel.js'

	const requiredTextResources = ['QFormVendawVendaw06', 'hardcoded', 'messages']
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawVendaw06', false),

				interfaceMetadata: {
					id: 'QFormVendawVendaw06', // Used for resources
