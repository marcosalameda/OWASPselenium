				...
				<q-row-container v-show="controls.VENDAWV_PSEUDFASES___.isVisible">
					<q-control-wrapper
						...
						<q-wizard
							...
							<q-row-container
								v-show="controls.VENDAW07PSEUDNOVOGR07.isVisible"
								is-large>
								<q-control-wrapper
									v-show="controls.VENDAW07PSEUDNOVOGR07.isVisible"
									...
									<q-group-box-container
										...
										:is-visible="controls.VENDAW07PSEUDNOVOGR07.isVisible">
										<!-- Start VENDAW07PSEUDNOVOGR07 -->
										<q-row-container v-show="controls.VENDAW07SALE_TENTFECH.isVisible || controls.VENDAW07SALE_DTVENDA_.isVisible">
											<q-control-wrapper
												v-show="controls.VENDAW07SALE_TENTFECH.isVisible"
												class="control-join-group">
											...
											<q-control-wrapper
												v-show="controls.VENDAW07SALE_DTVENDA_.isVisible"
												class="control-join-group">
												<base-input-structure
													class="i-text"
