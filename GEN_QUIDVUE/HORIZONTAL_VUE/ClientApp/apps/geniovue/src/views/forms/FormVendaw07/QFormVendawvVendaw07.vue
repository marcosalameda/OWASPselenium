				...
				<q-row v-if="controls.VENDAWV_PSEUDFASES___.isVisible">
					<q-col
						...
						<q-wizard
							...
							<q-row v-if="controls.VENDAW07PSEUDNOVOGR07.isVisible">
								<q-col v-if="controls.VENDAW07PSEUDNOVOGR07.isVisible">
									<q-group-box-container
										v-if="controls.VENDAW07PSEUDNOVOGR07.isVisible"
										v-bind="controls.VENDAW07PSEUDNOVOGR07"
										:id="getControlId(controls.VENDAW07PSEUDNOVOGR07)"
										:no-border="controls.VENDAW07PSEUDNOVOGR07.borderless">
										<!-- Start VENDAW07PSEUDNOVOGR07 -->
										<q-row v-if="controls.VENDAW07SALE_TENTFECH.isVisible || controls.VENDAW07SALE_DTVENDA_.isVisible">
											<q-col
												...
												<base-input-structure
													v-if="controls.VENDAW07SALE_TENTFECH.isVisible"
													class="i-text"
													v-bind="controls.VENDAW07SALE_TENTFECH.wrapperProps"
													:id="getControlId(controls.VENDAW07SALE_TENTFECH)"
											...
											<q-col
												...
												<base-input-structure
													v-if="controls.VENDAW07SALE_DTVENDA_.isVisible"
													class="i-text"
													v-bind="controls.VENDAW07SALE_DTVENDA_.wrapperProps"
													:id="getControlId(controls.VENDAW07SALE_DTVENDA_)"
...
<script>
	...
	import FormViewModel from './QFormVendawvVendaw07ViewModel.js'

	const requiredTextResources = ['QFormVendawvVendaw07', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QFormVendawvVendaw07',
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW07',
					location: 'form-VENDAWV-VENDAW07',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawvVendaw07', false),

				interfaceMetadata: {
					id: 'QFormVendawvVendaw07', // Used for resources
				...
				formInfo: {
					...
					designation: computed(() => this.Resources.FECHO_DA_VENDA48081),
				...
				wizardData: readonly({
					...
					stepFieldIds: [
						...
						'VENDAW07SALE_TENTFECH',
						'VENDAW07SALE_DTVENDA_',
					]
				}),
				...
				controls: {
					VENDAW07PSEUDNOVOGR07: new fieldControlClass.GroupControl({
						...
						isCollapsible: false,
						anchored: false,
						directChildren: ['VENDAW07SALE_TENTFECH', 'VENDAW07SALE_DTVENDA_'],
						controlLimits: [
						],
					}, this),
					VENDAW07SALE_TENTFECH: new fieldControlClass.DateControl({
					...
					VENDAW07SALE_DTVENDA_: new fieldControlClass.DateControl({
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_LOAD_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_LOADED_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_APPLY_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_APPLY_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_SAVE_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_SAVE_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_DEL_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_DEL_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT BEFORE_EXIT_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT AFTER_EXIT_JS VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT DLGUPDT VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT CTRLUPD VENDAW07]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
