...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			actions: {
				...
				updateFilesTickets: 'UpdateFilesTicketsVendaw07',
				setFile: 'SetFileVendaw07'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormVendawvVendaw07ViewModel instance.
	 * @returns {QFormVendawvVendaw07ViewModel} A new instance of QFormVendawvVendaw07ViewModel
	 */
	clone()
	{
