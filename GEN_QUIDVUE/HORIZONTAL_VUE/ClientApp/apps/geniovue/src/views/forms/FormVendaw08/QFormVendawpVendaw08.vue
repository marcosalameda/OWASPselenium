...
<script>
	...
	import FormViewModel from './QFormVendawpVendaw08ViewModel.js'

	const requiredTextResources = ['QFormVendawpVendaw08', 'hardcoded', 'messages']
	...
	export default {
		...
		props: {
			...
			nestedRouteParams: {
				...
				default: () => ({
					name: 'VENDAW08',
					location: 'form-VENDAWP-VENDAW08',
					params: {
						isNested: true
					}
				})
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormVendawpVendaw08', false),

				interfaceMetadata: {
					id: 'QFormVendawpVendaw08', // Used for resources
