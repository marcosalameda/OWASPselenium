...
<script>
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('GQT_Menu_2411', false),

				interfaceMetadata: {
					id: 'QMenuGQT_2411', // Used for resources
		...
		methods: {
			...
			applyChanges()
			{
				const action = 'GQT_Menu_2411_Execute'
