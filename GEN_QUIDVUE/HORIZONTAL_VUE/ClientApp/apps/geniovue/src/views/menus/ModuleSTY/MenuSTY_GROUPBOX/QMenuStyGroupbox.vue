...
<script>
	...
	import MenuViewModel from './QMenuSTY_GROUPBOXViewModel.js'

	const requiredTextResources = ['QMenuSTY_GROUPBOX', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS STY_MENU_GROUPBOX]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuStyGroupbox',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuSTY_GROUPBOX', false),

				interfaceMetadata: {
					id: 'QMenuSTY_GROUPBOX', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'STY_GROUPBOX',
					name: 'EQUIP',
					route: 'menu-STY_GROUPBOX',
					order: '2311',
					controller: 'EQUIP',
					action: 'STY_Menu_GROUPBOX',
					isPopup: false
				},
				...
				controls: {
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							viewManagement: 'U',
							showLimitsInfo: true,
							tableTitle: computed(() => this.Resources.GROUPBOX00384),
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'SHOW', formName: 'GROUPBX'
								}
							},
							formsDefinition: {
								'GROUPBX': {
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS STY_MENU_GROUPBOX]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT STY_MENU_GROUPBOX]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS STY_GROUPBOX]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS STY_MENU_GROUPBOX]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
