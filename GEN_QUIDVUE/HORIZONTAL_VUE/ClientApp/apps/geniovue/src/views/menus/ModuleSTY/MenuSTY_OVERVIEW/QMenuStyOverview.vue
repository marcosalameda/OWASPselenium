		...
		<div
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE STY_Menu_OVERVIEW]/ -->
				</q-table>
			</q-row-container>
		</div>
	</teleport>
...
<script>
	...
	import MenuViewModel from './QMenuSTY_OVERVIEWViewModel.js'
		...
		data()
		{
			...
			return {
				...
				menuInfo: {
					id: 'OVERVIEW',
					isMenuList: true,
					designation: computed(() => this.Resources.UI_COMPONENTS21662),
					...
					menu: new controlClass.TableSpecialRenderingControl({
						...
						columnsOriginal: [
							...
							new listColumnTypes.ImageColumn({
								...
								dataTitle: computed(() => genericFunctions.formatString(vm.Resources.IMAGEM_UTILIZADA_PAR58591, vm.Resources.THUMBNAIL30025)),
								scrollData: 3,
								sortable: false,
								searchable: false,
								export: 1,
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT STY_MENU_OVERVIEW]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS STY_OVERVIEW]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
