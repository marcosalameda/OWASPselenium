		...
		<div
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL GQT CUSTOM_TABLE TRN_Menu_T19PROPERTY]/ -->
				</q-table>
			</q-row-container>
		</div>
	</teleport>
...
<script>
	...
	import MenuViewModel from './QMenuTRN_T19PROPERTYViewModel.js'

	const requiredTextResources = ['QMenuTRN_T19PROPERTY', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS TRN_MENU_T19PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuTrnT19property',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuTRN_T19PROPERTY', false),

				interfaceMetadata: {
					id: 'QMenuTRN_T19PROPERTY', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'TRN_T19PROPERTY',
					name: 'PROPE',
					route: 'menu-TRN_T19PROPERTY',
					order: '1J11',
					controller: 'PROPE',
					action: 'TRN_Menu_T19PROPERTY',
					isPopup: false
				},
				...
				controls: {
					menu: new controlClass.TableListControl({
						...
						config: {
							...
							rowClickAction: {
								...
								params: {
									...
									isControlled: true,
									action: vm.openFormAction, type: 'form', mode: 'SHOW', formName: 'PROPE19'
								}
							},
							formsDefinition: {
								'PROPE19': {
						...
						uuid: 'c95ccfe6-3b62-4e44-91b5-55b24c2e14cd',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS TRN_MENU_T19PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT COMPONENT_BEFORE_UNMOUNT TRN_MENU_T19PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS TRN_T19PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS TRN_MENU_T19PROPERTY]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
