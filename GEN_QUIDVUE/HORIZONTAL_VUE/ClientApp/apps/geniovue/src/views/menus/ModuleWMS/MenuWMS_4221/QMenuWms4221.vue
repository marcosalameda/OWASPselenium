...
<script>
	...
	import MenuViewModel from './QMenuWMS_4221ViewModel.js'

	const requiredTextResources = ['QMenuWMS_4221', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS WMS_MENU_4221]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuWMS_4221', false),

				interfaceMetadata: {
					id: 'QMenuWMS_4221', // Used for resources
				...
				controls: {
					menu: new controlClass.TableListControl({
							...
							rowClickAction: {
								...
								params: {
									...
									limits: [
										{
											identifier: 'id',
											fnValueSelector: (row) => row.ValCodfacil
										},
									],
									isControlled: true,
						...
						globalEvents: ['changed-FACIL', 'changed-ENTIT', 'changed-CNTRY', 'changed-FACTY'],
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS WMS_MENU_4221]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS WMS_4221]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS WMS_MENU_4221]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
