<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-artigvalgitemitemdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ARTIGVALGITEMITEMDES__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ArtigvalgitemitemdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ARTIGVALGITEMITEMDES__SeeMore', false),

				interfaceMetadata: {
					id: 'ARTIGVALGITEMITEMDES__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ARTIGVALGITEMITEMDES__SeeMore',
					name: 'ARTIGVALGITEMITEMDES__SeeMore',
					controller: 'ITEM',
					action: 'ARTIGVAL_GitemValItemdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-artigvalgitemitemdes',
				...
				isActive: true,
				returnElement: 'ARTIGVALGITEMITEMDES__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-artigvalgitemitemdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Artigval_Artigval_GitemValItemdes',
