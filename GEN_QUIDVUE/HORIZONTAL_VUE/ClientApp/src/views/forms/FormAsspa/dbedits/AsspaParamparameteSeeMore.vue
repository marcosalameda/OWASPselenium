...
<script>
	...
	const requiredTextResources = ['ASSPA___PARAMPARAMETE_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'AsspaParamparameteSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ASSPA___PARAMPARAMETE_SeeMore', false),

				interfaceMetadata: {
					id: 'ASSPA___PARAMPARAMETE_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ASSPA___PARAMPARAMETE_SeeMore',
					name: 'ASSPA___PARAMPARAMETE_SeeMore',
					controller: 'ASSPA',
					action: 'ASSPA_ParamValParameter'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'ASSPA___PARAMPARAMETE_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-asspa-paramparamete')
		},
