<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-dentr-ware1warehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['DENTR___WARE1WAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'DentrWare1warehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('DENTR___WARE1WAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'DENTR___WARE1WAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'DENTR___WARE1WAREHDES_SeeMore',
					name: 'DENTR___WARE1WAREHDES_SeeMore',
					controller: 'INDOC',
					action: 'DENTR_Ware1ValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-dentr-ware1warehdes',
				...
				isActive: true,
				returnElement: 'DENTR___WARE1WAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-dentr-ware1warehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						changeEvents: ['changed-WARE1'],
						uuid: 'Dentr_Dentr_Ware1ValWarehdes',
