				...
				<q-row-container
					...
					<q-control-wrapper
						...
						<q-accordion-container
							...
							v-on="controls.ENTIX___PSEUDNOVOGR05.handlers"
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		...
		watch: {
			...
			'controls.ENTIX___PSEUDNOVOGR02.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'ENTIX___PSEUDNOVOGR02',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.ENTIX___PSEUDNOVOGR03.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'ENTIX___PSEUDNOVOGR03',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
			'controls.ENTIX___PSEUDNOVOGR04.isOpen'(newVal)
			{
				const data = {
					navigationId: this.navigationId,
					key: this.storeKey,
					formInfo: this.formInfo,
					fieldId: 'ENTIX___PSEUDNOVOGR04',
					containerState: newVal
				}
				this.storeContainerState(data)
			},
