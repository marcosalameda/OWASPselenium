<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equip-warehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIP___WAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipWarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIP___WAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIP___WAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIP___WAREHWAREHDES_SeeMore',
					name: 'EQUIP___WAREHWAREHDES_SeeMore',
					controller: 'EQUIP',
					action: 'EQUIP_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equip-warehwarehdes',
				...
				isActive: true,
				returnElement: 'EQUIP___WAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-equip-warehwarehdes')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Equip_Equip_WarehValWarehdes',
