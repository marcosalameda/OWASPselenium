<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-equipm-manufname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EQUIPM__MANUFNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'EquipmManufnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EQUIPM__MANUFNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'EQUIPM__MANUFNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EQUIPM__MANUFNAME_____SeeMore',
					name: 'EQUIPM__MANUFNAME_____SeeMore',
					controller: 'ASSET',
					action: 'EQUIPM_ManufValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-equipm-manufname',
				headerTitle: computed(() => this.Resources.MANUFACTURERS25464),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'EQUIPM__MANUFNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-equipm-manufname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Equipm_ManufValName',
							serverMode: true,
							pkColumn: 'ValCodentit',
							tableAlias: 'MANUF',
							tableNamePlural: computed(() => this.Resources.MANUFACTURERS25464),
							viewManagement: 'N',
							tableTitle: '',
						...
						changeEvents: ['changed-MANUF'],
						uuid: 'Equipm_Equipm_ManufValName',
