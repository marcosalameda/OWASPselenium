<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-facilfexentitname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FACILFEXENTITNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FacilfexentitnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FACILFEXENTITNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'FACILFEXENTITNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FACILFEXENTITNAME_____SeeMore',
					name: 'FACILFEXENTITNAME_____SeeMore',
					controller: 'FACIL',
					action: 'FACILFEX_EntitValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FACILFEXENTITNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-facilfexentitname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Facilfex_Facilfex_EntitValName',
