<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fotos-equipregistnr-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FOTOS___EQUIPREGISTNR_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FotosEquipregistnrSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FOTOS___EQUIPREGISTNR_SeeMore', false),

				interfaceMetadata: {
					id: 'FOTOS___EQUIPREGISTNR_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FOTOS___EQUIPREGISTNR_SeeMore',
					name: 'FOTOS___EQUIPREGISTNR_SeeMore',
					controller: 'PHOTO',
					action: 'FOTOS_EquipValRegistnr'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-fotos-equipregistnr',
				...
				isActive: true,
				returnElement: 'FOTOS___EQUIPREGISTNR_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-fotos-equipregistnr')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Fotos_Fotos_EquipValRegistnr',
