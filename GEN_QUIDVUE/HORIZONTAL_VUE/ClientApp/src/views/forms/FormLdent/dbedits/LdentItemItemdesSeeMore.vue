<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-ldent-item-itemdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['LDENT___ITEM_ITEMDES__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'LdentItemItemdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('LDENT___ITEM_ITEMDES__SeeMore', false),

				interfaceMetadata: {
					id: 'LDENT___ITEM_ITEMDES__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'LDENT___ITEM_ITEMDES__SeeMore',
					name: 'LDENT___ITEM_ITEMDES__SeeMore',
					controller: 'LDENT',
					action: 'LDENT_ItemValItemdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-ldent-item-itemdes',
				...
				isActive: true,
				returnElement: 'LDENT___ITEM_ITEMDES__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-ldent-item-itemdes')
		},
