<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-messa-entitname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['MESSA___ENTITNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'MessaEntitnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('MESSA___ENTITNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'MESSA___ENTITNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'MESSA___ENTITNAME_____SeeMore',
					name: 'MESSA___ENTITNAME_____SeeMore',
					controller: 'MESSA',
					action: 'MESSA_EntitValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'MESSA___ENTITNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-messa-entitname')
		},
