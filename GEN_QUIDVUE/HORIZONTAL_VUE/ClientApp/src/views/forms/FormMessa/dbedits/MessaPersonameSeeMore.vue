<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-messa-personame-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['MESSA___PERSONAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'MessaPersonameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('MESSA___PERSONAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'MESSA___PERSONAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'MESSA___PERSONAME_____SeeMore',
					name: 'MESSA___PERSONAME_____SeeMore',
					controller: 'MESSA',
					action: 'MESSA_PersoValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'MESSA___PERSONAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-messa-personame')
		},
