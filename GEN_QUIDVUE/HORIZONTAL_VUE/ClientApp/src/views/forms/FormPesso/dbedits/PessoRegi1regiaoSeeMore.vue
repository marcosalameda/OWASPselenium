<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pesso-regi1regiao-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PESSO___REGI1REGIAO___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PessoRegi1regiaoSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PESSO___REGI1REGIAO___SeeMore', false),

				interfaceMetadata: {
					id: 'PESSO___REGI1REGIAO___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PESSO___REGI1REGIAO___SeeMore',
					name: 'PESSO___REGI1REGIAO___SeeMore',
					controller: 'PESSO',
					action: 'PESSO_Regi1ValRegiao'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PESSO___REGI1REGIAO___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pesso-regi1regiao')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						changeEvents: ['changed-PAIS1', 'changed-REGI1'],
						uuid: 'Pesso_Pesso_Regi1ValRegiao',
