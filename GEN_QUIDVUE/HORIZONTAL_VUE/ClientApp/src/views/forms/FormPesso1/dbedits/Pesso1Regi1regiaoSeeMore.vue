...
<script>
	...
	const requiredTextResources = ['PESSO1__REGI1REGIAO___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Pesso1Regi1regiaoSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PESSO1__REGI1REGIAO___SeeMore', false),

				interfaceMetadata: {
					id: 'PESSO1__REGI1REGIAO___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PESSO1__REGI1REGIAO___SeeMore',
					name: 'PESSO1__REGI1REGIAO___SeeMore',
					controller: 'PESSO',
					action: 'PESSO1_Regi1ValRegiao'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PESSO1__REGI1REGIAO___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pesso1-regi1regiao')
		},
