<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-plist-warehwarehdes-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PLIST___WAREHWAREHDES_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PlistWarehwarehdesSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PLIST___WAREHWAREHDES_SeeMore', false),

				interfaceMetadata: {
					id: 'PLIST___WAREHWAREHDES_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PLIST___WAREHWAREHDES_SeeMore',
					name: 'PLIST___WAREHWAREHDES_SeeMore',
					controller: 'ITEM',
					action: 'PLIST_WarehValWarehdes'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PLIST___WAREHWAREHDES_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-plist-warehwarehdes')
		},
