<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-prope03-city-city-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPE03_CITY_CITY_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Prope03CityCitySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPE03_CITY_CITY_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPE03_CITY_CITY_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPE03_CITY_CITY_____SeeMore',
					name: 'PROPE03_CITY_CITY_____SeeMore',
					controller: 'PROPE',
					action: 'PROPE03_CityValCity'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PROPE03_CITY_CITY_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-prope03-city-city')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Prope03_Prope03_CityValCity',
