<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-prope10-agentname-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPE10_AGENTNAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Prope10AgentnameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPE10_AGENTNAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPE10_AGENTNAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPE10_AGENTNAME_____SeeMore',
					name: 'PROPE10_AGENTNAME_____SeeMore',
					controller: 'PROPE',
					action: 'PROPE10_AgentValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PROPE10_AGENTNAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-prope10-agentname')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Prope10_Prope10_AgentValName',
