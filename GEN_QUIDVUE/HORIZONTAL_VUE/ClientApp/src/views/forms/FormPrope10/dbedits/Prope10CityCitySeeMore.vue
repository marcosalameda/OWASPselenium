<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-prope10-city-city-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPE10_CITY_CITY_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Prope10CityCitySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPE10_CITY_CITY_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPE10_CITY_CITY_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPE10_CITY_CITY_____SeeMore',
					name: 'PROPE10_CITY_CITY_____SeeMore',
					controller: 'PROPE',
					action: 'PROPE10_CityValCity'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'PROPE10_CITY_CITY_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-prope10-city-city')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Prope10_Prope10_CityValCity',
