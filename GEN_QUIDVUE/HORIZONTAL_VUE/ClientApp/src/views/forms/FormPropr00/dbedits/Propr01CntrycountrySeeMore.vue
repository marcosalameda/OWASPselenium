<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-propr01-cntrycountry-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPR01_CNTRYCOUNTRY__SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Propr01CntrycountrySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPR01_CNTRYCOUNTRY__SeeMore', false),

				interfaceMetadata: {
					id: 'PROPR01_CNTRYCOUNTRY__SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPR01_CNTRYCOUNTRY__SeeMore',
					name: 'PROPR01_CNTRYCOUNTRY__SeeMore',
					controller: 'PROPR',
					action: 'PROPR01_CntryValCountry'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-propr01-cntrycountry',
				...
				isActive: true,
				returnElement: 'PROPR01_CNTRYCOUNTRY__lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-propr01-cntrycountry')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Propr01_Propr01_CntryValCountry',
