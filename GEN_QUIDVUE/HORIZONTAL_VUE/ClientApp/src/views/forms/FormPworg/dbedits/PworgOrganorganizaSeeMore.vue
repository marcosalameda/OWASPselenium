<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-pworg-organorganiza-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PWORG___ORGANORGANIZA_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PworgOrganorganizaSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PWORG___ORGANORGANIZA_SeeMore', false),

				interfaceMetadata: {
					id: 'PWORG___ORGANORGANIZA_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PWORG___ORGANORGANIZA_SeeMore',
					name: 'PWORG___ORGANORGANIZA_SeeMore',
					controller: 'PWORG',
					action: 'PWORG_OrganValOrganiza'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-pworg-organorganiza',
				...
				isActive: true,
				returnElement: 'PWORG___ORGANORGANIZA_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-pworg-organorganiza')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Pworg_Pworg_OrganValOrganiza',
