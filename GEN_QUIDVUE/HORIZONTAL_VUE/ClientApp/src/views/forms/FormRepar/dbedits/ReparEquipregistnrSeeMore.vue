<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-repar-equipregistnr-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['REPAR___EQUIPREGISTNR_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ReparEquipregistnrSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('REPAR___EQUIPREGISTNR_SeeMore', false),

				interfaceMetadata: {
					id: 'REPAR___EQUIPREGISTNR_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'REPAR___EQUIPREGISTNR_SeeMore',
					name: 'REPAR___EQUIPREGISTNR_SeeMore',
					controller: 'REPAR',
					action: 'REPAR_EquipValRegistnr'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'REPAR___EQUIPREGISTNR_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-repar-equipregistnr')
		},
