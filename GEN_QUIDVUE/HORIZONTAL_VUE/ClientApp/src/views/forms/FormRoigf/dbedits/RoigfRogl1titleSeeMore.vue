<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-roigf-rogl1title-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['ROIGF___ROGL1TITLE____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'RoigfRogl1titleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('ROIGF___ROGL1TITLE____SeeMore', false),

				interfaceMetadata: {
					id: 'ROIGF___ROGL1TITLE____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'ROIGF___ROGL1TITLE____SeeMore',
					name: 'ROIGF___ROGL1TITLE____SeeMore',
					controller: 'ROIGF',
					action: 'ROIGF_Rogl1ValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-roigf-rogl1title',
				headerTitle: computed(() => this.Resources.ROW_ORDER_GROUPS_LEV49262),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'ROIGF___ROGL1TITLE____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-roigf-rogl1title')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Roigf_Roigf_Rogl1ValTitle',
