<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-tabpr-tpequtipoequi-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['TABPR___TPEQUTIPOEQUI_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'TabprTpequtipoequiSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('TABPR___TPEQUTIPOEQUI_SeeMore', false),

				interfaceMetadata: {
					id: 'TABPR___TPEQUTIPOEQUI_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'TABPR___TPEQUTIPOEQUI_SeeMore',
					name: 'TABPR___TPEQUTIPOEQUI_SeeMore',
					controller: 'TABPR',
					action: 'TABPR_TpequValTipoequi'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-tabpr-tpequtipoequi',
				...
				isActive: true,
				returnElement: 'TABPR___TPEQUTIPOEQUI_lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-tabpr-tpequtipoequi')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Tabpr_Tabpr_TpequValTipoequi',
