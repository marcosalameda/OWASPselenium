<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-tblk-grpb-name-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['TBLK____GRPB_NAME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'TblkGrpbNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('TBLK____GRPB_NAME_____SeeMore', false),

				interfaceMetadata: {
					id: 'TBLK____GRPB_NAME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'TBLK____GRPB_NAME_____SeeMore',
					name: 'TBLK____GRPB_NAME_____SeeMore',
					controller: 'TBLK',
					action: 'TBLK_GrpbValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-tblk-grpb-name',
				headerTitle: computed(() => this.Resources.GROUPS__BASIC_25795),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'TBLK____GRPB_NAME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-tblk-grpb-name')
		},
