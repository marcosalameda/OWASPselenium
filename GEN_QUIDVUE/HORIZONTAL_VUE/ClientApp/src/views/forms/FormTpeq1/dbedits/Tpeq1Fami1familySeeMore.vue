<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-tpeq1-fami1family-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['TPEQ1___FAMI1FAMILY___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'Tpeq1Fami1familySeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('TPEQ1___FAMI1FAMILY___SeeMore', false),

				interfaceMetadata: {
					id: 'TPEQ1___FAMI1FAMILY___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'TPEQ1___FAMI1FAMILY___SeeMore',
					name: 'TPEQ1___FAMI1FAMILY___SeeMore',
					controller: 'TPEQ1',
					action: 'TPEQ1_Fami1ValFamily'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-tpeq1-fami1family',
				headerTitle: computed(() => this.Resources.EQUIPMET_FAMILIES32461),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'TPEQ1___FAMI1FAMILY___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-tpeq1-fami1family')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Tpeq1_Tpeq1_Fami1ValFamily',
