<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-tradu-lang1langua-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['TRADU___LANG1LANGUA___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'TraduLang1languaSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('TRADU___LANG1LANGUA___SeeMore', false),

				interfaceMetadata: {
					id: 'TRADU___LANG1LANGUA___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'TRADU___LANG1LANGUA___SeeMore',
					name: 'TRADU___LANG1LANGUA___SeeMore',
					controller: 'TRADU',
					action: 'TRADU_Lang1ValLangua'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'TRADU___LANG1LANGUA___lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-tradu-lang1langua')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						changeEvents: ['changed-LANG1'],
						uuid: 'Tradu_Tradu_Lang1ValLangua',
