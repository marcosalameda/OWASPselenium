<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-users-psw-nome-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['USERS___PSW__NOME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'UsersPswNomeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('USERS___PSW__NOME_____SeeMore', false),

				interfaceMetadata: {
					id: 'USERS___PSW__NOME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'USERS___PSW__NOME_____SeeMore',
					name: 'USERS___PSW__NOME_____SeeMore',
					controller: 'USERS',
					action: 'USERS_PswValNome'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'USERS___PSW__NOME_____lookup_see-more_button'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-users-psw-nome')
		},
