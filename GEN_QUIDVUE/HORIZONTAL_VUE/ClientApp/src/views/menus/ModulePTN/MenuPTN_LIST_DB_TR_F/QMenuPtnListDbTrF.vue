...
<script>
	...
	const requiredTextResources = ['QMenuPTN_LIST_DB_TR_F', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_INCLUDEJS PTN_MENU_LIST_DB_TR_F]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */

	export default {
		name: 'QMenuPtnListDbTrF',
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuPTN_LIST_DB_TR_F', false),

				interfaceMetadata: {
					id: 'QMenuPTN_LIST_DB_TR_F', // Used for resources
				...
				menuInfo: {
					...
					acronym: 'PTN_LIST_DB_TR_F',
					name: 'EXPEN',
					route: 'menu-PTN_LIST_DB_TR_F',
					order: '3K1',
					controller: 'EXPEN',
					action: 'PTN_Menu_LIST_DB_TR_F',
					isPopup: false
				},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FORM_CODEJS PTN_MENU_LIST_DB_TR_F]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
			...
			/**
			 * Execute the triggers of the trigger button TRIGGER_MENU2.
			...
			async PTN_MenuTR_TRIGGER_MENU2_TRIGMENU2_1(id)
			{
				netAPI.postData(
					'Expen',
					'PTN_MenuTR_TRIGGER_MENU2_TRIGMENU2_1',
					{ key: id },
					async (data) => {
						try
						{
							...
							{
								await this.PTN_MenuTR_TRIGGER_MENU2_TRIGMENU2_2(id)
							}
							else
								this.$eventTracker.addError({ origin: 'Trigger TRIGMENU2', message: 'Routine "PTN_MenuTR_TRIGGER_MENU2" finished execution with an unknown result type: ' + data.success })
						}
						catch (e)
						{
							genericFunctions.displayMessage(this.Resources.NAO_FOI_POSSIVEL_CON65121, 'error')
							this.$eventTracker.addError({ origin: 'Trigger TRIGMENU2 (catch)', message: e.toString() })
						}
					}, () => {
						genericFunctions.displayMessage(this.Resources.NAO_FOI_POSSIVEL_CON65121, 'error')
					},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT FUNCTIONS_JS PTN_LIST_DB_TR_F]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL GQT LISTING_CODEJS PTN_MENU_LIST_DB_TR_F]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
