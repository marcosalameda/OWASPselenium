...
public class AssmaForm : Form
{
	...
	/// Manual name
	/// </summary>
	public BaseInputControl AssmaName => new BaseInputControl(driver, ContainerLocator, "#ASSMA___ASSMANAME____");

	/// <summary>
	/// Digital document
	/// </summary>
	public DocumentControl AssmaDigdocum => new DocumentControl(driver, ContainerLocator, "container-ASSMA___ASSMADIGDOCUM");

	/// <summary>
	/// Notes
	/// </summary>
	public BaseInputControl AssmaNotes => new BaseInputControl(driver, ContainerLocator, "#ASSMA___ASSMANOTES___");
