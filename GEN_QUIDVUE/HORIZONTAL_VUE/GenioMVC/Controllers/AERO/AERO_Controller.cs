...
namespace GenioMVC.Controllers
{
	public partial class AeroController : ControllerBase
	{
		...
		public AeroController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AERO]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAaero>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER AERO]/
		...
		/// <summary>
		/// Recalculate formulas of the "Aero" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Aero([FromBody]Aero_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "aero",
				(primaryKey) => Models.Aero.Find(primaryKey, UserContext.Current, "FAERO"),
				(model) => formData.MapToModel(model as Models.Aero)
			);
		}
		...
		{
			return base.GetDocumsTickets("AERO", requestModel.FieldName, requestModel.KeyValue);
		}
