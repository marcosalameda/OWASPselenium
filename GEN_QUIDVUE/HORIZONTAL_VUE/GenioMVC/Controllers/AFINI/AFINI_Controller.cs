...
// USE /[MANUAL GQT INCLUDE_CONTROLLER AFINI]/

namespace GenioMVC.Controllers
{
	public partial class AfiniController : ControllerBase
	{
		private IChatbotService _aiService;
		public AfiniController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AFINI]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAafini>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER AFINI]/
		...
		{
			return base.GetDocumsTickets("AFINI", requestModel.FieldName, requestModel.KeyValue);
		}
