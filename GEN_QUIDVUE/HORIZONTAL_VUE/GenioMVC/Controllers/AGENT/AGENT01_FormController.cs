...
// USE /[MANUAL GQT CONTROLLER_SHOW AGENT01]/
		...
		public ActionResult Agent01_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Agent01_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST AGENT01]/
		...
		{
			string id = requestModel.Id;
			Agent01_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET AGENT01]/
		public ActionResult Agent01_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("agent");
					var model = GenioMVC.Models.Agent.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT AGENT01]/
		...
		public class Agent01DocumValidateTickets : RequestDocumValidateTickets
		{
			public Agent01_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsAgent01([FromBody] Agent01DocumValidateTickets requestModel)
		{
