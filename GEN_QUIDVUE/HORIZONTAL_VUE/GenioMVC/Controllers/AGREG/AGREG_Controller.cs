...
namespace GenioMVC.Controllers
{
	public partial class AgregController : ControllerBase
	{
		...
		public AgregController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER AGREG]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Agreg row = new Models.Agreg(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Agreg([FromBody]Agreg_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "agreg",
				(primaryKey) => Models.Agreg.Find(primaryKey, UserContext.Current, "FAGREG"),
				(model) => formData.MapToModel(model as Models.Agreg)
			);
		}
		...
		{
			return base.GetDocumsTickets("AGREG", requestModel.FieldName, requestModel.KeyValue);
		}
