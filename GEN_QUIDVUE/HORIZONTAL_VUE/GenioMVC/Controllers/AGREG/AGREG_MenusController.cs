...
namespace GenioMVC.Controllers
{
	public partial class AgregController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult GQT_Menu_A41([FromBody]RequestMenuModel requestModel)
		{
			...
			GQT_Menu_A41_ViewModel model = new GQT_Menu_A41_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_GQT_MENU_A41.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_GQT_MENU_A41.Action)
