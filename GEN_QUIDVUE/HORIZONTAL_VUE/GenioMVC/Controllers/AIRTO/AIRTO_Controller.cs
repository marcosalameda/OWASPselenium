...
// USE /[MANUAL GQT INCLUDE_CONTROLLER AIRTO]/

namespace GenioMVC.Controllers
{
	public partial class AirtoController : ControllerBase
	{
		private IChatbotService _aiService;
		public AirtoController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AIRTO]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAairto>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER AIRTO]/
		...
		{
			return base.GetDocumsTickets("AIRTO", requestModel.FieldName, requestModel.KeyValue);
		}
