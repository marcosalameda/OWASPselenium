...
namespace GenioMVC.Controllers
{
	public partial class AssmaController : ControllerBase
	{
		...
		public AssmaController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER ASSMA]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Assma row = new Models.Assma(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Assma([FromBody]Assma_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "assma",
				(primaryKey) => Models.Assma.Find(primaryKey, UserContext.Current, "FASSMA"),
				(model) => formData.MapToModel(model as Models.Assma)
			);
		}
		...
		{
			return base.GetDocumsTickets("ASSMA", requestModel.FieldName, requestModel.KeyValue);
		}
