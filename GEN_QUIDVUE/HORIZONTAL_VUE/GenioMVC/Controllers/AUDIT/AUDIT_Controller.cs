...
// USE /[MANUAL GQT INCLUDE_CONTROLLER AUDIT]/
...
namespace GenioMVC.Controllers
{
	public partial class AuditController : ControllerBase
	{
		...
		public AuditController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AUDIT]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAaudit>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER AUDIT]/
		...
		{
			return base.GetDocumsTickets("AUDIT", requestModel.FieldName, requestModel.KeyValue);
		}
