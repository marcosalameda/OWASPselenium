...
namespace GenioMVC.Controllers
{
	public partial class AuthenticatoptController : ControllerBase
	{
		...
		public AuthenticatoptController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION AUTHENTICATOPT]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAauthenticatopt>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER AUTHENTICATOPT]/
		...
		/// <summary>
		/// Recalculate formulas of the "Authentclass" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Authentclass([FromBody]Authentclass_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "authenticatopt",
				(primaryKey) => Models.Authenticatopt.Find(primaryKey, UserContext.Current, "FAUTHENTCLASS"),
				(model) => formData.MapToModel(model as Models.Authenticatopt)
			);
		}
		...
		/// <summary>
		/// Recalculate formulas of the "Authentcopt" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Authentcopt([FromBody]Authentcopt_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "authenticatopt",
				(primaryKey) => Models.Authenticatopt.Find(primaryKey, UserContext.Current, "FAUTHENTCOPT"),
				(model) => formData.MapToModel(model as Models.Authenticatopt)
			);
		}
		...
		{
			return base.GetDocumsTickets("AUTHENTICATOPT", requestModel.FieldName, requestModel.KeyValue);
		}
