...
// USE /[MANUAL GQT INCLUDE_CONTROLLER BRDPS]/

namespace GenioMVC.Controllers
{
	public partial class BrdpsController : ControllerBase
	{
		private IChatbotService _aiService;
		public BrdpsController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION BRDPS]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAbrdps>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER BRDPS]/
		...
		{
			return base.GetDocumsTickets("BRDPS", requestModel.FieldName, requestModel.KeyValue);
		}
