...
namespace GenioMVC.Controllers
{
	public partial class CardsController : ControllerBase
	{
		...
		public CardsController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION CARDS]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcards>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER CARDS]/
		...
		/// <summary>
		/// Recalculate formulas of the "Cardconfig" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Cardconfig([FromBody]Cardconfig_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "cards",
				(primaryKey) => Models.Cards.Find(primaryKey, UserContext.Current, "FCARDCONFIG"),
				(model) => formData.MapToModel(model as Models.Cards)
			);
		}
		...
		/// <summary>
		/// Recalculate formulas of the "Cards" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Cards([FromBody]Cards_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "cards",
				(primaryKey) => Models.Cards.Find(primaryKey, UserContext.Current, "FCARDS"),
				(model) => formData.MapToModel(model as Models.Cards)
			);
		}
		...
		{
			return base.GetDocumsTickets("CARDS", requestModel.FieldName, requestModel.KeyValue);
		}
