...
// USE /[MANUAL GQT INCLUDE_CONTROLLER CATE2]/

namespace GenioMVC.Controllers
{
	public partial class Cate2Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Cate2Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION CATE2]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcate2>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER CATE2]/
		...
		{
			return base.GetDocumsTickets("CATE2", requestModel.FieldName, requestModel.KeyValue);
		}
