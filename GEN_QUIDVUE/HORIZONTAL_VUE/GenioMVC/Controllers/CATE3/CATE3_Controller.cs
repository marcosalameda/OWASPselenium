...
// USE /[MANUAL GQT INCLUDE_CONTROLLER CATE3]/

namespace GenioMVC.Controllers
{
	public partial class Cate3Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Cate3Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION CATE3]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcate3>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER CATE3]/
		...
		{
			return base.GetDocumsTickets("CATE3", requestModel.FieldName, requestModel.KeyValue);
		}
