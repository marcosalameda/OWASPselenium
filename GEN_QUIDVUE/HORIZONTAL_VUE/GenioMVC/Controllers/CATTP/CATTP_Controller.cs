...
namespace GenioMVC.Controllers
{
	public partial class CattpController : ControllerBase
	{
		...
		public CattpController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER CATTP]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Cattp row = new Models.Cattp(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Tpcat([FromBody]Tpcat_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "cattp",
				(primaryKey) => Models.Cattp.Find(primaryKey, UserContext.Current, "FTPCAT"),
				(model) => formData.MapToModel(model as Models.Cattp)
			);
		}
		...
		{
			return base.GetDocumsTickets("CATTP", requestModel.FieldName, requestModel.KeyValue);
		}
