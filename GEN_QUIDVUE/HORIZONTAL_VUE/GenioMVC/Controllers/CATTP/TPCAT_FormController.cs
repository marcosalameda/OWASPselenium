...
// USE /[MANUAL GQT CONTROLLER_SHOW TPCAT]/
		...
		public ActionResult Tpcat_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Tpcat_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST TPCAT]/
		...
		{
			string id = requestModel.Id;
			Tpcat_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET TPCAT]/
		public ActionResult Tpcat_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("cattp");
					var model = GenioMVC.Models.Cattp.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL TPCAT]/
		...
		public ActionResult Tpcat_SbcatValSubcateg([FromBody] Tpcat_SbcatValSubcategModel requestModel)
		{
			...
			Models.Cattp parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Tpcat_SbcatValSubcateg_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT TPCAT]/
		...
		public class TpcatDocumValidateTickets : RequestDocumValidateTickets
		{
			public Tpcat_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsTpcat([FromBody] TpcatDocumValidateTickets requestModel)
		{
