...
// USE /[MANUAL GQT MANUAL_CONTROLLER CITY]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			dynamic result = null;
			Models.City row = null;

			if (row == null)
			{
				row = new Models.City(UserContext.Current, isEmpty: true);
			...
			try
			{
				...
				{
					case "CITY03__CTRY_COUNTRY_":	// Field (DB)
						{
							row.LoadKeysFromHistory(Navigation, Navigation.CurrentLevel.Level, false, true, true, true);
							var model = new City03_ViewModel(UserContext.Current) { editable = false };							
							model.MapFromModel(row);
							model.Load_City03__ctry_country_(qs);
							result = model.TableCtryCountry;
						}
						break;
					default:
						break;
		...
		public JsonResult GetDependants([FromBody]RequestDependantsModel requestModel)
		{
			...
			try
			{
				...
				{
					case "CITY03__CTRY_COUNTRY_":	// Field (DB)
						values = new City03_ViewModel(UserContext.Current).GetDependant_City03TableCtryCountry(Selected);
						break;
					default: break;
				}
		...
		/// <summary>
		/// Recalculate formulas of the "City03" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_City03([FromBody]City03_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "city",
				(primaryKey) => Models.City.Find(primaryKey, UserContext.Current, "FCITY03"),
