...
// USE /[MANUAL GQT MANUAL_CONTROLLER CMPNY]/
		...
		public JsonResult GetDependants([FromBody]RequestDependantsModel requestModel)
		{
			...
			try
			{
				...
				{
					case "EMPRE___CNTRYCOUNTRY_":	// Field (DB)
						values = new Empre_ViewModel(UserContext.Current).GetDependant_EmpreTableCntryCountry(Selected);
						break;
					default: break;
				}
		...
		{
			return base.GetDocumsTickets("CMPNY", requestModel.FieldName, requestModel.KeyValue);
		}
