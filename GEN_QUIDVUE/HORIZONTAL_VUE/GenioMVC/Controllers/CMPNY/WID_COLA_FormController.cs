...
// USE /[MANUAL GQT CONTROLLER_SHOW WID_COLA]/
		...
		public ActionResult Wid_cola_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Wid_cola_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST WID_COLA]/
		...
		{
			string id = requestModel.Id;
			Wid_cola_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET WID_COLA]/
		public ActionResult Wid_cola_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("cmpny");
					var model = GenioMVC.Models.Cmpny.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL WID_COLA]/
		...
		public class Wid_cola_ValPesslistModel : RequestLookupModel
		{
			public Wid_cola_ViewModel Model { get; set; }
		}
		...
		public ActionResult Wid_cola_ValPesslist([FromBody] Wid_cola_ValPesslistModel requestModel)
		{
			...
			Models.Cmpny parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Wid_cola_ValPesslist_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT WID_COLA]/
		...
		public class Wid_colaDocumValidateTickets : RequestDocumValidateTickets
		{
			public Wid_cola_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsWid_cola([FromBody] Wid_colaDocumValidateTickets requestModel)
		{
