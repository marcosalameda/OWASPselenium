...
// USE /[MANUAL GQT INCLUDE_CONTROLLER COMPA]/

namespace GenioMVC.Controllers
{
	public partial class CompaController : ControllerBase
	{
		private IChatbotService _aiService;
		public CompaController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION COMPA]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcompa>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER COMPA]/
		...
		{
			return base.GetDocumsTickets("COMPA", requestModel.FieldName, requestModel.KeyValue);
		}
