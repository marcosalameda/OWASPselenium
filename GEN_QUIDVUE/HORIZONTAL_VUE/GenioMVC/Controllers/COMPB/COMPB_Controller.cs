...
namespace GenioMVC.Controllers
{
	public partial class CompbController : ControllerBase
	{
		...
		public CompbController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION COMPB]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcompb>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER COMPB]/
		...
		/// <summary>
		/// Recalculate formulas of the "Compbeh" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Compbeh([FromBody]Compbeh_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "compb",
				(primaryKey) => Models.Compb.Find(primaryKey, UserContext.Current, "FCOMPBEH"),
				(model) => formData.MapToModel(model as Models.Compb)
			);
		}
		...
		{
			return base.GetDocumsTickets("COMPB", requestModel.FieldName, requestModel.KeyValue);
		}
