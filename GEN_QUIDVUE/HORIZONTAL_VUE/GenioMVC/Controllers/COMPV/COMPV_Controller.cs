...
namespace GenioMVC.Controllers
{
	public partial class CompvController : ControllerBase
	{
		...
		public CompvController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION COMPV]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcompv>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER COMPV]/
		...
		/// <summary>
		/// Recalculate formulas of the "Opttable" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Opttable([FromBody]Opttable_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "compv",
				(primaryKey) => Models.Compv.Find(primaryKey, UserContext.Current, "FOPTTABLE"),
				(model) => formData.MapToModel(model as Models.Compv)
			);
		}
		...
		{
			return base.GetDocumsTickets("COMPV", requestModel.FieldName, requestModel.KeyValue);
		}
