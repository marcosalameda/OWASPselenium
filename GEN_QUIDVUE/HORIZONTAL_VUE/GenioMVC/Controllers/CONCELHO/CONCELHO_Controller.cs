...
namespace GenioMVC.Controllers
{
	public partial class ConcelhoController : ControllerBase
	{
		...
		public ConcelhoController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION CONCELHO]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAconcelho>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER CONCELHO]/
		...
		/// <summary>
		/// Recalculate formulas of the "Concelho" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Concelho([FromBody]Concelho_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "concelho",
				(primaryKey) => Models.Concelho.Find(primaryKey, UserContext.Current, "FCONCELHO"),
				(model) => formData.MapToModel(model as Models.Concelho)
			);
		}
		...
		{
			return base.GetDocumsTickets("CONCELHO", requestModel.FieldName, requestModel.KeyValue);
		}
