...
namespace GenioMVC.Controllers
{
	public partial class CtryController : ControllerBase
	{
		...
		public CtryController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION CTRY]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioActry>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER CTRY]/
		...
		/// <summary>
		/// Recalculate formulas of the "Ctry03" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Ctry03([FromBody]Ctry03_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "ctry",
				(primaryKey) => Models.Ctry.Find(primaryKey, UserContext.Current, "FCTRY03"),
				(model) => formData.MapToModel(model as Models.Ctry)
			);
		}
		...
		{
			return base.GetDocumsTickets("CTRY", requestModel.FieldName, requestModel.KeyValue);
		}
