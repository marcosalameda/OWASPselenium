...
// USE /[MANUAL GQT AFTER_APPLY_EDIT ABATE]/
		...
		public class AbateDocumValidateTickets : RequestDocumValidateTickets
		{
			public Abate_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsAbate([FromBody] AbateDocumValidateTickets requestModel)
		{
