...
namespace GenioMVC.Controllers
{
	public partial class DilinController : ControllerBase
	{
		...
		public DilinController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER DILIN]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Dilin row = new Models.Dilin(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Dilin([FromBody]Dilin_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "dilin",
				(primaryKey) => Models.Dilin.Find(primaryKey, UserContext.Current, "FDILIN"),
				(model) => formData.MapToModel(model as Models.Dilin)
			);
		}
		...
		{
			return base.GetDocumsTickets("DILIN", requestModel.FieldName, requestModel.KeyValue);
		}
