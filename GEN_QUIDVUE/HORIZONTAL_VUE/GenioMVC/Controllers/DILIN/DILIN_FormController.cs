...
// USE /[MANUAL GQT CONTROLLER_SHOW DILIN]/
		...
		public ActionResult Dilin_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Dilin_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST DILIN]/
		...
		{
			string id = requestModel.Id;
			Dilin_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET DILIN]/
		public ActionResult Dilin_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("dilin");
					var model = GenioMVC.Models.Dilin.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL DILIN]/
		...
		public class Dilin_DispaValDispanrModel : RequestLookupModel
		{
			public Dilin_ViewModel Model { get; set; }
		}
		...
		public ActionResult Dilin_DispaValDispanr([FromBody] Dilin_DispaValDispanrModel requestModel)
		{
			...
			Models.Dilin parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Dilin_DispaValDispanr_ViewModel model = new(m_userContext, parentCtx);
		...
		public class Dilin_ProduValProductModel : RequestLookupModel
		{
			public Dilin_ViewModel Model { get; set; }
		}
		...
		public ActionResult Dilin_ProduValProduct([FromBody] Dilin_ProduValProductModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Dilin_ProduValProduct_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT DILIN]/
		...
		public class DilinDocumValidateTickets : RequestDocumValidateTickets
		{
			public Dilin_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsDilin([FromBody] DilinDocumValidateTickets requestModel)
		{
