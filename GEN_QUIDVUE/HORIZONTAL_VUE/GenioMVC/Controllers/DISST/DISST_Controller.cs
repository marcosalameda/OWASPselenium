...
namespace GenioMVC.Controllers
{
	public partial class DisstController : ControllerBase
	{
		...
		public DisstController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION DISST]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAdisst>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER DISST]/
		...
		/// <summary>
		/// Recalculate formulas of the "Disst" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Disst([FromBody]Disst_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "disst",
				(primaryKey) => Models.Disst.Find(primaryKey, UserContext.Current, "FDISST"),
				(model) => formData.MapToModel(model as Models.Disst)
			);
		}
		...
		{
			return base.GetDocumsTickets("DISST", requestModel.FieldName, requestModel.KeyValue);
		}
