...
// USE /[MANUAL GQT INCLUDE_CONTROLLER DOWN_RULES]/

namespace GenioMVC.Controllers
{
	public partial class Down_rulesController : ControllerBase
	{
		private IChatbotService _aiService;
		public Down_rulesController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION DOWN_RULES]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAdown_rules>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER DOWN_RULES]/
		...
		{
			return base.GetDocumsTickets("DOWN_RULES", requestModel.FieldName, requestModel.KeyValue);
		}
