...
namespace GenioMVC.Controllers
{
	public partial class EsppeController : ControllerBase
	{
		...
		public EsppeController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER ESPPE]/
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Esppe([FromBody]Esppe_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "esppe",
				(primaryKey) => Models.Esppe.Find(primaryKey, UserContext.Current, "FESPPE"),
				(model) => formData.MapToModel(model as Models.Esppe)
			);
		}
		...
		{
			return base.GetDocumsTickets("ESPPE", requestModel.FieldName, requestModel.KeyValue);
		}
