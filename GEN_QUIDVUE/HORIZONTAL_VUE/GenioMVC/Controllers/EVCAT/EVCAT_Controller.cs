...
namespace GenioMVC.Controllers
{
	public partial class EvcatController : ControllerBase
	{
		...
		public EvcatController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER EVCAT]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Evcat row = new Models.Evcat(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Evcat([FromBody]Evcat_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "evcat",
				(primaryKey) => Models.Evcat.Find(primaryKey, UserContext.Current, "FEVCAT"),
				(model) => formData.MapToModel(model as Models.Evcat)
			);
		}
		...
		{
			return base.GetDocumsTickets("EVCAT", requestModel.FieldName, requestModel.KeyValue);
		}
