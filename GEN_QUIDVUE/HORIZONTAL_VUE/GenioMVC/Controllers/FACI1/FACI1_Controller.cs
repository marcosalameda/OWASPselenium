...
// USE /[MANUAL GQT INCLUDE_CONTROLLER FACI1]/

namespace GenioMVC.Controllers
{
	public partial class Faci1Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Faci1Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION FACI1]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAfaci1>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER FACI1]/
		...
		{
			return base.GetDocumsTickets("FACI1", requestModel.FieldName, requestModel.KeyValue);
		}
