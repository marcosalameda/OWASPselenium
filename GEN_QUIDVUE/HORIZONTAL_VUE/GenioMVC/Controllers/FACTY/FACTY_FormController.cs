...
// USE /[MANUAL GQT AFTER_APPLY_EDIT FACTY]/
		...
		public class FactyDocumValidateTickets : RequestDocumValidateTickets
		{
			public Facty_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsFacty([FromBody] FactyDocumValidateTickets requestModel)
		{
