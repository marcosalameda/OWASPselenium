...
// USE /[MANUAL GQT CONTROLLER_SHOW FAMI1]/
		...
		public ActionResult Fami1_Show_GET([FromBody]RequestIdModel requestModel)
		{
			...
			var model = new Fami1_ViewModel(UserContext.Current);
