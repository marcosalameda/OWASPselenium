...
namespace GenioMVC.Controllers
{
	public partial class FeecaController : ControllerBase
	{
		...
		public FeecaController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER FEECA]/
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Feeca([FromBody]Feeca_ViewModel formData)
		{
		...
		{
			return base.GetDocumsTickets("FEECA", requestModel.FieldName, requestModel.KeyValue);
		}
