...
namespace GenioMVC.Controllers
{
	public partial class FeecaController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult TBS_Menu_1931([FromBody]RequestMenuModel requestModel)
		{
			...
			TBS_Menu_1931_ViewModel model = new TBS_Menu_1931_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_TBS_MENU_1931.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_TBS_MENU_1931.Action)
