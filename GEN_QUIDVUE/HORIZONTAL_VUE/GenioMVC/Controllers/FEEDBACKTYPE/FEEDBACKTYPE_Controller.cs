...
// USE /[MANUAL GQT INCLUDE_CONTROLLER FEEDBACKTYPE]/

namespace GenioMVC.Controllers
{
	public partial class FeedbacktypeController : ControllerBase
	{
		private IChatbotService _aiService;
		public FeedbacktypeController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION FEEDBACKTYPE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAfeedbacktype>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER FEEDBACKTYPE]/
		...
		{
			return base.GetDocumsTickets("FEEDBACKTYPE", requestModel.FieldName, requestModel.KeyValue);
		}
