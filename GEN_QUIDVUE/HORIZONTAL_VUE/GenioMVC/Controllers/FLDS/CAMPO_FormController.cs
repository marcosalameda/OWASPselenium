...
// USE /[MANUAL GQT AFTER_CANCEL CAMPO]/
		...
		public ActionResult Campo_AeroValName([FromBody] Campo_AeroValNameModel requestModel)
		{
			...
			Campo_AeroValName_ViewModel model = new(UserContext.Current, parentCtx);
