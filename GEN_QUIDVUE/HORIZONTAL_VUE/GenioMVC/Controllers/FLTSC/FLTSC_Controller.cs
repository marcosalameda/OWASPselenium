...
// USE /[MANUAL GQT CONTROLLER_NAVIGATION FLTSC]/
		...
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAfltsc>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER FLTSC]/
		...
		{
			return base.GetDocumsTickets("FLTSC", requestModel.FieldName, requestModel.KeyValue);
		}
