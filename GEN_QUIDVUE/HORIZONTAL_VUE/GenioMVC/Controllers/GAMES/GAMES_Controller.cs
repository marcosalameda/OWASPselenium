...
// USE /[MANUAL GQT INCLUDE_CONTROLLER GAMES]/
...
namespace GenioMVC.Controllers
{
	public partial class GamesController : ControllerBase
	{
		...
		public GamesController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION GAMES]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAgames>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER GAMES]/
		...
		{
			return base.GetDocumsTickets("GAMES", requestModel.FieldName, requestModel.KeyValue);
		}
