...
namespace GenioMVC.Controllers
{
	public partial class GenreController : ControllerBase
	{
		...
		public GenreController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION GENRE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAgenre>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER GENRE]/
		...
		/// <summary>
		/// Recalculate formulas of the "Genco" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Genco([FromBody]Genco_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "genre",
				(primaryKey) => Models.Genre.Find(primaryKey, UserContext.Current, "FGENCO"),
				(model) => formData.MapToModel(model as Models.Genre)
			);
		}
		...
		{
			return base.GetDocumsTickets("GENRE", requestModel.FieldName, requestModel.KeyValue);
		}
