...
namespace GenioMVC.Controllers
{
	public partial class HerodescripController : ControllerBase
	{
		...
		public HerodescripController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION HERODESCRIP]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAherodescrip>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER HERODESCRIP]/
		...
		/// <summary>
		/// Recalculate formulas of the "Herocsec" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Herocsec([FromBody]Herocsec_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "herodescrip",
				(primaryKey) => Models.Herodescrip.Find(primaryKey, UserContext.Current, "FHEROCSEC"),
				(model) => formData.MapToModel(model as Models.Herodescrip)
			);
		}
		...
		{
			return base.GetDocumsTickets("HERODESCRIP", requestModel.FieldName, requestModel.KeyValue);
		}
