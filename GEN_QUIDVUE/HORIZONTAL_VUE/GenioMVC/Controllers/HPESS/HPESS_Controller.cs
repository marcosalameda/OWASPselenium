...
namespace GenioMVC.Controllers
{
	public partial class HpessController : ControllerBase
	{
		...
		public HpessController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION HPESS]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAhpess>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER HPESS]/
		...
		{
			return base.GetDocumsTickets("HPESS", requestModel.FieldName, requestModel.KeyValue);
		}
