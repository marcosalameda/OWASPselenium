...
namespace GenioMVC.Controllers
{
	...
	public class HomeController(UserContextService userContext) : ControllerBase(userContext)
	{
		...
		private static readonly NavigationLocation ACTION_EQUIP_EMPTY_SHOW = new("CONSULTA40695", "Equip_empty_Show", "Home")  { vueRouteName = "form-EQUIP_EMPTY", mode = "SHOW" };
		private static readonly NavigationLocation ACTION_EQUIP_EMPTY_EDIT = new("EDITAR11616", "Equip_empty_Edit", "Home")  { vueRouteName = "form-EQUIP_EMPTY", mode = "EDIT" };
...
// USE /[MANUAL GQT HOME_CONTROLLER_INDEX]/
		...
		#region Form Methods -> Equip_empty (Equipment)

		// GET: /Home/Equip_empty_Show
		public ActionResult Equip_empty_Show()
		{
			Equip_empty_ViewModel model = new(UserContext.Current);
			CSGenio.framework.StatusMessage permission = model.CheckPermissions(FormMode.Show);
			bool isHomePage = RouteData.Values.ContainsKey("isHomePage") && (bool)RouteData.Values["isHomePage"];
			ViewBag.isHomePage = isHomePage;
			if (isHomePage)
				Navigation.SetValue("HomePage", "Equip_empty");
			if (permission.Status.Equals(CSGenio.framework.Status.E))
				return PermissionError(permission.Message);

			// Audit
			CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.FORM54242 + " " + ACTION_EQUIP_EMPTY_SHOW.ShortDescription());

// USE /[MANUAL GQT BEFORE_LOAD_SHOW EQUIP_EMPTY]/

			model.Load([], true);

// USE /[MANUAL GQT AFTER_LOAD_SHOW EQUIP_EMPTY]/

			return JsonOK(model);
		}

		[HttpPost]
		public ActionResult Equip_empty_Show_GET()
		{
			return Equip_empty_Show();
		}

		// GET: /Home/Equip_empty_Edit
		public ActionResult Equip_empty_Edit()
		{
			Equip_empty_ViewModel model = new(UserContext.Current);
			...
			// Audit
			CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.FORM54242 + " " + ACTION_EQUIP_EMPTY_EDIT.ShortDescription());

// USE /[MANUAL GQT BEFORE_LOAD_EDIT EQUIP_EMPTY]/

			model.Load([], true);

// USE /[MANUAL GQT AFTER_LOAD_EDIT EQUIP_EMPTY]/

			return JsonOK(model);
		}

		[HttpPost]
		public ActionResult Equip_empty_Edit_GET()
		{
			return Equip_empty_Edit();
		}

		//
		// GET: /Home/Equip_empty_Cancel
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET EQUIP_EMPTY]/
		public ActionResult Equip_empty_Cancel()
		{
			return JsonOK(new { Success = true });
		}

		//
		// GET: /Home/Equip_empty_ValCountry
		// POST: /Home/Equip_empty_ValCountry
		[ActionName("Equip_empty_ValCountry")]
		public ActionResult Equip_empty_ValCountry([FromBody] RequestLookupModel requestModel)
		{
			...
			Equip_empty_ValCountry_ViewModel model = new(m_userContext);
		...
		//
		// GET: /Home/Equip_empty_ValDesignat
		// POST: /Home/Equip_empty_ValDesignat
		[ActionName("Equip_empty_ValDesignat")]
		public ActionResult Equip_empty_ValDesignat([FromBody] RequestLookupModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
			...
			Equip_empty_ValDesignat_ViewModel model = new(m_userContext);
		...
		//
		// GET: /Home/Equip_empty_ValName
		// POST: /Home/Equip_empty_ValName
		[ActionName("Equip_empty_ValName")]
		public ActionResult Equip_empty_ValName([FromBody] RequestLookupModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
			...
			Equip_empty_ValName_ViewModel model = new(m_userContext);
		...
		//
		// GET: /Home/Equip_empty_ValEquip_filtrado
		// POST: /Home/Equip_empty_ValEquip_filtrado
		[ActionName("Equip_empty_ValEquip_filtrado")]
		public ActionResult Equip_empty_ValEquip_filtrado([FromBody] RequestLookupModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
			...
			Equip_empty_ValEquip_filtrado_ViewModel model = new(m_userContext);
