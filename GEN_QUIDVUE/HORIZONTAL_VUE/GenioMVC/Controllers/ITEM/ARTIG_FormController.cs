...
namespace GenioMVC.Controllers
{
	public partial class ItemController : ControllerBase
	{
		...
		private static readonly NavigationLocation ACTION_ARTIG_CANCEL = new("ITEM40802", "Artig_Cancel", "Item") { vueRouteName = "form-ARTIG", mode = "CANCEL" };
		private static readonly NavigationLocation ACTION_ARTIG_SHOW = new("ITEM40802", "Artig_Show", "Item") { vueRouteName = "form-ARTIG", mode = "SHOW" };
		private static readonly NavigationLocation ACTION_ARTIG_NEW = new("ITEM40802", "Artig_New", "Item") { vueRouteName = "form-ARTIG", mode = "NEW" };
		private static readonly NavigationLocation ACTION_ARTIG_EDIT = new("ITEM40802", "Artig_Edit", "Item") { vueRouteName = "form-ARTIG", mode = "EDIT" };
		private static readonly NavigationLocation ACTION_ARTIG_DUPLICATE = new("ITEM40802", "Artig_Duplicate", "Item") { vueRouteName = "form-ARTIG", mode = "DUPLICATE" };
		private static readonly NavigationLocation ACTION_ARTIG_DELETE = new("ITEM40802", "Artig_Delete", "Item") { vueRouteName = "form-ARTIG", mode = "DELETE" };
...
// USE /[MANUAL GQT AFTER_CANCEL ARTIG]/
		...
		public class Artig_WarehValWarehdesModel : RequestLookupModel
		{
			public Artig_ViewModel Model { get; set; }
		}
		...
		public ActionResult Artig_WarehValWarehdes([FromBody] Artig_WarehValWarehdesModel requestModel)
		{
		...
		public class Artig_GitemValItemdesModel : RequestLookupModel
		{
			public Artig_ViewModel Model { get; set; }
		}
		...
		public ActionResult Artig_GitemValItemdes([FromBody] Artig_GitemValItemdesModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
		...
		public class Artig_ValContacorModel : RequestLookupModel
		{
			public Artig_ViewModel Model { get; set; }
		}
		...
		public ActionResult Artig_ValContacor([FromBody] Artig_ValContacorModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
		...
		public class Artig_ValLentradaModel : RequestLookupModel
		{
			public Artig_ViewModel Model { get; set; }
		}
		...
		public ActionResult Artig_ValLentrada([FromBody] Artig_ValLentradaModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
		...
		public class Artig_ValLsaidasModel : RequestLookupModel
		{
			public Artig_ViewModel Model { get; set; }
		}
		...
		public ActionResult Artig_ValLsaidas([FromBody] Artig_ValLsaidasModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT ARTIG]/
		...
		public class ArtigDocumValidateTickets : RequestDocumValidateTickets
		{
			public Artig_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsArtig([FromBody] ArtigDocumValidateTickets requestModel)
		{
			requestModel.Model.Init(UserContext.Current);
