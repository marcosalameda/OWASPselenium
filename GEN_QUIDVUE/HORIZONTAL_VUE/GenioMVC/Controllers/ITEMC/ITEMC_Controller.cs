...
namespace GenioMVC.Controllers
{
	public partial class ItemcController : ControllerBase
	{
		...
		public ItemcController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER ITEMC]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Itemc row = new Models.Itemc(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Catar([FromBody]Catar_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "itemc",
				(primaryKey) => Models.Itemc.Find(primaryKey, UserContext.Current, "FCATAR"),
				(model) => formData.MapToModel(model as Models.Itemc)
			);
		}
		...
		{
			return base.GetDocumsTickets("ITEMC", requestModel.FieldName, requestModel.KeyValue);
		}
