...
// USE /[MANUAL GQT INCLUDE_CONTROLLER ITEMP]/

namespace GenioMVC.Controllers
{
	public partial class ItempController : ControllerBase
	{
		private IChatbotService _aiService;
		public ItempController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION ITEMP]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAitemp>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER ITEMP]/
		...
		{
			return base.GetDocumsTickets("ITEMP", requestModel.FieldName, requestModel.KeyValue);
		}
