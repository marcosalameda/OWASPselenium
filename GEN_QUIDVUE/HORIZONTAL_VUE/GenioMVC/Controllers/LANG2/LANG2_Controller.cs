...
// USE /[MANUAL GQT INCLUDE_CONTROLLER LANG2]/

namespace GenioMVC.Controllers
{
	public partial class Lang2Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Lang2Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION LANG2]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAlang2>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER LANG2]/
		...
		{
			return base.GetDocumsTickets("LANG2", requestModel.FieldName, requestModel.KeyValue);
		}
