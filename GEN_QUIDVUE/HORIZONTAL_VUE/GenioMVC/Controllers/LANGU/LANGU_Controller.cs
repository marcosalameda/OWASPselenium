...
namespace GenioMVC.Controllers
{
	public partial class LanguController : ControllerBase
	{
		...
		public LanguController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION LANGU]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAlangu>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER LANGU]/
		...
		/// <summary>
		/// Recalculate formulas of the "Idiom" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Idiom([FromBody]Idiom_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "langu",
				(primaryKey) => Models.Langu.Find(primaryKey, UserContext.Current, "FIDIOM"),
				(model) => formData.MapToModel(model as Models.Langu)
			);
		}
		...
		{
			return base.GetDocumsTickets("LANGU", requestModel.FieldName, requestModel.KeyValue);
		}
