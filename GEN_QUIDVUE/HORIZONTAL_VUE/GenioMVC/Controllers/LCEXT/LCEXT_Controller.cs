...
namespace GenioMVC.Controllers
{
	public partial class LcextController : ControllerBase
	{
		...
		public LcextController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER LCEXT]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Lcext row = new Models.Lcext(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Lcext([FromBody]Lcext_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "lcext",
				(primaryKey) => Models.Lcext.Find(primaryKey, UserContext.Current, "FLCEXT"),
				(model) => formData.MapToModel(model as Models.Lcext)
			);
		}
		...
		{
			return base.GetDocumsTickets("LCEXT", requestModel.FieldName, requestModel.KeyValue);
		}
