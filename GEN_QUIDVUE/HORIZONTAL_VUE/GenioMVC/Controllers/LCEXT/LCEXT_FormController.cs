...
// USE /[MANUAL GQT CONTROLLER_SHOW LCEXT]/
		...
		public ActionResult Lcext_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Lcext_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST LCEXT]/
		...
		{
			string id = requestModel.Id;
			Lcext_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET LCEXT]/
		public ActionResult Lcext_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("lcext");
					var model = GenioMVC.Models.Lcext.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL LCEXT]/
		...
		public ActionResult Lcext_LocatValGln([FromBody] Lcext_LocatValGlnModel requestModel)
		{
			...
			Models.Lcext parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Lcext_LocatValGln_ViewModel model = new(m_userContext, parentCtx);
