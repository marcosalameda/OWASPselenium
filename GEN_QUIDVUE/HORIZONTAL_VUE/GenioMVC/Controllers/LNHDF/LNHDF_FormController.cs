...
// USE /[MANUAL GQT AFTER_APPLY_EDIT LNHDF]/
		...
		public class LnhdfDocumValidateTickets : RequestDocumValidateTickets
		{
			public Lnhdf_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsLnhdf([FromBody] LnhdfDocumValidateTickets requestModel)
		{
