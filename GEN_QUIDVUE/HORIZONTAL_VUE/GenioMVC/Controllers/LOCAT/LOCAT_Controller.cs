...
namespace GenioMVC.Controllers
{
	public partial class LocatController : ControllerBase
	{
		...
		public LocatController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER LOCAT]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Locat row = new Models.Locat(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Locat([FromBody]Locat_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "locat",
				(primaryKey) => Models.Locat.Find(primaryKey, UserContext.Current, "FLOCAT"),
				(model) => formData.MapToModel(model as Models.Locat)
			);
		}
		...
		{
			return base.GetDocumsTickets("LOCAT", requestModel.FieldName, requestModel.KeyValue);
		}
