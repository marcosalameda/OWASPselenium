...
namespace GenioMVC.Controllers
{
	public partial class LocatController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult WMS_Menu_4251([FromBody]RequestMenuModel requestModel)
		{
			...
			WMS_Menu_4251_ViewModel model = new WMS_Menu_4251_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_WMS_MENU_4251.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_WMS_MENU_4251.Action)
