...
namespace GenioMVC.Controllers
{
	public partial class ManuaController : ControllerBase
	{
		...
		public ManuaController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER MANUA]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Manua row = new Models.Manua(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Manua([FromBody]Manua_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "manua",
				(primaryKey) => Models.Manua.Find(primaryKey, UserContext.Current, "FMANUA"),
				(model) => formData.MapToModel(model as Models.Manua)
			);
		}
		...
		{
			return base.GetDocumsTickets("MANUA", requestModel.FieldName, requestModel.KeyValue);
		}
