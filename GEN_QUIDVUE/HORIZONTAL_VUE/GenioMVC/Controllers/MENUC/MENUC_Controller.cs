...
namespace GenioMVC.Controllers
{
	public partial class MenucController : ControllerBase
	{
		...
		public MenucController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION MENUC]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAmenuc>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER MENUC]/
		...
		/// <summary>
		/// Recalculate formulas of the "F_menuc" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_F_menuc([FromBody]F_menuc_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "menuc",
				(primaryKey) => Models.Menuc.Find(primaryKey, UserContext.Current, "FF_MENUC"),
				(model) => formData.MapToModel(model as Models.Menuc)
			);
		}
		...
		{
			return base.GetDocumsTickets("MENUC", requestModel.FieldName, requestModel.KeyValue);
		}
