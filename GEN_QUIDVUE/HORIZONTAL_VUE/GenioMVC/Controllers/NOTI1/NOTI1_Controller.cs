...
// USE /[MANUAL GQT INCLUDE_CONTROLLER NOTI1]/

namespace GenioMVC.Controllers
{
	public partial class Noti1Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Noti1Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION NOTI1]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAnoti1>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER NOTI1]/
		...
		{
			return base.GetDocumsTickets("NOTI1", requestModel.FieldName, requestModel.KeyValue);
		}
