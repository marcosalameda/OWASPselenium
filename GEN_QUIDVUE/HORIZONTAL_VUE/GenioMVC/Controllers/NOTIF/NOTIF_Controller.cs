...
// USE /[MANUAL GQT MANUAL_CONTROLLER NOTIF]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Notif row = new Models.Notif(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Notif([FromBody]Notif_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "notif",
				(primaryKey) => Models.Notif.Find(primaryKey, UserContext.Current, "FNOTIF"),
				(model) => formData.MapToModel(model as Models.Notif)
			);
		}
		...
		{
			return base.GetDocumsTickets("NOTIF", requestModel.FieldName, requestModel.KeyValue);
		}
