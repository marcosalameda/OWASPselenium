...
// USE /[MANUAL GQT INCLUDE_CONTROLLER ORGAN]/

namespace GenioMVC.Controllers
{
	public partial class OrganController : ControllerBase
	{
		private IChatbotService _aiService;
		public OrganController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION ORGAN]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAorgan>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER ORGAN]/
		...
		{
			return base.GetDocumsTickets("ORGAN", requestModel.FieldName, requestModel.KeyValue);
		}
