...
// USE /[MANUAL GQT CONTROLLER_SHOW DOCSD]/
		...
		public ActionResult Docsd_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Docsd_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST DOCSD]/
		...
		{
			string id = requestModel.Id;
			Docsd_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET DOCSD]/
		public ActionResult Docsd_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("oudoc");
					var model = GenioMVC.Models.Oudoc.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT DOCSD]/
		...
		public class DocsdDocumValidateTickets : RequestDocumValidateTickets
		{
			public Docsd_ViewModel Model { get; set; }
		}
