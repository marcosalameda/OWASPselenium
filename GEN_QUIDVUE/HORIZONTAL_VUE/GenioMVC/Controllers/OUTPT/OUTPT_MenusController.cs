...
namespace GenioMVC.Controllers
{
	public partial class OutptController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult GQT_Menu_411([FromBody]RequestMenuModel requestModel)
		{
			...
			GQT_Menu_411_ViewModel model = new GQT_Menu_411_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_GQT_MENU_411.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_GQT_MENU_411.Action)
...
// USE /[MANUAL GQT MENU_GET 411]/
		...
		[HttpPost]
		public ActionResult GQT_Menu_421([FromBody]RequestMenuModel requestModel)
		{
			var queryParams = requestModel.QueryParams;
			...
			GQT_Menu_421_ViewModel model = new GQT_Menu_421_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_GQT_MENU_421.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_GQT_MENU_421.Action)
				CSGenio.framework.Audit.registAction(UserContext.Current.User, Resources.Resources.MENU01948 + " " + Navigation.CurrentLevel.Location.ShortDescription());
			else if (isHomePage)
			{
