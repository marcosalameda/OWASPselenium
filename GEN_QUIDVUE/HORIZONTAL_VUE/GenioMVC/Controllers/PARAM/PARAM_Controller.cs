...
namespace GenioMVC.Controllers
{
	public partial class ParamController : ControllerBase
	{
		...
		public ParamController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER PARAM]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Param row = new Models.Param(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Param([FromBody]Param_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "param",
				(primaryKey) => Models.Param.Find(primaryKey, UserContext.Current, "FPARAM"),
				(model) => formData.MapToModel(model as Models.Param)
			);
		}
		...
		{
			return base.GetDocumsTickets("PARAM", requestModel.FieldName, requestModel.KeyValue);
		}
