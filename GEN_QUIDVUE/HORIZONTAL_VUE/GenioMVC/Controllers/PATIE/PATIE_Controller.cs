...
// USE /[MANUAL GQT INCLUDE_CONTROLLER PATIE]/

namespace GenioMVC.Controllers
{
	public partial class PatieController : ControllerBase
	{
		private IChatbotService _aiService;
		public PatieController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION PATIE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioApatie>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER PATIE]/
		...
		{
			return base.GetDocumsTickets("PATIE", requestModel.FieldName, requestModel.KeyValue);
		}
