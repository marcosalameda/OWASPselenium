...
namespace GenioMVC.Controllers
{
	public partial class PedidController : ControllerBase
	{
		...
		public PedidController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION PEDID]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioApedid>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER PEDID]/
		...
		/// <summary>
		/// Recalculate formulas of the "Pedid" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Pedid([FromBody]Pedid_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "pedid",
				(primaryKey) => Models.Pedid.Find(primaryKey, UserContext.Current, "FPEDID"),
				(model) => formData.MapToModel(model as Models.Pedid)
			);
		}
		...
		{
			return base.GetDocumsTickets("PEDID", requestModel.FieldName, requestModel.KeyValue);
		}
