...
namespace GenioMVC.Controllers
{
	public partial class PersoController : ControllerBase
	{
		...
		public PersoController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION PERSO]/
...
// USE /[MANUAL GQT MANUAL_CONTROLLER PERSO]/
		...
		/// <summary>
		/// Recalculate formulas of the "Perso" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Perso([FromBody]Perso_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "perso",
				(primaryKey) => Models.Perso.Find(primaryKey, UserContext.Current, "FPERSO"),
		...
		{
			return base.GetDocumsTickets("PERSO", requestModel.FieldName, requestModel.KeyValue);
		}
