...
// USE /[MANUAL GQT CONTROLLER_NAVIGATION PESS2]/
		...
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioApess2>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER PESS2]/
		...
		{
			return base.GetDocumsTickets("PESS2", requestModel.FieldName, requestModel.KeyValue);
		}
