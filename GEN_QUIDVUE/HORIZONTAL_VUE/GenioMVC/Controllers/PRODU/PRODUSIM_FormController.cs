...
// USE /[MANUAL GQT CONTROLLER_SHOW PRODUSIM]/
		...
		public ActionResult Produsim_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Produsim_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST PRODUSIM]/
		...
		{
			string id = requestModel.Id;
			Produsim_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET PRODUSIM]/
		public ActionResult Produsim_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("produ");
					var model = GenioMVC.Models.Produ.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL PRODUSIM]/
		...
		public ActionResult Produsim_LocatValGln([FromBody] Produsim_LocatValGlnModel requestModel)
		{
			...
			Produsim_LocatValGln_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Produsim_LcextValGlnext([FromBody] Produsim_LcextValGlnextModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Produsim_LcextValGlnext_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT PRODUSIM]/
		...
		public class ProdusimDocumValidateTickets : RequestDocumValidateTickets
		{
			public Produsim_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsProdusim([FromBody] ProdusimDocumValidateTickets requestModel)
		{
