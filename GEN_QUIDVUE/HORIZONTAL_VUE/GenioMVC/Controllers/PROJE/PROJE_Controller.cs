...
namespace GenioMVC.Controllers
{
	public partial class ProjeController : ControllerBase
	{
		...
		public ProjeController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER PROJE]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Proje row = new Models.Proje(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Proje([FromBody]Proje_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "proje",
				(primaryKey) => Models.Proje.Find(primaryKey, UserContext.Current, "FPROJE"),
				(model) => formData.MapToModel(model as Models.Proje)
			);
		}
		...
		{
			return base.GetDocumsTickets("PROJE", requestModel.FieldName, requestModel.KeyValue);
		}
