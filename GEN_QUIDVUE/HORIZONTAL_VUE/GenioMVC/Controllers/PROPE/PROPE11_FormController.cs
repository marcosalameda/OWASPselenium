...
// USE /[MANUAL GQT CONTROLLER_SHOW PROPE11]/
		...
		public ActionResult Prope11_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Prope11_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST PROPE11]/
		...
		{
			string id = requestModel.Id;
			Prope11_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT AFTER_CANCEL PROPE11]/
		...
		public ActionResult Prope11_CityValCity([FromBody] Prope11_CityValCityModel requestModel)
		{
			...
			Prope11_CityValCity_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Prope11_AgentValName([FromBody] Prope11_AgentValNameModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Prope11_AgentValName_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Prope11_ValProphoto([FromBody] Prope11_ValProphotoModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Prope11_ValProphoto_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Prope11_ValPropcont([FromBody] Prope11_ValPropcontModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Prope11_ValPropcont_ViewModel model = new(m_userContext, parentCtx);
