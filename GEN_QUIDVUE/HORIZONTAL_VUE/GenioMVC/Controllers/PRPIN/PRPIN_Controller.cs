...
// USE /[MANUAL GQT INCLUDE_CONTROLLER PRPIN]/

namespace GenioMVC.Controllers
{
	public partial class PrpinController : ControllerBase
	{
		private IChatbotService _aiService;
		public PrpinController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION PRPIN]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAprpin>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER PRPIN]/
		...
		{
			return base.GetDocumsTickets("PRPIN", requestModel.FieldName, requestModel.KeyValue);
		}
