...
// USE /[MANUAL GQT INCLUDE_CONTROLLER PSNGR]/

namespace GenioMVC.Controllers
{
	public partial class PsngrController : ControllerBase
	{
		private IChatbotService _aiService;
		public PsngrController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION PSNGR]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioApsngr>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER PSNGR]/
		...
		{
			return base.GetDocumsTickets("PSNGR", requestModel.FieldName, requestModel.KeyValue);
		}
