...
namespace GenioMVC.Controllers
{
	public partial class PwcomController : ControllerBase
	{
		...
		public PwcomController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER PWCOM]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Pwcom row = new Models.Pwcom(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Pwcom([FromBody]Pwcom_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "pwcom",
				(primaryKey) => Models.Pwcom.Find(primaryKey, UserContext.Current, "FPWCOM"),
				(model) => formData.MapToModel(model as Models.Pwcom)
			);
		}
		...
		{
			return base.GetDocumsTickets("PWCOM", requestModel.FieldName, requestModel.KeyValue);
		}
