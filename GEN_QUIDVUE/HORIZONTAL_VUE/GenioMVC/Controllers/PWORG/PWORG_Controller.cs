...
namespace GenioMVC.Controllers
{
	public partial class PworgController : ControllerBase
	{
		...
		public PworgController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER PWORG]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Pworg row = new Models.Pworg(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Pworg([FromBody]Pworg_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "pworg",
				(primaryKey) => Models.Pworg.Find(primaryKey, UserContext.Current, "FPWORG"),
				(model) => formData.MapToModel(model as Models.Pworg)
			);
		}
		...
		{
			return base.GetDocumsTickets("PWORG", requestModel.FieldName, requestModel.KeyValue);
		}
