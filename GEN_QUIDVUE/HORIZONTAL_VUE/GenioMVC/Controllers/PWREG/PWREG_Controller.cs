...
namespace GenioMVC.Controllers
{
	public partial class PwregController : ControllerBase
	{
		...
		public PwregController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER PWREG]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Pwreg row = new Models.Pwreg(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Pwreg([FromBody]Pwreg_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "pwreg",
				(primaryKey) => Models.Pwreg.Find(primaryKey, UserContext.Current, "FPWREG"),
				(model) => formData.MapToModel(model as Models.Pwreg)
			);
		}
		...
		{
			return base.GetDocumsTickets("PWREG", requestModel.FieldName, requestModel.KeyValue);
		}
