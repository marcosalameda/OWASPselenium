...
namespace GenioMVC.Controllers
{
	public partial class RecordinfoController : ControllerBase
	{
		...
		public RecordinfoController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION RECORDINFO]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioArecordinfo>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER RECORDINFO]/
		...
		/// <summary>
		/// Recalculate formulas of the "Recordinfor" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Recordinfor([FromBody]Recordinfor_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "recordinfo",
				(primaryKey) => Models.Recordinfo.Find(primaryKey, UserContext.Current, "FRECORDINFOR"),
				(model) => formData.MapToModel(model as Models.Recordinfo)
			);
		}
		...
		{
			return base.GetDocumsTickets("RECORDINFO", requestModel.FieldName, requestModel.KeyValue);
		}
