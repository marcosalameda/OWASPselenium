...
// USE /[MANUAL GQT AFTER_CANCEL REGIA]/
		...
		public ActionResult Regia_CntryValCountry([FromBody] Regia_CntryValCountryModel requestModel)
		{
			...
			Regia_CntryValCountry_ViewModel model = new(UserContext.Current, parentCtx);
