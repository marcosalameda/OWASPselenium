...
namespace GenioMVC.Controllers
{
	public partial class RegisController : ControllerBase
	{
		...
		[HttpPost]
		public ActionResult REG_Menu_111([FromBody]RequestMenuModel requestModel)
		{
			...
			REG_Menu_111_ViewModel model = new REG_Menu_111_ViewModel(UserContext.Current);
			...
			if (!isHomePage &&
				(Navigation.CurrentLevel == null || !ACTION_REG_MENU_111.IsSameAction(Navigation.CurrentLevel.Location)) &&
				Navigation.CurrentLevel.Location.Action != ACTION_REG_MENU_111.Action)
