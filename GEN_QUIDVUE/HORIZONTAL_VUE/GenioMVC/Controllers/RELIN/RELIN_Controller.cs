...
namespace GenioMVC.Controllers
{
	public partial class RelinController : ControllerBase
	{
		...
		public RelinController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER RELIN]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Relin row = new Models.Relin(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Relin([FromBody]Relin_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "relin",
				(primaryKey) => Models.Relin.Find(primaryKey, UserContext.Current, "FRELIN"),
				(model) => formData.MapToModel(model as Models.Relin)
			);
		}
		...
		{
			return base.GetDocumsTickets("RELIN", requestModel.FieldName, requestModel.KeyValue);
		}
