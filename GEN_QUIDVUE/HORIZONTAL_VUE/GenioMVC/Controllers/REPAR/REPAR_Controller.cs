...
namespace GenioMVC.Controllers
{
	public partial class ReparController : ControllerBase
	{
		...
		public ReparController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION REPAR]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioArepar>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER REPAR]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Repar row = new Models.Repar(UserContext.Current, isEmpty: true);
...
#pragma warning restore QUID001 // Direct Property Access to read only fields
		...
		public JsonResult GetDependants([FromBody]RequestDependantsModel requestModel)
		{
			...
			try
			{
				...
				{
					case "REPAR___EQUIPREGISTNR":	// Field (DB)
						values = new Repar_ViewModel(UserContext.Current).GetDependant_ReparTableEquipRegistnr(Selected);
						break;
					case "REPAR___SPECIESPECIAL":	// Field (DB)
						values = new Repar_ViewModel(UserContext.Current).GetDependant_ReparTableSpeciEspecial(Selected);
						break;
					case "REPAR___PESSONAME____":	// Field (DB)
						values = new Repar_ViewModel(UserContext.Current).GetDependant_ReparTablePessoName(Selected);
						break;
					default: break;
				}
		...
		{
			return base.GetDocumsTickets("REPAR", requestModel.FieldName, requestModel.KeyValue);
		}
