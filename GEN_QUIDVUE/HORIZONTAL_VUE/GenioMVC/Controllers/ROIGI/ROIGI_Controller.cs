...
namespace GenioMVC.Controllers
{
	public partial class RoigiController : ControllerBase
	{
		...
		public RoigiController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER ROIGI]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Roigi row = new Models.Roigi(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Roigi([FromBody]Roigi_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "roigi",
				(primaryKey) => Models.Roigi.Find(primaryKey, UserContext.Current, "FROIGI"),
				(model) => formData.MapToModel(model as Models.Roigi)
			);
		}
		...
		{
			return base.GetDocumsTickets("ROIGI", requestModel.FieldName, requestModel.KeyValue);
		}
