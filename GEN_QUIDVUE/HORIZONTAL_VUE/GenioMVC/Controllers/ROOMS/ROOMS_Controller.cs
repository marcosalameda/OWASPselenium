...
namespace GenioMVC.Controllers
{
	public partial class RoomsController : ControllerBase
	{
		...
		public RoomsController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION ROOMS]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioArooms>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER ROOMS]/
		...
		/// <summary>
		/// Recalculate formulas of the "Salas" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Salas([FromBody]Salas_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "rooms",
				(primaryKey) => Models.Rooms.Find(primaryKey, UserContext.Current, "FSALAS"),
				(model) => formData.MapToModel(model as Models.Rooms)
			);
		}
		...
		{
			return base.GetDocumsTickets("ROOMS", requestModel.FieldName, requestModel.KeyValue);
		}
