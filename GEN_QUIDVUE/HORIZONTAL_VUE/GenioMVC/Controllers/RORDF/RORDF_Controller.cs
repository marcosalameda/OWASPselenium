...
// USE /[MANUAL GQT CONTROLLER_NAVIGATION RORDF]/
		...
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioArordf>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
...
// USE /[MANUAL GQT MANUAL_CONTROLLER RORDF]/
		...
		/// <summary>
		/// Recalculate formulas of the "Rordf" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Rordf([FromBody]Rordf_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "rordf",
				(primaryKey) => Models.Rordf.Find(primaryKey, UserContext.Current, "FRORDF"),
				(model) => formData.MapToModel(model as Models.Rordf)
			);
		}
		...
		{
			return base.GetDocumsTickets("RORDF", requestModel.FieldName, requestModel.KeyValue);
		}
