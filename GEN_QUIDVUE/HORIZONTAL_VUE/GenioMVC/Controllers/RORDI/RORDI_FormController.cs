...
// USE /[MANUAL GQT CONTROLLER_SHOW RORDI]/
		...
		public ActionResult Rordi_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Rordi_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST RORDI]/
		...
		{
			string id = requestModel.Id;
			Rordi_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET RORDI]/
		public ActionResult Rordi_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("rordi");
					var model = GenioMVC.Models.Rordi.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT RORDI]/
		...
		public class RordiDocumValidateTickets : RequestDocumValidateTickets
		{
			public Rordi_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsRordi([FromBody] RordiDocumValidateTickets requestModel)
		{
