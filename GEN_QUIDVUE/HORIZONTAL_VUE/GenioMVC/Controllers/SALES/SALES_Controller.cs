...
// USE /[MANUAL GQT INCLUDE_CONTROLLER SALES]/
...
namespace GenioMVC.Controllers
{
	public partial class SalesController : ControllerBase
	{
		...
		public SalesController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION SALES]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAsales>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER SALES]/
		...
		{
			return base.GetDocumsTickets("SALES", requestModel.FieldName, requestModel.KeyValue);
		}
