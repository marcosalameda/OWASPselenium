...
// USE /[MANUAL GQT INCLUDE_CONTROLLER SHITY]/

namespace GenioMVC.Controllers
{
	public partial class ShityController : ControllerBase
	{
		private IChatbotService _aiService;
		public ShityController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION SHITY]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAshity>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER SHITY]/
		...
		{
			return base.GetDocumsTickets("SHITY", requestModel.FieldName, requestModel.KeyValue);
		}
