...
// USE /[MANUAL GQT INCLUDE_CONTROLLER SPACE]/
...
namespace GenioMVC.Controllers
{
	public partial class SpaceController : ControllerBase
	{
		...
		public SpaceController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION SPACE]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAspace>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER SPACE]/
		...
		{
			return base.GetDocumsTickets("SPACE", requestModel.FieldName, requestModel.KeyValue);
		}
