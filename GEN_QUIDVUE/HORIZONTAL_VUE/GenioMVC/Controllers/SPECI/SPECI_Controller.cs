...
namespace GenioMVC.Controllers
{
	public partial class SpeciController : ControllerBase
	{
		...
		public SpeciController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION SPECI]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAspeci>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER SPECI]/
		...
		/// <summary>
		/// Recalculate formulas of the "Espec" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Espec([FromBody]Espec_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "speci",
				(primaryKey) => Models.Speci.Find(primaryKey, UserContext.Current, "FESPEC"),
				(model) => formData.MapToModel(model as Models.Speci)
			);
		}
		...
		{
			return base.GetDocumsTickets("SPECI", requestModel.FieldName, requestModel.KeyValue);
		}
