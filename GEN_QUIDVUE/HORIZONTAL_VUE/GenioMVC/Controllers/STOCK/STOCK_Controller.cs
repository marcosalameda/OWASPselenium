...
// USE /[MANUAL GQT INCLUDE_CONTROLLER STOCK]/
...
namespace GenioMVC.Controllers
{
	public partial class StockController : ControllerBase
	{
		...
		public StockController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION STOCK]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAstock>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER STOCK]/
		...
		{
			return base.GetDocumsTickets("STOCK", requestModel.FieldName, requestModel.KeyValue);
		}
