...
// USE /[MANUAL GQT INCLUDE_CONTROLLER STRAT]/

namespace GenioMVC.Controllers
{
	public partial class StratController : ControllerBase
	{
		private IChatbotService _aiService;
		public StratController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION STRAT]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAstrat>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER STRAT]/
		...
		{
			return base.GetDocumsTickets("STRAT", requestModel.FieldName, requestModel.KeyValue);
		}
