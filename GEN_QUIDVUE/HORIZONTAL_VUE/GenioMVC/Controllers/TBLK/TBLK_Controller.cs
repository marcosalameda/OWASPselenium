...
namespace GenioMVC.Controllers
{
	public partial class TblkController : ControllerBase
	{
		...
		public TblkController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER TBLK]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Tblk row = new Models.Tblk(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Tblk([FromBody]Tblk_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "tblk",
				(primaryKey) => Models.Tblk.Find(primaryKey, UserContext.Current, "FTBLK"),
				(model) => formData.MapToModel(model as Models.Tblk)
			);
		}
		...
		{
			return base.GetDocumsTickets("TBLK", requestModel.FieldName, requestModel.KeyValue);
		}
