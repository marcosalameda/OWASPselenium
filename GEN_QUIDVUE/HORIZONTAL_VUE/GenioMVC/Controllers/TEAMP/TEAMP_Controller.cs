...
// USE /[MANUAL GQT INCLUDE_CONTROLLER TEAMP]/

namespace GenioMVC.Controllers
{
	public partial class TeampController : ControllerBase
	{
		private IChatbotService _aiService;
		public TeampController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION TEAMP]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAteamp>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER TEAMP]/
		...
		{
			return base.GetDocumsTickets("TEAMP", requestModel.FieldName, requestModel.KeyValue);
		}
