...
// USE /[MANUAL GQT INCLUDE_CONTROLLER TICKT]/

namespace GenioMVC.Controllers
{
	public partial class TicktController : ControllerBase
	{
		private IChatbotService _aiService;
		public TicktController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION TICKT]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAtickt>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER TICKT]/
		...
		{
			return base.GetDocumsTickets("TICKT", requestModel.FieldName, requestModel.KeyValue);
		}
