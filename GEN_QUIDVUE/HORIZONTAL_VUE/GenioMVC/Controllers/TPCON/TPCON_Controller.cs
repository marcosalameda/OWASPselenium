...
namespace GenioMVC.Controllers
{
	public partial class TpconController : ControllerBase
	{
		...
		public TpconController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER TPCON]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Tpcon row = new Models.Tpcon(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Tpcon([FromBody]Tpcon_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "tpcon",
				(primaryKey) => Models.Tpcon.Find(primaryKey, UserContext.Current, "FTPCON"),
				(model) => formData.MapToModel(model as Models.Tpcon)
			);
		}
		...
		{
			return base.GetDocumsTickets("TPCON", requestModel.FieldName, requestModel.KeyValue);
		}
