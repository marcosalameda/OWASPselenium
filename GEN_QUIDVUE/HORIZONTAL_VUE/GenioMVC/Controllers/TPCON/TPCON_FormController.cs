...
// USE /[MANUAL GQT CONTROLLER_SHOW TPCON]/
		...
		public ActionResult Tpcon_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Tpcon_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST TPCON]/
		...
		{
			string id = requestModel.Id;
			Tpcon_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET TPCON]/
		public ActionResult Tpcon_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("tpcon");
					var model = GenioMVC.Models.Tpcon.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL TPCON]/
		...
		public ActionResult Tpcon_GenreValGender([FromBody] Tpcon_GenreValGenderModel requestModel)
		{
			...
			Models.Tpcon parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Tpcon_GenreValGender_ViewModel model = new(m_userContext, parentCtx);
