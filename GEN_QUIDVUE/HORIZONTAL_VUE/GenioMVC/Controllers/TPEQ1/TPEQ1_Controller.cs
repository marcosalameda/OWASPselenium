...
namespace GenioMVC.Controllers
{
	public partial class Tpeq1Controller : ControllerBase
	{
		...
		public Tpeq1Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
...
// USE /[MANUAL GQT MANUAL_CONTROLLER TPEQ1]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Tpeq1 row = new Models.Tpeq1(UserContext.Current, isEmpty: true);
		...
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Tpeq1([FromBody]Tpeq1_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "tpeq1",
				(primaryKey) => Models.Tpeq1.Find(primaryKey, UserContext.Current, "FTPEQ1"),
				(model) => formData.MapToModel(model as Models.Tpeq1)
			);
		}
		...
		{
			return base.GetDocumsTickets("TPEQ1", requestModel.FieldName, requestModel.KeyValue);
		}
