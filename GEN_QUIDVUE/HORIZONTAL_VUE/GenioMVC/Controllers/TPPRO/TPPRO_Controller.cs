...
namespace GenioMVC.Controllers
{
	public partial class TpproController : ControllerBase
	{
		...
		public TpproController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION TPPRO]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAtppro>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER TPPRO]/
		...
		/// <summary>
		/// Recalculate formulas of the "Tppro" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Tppro([FromBody]Tppro_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "tppro",
				(primaryKey) => Models.Tppro.Find(primaryKey, UserContext.Current, "FTPPRO"),
				(model) => formData.MapToModel(model as Models.Tppro)
			);
		}
		...
		{
			return base.GetDocumsTickets("TPPRO", requestModel.FieldName, requestModel.KeyValue);
		}
