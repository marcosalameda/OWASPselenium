...
namespace GenioMVC.Controllers
{
	public partial class UfeedbackController : ControllerBase
	{
		...
		public UfeedbackController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION UFEEDBACK]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAufeedback>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER UFEEDBACK]/
		...
		/// <summary>
		/// Recalculate formulas of the "Detailedfeedback" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Detailedfeedback([FromBody]Detailedfeedback_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "ufeedback",
				(primaryKey) => Models.Ufeedback.Find(primaryKey, UserContext.Current, "FDETAILEDFEEDBACK"),
				(model) => formData.MapToModel(model as Models.Ufeedback)
			);
		}
		...
		/// <summary>
		/// Recalculate formulas of the "Quickfeedback" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Quickfeedback([FromBody]Quickfeedback_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "ufeedback",
				(primaryKey) => Models.Ufeedback.Find(primaryKey, UserContext.Current, "FQUICKFEEDBACK"),
				(model) => formData.MapToModel(model as Models.Ufeedback)
			);
		}
		...
		/// <summary>
		/// Recalculate formulas of the "Starfeedb" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Starfeedb([FromBody]Starfeedb_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "ufeedback",
				(primaryKey) => Models.Ufeedback.Find(primaryKey, UserContext.Current, "FSTARFEEDB"),
				(model) => formData.MapToModel(model as Models.Ufeedback)
			);
		}
		...
		/// <summary>
		/// Recalculate formulas of the "Usefulfeedback" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Usefulfeedback([FromBody]Usefulfeedback_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "ufeedback",
				(primaryKey) => Models.Ufeedback.Find(primaryKey, UserContext.Current, "FUSEFULFEEDBACK"),
				(model) => formData.MapToModel(model as Models.Ufeedback)
			);
		}
		...
		{
			return base.GetDocumsTickets("UFEEDBACK", requestModel.FieldName, requestModel.KeyValue);
		}
