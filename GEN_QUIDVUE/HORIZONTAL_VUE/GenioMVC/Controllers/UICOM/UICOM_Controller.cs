...
namespace GenioMVC.Controllers
{
	public partial class UicomController : ControllerBase
	{
		...
		public UicomController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION UICOM]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAuicom>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER UICOM]/
		...
		/// <summary>
		/// Recalculate formulas of the "Uicom" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Uicom([FromBody]Uicom_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "uicom",
				(primaryKey) => Models.Uicom.Find(primaryKey, UserContext.Current, "FUICOM"),
				(model) => formData.MapToModel(model as Models.Uicom)
			);
		}
		...
		{
			return base.GetDocumsTickets("UICOM", requestModel.FieldName, requestModel.KeyValue);
		}
