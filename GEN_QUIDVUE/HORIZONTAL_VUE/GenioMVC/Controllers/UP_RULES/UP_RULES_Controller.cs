...
namespace GenioMVC.Controllers
{
	public partial class Up_rulesController : ControllerBase
	{
		...
		public Up_rulesController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION UP_RULES]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAup_rules>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER UP_RULES]/
		...
		/// <summary>
		/// Recalculate formulas of the "Up_rules" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Up_rules([FromBody]Up_rules_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "up_rules",
				(primaryKey) => Models.Up_rules.Find(primaryKey, UserContext.Current, "FUP_RULES"),
				(model) => formData.MapToModel(model as Models.Up_rules)
			);
		}
		...
		{
			return base.GetDocumsTickets("UP_RULES", requestModel.FieldName, requestModel.KeyValue);
		}
