...
// USE /[MANUAL GQT CONTROLLER_SHOW USERS]/
		...
		public ActionResult Users_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Users_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST USERS]/
		...
		{
			string id = requestModel.Id;
			Users_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET USERS]/
		public ActionResult Users_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("users");
					var model = GenioMVC.Models.Users.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_CANCEL USERS]/
		...
		public ActionResult Users_PswValNome([FromBody] Users_PswValNomeModel requestModel)
		{
			...
			Models.Users parentCtx = requestModel.Model == null ? null : new(m_userContext);
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Users_PswValNome_ViewModel model = new(m_userContext, parentCtx);
		...
		public ActionResult Users_PersoValName([FromBody] Users_PersoValNameModel requestModel)
		{
			...
			requestModel.Model?.Init(m_userContext);
			requestModel.Model?.MapToModel(parentCtx);
			Users_PersoValName_ViewModel model = new(m_userContext, parentCtx);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT USERS]/
		...
		public class UsersDocumValidateTickets : RequestDocumValidateTickets
		{
			public Users_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsUsers([FromBody] UsersDocumValidateTickets requestModel)
		{
