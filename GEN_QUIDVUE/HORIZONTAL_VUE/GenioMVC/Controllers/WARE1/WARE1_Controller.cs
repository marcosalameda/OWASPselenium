...
// USE /[MANUAL GQT INCLUDE_CONTROLLER WARE1]/

namespace GenioMVC.Controllers
{
	public partial class Ware1Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Ware1Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION WARE1]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAware1>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER WARE1]/
		...
		{
			return base.GetDocumsTickets("WARE1", requestModel.FieldName, requestModel.KeyValue);
		}
