...
// USE /[MANUAL GQT INCLUDE_CONTROLLER WARE2]/

namespace GenioMVC.Controllers
{
	public partial class Ware2Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Ware2Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION WARE2]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAware2>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER WARE2]/
		...
		{
			return base.GetDocumsTickets("WARE2", requestModel.FieldName, requestModel.KeyValue);
		}
