...
// USE /[MANUAL GQT AFTER_CANCEL ARMAZ03]/
		...
		public ActionResult Armaz03_ValArtigos([FromBody] Armaz03_ValArtigosModel requestModel)
		{
			...
			Armaz03_ValArtigos_ViewModel model = new(UserContext.Current, parentCtx);
