...
// USE /[MANUAL GQT CONTROLLER_SHOW IMGMAGN]/
		...
		public ActionResult Imgmagn_Show_GET([FromBody] RequestIdModel requestModel)
		{
			...
			Imgmagn_ViewModel model = new(UserContext.Current);
...
// USE /[MANUAL GQT CONTROLLER_DELETE_POST IMGMAGN]/
		...
		{
			string id = requestModel.Id;
			Imgmagn_ViewModel model = new(UserContext.Current, id);
			model.MapFromModel();
...
// USE /[MANUAL GQT CONTROLLER_CANCEL_GET IMGMAGN]/
		public ActionResult Imgmagn_Cancel()
		{
			if (Navigation.CurrentLevel.FormMode == FormMode.New || Navigation.CurrentLevel.FormMode == FormMode.Duplicate)
			{
				...
				try
				{
					var recordKey = Navigation.GetStrValue("wpess");
					var model = GenioMVC.Models.Wpess.Find(recordKey, UserContext.Current);
...
// USE /[MANUAL GQT AFTER_APPLY_EDIT IMGMAGN]/
		...
		public class ImgmagnDocumValidateTickets : RequestDocumValidateTickets
		{
			public Imgmagn_ViewModel Model { get; set; }
		}
		...
		public ActionResult UpdateFilesTicketsImgmagn([FromBody] ImgmagnDocumValidateTickets requestModel)
		{
