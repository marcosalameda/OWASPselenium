...
// USE /[MANUAL GQT INCLUDE_CONTROLLER YEAR1]/

namespace GenioMVC.Controllers
{
	public partial class Year1Controller : ControllerBase
	{
		private IChatbotService _aiService;
		public Year1Controller(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL GQT CONTROLLER_NAVIGATION YEAR1]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAyear1>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL GQT MANUAL_CONTROLLER YEAR1]/
		...
		{
			return base.GetDocumsTickets("YEAR1", requestModel.FieldName, requestModel.KeyValue);
		}
