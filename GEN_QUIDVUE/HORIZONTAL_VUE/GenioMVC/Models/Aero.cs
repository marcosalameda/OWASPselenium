...
namespace GenioMVC.Models
{
	public class Aero : ModelBase
	{
		...
		[ShouldSerialize("Aero.ValCodaero")]
		...
		{
			klass = new CSGenioAaero(userContext.User);
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
				SetFieldsToSerialize(fieldsToSerialize);
		}

		public Aero(UserContext userContext, CSGenioAaero val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext)
		{
			klass = val;
			isEmptyModel = isEmpty;
			if (fieldsToSerialize != null)
		...
		public static Aero Find(string id, UserContext userCtx, string identifier = null, string[] fieldsToSerialize = null, string[] fieldsToQuery = null)
		{
			...
			return record == null ? null : new Aero(userCtx, record, false, fieldsToSerialize) { Identifier = identifier };
		}

		public static List<Aero> AllModel(UserContext userCtx, CriteriaSet args = null, string identifier = null)
		{
			return Where<CSGenioAaero>(userCtx, false, args, numRegs: -1, identifier: identifier).RowsForViewModel<Aero>((r) => new Aero(userCtx, r));
		}
