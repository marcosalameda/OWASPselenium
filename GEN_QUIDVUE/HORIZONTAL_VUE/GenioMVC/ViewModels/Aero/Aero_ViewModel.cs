...
namespace GenioMVC.ViewModels.Aero
{
	public class Aero_ViewModel : FormViewModel<Models.Aero>, IPreparableForSerialization
	{
		...
		public Aero_ViewModel(UserContext userContext, bool nestedForm = false) : base(userContext, "FAERO", nestedForm) { }

		public Aero_ViewModel(UserContext userContext, Models.Aero row, bool nestedForm = false) : base(userContext, "FAERO", row, nestedForm) { }

		public Aero_ViewModel(UserContext userContext, string id, bool nestedForm = false, string[]? fieldsToLoad = null) : this(userContext, nestedForm)
		{
			this.Navigation.SetValue("aero", id);
			Model = Models.Aero.Find(id, userContext, "FAERO", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Aero.Find(Navigation.GetStrValue("aero"), m_userContext, "FAERO");
			}
			finally
			{
				if (Model == null)
		...
		public override void LoadPartial(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			if (Model == null)
			{
				...
				if (Model == null)
				{
					Model = new Models.Aero(m_userContext) { Identifier = "FAERO" };
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY AERO]/
		...
		{
			Model = Models.Aero.Find(id, m_userContext, "FAERO");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
