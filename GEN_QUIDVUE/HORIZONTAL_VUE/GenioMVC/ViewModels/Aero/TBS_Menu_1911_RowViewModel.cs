...
public class TBS_Menu_1911_RowViewModel : Models.Aero
{
	#region Constructors

	public TBS_Menu_1911_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public TBS_Menu_1911_RowViewModel(UserContext userContext, CSGenioAaero val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
