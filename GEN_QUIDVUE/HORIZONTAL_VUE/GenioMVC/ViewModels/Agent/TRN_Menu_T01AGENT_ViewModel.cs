...
{
	public class TRN_Menu_T01AGENT_ViewModel : MenuListViewModel<Models.Agent>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<TRN_Menu_T01AGENT_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "8eff371d-1d96-4236-9a5f-99682561ce0b";
...
// USE /[MANUAL TRN LIST_LIMITS T01AGENT]/
		...
		public TRN_Menu_T01AGENT_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="TRN_Menu_T01AGENT_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public TRN_Menu_T01AGENT_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public TRN_Menu_T01AGENT_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Agent.AddEPH<CSGenioAagent>(ref u, crs, "MLT01AGENT");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Agent.AddEPH<CSGenioAagent>(ref u, null, "MLT01AGENT"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAagent> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet trn_menu_t01agentConds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "MLT01AGENT");
			...
			conditions.SubSets.Add(trn_menu_t01agentConds);
			trn_menu_t01agentConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL TRN OVERRQ T01AGENT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref trn_menu_t01agentConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT01AGENT", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL TRN OVERRQLSTEXP T01AGENT]/
			...
			if (tableReload)
			{
// USE /[MANUAL TRN OVERRQLIST T01AGENT]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAagent.GetInformation(), QMVC_POS_RECORD, sorts, trn_menu_t01agentConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
				...
				Menu.Elements = MapTRN_Menu_T01AGENT(listing);

				Menu.Identifier = "MLT01AGENT";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "MLT01AGENT";
		...
		private List<TRN_Menu_T01AGENT_RowViewModel> MapTRN_Menu_T01AGENT(ListingMVC<CSGenioAagent> Qlisting)
		{
			List<TRN_Menu_T01AGENT_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapTRN_Menu_T01AGENT(row));
					i++;
				}
			}
		...
		/// to a TRN_Menu_T01AGENT_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private TRN_Menu_T01AGENT_RowViewModel MapTRN_Menu_T01AGENT(CSGenioAagent row)
		{
			var model = new TRN_Menu_T01AGENT_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T01AGENT]/

		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Agent", "Agent.ValCodagent", "Agent.ValZzstate", "Agent.ValBirthdat", "Agent.ValName", "Agent.ValPhoto", "Agent.ValEmail"
		];
