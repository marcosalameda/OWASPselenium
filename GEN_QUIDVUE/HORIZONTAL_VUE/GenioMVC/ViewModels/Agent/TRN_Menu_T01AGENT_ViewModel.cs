...
// USE /[MANUAL TRN OVERRQ T01AGENT]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAagent>(m_userContext, false, trn_menu_t01agentConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT01AGENT", true, firstVisibleColumn: firstVisibleColumn);
