...
{
	public class TRN_Menu_T01AGENT_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "8eff371d-1d96-4236-9a5f-99682561ce0b"; }
...
// USE /[MANUAL TRN OVERRQLIST T01AGENT]/
		...
		{
			var Elements = new List<TRN_Menu_T01AGENT_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T01AGENT_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T01AGENT]/
		...
		[
			"Agent", "Agent.ValCodagent", "Agent.ValZzstate", "Agent.ValBirthdat", "Agent.ValName", "Agent.ValPhoto", "Agent.ValEmail", "BtnPermission"
		];
