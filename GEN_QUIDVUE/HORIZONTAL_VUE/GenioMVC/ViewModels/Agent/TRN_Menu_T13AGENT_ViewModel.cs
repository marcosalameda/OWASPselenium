...
{
	public class TRN_Menu_T13AGENT_ViewModel : MenuListViewModel<Models.Agent>
	{
		/// <summary>
		...
		public override string Uuid => "e4153c58-7140-4fa6-8d32-faf89363c112";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T13AGENT]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT13AGENT");
		...
		public TRN_Menu_T13AGENT_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T13AGENT_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T13AGENT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref trn_menu_t13agentConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT13AGENT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T13AGENT]/
				...
				ListingMVC<CSGenioAagent> listing = Models.ModelBase.Where<CSGenioAagent>(m_userContext, distinct, trn_menu_t13agentConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT13AGENT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T13AGENT_RowViewModel> Elements = [];
			int i = 0;
