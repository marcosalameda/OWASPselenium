...
{
	public class TRN_Menu_T16AGENT_ViewModel : MenuListViewModel<Models.Agent>
	{
		/// <summary>
		...
		public override string Uuid => "24daf59d-e616-4c6e-8755-3e11a9f6ff85";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T16AGENT]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT16AGENT");
		...
		public TRN_Menu_T16AGENT_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T16AGENT_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T16AGENT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref trn_menu_t16agentConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT16AGENT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T16AGENT]/
				...
				ListingMVC<CSGenioAagent> listing = Models.ModelBase.Where<CSGenioAagent>(m_userContext, distinct, trn_menu_t16agentConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT16AGENT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T16AGENT_RowViewModel> Elements = [];
			int i = 0;
