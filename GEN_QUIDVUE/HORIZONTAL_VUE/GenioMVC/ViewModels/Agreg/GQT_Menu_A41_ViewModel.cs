...
namespace GenioMVC.ViewModels.Agreg
{
	public class GQT_Menu_A41_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_a41Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLA41");
			gqt_menu_a41Conds.Equal(CSGenioAagreg.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ A41]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_a41Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST A41]/
		...
		{
			var Elements = new List<GQT_Menu_A41_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_A41_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
