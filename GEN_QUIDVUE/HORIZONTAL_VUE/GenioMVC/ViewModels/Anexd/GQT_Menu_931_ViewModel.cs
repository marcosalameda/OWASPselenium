...
// USE /[MANUAL GQT OVERRQ 931]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAanexd>(m_userContext, false, ref gqt_menu_931Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML931", true, firstVisibleColumn: firstVisibleColumn);
