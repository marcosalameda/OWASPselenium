...
public class Asset02_ValAttachme_RowViewModel : Models.Attac
{
	#region Constructors

	public Asset02_ValAttachme_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Asset02_ValAttachme_RowViewModel(UserContext userContext, CSGenioAattac val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
