...
{
	public class Asset02_ValAttachme_ViewModel : MenuListViewModel<Models.Attac>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Asset02_ValAttachme_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Asset02_ValAttachme";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS ASSET02_PSEUDATTACHME]/
		...
		public Asset02_ValAttachme_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Asset02_ValAttachme_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Asset02_ValAttachme_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Asset02_ValAttachme_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Asset02_ValAttachme_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Attac.AddEPH<CSGenioAattac>(ref u, crs, "IBL_ASSET02_PSEUDATTACHME");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Attac.AddEPH<CSGenioAattac>(ref u, null, "IBL_ASSET02_PSEUDATTACHME"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAattac> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet asset02_pseudattachmeConds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "IBL_ASSET02_PSEUDATTACHME");
			...
			conditions.SubSets.Add(asset02_pseudattachmeConds);
			asset02_pseudattachmeConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ ASSET02_PSEUDATTACHME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAattac>(m_userContext, false, ref asset02_pseudattachmeConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ASSET02_PSEUDATTACHME", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP ASSET02_PSEUDATTACHME]/
			...
			if (tableReload)
			{
// USE /[MANUAL GQT OVERRQLIST ASSET02_PSEUDATTACHME]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAattac.GetInformation(), QMVC_POS_RECORD, sorts, asset02_pseudattachmeConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAattac> listing = Models.ModelBase.Where<CSGenioAattac>(m_userContext, distinct, asset02_pseudattachmeConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ASSET02_PSEUDATTACHME", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapAsset02_ValAttachme(listing);

				Menu.Identifier = "IBL_ASSET02_PSEUDATTACHME";

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "IBL_ASSET02_PSEUDATTACHME";
		...
		private List<Asset02_ValAttachme_RowViewModel> MapAsset02_ValAttachme(ListingMVC<CSGenioAattac> Qlisting)
		{
			List<Asset02_ValAttachme_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapAsset02_ValAttachme(row));
					i++;
				}
			}
		...
		/// to a Asset02_ValAttachme_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Asset02_ValAttachme_RowViewModel MapAsset02_ValAttachme(CSGenioAattac row)
		{
			var model = new Asset02_ValAttachme_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM ASSET02_VALATTACHME]/
