...
public class Asset03_ValDocument_RowViewModel : Models.Assma
{
	#region Constructors

	public Asset03_ValDocument_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Asset03_ValDocument_RowViewModel(UserContext userContext, CSGenioAassma val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
