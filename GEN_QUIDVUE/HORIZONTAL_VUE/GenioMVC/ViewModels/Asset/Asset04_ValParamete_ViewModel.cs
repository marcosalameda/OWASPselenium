...
{
	public class Asset04_ValParamete_ViewModel : MenuListViewModel<Models.Asspa>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Asset04_ValParamete_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Asset04_ValParamete";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS ASSET04_PSEUDPARAMETE]/
		...
		public Asset04_ValParamete_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Asset04_ValParamete_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Asset04_ValParamete_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Asset04_ValParamete_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Asset04_ValParamete_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Asspa.AddEPH<CSGenioAasspa>(ref u, crs, "IBL_ASSET04_PSEUDPARAMETE");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Asspa.AddEPH<CSGenioAasspa>(ref u, null, "IBL_ASSET04_PSEUDPARAMETE"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAasspa> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet asset04_pseudparameteConds = CriteriaSet.And();
			...
			FieldRef[] fields = new FieldRef[] { CSGenioAasspa.FldCodasspa, CSGenioAasspa.FldZzstate, CSGenioAasspa.FldCodparam, CSGenioAparam.FldCodparam, CSGenioAparam.FldParameter, CSGenioAasspa.FldDatatype, CSGenioAasspa.FldDecimalplaces, CSGenioAasspa.FldText, CSGenioAasspa.FldQuantity, CSGenioAasspa.FldDate, CSGenioAasspa.FldToshow };
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "IBL_ASSET04_PSEUDPARAMETE");
			...
			conditions.SubSets.Add(asset04_pseudparameteConds);
			asset04_pseudparameteConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL GQT OVERRQ ASSET04_PSEUDPARAMETE]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAasspa>(m_userContext, false, ref asset04_pseudparameteConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ASSET04_PSEUDPARAMETE", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP ASSET04_PSEUDPARAMETE]/
			...
			if (tableReload)
			{
// USE /[MANUAL GQT OVERRQLIST ASSET04_PSEUDPARAMETE]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAasspa.GetInformation(), QMVC_POS_RECORD, sorts, asset04_pseudparameteConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAasspa> listing = Models.ModelBase.Where<CSGenioAasspa>(m_userContext, distinct, asset04_pseudparameteConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ASSET04_PSEUDPARAMETE", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapAsset04_ValParamete(listing);

				Menu.Identifier = "IBL_ASSET04_PSEUDPARAMETE";

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "IBL_ASSET04_PSEUDPARAMETE";
		...
		private List<Asset04_ValParamete_RowViewModel> MapAsset04_ValParamete(ListingMVC<CSGenioAasspa> Qlisting)
		{
			List<Asset04_ValParamete_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapAsset04_ValParamete(row));
					i++;
				}
			}
		...
		/// to a Asset04_ValParamete_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Asset04_ValParamete_RowViewModel MapAsset04_ValParamete(CSGenioAasspa row)
		{
			var model = new Asset04_ValParamete_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM ASSET04_VALPARAMETE]/
		...
		[
			...
			new TableSearchColumn("ValDecimalplaces", CSGenioAasspa.FldDecimalplaces, typeof(decimal?), visible : false),
