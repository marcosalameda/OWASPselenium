...
public class Asset_ManufValName_RowViewModel : Models.Manuf
{
	#region Constructors

	public Asset_ManufValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Asset_ManufValName_RowViewModel(UserContext userContext, CSGenioAmanuf val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
