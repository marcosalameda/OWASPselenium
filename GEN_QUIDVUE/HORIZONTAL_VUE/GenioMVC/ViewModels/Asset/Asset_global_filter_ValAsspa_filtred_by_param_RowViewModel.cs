...
public class Asset_global_filter_ValAsspa_filtred_by_param_RowViewModel : Models.Asspa
{
	#region Constructors

	public Asset_global_filter_ValAsspa_filtred_by_param_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Asset_global_filter_ValAsspa_filtred_by_param_RowViewModel(UserContext userContext, CSGenioAasspa val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
