...
public class Asset_global_filter_ValParameter_RowViewModel : Models.Param
{
	#region Constructors

	public Asset_global_filter_ValParameter_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Asset_global_filter_ValParameter_RowViewModel(UserContext userContext, CSGenioAparam val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
