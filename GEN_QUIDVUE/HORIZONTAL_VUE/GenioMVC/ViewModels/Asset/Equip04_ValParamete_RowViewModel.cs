...
public class Equip04_ValParamete_RowViewModel : Models.Asspa
{
	#region Constructors

	public Equip04_ValParamete_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Equip04_ValParamete_RowViewModel(UserContext userContext, CSGenioAasspa val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
