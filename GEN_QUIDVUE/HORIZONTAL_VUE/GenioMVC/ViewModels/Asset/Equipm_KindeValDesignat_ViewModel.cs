...
// USE /[MANUAL GQT OVERRQ EQUIPM_KINDEDESIGNAT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAkinde>(m_userContext, false, ref equipm__kindedesignatConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIPM__KINDEDESIGNAT", true, firstVisibleColumn: firstVisibleColumn);
