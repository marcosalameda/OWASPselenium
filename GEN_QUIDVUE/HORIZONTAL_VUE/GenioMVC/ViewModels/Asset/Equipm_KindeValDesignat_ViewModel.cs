...
{
	public class Equipm_KindeValDesignat_ViewModel : MenuListViewModel<Models.Kinde>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<Equipm_KindeValDesignat_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "Equipm_KindeValDesignat";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS EQUIPM_KINDEDESIGNAT]/
		...
		public Equipm_KindeValDesignat_ViewModel() : base(null!) { }
		...
		public Equipm_KindeValDesignat_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Equipm_KindeValDesignat_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAkinde> Qlisting, ref CriteriaSet conditions)
		{
			...
			]), "ms", "Time to load the page."))
			{
				...
				equipm__kindedesignatConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLSTEXP EQUIPM_KINDEDESIGNAT]/
				...
				if (tableReload)
				{
// USE /[MANUAL GQT OVERRQLIST EQUIPM_KINDEDESIGNAT]/
					...
					ListingMVC<CSGenioAkinde> listing = Models.ModelBase.Where<CSGenioAkinde>(m_userContext, distinct, equipm__kindedesignatConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIPM__KINDEDESIGNAT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Equipm_KindeValDesignat_RowViewModel> MapEquipm_KindeValDesignat(ListingMVC<CSGenioAkinde> Qlisting)
		{
			List<Equipm_KindeValDesignat_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Equipm_KindeValDesignat_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Equipm_KindeValDesignat_RowViewModel MapEquipm_KindeValDesignat(CSGenioAkinde row)
		{
			var model = new Equipm_KindeValDesignat_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
