...
// USE /[MANUAL GQT LIST_LIMITS EQUIPM_MANUFNAME]/
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAmanuf> Qlisting, ref CriteriaSet conditions)
		{
			...
			equipm__manufname____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ EQUIPM_MANUFNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAmanuf>(m_userContext, false, ref equipm__manufname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIPM__MANUFNAME____", true, firstVisibleColumn: firstVisibleColumn);
