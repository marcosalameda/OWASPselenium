...
public class TBS_Menu_1A1_RowViewModel : Models.Asset
{
	#region Constructors

	public TBS_Menu_1A1_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public TBS_Menu_1A1_RowViewModel(UserContext userContext, CSGenioAasset val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
