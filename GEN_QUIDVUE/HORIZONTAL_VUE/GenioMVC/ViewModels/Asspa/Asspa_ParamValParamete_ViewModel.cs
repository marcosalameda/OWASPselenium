...
// USE /[MANUAL GQT OVERRQ ASSPA_PARAMPARAMETE]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAparam>(m_userContext, false, ref asspa___paramparameteConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ASSPA___PARAMPARAMETE", true, firstVisibleColumn: firstVisibleColumn);
