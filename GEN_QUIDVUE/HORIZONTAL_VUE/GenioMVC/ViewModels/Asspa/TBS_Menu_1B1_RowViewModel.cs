...
public class TBS_Menu_1B1_RowViewModel : Models.Asspa
{
	#region Constructors

	public TBS_Menu_1B1_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public TBS_Menu_1B1_RowViewModel(UserContext userContext, CSGenioAasspa val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
