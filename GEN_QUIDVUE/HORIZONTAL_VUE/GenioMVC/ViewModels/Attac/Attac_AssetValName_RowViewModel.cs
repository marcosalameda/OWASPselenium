...
public class Attac_AssetValName_RowViewModel : Models.Asset
{
	#region Constructors

	public Attac_AssetValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Attac_AssetValName_RowViewModel(UserContext userContext, CSGenioAasset val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
