...
public class UIS_Menu_211_RowViewModel : Models.Authenticatopt
{
	#region Constructors

	public UIS_Menu_211_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public UIS_Menu_211_RowViewModel(UserContext userContext, CSGenioAauthenticatopt val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
