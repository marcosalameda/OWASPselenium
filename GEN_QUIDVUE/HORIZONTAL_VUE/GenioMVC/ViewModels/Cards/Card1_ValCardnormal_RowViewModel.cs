...
public class Card1_ValCardnormal_RowViewModel : Models.Cards
{
	#region Constructors

	public Card1_ValCardnormal_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Card1_ValCardnormal_RowViewModel(UserContext userContext, CSGenioAcards val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
