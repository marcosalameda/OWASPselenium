...
namespace GenioMVC.ViewModels.Cate1
{
	public class GQT_Menu_6141_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_6141Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML6141");
			gqt_menu_6141Conds.Equal(CSGenioAcate1.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 6141]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_6141Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 6141]/
		...
		{
			var Elements = new List<GQT_Menu_6141_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_6141_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
