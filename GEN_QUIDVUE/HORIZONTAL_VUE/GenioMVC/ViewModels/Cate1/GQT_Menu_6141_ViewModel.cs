...
{
	public class GQT_Menu_6141_ViewModel : MenuListViewModel<Models.Cate1>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<GQT_Menu_6141_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		[JsonIgnore]
		public override string TableAlias => "cate1";

		/// <inheritdoc/>
		[JsonPropertyName("uuid")]
		public override string Uuid => "78e89b41-c18a-4d5e-af02-3117ce9c80e0";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS 6141]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML6141");
			...
			ListingMVC<CSGenioAcate1> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public GQT_Menu_6141_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="GQT_Menu_6141_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public GQT_Menu_6141_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public GQT_Menu_6141_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void LoadToExport(out ListingMVC<CSGenioAcate1> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<GQT_Menu_6141_RowViewModel>();
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcate1> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<GQT_Menu_6141_RowViewModel>();

			CriteriaSet gqt_menu_6141Conds = CriteriaSet.And();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "cate1", allSortOrders);
			...
			conditions.SubSets.Add(gqt_menu_6141Conds);
			gqt_menu_6141Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 6141]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcate1>(m_userContext, false, ref gqt_menu_6141Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6141", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 6141]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcate1.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_6141Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<GQT_Menu_6141_RowViewModel> MapGQT_Menu_6141(ListingMVC<CSGenioAcate1> Qlisting)
		{
			List<GQT_Menu_6141_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a GQT_Menu_6141_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_6141_RowViewModel MapGQT_Menu_6141(CSGenioAcate1 row)
		{
			var model = new GQT_Menu_6141_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
