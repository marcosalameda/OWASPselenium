...
public class TBS_Menu_131_RowViewModel : Models.Categ
{
	#region Constructors

	public TBS_Menu_131_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public TBS_Menu_131_RowViewModel(UserContext userContext, CSGenioAcateg val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
