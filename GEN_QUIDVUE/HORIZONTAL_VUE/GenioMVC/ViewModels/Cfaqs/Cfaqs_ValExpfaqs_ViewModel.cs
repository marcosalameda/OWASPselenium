...
// USE /[MANUAL GQT OVERRQ CFAQS_PSEUDEXPFAQS]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAfaqs>(m_userContext, false, cfaqs___pseudexpfaqs_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CFAQS___PSEUDEXPFAQS_", true, firstVisibleColumn: firstVisibleColumn);
