...
{
	public class GQT_Menu_B1_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "a6f630f6-28cf-442d-8c37-72a353de1755"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_b1Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLB1");
			gqt_menu_b1Conds.Equal(CSGenioAcfaqs.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ B1]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_b1Conds, listing);
...
// USE /[MANUAL GQT OVERRQ B1]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcfaqs>(m_userContext, false, gqt_menu_b1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLB1", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST B1]/
					...
					ListingMVC<CSGenioAcfaqs> listing = Models.ModelBase.Where<CSGenioAcfaqs>(m_userContext, false, gqt_menu_b1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLB1", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_B1_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_B1_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		private void SetDocumentFields(ListingMVC<CSGenioAcfaqs> listing)
		{
			...
			foreach (CSGenioAcfaqs row in listing.Rows)
			{
			}
		}
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_B1]/
		...
		[
			"Cfaqs", "Cfaqs.ValCodcfaqs", "Cfaqs.ValZzstate", "Cfaqs.ValIcon", "Cfaqs.ValCategory", "Cfaqs.ValDescript", "BtnPermission"
		];
