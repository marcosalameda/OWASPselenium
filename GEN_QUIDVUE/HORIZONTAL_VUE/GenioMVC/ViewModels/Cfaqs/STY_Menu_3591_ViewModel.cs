...
namespace GenioMVC.ViewModels.Cfaqs
{
	public class STY_Menu_3591_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet sty_menu_3591Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML3591");
			sty_menu_3591Conds.Equal(CSGenioAcfaqs.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL STY OVERRQ 3591]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(sty_menu_3591Conds, listing);
...
// USE /[MANUAL STY OVERRQLIST 3591]/
		...
		{
			var Elements = new List<STY_Menu_3591_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(STY_Menu_3591_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
