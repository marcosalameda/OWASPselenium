...
public class City03_CtryValCountry_RowViewModel : Models.Ctry
{
	#region Constructors

	public City03_CtryValCountry_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public City03_CtryValCountry_RowViewModel(UserContext userContext, CSGenioActry val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
