...
// USE /[MANUAL GQT VIEWMODEL_DESTROY CITY03]/
		...
		public void Load_City03__ctry_country_(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			if (city03__ctry_country_DoLoad)
			{
				...
				FieldRef[] fields = [CSGenioActry.FldCodctry, CSGenioActry.FldCountry, CSGenioActry.FldZzstate];
...
// USE /[MANUAL GQT OVERRQ CITY03_CTRYCOUNTRY]/
				...
				*/
				...
				TableCtryCountry.Elements = listing.RowsForViewModel<GenioMVC.Models.Ctry>((r) => new GenioMVC.Models.Ctry(m_userContext, r, true, _fieldsToSerialize_CITY03__CTRY_COUNTRY_));
