...
// USE /[MANUAL TRN OVERRQ T03CITY]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcity>(m_userContext, false, trn_menu_t03cityConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT03CITY", true, firstVisibleColumn: firstVisibleColumn);
