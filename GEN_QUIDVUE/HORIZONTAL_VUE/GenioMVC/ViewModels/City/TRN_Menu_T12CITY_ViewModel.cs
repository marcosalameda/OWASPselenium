...
// USE /[MANUAL TRN OVERRQ T12CITY]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcity>(m_userContext, false, trn_menu_t12cityConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT12CITY", true, firstVisibleColumn: firstVisibleColumn);
