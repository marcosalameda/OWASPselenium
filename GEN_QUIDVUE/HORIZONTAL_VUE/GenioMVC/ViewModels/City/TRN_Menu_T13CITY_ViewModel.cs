...
{
	public class TRN_Menu_T13CITY_ViewModel : MenuListViewModel<Models.City>
	{
		/// <summary>
		...
		public override string Uuid => "db4f0ce4-600e-4901-8d8f-a2f8141c3e4c";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T13CITY]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT13CITY");
		...
		public TRN_Menu_T13CITY_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T13CITY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T13CITY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcity>(m_userContext, false, ref trn_menu_t13cityConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT13CITY", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T13CITY]/
				...
				ListingMVC<CSGenioAcity> listing = Models.ModelBase.Where<CSGenioAcity>(m_userContext, distinct, trn_menu_t13cityConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT13CITY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T13CITY_RowViewModel> Elements = [];
			int i = 0;
