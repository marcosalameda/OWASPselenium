...
// USE /[MANUAL TRN OVERRQ T16CITY]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcity>(m_userContext, false, trn_menu_t16cityConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT16CITY", true, firstVisibleColumn: firstVisibleColumn);
