...
{
	public class GQT_Menu_2B1_ViewModel : MenuListViewModel<Models.Cmpki>
	{
		/// <summary>
		...
		public override string Uuid => "92c5f22f-04ae-44dd-9688-bdfafa2721ba";
...
// USE /[MANUAL GQT LIST_LIMITS 2B1]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2B1");
		...
		public GQT_Menu_2B1_ViewModel() : base(null!) { }
		...
		public GQT_Menu_2B1_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ 2B1]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcmpki>(m_userContext, false, ref gqt_menu_2b1Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2B1", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 2B1]/
				...
				ListingMVC<CSGenioAcmpki> listing = Models.ModelBase.Where<CSGenioAcmpki>(m_userContext, distinct, gqt_menu_2b1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2B1", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_2B1_RowViewModel> Elements = [];
			int i = 0;
