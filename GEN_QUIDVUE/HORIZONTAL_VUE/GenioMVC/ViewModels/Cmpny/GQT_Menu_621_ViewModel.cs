...
namespace GenioMVC.ViewModels.Cmpny
{
	public class GQT_Menu_621_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_621Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML621");
			gqt_menu_621Conds.Equal(CSGenioAcmpny.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 621]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_621Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 621]/
					...
					ListingMVC<CSGenioAcmpny> listing = Models.ModelBase.Where<CSGenioAcmpny>(m_userContext, false, gqt_menu_621Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML621", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_621_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_621_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
