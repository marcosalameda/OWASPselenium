...
{
	public class TBS_Menu_111_ViewModel : MenuListViewModel<Models.Cmpny>
	{
		/// <summary>
		...
		public override string Uuid => "3a33592d-582d-4485-8cd5-f73311b6c28b";
...
// USE /[MANUAL TBS LIST_LIMITS 111]/
		...
		public TBS_Menu_111_ViewModel() : base(null!) { }
		...
		public TBS_Menu_111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TBS OVERRQ 111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcmpny>(m_userContext, false, ref tbs_menu_111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TBS OVERRQLIST 111]/
		...
		{
			List<TBS_Menu_111_RowViewModel> Elements = [];
			int i = 0;
