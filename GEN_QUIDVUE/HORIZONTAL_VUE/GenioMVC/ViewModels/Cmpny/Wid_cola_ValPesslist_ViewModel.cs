...
// USE /[MANUAL GQT OVERRQ WID_COLA_PSEUDPESSLIST]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, wid_colapseudpesslistConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_WID_COLAPSEUDPESSLIST", true, firstVisibleColumn: firstVisibleColumn);
