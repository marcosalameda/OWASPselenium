...
{
	public class Wid_cola_ValPesslist_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Wid_cola_ValPesslist_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Wid_cola_ValPesslist";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS WID_COLA_PSEUDPESSLIST]/
		...
		public Wid_cola_ValPesslist_ViewModel() : base(null!) { }
		...
		public Wid_cola_ValPesslist_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Wid_cola_ValPesslist_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApesso> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet wid_colapseudpesslistConds = CriteriaSet.And();
			...
			conditions.SubSets.Add(wid_colapseudpesslistConds);
			wid_colapseudpesslistConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ WID_COLA_PSEUDPESSLIST]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref wid_colapseudpesslistConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_WID_COLAPSEUDPESSLIST", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST WID_COLA_PSEUDPESSLIST]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApesso.GetInformation(), QMVC_POS_RECORD, sorts, wid_colapseudpesslistConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<Wid_cola_ValPesslist_RowViewModel> MapWid_cola_ValPesslist(ListingMVC<CSGenioApesso> Qlisting)
		{
			List<Wid_cola_ValPesslist_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Wid_cola_ValPesslist_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Wid_cola_ValPesslist_RowViewModel MapWid_cola_ValPesslist(CSGenioApesso row)
		{
			var model = new Wid_cola_ValPesslist_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WID_COLA_VALPESSLIST]/
		...
		[
			"Pesso", "Pesso.ValCodpesso", "Pesso.ValZzstate", "Pesso.ValName", "Pesso.ValPhotogra", "Pesso.ValEmail", "Categ", "Categ.ValCategoria", "Pesso.ValCodcateg", "Pesso.ValCodempre", "Pesso.ValCodpaise", "Pesso.ValCodcntry", "Pesso.ValCodregia"
		];
