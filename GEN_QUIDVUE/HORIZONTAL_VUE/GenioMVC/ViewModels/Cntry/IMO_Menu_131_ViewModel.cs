...
namespace GenioMVC.ViewModels.Cntry
{
	public class IMO_Menu_131_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet imo_menu_131Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML131");
			imo_menu_131Conds.Equal(CSGenioAcntry.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL IMO OVERRQ 131]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(imo_menu_131Conds, listing);
...
// USE /[MANUAL IMO OVERRQLIST 131]/
					...
					ListingMVC<CSGenioAcntry> listing = Models.ModelBase.Where<CSGenioAcntry>(m_userContext, false, imo_menu_131Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML131", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<IMO_Menu_131_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(IMO_Menu_131_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
