...
{
	public class IMO_Menu_231_ViewModel : MenuListViewModel<Models.Cntry>
	{
		/// <summary>
		...
		public override string Uuid => "92e9ac39-cb12-4a4f-9153-c5e720ca8e78";
...
// USE /[MANUAL IMO LIST_LIMITS 231]/
		...
		public IMO_Menu_231_ViewModel() : base(null!) { }
		...
		public IMO_Menu_231_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL IMO OVERRQ 231]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcntry>(m_userContext, false, ref imo_menu_231Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML231", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL IMO OVERRQLIST 231]/
		...
		{
			List<IMO_Menu_231_RowViewModel> Elements = [];
			int i = 0;
