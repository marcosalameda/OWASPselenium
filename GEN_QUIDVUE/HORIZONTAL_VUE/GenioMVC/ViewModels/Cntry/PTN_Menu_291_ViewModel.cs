...
{
	public class PTN_Menu_291_ViewModel : MenuListViewModel<Models.Cntry>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<PTN_Menu_291_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "d95ff9a4-a614-40c4-b9fd-17b51567d7f7";
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 291]/
		...
		public override int GetCount(User user)
		{
			...
			var areaBase = CSGenio.business.Area.createArea("cntry", user, "PTN");

			//gets eph conditions to be applied in listing
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML291");
			...
			FieldRef[] fields = new FieldRef[] { CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldZzstate, CSGenioAcntry.FldCountry, CSGenioAcntry.FldAlfa3, CSGenioAcntry.FldCodigonr, CSGenioAcntry.FldAlfa2, CSGenioAcntry.FldFlag, CSGenioAcntry.FldActive };
		...
		public PTN_Menu_291_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_291_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_291_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public PTN_Menu_291_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<PTN_Menu_291_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Cntry.AddEPH<CSGenioAcntry>(ref u, crs, "ML291");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Cntry.AddEPH<CSGenioAcntry>(ref u, null, "ML291"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcntry> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet ptn_menu_291Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML291");
			...
			conditions.SubSets.Add(ptn_menu_291Conds);
			ptn_menu_291Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PTN OVERRQ 291]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcntry>(m_userContext, false, ref ptn_menu_291Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML291", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 291]/
...
// USE /[MANUAL PTN OVERRQLIST 291]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcntry.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_291Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAcntry> listing = Models.ModelBase.Where<CSGenioAcntry>(m_userContext, distinct, ptn_menu_291Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML291", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapPTN_Menu_291(listing);

				Menu.Identifier = "ML291";
				Menu.Slots = new Dictionary<string, List<object>>();

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "ML291";
		...
		private List<PTN_Menu_291_RowViewModel> MapPTN_Menu_291(ListingMVC<CSGenioAcntry> Qlisting)
		{
			List<PTN_Menu_291_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPTN_Menu_291(row));
					i++;
				}
			}
		...
		/// to a PTN_Menu_291_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_291_RowViewModel MapPTN_Menu_291(CSGenioAcntry row)
		{
			var model = new PTN_Menu_291_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_291]/

		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Cntry", "Cntry.ValCodcntry", "Cntry.ValZzstate", "Cntry.ValCountry", "Cntry.ValAlfa3", "Cntry.ValCodigonr", "Cntry.ValAlfa2", "Cntry.ValFlag", "Cntry.ValActive"
		];
