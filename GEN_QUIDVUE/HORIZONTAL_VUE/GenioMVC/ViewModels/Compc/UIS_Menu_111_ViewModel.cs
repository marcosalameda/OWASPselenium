...
// USE /[MANUAL UIS LIST_LIMITS 111]/
		...
		public override int GetCount(User user)
		{
			...
			FieldRef[] fields = new FieldRef[] { CSGenioAcompc.FldCodcompc, CSGenioAcompc.FldZzstate, CSGenioAcompc.FldClassico, CSGenioAcompc.FldCompclas, CSGenioAcompc.FldClassdes };
		...
		public override List<Exports.QColumn> GetColumnsToExport(bool ajaxRequest = false)
		{
			...
			{
				!ajaxRequest ? new Exports.QColumn(CSGenioAcompc.FldClassico, FieldType.IMAGE, Resources.Resources.CLASS_ICON19969, 3, 0, false):null,
				new Exports.QColumn(CSGenioAcompc.FldCompclas, FieldType.TEXT, Resources.Resources.COMPONENT_CLASS55392, 30, 0, true),
				new Exports.QColumn(CSGenioAcompc.FldClassdes, FieldType.MEMO, Resources.Resources.CLASS_DESCRIPTION30131, 100, 5, true),
			};
...
// USE /[MANUAL UIS OVERRQ 111]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcompc>(m_userContext, false, uis_menu_111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM UIS_MENU_111]/
		...
		[
			"Compc", "Compc.ValCodcompc", "Compc.ValZzstate", "Compc.ValClassico", "Compc.ValCompclas", "Compc.ValClassdes"
		];
