...
public class UIS_Menu_1111_RowViewModel : Models.Compo
{
	#region Constructors

	public UIS_Menu_1111_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public UIS_Menu_1111_RowViewModel(UserContext userContext, CSGenioAcompo val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
