...
// USE /[MANUAL UIS LIST_LIMITS 1111]/
		...
		public override int GetCount(User user)
		{
			...
			FieldRef[] fields = new FieldRef[] { CSGenioAcompo.FldCodcompo, CSGenioAcompo.FldZzstate, CSGenioAcompo.FldComptype, CSGenioAcompo.FldCompicon, CSGenioAcompo.FldMvc, CSGenioAcompo.FldVuemvc, CSGenioAcompo.FldCompdesc };
		...
		public override List<Exports.QColumn> GetColumnsToExport(bool ajaxRequest = false)
		{
			var columns = new List<Exports.QColumn>()
			{
				...
				new Exports.QColumn(CSGenioAcompo.FldCompdesc, FieldType.MEMO, Resources.Resources.DESCRIPTION07438, 200, 5, true),
			};
...
// USE /[MANUAL UIS OVERRQ 1111]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAcompo>(m_userContext, false, uis_menu_1111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM UIS_MENU_1111]/
		...
		[
			"Compo", "Compo.ValCodcompo", "Compo.ValZzstate", "Compo.ValComptype", "Compo.ValCompicon", "Compo.ValMvc", "Compo.ValVuemvc", "Compo.ValCompdesc", "Compo.ValCodcompc"
		];
