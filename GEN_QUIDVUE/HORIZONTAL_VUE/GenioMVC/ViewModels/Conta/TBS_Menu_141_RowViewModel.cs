...
public class TBS_Menu_141_RowViewModel : Models.Conta
{
	#region Constructors

	public TBS_Menu_141_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public TBS_Menu_141_RowViewModel(UserContext userContext, CSGenioAconta val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
