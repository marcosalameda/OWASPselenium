...
// USE /[MANUAL TBS OVERRQ 141]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAconta>(m_userContext, false, ref tbs_menu_141Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML141", true, firstVisibleColumn: firstVisibleColumn);
