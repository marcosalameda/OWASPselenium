...
// USE /[MANUAL TRN OVERRQ T12COUNTRY]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioActry>(m_userContext, false, trn_menu_t12countryConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT12COUNTRY", true, firstVisibleColumn: firstVisibleColumn);
