...
namespace GenioMVC.ViewModels.Decom
{
	public class GQT_Menu_2C111_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_2c111Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2C111");
			gqt_menu_2c111Conds.Equal(CSGenioAdecom.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 2C111]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_2c111Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 2C111]/
		...
		{
			var Elements = new List<GQT_Menu_2C111_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_2C111_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
