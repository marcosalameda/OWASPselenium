...
{
	public class Dilin_DispaValDispanr_ViewModel : MenuListViewModel<Models.Dispa>
	{
		/// <summary>
		...
		public override string Uuid => "Dilin_DispaValDispanr";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS DILIN_DISPADISPANR]/
		...
		public Dilin_DispaValDispanr_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Dilin_DispaValDispanr_ViewModel" /> class.
		/// </summary>
		...
		public Dilin_DispaValDispanr_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Dispa.AddEPH<CSGenioAdispa>(ref u, crs, "IBL_DILIN___DISPADISPANR_");
			...
			crs.Criterias.Add(new Criteria(new ColumnReference(CSGenioAdispa.FldZzstate), CriteriaOperator.Equal, 0));
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Dispa.AddEPH<CSGenioAdispa>(ref u, null, "IBL_DILIN___DISPADISPANR_"));
			}
...
// USE /[MANUAL GQT OVERRQ DILIN_DISPADISPANR]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAdispa>(m_userContext, false, ref dilin___dispadispanr_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DILIN___DISPADISPANR_", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP DILIN_DISPADISPANR]/
			...
			if (tableReload)
			{
// USE /[MANUAL GQT OVERRQLIST DILIN_DISPADISPANR]/
		...
		{
			List<Dilin_DispaValDispanr_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapDilin_DispaValDispanr(row));
					i++;
				}
			}
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM DILIN_DISPAVALDISPANR]/
