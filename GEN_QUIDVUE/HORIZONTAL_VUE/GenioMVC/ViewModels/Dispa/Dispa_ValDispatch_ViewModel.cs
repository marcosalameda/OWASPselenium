...
{
	public class Dispa_ValDispatch_ViewModel : MenuListViewModel<Models.Dilin>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Dispa_ValDispatch";
...
// USE /[MANUAL GQT LIST_LIMITS DISPA_PSEUDDISPATCH]/
		...
		public Dispa_ValDispatch_ViewModel() : base(null!) { }
		...
		public Dispa_ValDispatch_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST DISPA_PSEUDDISPATCH]/
		...
		{
			List<Dispa_ValDispatch_RowViewModel> Elements = [];
			int i = 0;
