...
namespace GenioMVC.ViewModels.Dispa
{
	public class WMS_Menu_2111_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_2111Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2111");
			wms_menu_2111Conds.Equal(CSGenioAdispa.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						wms_menu_2111Conds.Equal(CSGenioAdispa.FldIsprepar, 0);
...
// USE /[MANUAL WMS OVERRQ 2111]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_2111Conds, listing);
...
// USE /[MANUAL WMS OVERRQLIST 2111]/
					...
					ListingMVC<CSGenioAdispa> listing = Models.ModelBase.Where<CSGenioAdispa>(m_userContext, false, wms_menu_2111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<WMS_Menu_2111_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_2111_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
