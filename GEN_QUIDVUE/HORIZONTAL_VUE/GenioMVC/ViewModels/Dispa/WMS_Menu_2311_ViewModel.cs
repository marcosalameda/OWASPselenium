...
{
	public class WMS_Menu_2311_ViewModel : MenuListViewModel<Models.Dispa>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<WMS_Menu_2311_RowViewModel> Menu { get; set; }
		...
		{
// USE /[MANUAL WMS LIST_LIMITS 2311]/
		...
		public WMS_Menu_2311_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="WMS_Menu_2311_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public WMS_Menu_2311_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public WMS_Menu_2311_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<WMS_Menu_2311_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Dispa.AddEPH<CSGenioAdispa>(ref u, crs, "ML2311");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Dispa.AddEPH<CSGenioAdispa>(ref u, null, "ML2311"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAdispa> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet wms_menu_2311Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(wms_menu_2311Conds);
			wms_menu_2311Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL WMS OVERRQ 2311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAdispa>(m_userContext, false, ref wms_menu_2311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2311", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL WMS OVERRQLSTEXP 2311]/
			...
			if (tableReload)
			{
// USE /[MANUAL WMS OVERRQLIST 2311]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAdispa.GetInformation(), QMVC_POS_RECORD, sorts, wms_menu_2311Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAdispa> listing = Models.ModelBase.Where<CSGenioAdispa>(m_userContext, distinct, wms_menu_2311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapWMS_Menu_2311(listing);
		...
		private List<WMS_Menu_2311_RowViewModel> MapWMS_Menu_2311(ListingMVC<CSGenioAdispa> Qlisting)
		{
			List<WMS_Menu_2311_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapWMS_Menu_2311(row));
					i++;
				}
			}
		...
		/// to a WMS_Menu_2311_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private WMS_Menu_2311_RowViewModel MapWMS_Menu_2311(CSGenioAdispa row)
		{
			var model = new WMS_Menu_2311_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_2311]/
