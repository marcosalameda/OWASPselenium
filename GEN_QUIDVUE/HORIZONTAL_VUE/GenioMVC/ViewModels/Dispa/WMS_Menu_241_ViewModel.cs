...
// USE /[MANUAL WMS OVERRQ 241]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAdispa>(m_userContext, false, wms_menu_241Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML241", true, firstVisibleColumn: firstVisibleColumn);
