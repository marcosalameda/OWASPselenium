...
public class Entidade_ValOperacoes_RowViewModel : Models.Operacoes
{
	#region Constructors

	public Entidade_ValOperacoes_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Entidade_ValOperacoes_RowViewModel(UserContext userContext, CSGenioAoperacoes val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
