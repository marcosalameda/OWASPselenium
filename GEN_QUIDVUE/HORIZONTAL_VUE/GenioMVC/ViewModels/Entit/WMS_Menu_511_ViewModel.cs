...
{
	public class WMS_Menu_511_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<WMS_Menu_511_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid { get => "07a4ae81-9ea2-4709-901d-950c72bb072b"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_511Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML511");
			wms_menu_511Conds.Equal(CSGenioAentit.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

			

// USE /[MANUAL WMS OVERRQ 511]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_511Conds, listing);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="WMS_Menu_511_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public WMS_Menu_511_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override List<Exports.QColumn> GetColumnsToExport(bool ajaxRequest = false)
		{
			var columns = new List<Exports.QColumn>()
			{
				...
				new Exports.QColumn(CSGenioAentit.FldWebsite, FieldType.TEXTO, Resources.Resources.WEB_SITE06263, 30, 0, true),
				new Exports.QColumn(CSGenioAentit.FldPerson, FieldType.TEXTO, Resources.Resources.PERSON_DEPARTMENT_TO28777, 30, 0, true),
				...
				new Exports.QColumn(CSGenioAentit.FldOwner, FieldType.TEXTO, Resources.Resources.OWNER09558, 30, 0, true),
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<WMS_Menu_511_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Entit.AddEPH<CSGenioAentit>(ref u, crs, "ML511");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Entit.AddEPH<CSGenioAentit>(ref u, null, "ML511"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAentit> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet wms_menu_511Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				conditions.SubSets.Add(wms_menu_511Conds);
				wms_menu_511Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQ 511]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAentit>(m_userContext, false, wms_menu_511Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL WMS OVERRQLSTEXP 511]/
...
// USE /[MANUAL WMS OVERRQLIST 511]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAentit.GetInformation(), QMVC_POS_RECORD, sorts, wms_menu_511Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAentit> listing = Models.ModelBase.Where<CSGenioAentit>(m_userContext, false, wms_menu_511Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML511", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapWMS_Menu_511(listing);
		...
		private List<WMS_Menu_511_RowViewModel> MapWMS_Menu_511(ListingMVC<CSGenioAentit> Qlisting)
		{
			var Elements = new List<WMS_Menu_511_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapWMS_Menu_511(row));
					i++;
				}
			}
		...
		/// to a WMS_Menu_511_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private WMS_Menu_511_RowViewModel MapWMS_Menu_511(CSGenioAentit row)
		{
			var model = new WMS_Menu_511_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_511_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_511]/
		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Entit", "Entit.ValCodentit", "Entit.ValZzstate", "Entit.ValName", "Entit.ValInitials", "Entit.ValRegistra", "Entit.ValTaxnumbe", "Entit.ValEmail", "Entit.ValPhonenum", "Entit.ValWebsite", "Entit.ValPerson", "Entit.ValIban", "Entit.ValBuilding", "Entit.ValStreet", "Entit.ValTown", "Entit.ValCounty", "Entit.ValState", "Entit.ValPobox", "Entit.ValPostalco", "Entit.ValTelephon", "Entit.ValFax", "Entit.ValContact", "Entit.ValManufact", "Entit.ValFounded", "Faci1", "Faci1.ValName", "Faci2", "Faci2.ValName", "Entit.ValLanguage", "Entit.ValCurrency", "Entit.ValOwner", "Entit.ValCarrier", "Entit.ValSupplier", "Entit.ValFirstfacilitie", "Entit.ValLastfacilitie", "BtnPermission"
		];
		...
		[
			...
			new TableSearchColumn("ValWebsite", CSGenioAentit.FldWebsite, typeof(string)),
			new TableSearchColumn("ValPerson", CSGenioAentit.FldPerson, typeof(string)),
