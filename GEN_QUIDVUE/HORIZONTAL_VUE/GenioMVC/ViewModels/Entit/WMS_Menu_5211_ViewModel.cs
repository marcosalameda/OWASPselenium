...
namespace GenioMVC.ViewModels.Entit
{
	public class WMS_Menu_5211_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_5211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML5211");
			wms_menu_5211Conds.Equal(CSGenioAentit.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						wms_menu_5211Conds.Equal(CSGenioAentit.FldSupplier, 1);
...
// USE /[MANUAL WMS OVERRQ 5211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_5211Conds, listing);
