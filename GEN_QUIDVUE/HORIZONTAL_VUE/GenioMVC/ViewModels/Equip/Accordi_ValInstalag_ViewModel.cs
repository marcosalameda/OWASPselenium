...
// USE /[MANUAL GQT OVERRQ ACCORDI_PSEUDINSTALAG]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAinsta>(m_userContext, false, ref accordi_pseudinstalagConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ACCORDI_PSEUDINSTALAG", true, firstVisibleColumn: firstVisibleColumn);
