...
{
	public class Accordi_ValReparaco_ViewModel : MenuListViewModel<Models.Repar>
	{
		/// <summary>
		...
		public override string Uuid => "Accordi_ValReparaco";
...
// USE /[MANUAL GQT LIST_LIMITS ACCORDI_PSEUDREPARACO]/
		...
		public Accordi_ValReparaco_ViewModel() : base(null!) { }
		...
		public Accordi_ValReparaco_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ ACCORDI_PSEUDREPARACO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArepar>(m_userContext, false, ref accordi_pseudreparacoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ACCORDI_PSEUDREPARACO", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ACCORDI_PSEUDREPARACO]/
		...
		{
			List<Accordi_ValReparaco_RowViewModel> Elements = [];
			int i = 0;
