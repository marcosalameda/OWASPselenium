...
{
	public class Equip_Pess1ValName_ViewModel : MenuListViewModel<Models.Pess1>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "Equip_Pess1ValName";
...
// USE /[MANUAL GQT LIST_LIMITS EQUIP_PESS1NAME]/
		...
		public Equip_Pess1ValName_ViewModel() : base(null!) { }
		...
		public Equip_Pess1ValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override List<Exports.QColumn> GetColumnsToExport(bool ajaxRequest = false)
		{
			...
			{
				new Exports.QColumn(CSGenioApess1.FldName, FieldType.TEXT, Resources.Resources.NAME31974, 85, 0, true),
			};
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PESS1NAME]/
					...
					ListingMVC<CSGenioApess1> listing = Models.ModelBase.Where<CSGenioApess1>(m_userContext, distinct, equip___pess1name____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PESS1NAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<Equip_Pess1ValName_RowViewModel> Elements = [];
			int i = 0;
