...
public class Equip_ValMovimels_RowViewModel : Models.Movim
{
	#region Constructors

	public Equip_ValMovimels_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Equip_ValMovimels_RowViewModel(UserContext userContext, CSGenioAmovim val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
