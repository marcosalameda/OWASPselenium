...
namespace GenioMVC.ViewModels.Equip
{
	public class Equip_ValReparaco_ViewModel : ListViewModel
	{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (!tableConfig.StaticFilters.ContainsKey("filter_ValReparaco_STARTED"))
				tableConfig.StaticFilters.Add("filter_ValReparaco_STARTED", null);

			{
				var groupFilters = CriteriaSet.Or();
				bool filter_ValReparaco_STARTED_1 = false;
				if (tableConfig.StaticFilters["filter_ValReparaco_STARTED"] != null)
					filter_ValReparaco_STARTED_1 = tableConfig.StaticFilters["filter_ValReparaco_STARTED"].Contains("1");
				...
				if (tableConfig.StaticFilters["filter_ValReparaco_STARTED"] != null)
					filter_ValReparaco_STARTED_2 = tableConfig.StaticFilters["filter_ValReparaco_STARTED"].Contains("2");
				...
				if (tableConfig.StaticFilters["filter_ValReparaco_STARTED"] != null)
					filter_ValReparaco_STARTED_3 = tableConfig.StaticFilters["filter_ValReparaco_STARTED"].Contains("3");
...
// USE /[MANUAL GQT OVERRQ EQUIP_PSEUDREPARACO]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioArepar>(m_userContext, false, equip___pseudreparacoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDREPARACO", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST EQUIP_PSEUDREPARACO]/
					...
					ListingMVC<CSGenioArepar> listing = Models.ModelBase.Where<CSGenioArepar>(m_userContext, false, equip___pseudreparacoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EQUIP___PSEUDREPARACO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Equip_ValReparaco_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Equip_ValReparaco_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM EQUIP_VALREPARACO]/
		...
		[
			"Repar", "Repar.ValCodrepar", "Repar.ValZzstate", "Repar.ValNrrepara", "Repar.ValDtrepara", "Cate1", "Cate1.ValCategoria", "Pesso", "Pesso.ValName", "Repar.ValDescript", "Repar.ValHours", "Repar.ValTipoarea", "Repar.ValCodcateg", "Repar.ValCodempre", "Repar.ValCodequip", "Repar.ValCodpesso", "Repar.ValCodespec", "BtnPermission"
		];
