...
// USE /[MANUAL GQT LIST_LIMITS 211]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			//Set active filters
			crs.SubSets.Add(ProcessActiveFilter(Menu, tableConfig));
...
// USE /[MANUAL GQT OVERRQ 211]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref gqt_menu_211Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, firstVisibleColumn: firstVisibleColumn);
