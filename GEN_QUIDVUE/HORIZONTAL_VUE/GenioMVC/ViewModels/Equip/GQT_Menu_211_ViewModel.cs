...
{
	public class GQT_Menu_211_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "9c20afa8-9950-45e5-9447-fccf9853de7d";
...
// USE /[MANUAL GQT LIST_LIMITS 211]/
		...
		public GQT_Menu_211_ViewModel() : base(null!) { }
		...
		public GQT_Menu_211_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST 211]/
					...
					ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, gqt_menu_211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_211_RowViewModel> Elements = [];
			int i = 0;
