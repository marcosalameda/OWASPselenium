...
{
	public class GQT_Menu_231_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "1ef47b5e-55ef-4a74-adc4-a282edf007b4";
...
// USE /[MANUAL GQT LIST_LIMITS 231]/
		...
		public GQT_Menu_231_ViewModel() : base(null!) { }
		...
		public GQT_Menu_231_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST 231]/
					...
					ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, gqt_menu_231Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML231", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_231_RowViewModel> Elements = [];
			int i = 0;
