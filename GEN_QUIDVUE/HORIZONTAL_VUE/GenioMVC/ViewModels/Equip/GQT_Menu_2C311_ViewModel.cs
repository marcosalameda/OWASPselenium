...
namespace GenioMVC.ViewModels.Equip
{
	public class GQT_Menu_2C311_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_2c311Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2C311");
			gqt_menu_2c311Conds.Equal(CSGenioAequip.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 2C311]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_2c311Conds, listing);
