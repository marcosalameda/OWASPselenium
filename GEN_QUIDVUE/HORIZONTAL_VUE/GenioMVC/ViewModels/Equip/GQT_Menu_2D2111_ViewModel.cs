...
// USE /[MANUAL GQT OVERRQ 2D2111]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, gqt_menu_2d2111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2D2111", true, firstVisibleColumn: firstVisibleColumn);
