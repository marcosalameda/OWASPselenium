...
{
	public class GQT_Menu_6211_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<GQT_Menu_6211_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid { get => "1894ac04-c1ca-40a7-a507-5fc0f49867ed"; }
		...
		public override CriteriaSet baseConditions
		{
			get
			{
				...
				conds.Equal(CSGenioAequip.FldCodempre, Navigation.GetValue("cmpny"));
				return conds;
			}
		}
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_6211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML6211");
			gqt_menu_6211Conds.Equal(CSGenioAequip.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

			

// USE /[MANUAL GQT OVERRQ 6211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_6211Conds, listing);
			...
			if (!qs.Joins.Select(x => x.Table).Select(y=>y.TableAlias).Contains(CSGenio.business.Area.AreaCMPNY.Alias))
				qs.Join(CSGenio.business.Area.AreaCMPNY, TableJoinType.Inner).On(CriteriaSet.And().Equal(CSGenioAcmpny.FldCodempre, CSGenioAequip.FldCodempre));
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GQT_Menu_6211_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public GQT_Menu_6211_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_6211_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Equip.AddEPH<CSGenioAequip>(ref u, crs, "ML6211");
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAequip> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet gqt_menu_6211Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML6211");
			...
			//1st Area Value: ""
			{
				...
				conditions.SubSets.Add(gqt_menu_6211Conds);
				gqt_menu_6211Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 6211]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, gqt_menu_6211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6211", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP 6211]/
				...
				if (tableReload)
				{
// USE /[MANUAL GQT OVERRQLIST 6211]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAequip.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_6211Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, gqt_menu_6211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML6211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapGQT_Menu_6211(listing);

					Menu.Identifier = "ML6211";
					Menu.Slots = new Dictionary<string, List<object>>();

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "ML6211";
		...
		private List<GQT_Menu_6211_RowViewModel> MapGQT_Menu_6211(ListingMVC<CSGenioAequip> Qlisting)
		{
			var Elements = new List<GQT_Menu_6211_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapGQT_Menu_6211(row));
					i++;
				}
			}
		...
		/// to a GQT_Menu_6211_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_6211_RowViewModel MapGQT_Menu_6211(CSGenioAequip row)
		{
			var model = new GQT_Menu_6211_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_6211_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_6211]/
		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Equip", "Equip.ValCodequip", "Equip.ValZzstate", "Equip.ValRegistnr", "Equip.ValSequennr", "Equip.ValDesignat", "Equip.ValDtaquisi", "Equip.ValDtdeco", "Cmpny", "Cmpny.ValDesignat", "Equip.ValCodempre", "Equip.ValCoddeco", "Equip.ValCoditem", "Equip.ValCodpess1", "Equip.ValCodrooms", "Equip.ValCodtpequ", "Equip.ValCodwareh", "BtnPermission"
		];
