...
{
	public class STY_Menu_ACCORD_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "63f47415-010f-4c3a-890d-4d78a7386e11"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet sty_menu_accordConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLACCORD");
			sty_menu_accordConds.Equal(CSGenioAequip.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						sty_menu_accordConds.Equal(CSGenioAequip.FldShowrc, 1);
...
// USE /[MANUAL STY OVERRQ ACCORD]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(sty_menu_accordConds, listing);
...
// USE /[MANUAL STY OVERRQ ACCORD]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, sty_menu_accordConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLACCORD", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST ACCORD]/
					...
					ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, sty_menu_accordConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLACCORD", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<STY_Menu_ACCORD_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(STY_Menu_ACCORD_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = false;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM STY_MENU_ACCORD]/
		...
		[
			"Equip", "Equip.ValCodequip", "Equip.ValZzstate", "Cmpny", "Cmpny.ValDesignat", "Equip.ValSequennr", "Equip.ValRegistnr", "Tpequ", "Tpequ.ValTipoequi", "Equip.ValDesignat", "Equip.ValDtaquisi", "Equip.ValDtdeco", "Equip.ValSitefabr", "Equip.ValCodempre", "Equip.ValCoddeco", "Equip.ValCoditem", "Equip.ValCodpess1", "Equip.ValCodrooms", "Equip.ValCodtpequ", "Equip.ValCodwareh", "BtnPermission"
		];
