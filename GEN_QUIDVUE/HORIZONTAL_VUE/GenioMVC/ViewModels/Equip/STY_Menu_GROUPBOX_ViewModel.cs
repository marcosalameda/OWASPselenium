...
{
	public class STY_Menu_GROUPBOX_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<STY_Menu_GROUPBOX_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "4e9ccb50-3e83-46f4-b9ec-5040fa799e8f";
		...
		{
// USE /[MANUAL STY LIST_LIMITS GROUPBOX]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLGROUPBOX");
		...
		public STY_Menu_GROUPBOX_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="STY_Menu_GROUPBOX_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public STY_Menu_GROUPBOX_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public STY_Menu_GROUPBOX_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<STY_Menu_GROUPBOX_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAequip> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet sty_menu_groupboxConds = CriteriaSet.And();
			...
			conditions.SubSets.Add(sty_menu_groupboxConds);
			sty_menu_groupboxConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL STY OVERRQ GROUPBOX]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref sty_menu_groupboxConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLGROUPBOX", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST GROUPBOX]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAequip.GetInformation(), QMVC_POS_RECORD, sorts, sty_menu_groupboxConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAequip> listing = Models.ModelBase.Where<CSGenioAequip>(m_userContext, distinct, sty_menu_groupboxConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLGROUPBOX", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<STY_Menu_GROUPBOX_RowViewModel> MapSTY_Menu_GROUPBOX(ListingMVC<CSGenioAequip> Qlisting)
		{
			List<STY_Menu_GROUPBOX_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a STY_Menu_GROUPBOX_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private STY_Menu_GROUPBOX_RowViewModel MapSTY_Menu_GROUPBOX(CSGenioAequip row)
		{
			var model = new STY_Menu_GROUPBOX_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
