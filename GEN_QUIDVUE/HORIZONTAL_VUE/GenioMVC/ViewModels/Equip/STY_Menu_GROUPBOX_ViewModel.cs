...
// USE /[MANUAL STY OVERRQ GROUPBOX]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAequip>(m_userContext, false, sty_menu_groupboxConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLGROUPBOX", true, firstVisibleColumn: firstVisibleColumn);
