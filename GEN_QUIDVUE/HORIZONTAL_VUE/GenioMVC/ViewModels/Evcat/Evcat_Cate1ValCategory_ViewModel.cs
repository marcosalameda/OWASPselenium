...
{
	public class Evcat_Cate1ValCategoria_ViewModel : MenuListViewModel<Models.Cate1>
	{
		/// <summary>
		...
		public override string Uuid => "Evcat_Cate1ValCategoria";
...
// USE /[MANUAL GQT LIST_LIMITS EVCAT_CATE1CATEGORY]/
		...
		public Evcat_Cate1ValCategoria_ViewModel() : base(null!) { }
		...
		public Evcat_Cate1ValCategoria_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ EVCAT_CATE1CATEGORY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcate1>(m_userContext, false, ref evcat___cate1categoryConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EVCAT___CATE1CATEGORY", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST EVCAT_CATE1CATEGORY]/
				...
				ListingMVC<CSGenioAcate1> listing = Models.ModelBase.Where<CSGenioAcate1>(m_userContext, distinct, evcat___cate1categoryConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EVCAT___CATE1CATEGORY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<Evcat_Cate1ValCategoria_RowViewModel> Elements = [];
			int i = 0;
