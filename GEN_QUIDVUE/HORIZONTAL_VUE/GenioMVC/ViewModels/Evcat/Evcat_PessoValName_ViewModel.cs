...
// USE /[MANUAL GQT OVERRQ EVCAT_PESSONAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref evcat___pessoname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_EVCAT___PESSONAME____", true, firstVisibleColumn: firstVisibleColumn);
