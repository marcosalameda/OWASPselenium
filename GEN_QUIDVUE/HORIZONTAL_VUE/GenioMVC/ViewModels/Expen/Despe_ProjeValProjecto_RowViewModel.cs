...
public class Despe_ProjeValProjecto_RowViewModel : Models.Proje
{
	#region Constructors

	public Despe_ProjeValProjecto_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Despe_ProjeValProjecto_RowViewModel(UserContext userContext, CSGenioAproje val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
