...
{
	public class PTN_Menu_361_ViewModel : MenuListViewModel<Models.Expen>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<PTN_Menu_361_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "3612ebc8-c028-4cd6-b6af-3c0409fb81ba";
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 361]/
		...
		public PTN_Menu_361_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_361_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_361_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public PTN_Menu_361_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<PTN_Menu_361_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Expen.AddEPH<CSGenioAexpen>(ref u, crs, "ML361");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Expen.AddEPH<CSGenioAexpen>(ref u, null, "ML361"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAexpen> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet ptn_menu_361Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(ptn_menu_361Conds);
			ptn_menu_361Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ 361]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAexpen>(m_userContext, false, ref ptn_menu_361Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML361", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 361]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAexpen.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_361Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<PTN_Menu_361_RowViewModel> MapPTN_Menu_361(ListingMVC<CSGenioAexpen> Qlisting)
		{
			List<PTN_Menu_361_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a PTN_Menu_361_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_361_RowViewModel MapPTN_Menu_361(CSGenioAexpen row)
		{
			var model = new PTN_Menu_361_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
