...
{
	public class PTN_Menu_LIST_DB_MB_TR_ViewModel : MenuListViewModel<Models.Expen>
	{
		/// <summary>
		...
		public override string Uuid => "4d59767d-72c2-4fc8-afe5-1220c23dfd7b";
...
// USE /[MANUAL PTN LIST_LIMITS LIST_DB_MB_TR]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLLIST_DB_MB_TR");
		...
		public PTN_Menu_LIST_DB_MB_TR_ViewModel() : base(null!) { }
		...
		public PTN_Menu_LIST_DB_MB_TR_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ LIST_DB_MB_TR]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAexpen>(m_userContext, false, ref ptn_menu_list_db_mb_trConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MB_TR", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST LIST_DB_MB_TR]/
				...
				ListingMVC<CSGenioAexpen> listing = Models.ModelBase.Where<CSGenioAexpen>(m_userContext, distinct, ptn_menu_list_db_mb_trConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MB_TR", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_LIST_DB_MB_TR_RowViewModel> Elements = [];
			int i = 0;
