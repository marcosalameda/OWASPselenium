...
// USE /[MANUAL PTN OVERRQ LIST_DB_TR_F]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAexpen>(m_userContext, false, ptn_menu_list_db_tr_fConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_TR_F", true, firstVisibleColumn: firstVisibleColumn);
