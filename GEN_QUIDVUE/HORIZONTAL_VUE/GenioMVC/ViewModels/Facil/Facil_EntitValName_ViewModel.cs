...
{
	public class Facil_EntitValName_ViewModel : MenuListViewModel<Models.Entit>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Facil_EntitValName_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Facil_EntitValName";
...
// USE /[MANUAL GQT LIST_LIMITS FACIL_ENTITNAME]/
		...
		public Facil_EntitValName_ViewModel() : base(null!) { }
		...
		public Facil_EntitValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ FACIL_ENTITNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAentit>(m_userContext, false, ref facil___entitname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_FACIL___ENTITNAME____", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST FACIL_ENTITNAME]/
				...
				ListingMVC<CSGenioAentit> listing = Models.ModelBase.Where<CSGenioAentit>(m_userContext, distinct, facil___entitname____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_FACIL___ENTITNAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Facil_EntitValName_RowViewModel> MapFacil_EntitValName(ListingMVC<CSGenioAentit> Qlisting)
		{
			List<Facil_EntitValName_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Facil_EntitValName_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Facil_EntitValName_RowViewModel MapFacil_EntitValName(CSGenioAentit row)
		{
			var model = new Facil_EntitValName_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
