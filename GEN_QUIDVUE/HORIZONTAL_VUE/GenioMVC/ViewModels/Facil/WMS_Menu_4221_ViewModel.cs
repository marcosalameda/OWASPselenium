...
// USE /[MANUAL WMS OVERRQ 4221]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAfacil>(m_userContext, false, wms_menu_4221Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4221", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL WMS OVERRQLIST 4221]/
					...
					ListingMVC<CSGenioAfacil> listing = Models.ModelBase.Where<CSGenioAfacil>(m_userContext, false, wms_menu_4221Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4221", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<WMS_Menu_4221_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_4221_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_4221]/
		...
		[
			"Facil", "Facil.ValCodfacil", "Facil.ValZzstate", "Facil.ValImage", "Entit", "Entit.ValName", "Facil.ValIncorpor", "Facil.ValName", "Facty", "Facty.ValType", "Facil.ValAddress", "Facil.ValLatitude", "Facil.ValLongitud", "Facil.ValGeocoord", "Facil.ValCodcntry", "Facil.ValCodentit", "Facil.ValCodfacty", "BtnPermission"
		];
