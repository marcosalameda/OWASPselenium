...
// USE /[MANUAL WMS OVERRQ 4231]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAfacty>(m_userContext, false, ref wms_menu_4231Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4231", true, firstVisibleColumn: firstVisibleColumn);
