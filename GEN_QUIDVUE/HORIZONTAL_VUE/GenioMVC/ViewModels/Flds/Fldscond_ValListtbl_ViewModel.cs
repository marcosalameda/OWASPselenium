...
{
	public class Fldscond_ValListtbl_ViewModel : MenuListViewModel<Models.Feeca>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Fldscond_ValListtbl_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Fldscond_ValListtbl";
...
// USE /[MANUAL GQT LIST_LIMITS FLDSCOND_PSEUDLISTTBL]/
		...
		public Fldscond_ValListtbl_ViewModel() : base(null!) { }
		...
		public Fldscond_ValListtbl_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Fldscond_ValListtbl_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAfeeca> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet fldscondpseudlisttbl_Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(fldscondpseudlisttbl_Conds);
			fldscondpseudlisttbl_Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ FLDSCOND_PSEUDLISTTBL]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAfeeca>(m_userContext, false, ref fldscondpseudlisttbl_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_FLDSCONDPSEUDLISTTBL_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST FLDSCOND_PSEUDLISTTBL]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAfeeca.GetInformation(), QMVC_POS_RECORD, sorts, fldscondpseudlisttbl_Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<Fldscond_ValListtbl_RowViewModel> MapFldscond_ValListtbl(ListingMVC<CSGenioAfeeca> Qlisting)
		{
			List<Fldscond_ValListtbl_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Fldscond_ValListtbl_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Fldscond_ValListtbl_RowViewModel MapFldscond_ValListtbl(CSGenioAfeeca row)
		{
			var model = new Fldscond_ValListtbl_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
