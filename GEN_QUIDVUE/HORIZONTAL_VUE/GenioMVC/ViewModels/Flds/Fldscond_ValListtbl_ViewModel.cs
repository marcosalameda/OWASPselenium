...
// USE /[MANUAL GQT OVERRQ FLDSCOND_PSEUDLISTTBL]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAfeeca>(m_userContext, false, fldscondpseudlisttbl_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_FLDSCONDPSEUDLISTTBL_", true, firstVisibleColumn: firstVisibleColumn);
