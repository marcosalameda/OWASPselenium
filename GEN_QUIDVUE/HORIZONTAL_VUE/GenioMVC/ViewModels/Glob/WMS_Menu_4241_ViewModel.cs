...
// USE /[MANUAL WMS OVERRQ 4241]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAglob>(m_userContext, false, ref wms_menu_4241Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4241", true, firstVisibleColumn: firstVisibleColumn);
