...
// USE /[MANUAL PTN LIST_LIMITS EDITABLETABLELIST]/
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAgrpb> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("page_load_time", new System.Diagnostics.TagList([
                new("PageId", "PTN.EDITABLETABLELIST"),
                new("PageType", "menu")
...
// USE /[MANUAL PTN OVERRQ EDITABLETABLELIST]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAgrpb>(m_userContext, false, ptn_menu_editabletablelistConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLEDITABLETABLELIST", true, firstVisibleColumn: firstVisibleColumn);
