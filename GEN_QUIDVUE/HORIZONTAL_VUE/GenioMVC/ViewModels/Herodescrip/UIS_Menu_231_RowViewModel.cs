...
public class UIS_Menu_231_RowViewModel : Models.Herodescrip
{
	#region Constructors

	public UIS_Menu_231_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public UIS_Menu_231_RowViewModel(UserContext userContext, CSGenioAherodescrip val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
