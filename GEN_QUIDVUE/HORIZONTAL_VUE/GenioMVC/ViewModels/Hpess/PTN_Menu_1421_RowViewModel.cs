...
public class PTN_Menu_1421_RowViewModel : Models.Hpess
{
	#region Constructors

	public PTN_Menu_1421_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_1421_RowViewModel(UserContext userContext, CSGenioAhpess val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
