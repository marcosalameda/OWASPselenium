...
// USE /[MANUAL PTN OVERRQ 1421]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAhpess>(m_userContext, false, ref ptn_menu_1421Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1421", true, firstVisibleColumn: firstVisibleColumn);
