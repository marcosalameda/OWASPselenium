...
// USE /[MANUAL GQT OVERRQ DENTR_PSEUDENTRADAS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAldent>(m_userContext, false, ref dentr___pseudentradasConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_DENTR___PSEUDENTRADAS", true, firstVisibleColumn: firstVisibleColumn);
