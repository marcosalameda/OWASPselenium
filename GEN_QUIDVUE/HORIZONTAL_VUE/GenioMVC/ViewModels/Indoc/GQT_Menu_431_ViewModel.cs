...
// USE /[MANUAL GQT OVERRQ 431]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAindoc>(m_userContext, false, ref gqt_menu_431Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML431", true, firstVisibleColumn: firstVisibleColumn);
