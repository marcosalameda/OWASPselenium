...
namespace GenioMVC.ViewModels.Indoc
{
	public class GQT_Menu_431_ViewModel : ListViewModel
	{
		...
		public TablePartial<GQT_Menu_431_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_431Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML431");
			gqt_menu_431Conds.Equal(CSGenioAindoc.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 431]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_431Conds, listing);
		...
		public GQT_Menu_431_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_431_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAindoc> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet gqt_menu_431Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				conditions.SubSets.Add(gqt_menu_431Conds);
				gqt_menu_431Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 431]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAindoc>(m_userContext, false, gqt_menu_431Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML431", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 431]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAindoc.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_431Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAindoc> listing = Models.ModelBase.Where<CSGenioAindoc>(m_userContext, false, gqt_menu_431Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML431", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<GQT_Menu_431_RowViewModel> MapGQT_Menu_431(ListingMVC<CSGenioAindoc> Qlisting)
		{
			var Elements = new List<GQT_Menu_431_RowViewModel>();
			int i = 0;
		...
		/// to a GQT_Menu_431_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_431_RowViewModel MapGQT_Menu_431(CSGenioAindoc row)
		{
			var model = new GQT_Menu_431_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_431_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_431]/
		...
		[
			"Indoc", "Indoc.ValCoddentr", "Indoc.ValZzstate", "Indoc.ValDocumenr", "Indoc.ValDhdocume", "Ware1", "Ware1.ValWarehdes", "Indoc.ValCodempre", "Indoc.ValCodcntry", "Indoc.ValCodpesso", "Indoc.ValCodwareh", "BtnPermission"
		];
