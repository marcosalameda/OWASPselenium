...
// USE /[MANUAL GQT LIST_LIMITS INSTA_EQUIPREGISTNR]/
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAequip> Qlisting, ref CriteriaSet conditions)
		{
			...
			insta___equipregistnrConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ INSTA_EQUIPREGISTNR]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref insta___equipregistnrConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_INSTA___EQUIPREGISTNR", true, firstVisibleColumn: firstVisibleColumn);
