...
{
	public class STY_Menu_LEAFTLETDRAW_ViewModel : MenuListViewModel<Models.Insta>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<STY_Menu_LEAFTLETDRAW_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "5b5648c2-338b-4f0a-8b4e-33bb84218448";
...
// USE /[MANUAL STY LIST_LIMITS LEAFTLETDRAW]/
		...
		public STY_Menu_LEAFTLETDRAW_ViewModel() : base(null!) { }
		...
		public STY_Menu_LEAFTLETDRAW_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAinsta> Qlisting, ref CriteriaSet conditions)
		{
			...
			sty_menu_leaftletdrawConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL STY OVERRQ LEAFTLETDRAW]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAinsta>(m_userContext, false, ref sty_menu_leaftletdrawConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLEAFTLETDRAW", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST LEAFTLETDRAW]/
				...
				ListingMVC<CSGenioAinsta> listing = Models.ModelBase.Where<CSGenioAinsta>(m_userContext, distinct, sty_menu_leaftletdrawConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLEAFTLETDRAW", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<STY_Menu_LEAFTLETDRAW_RowViewModel> MapSTY_Menu_LEAFTLETDRAW(ListingMVC<CSGenioAinsta> Qlisting)
		{
			List<STY_Menu_LEAFTLETDRAW_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a STY_Menu_LEAFTLETDRAW_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private STY_Menu_LEAFTLETDRAW_RowViewModel MapSTY_Menu_LEAFTLETDRAW(CSGenioAinsta row)
		{
			var model = new STY_Menu_LEAFTLETDRAW_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
