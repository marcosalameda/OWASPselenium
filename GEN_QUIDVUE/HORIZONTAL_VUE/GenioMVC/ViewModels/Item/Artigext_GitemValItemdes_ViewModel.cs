...
// USE /[MANUAL GQT OVERRQ ARTIGEXT_GITEMITEMDES]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAgitem>(m_userContext, false, artigextgitemitemdes_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARTIGEXTGITEMITEMDES_", true, firstVisibleColumn: firstVisibleColumn);
