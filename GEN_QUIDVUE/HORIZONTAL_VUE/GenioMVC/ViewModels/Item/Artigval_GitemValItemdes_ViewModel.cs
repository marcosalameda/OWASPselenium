...
{
	public class Artigval_GitemValItemdes_ViewModel : MenuListViewModel<Models.Gitem>
	{
		/// <summary>
		...
		public override string Uuid => "Artigval_GitemValItemdes";
...
// USE /[MANUAL GQT LIST_LIMITS ARTIGVAL_GITEMITEMDES]/
		...
		public Artigval_GitemValItemdes_ViewModel() : base(null!) { }
		...
		public Artigval_GitemValItemdes_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ ARTIGVAL_GITEMITEMDES]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAgitem>(m_userContext, false, ref artigvalgitemitemdes_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARTIGVALGITEMITEMDES_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ARTIGVAL_GITEMITEMDES]/
		...
		{
			List<Artigval_GitemValItemdes_RowViewModel> Elements = [];
			int i = 0;
