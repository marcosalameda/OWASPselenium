...
public class Equip_item_WarehValWarehdes_RowViewModel : Models.Wareh
{
	#region Constructors

	public Equip_item_WarehValWarehdes_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Equip_item_WarehValWarehdes_RowViewModel(UserContext userContext, CSGenioAwareh val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
