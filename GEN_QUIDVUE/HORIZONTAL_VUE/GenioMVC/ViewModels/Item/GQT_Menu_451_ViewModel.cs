...
namespace GenioMVC.ViewModels.Item
{
	public class GQT_Menu_451_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_451Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML451");
			gqt_menu_451Conds.Equal(CSGenioAitem.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 451]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_451Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 451]/
					...
					ListingMVC<CSGenioAitem> listing = Models.ModelBase.Where<CSGenioAitem>(m_userContext, false, gqt_menu_451Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML451", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_451_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_451_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_451]/
		...
		[
			"Item", "Item.ValCoditem", "Item.ValZzstate", "Item.ValItemdes", "Item.ValItemcod", "Item.ValEntries", "Item.ValExits", "Item.ValExistenc", "Gitem", "Gitem.ValItemdes", "Wareh", "Wareh.ValWarehdes", "Item.ValImage", "Item.ValCategory", "Item.ValCodgitem", "Item.ValCodwareh", "BtnPermission"
		];
