...
// USE /[MANUAL GQT OVERRQ UNUSED_ITEMS]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAitem>(m_userContext, false, gqt_menu_unused_itemsConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLUNUSED_ITEMS", true, firstVisibleColumn: firstVisibleColumn);
