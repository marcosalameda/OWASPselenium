...
public class Item_GitemValItemdes_RowViewModel : Models.Gitem
{
	#region Constructors

	public Item_GitemValItemdes_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Item_GitemValItemdes_RowViewModel(UserContext userContext, CSGenioAgitem val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
