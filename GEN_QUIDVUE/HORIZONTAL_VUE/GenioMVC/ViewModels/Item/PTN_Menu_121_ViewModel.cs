...
{
	public class PTN_Menu_121_ViewModel : MenuListViewModel<Models.Item>
	{
		/// <summary>
		...
		public override string Uuid => "eb3397a7-f7a5-4956-8630-eb249d2c952a";
...
// USE /[MANUAL PTN LIST_LIMITS 121]/
		...
		public PTN_Menu_121_ViewModel() : base(null!) { }
		...
		public PTN_Menu_121_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 121]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAitem>(m_userContext, false, ref ptn_menu_121Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML121", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 121]/
				...
				ListingMVC<CSGenioAitem> listing = Models.ModelBase.Where<CSGenioAitem>(m_userContext, distinct, ptn_menu_121Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML121", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_121_RowViewModel> Elements = [];
			int i = 0;
