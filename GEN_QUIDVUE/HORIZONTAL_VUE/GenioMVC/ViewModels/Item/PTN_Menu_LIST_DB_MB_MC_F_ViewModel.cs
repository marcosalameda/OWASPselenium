...
namespace GenioMVC.ViewModels.Item
{
	public class PTN_Menu_LIST_DB_MB_MC_F_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_list_db_mb_mc_fConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLLIST_DB_MB_MC_F");
			ptn_menu_list_db_mb_mc_fConds.Equal(CSGenioAitem.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ LIST_DB_MB_MC_F]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_list_db_mb_mc_fConds, listing);
...
// USE /[MANUAL PTN OVERRQLIST LIST_DB_MB_MC_F]/
		...
		{
			var Elements = new List<PTN_Menu_LIST_DB_MB_MC_F_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_LIST_DB_MB_MC_F_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
