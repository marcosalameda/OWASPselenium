...
// USE /[MANUAL PTN OVERRQ LIST_DB_MB_MC_F]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAitem>(m_userContext, false, ref ptn_menu_list_db_mb_mc_fConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MB_MC_F", true, firstVisibleColumn: firstVisibleColumn);
