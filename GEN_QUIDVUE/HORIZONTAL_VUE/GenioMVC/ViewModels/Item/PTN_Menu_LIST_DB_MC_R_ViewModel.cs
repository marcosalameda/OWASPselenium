...
{
	public class PTN_Menu_LIST_DB_MC_R_ViewModel : MenuListViewModel<Models.Item>
	{
		/// <summary>
		...
		public override string Uuid => "e101ee50-17a2-4e6b-862d-f798f9598d98";
...
// USE /[MANUAL PTN LIST_LIMITS LIST_DB_MC_R]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLLIST_DB_MC_R");
		...
		public PTN_Menu_LIST_DB_MC_R_ViewModel() : base(null!) { }
		...
		public PTN_Menu_LIST_DB_MC_R_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ LIST_DB_MC_R]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAitem>(m_userContext, false, ref ptn_menu_list_db_mc_rConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DB_MC_R", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST LIST_DB_MC_R]/
		...
		{
			List<PTN_Menu_LIST_DB_MC_R_RowViewModel> Elements = [];
			int i = 0;
