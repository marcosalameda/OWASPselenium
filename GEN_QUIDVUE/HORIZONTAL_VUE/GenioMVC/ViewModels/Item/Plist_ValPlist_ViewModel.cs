...
// USE /[MANUAL GQT LIST_LIMITS PLIST_PSEUDPLIST]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAitemp> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAitemp> Qlisting, ref CriteriaSet conditions)
		{
			...
			]), "ms", "Time to load the page."))
			{
				...
				List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig.ColumnOrderBy, "itemp", allSortOrders);
...
// USE /[MANUAL GQT OVERRQ PLIST_PSEUDPLIST]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAitemp>(m_userContext, false, plist___pseudplist___Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PLIST___PSEUDPLIST___", true, firstVisibleColumn: firstVisibleColumn);
