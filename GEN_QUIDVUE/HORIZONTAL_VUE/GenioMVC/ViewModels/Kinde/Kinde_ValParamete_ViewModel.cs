...
{
	public class Kinde_ValParamete_ViewModel : MenuListViewModel<Models.Param>
	{
		/// <summary>
		...
		{
// USE /[MANUAL GQT LIST_LIMITS KINDE_PSEUDPARAMETE]/
		...
		public Kinde_ValParamete_ViewModel() : base(null!) { }
		...
		public Kinde_ValParamete_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST KINDE_PSEUDPARAMETE]/
		...
		{
			List<Kinde_ValParamete_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Kinde_ValParamete_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Kinde_ValParamete_RowViewModel MapKinde_ValParamete(CSGenioAparam row)
		{
			var model = new Kinde_ValParamete_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
