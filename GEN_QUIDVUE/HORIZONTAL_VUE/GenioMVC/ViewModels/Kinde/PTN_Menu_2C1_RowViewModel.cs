...
public class PTN_Menu_2C1_RowViewModel : Models.Kinde
{
	#region Constructors

	public PTN_Menu_2C1_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_2C1_RowViewModel(UserContext userContext, CSGenioAkinde val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
