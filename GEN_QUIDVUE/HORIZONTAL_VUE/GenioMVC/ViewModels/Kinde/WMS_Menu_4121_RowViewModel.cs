...
public class WMS_Menu_4121_RowViewModel : Models.Kinde
{
	#region Constructors

	public WMS_Menu_4121_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public WMS_Menu_4121_RowViewModel(UserContext userContext, CSGenioAkinde val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
