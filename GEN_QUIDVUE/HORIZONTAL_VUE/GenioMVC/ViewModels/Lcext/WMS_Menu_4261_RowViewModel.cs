...
public class WMS_Menu_4261_RowViewModel : Models.Lcext
{
	#region Constructors

	public WMS_Menu_4261_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public WMS_Menu_4261_RowViewModel(UserContext userContext, CSGenioAlcext val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
