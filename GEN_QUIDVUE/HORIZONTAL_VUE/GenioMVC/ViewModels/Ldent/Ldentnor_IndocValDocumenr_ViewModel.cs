...
// USE /[MANUAL GQT OVERRQ LDENTNOR_INDOCDOCUMENR]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAindoc>(m_userContext, false, ref ldentnorindocdocumenrConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LDENTNORINDOCDOCUMENR", true, firstVisibleColumn: firstVisibleColumn);
