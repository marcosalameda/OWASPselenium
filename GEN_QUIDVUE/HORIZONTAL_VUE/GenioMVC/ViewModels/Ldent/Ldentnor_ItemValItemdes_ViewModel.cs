...
// USE /[MANUAL GQT OVERRQ LDENTNOR_ITEMITEMDES]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAitem>(m_userContext, false, ref ldentnoritem_itemdes_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LDENTNORITEM_ITEMDES_", true, firstVisibleColumn: firstVisibleColumn);
