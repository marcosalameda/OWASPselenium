...
{
	public class GQT_Menu_1211_ViewModel : MenuListViewModel<Models.Lendi>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "15439473-a882-4d0e-8b4f-0677625fe691";
...
// USE /[MANUAL GQT LIST_LIMITS 1211]/
		...
		public GQT_Menu_1211_ViewModel() : base(null!) { }
		...
		public GQT_Menu_1211_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST 1211]/
					...
					ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, distinct, gqt_menu_1211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1211", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<GQT_Menu_1211_RowViewModel> Elements = [];
			int i = 0;
