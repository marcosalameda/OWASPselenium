...
{
	public class GQT_Menu_1211_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<GQT_Menu_1211_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid { get => "15439473-a882-4d0e-8b4f-0677625fe691"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_1211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML1211");
			gqt_menu_1211Conds.Equal(CSGenioAlendi.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

			
			AddHistoryLimit(gqt_menu_1211Conds, CSGenioAlendi.FldCodpess1, "user");


// USE /[MANUAL GQT OVERRQ 1211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_1211Conds, listing);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GQT_Menu_1211_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public GQT_Menu_1211_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<GQT_Menu_1211_RowViewModel>();
			...
			if (!tableConfig.StaticFilters.ContainsKey("filter_GQT_Menu_1211_DEVOLUCAO"))
				tableConfig.StaticFilters.Add("filter_GQT_Menu_1211_DEVOLUCAO", null);

			{
				var groupFilters = CriteriaSet.Or();
				bool filter_GQT_Menu_1211_DEVOLUCAO_1 = false;
				if (tableConfig.StaticFilters["filter_GQT_Menu_1211_DEVOLUCAO"] != null)
					filter_GQT_Menu_1211_DEVOLUCAO_1 = tableConfig.StaticFilters["filter_GQT_Menu_1211_DEVOLUCAO"].Contains("1");
				else if (tableConfig.StaticFilters["filter_GQT_Menu_1211_DEVOLUCAO"] == null)
				...
				bool filter_GQT_Menu_1211_DEVOLUCAO_2 = false;
				if (tableConfig.StaticFilters["filter_GQT_Menu_1211_DEVOLUCAO"] != null)
					filter_GQT_Menu_1211_DEVOLUCAO_2 = tableConfig.StaticFilters["filter_GQT_Menu_1211_DEVOLUCAO"].Contains("2");
				...
				if (tableConfig.StaticFilters["filter_GQT_Menu_1211_DEVOLUCAO"] != null)
					filter_GQT_Menu_1211_DEVOLUCAO_3 = tableConfig.StaticFilters["filter_GQT_Menu_1211_DEVOLUCAO"].Contains("3");
			...
			{
				// EPH
				crs = Models.Lendi.AddEPH<CSGenioAlendi>(ref u, crs, "ML1211");
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAlendi> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet gqt_menu_1211Conds = CriteriaSet.And();
	...
	//Tooltip for limit "HM" to area "PESS1" was ignored (unrelated to this viewmodel).
			//Limit type: "HM"
			//Current Area = "LENDI"
			...
			//1st Area Value: "user"
				...
				conditions.SubSets.Add(gqt_menu_1211Conds);
				gqt_menu_1211Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 1211]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, false, gqt_menu_1211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1211", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP 1211]/
				...
				if (tableReload)
				{
// USE /[MANUAL GQT OVERRQLIST 1211]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAlendi.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_1211Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, false, gqt_menu_1211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1211", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapGQT_Menu_1211(listing);
		...
		private List<GQT_Menu_1211_RowViewModel> MapGQT_Menu_1211(ListingMVC<CSGenioAlendi> Qlisting)
		{
			var Elements = new List<GQT_Menu_1211_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapGQT_Menu_1211(row));
					i++;
				}
			}
		...
		/// to a GQT_Menu_1211_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private GQT_Menu_1211_RowViewModel MapGQT_Menu_1211(CSGenioAlendi row)
		{
			var model = new GQT_Menu_1211_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_1211_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_1211]/
		#endregion

		private static readonly string[] _fieldsToSerialize =
		[
			"Lendi", "Lendi.ValCodlendi", "Lendi.ValZzstate", "Pess1", "Pess1.ValName", "Equip", "Equip.ValRegistnr", "Pess2", "Pess2.ValName", "Lendi.ValLendinnr", "Lendi.ValStart", "Equip.ValFrequenc", "Lendi.ValWarndt", "Lendi.ValEnd", "Lendi.ValObservat", "Lendi.ValReturndt", "Lendi.ValReturned", "Lendi.ValDayslimi", "Lendi.ValCodequip", "Lendi.ValCodpess1", "Lendi.ValCodpess2", "BtnPermission"
		];
