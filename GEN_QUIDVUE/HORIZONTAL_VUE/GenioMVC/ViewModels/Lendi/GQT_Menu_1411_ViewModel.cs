...
namespace GenioMVC.ViewModels.Lendi
{
	public class GQT_Menu_1411_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_1411Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML1411");
			gqt_menu_1411Conds.Equal(CSGenioAlendi.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 1411]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_1411Conds, listing);
