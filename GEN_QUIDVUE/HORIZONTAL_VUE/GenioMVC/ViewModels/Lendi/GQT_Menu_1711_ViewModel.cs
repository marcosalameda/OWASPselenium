...
namespace GenioMVC.ViewModels.Lendi
{
	public class GQT_Menu_1711_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_1711Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML1711");
			gqt_menu_1711Conds.Equal(CSGenioAlendi.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 1711]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_1711Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 1711]/
		...
		{
			var Elements = new List<GQT_Menu_1711_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_1711_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
