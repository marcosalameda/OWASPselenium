...
namespace GenioMVC.ViewModels.Lendi
{
	public class PTN_Menu_LIST_DM_MB_R_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_list_dm_mb_rConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLLIST_DM_MB_R");
			ptn_menu_list_dm_mb_rConds.Equal(CSGenioAlendi.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ LIST_DM_MB_R]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_list_dm_mb_rConds, listing);
...
// USE /[MANUAL PTN OVERRQLIST LIST_DM_MB_R]/
		...
		{
			var Elements = new List<PTN_Menu_LIST_DM_MB_R_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_LIST_DM_MB_R_RowViewModel model)
		{
			bool canView = false;
			bool canEdit = false;
