...
// USE /[MANUAL PTN OVERRQ LIST_DM_MB_R]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, false, ptn_menu_list_dm_mb_rConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DM_MB_R", true, firstVisibleColumn: firstVisibleColumn);
