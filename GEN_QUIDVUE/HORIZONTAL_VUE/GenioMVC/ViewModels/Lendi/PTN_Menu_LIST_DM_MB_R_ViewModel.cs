...
{
	public class PTN_Menu_LIST_DM_MB_R_ViewModel : MenuListViewModel<Models.Lendi>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<PTN_Menu_LIST_DM_MB_R_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "5e4e7e69-c5b2-478b-bb88-e077baaaf55b";
...
// USE /[MANUAL PTN LIST_LIMITS LIST_DM_MB_R]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLLIST_DM_MB_R");
		...
		public PTN_Menu_LIST_DM_MB_R_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_LIST_DM_MB_R_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_LIST_DM_MB_R_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public PTN_Menu_LIST_DM_MB_R_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<PTN_Menu_LIST_DM_MB_R_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAlendi> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet ptn_menu_list_dm_mb_rConds = CriteriaSet.And();
			...
			conditions.SubSets.Add(ptn_menu_list_dm_mb_rConds);
			ptn_menu_list_dm_mb_rConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ LIST_DM_MB_R]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlendi>(m_userContext, false, ref ptn_menu_list_dm_mb_rConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DM_MB_R", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST LIST_DM_MB_R]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAlendi.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_list_dm_mb_rConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAlendi> listing = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, distinct, ptn_menu_list_dm_mb_rConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLLIST_DM_MB_R", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<PTN_Menu_LIST_DM_MB_R_RowViewModel> MapPTN_Menu_LIST_DM_MB_R(ListingMVC<CSGenioAlendi> Qlisting)
		{
			List<PTN_Menu_LIST_DM_MB_R_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a PTN_Menu_LIST_DM_MB_R_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_LIST_DM_MB_R_RowViewModel MapPTN_Menu_LIST_DM_MB_R(CSGenioAlendi row)
		{
			var model = new PTN_Menu_LIST_DM_MB_R_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
