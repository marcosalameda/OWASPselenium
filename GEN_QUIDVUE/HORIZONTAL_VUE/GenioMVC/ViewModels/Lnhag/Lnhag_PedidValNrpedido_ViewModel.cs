...
{
	public class Lnhag_PedidValNrpedido_ViewModel : MenuListViewModel<Models.Pedid>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<Lnhag_PedidValNrpedido_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "Lnhag_PedidValNrpedido";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS LNHAG_PEDIDNRPEDIDO]/
		...
		public Lnhag_PedidValNrpedido_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Lnhag_PedidValNrpedido_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Lnhag_PedidValNrpedido_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Lnhag_PedidValNrpedido_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<Lnhag_PedidValNrpedido_RowViewModel>();
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApedid> Qlisting, ref CriteriaSet conditions)
		{
			...
			]), "ms", "Time to load the page."))
			{
				...
				conditions.SubSets.Add(lnhag___pedidnrpedidoConds);
				lnhag___pedidnrpedidoConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ LNHAG_PEDIDNRPEDIDO]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApedid>(m_userContext, false, lnhag___pedidnrpedidoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHAG___PEDIDNRPEDIDO", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST LNHAG_PEDIDNRPEDIDO]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApedid.GetInformation(), QMVC_POS_RECORD, sorts, lnhag___pedidnrpedidoConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioApedid> listing = Models.ModelBase.Where<CSGenioApedid>(m_userContext, distinct, lnhag___pedidnrpedidoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LNHAG___PEDIDNRPEDIDO", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Lnhag_PedidValNrpedido_RowViewModel> MapLnhag_PedidValNrpedido(ListingMVC<CSGenioApedid> Qlisting)
		{
			List<Lnhag_PedidValNrpedido_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Lnhag_PedidValNrpedido_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Lnhag_PedidValNrpedido_RowViewModel MapLnhag_PedidValNrpedido(CSGenioApedid row)
		{
			var model = new Lnhag_PedidValNrpedido_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
