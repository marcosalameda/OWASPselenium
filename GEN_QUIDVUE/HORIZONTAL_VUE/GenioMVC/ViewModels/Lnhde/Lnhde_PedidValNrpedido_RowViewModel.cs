...
public class Lnhde_PedidValNrpedido_RowViewModel : Models.Pedid
{
	#region Constructors

	public Lnhde_PedidValNrpedido_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Lnhde_PedidValNrpedido_RowViewModel(UserContext userContext, CSGenioApedid val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
