...
// USE /[MANUAL GQT OVERRQLIST LNHPD_PSEUDDESAGREG]/
		...
		{
			var Elements = new List<Lnhpd_ValDesagreg_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Lnhpd_ValDesagreg_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM LNHPD_VALDESAGREG]/
		...
		[
			"Lnhde", "Lnhde.ValCodlnhde", "Lnhde.ValZzstate", "Lnhde.ValOrdem", "Tpeq1", "Tpeq1.ValTipoequi", "Lnhde.ValQuantida", "Lnhde.ValDescript", "Lnhde.ValCode", "Lnhde.ValUrl", "Lnhde.ValCodlnhag", "Lnhde.ValCodlnhpd", "Lnhde.ValCodpedid", "Lnhde.ValCodtpequ", "BtnPermission"
		];
