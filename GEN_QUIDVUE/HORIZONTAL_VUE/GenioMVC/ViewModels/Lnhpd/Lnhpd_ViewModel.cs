...
// USE /[MANUAL GQT OVERRQ LNHPD_PEDIDNRPEDIDO]/
				...
				*/
				...
				TablePedidNrpedido.Elements = listing.RowsForViewModel<GenioMVC.Models.Pedid>((r) => new GenioMVC.Models.Pedid(m_userContext, r, true, _fieldsToSerialize_LNHPD___PEDIDNRPEDIDO));
...
// USE /[MANUAL GQT OVERRQ LNHPD_TPEQUTIPOEQUI]/
				...
				*/
				...
				TableTpequTipoequi.Elements = listing.RowsForViewModel<GenioMVC.Models.Tpequ>((r) => new GenioMVC.Models.Tpequ(m_userContext, r, true, _fieldsToSerialize_LNHPD___TPEQUTIPOEQUI));
