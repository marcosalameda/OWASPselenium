...
{
	public class Locat_EntitValName_ViewModel : MenuListViewModel<Models.Entit>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Locat_EntitValName_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Locat_EntitValName";
...
// USE /[MANUAL GQT LIST_LIMITS LOCAT_ENTITNAME]/
		...
		public Locat_EntitValName_ViewModel() : base(null!) { }
		...
		public Locat_EntitValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ LOCAT_ENTITNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAentit>(m_userContext, false, ref locat___entitname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LOCAT___ENTITNAME____", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST LOCAT_ENTITNAME]/
				...
				ListingMVC<CSGenioAentit> listing = Models.ModelBase.Where<CSGenioAentit>(m_userContext, distinct, locat___entitname____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LOCAT___ENTITNAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Locat_EntitValName_RowViewModel> MapLocat_EntitValName(ListingMVC<CSGenioAentit> Qlisting)
		{
			List<Locat_EntitValName_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Locat_EntitValName_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Locat_EntitValName_RowViewModel MapLocat_EntitValName(CSGenioAentit row)
		{
			var model = new Locat_EntitValName_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
