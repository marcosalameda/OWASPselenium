...
{
	public class Locat_FacilValName_ViewModel : MenuListViewModel<Models.Facil>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Locat_FacilValName_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Locat_FacilValName";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS LOCAT_FACILNAME]/
		...
		public Locat_FacilValName_ViewModel() : base(null!) { }
		...
		public Locat_FacilValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override List<Exports.QColumn> GetColumnsToExport()
		{
			return
			[
				new Exports.QColumn(CSGenioAfacil.FldName, FieldType.TEXT, Resources.Resources.FACILITY_NAME19514, 85, 0, true),
			];
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Locat_FacilValName_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAfacil> Qlisting, ref CriteriaSet conditions)
		{
			...
			locat___facilname____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ LOCAT_FACILNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAfacil>(m_userContext, false, ref locat___facilname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LOCAT___FACILNAME____", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP LOCAT_FACILNAME]/
			...
			if (tableReload)
			{
// USE /[MANUAL GQT OVERRQLIST LOCAT_FACILNAME]/
				...
				ListingMVC<CSGenioAfacil> listing = Models.ModelBase.Where<CSGenioAfacil>(m_userContext, distinct, locat___facilname____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LOCAT___FACILNAME____", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Locat_FacilValName_RowViewModel> MapLocat_FacilValName(ListingMVC<CSGenioAfacil> Qlisting)
		{
			List<Locat_FacilValName_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Locat_FacilValName_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Locat_FacilValName_RowViewModel MapLocat_FacilValName(CSGenioAfacil row)
		{
			var model = new Locat_FacilValName_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
