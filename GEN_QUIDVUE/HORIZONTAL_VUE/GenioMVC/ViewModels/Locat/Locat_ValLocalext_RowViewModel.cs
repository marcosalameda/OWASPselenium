...
public class Locat_ValLocalext_RowViewModel : Models.Lcext
{
	#region Constructors

	public Locat_ValLocalext_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Locat_ValLocalext_RowViewModel(UserContext userContext, CSGenioAlcext val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
