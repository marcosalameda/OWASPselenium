...
// USE /[MANUAL GQT OVERRQ LOCAT_PSEUDLOCALEXT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlcext>(m_userContext, false, ref locat___pseudlocalextConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LOCAT___PSEUDLOCALEXT", true, firstVisibleColumn: firstVisibleColumn);
