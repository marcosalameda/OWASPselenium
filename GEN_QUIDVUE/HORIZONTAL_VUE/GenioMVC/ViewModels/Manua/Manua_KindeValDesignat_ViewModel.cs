...
namespace GenioMVC.ViewModels.Manua
{
	public class Manua_KindeValDesignat_ViewModel : MenuListViewModel<Models.Kinde>
	{
		...
		{
// USE /[MANUAL GQT LIST_LIMITS MANUA_KINDEDESIGNAT]/
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAkinde> Qlisting, ref CriteriaSet conditions)
		{
			...
			]), "ms", "Time to load the page."))
			{
				...
				manua___kindedesignatConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQLSTEXP MANUA_KINDEDESIGNAT]/
				...
				if (tableReload)
				{
// USE /[MANUAL GQT OVERRQLIST MANUA_KINDEDESIGNAT]/
					...
					ListingMVC<CSGenioAkinde> listing = Models.ModelBase.Where<CSGenioAkinde>(m_userContext, distinct, manua___kindedesignatConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_MANUA___KINDEDESIGNAT", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
