...
public class UIS_Menu_41_RowViewModel : Models.Menuc
{
	#region Constructors

	public UIS_Menu_41_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public UIS_Menu_41_RowViewModel(UserContext userContext, CSGenioAmenuc val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
