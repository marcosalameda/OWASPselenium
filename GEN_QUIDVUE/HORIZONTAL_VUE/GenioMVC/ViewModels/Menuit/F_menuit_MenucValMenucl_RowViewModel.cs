...
public class F_menuit_MenucValMenucl_RowViewModel : Models.Menuc
{
	#region Constructors

	public F_menuit_MenucValMenucl_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public F_menuit_MenucValMenucl_RowViewModel(UserContext userContext, CSGenioAmenuc val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
