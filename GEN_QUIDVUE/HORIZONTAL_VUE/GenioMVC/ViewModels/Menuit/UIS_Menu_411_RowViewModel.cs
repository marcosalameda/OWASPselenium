...
public class UIS_Menu_411_RowViewModel : Models.Menuit
{
	#region Constructors

	public UIS_Menu_411_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public UIS_Menu_411_RowViewModel(UserContext userContext, CSGenioAmenuit val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
