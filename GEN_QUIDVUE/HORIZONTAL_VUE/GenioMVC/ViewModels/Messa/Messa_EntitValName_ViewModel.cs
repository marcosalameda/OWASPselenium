...
namespace GenioMVC.ViewModels.Messa
{
	public class Messa_EntitValName_ViewModel : MenuListViewModel<Models.Entit>
	{
		...
		{
// USE /[MANUAL GQT LIST_LIMITS MESSA_ENTITNAME]/
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAentit> Qlisting, ref CriteriaSet conditions)
		{
			...
			messa___entitname____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ MESSA_ENTITNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAentit>(m_userContext, false, ref messa___entitname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_MESSA___ENTITNAME____", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL GQT OVERRQLSTEXP MESSA_ENTITNAME]/
			...
			if (tableReload)
			{
// USE /[MANUAL GQT OVERRQLIST MESSA_ENTITNAME]/
