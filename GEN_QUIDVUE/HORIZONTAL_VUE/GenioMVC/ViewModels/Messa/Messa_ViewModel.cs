...
// USE /[MANUAL GQT OVERRQ MESSA_ENTITNAME]/
				...
				*/
				...
				TableEntitName.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Entit(m_userContext, r, true, _fieldsToSerialize_MESSA___ENTITNAME____));
...
// USE /[MANUAL GQT OVERRQ MESSA_PERSONAME]/
				...
				*/
				...
				TablePersoName.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Perso(m_userContext, r, true, _fieldsToSerialize_MESSA___PERSONAME____));
