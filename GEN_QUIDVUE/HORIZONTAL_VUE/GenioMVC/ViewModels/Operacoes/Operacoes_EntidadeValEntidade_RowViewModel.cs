...
public class Operacoes_EntidadeValEntidade_RowViewModel : Models.Entidade
{
	#region Constructors

	public Operacoes_EntidadeValEntidade_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Operacoes_EntidadeValEntidade_RowViewModel(UserContext userContext, CSGenioAentidade val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
