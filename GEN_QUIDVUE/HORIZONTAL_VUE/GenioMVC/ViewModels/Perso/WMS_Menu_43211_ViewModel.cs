...
namespace GenioMVC.ViewModels.Perso
{
	public class WMS_Menu_43211_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_43211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML43211");
			wms_menu_43211Conds.Equal(CSGenioAperso.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL WMS OVERRQ 43211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_43211Conds, listing);
...
// USE /[MANUAL WMS OVERRQLIST 43211]/
		...
		{
			var Elements = new List<WMS_Menu_43211_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_43211_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
