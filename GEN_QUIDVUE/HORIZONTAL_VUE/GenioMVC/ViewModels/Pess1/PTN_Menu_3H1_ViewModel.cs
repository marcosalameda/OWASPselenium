...
// USE /[MANUAL PTN OVERRQ 3H1]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApess1>(m_userContext, false, ptn_menu_3h1Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3H1", true, firstVisibleColumn: firstVisibleColumn);
