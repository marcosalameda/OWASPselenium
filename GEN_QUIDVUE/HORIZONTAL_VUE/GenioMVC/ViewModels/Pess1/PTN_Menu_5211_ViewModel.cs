...
namespace GenioMVC.ViewModels.Pess1
{
	public class PTN_Menu_5211_ViewModel : ListViewModel
	{
		...
		public TablePartial<PTN_Menu_5211_RowViewModel> Menu { get; set; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_5211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML5211");
			ptn_menu_5211Conds.Equal(CSGenioApess1.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ 5211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_5211Conds, listing);
		...
		public PTN_Menu_5211_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApess1> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet ptn_menu_5211Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				conditions.SubSets.Add(ptn_menu_5211Conds);
				ptn_menu_5211Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ 5211]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApess1>(m_userContext, false, ptn_menu_5211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5211", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 5211]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApess1.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_5211Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioApess1> listing = Models.ModelBase.Where<CSGenioApess1>(m_userContext, false, ptn_menu_5211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<PTN_Menu_5211_RowViewModel>();
			int i = 0;
		...
		/// to a PTN_Menu_5211_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_5211_RowViewModel MapPTN_Menu_5211(CSGenioApess1 row)
		{
			var model = new PTN_Menu_5211_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_5211_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
