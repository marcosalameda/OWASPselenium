...
{
	public class PTN_Menu_5221_ViewModel : MenuListViewModel<Models.Pess1>
	{
		/// <summary>
		...
		public override string Uuid => "40157e0a-8b62-4cb7-ab60-aac650c37731";
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 5221]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML5221");
		...
		public PTN_Menu_5221_ViewModel() : base(null!) { }
		...
		public PTN_Menu_5221_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 5221]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApess1>(m_userContext, false, ref ptn_menu_5221Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5221", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 5221]/
				...
				ListingMVC<CSGenioApess1> listing = Models.ModelBase.Where<CSGenioApess1>(m_userContext, distinct, ptn_menu_5221Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5221", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_5221_RowViewModel> Elements = [];
			int i = 0;
