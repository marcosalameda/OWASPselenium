...
// USE /[MANUAL PTN OVERRQ 5231]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApess1>(m_userContext, false, ptn_menu_5231Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML5231", true, firstVisibleColumn: firstVisibleColumn);
