...
{
	public class PTN_Menu_531_ViewModel : MenuListViewModel<Models.Pess1>
	{
		/// <summary>
		...
		public override string Uuid => "286009b7-3b38-48b9-b559-7115ee2c6521";
...
// USE /[MANUAL PTN LIST_LIMITS 531]/
		...
		public PTN_Menu_531_ViewModel() : base(null!) { }
		...
		public PTN_Menu_531_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 531]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApess1>(m_userContext, false, ref ptn_menu_531Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML531", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 531]/
				...
				ListingMVC<CSGenioApess1> listing = Models.ModelBase.Where<CSGenioApess1>(m_userContext, distinct, ptn_menu_531Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML531", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_531_RowViewModel> Elements = [];
			int i = 0;
