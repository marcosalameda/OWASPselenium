...
public class Pess1_StakeValDesignat_RowViewModel : Models.Stake
{
	#region Constructors

	public Pess1_StakeValDesignat_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Pess1_StakeValDesignat_RowViewModel(UserContext userContext, CSGenioAstake val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
