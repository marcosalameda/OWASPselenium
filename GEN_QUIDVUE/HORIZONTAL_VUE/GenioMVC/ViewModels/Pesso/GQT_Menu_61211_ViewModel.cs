...
namespace GenioMVC.ViewModels.Pesso
{
	public class GQT_Menu_61211_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_61211Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML61211");
			gqt_menu_61211Conds.Equal(CSGenioApesso.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

						gqt_menu_61211Conds.Equal(CSGenioApesso.FldGender, "M");
...
// USE /[MANUAL GQT OVERRQ 61211]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_61211Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 61211]/
					...
					ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, gqt_menu_61211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_61211_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_61211_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
