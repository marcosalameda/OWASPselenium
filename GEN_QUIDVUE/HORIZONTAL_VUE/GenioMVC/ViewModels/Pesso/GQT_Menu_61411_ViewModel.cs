...
// USE /[MANUAL GQT OVERRQ 61411]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref gqt_menu_61411Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61411", true, firstVisibleColumn: firstVisibleColumn);
