...
// USE /[MANUAL PTN OVERRQ 1411]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApesso>(m_userContext, false, ptn_menu_1411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1411", true, firstVisibleColumn: firstVisibleColumn);
