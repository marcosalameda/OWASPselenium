...
{
	public class PTN_Menu_3F111_ViewModel : MenuListViewModel<Models.Pesso>
	{
		/// <summary>
		...
		public override string Uuid => "bf8a79e9-5cec-4227-a76b-5d96785bc4ea";
...
// USE /[MANUAL PTN LIST_LIMITS 3F111]/
		...
		public PTN_Menu_3F111_ViewModel() : base(null!) { }
		...
		public PTN_Menu_3F111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQ 3F111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref ptn_menu_3f111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3F111", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3F111]/
				...
				ListingMVC<CSGenioApesso> listing = Models.ModelBase.Where<CSGenioApesso>(m_userContext, distinct, ptn_menu_3f111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3F111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_3F111_RowViewModel> Elements = [];
			int i = 0;
