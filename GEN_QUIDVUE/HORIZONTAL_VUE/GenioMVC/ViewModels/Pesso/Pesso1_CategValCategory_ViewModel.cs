...
// USE /[MANUAL GQT OVERRQ PESSO1_CATEGCATEGORY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcateg>(m_userContext, false, ref pesso1__categcategoryConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__CATEGCATEGORY", true, firstVisibleColumn: firstVisibleColumn);
