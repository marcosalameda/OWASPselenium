...
// USE /[MANUAL GQT OVERRQLIST PESSO1_CATEGCATEGORY]/
					...
					ListingMVC<CSGenioAcateg> listing = Models.ModelBase.Where<CSGenioAcateg>(m_userContext, false, pesso1__categcategoryConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__CATEGCATEGORY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<Pesso1_CategValCategoria_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Pesso1_CategValCategoria_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
