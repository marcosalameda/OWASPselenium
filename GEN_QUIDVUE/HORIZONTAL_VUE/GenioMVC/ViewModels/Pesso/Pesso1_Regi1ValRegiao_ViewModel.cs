...
// USE /[MANUAL GQT OVERRQ PESSO1_REGI1REGIAO]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAregi1>(m_userContext, false, pesso1__regi1regiao__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__REGI1REGIAO__", true, firstVisibleColumn: firstVisibleColumn);
