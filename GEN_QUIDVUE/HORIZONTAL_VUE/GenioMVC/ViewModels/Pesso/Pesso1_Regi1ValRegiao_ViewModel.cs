...
namespace GenioMVC.ViewModels.Pesso
{
	public class Pesso1_Regi1ValRegiao_ViewModel : MenuListViewModel<Models.Regi1>
	{
		...
		{
// USE /[MANUAL GQT LIST_LIMITS PESSO1_REGI1REGIAO]/
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAregi1> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(pesso1__regi1regiao__Conds);
			pesso1__regi1regiao__Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PESSO1_REGI1REGIAO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAregi1>(m_userContext, false, ref pesso1__regi1regiao__Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__REGI1REGIAO__", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PESSO1_REGI1REGIAO]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAregi1.GetInformation(), QMVC_POS_RECORD, sorts, pesso1__regi1regiao__Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAregi1> listing = Models.ModelBase.Where<CSGenioAregi1>(m_userContext, distinct, pesso1__regi1regiao__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO1__REGI1REGIAO__", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
