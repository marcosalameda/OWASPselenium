...
{
	public class Pesso1_ViewModel : FormViewModel<Models.Pesso>, IPreparableForSerialization
	{
		[JsonIgnore]
		...
		public string Pais1ValCountry 
		{
			get
			{
				return funcPais1ValCountry != null ? funcPais1ValCountry() : _auxPais1ValCountry;
			}
			set { funcPais1ValCountry = () => value; }
		}
		...
		public Pesso1_ViewModel() : base(null!) { }

		public Pesso1_ViewModel(UserContext userContext, bool nestedForm = false) : base(userContext, "FPESSO1", nestedForm) { }

		public Pesso1_ViewModel(UserContext userContext, Models.Pesso row, bool nestedForm = false) : base(userContext, "FPESSO1", row, nestedForm) { }

		public Pesso1_ViewModel(UserContext userContext, string id, bool nestedForm = false, string[]? fieldsToLoad = null) : this(userContext, nestedForm)
		{
			this.Navigation.SetValue("pesso", id);
			Model = Models.Pesso.Find(id, userContext, "FPESSO1", fieldsToQuery: fieldsToLoad);
			if (Model == null)
		...
		public static StatusMessage InsertConditions(UserContext userContext)
		{
			...
			Models.Pesso model = new Models.Pesso(userContext) { Identifier = "FPESSO1" };

			var navigation = m_userContext.CurrentNavigation;
			// The "LoadKeysFromHistory" must be after the "LoadEPH" because the PHE's in the tree mark Foreign Keys to null
			// (since they cannot assign multiple values to a single field) and thus the value that comes from Navigation is lost.
			// And this makes it more like the order of loading the model when opening the form.
			model.LoadEPH("FPESSO1");
			if (navigation != null)
		...
		public override void MapToModel(Models.Pesso m)
		{
			...
			{
				CSGenio.framework.Log.Error($"Map ViewModel (Pesso1) to Model (Pesso) - Error during mapping. All user values: {HasDisabledUserValuesSecurity}");
				throw;
			}
		}
			...
			try
			{
				...
				switch (fullFieldName)
				{
					...
					case "pesso.codpesso":
						...
						break;
					default:
						Log.Error($"SetViewModelValue (Pesso1) - Unexpected field identifier {fullFieldName}");
						break;
				}
			}
			catch (Exception ex)
			{
				throw new FrameworkException(Resources.Resources.PEDIMOS_DESCULPA__OC63848, "SetViewModelValue (Pesso1)", "Unexpected error", ex);
			}
		}
		...
		{
			try { Model = Models.Pesso.Find(id ?? Navigation.GetStrValue("pesso"), m_userContext, "FPESSO1"); }
			finally { Model ??= new Models.Pesso(m_userContext) { Identifier = "FPESSO1" }; }
		...
		public override void Load(NameValueCollection qs, bool editable, bool ajaxRequest = false, bool lazyLoad = false)
		{
			...
			try
			{
				Model = Models.Pesso.Find(Navigation.GetStrValue("pesso"), m_userContext, "FPESSO1");
			}
			finally
			{
				if (Model == null)
		...
		public override void LoadPartial(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			if (Model == null)
			{
				...
				if (Model == null)
				{
					Model = new Models.Pesso(m_userContext) { Identifier = "FPESSO1" };
			...
			this.ValGender = Navigation.GetValue<string>("pesso.gender");
...
// USE /[MANUAL GQT VIEWMODEL_NEW PESSO1]/
		...
		public override CrudViewModelValidationResult Validate()
		{
			...
			validator.StringLength("Pais1ValCountry", Resources.Resources.COUNTRY64133, Pais1ValCountry, 90);
...
// USE /[MANUAL GQT VIEWMODEL_DESTROY PESSO1]/
		...
		{
			Model = Models.Pesso.Find(id, m_userContext, "FPESSO1");
			if (Model == null)
				throw new ModelNotFoundException("Model not found");
		...
		public void Load_Pesso1__categcategory(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			CriteriaSet pesso1__categcategoryConds = CriteriaSet.And();
			{
				...
				{
					pesso1__categcategoryConds.Equal(CSGenioAcateg.FldCodcateg, hValue);
...
// USE /[MANUAL GQT OVERRQ PESSO1_CATEGCATEGORY]/
				...
				*/
				...
				ListingMVC<CSGenioAcateg> listing = Models.ModelBase.Where<CSGenioAcateg>(m_userContext, false, pesso1__categcategoryConds, fields, offset, numberItems, sorts, "LED_PESSO1__CATEGCATEGORY", true, false, firstVisibleColumn: firstVisibleColumn);
				...
				TableCategCategory.Elements = listing.RowsForViewModel<GenioMVC.Models.Categ>((r) => new GenioMVC.Models.Categ(m_userContext, r, true, _fieldsToSerialize_PESSO1__CATEGCATEGORY));
		...
		public ConcurrentDictionary<string, object> GetDependant_Pesso1TableCategCategory(string PKey)
		{
		...
		{
			var row = GetDependant_Pesso1TableCategCategory(this.ValCodcateg);
			try
			{
		...
		public void Load_Pesso1__cmpnydesignat(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			CriteriaSet pesso1__cmpnydesignatConds = CriteriaSet.And();
			{
				...
				if (hValue != null && !(hValue is Array) && !string.IsNullOrEmpty(Convert.ToString(hValue)))
				{
					pesso1__cmpnydesignatConds.Equal(CSGenioAcmpny.FldCodempre, hValue);
...
// USE /[MANUAL GQT OVERRQ PESSO1_CMPNYDESIGNAT]/
				...
				*/
				...
				ListingMVC<CSGenioAcmpny> listing = Models.ModelBase.Where<CSGenioAcmpny>(m_userContext, false, pesso1__cmpnydesignatConds, fields, offset, numberItems, sorts, "LED_PESSO1__CMPNYDESIGNAT", true, false, firstVisibleColumn: firstVisibleColumn);
				...
				TableCmpnyDesignat.Elements = listing.RowsForViewModel<GenioMVC.Models.Cmpny>((r) => new GenioMVC.Models.Cmpny(m_userContext, r, true, _fieldsToSerialize_PESSO1__CMPNYDESIGNAT));
		...
		public ConcurrentDictionary<string, object> GetDependant_Pesso1TableCmpnyDesignat(string PKey)
		{
			FieldRef[] refDependantFields = [CSGenioAcmpny.FldCodempre, CSGenioAcmpny.FldDesignat, CSGenioAcntry.FldCodcntry, CSGenioAcntry.FldCountry];
		...
		{
			var row = GetDependant_Pesso1TableCmpnyDesignat(this.ValCodempre);
			try
			{
		...
		public void Load_Pesso1__regi1regiao__(NameValueCollection qs, bool lazyLoad = false)
		{
			...
			CriteriaSet pesso1__regi1regiao__Conds = CriteriaSet.And();
			{
				...
				if (hValue != null && !(hValue is Array) && !string.IsNullOrEmpty(Convert.ToString(hValue)))
				{
					pesso1__regi1regiao__Conds.Equal(CSGenioAregi1.FldCodregia, hValue);
...
// USE /[MANUAL GQT OVERRQ PESSO1_REGI1REGIAO]/
				...
				*/
				...
				ListingMVC<CSGenioAregi1> listing = Models.ModelBase.Where<CSGenioAregi1>(m_userContext, false, pesso1__regi1regiao__Conds, fields, offset, numberItems, sorts, "LED_PESSO1__REGI1REGIAO__", true, false, firstVisibleColumn: firstVisibleColumn);
				...
				TableRegi1Regiao.Elements = listing.RowsForViewModel<GenioMVC.Models.Regi1>((r) => new GenioMVC.Models.Regi1(m_userContext, r, true, _fieldsToSerialize_PESSO1__REGI1REGIAO__));
		...
		public ConcurrentDictionary<string, object> GetDependant_Pesso1TableRegi1Regiao(string PKey)
		{
			FieldRef[] refDependantFields = [CSGenioAregi1.FldCodregia, CSGenioAregi1.FldRegiao, CSGenioApais1.FldCodcntry, CSGenioApais1.FldCountry];
		...
		{
			var row = GetDependant_Pesso1TableRegi1Regiao(this.ValCodregia);
			try
			{
				this.ValCodcntry = (string)row["pais1.codcntry"];
				this.funcPais1ValCountry = () => (string)row["pais1.country"];
