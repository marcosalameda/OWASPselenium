...
// USE /[MANUAL GQT LIST_LIMITS PESSO_REGI1REGIAO]/
		...
		public void LoadToExport(out ListingMVC<CSGenioAregi1> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAregi1> Qlisting, ref CriteriaSet conditions)
		{
			...
			]), "ms", "Time to load the page."))
			{
				...
				List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig.ColumnOrderBy, "regi1", allSortOrders);
...
// USE /[MANUAL GQT OVERRQ PESSO_REGI1REGIAO]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAregi1>(m_userContext, false, pesso___regi1regiao__Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO___REGI1REGIAO__", true, firstVisibleColumn: firstVisibleColumn);
