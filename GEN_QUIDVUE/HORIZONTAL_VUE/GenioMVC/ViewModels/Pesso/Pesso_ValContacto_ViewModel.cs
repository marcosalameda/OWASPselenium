...
// USE /[MANUAL GQT OVERRQ PESSO_PSEUDCONTACTO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAconta>(m_userContext, false, ref pesso___pseudcontactoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSO___PSEUDCONTACTO", true, firstVisibleColumn: firstVisibleColumn);
