...
// USE /[MANUAL GQT OVERRQLIST PESSO_PSEUDESPECITL]/
		...
		{
			var Elements = new List<Pesso_ValEspecitl_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Pesso_ValEspecitl_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PESSO_VALESPECITL]/
		...
		[
			"Esppe", "Esppe.ValCodesppe", "Esppe.ValZzstate", "Speci", "Speci.ValEspecial", "Speci.ValAreatecn", "Esppe.ValCodpesso", "Esppe.ValCodespec", "BtnPermission"
		];
