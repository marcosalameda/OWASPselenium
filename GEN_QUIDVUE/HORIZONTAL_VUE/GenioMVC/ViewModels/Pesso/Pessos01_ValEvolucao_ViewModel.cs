...
{
	public class Pessos01_ValEvolucao_ViewModel : MenuListViewModel<Models.Evcat>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Pessos01_ValEvolucao_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Pessos01_ValEvolucao";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS PESSOS01_PSEUDEVOLUCAO]/
		...
		public Pessos01_ValEvolucao_ViewModel() : base(null!) { }
		...
		public Pessos01_ValEvolucao_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Pessos01_ValEvolucao_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAevcat> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet pessos01pseudevolucaoConds = CriteriaSet.And();
			...
			conditions.SubSets.Add(pessos01pseudevolucaoConds);
			pessos01pseudevolucaoConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ PESSOS01_PSEUDEVOLUCAO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAevcat>(m_userContext, false, ref pessos01pseudevolucaoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSOS01PSEUDEVOLUCAO", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST PESSOS01_PSEUDEVOLUCAO]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAevcat.GetInformation(), QMVC_POS_RECORD, sorts, pessos01pseudevolucaoConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
		...
		private List<Pessos01_ValEvolucao_RowViewModel> MapPessos01_ValEvolucao(ListingMVC<CSGenioAevcat> Qlisting)
		{
			List<Pessos01_ValEvolucao_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Pessos01_ValEvolucao_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Pessos01_ValEvolucao_RowViewModel MapPessos01_ValEvolucao(CSGenioAevcat row)
		{
			var model = new Pessos01_ValEvolucao_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
