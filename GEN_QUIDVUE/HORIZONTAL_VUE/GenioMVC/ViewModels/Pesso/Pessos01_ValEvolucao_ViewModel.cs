...
// USE /[MANUAL GQT OVERRQ PESSOS01_PSEUDEVOLUCAO]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAevcat>(m_userContext, false, pessos01pseudevolucaoConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PESSOS01PSEUDEVOLUCAO", true, firstVisibleColumn: firstVisibleColumn);
