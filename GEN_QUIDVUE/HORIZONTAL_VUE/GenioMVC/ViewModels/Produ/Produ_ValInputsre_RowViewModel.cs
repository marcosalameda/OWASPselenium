...
public class Produ_ValInputsre_RowViewModel : Models.Relin
{
	#region Constructors

	public Produ_ValInputsre_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Produ_ValInputsre_RowViewModel(UserContext userContext, CSGenioArelin val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
