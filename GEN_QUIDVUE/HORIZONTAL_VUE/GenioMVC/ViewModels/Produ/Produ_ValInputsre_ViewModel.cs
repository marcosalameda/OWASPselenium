...
// USE /[MANUAL GQT OVERRQLIST PRODU_PSEUDINPUTSRE]/
		...
		{
			var Elements = new List<Produ_ValInputsre_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Produ_ValInputsre_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PRODU_VALINPUTSRE]/
		...
		[
			"Relin", "Relin.ValCoddilin", "Relin.ValZzstate", "Relin.ValInstant", "Recei", "Recei.ValNumber", "Entit", "Entit.ValName", "Relin.ValLinenumb", "Relin.ValOrdered", "Relin.ValReceived", "Relin.ValOutstand", "Relin.ValCodentit", "Relin.ValCodprodu", "Relin.ValCodrecei", "BtnPermission"
		];
