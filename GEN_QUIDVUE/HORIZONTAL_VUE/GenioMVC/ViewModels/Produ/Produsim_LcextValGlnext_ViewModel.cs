...
// USE /[MANUAL GQT OVERRQ PRODUSIM_LCEXTGLNEXT]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAlcext>(m_userContext, false, ref produsimlcextglnext__Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PRODUSIMLCEXTGLNEXT__", true, firstVisibleColumn: firstVisibleColumn);
