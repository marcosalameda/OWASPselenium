...
{
	public class WMS_Menu_311_ViewModel : MenuListViewModel<Models.Produ>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<WMS_Menu_311_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "92697297-35db-4e66-a7dc-b3b9b29febb5";
		...
		{
// USE /[MANUAL WMS LIST_LIMITS 311]/
		...
		public WMS_Menu_311_ViewModel() : base(null!) { }
		...
		public WMS_Menu_311_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void LoadToExport(out ListingMVC<CSGenioAprodu> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<WMS_Menu_311_RowViewModel>();
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAprodu> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<WMS_Menu_311_RowViewModel>();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "produ", allSortOrders);
			...
			wms_menu_311Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQ 311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprodu>(m_userContext, false, ref wms_menu_311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML311", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL WMS OVERRQLIST 311]/
		...
		private List<WMS_Menu_311_RowViewModel> MapWMS_Menu_311(ListingMVC<CSGenioAprodu> Qlisting)
		{
			List<WMS_Menu_311_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a WMS_Menu_311_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private WMS_Menu_311_RowViewModel MapWMS_Menu_311(CSGenioAprodu row)
		{
			var model = new WMS_Menu_311_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_311]/
		...
		protected void SetTicketToImageFields(Models.Produ row)
		{
			...
			row.ValImageQTicket = Helpers.Helpers.GetFileTicket(m_userContext.User, CSGenio.business.Area.AreaPRODU, CSGenioAprodu.FldImage.Field, null, row.ValCodprodu);
		}
	}
}
