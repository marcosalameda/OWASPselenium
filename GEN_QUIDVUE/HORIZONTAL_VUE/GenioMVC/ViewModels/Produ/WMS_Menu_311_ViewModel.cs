...
namespace GenioMVC.ViewModels.Produ
{
	public class WMS_Menu_311_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_311Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML311");
			wms_menu_311Conds.Equal(CSGenioAprodu.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL WMS OVERRQ 311]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_311Conds, listing);
...
// USE /[MANUAL WMS OVERRQLIST 311]/
		...
		{
			var Elements = new List<WMS_Menu_311_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_311_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
