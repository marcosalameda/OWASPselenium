...
{
	public class Prope05_CityValCity_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Prope05_CityValCity"; }
...
// USE /[MANUAL GQT OVERRQLIST PROPE05_CITY]/
		...
		{
			var Elements = new List<Prope05_CityValCity_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(Prope05_CityValCity_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
