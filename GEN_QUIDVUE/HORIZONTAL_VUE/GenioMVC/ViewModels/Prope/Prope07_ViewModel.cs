...
// USE /[MANUAL GQT OVERRQ PROPE07_CITYCITY]/
				...
				*/
				...
				TableCityCity.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.City(m_userContext, r, true, _fieldsToSerialize_PROPE07_CITY_CITY____));
...
// USE /[MANUAL GQT OVERRQ PROPE07_AGENTNAME]/
				...
				*/
				...
				TableAgentName.Elements = listing.RowsForViewModel((r) => new GenioMVC.Models.Agent(m_userContext, r, true, _fieldsToSerialize_PROPE07_AGENTNAME____));
