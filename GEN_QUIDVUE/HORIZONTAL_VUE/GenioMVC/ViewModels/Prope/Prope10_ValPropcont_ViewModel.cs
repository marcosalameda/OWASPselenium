...
// USE /[MANUAL GQT OVERRQ PROPE10_PSEUDPROPCONT]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAprocn>(m_userContext, false, prope10_pseudpropcontConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE10_PSEUDPROPCONT", true, firstVisibleColumn: firstVisibleColumn);
