...
// USE /[MANUAL GQT OVERRQ PROPE11_AGENTNAME]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAagent>(m_userContext, false, prope11_agentname____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE11_AGENTNAME____", true, firstVisibleColumn: firstVisibleColumn);
