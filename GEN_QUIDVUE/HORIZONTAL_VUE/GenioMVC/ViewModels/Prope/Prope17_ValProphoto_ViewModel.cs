...
// USE /[MANUAL GQT OVERRQ PROPE17_PSEUDPROPHOTO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAproph>(m_userContext, false, ref prope17_pseudprophotoConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE17_PSEUDPROPHOTO", true, firstVisibleColumn: firstVisibleColumn);
