...
// USE /[MANUAL GQT OVERRQ PROPE19_AGENTNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAagent>(m_userContext, false, ref prope19_agentname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE19_AGENTNAME____", true, firstVisibleColumn: firstVisibleColumn);
