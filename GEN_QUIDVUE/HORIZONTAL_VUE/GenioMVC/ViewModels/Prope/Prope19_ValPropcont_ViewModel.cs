...
// USE /[MANUAL GQT OVERRQ PROPE19_PSEUDPROPCONT]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAprocn>(m_userContext, false, prope19_pseudpropcontConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPE19_PSEUDPROPCONT", true, firstVisibleColumn: firstVisibleColumn);
