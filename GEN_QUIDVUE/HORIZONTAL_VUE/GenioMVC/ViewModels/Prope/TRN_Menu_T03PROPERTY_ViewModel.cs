...
{
	public class TRN_Menu_T03PROPERTY_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<TRN_Menu_T03PROPERTY_RowViewModel> Menu { get; set; }

		/// <inheritdoc/>
		public override string TableAlias { get => "prope"; }

		/// <inheritdoc/>
		public override string Uuid { get => "bae15f01-1d2b-4cd3-b5ec-656e55918060"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet trn_menu_t03propertyConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT03PROPERTY");
			trn_menu_t03propertyConds.Equal(CSGenioAprope.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL TRN OVERRQ T03PROPERTY]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(trn_menu_t03propertyConds, listing);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TRN_Menu_T03PROPERTY_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public TRN_Menu_T03PROPERTY_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<TRN_Menu_T03PROPERTY_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Prope.AddEPH<CSGenioAprope>(ref u, crs, "MLT03PROPERTY");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Prope.AddEPH<CSGenioAprope>(ref u, null, "MLT03PROPERTY"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAprope> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet trn_menu_t03propertyConds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "MLT03PROPERTY");
				...
				conditions.SubSets.Add(trn_menu_t03propertyConds);
				trn_menu_t03propertyConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL TRN OVERRQ T03PROPERTY]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAprope>(m_userContext, false, trn_menu_t03propertyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT03PROPERTY", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL TRN OVERRQLSTEXP T03PROPERTY]/
				...
				if (tableReload)
				{
// USE /[MANUAL TRN OVERRQLIST T03PROPERTY]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAprope.GetInformation(), QMVC_POS_RECORD, sorts, trn_menu_t03propertyConds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
					...
					Menu.Elements = MapTRN_Menu_T03PROPERTY(listing);

					Menu.Identifier = "MLT03PROPERTY";
					Menu.Slots = new Dictionary<string, List<object>>();

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "MLT03PROPERTY";
		...
		private List<TRN_Menu_T03PROPERTY_RowViewModel> MapTRN_Menu_T03PROPERTY(ListingMVC<CSGenioAprope> Qlisting)
		{
			var Elements = new List<TRN_Menu_T03PROPERTY_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapTRN_Menu_T03PROPERTY(row));
					i++;
				}
			}
		...
		/// to a TRN_Menu_T03PROPERTY_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private TRN_Menu_T03PROPERTY_RowViewModel MapTRN_Menu_T03PROPERTY(CSGenioAprope row)
		{
			var model = new TRN_Menu_T03PROPERTY_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T03PROPERTY_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T03PROPERTY]/
		#endregion
