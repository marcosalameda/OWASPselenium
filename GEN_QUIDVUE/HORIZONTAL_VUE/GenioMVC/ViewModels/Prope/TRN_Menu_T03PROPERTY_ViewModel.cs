...
{
	public class TRN_Menu_T03PROPERTY_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		...
		public override string Uuid => "bae15f01-1d2b-4cd3-b5ec-656e55918060";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T03PROPERTY]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT03PROPERTY");
		...
		public TRN_Menu_T03PROPERTY_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T03PROPERTY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T03PROPERTY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref trn_menu_t03propertyConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT03PROPERTY", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T03PROPERTY]/
		...
		{
			List<TRN_Menu_T03PROPERTY_RowViewModel> Elements = [];
			int i = 0;
