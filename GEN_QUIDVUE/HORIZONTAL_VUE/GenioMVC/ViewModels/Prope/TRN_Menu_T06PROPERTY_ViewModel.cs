...
{
	public class TRN_Menu_T06PROPERTY_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		...
		public override string Uuid => "3c303aa1-f3f3-4ad9-be36-59fd570f59a3";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T06PROPERTY]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT06PROPERTY");
		...
		public TRN_Menu_T06PROPERTY_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T06PROPERTY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T06PROPERTY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref trn_menu_t06propertyConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT06PROPERTY", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T06PROPERTY]/
				...
				ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, distinct, trn_menu_t06propertyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT06PROPERTY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T06PROPERTY_RowViewModel> Elements = [];
			int i = 0;
