...
{
	public class TRN_Menu_T11PROPERTY_ViewModel : MenuListViewModel<Models.Prope>
	{
		/// <summary>
		...
		public override string Uuid => "4e521a19-ad3d-40e5-a2f4-665be4e167f0";
		...
		{
// USE /[MANUAL TRN LIST_LIMITS T11PROPERTY]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT11PROPERTY");
		...
		public TRN_Menu_T11PROPERTY_ViewModel() : base(null!) { }
		...
		public TRN_Menu_T11PROPERTY_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL TRN OVERRQ T11PROPERTY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAprope>(m_userContext, false, ref trn_menu_t11propertyConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT11PROPERTY", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T11PROPERTY]/
				...
				ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, distinct, trn_menu_t11propertyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT11PROPERTY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<TRN_Menu_T11PROPERTY_RowViewModel> Elements = [];
			int i = 0;
