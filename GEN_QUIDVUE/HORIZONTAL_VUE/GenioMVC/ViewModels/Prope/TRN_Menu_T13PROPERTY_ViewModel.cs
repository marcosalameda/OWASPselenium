...
// USE /[MANUAL TRN OVERRQ T13PROPERTY]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAprope>(m_userContext, false, trn_menu_t13propertyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT13PROPERTY", true, firstVisibleColumn: firstVisibleColumn);
