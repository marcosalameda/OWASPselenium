...
// USE /[MANUAL TRN OVERRQ T15PROPERTY]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAprope>(m_userContext, false, trn_menu_t15propertyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT15PROPERTY", true, firstVisibleColumn: firstVisibleColumn);
