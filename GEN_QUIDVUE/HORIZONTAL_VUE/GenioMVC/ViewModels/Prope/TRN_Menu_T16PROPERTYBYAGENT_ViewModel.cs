...
{
	public class TRN_Menu_T16PROPERTYBYAGENT_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "df72deae-d982-44c0-9ea8-ffe3693fabc3"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet trn_menu_t16propertybyagentConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT16PROPERTYBYAGENT");
			trn_menu_t16propertybyagentConds.Equal(CSGenioAprope.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL TRN OVERRQ T16PROPERTYBYAGENT]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(trn_menu_t16propertybyagentConds, listing);
...
// USE /[MANUAL TRN OVERRQ T16PROPERTYBYAGENT]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAprope>(m_userContext, false, trn_menu_t16propertybyagentConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT16PROPERTYBYAGENT", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRN OVERRQLIST T16PROPERTYBYAGENT]/
					...
					ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, false, trn_menu_t16propertybyagentConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT16PROPERTYBYAGENT", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<TRN_Menu_T16PROPERTYBYAGENT_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T16PROPERTYBYAGENT_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T16PROPERTYBYAGENT]/
		...
		[
			"Prope", "Prope.ValCodprope", "Prope.ValZzstate", "Prope.ValTitle", "Prope.ValPrice", "Prope.ValPhoto", "Agent", "Agent.ValName", "Prope.ValSize", "Prope.ValBathrms", "Prope.ValYear", "Prope.ValDescript", "City", "City.ValCity", "Prope.ValBuildtyp", "Prope.ValTypology", "Prope.ValCodagent", "Prope.ValCodcity", "BtnPermission"
		];
