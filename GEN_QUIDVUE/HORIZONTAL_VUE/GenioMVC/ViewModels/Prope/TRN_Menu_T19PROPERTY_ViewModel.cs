...
{
	public class TRN_Menu_T19PROPERTY_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "c95ccfe6-3b62-4e44-91b5-55b24c2e14cd"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet trn_menu_t19propertyConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLT19PROPERTY");
			trn_menu_t19propertyConds.Equal(CSGenioAprope.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL TRN OVERRQ T19PROPERTY]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(trn_menu_t19propertyConds, listing);
...
// USE /[MANUAL TRN OVERRQLIST T19PROPERTY]/
					...
					ListingMVC<CSGenioAprope> listing = Models.ModelBase.Where<CSGenioAprope>(m_userContext, false, trn_menu_t19propertyConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLT19PROPERTY", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<TRN_Menu_T19PROPERTY_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T19PROPERTY_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
