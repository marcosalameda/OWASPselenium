...
{
	public class TRN_Menu_T03PHOTOS_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "1b922be3-3c02-481c-9ecb-b4436e31b7df"; }
...
// USE /[MANUAL TRN OVERRQLIST T03PHOTOS]/
		...
		{
			var Elements = new List<TRN_Menu_T03PHOTOS_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(TRN_Menu_T03PHOTOS_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM TRN_MENU_T03PHOTOS]/
		...
		[
			"Proph", "Proph.ValCodproph", "Proph.ValZzstate", "Proph.ValPhoto", "Proph.ValTitle", "Prope", "Prope.ValTitle", "Proph.ValCodprope", "BtnPermission"
		];
