...
{
	public class IMO_Menu_1311_ViewModel : MenuListViewModel<Models.Propr>
	{
		/// <summary>
		...
		public override string Uuid => "b6a2ec7f-338e-44c1-acf0-952b71cb46b6";
		...
		{
// USE /[MANUAL IMO LIST_LIMITS 1311]/
		...
		public override int GetCount(User user)
		{
			...
			ListingMVC<CSGenioApropr> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public IMO_Menu_1311_ViewModel() : base(null!) { }
		...
		public IMO_Menu_1311_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL IMO OVERRQ 1311]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApropr>(m_userContext, false, ref imo_menu_1311Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1311", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL IMO OVERRQLIST 1311]/
				...
				ListingMVC<CSGenioApropr> listing = Models.ModelBase.Where<CSGenioApropr>(m_userContext, distinct, imo_menu_1311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML1311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<IMO_Menu_1311_RowViewModel> Elements = [];
			int i = 0;
