...
// USE /[MANUAL GQT OVERRQ PROPR01_REGIOREGIAO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAregio>(m_userContext, false, ref propr01_regioregiao__Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PROPR01_REGIOREGIAO__", true, firstVisibleColumn: firstVisibleColumn);
