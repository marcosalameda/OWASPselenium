...
public class Proprall_RegioValRegiao_RowViewModel : Models.Regio
{
	#region Constructors

	public Proprall_RegioValRegiao_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Proprall_RegioValRegiao_RowViewModel(UserContext userContext, CSGenioAregio val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
