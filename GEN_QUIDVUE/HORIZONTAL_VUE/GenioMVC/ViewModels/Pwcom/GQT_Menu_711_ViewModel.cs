...
namespace GenioMVC.ViewModels.Pwcom
{
	public class GQT_Menu_711_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_711Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML711");
			gqt_menu_711Conds.Equal(CSGenioApwcom.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 711]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_711Conds, listing);
		...
		public void LoadToExport(out ListingMVC<CSGenioApwcom> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApwcom> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig.ColumnOrderBy, "pwcom", allSortOrders);
...
// USE /[MANUAL GQT OVERRQ 711]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioApwcom>(m_userContext, false, gqt_menu_711Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML711", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 711]/
		...
		{
			var Elements = new List<GQT_Menu_711_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_711_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		private void SetDocumentFields(ListingMVC<CSGenioApwcom> listing)
		{
			...
			foreach (CSGenioApwcom row in listing.Rows)
			{
			}
		}
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_711]/
		...
		[
			"Pwcom", "Pwcom.ValCodpwcom", "Pwcom.ValZzstate", "Psw", "Psw.ValNome", "Pess1", "Pess1.ValName", "Pwcom.ValFoto", "Pwcom.ValNridenti", "Pwcom.ValCodpess1", "Pwcom.ValCodpsw", "BtnPermission"
		];
