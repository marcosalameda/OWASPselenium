...
public class GQT_Menu_541_RowViewModel : Models.Pworg
{
	#region Constructors

	public GQT_Menu_541_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_541_RowViewModel(UserContext userContext, CSGenioApworg val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
