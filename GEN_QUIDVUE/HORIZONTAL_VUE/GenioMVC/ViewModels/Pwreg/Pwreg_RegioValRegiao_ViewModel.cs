...
// USE /[MANUAL GQT OVERRQ PWREG_REGIOREGIAO]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAregio>(m_userContext, false, ref pwreg___regioregiao__Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_PWREG___REGIOREGIAO__", true, firstVisibleColumn: firstVisibleColumn);
