...
{
	public class Recei_EntitValName_ViewModel : MenuListViewModel<Models.Entit>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Recei_EntitValName_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Recei_EntitValName";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS RECEI_ENTITNAME]/
		...
		public Recei_EntitValName_ViewModel() : base(null!) { }
		...
		public Recei_EntitValName_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAentit> Qlisting, ref CriteriaSet conditions)
		{
			...
			recei___entitname____Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ RECEI_ENTITNAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAentit>(m_userContext, false, ref recei___entitname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_RECEI___ENTITNAME____", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST RECEI_ENTITNAME]/
		...
		{
			List<Recei_EntitValName_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Recei_EntitValName_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Recei_EntitValName_RowViewModel MapRecei_EntitValName(CSGenioAentit row)
		{
			var model = new Recei_EntitValName_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
