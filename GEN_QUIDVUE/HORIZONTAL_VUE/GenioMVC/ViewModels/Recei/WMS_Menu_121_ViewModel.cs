...
namespace GenioMVC.ViewModels.Recei
{
	public class WMS_Menu_121_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_121Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML121");
			wms_menu_121Conds.Equal(CSGenioArecei.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL WMS OVERRQ 121]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_121Conds, listing);
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (!tableConfig.StaticFilters.ContainsKey("filter_WMS_Menu_121_VERIFICATI"))
				tableConfig.StaticFilters.Add("filter_WMS_Menu_121_VERIFICATI", null);

			{
				var groupFilters = CriteriaSet.Or();
				bool filter_WMS_Menu_121_VERIFICATI_1 = false;
				if (tableConfig.StaticFilters["filter_WMS_Menu_121_VERIFICATI"] != null)
					filter_WMS_Menu_121_VERIFICATI_1 = tableConfig.StaticFilters["filter_WMS_Menu_121_VERIFICATI"].Contains("1");
				else if (tableConfig.StaticFilters["filter_WMS_Menu_121_VERIFICATI"] == null)
				...
				if (tableConfig.StaticFilters["filter_WMS_Menu_121_VERIFICATI"] != null)
					filter_WMS_Menu_121_VERIFICATI_2 = tableConfig.StaticFilters["filter_WMS_Menu_121_VERIFICATI"].Contains("2");
...
// USE /[MANUAL WMS OVERRQLIST 121]/
		...
		{
			var Elements = new List<WMS_Menu_121_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_121_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
