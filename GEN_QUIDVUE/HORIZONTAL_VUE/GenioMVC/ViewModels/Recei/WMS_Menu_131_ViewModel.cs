...
namespace GenioMVC.ViewModels.Recei
{
	public class WMS_Menu_131_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_131Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML131");
			wms_menu_131Conds.Equal(CSGenioArecei.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL WMS OVERRQ 131]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_131Conds, listing);
...
// USE /[MANUAL WMS OVERRQLIST 131]/
		...
		{
			var Elements = new List<WMS_Menu_131_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_131_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_131]/
		...
		[
			"Recei", "Recei.ValCodrecei", "Recei.ValZzstate", "Recei.ValNumber", "Recei.ValDtreceip", "Entit", "Entit.ValName", "Recei.ValCodentit", "BtnPermission"
		];
