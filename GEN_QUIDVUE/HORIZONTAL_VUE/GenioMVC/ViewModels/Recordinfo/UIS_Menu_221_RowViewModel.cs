...
public class UIS_Menu_221_RowViewModel : Models.Recordinfo
{
	#region Constructors

	public UIS_Menu_221_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public UIS_Menu_221_RowViewModel(UserContext userContext, CSGenioArecordinfo val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
