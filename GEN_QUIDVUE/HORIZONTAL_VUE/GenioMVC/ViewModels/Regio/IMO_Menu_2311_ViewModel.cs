...
{
	public class IMO_Menu_2311_ViewModel : MenuListViewModel<Models.Regio>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<IMO_Menu_2311_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		public override string Uuid => "bf308678-026e-4364-bff4-f47500c90029";
...
// USE /[MANUAL IMO LIST_LIMITS 2311]/
		...
		public override int GetCount(User user)
		{
			...
			ListingMVC<CSGenioAregio> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public IMO_Menu_2311_ViewModel() : base(null!) { }
		...
		public IMO_Menu_2311_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAregio> Qlisting, ref CriteriaSet conditions)
		{
				...
				imo_menu_2311Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL IMO OVERRQLIST 2311]/
					...
					ListingMVC<CSGenioAregio> listing = Models.ModelBase.Where<CSGenioAregio>(m_userContext, distinct, imo_menu_2311Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2311", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<IMO_Menu_2311_RowViewModel> MapIMO_Menu_2311(ListingMVC<CSGenioAregio> Qlisting)
		{
			List<IMO_Menu_2311_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a IMO_Menu_2311_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private IMO_Menu_2311_RowViewModel MapIMO_Menu_2311(CSGenioAregio row)
		{
			var model = new IMO_Menu_2311_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
