...
{
	public class PTN_Menu_211_ViewModel : MenuListViewModel<Models.Regio>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "3ff5c84d-e77b-442c-b81e-603fe2ba55be";
...
// USE /[MANUAL PTN LIST_LIMITS 211]/
		...
		public PTN_Menu_211_ViewModel() : base(null!) { }
		...
		public PTN_Menu_211_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQLIST 211]/
					...
					ListingMVC<CSGenioAregio> listing = Models.ModelBase.Where<CSGenioAregio>(m_userContext, distinct, ptn_menu_211Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML211", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_211_RowViewModel> Elements = [];
			int i = 0;
