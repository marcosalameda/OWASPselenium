...
{
	public class PTN_Menu_221_ViewModel : MenuListViewModel<Models.Regio>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid => "be72babe-0766-42e6-977c-ad7e8bd8b426";
...
// USE /[MANUAL PTN LIST_LIMITS 221]/
		...
		public PTN_Menu_221_ViewModel() : base(null!) { }
		...
		public PTN_Menu_221_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL PTN OVERRQLIST 221]/
					...
					ListingMVC<CSGenioAregio> listing = Models.ModelBase.Where<CSGenioAregio>(m_userContext, distinct, ptn_menu_221Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML221", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<PTN_Menu_221_RowViewModel> Elements = [];
			int i = 0;
