...
{
	public class Regia_CntryValCountry_ViewModel : MenuListViewModel<Models.Cntry>
	{
		/// <summary>
		...
		public override string Uuid => "Regia_CntryValCountry";
...
// USE /[MANUAL GQT LIST_LIMITS REGIA_CNTRYCOUNTRY]/
		...
		public Regia_CntryValCountry_ViewModel() : base(null!) { }
		...
		public Regia_CntryValCountry_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ REGIA_CNTRYCOUNTRY]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcntry>(m_userContext, false, ref regia___cntrycountry_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REGIA___CNTRYCOUNTRY_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST REGIA_CNTRYCOUNTRY]/
		...
		{
			List<Regia_CntryValCountry_RowViewModel> Elements = [];
			int i = 0;
