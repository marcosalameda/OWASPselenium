...
// USE /[MANUAL GQT OVERRQ REGIA_ON_PSEUDIMOVEISL]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApropr>(m_userContext, false, ref regia_onpseudimoveislConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REGIA_ONPSEUDIMOVEISL", true, firstVisibleColumn: firstVisibleColumn);
