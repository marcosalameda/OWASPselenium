...
{
	public class Regiapro_ValImoveisg_ViewModel : MenuListViewModel<Models.Propr>
	{
		/// <summary>
		...
		public override string Uuid => "Regiapro_ValImoveisg";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS REGIAPRO_PSEUDIMOVEISG]/
		...
		public Regiapro_ValImoveisg_ViewModel() : base(null!) { }
		...
		public Regiapro_ValImoveisg_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ REGIAPRO_PSEUDIMOVEISG]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApropr>(m_userContext, false, ref regiapropseudimoveisgConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REGIAPROPSEUDIMOVEISG", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST REGIAPRO_PSEUDIMOVEISG]/
		...
		{
			List<Regiapro_ValImoveisg_RowViewModel> Elements = [];
			int i = 0;
