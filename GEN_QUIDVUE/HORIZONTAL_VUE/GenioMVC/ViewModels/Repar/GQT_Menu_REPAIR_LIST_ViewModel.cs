...
// USE /[MANUAL GQT OVERRQ REPAIR_LIST]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioArepar>(m_userContext, false, gqt_menu_repair_listConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLREPAIR_LIST", true, firstVisibleColumn: firstVisibleColumn);
