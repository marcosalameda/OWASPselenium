...
{
	public class Repar_EquipValRegistnr_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Repar_EquipValRegistnr_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Repar_EquipValRegistnr";
...
// USE /[MANUAL GQT LIST_LIMITS REPAR_EQUIPREGISTNR]/
		...
		public Repar_EquipValRegistnr_ViewModel() : base(null!) { }
		...
		public Repar_EquipValRegistnr_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Repar_EquipValRegistnr_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAequip> Qlisting, ref CriteriaSet conditions)
		{
			...
			repar___equipregistnrConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ REPAR_EQUIPREGISTNR]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref repar___equipregistnrConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REPAR___EQUIPREGISTNR", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST REPAR_EQUIPREGISTNR]/
		...
		private List<Repar_EquipValRegistnr_RowViewModel> MapRepar_EquipValRegistnr(ListingMVC<CSGenioAequip> Qlisting)
		{
			List<Repar_EquipValRegistnr_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Repar_EquipValRegistnr_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Repar_EquipValRegistnr_RowViewModel MapRepar_EquipValRegistnr(CSGenioAequip row)
		{
			var model = new Repar_EquipValRegistnr_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
