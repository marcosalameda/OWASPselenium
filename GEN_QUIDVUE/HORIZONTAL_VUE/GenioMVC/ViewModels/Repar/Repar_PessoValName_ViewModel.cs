...
// USE /[MANUAL GQT OVERRQ REPAR_PESSONAME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApesso>(m_userContext, false, ref repar___pessoname____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_REPAR___PESSONAME____", true, firstVisibleColumn: firstVisibleColumn);
