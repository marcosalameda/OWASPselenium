...
public class PTN_Menu_4411_RowViewModel : Models.Roigi
{
	#region Constructors

	public PTN_Menu_4411_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_4411_RowViewModel(UserContext userContext, CSGenioAroigi val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
