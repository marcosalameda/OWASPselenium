...
public class GQT_Menu_2311_RowViewModel : Models.Rooms
{
	#region Constructors

	public GQT_Menu_2311_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_2311_RowViewModel(UserContext userContext, CSGenioArooms val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
