...
{
	public class PTN_Menu_3411_ViewModel : ListViewModel
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements. List type: "${exposeField.Fajuda}"
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<PTN_Menu_3411_RowViewModel> Menu { get; set; }

		/// <inheritdoc/>
		public override string TableAlias { get => "rooms"; }

		/// <inheritdoc/>
		public override string Uuid { get => "b7bbcce5-d714-4ca0-ba86-50f80137d65b"; }
		...
		public override int GetCount(User user)
		{
			...
			var areaBase = CSGenio.business.Area.createArea("rooms", user, "PTN");

			//gets eph conditions to be applied in listing
			CriteriaSet ptn_menu_3411Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML3411");
			ptn_menu_3411Conds.Equal(CSGenioArooms.FldZzstate, 0); //valid zzstate only

			//Menu fixed limits and relations:

			

// USE /[MANUAL PTN OVERRQ 3411]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_3411Conds, listing);
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_3411_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_3411_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<PTN_Menu_3411_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Rooms.AddEPH<CSGenioArooms>(ref u, crs, "ML3411");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Rooms.AddEPH<CSGenioArooms>(ref u, null, "ML3411"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioArooms> Qlisting, ref CriteriaSet conditions)
		{
			using (GenioDI.MetricsOtlp.RecordTime("menu_load_time", new List<KeyValuePair<string, object>>() {
				...
				CriteriaSet ptn_menu_3411Conds = CriteriaSet.And();
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "ML3411");
			...
			// Limit origin: menu 
				...
				conditions.SubSets.Add(ptn_menu_3411Conds);
				ptn_menu_3411Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ 3411]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioArooms>(m_userContext, false, ptn_menu_3411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3411", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 3411]/
				...
				if (tableReload)
				{
// USE /[MANUAL PTN OVERRQLIST 3411]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioArooms.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_3411Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
							pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
					}

					ListingMVC<CSGenioArooms> listing = Models.ModelBase.Where<CSGenioArooms>(m_userContext, false, ptn_menu_3411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
					...
					Menu.Elements = MapPTN_Menu_3411(listing);

					Menu.Identifier = "ML3411";
					Menu.Slots = new Dictionary<string, List<object>>();

					// Last updated by [CJP] at [2015.02.03]
					// Adds the identifier to each element
					foreach (var element in Menu.Elements)
						element.Identifier = "ML3411";
		...
		private List<PTN_Menu_3411_RowViewModel> MapPTN_Menu_3411(ListingMVC<CSGenioArooms> Qlisting)
		{
			var Elements = new List<PTN_Menu_3411_RowViewModel>();
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPTN_Menu_3411(row));
					i++;
				}
			}
		...
		/// to a PTN_Menu_3411_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_3411_RowViewModel MapPTN_Menu_3411(CSGenioArooms row)
		{
			var model = new PTN_Menu_3411_RowViewModel(m_userContext, true, _fieldsToSerialize);
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_3411_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		#region Custom code
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_3411]/
		#endregion
