...
public class PTN_Menu_3511_RowViewModel : Models.Rooms
{
	#region Constructors
	...
	public PTN_Menu_3511_RowViewModel(UserContext userContext, CSGenioArooms val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
