...
// USE /[MANUAL PTN OVERRQ 351]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArooms>(m_userContext, false, ref ptn_menu_351Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML351", true, firstVisibleColumn: firstVisibleColumn);
