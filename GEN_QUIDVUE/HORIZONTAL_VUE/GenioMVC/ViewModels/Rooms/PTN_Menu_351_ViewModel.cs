...
namespace GenioMVC.ViewModels.Rooms
{
	public class PTN_Menu_351_ViewModel : ListViewModel
	{
		...
		/// <inheritdoc/>
		public override string Uuid { get => "457cb6c5-92df-44e2-b595-bbd715d45ef8"; }
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet ptn_menu_351Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML351");
			ptn_menu_351Conds.Equal(CSGenioArooms.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL PTN OVERRQ 351]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(ptn_menu_351Conds, listing);
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Rooms.AddEPH<CSGenioArooms>(ref u, crs, "ML351");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Rooms.AddEPH<CSGenioArooms>(ref u, null, "ML351"));
			}
...
// USE /[MANUAL PTN OVERRQ 351]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioArooms>(m_userContext, false, ptn_menu_351Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML351", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 351]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioArooms.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_351Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
		...
		private List<PTN_Menu_351_RowViewModel> MapPTN_Menu_351(ListingMVC<CSGenioArooms> Qlisting)
		{
			var Elements = new List<PTN_Menu_351_RowViewModel>();
			int i = 0;
		...
		private PTN_Menu_351_RowViewModel MapPTN_Menu_351(CSGenioArooms row)
		{
		...
		/// </summary>
		public void CalculateButtonPermissions(PTN_Menu_351_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
