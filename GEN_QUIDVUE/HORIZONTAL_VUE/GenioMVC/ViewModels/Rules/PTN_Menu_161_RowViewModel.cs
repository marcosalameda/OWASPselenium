...
public class PTN_Menu_161_RowViewModel : Models.Rules
{
	#region Constructors

	public PTN_Menu_161_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_161_RowViewModel(UserContext userContext, CSGenioArules val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
