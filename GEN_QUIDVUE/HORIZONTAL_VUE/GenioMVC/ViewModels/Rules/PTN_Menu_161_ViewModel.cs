...
{
	public class PTN_Menu_161_ViewModel : MenuListViewModel<Models.Rules>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<PTN_Menu_161_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "c5365297-560f-4d93-a1b2-c28fa894efec";
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 161]/
		...
		public PTN_Menu_161_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_161_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_161_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public PTN_Menu_161_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<PTN_Menu_161_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Rules.AddEPH<CSGenioArules>(ref u, crs, "ML161");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Rules.AddEPH<CSGenioArules>(ref u, null, "ML161"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioArules> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet ptn_menu_161Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(ptn_menu_161Conds);
			ptn_menu_161Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PTN OVERRQ 161]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioArules>(m_userContext, false, ref ptn_menu_161Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML161", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PTN OVERRQLSTEXP 161]/
...
// USE /[MANUAL PTN OVERRQLIST 161]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioArules.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_161Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioArules> listing = Models.ModelBase.Where<CSGenioArules>(m_userContext, distinct, ptn_menu_161Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML161", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapPTN_Menu_161(listing);
		...
		private List<PTN_Menu_161_RowViewModel> MapPTN_Menu_161(ListingMVC<CSGenioArules> Qlisting)
		{
			List<PTN_Menu_161_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapPTN_Menu_161(row));
					i++;
				}
			}
		...
		/// to a PTN_Menu_161_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_161_RowViewModel MapPTN_Menu_161(CSGenioArules row)
		{
			var model = new PTN_Menu_161_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM PTN_MENU_161]/
