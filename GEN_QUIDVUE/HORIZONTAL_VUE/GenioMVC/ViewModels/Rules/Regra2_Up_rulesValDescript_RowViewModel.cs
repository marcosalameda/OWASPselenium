...
public class Regra2_Up_rulesValDescript_RowViewModel : Models.Up_rules
{
	#region Constructors

	public Regra2_Up_rulesValDescript_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Regra2_Up_rulesValDescript_RowViewModel(UserContext userContext, CSGenioAup_rules val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
