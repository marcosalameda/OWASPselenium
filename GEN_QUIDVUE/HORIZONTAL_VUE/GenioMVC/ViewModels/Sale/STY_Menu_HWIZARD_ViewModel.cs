...
{
	public class STY_Menu_HWIZARD_ViewModel : MenuListViewModel<Models.Sale>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<STY_Menu_HWIZARD_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "a370304d-2d03-4a9e-8e32-41d68cf57714";
...
// USE /[MANUAL STY LIST_LIMITS HWIZARD]/
		...
		public STY_Menu_HWIZARD_ViewModel() : base(null!) { }
		...
		public STY_Menu_HWIZARD_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAsale> Qlisting, ref CriteriaSet conditions)
		{
			...
			sty_menu_hwizardConds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL STY OVERRQ HWIZARD]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAsale>(m_userContext, false, ref sty_menu_hwizardConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLHWIZARD", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST HWIZARD]/
				...
				ListingMVC<CSGenioAsale> listing = Models.ModelBase.Where<CSGenioAsale>(m_userContext, distinct, sty_menu_hwizardConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLHWIZARD", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<STY_Menu_HWIZARD_RowViewModel> MapSTY_Menu_HWIZARD(ListingMVC<CSGenioAsale> Qlisting)
		{
			List<STY_Menu_HWIZARD_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a STY_Menu_HWIZARD_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private STY_Menu_HWIZARD_RowViewModel MapSTY_Menu_HWIZARD(CSGenioAsale row)
		{
			var model = new STY_Menu_HWIZARD_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
