...
{
	public class STY_Menu_PWIZARD_ViewModel : MenuListViewModel<Models.Sale>
	{
		/// <summary>
		...
		public override string Uuid => "a184b20e-024a-470b-9ef1-f0447e74da48";
...
// USE /[MANUAL STY LIST_LIMITS PWIZARD]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLPWIZARD");
		...
		public STY_Menu_PWIZARD_ViewModel() : base(null!) { }
		...
		public STY_Menu_PWIZARD_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL STY OVERRQ PWIZARD]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAsale>(m_userContext, false, ref sty_menu_pwizardConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLPWIZARD", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST PWIZARD]/
				...
				ListingMVC<CSGenioAsale> listing = Models.ModelBase.Where<CSGenioAsale>(m_userContext, distinct, sty_menu_pwizardConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLPWIZARD", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<STY_Menu_PWIZARD_RowViewModel> Elements = [];
			int i = 0;
