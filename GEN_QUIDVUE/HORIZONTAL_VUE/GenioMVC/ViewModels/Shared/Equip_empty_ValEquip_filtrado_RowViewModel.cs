...
public class Equip_empty_ValEquip_filtrado_RowViewModel : Models.Equip
{
	#region Constructors

	public Equip_empty_ValEquip_filtrado_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Equip_empty_ValEquip_filtrado_RowViewModel(UserContext userContext, CSGenioAequip val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
