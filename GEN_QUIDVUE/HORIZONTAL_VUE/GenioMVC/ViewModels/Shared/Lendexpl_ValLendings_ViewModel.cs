...
// USE /[MANUAL GQT OVERRQ LENDEXPL_PSEUDLENDINGS]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAlendi>(m_userContext, false, lendexplpseudlendingsConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_LENDEXPLPSEUDLENDINGS", true, firstVisibleColumn: firstVisibleColumn);
