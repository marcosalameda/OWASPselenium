...
{
	public class Wid_equi_ValWidequi_ViewModel : MenuListViewModel<Models.Equip>
	{
		/// <summary>
		...
		public override string Uuid => "Wid_equi_ValWidequi";
...
// USE /[MANUAL GQT LIST_LIMITS WID_EQUI_PSEUDWIDEQUI]/
		...
		public Wid_equi_ValWidequi_ViewModel() : base(null!) { }
		...
		public Wid_equi_ValWidequi_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ WID_EQUI_PSEUDWIDEQUI]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAequip>(m_userContext, false, ref wid_equipseudwidequi_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_WID_EQUIPSEUDWIDEQUI_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST WID_EQUI_PSEUDWIDEQUI]/
		...
		{
			List<Wid_equi_ValWidequi_RowViewModel> Elements = [];
			int i = 0;
