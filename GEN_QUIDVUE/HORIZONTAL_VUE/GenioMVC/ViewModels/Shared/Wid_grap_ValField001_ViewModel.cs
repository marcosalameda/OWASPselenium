...
// USE /[MANUAL GQT OVERRQ WID_GRAP_PSEUDFIELD001]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcmpny>(m_userContext, false, ref wid_grappseudfield001Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_WID_GRAPPSEUDFIELD001", true, firstVisibleColumn: firstVisibleColumn);
