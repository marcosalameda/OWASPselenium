...
public class Wid_pess_ValPesslist_RowViewModel : Models.Pesso
{
	#region Constructors

	public Wid_pess_ValPesslist_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Wid_pess_ValPesslist_RowViewModel(UserContext userContext, CSGenioApesso val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
