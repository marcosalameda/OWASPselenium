...
public class GQT_Menu_331_RowViewModel : Models.Speci
{
	#region Constructors

	public GQT_Menu_331_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_331_RowViewModel(UserContext userContext, CSGenioAspeci val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
