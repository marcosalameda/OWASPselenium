...
// USE /[MANUAL PTN OVERRQ 3131]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAtblb>(m_userContext, false, ptn_menu_3131Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3131", true, firstVisibleColumn: firstVisibleColumn);
