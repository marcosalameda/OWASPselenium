...
// USE /[MANUAL PTN OVERRQ 3141]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtblb>(m_userContext, false, ref ptn_menu_3141Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3141", true, firstVisibleColumn: firstVisibleColumn);
