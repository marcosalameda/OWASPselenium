...
{
	public class PTN_Menu_3161_ViewModel : MenuListViewModel<Models.Tblk>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<PTN_Menu_3161_RowViewModel> Menu { get; set; }
		...
		/// <inheritdoc/>
		[JsonIgnore]
		public override string TableAlias => "tblk";

		/// <inheritdoc/>
		[JsonPropertyName("uuid")]
		public override string Uuid => "3b185cfa-ac50-486e-9679-724d526a89a7";
...
// USE /[MANUAL PTN LIST_LIMITS 3161]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML3161");
			...
			ListingMVC<CSGenioAtblk> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public PTN_Menu_3161_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="PTN_Menu_3161_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public PTN_Menu_3161_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public PTN_Menu_3161_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void LoadToExport(out ListingMVC<CSGenioAtblk> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<PTN_Menu_3161_RowViewModel>();
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtblk> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<PTN_Menu_3161_RowViewModel>();

			CriteriaSet ptn_menu_3161Conds = CriteriaSet.And();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "tblk", allSortOrders);
			...
			conditions.SubSets.Add(ptn_menu_3161Conds);
			ptn_menu_3161Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL PTN OVERRQ 3161]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtblk>(m_userContext, false, ref ptn_menu_3161Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3161", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3161]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAtblk.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_3161Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAtblk> listing = Models.ModelBase.Where<CSGenioAtblk>(m_userContext, distinct, ptn_menu_3161Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3161", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<PTN_Menu_3161_RowViewModel> MapPTN_Menu_3161(ListingMVC<CSGenioAtblk> Qlisting)
		{
			List<PTN_Menu_3161_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a PTN_Menu_3161_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private PTN_Menu_3161_RowViewModel MapPTN_Menu_3161(CSGenioAtblk row)
		{
			var model = new PTN_Menu_3161_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
