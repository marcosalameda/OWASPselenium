...
// USE /[MANUAL GQT OVERRQ TBLK_TRSBNAME]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAtrsb>(m_userContext, false, tblk____trsb_name____Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_TBLK____TRSB_NAME____", true, firstVisibleColumn: firstVisibleColumn);
