...
namespace GenioMVC.ViewModels.Tpequ
{
	public class GQT_Menu_2911_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_2911Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2911");
			gqt_menu_2911Conds.Equal(CSGenioAtpequ.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 2911]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_2911Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 2911]/
					...
					ListingMVC<CSGenioAtpequ> listing = Models.ModelBase.Where<CSGenioAtpequ>(m_userContext, false, gqt_menu_2911Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2911", true, true, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_2911_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_2911_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM GQT_MENU_2911]/
		...
		[
			"Tpequ", "Tpequ.ValCodtpequ", "Tpequ.ValZzstate", "Tpequ.ValTpequcod", "Tpequ.ValTipoequi", "Famil", "Famil.ValFamily", "Tpequ.ValTpequpai", "Tpequ.ValNivel", "Tpequ.ValBackcolo", "Tpequ.ValCorletra", "Tpequ.ValPrecomax", "Tpequ.ValPrecoult", "Tpequ.ValSince", "Tpequ.ValQtdequip", "Tpequ.ValKit", "Tpequ.ValCodfamil", "BtnPermission"
		];
