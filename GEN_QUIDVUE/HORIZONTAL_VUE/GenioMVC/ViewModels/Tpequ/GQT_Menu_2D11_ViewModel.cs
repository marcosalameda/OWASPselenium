...
namespace GenioMVC.ViewModels.Tpequ
{
	public class GQT_Menu_2D11_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet gqt_menu_2d11Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML2D11");
			gqt_menu_2d11Conds.Equal(CSGenioAtpequ.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL GQT OVERRQ 2D11]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(gqt_menu_2d11Conds, listing);
...
// USE /[MANUAL GQT OVERRQLIST 2D11]/
					...
					ListingMVC<CSGenioAtpequ> listing = Models.ModelBase.Where<CSGenioAtpequ>(m_userContext, false, gqt_menu_2d11Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2D11", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<GQT_Menu_2D11_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(GQT_Menu_2D11_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
