...
// USE /[MANUAL GQT LIST_LIMITS 2D21]/
		...
		public GQT_Menu_2D21_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAtpequ> Qlisting, ref CriteriaSet conditions)
		{
			...
			conditions.SubSets.Add(gqt_menu_2d21Conds);
			gqt_menu_2d21Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ 2D21]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtpequ>(m_userContext, false, ref gqt_menu_2d21Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML2D21", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST 2D21]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAtpequ.GetInformation(), QMVC_POS_RECORD, sorts, gqt_menu_2d21Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
