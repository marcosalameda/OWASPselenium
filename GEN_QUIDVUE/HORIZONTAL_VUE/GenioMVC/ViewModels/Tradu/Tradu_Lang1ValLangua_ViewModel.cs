...
{
	public class Tradu_Lang1ValLangua_ViewModel : MenuListViewModel<Models.Lang1>
	{
		/// <summary>
		...
		{
// USE /[MANUAL GQT LIST_LIMITS TRADU_LANG1LANGUA]/
		...
		public Tradu_Lang1ValLangua_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="Tradu_Lang1ValLangua_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Tradu_Lang1ValLangua_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public Tradu_Lang1ValLangua_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQLIST TRADU_LANG1LANGUA]/
		...
		{
			List<Tradu_Lang1ValLangua_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Tradu_Lang1ValLangua_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Tradu_Lang1ValLangua_RowViewModel MapTradu_Lang1ValLangua(CSGenioAlang1 row)
		{
			var model = new Tradu_Lang1ValLangua_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
		...
		private void SetDocumentFields(ListingMVC<CSGenioAlang1> listing)
		{
		}
		...
		/// <inheritdoc />
		public override void MapFromModel(Models.Lang1 m)
		{
		}

		/// <inheritdoc />
		public override void MapToModel(Models.Lang1 m)
		{
		}
