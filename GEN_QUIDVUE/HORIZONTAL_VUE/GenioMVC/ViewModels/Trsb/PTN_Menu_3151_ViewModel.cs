...
{
	public class PTN_Menu_3151_ViewModel : MenuListViewModel<Models.Trsb>
	{
		/// <summary>
		...
		public override string Uuid => "af8a7b0d-5af1-4fed-b40f-75b9abd0d802";
		...
		{
// USE /[MANUAL PTN LIST_LIMITS 3151]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML3151");
			...
			ListingMVC<CSGenioAtrsb> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public PTN_Menu_3151_ViewModel() : base(null!) { }
		...
		public PTN_Menu_3151_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Trsb.AddEPH<CSGenioAtrsb>(ref u, crs, "ML3151");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Trsb.AddEPH<CSGenioAtrsb>(ref u, null, "ML3151"));
			}
...
// USE /[MANUAL PTN OVERRQ 3151]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAtrsb>(m_userContext, false, ref ptn_menu_3151Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3151", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL PTN OVERRQLIST 3151]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAtrsb.GetInformation(), QMVC_POS_RECORD, sorts, ptn_menu_3151Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAtrsb> listing = Models.ModelBase.Where<CSGenioAtrsb>(m_userContext, distinct, ptn_menu_3151Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML3151", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<PTN_Menu_3151_RowViewModel> MapPTN_Menu_3151(ListingMVC<CSGenioAtrsb> Qlisting)
		{
			List<PTN_Menu_3151_RowViewModel> Elements = [];
			int i = 0;
		...
		private PTN_Menu_3151_RowViewModel MapPTN_Menu_3151(CSGenioAtrsb row)
		{
