...
public class UIS_Menu_2441_RowViewModel : Models.Ufeedback
{
	#region Constructors

	public UIS_Menu_2441_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public UIS_Menu_2441_RowViewModel(UserContext userContext, CSGenioAufeedback val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
