...
public class STY_Menu_OVERVIEW_RowViewModel : Models.Uicom
{
	#region Constructors

	public STY_Menu_OVERVIEW_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public STY_Menu_OVERVIEW_RowViewModel(UserContext userContext, CSGenioAuicom val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
