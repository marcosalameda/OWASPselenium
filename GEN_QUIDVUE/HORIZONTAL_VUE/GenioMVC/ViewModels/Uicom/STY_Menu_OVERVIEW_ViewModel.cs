...
{
	public class STY_Menu_OVERVIEW_ViewModel : MenuListViewModel<Models.Uicom>
	{
		/// <summary>
		...
		/// <inheritdoc/>
		[JsonIgnore]
		public override string TableAlias => "uicom";

		/// <inheritdoc/>
		[JsonPropertyName("uuid")]
		public override string Uuid => "7a94d3ef-80ac-4408-8016-eb66cf9a4ae5";
...
// USE /[MANUAL STY LIST_LIMITS OVERVIEW]/
		...
		public override int GetCount(User user)
		{
			...
			ListingMVC<CSGenioAuicom> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public STY_Menu_OVERVIEW_ViewModel() : base(null!) { }
		...
		public STY_Menu_OVERVIEW_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void LoadToExport(out ListingMVC<CSGenioAuicom> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAuicom> Qlisting, ref CriteriaSet conditions)
		{
			User u = m_userContext.User;
			Menu = new TablePartial<STY_Menu_OVERVIEW_RowViewModel>();
			...
			List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig, "uicom", allSortOrders);
...
// USE /[MANUAL STY OVERRQ OVERVIEW]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAuicom>(m_userContext, false, ref sty_menu_overviewConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLOVERVIEW", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST OVERVIEW]/
				...
				ListingMVC<CSGenioAuicom> listing = Models.ModelBase.Where<CSGenioAuicom>(m_userContext, distinct, sty_menu_overviewConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLOVERVIEW", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			List<STY_Menu_OVERVIEW_RowViewModel> Elements = [];
			int i = 0;
