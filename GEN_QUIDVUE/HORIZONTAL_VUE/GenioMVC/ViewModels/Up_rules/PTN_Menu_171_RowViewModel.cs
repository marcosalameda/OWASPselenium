...
public class PTN_Menu_171_RowViewModel : Models.Up_rules
{
	#region Constructors

	public PTN_Menu_171_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public PTN_Menu_171_RowViewModel(UserContext userContext, CSGenioAup_rules val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
