...
public class Up_rules_ValRegras_RowViewModel : Models.Rules
{
	#region Constructors

	public Up_rules_ValRegras_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Up_rules_ValRegras_RowViewModel(UserContext userContext, CSGenioArules val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
