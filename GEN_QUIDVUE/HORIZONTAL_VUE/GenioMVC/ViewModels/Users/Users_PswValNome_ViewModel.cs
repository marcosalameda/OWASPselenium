...
{
	public class Users_PswValNome_ViewModel : MenuListViewModel<Models.Psw>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Users_PswValNome_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Users_PswValNome";
...
// USE /[MANUAL GQT LIST_LIMITS USERS_PSWNOME]/
		...
		public Users_PswValNome_ViewModel() : base(null!) { }
		...
		public Users_PswValNome_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL GQT OVERRQ USERS_PSWNOME]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioApsw>(m_userContext, false, ref users___psw__nome____Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_USERS___PSW__NOME____", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST USERS_PSWNOME]/
		...
		private List<Users_PswValNome_RowViewModel> MapUsers_PswValNome(ListingMVC<CSGenioApsw> Qlisting)
		{
			List<Users_PswValNome_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Users_PswValNome_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Users_PswValNome_RowViewModel MapUsers_PswValNome(CSGenioApsw row)
		{
			var model = new Users_PswValNome_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
