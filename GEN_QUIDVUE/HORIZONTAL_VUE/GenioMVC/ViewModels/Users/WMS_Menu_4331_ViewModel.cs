...
{
	public class WMS_Menu_4331_ViewModel : MenuListViewModel<Models.Users>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("Table")]
		public TablePartial<WMS_Menu_4331_RowViewModel> Menu { get; set; }

		protected override TableViewsManagementMode ViewsManagementMode => TableViewsManagementMode.PersistOne;

		/// <inheritdoc/>
		[JsonIgnore]
		public override string TableAlias => "users";

		/// <inheritdoc/>
		public override string Uuid => "c5a5ce8c-7964-41c6-b248-bd9d4be5dc71";
		...
		{
// USE /[MANUAL WMS LIST_LIMITS 4331]/
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet conditions = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML4331");
			...
			ListingMVC<CSGenioAusers> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public WMS_Menu_4331_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="WMS_Menu_4331_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public WMS_Menu_4331_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public WMS_Menu_4331_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void LoadToExport(out ListingMVC<CSGenioAusers> listing, out CriteriaSet conditions, out List<Exports.QColumn> columns, CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest = false)
		{
			listing = null;
			conditions = null;
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (Menu == null)
				Menu = new TablePartial<WMS_Menu_4331_RowViewModel>();
		...
		/// <param name="Qlisting">The rows.</param>
		/// <param name="conditions">The conditions.</param>
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAusers> Qlisting, ref CriteriaSet conditions)
		{
            ...
            ]), "ms", "Time to load the page."))
			{
				...
				CriteriaSet wms_menu_4331Conds = CriteriaSet.And();
				...
				List<ColumnSort> sorts = GetRequestSorts(this.Menu, tableConfig.ColumnOrderBy, "users", allSortOrders);
				...
				//Tooltip for EPHs affecting this viewmodel list
				{
					...
					CSGenioAusers model_limit_area = new CSGenioAusers(m_userContext.User);
				...
				conditions.SubSets.Add(wms_menu_4331Conds);
				wms_menu_4331Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL WMS OVERRQ 4331]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAusers>(m_userContext, false, wms_menu_4331Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML4331", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL WMS OVERRQLIST 4331]/
					...
					if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					{
						var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAusers.GetInformation(), QMVC_POS_RECORD, sorts, wms_menu_4331Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
						if (m_iCurPag != -1)
		...
		private List<WMS_Menu_4331_RowViewModel> MapWMS_Menu_4331(ListingMVC<CSGenioAusers> Qlisting)
		{
			List<WMS_Menu_4331_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a WMS_Menu_4331_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private WMS_Menu_4331_RowViewModel MapWMS_Menu_4331(CSGenioAusers row)
		{
			var model = new WMS_Menu_4331_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
		...
		private void SetDocumentFields(ListingMVC<CSGenioAusers> listing)
		{
		}
