...
namespace GenioMVC.ViewModels.Users
{
	public class WMS_Menu_4331_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet wms_menu_4331Conds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "ML4331");
			wms_menu_4331Conds.Equal(CSGenioAusers.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL WMS OVERRQ 4331]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(wms_menu_4331Conds, listing);
...
// USE /[MANUAL WMS OVERRQLIST 4331]/
		...
		{
			var Elements = new List<WMS_Menu_4331_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(WMS_Menu_4331_RowViewModel model)
		{
			bool canView = true;
			bool canEdit = true;
			bool canDelete = true;
		...
		private void SetDocumentFields(ListingMVC<CSGenioAusers> listing)
		{
			...
			foreach (CSGenioAusers row in listing.Rows)
			{
			}
		}
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM WMS_MENU_4331]/
		...
		[
			"Users", "Users.ValCodusers", "Users.ValZzstate", "Psw", "Psw.ValNome", "Perso", "Perso.ValName", "Users.ValCodperso", "Users.ValCodpsw", "BtnPermission"
		];
