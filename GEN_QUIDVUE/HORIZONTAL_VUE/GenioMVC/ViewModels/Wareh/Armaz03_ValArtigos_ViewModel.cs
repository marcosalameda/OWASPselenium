...
{
	public class Armaz03_ValArtigos_ViewModel : MenuListViewModel<Models.Item>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<Armaz03_ValArtigos_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "Armaz03_ValArtigos";
		...
		{
// USE /[MANUAL GQT LIST_LIMITS ARMAZ03_PSEUDARTIGOS]/
		...
		public Armaz03_ValArtigos_ViewModel() : base(null!) { }
		...
		public Armaz03_ValArtigos_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<Armaz03_ValArtigos_RowViewModel>();
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAitem> Qlisting, ref CriteriaSet conditions)
		{
			...
			armaz03_pseudartigos_Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
...
// USE /[MANUAL GQT OVERRQ ARMAZ03_PSEUDARTIGOS]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAitem>(m_userContext, false, ref armaz03_pseudartigos_Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAZ03_PSEUDARTIGOS_", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL GQT OVERRQLIST ARMAZ03_PSEUDARTIGOS]/
				...
				ListingMVC<CSGenioAitem> listing = Models.ModelBase.Where<CSGenioAitem>(m_userContext, distinct, armaz03_pseudartigos_Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAZ03_PSEUDARTIGOS_", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<Armaz03_ValArtigos_RowViewModel> MapArmaz03_ValArtigos(ListingMVC<CSGenioAitem> Qlisting)
		{
			List<Armaz03_ValArtigos_RowViewModel> Elements = [];
			int i = 0;
		...
		/// to a Armaz03_ValArtigos_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private Armaz03_ValArtigos_RowViewModel MapArmaz03_ValArtigos(CSGenioAitem row)
		{
			var model = new Armaz03_ValArtigos_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
