...
public class GQT_Menu_461_RowViewModel : Models.Wareh
{
	#region Constructors

	public GQT_Menu_461_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_461_RowViewModel(UserContext userContext, CSGenioAwareh val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
