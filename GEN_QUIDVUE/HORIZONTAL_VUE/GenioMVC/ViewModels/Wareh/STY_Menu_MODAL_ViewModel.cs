...
// USE /[MANUAL STY OVERRQ MODAL]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, sty_menu_modalConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLMODAL", true, firstVisibleColumn: firstVisibleColumn);
