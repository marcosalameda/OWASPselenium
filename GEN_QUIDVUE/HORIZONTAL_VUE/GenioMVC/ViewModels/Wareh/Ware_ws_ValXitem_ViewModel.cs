...
// USE /[MANUAL GQT OVERRQ WARE_WS_PSEUDXITEM]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAitem>(m_userContext, false, ware_ws_pseudxitem___Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_WARE_WS_PSEUDXITEM___", true, firstVisibleColumn: firstVisibleColumn);
