...
// USE /[MANUAL GQT OVERRQ ARMAPESS_WAREHWAREHDES]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAwareh>(m_userContext, false, armapesswarehwarehdesConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ARMAPESSWAREHWAREHDES", true, firstVisibleColumn: firstVisibleColumn);
