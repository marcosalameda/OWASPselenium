...
namespace GenioMVC.ViewModels.Wpess
{
	public class STY_Menu_CARDIMGTHUMB_ViewModel : ListViewModel
	{
		...
		public override int GetCount(User user)
		{
			...
			CriteriaSet sty_menu_cardimgthumbConds = CSGenio.business.Listing.CalculateConditionsEphGeneric(areaBase, "MLCARDIMGTHUMB");
			sty_menu_cardimgthumbConds.Equal(CSGenioAwpess.FldZzstate, 0); //valid zzstate only
...
// USE /[MANUAL STY OVERRQ CARDIMGTHUMB]/
			...
			SelectQuery qs = sp.getSelectQueryFromListingMVC(sty_menu_cardimgthumbConds, listing);
...
// USE /[MANUAL STY OVERRQLIST CARDIMGTHUMB]/
					...
					ListingMVC<CSGenioAwpess> listing = Models.ModelBase.Where<CSGenioAwpess>(m_userContext, false, sty_menu_cardimgthumbConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLCARDIMGTHUMB", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		{
			var Elements = new List<STY_Menu_CARDIMGTHUMB_RowViewModel>();
			int i = 0;
		...
		/// </summary>
		public void CalculateButtonPermissions(STY_Menu_CARDIMGTHUMB_RowViewModel model)
		{
			bool canView = false;
			bool canEdit = false;
...
// USE /[MANUAL GQT VIEWMODEL_CUSTOM STY_MENU_CARDIMGTHUMB]/
		...
		[
			"Wpess", "Wpess.ValCodpess", "Wpess.ValZzstate", "Wpess.ValName", "Wpess.ValDate", "Wpess.ValSex", "Wpess.ValNfunc", "Wpess.ValAdress", "Wpess.ValZipcode", "Wpess.ValCountry", "Wpess.ValEmail", "Wpess.ValCellphon", "Wpess.ValNaturali", "Wpess.ValNacional", "Wareh", "Wareh.ValWarehdes", "Wpess.ValFtthumb", "Wpess.ValCodwareh", "BtnPermission"
		];
