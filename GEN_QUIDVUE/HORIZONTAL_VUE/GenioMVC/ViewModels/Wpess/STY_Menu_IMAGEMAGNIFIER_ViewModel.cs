...
{
	public class STY_Menu_IMAGEMAGNIFIER_ViewModel : MenuListViewModel<Models.Wpess>
	{
		/// <summary>
		...
		public override string Uuid => "9113c297-09a6-4691-925e-b000abf7937c";
...
// USE /[MANUAL STY LIST_LIMITS IMAGEMAGNIFIER]/
		...
		public STY_Menu_IMAGEMAGNIFIER_ViewModel() : base(null!) { }
		...
		public STY_Menu_IMAGEMAGNIFIER_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
...
// USE /[MANUAL STY OVERRQ IMAGEMAGNIFIER]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAwpess>(m_userContext, false, ref sty_menu_imagemagnifierConds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "MLIMAGEMAGNIFIER", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL STY OVERRQLIST IMAGEMAGNIFIER]/
		...
		{
			List<STY_Menu_IMAGEMAGNIFIER_RowViewModel> Elements = [];
			int i = 0;
