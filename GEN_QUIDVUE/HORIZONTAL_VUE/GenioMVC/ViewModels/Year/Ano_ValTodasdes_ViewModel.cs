...
// USE /[MANUAL GQT OVERRQ ANO_PSEUDTODASDES]/
				...
				if (isToExport)
				{
					...
					Qlisting = Models.ModelBase.Where<CSGenioAexpen>(m_userContext, false, ano_____pseudtodasdesConds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_ANO_____PSEUDTODASDES", true, firstVisibleColumn: firstVisibleColumn);
