...
public class GQT_Menu_A31_RowViewModel : Models.Year
{
	#region Constructors

	public GQT_Menu_A31_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public GQT_Menu_A31_RowViewModel(UserContext userContext, CSGenioAyear val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
