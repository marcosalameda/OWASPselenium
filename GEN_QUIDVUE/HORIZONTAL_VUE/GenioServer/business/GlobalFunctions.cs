...
// USE /[MANUAL GQT ONASSINA]/
        ...
        /// <summary>
        /// Vertical layout - Vue theme variables
        /// </summary>
        ...
        /// <summary>
        /// Horizontal Layout - Vue theme variables
        /// </summary>
        private static readonly Dictionary<string, string> HORIZONTAL_VUE_THEME_VARIABLES = new Dictionary<string, string>()
        {
            { "$footer-bg", "transparent" },
            { "$menu-sidebar-width", "16rem" },
            { "$menu-behaviour", "partial_collapse" },
        ...
        {
            return HORIZONTAL_VUE_THEME_VARIABLES[variable];
        }
        ...
        {
            if ("FLAT_VUE" == appID)
                return FLAT_VUE_THEME_VARIABLES[variable];
            if ("HORIZONTAL_VUE" == appID)
                return HORIZONTAL_VUE_THEME_VARIABLES[variable];
            return "";
        }
