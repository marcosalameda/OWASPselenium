...
namespace Administration.Controllers
{
    public class ManageUsersController(CSGenio.config.IConfigurationManager configManager) : ControllerBase
    {
        ...
        private void addModules(ref ManageUsersModel model)
        {
            ...
            model.Modules.Add(new Module("GQT", Resources.Resources.GENIO_QUALITY_TESTS30896));
            model.Modules.Add(new Module("IMO", Resources.Resources.REAL_ESTATE24996));
            model.Modules.Add(new Module("PTN", Resources.Resources.PATTERNS16056));
            model.Modules.Add(new Module("REG", Resources.Resources.REGISTRATION03584));
