...
namespace Administration.Controllers
{
    public class UsersController(CSGenio.config.IConfigurationManager configManager) : ControllerBase
    {
        ...
        {
            model.Modules.Add(new UsersModule("GQT", Resources.Resources.GENIO_QUALITY_TESTS30896));
            model.Modules.Add(new UsersModule("IMO", Resources.Resources.REAL_ESTATE24996));
            model.Modules.Add(new UsersModule("PTN", Resources.Resources.PATTERNS16056));
