...
namespace CSGenio.business
{
	...
	public class CSGenioApostit : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
            ...
            info.RegisterFieldDB(new Field(info.Alias, "codpostit", FieldType.KEY_GUID));
            info.RegisterFieldDB(new Field(info.Alias, "codpost1", FieldType.KEY_GUID));
