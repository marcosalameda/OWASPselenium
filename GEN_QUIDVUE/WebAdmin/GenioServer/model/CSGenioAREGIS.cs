...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codregis", FieldType.KEY_GUID);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "email1", FieldType.TEXT);
        ...
        public static CSGenioAregis search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
